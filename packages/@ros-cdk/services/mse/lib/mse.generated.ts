...
export class RosCluster extends ros.RosResource {
     ...
     */
    public readonly attrCreateTime: any;
    ...
    /**
     * @Attribute InitCostTime: init cost time
     */
    public readonly attrInitCostTime: any;
    ...
    constructor(scope: ros.Construct, id: string, props: RosClusterProps, enableResourcePropertyConstraint: boolean) {
        ...
        this.attrCreateTime = ros.Token.asString(this.getAtt('CreateTime'));
        ...
        this.attrInitCostTime = ros.Token.asString(this.getAtt('InitCostTime'));
