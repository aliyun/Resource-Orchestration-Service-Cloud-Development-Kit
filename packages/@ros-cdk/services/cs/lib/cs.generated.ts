...
export interface RosKubernetesClusterProps {
    ...
    /**
     * @Property kubernetesVersion: Kubernetes version. Default to 1.14.8-aliyun.1 .
     */
    ...
    /**
     * @Property workerSystemDiskCategory: Worker node system disk type. The value range is:
     * cloud_efficiency: efficient cloud disk
     * cloud_ssd: SSD cloud disk
...
function RosKubernetesClusterPropsValidator(properties: any): ros.ValidationResult {
    ...
    if(properties.workerSystemDiskCategory && (typeof properties.workerSystemDiskCategory) !== 'object') {
        errors.collect(ros.propertyValidator('workerSystemDiskCategory', ros.validateAllowedValues)({
          data: properties.workerSystemDiskCategory,
          allowedValues: ["cloud_efficiency","cloud_ssd"],
        }));
    }
    ...
    if(properties.proxyMode && (typeof properties.proxyMode) !== 'object') {
        errors.collect(ros.propertyValidator('proxyMode', ros.validateAllowedValues)({
          data: properties.proxyMode,
          allowedValues: ["iptables","IPVS"],
        }));
    }
    ...
    if(properties.kubernetesVersion && (typeof properties.kubernetesVersion) !== 'object') {
        errors.collect(ros.propertyValidator('kubernetesVersion', ros.validateAllowedValues)({
          data: properties.kubernetesVersion,
          allowedValues: ["1.12.6-aliyun.1","1.14.8-aliyun.1"],
        }));
    }
...
export namespace RosKubernetesCluster {
    ...
    export interface MasterDataDisksProperty {
        /**
         * @Property category: Data disk type. Ranges:
