 ...
 */
export abstract class RosElement extends Construct {
  /**
   ...
   */
  public static isRosElement(x: any): x is RosElement {
  ...
  constructor(scope: Construct, id: string) {
    ...
    this.logicalId = Lazy.stringValue(
  ...
  public get creationStack(): string[] {
    const trace = this.node.metadata.find(
   ...
   * @internal
   */
  public abstract _toRosTemplate(): object;
 ...
 */
export abstract class RosRefElement extends RosElement {
  /**
  ...
  public get ref(): string {
    return Token.asString(RosReference.for(this, "Ref"));
  }
}
