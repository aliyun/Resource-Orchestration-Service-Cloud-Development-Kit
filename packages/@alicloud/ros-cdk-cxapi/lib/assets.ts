 ...
 * tests.
 */
export const ASSET_RESOURCE_METADATA_ENABLED_CONTEXT = 'ros:cdk:enable-asset-metadata';

/**
 * Metadata added to the ROS template entries that map local assets
 * to resources.
 */
export const ASSET_RESOURCE_METADATA_PATH_KEY = 'ros:asset:path';
export const ASSET_RESOURCE_METADATA_PROPERTY_KEY = 'ros:asset:property';
export const ASSET_RESOURCE_METADATA_IS_BUNDLED_KEY = 'ros:asset:is-bundled';
