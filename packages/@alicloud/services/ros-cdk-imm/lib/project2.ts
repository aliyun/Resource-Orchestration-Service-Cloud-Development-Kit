 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-imm-project2
 */
export class Project2 extends ros.Resource implements IProject2 {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: Project2Props;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: Project2Props, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
