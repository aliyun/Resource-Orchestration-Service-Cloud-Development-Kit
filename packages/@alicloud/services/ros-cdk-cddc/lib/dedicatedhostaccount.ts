 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cddc-dedicatedhostaccount
 */
export class DedicatedHostAccount extends ros.Resource implements IDedicatedHostAccount {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: DedicatedHostAccountProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DedicatedHostAccountProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosDedicatedHostAccount = new RosDedicatedHostAccount(this, id,  {
            dedicatedHostId: props.dedicatedHostId,
            bastionInstanceId: props.bastionInstanceId,
            accountType: props.accountType,
            accountName: props.accountName,
            accountPassword: props.accountPassword,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosDedicatedHostAccount;
    }
}
