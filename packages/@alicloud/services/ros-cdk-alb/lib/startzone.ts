 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-alb-startzone
 */
export class StartZone extends ros.Resource implements IStartZone {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: StartZoneProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: StartZoneProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosStartZone = new RosStartZone(this, id,  {
