 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-nlb-hdmonitorregionconfig
 */
export class HdMonitorRegionConfig extends ros.Resource implements IHdMonitorRegionConfig {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HdMonitorRegionConfigProps;
     ...
     * Attribute MetricStore: The name of the MetricStore.
     */
    public readonly attrMetricStore: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HdMonitorRegionConfigProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHdMonitorRegionConfig = new RosHdMonitorRegionConfig(this, id,  {
            metricStore: props.metricStore,
            logProject: props.logProject,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHdMonitorRegionConfig;
        this.attrLogProject = rosHdMonitorRegionConfig.attrLogProject;
        this.attrMetricStore = rosHdMonitorRegionConfig.attrMetricStore;
    }
}
