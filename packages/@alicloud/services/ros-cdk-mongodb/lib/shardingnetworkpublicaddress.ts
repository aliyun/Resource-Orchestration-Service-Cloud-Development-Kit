 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mongodb-shardingnetworkpublicaddress
 */
export class ShardingNetworkPublicAddress extends ros.Resource implements IShardingNetworkPublicAddress {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ShardingNetworkPublicAddressProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ShardingNetworkPublicAddressProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosShardingNetworkPublicAddress = new RosShardingNetworkPublicAddress(this, id,  {
            dbInstanceId: props.dbInstanceId,
            nodeId: props.nodeId,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosShardingNetworkPublicAddress;
        this.attrNetworkAddresses = rosShardingNetworkPublicAddress.attrNetworkAddresses;
    }
}
