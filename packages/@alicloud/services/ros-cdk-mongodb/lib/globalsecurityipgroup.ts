...
export class GlobalSecurityIPGroup extends ros.Resource implements IGlobalSecurityIPGroup {
     ...
     * Attribute GlobalIgName: The name of the IP whitelist template.
     */
    public readonly attrGlobalIgName: ros.IResolvable | string;
     ...
     * Attribute GlobalSecurityIpList: The IP address in the whitelist template.
     */
    public readonly attrGlobalSecurityIpList: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: GlobalSecurityIPGroupProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosGlobalSecurityIPGroup = new RosGlobalSecurityIPGroup(this, id,  {
            ...
            globalSecurityIpList: props.globalSecurityIpList,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosGlobalSecurityIPGroup;
        this.attrGlobalIgName = rosGlobalSecurityIPGroup.attrGlobalIgName;
        this.attrGlobalSecurityGroupId = rosGlobalSecurityIPGroup.attrGlobalSecurityGroupId;
        this.attrGlobalSecurityIpList = rosGlobalSecurityIPGroup.attrGlobalSecurityIpList;
    }
}
