 ...
 */
export interface IClusterNodePool extends ros.IResource {
    readonly props: ClusterNodePoolProps;
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cs-clusternodepool
 */
export class ClusterNodePool extends ros.Resource implements IClusterNodePool {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ClusterNodePoolProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute NodePoolId: Cluster node pool ID.
     */
    public readonly attrNodePoolId: ros.IResolvable | string;
