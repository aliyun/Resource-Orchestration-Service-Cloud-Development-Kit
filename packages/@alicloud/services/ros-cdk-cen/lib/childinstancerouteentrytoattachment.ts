 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-childinstancerouteentrytoattachment
 */
export class ChildInstanceRouteEntryToAttachment extends ros.Resource implements IChildInstanceRouteEntryToAttachment {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ChildInstanceRouteEntryToAttachmentProps;
     ...
     * Attribute DestinationCidrBlock: The destination CIDR block of the route.
     */
    public readonly attrDestinationCidrBlock: ros.IResolvable | string;
