 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-cen-transitrouterpeerattachments
 */
export class TransitRouterPeerAttachments extends ros.Resource implements ITransitRouterPeerAttachments {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: TransitRouterPeerAttachmentsProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute TransitRouterPeerAttachmentIds: The list of The TransitRouterPeerAttachment IDs.
     */
    public readonly attrTransitRouterPeerAttachmentIds: ros.IResolvable | string;

    /**
     * Attribute TransitRouterPeerAttachments: The information about TransitRouterPeerAttachments.
     */
    public readonly attrTransitRouterPeerAttachments: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TransitRouterPeerAttachmentsProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosTransitRouterPeerAttachments = new RosTransitRouterPeerAttachments(this, id,  {
        ...
        this.resource = rosTransitRouterPeerAttachments;
        this.attrTransitRouterPeerAttachmentIds = rosTransitRouterPeerAttachments.attrTransitRouterPeerAttachmentIds;
        this.attrTransitRouterPeerAttachments = rosTransitRouterPeerAttachments.attrTransitRouterPeerAttachments;
    }
}
