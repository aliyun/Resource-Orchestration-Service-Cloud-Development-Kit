 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetableassociationreplacement
 */
export class TransitRouterRouteTableAssociationReplacement extends ros.Resource implements ITransitRouterRouteTableAssociationReplacement {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: TransitRouterRouteTableAssociationReplacementProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute OriginalTransitRouterRouteTableId: The original transit router route table ID before replacement.
     */
    public readonly attrOriginalTransitRouterRouteTableId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TransitRouterRouteTableAssociationReplacementProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
