...
export class Flowlog extends ros.Resource implements IFlowlog {
     ...
     * Attribute FlowLogVersion: The flow log version.
     */
    public readonly attrFlowLogVersion: ros.IResolvable | string;
     ...
     * Attribute LogFormatString: The strings that define the fields in the flow log.
     */
    public readonly attrLogFormatString: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: FlowlogProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.attrCenId = rosFlowlog.attrCenId;
        ...
        this.attrFlowLogVersion = rosFlowlog.attrFlowLogVersion;
        this.attrInterval = rosFlowlog.attrInterval;
        this.attrLogFormatString = rosFlowlog.attrLogFormatString;
        this.attrLogStoreName = rosFlowlog.attrLogStoreName;
        this.attrProjectName = rosFlowlog.attrProjectName;
        this.attrTags = rosFlowlog.attrTags;
        this.attrTransitRouterAttachmentId = rosFlowlog.attrTransitRouterAttachmentId;
        this.attrTransitRouterId = rosFlowlog.attrTransitRouterId;
    }
}
