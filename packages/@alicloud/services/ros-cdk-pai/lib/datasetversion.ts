 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-pai-datasetversion
 */
export class DatasetVersion extends ros.Resource implements IDatasetVersion {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: DatasetVersionProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DatasetVersionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
