...
export class Quota extends ros.Resource implements IQuota {
     ...
     * Attribute QuotaId: The ID of the quota.
     */
    public readonly attrQuotaId: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: QuotaProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosQuota = new RosQuota(this, id,  {
            ...
            allocateStrategy: props.allocateStrategy,
            quotaConfig: props.quotaConfig,
            resourceType: props.resourceType,
            labels: props.labels,
            clusterSpec: props.clusterSpec,
            parentQuotaId: props.parentQuotaId,
            queueStrategy: props.queueStrategy,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosQuota;
        this.attrQuotaId = rosQuota.attrQuotaId;
    }
}
