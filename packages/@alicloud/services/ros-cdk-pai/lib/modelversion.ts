 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-pai-modelversion
 */
export class ModelVersion extends ros.Resource implements IModelVersion {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ModelVersionProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ApprovalStatus: Admission status, with values as follows:.
     */
    public readonly attrApprovalStatus: ros.IResolvable | string;

    /**
     * Attribute ExtraInfo: Other information.
     */
    public readonly attrExtraInfo: ros.IResolvable | string;

    /**
     * Attribute FormatType: Model format, possible values:.
     */
    public readonly attrFormatType: ros.IResolvable | string;

    /**
     * Attribute FrameworkType: Model framework, possible values:.
     */
    public readonly attrFrameworkType: ros.IResolvable | string;

    /**
     * Attribute GmtCreateTime: Create a model UTC time in the format ISO8601.
     */
    public readonly attrGmtCreateTime: ros.IResolvable | string;
     ...
     * Attribute InferenceSpec: Describes how to apply to downstream inference services, such as processors and containers of EAS.
     */
    public readonly attrInferenceSpec: ros.IResolvable | string;
     ...
     * Attribute TrainingSpec: Training configuration. Configuration for fine-tuning, incremental training.
     */
    public readonly attrTrainingSpec: ros.IResolvable | string;
     ...
     * Attribute VersionName: Model version.
     */
    public readonly attrVersionName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ModelVersionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosModelVersion = new RosModelVersion(this, id,  {
            ...
            labels: props.labels,
            trainingSpec: props.trainingSpec,
            uri: props.uri,
            formatType: props.formatType,
            approvalStatus: props.approvalStatus,
            metrics: props.metrics,
            frameworkType: props.frameworkType,
            inferenceSpec: props.inferenceSpec,
            versionName: props.versionName,
            modelId: props.modelId,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosModelVersion;
        this.attrApprovalStatus = rosModelVersion.attrApprovalStatus;
        this.attrExtraInfo = rosModelVersion.attrExtraInfo;
        this.attrFormatType = rosModelVersion.attrFormatType;
        this.attrFrameworkType = rosModelVersion.attrFrameworkType;
        this.attrGmtCreateTime = rosModelVersion.attrGmtCreateTime;
        this.attrGmtModifiedTime = rosModelVersion.attrGmtModifiedTime;
        this.attrInferenceSpec = rosModelVersion.attrInferenceSpec;
        this.attrLabels = rosModelVersion.attrLabels;
        this.attrMetrics = rosModelVersion.attrMetrics;
        this.attrOptions = rosModelVersion.attrOptions;
        this.attrOwnerId = rosModelVersion.attrOwnerId;
        this.attrSourceId = rosModelVersion.attrSourceId;
        this.attrSourceType = rosModelVersion.attrSourceType;
        this.attrTrainingSpec = rosModelVersion.attrTrainingSpec;
        this.attrUri = rosModelVersion.attrUri;
        this.attrUserId = rosModelVersion.attrUserId;
        this.attrVersionDescription = rosModelVersion.attrVersionDescription;
        this.attrVersionName = rosModelVersion.attrVersionName;
    }
}
