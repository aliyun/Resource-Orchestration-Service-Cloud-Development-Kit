...
export class WorkspaceResourceDlcs extends ros.Resource implements IWorkspaceResourceDlcs {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WorkspaceResourceDlcsProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosWorkspaceResourceDlcs = new RosWorkspaceResourceDlcs(this, id,  {
