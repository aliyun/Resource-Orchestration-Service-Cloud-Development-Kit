...
export class Member extends ros.Resource implements IMember {
     ...
     * Attribute MemberId: The member ID.
     */
    public readonly attrMemberId: ros.IResolvable | string;

    /**
     * Attribute MemberName: The name of user.
     */
    public readonly attrMemberName: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: MemberProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.attrCreateTime = rosMember.attrCreateTime;
        this.attrDisplayName = rosMember.attrDisplayName;
        this.attrMemberId = rosMember.attrMemberId;
        this.attrMemberName = rosMember.attrMemberName;
        this.attrRoles = rosMember.attrRoles;
        this.attrUserId = rosMember.attrUserId;
    }
}
