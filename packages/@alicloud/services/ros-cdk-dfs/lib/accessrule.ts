...
/**
 * This class encapsulates and extends the ROS resource type `ALIYUN::DFS::AccessRule`.
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dfs-accessrule
 */
export class AccessRule extends ros.Resource implements IAccessRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: AccessRuleProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute AccessRuleId: The ID of the access_rule.
     */
    public readonly attrAccessRuleId: ros.IResolvable | string;
