 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-vulwhitelist
 */
export class VulWhitelist extends ros.Resource implements IVulWhitelist {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: VulWhitelistProps;
     ...
     * Attribute TargetInfo: The applicable scope of the whitelist.
     */
    public readonly attrTargetInfo: ros.IResolvable | string;

    /**
     * Attribute VulWhitelistId: The ID of the whitelist.
     */
    public readonly attrVulWhitelistId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VulWhitelistProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosVulWhitelist = new RosVulWhitelist(this, id,  {
            targetInfo: props.targetInfo,
            whitelist: props.whitelist,
            reason: props.reason,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosVulWhitelist;
        this.attrReason = rosVulWhitelist.attrReason;
        this.attrTargetInfo = rosVulWhitelist.attrTargetInfo;
        this.attrVulWhitelistId = rosVulWhitelist.attrVulWhitelistId;
        this.attrWhitelist = rosVulWhitelist.attrWhitelist;
    }
}
