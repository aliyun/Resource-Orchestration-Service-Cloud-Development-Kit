 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-honeypotprobe
 */
export class HoneypotProbe extends ros.Resource implements IHoneypotProbe {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HoneypotProbeProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute Arp: Specifies whether to enable Address Resolution Protocol (ARP) spoofing.
     */
    public readonly attrArp: ros.IResolvable | string;

    /**
     * Attribute ControlNodeId: The ID of the management node.
     */
    public readonly attrControlNodeId: ros.IResolvable | string;
     ...
     * Attribute HoneypotBindList: The configuration of the probe.
     */
    public readonly attrHoneypotBindList: ros.IResolvable | string;

    /**
     * Attribute HoneypotProbeId: The ID of the probe.
     */
    public readonly attrHoneypotProbeId: ros.IResolvable | string;

    /**
     * Attribute Ping: Specifies whether to enable ping scan.
     */
    public readonly attrPing: ros.IResolvable | string;

    /**
     * Attribute ProbeType: The type of the probe.
     */
    public readonly attrProbeType: ros.IResolvable | string;

    /**
     * Attribute ProbeVersion: The version of the probe.
     */
    public readonly attrProbeVersion: ros.IResolvable | string;

    /**
     * Attribute ServiceIpList: Listen to the IP address list.
     */
    public readonly attrServiceIpList: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HoneypotProbeProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHoneypotProbe = new RosHoneypotProbe(this, id,  {
            probeVersion: props.probeVersion,
            uuid: props.uuid,
            vpcId: props.vpcId,
            probeType: props.probeType,
            serviceIpList: props.serviceIpList,
            controlNodeId: props.controlNodeId,
            ping: props.ping,
            displayName: props.displayName,
            honeypotBindList: props.honeypotBindList,
            businessGroupId: props.businessGroupId,
            proxyIp: props.proxyIp,
            arp: props.arp,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHoneypotProbe;
        this.attrArp = rosHoneypotProbe.attrArp;
        this.attrControlNodeId = rosHoneypotProbe.attrControlNodeId;
        this.attrDisplayName = rosHoneypotProbe.attrDisplayName;
        this.attrHoneypotBindList = rosHoneypotProbe.attrHoneypotBindList;
        this.attrHoneypotProbeId = rosHoneypotProbe.attrHoneypotProbeId;
        this.attrPing = rosHoneypotProbe.attrPing;
        this.attrProbeType = rosHoneypotProbe.attrProbeType;
        this.attrProbeVersion = rosHoneypotProbe.attrProbeVersion;
        this.attrServiceIpList = rosHoneypotProbe.attrServiceIpList;
        this.attrUuid = rosHoneypotProbe.attrUuid;
        this.attrVpcId = rosHoneypotProbe.attrVpcId;
    }
}
