 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-honeypotpreset
 */
export class HoneypotPreset extends ros.Resource implements IHoneypotPreset {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HoneypotPresetProps;
     ...
     * Attribute HoneypotPresetId: The ID of the honeypot template.
     */
    public readonly attrHoneypotPresetId: ros.IResolvable | string;

    /**
     * Attribute Meta: The custom configurations of the honeypot template.
     */
    public readonly attrMeta: ros.IResolvable | string;
     ...
     * Attribute PresetName: The custom name of the honeypot template.
     */
    public readonly attrPresetName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HoneypotPresetProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHoneypotPreset = new RosHoneypotPreset(this, id,  {
            honeypotImageName: props.honeypotImageName,
            meta: props.meta,
            nodeId: props.nodeId,
            presetName: props.presetName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHoneypotPreset;
        this.attrHoneypotImageName = rosHoneypotPreset.attrHoneypotImageName;
        this.attrHoneypotPresetId = rosHoneypotPreset.attrHoneypotPresetId;
        this.attrMeta = rosHoneypotPreset.attrMeta;
        this.attrNodeId = rosHoneypotPreset.attrNodeId;
        this.attrPresetName = rosHoneypotPreset.attrPresetName;
    }
}
