 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-baselinestrategy
 */
export class BaselineStrategy extends ros.Resource implements IBaselineStrategy {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: BaselineStrategyProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute BaselineStrategyId: The ID of the baseline check policy.
     */
    public readonly attrBaselineStrategyId: ros.IResolvable | string;

    /**
     * Attribute BaselineStrategyName: The new name of the baseline check policy.
     */
    public readonly attrBaselineStrategyName: ros.IResolvable | string;

    /**
     * Attribute CustomType: The type of the baseline check policy.
     */
    public readonly attrCustomType: ros.IResolvable | string;

    /**
     * Attribute CycleDays: The new interval of the baseline check.
     */
    public readonly attrCycleDays: ros.IResolvable | string;
     ...
     * Attribute RiskSubTypeName: The subtype of the baselines.
     */
    public readonly attrRiskSubTypeName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: BaselineStrategyProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosBaselineStrategy = new RosBaselineStrategy(this, id,  {
            customType: props.customType,
            endTime: props.endTime,
            baselineStrategyName: props.baselineStrategyName,
            cycleDays: props.cycleDays,
            targetType: props.targetType,
            startTime: props.startTime,
            riskSubTypeName: props.riskSubTypeName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosBaselineStrategy;
        this.attrBaselineStrategyId = rosBaselineStrategy.attrBaselineStrategyId;
        this.attrBaselineStrategyName = rosBaselineStrategy.attrBaselineStrategyName;
        this.attrCustomType = rosBaselineStrategy.attrCustomType;
        this.attrCycleDays = rosBaselineStrategy.attrCycleDays;
        this.attrEndTime = rosBaselineStrategy.attrEndTime;
        this.attrRiskSubTypeName = rosBaselineStrategy.attrRiskSubTypeName;
        this.attrStartTime = rosBaselineStrategy.attrStartTime;
        this.attrTargetType = rosBaselineStrategy.attrTargetType;
    }
}
