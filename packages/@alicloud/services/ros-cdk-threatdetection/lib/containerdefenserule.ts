 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-containerdefenserule
 */
export class ContainerDefenseRule extends ros.Resource implements IContainerDefenseRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ContainerDefenseRuleProps;
     ...
     * Attribute RuleSwitch: The switch of the rule.
     */
    public readonly attrRuleSwitch: ros.IResolvable | string;

    /**
     * Attribute RuleType: The rule type.
     */
    public readonly attrRuleType: ros.IResolvable | string;
     ...
     * Attribute Whitelist: The whitelist of rule.
     */
    public readonly attrWhitelist: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ContainerDefenseRuleProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosContainerDefenseRule = new RosContainerDefenseRule(this, id,  {
            ruleSwitch: props.ruleSwitch,
            description: props.description,
            whitelistHash: props.whitelistHash,
            scope: props.scope,
            ruleId: props.ruleId,
        ...
        this.resource = rosContainerDefenseRule;
        this.attrDescription = rosContainerDefenseRule.attrDescription;
        this.attrRuleAction = rosContainerDefenseRule.attrRuleAction;
        this.attrRuleId = rosContainerDefenseRule.attrRuleId;
        this.attrRuleName = rosContainerDefenseRule.attrRuleName;
        this.attrRuleSwitch = rosContainerDefenseRule.attrRuleSwitch;
        this.attrRuleType = rosContainerDefenseRule.attrRuleType;
        this.attrScope = rosContainerDefenseRule.attrScope;
        this.attrWhitelist = rosContainerDefenseRule.attrWhitelist;
    }
}
