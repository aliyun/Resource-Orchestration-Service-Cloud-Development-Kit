 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-honeypot
 */
export class HoneyPot extends ros.Resource implements IHoneyPot {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HoneyPotProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute HoneypotId: The ID of the honeypot.
     */
    public readonly attrHoneypotId: ros.IResolvable | string;

    /**
     * Attribute HoneypotImageId: The ID of the honeypot image.
     */
    public readonly attrHoneypotImageId: ros.IResolvable | string;

    /**
     * Attribute HoneypotImageName: The name of the honeypot image.
     */
    public readonly attrHoneypotImageName: ros.IResolvable | string;

    /**
     * Attribute HoneypotName: The custom name of the honeypot.
     */
    public readonly attrHoneypotName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HoneyPotProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHoneyPot = new RosHoneyPot(this, id,  {
            honeypotImageName: props.honeypotImageName,
            meta: props.meta,
            nodeId: props.nodeId,
            honeypotImageId: props.honeypotImageId,
            honeypotName: props.honeypotName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHoneyPot;
        this.attrHoneypotId = rosHoneyPot.attrHoneypotId;
        this.attrHoneypotImageId = rosHoneyPot.attrHoneypotImageId;
        this.attrHoneypotImageName = rosHoneyPot.attrHoneypotImageName;
        this.attrHoneypotName = rosHoneyPot.attrHoneypotName;
        this.attrNodeId = rosHoneyPot.attrNodeId;
        this.attrState = rosHoneyPot.attrState;
    }
}
