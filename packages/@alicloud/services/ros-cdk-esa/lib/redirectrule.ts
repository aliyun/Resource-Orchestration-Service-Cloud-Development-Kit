 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-redirectrule
 */
export class RedirectRule extends ros.Resource implements IRedirectRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: RedirectRuleProps;
     ...
     * Attribute ReserveQueryString: Indicates whether the feature of retaining the query string is enabled.
     */
    public readonly attrReserveQueryString: ros.IResolvable | string;
     ...
     * Attribute StatusCode: The response code that you want to use to indicate URL redirection.
     */
    public readonly attrStatusCode: ros.IResolvable | string;

    /**
     * Attribute TargetUrl: The destination URL to which requests are redirected.
     */
    public readonly attrTargetUrl: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RedirectRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosRedirectRule = new RosRedirectRule(this, id,  {
            siteId: props.siteId,
            type: props.type,
        ...
        this.resource = rosRedirectRule;
        this.attrConfigId = rosRedirectRule.attrConfigId;
        this.attrConfigType = rosRedirectRule.attrConfigType;
        this.attrReserveQueryString = rosRedirectRule.attrReserveQueryString;
        this.attrRule = rosRedirectRule.attrRule;
        this.attrRuleEnable = rosRedirectRule.attrRuleEnable;
        this.attrRuleName = rosRedirectRule.attrRuleName;
        this.attrSequence = rosRedirectRule.attrSequence;
        this.attrSiteVersion = rosRedirectRule.attrSiteVersion;
        this.attrStatusCode = rosRedirectRule.attrStatusCode;
        this.attrTargetUrl = rosRedirectRule.attrTargetUrl;
        this.attrType = rosRedirectRule.attrType;
    }
}
