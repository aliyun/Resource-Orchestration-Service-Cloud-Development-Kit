...
import { RosHttpIncomingResponseHeaderModificationRule } from './esa.generated';
// Generated from the AliCloud ROS Resource Specification
export { RosHttpIncomingResponseHeaderModificationRule as HttpIncomingResponseHeaderModificationRuleProperty };

/**
 * Properties for defining a `HttpIncomingResponseHeaderModificationRule`.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpincomingresponseheadermodificationrule
 */
export interface HttpIncomingResponseHeaderModificationRuleProps {
 ...
 */
export interface IHttpIncomingResponseHeaderModificationRule extends ros.IResource {
    readonly props: HttpIncomingResponseHeaderModificationRuleProps;
 ...
 * @Note This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosHttpIncomingResponseHeaderModificationRule`for a more convenient development experience.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpincomingresponseheadermodificationrule
 */
export class HttpIncomingResponseHeaderModificationRule extends ros.Resource implements IHttpIncomingResponseHeaderModificationRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HttpIncomingResponseHeaderModificationRuleProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HttpIncomingResponseHeaderModificationRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHttpIncomingResponseHeaderModificationRule = new RosHttpIncomingResponseHeaderModificationRule(this, id,  {
            siteId: props.siteId,
        ...
        this.resource = rosHttpIncomingResponseHeaderModificationRule;
        this.attrConfigId = rosHttpIncomingResponseHeaderModificationRule.attrConfigId;
        this.attrConfigType = rosHttpIncomingResponseHeaderModificationRule.attrConfigType;
        this.attrResponseHeaderModification = rosHttpIncomingResponseHeaderModificationRule.attrResponseHeaderModification;
        this.attrRule = rosHttpIncomingResponseHeaderModificationRule.attrRule;
        this.attrRuleEnable = rosHttpIncomingResponseHeaderModificationRule.attrRuleEnable;
        this.attrRuleName = rosHttpIncomingResponseHeaderModificationRule.attrRuleName;
        this.attrSequence = rosHttpIncomingResponseHeaderModificationRule.attrSequence;
        this.attrSiteVersion = rosHttpIncomingResponseHeaderModificationRule.attrSiteVersion;
    }
}
