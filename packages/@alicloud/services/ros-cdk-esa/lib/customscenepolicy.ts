 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-customscenepolicy
 */
export class CustomScenePolicy extends ros.Resource implements ICustomScenePolicy {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: CustomScenePolicyProps;
     ...
     * Attribute CustomScenePolicyName: The name of the policy.
     */
    public readonly attrCustomScenePolicyName: ros.IResolvable | string;
     ...
     * Attribute Objects: The IDs of websites associated.
     */
    public readonly attrObjects: ros.IResolvable | string;
     ...
     * Attribute Template: The name of the policy template.
     */
    public readonly attrTemplate: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CustomScenePolicyProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosCustomScenePolicy = new RosCustomScenePolicy(this, id,  {
            customScenePolicyName: props.customScenePolicyName,
            endTime: props.endTime,
            createTime: props.createTime,
            objects: props.objects,
            template: props.template,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosCustomScenePolicy;
        this.attrCreateTime = rosCustomScenePolicy.attrCreateTime;
        this.attrCustomScenePolicyName = rosCustomScenePolicy.attrCustomScenePolicyName;
        this.attrEndTime = rosCustomScenePolicy.attrEndTime;
        this.attrObjects = rosCustomScenePolicy.attrObjects;
        this.attrPolicyId = rosCustomScenePolicy.attrPolicyId;
        this.attrTemplate = rosCustomScenePolicy.attrTemplate;
    }
}
