 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-clientcacertificate
 */
export class ClientCaCertificate extends ros.Resource implements IClientCaCertificate {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ClientCaCertificateProps;
     ...
     * Attribute ClientCaCertId: ClientCaCertificate Id.
     */
    public readonly attrClientCaCertId: ros.IResolvable | string;

    /**
     * Attribute ClientCaCertName: The certificate name.
     */
    public readonly attrClientCaCertName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ClientCaCertificateProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosClientCaCertificate = new RosClientCaCertificate(this, id,  {
            clientCaCertName: props.clientCaCertName,
            siteId: props.siteId,
            certificate: props.certificate,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosClientCaCertificate;
        this.attrCertificate = rosClientCaCertificate.attrCertificate;
        this.attrClientCaCertId = rosClientCaCertificate.attrClientCaCertId;
        this.attrClientCaCertName = rosClientCaCertificate.attrClientCaCertName;
        this.attrCommonName = rosClientCaCertificate.attrCommonName;
        this.attrCreateTime = rosClientCaCertificate.attrCreateTime;
        this.attrIssuer = rosClientCaCertificate.attrIssuer;
        this.attrNotAfter = rosClientCaCertificate.attrNotAfter;
        this.attrNotBefore = rosClientCaCertificate.attrNotBefore;
        this.attrPubkeyAlgorithm = rosClientCaCertificate.attrPubkeyAlgorithm;
        this.attrSan = rosClientCaCertificate.attrSan;
        this.attrSignatureAlgorithm = rosClientCaCertificate.attrSignatureAlgorithm;
        this.attrSiteId = rosClientCaCertificate.attrSiteId;
        this.attrSiteName = rosClientCaCertificate.attrSiteName;
        this.attrType = rosClientCaCertificate.attrType;
        this.attrUpdateTime = rosClientCaCertificate.attrUpdateTime;
    }
}
