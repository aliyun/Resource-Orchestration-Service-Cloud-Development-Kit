 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-site
 */
export class Site extends ros.Resource implements ISite {
     ...
     * Attribute AccessType: Site Access Type.
     */
    public readonly attrAccessType: ros.IResolvable | string;

    /**
     * Attribute Coverage: Acceleration area.
     */
    public readonly attrCoverage: ros.IResolvable | string;
     ...
     * Attribute NameServerList: Site Resolution Name Server List.
     */
    public readonly attrNameServerList: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SiteProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        this.resource = rosSite;
        this.attrAccessType = rosSite.attrAccessType;
        this.attrCoverage = rosSite.attrCoverage;
        this.attrCreateTime = rosSite.attrCreateTime;
        this.attrInstanceId = rosSite.attrInstanceId;
        this.attrModifyTime = rosSite.attrModifyTime;
        this.attrNameServerList = rosSite.attrNameServerList;
        this.attrResourceGroupId = rosSite.attrResourceGroupId;
        this.attrSiteId = rosSite.attrSiteId;
        this.attrSiteName = rosSite.attrSiteName;
        this.attrTags = rosSite.attrTags;
    }
}
