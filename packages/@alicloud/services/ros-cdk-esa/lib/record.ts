 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-record
 */
export class Record extends ros.Resource implements IRecord {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: RecordProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute AuthConf: The origin authentication information of the CNAME record.
     */
    public readonly attrAuthConf: ros.IResolvable | string;

    /**
     * Attribute BizName: The business scenario of the record for acceleration. Leave the parameter empty if your record is not proxied.
     */
    public readonly attrBizName: ros.IResolvable | string;

    /**
     * Attribute Comment: The comment of the record. The maximum length is 100 characters.
     */
    public readonly attrComment: ros.IResolvable | string;
     ...
     * Attribute HostPolicy: The origin host policy. This policy takes effect when the record type is CNAME.
     */
    public readonly attrHostPolicy: ros.IResolvable | string;
     ...
     * Attribute Proxied: Specifies whether to proxy the record. Only CNAME and A/AAAA records can be proxied.
     */
    public readonly attrProxied: ros.IResolvable | string;

    /**
     * Attribute RecordCname: The CNAME. If you use CNAME setup when you add your website to ESA, the value is the CNAME that you configured then.
     */
    public readonly attrRecordCname: ros.IResolvable | string;
     ...
     * Attribute RecordType: The type of the DNS record, such as A/AAAA, CNAME, and TXT.
     */
    public readonly attrRecordType: ros.IResolvable | string;
     ...
     * Attribute Ttl: The TTL of the record. Unit: seconds. If the value is 1, the TTL of the record is determined by the system.
     */
    public readonly attrTtl: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RecordProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosRecord = new RosRecord(this, id,  {
            ...
            hostPolicy: props.hostPolicy,
            data: props.data,
            authConf: props.authConf,
            ttl: props.ttl,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosRecord;
        this.attrAuthConf = rosRecord.attrAuthConf;
        this.attrBizName = rosRecord.attrBizName;
        this.attrComment = rosRecord.attrComment;
        this.attrCreateTime = rosRecord.attrCreateTime;
        this.attrData = rosRecord.attrData;
        this.attrHostPolicy = rosRecord.attrHostPolicy;
        this.attrModifyTime = rosRecord.attrModifyTime;
        this.attrProxied = rosRecord.attrProxied;
        this.attrRecordCname = rosRecord.attrRecordCname;
        this.attrRecordId = rosRecord.attrRecordId;
        this.attrRecordName = rosRecord.attrRecordName;
        this.attrRecordType = rosRecord.attrRecordType;
        this.attrSiteId = rosRecord.attrSiteId;
        this.attrSiteName = rosRecord.attrSiteName;
        this.attrSourceType = rosRecord.attrSourceType;
        this.attrTtl = rosRecord.attrTtl;
    }
}
