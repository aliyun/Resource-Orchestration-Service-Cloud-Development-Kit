 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-waitingroom
 */
export class WaitingRoom extends ros.Resource implements IWaitingRoom {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: WaitingRoomProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute CookieName: Custom Cookie name.
     */
    public readonly attrCookieName: ros.IResolvable | string;
     ...
     * Attribute HostNameAndPath: Host name and path.
     */
    public readonly attrHostNameAndPath: ros.IResolvable | string;
     ...
     * Attribute QueueAllEnable: All in line.
     */
    public readonly attrQueueAllEnable: ros.IResolvable | string;
     ...
     * Attribute WaitingRoomName: The name of the waiting room.
     */
    public readonly attrWaitingRoomName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WaitingRoomProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosWaitingRoom = new RosWaitingRoom(this, id,  {
            status: props.status,
            hostNameAndPath: props.hostNameAndPath,
            ...
            queueAllEnable: props.queueAllEnable,
            waitingRoomName: props.waitingRoomName,
        ...
        this.resource = rosWaitingRoom;
        this.attrCookieName = rosWaitingRoom.attrCookieName;
        this.attrCustomPageHtml = rosWaitingRoom.attrCustomPageHtml;
        this.attrDescription = rosWaitingRoom.attrDescription;
        this.attrDisableSessionRenewalEnable = rosWaitingRoom.attrDisableSessionRenewalEnable;
        this.attrHostNameAndPath = rosWaitingRoom.attrHostNameAndPath;
        this.attrJsonResponseEnable = rosWaitingRoom.attrJsonResponseEnable;
        this.attrLanguage = rosWaitingRoom.attrLanguage;
        this.attrNewUsersPerMinute = rosWaitingRoom.attrNewUsersPerMinute;
        this.attrQueueAllEnable = rosWaitingRoom.attrQueueAllEnable;
        this.attrQueuingMethod = rosWaitingRoom.attrQueuingMethod;
        this.attrQueuingStatusCode = rosWaitingRoom.attrQueuingStatusCode;
        this.attrSessionDuration = rosWaitingRoom.attrSessionDuration;
        this.attrTotalActiveUsers = rosWaitingRoom.attrTotalActiveUsers;
        this.attrWaitingRoomId = rosWaitingRoom.attrWaitingRoomId;
        this.attrWaitingRoomName = rosWaitingRoom.attrWaitingRoomName;
        this.attrWaitingRoomType = rosWaitingRoom.attrWaitingRoomType;
    }
}
