...
import { RosCustomResponseCodeRule } from './esa.generated';
// Generated from the AliCloud ROS Resource Specification
export { RosCustomResponseCodeRule as CustomResponseCodeRuleProperty };

/**
 * Properties for defining a `CustomResponseCodeRule`.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-customresponsecoderule
 */
export interface CustomResponseCodeRuleProps {
 ...
 */
export interface ICustomResponseCodeRule extends ros.IResource {
    readonly props: CustomResponseCodeRuleProps;
     ...
     */
    readonly attrReturnCode: ros.IResolvable | string;
...
/**
 * This class encapsulates and extends the ROS resource type `ALIYUN::ESA::CustomResponseCodeRule`.
 * @Note This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosCustomResponseCodeRule`for a more convenient development experience.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-customresponsecoderule
 */
export class CustomResponseCodeRule extends ros.Resource implements ICustomResponseCodeRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: CustomResponseCodeRuleProps;
     ...
     * Attribute ReturnCode: The custom response code.
     */
    public readonly attrReturnCode: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CustomResponseCodeRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosCustomResponseCodeRule = new RosCustomResponseCodeRule(this, id,  {
            pageId: props.pageId,
            siteId: props.siteId,
        ...
        this.resource = rosCustomResponseCodeRule;
        this.attrConfigId = rosCustomResponseCodeRule.attrConfigId;
        this.attrConfigType = rosCustomResponseCodeRule.attrConfigType;
        this.attrPageId = rosCustomResponseCodeRule.attrPageId;
        this.attrReturnCode = rosCustomResponseCodeRule.attrReturnCode;
        this.attrRule = rosCustomResponseCodeRule.attrRule;
        this.attrRuleEnable = rosCustomResponseCodeRule.attrRuleEnable;
        this.attrRuleName = rosCustomResponseCodeRule.attrRuleName;
        this.attrSequence = rosCustomResponseCodeRule.attrSequence;
        this.attrSiteVersion = rosCustomResponseCodeRule.attrSiteVersion;
    }
}
