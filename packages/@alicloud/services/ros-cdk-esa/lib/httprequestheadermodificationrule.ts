 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httprequestheadermodificationrule
 */
export class HttpRequestHeaderModificationRule extends ros.Resource implements IHttpRequestHeaderModificationRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HttpRequestHeaderModificationRuleProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HttpRequestHeaderModificationRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHttpRequestHeaderModificationRule = new RosHttpRequestHeaderModificationRule(this, id,  {
            siteId: props.siteId,
        ...
        this.resource = rosHttpRequestHeaderModificationRule;
        this.attrConfigId = rosHttpRequestHeaderModificationRule.attrConfigId;
        this.attrConfigType = rosHttpRequestHeaderModificationRule.attrConfigType;
        this.attrRequestHeaderModification = rosHttpRequestHeaderModificationRule.attrRequestHeaderModification;
        this.attrRule = rosHttpRequestHeaderModificationRule.attrRule;
        this.attrRuleEnable = rosHttpRequestHeaderModificationRule.attrRuleEnable;
        this.attrRuleName = rosHttpRequestHeaderModificationRule.attrRuleName;
        this.attrSequence = rosHttpRequestHeaderModificationRule.attrSequence;
        this.attrSiteVersion = rosHttpRequestHeaderModificationRule.attrSiteVersion;
    }
}
