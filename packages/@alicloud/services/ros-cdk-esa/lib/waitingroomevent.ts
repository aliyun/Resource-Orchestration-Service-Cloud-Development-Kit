 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-waitingroomevent
 */
export class WaitingRoomEvent extends ros.Resource implements IWaitingRoomEvent {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: WaitingRoomEventProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute CustomPageHtml: User-defined waiting room page content, when the waiting room type is custom type, you need to enter. The incoming content needs to be base64 encoded.
     */
    public readonly attrCustomPageHtml: ros.IResolvable | string;
     ...
     * Attribute DisableSessionRenewalEnable: Disable session renewal.
     */
    public readonly attrDisableSessionRenewalEnable: ros.IResolvable | string;
     ...
     * Attribute JsonResponseEnable: JSON response switch.
     */
    public readonly attrJsonResponseEnable: ros.IResolvable | string;
     ...
     * Attribute NewUsersPerMinute: Number of new users per minute.
     */
    public readonly attrNewUsersPerMinute: ros.IResolvable | string;

    /**
     * Attribute PreQueueEnable: Pre-queue switch.
     */
    public readonly attrPreQueueEnable: ros.IResolvable | string;

    /**
     * Attribute PreQueueStartTime: Pre-queue start time.
     */
    public readonly attrPreQueueStartTime: ros.IResolvable | string;

    /**
     * Attribute QueuingMethod: Way of queuing.
     */
    public readonly attrQueuingMethod: ros.IResolvable | string;

    /**
     * Attribute QueuingStatusCode: Waiting room status code.
     */
    public readonly attrQueuingStatusCode: ros.IResolvable | string;

    /**
     * Attribute RandomPreQueueEnable: Random queue switch.
     */
    public readonly attrRandomPreQueueEnable: ros.IResolvable | string;

    /**
     * Attribute SessionDuration: User session duration in minutes.
     */
    public readonly attrSessionDuration: ros.IResolvable | string;
     ...
     * Attribute TotalActiveUsers: Total number of active users.
     */
    public readonly attrTotalActiveUsers: ros.IResolvable | string;

    /**
     * Attribute WaitingRoomEventId: The waiting room event ID, which can be obtained by calling the [ListWaitingRoomEvents](https://help.aliyun.com/document_detail/2850279.html) operation.
     */
    public readonly attrWaitingRoomEventId: ros.IResolvable | string;

    /**
     * Attribute WaitingRoomEventName: Event name, custom event description.
     */
    public readonly attrWaitingRoomEventName: ros.IResolvable | string;

    /**
     * Attribute WaitingRoomId: Waiting room ID, used to identify a specific waiting room. It can be obtained by calling the [listwaitingroom](https://help.aliyun.com/document_detail/2850279.html) interface.
     */
    public readonly attrWaitingRoomId: ros.IResolvable | string;

    /**
     * Attribute WaitingRoomType: Waiting room type.
     */
    public readonly attrWaitingRoomType: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WaitingRoomEventProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosWaitingRoomEvent = new RosWaitingRoomEvent(this, id,  {
            jsonResponseEnable: props.jsonResponseEnable,
            siteId: props.siteId,
            description: props.description,
            waitingRoomType: props.waitingRoomType,
            endTime: props.endTime,
            disableSessionRenewalEnable: props.disableSessionRenewalEnable,
            preQueueStartTime: props.preQueueStartTime,
            startTime: props.startTime,
            randomPreQueueEnable: props.randomPreQueueEnable,
            waitingRoomEventName: props.waitingRoomEventName,
            customPageHtml: props.customPageHtml,
            queuingStatusCode: props.queuingStatusCode,
            newUsersPerMinute: props.newUsersPerMinute,
            sessionDuration: props.sessionDuration,
            language: props.language,
            preQueueEnable: props.preQueueEnable,
            totalActiveUsers: props.totalActiveUsers,
            waitingRoomId: props.waitingRoomId,
            queuingMethod: props.queuingMethod,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosWaitingRoomEvent;
        this.attrCustomPageHtml = rosWaitingRoomEvent.attrCustomPageHtml;
        this.attrDescription = rosWaitingRoomEvent.attrDescription;
        this.attrDisableSessionRenewalEnable = rosWaitingRoomEvent.attrDisableSessionRenewalEnable;
        this.attrEndTime = rosWaitingRoomEvent.attrEndTime;
        this.attrJsonResponseEnable = rosWaitingRoomEvent.attrJsonResponseEnable;
        this.attrLanguage = rosWaitingRoomEvent.attrLanguage;
        this.attrNewUsersPerMinute = rosWaitingRoomEvent.attrNewUsersPerMinute;
        this.attrPreQueueEnable = rosWaitingRoomEvent.attrPreQueueEnable;
        this.attrPreQueueStartTime = rosWaitingRoomEvent.attrPreQueueStartTime;
        this.attrQueuingMethod = rosWaitingRoomEvent.attrQueuingMethod;
        this.attrQueuingStatusCode = rosWaitingRoomEvent.attrQueuingStatusCode;
        this.attrRandomPreQueueEnable = rosWaitingRoomEvent.attrRandomPreQueueEnable;
        this.attrSessionDuration = rosWaitingRoomEvent.attrSessionDuration;
        this.attrStartTime = rosWaitingRoomEvent.attrStartTime;
        this.attrTotalActiveUsers = rosWaitingRoomEvent.attrTotalActiveUsers;
        this.attrWaitingRoomEventId = rosWaitingRoomEvent.attrWaitingRoomEventId;
        this.attrWaitingRoomEventName = rosWaitingRoomEvent.attrWaitingRoomEventName;
        this.attrWaitingRoomId = rosWaitingRoomEvent.attrWaitingRoomId;
        this.attrWaitingRoomType = rosWaitingRoomEvent.attrWaitingRoomType;
    }
}
