 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-scheduledpreloadjob
 */
export class ScheduledPreloadJob extends ros.Resource implements IScheduledPreloadJob {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ScheduledPreloadJobProps;
     ...
     * Attribute ErrorInfo: The error message.
     */
    public readonly attrErrorInfo: ros.IResolvable | string;

    /**
     * Attribute FailedFileOss: OSS address of failed file.
     */
    public readonly attrFailedFileOss: ros.IResolvable | string;

    /**
     * Attribute FileId: The ID of the URL list file, which can be used during downloads.
     */
    public readonly attrFileId: ros.IResolvable | string;

    /**
     * Attribute InsertWay: The method to submit the URLs to be prefetched.
     */
    public readonly attrInsertWay: ros.IResolvable | string;
     ...
     * Attribute ScheduledPreloadJobName: The task name.
     */
    public readonly attrScheduledPreloadJobName: ros.IResolvable | string;
     ...
     * Attribute TaskSubmitted: The number of submitted prefetch tasks.
     */
    public readonly attrTaskSubmitted: ros.IResolvable | string;
     ...
     * Attribute UrlCount: The total number of URLs.
     */
    public readonly attrUrlCount: ros.IResolvable | string;

    /**
     * Attribute UrlSubmitted: The number of submitted URLs.
     */
    public readonly attrUrlSubmitted: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ScheduledPreloadJobProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosScheduledPreloadJob = new RosScheduledPreloadJob(this, id,  {
            insertWay: props.insertWay,
            siteId: props.siteId,
            ossUrl: props.ossUrl,
            scheduledPreloadJobName: props.scheduledPreloadJobName,
            urlList: props.urlList,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosScheduledPreloadJob;
        this.attrCreateTime = rosScheduledPreloadJob.attrCreateTime;
        this.attrDomains = rosScheduledPreloadJob.attrDomains;
        this.attrErrorInfo = rosScheduledPreloadJob.attrErrorInfo;
        this.attrFailedFileOss = rosScheduledPreloadJob.attrFailedFileOss;
        this.attrFileId = rosScheduledPreloadJob.attrFileId;
        this.attrInsertWay = rosScheduledPreloadJob.attrInsertWay;
        this.attrScheduledPreloadJobId = rosScheduledPreloadJob.attrScheduledPreloadJobId;
        this.attrScheduledPreloadJobName = rosScheduledPreloadJob.attrScheduledPreloadJobName;
        this.attrSiteId = rosScheduledPreloadJob.attrSiteId;
        this.attrTaskSubmitted = rosScheduledPreloadJob.attrTaskSubmitted;
        this.attrTaskType = rosScheduledPreloadJob.attrTaskType;
        this.attrUrlCount = rosScheduledPreloadJob.attrUrlCount;
        this.attrUrlSubmitted = rosScheduledPreloadJob.attrUrlSubmitted;
    }
}
