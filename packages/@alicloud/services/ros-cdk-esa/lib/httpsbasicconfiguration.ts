 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpsbasicconfiguration
 */
export class HttpsBasicConfiguration extends ros.Resource implements IHttpsBasicConfiguration {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HttpsBasicConfigurationProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute Ciphersuite: Custom cipher suite, indicating the specific encryption algorithm selected when CiphersuiteGroup is set to custom.
     */
    public readonly attrCiphersuite: ros.IResolvable | string;

    /**
     * Attribute CiphersuiteGroup: Cipher suite group. Default is all cipher suites.
     */
    public readonly attrCiphersuiteGroup: ros.IResolvable | string;
     ...
     * Attribute Http2: Indicates whether HTTP2 is enabled. Default is on.
     */
    public readonly attrHttp2: ros.IResolvable | string;

    /**
     * Attribute Http3: Whether to enable HTTP3, which is enabled by default.
     */
    public readonly attrHttp3: ros.IResolvable | string;

    /**
     * Attribute Https: Whether to enable HTTPS. Default is enabled.
     */
    public readonly attrHttps: ros.IResolvable | string;

    /**
     * Attribute OcspStapling: Indicates whether OCSP is enabled. Default is off.
     */
    public readonly attrOcspStapling: ros.IResolvable | string;
     ...
     * Attribute Tls10: Whether to enable TLS1.0. Default is disabled.
     */
    public readonly attrTls10: ros.IResolvable | string;

    /**
     * Attribute Tls11: Whether to enable TLS1.1. Default is enabled.
     */
    public readonly attrTls11: ros.IResolvable | string;

    /**
     * Attribute Tls12: Whether to enable TLS1.2. Default is enabled.
     */
    public readonly attrTls12: ros.IResolvable | string;

    /**
     * Attribute Tls13: Whether to enable TLS1.3. Default is enabled.
     */
    public readonly attrTls13: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HttpsBasicConfigurationProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHttpsBasicConfiguration = new RosHttpsBasicConfiguration(this, id,  {
            siteId: props.siteId,
            ciphersuite: props.ciphersuite,
            ...
            tls12: props.tls12,
            tls13: props.tls13,
            ciphersuiteGroup: props.ciphersuiteGroup,
            rule: props.rule,
            ruleName: props.ruleName,
            ocspStapling: props.ocspStapling,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHttpsBasicConfiguration;
        this.attrCiphersuite = rosHttpsBasicConfiguration.attrCiphersuite;
        this.attrCiphersuiteGroup = rosHttpsBasicConfiguration.attrCiphersuiteGroup;
        this.attrConfigId = rosHttpsBasicConfiguration.attrConfigId;
        this.attrConfigType = rosHttpsBasicConfiguration.attrConfigType;
        this.attrHttp2 = rosHttpsBasicConfiguration.attrHttp2;
        this.attrHttp3 = rosHttpsBasicConfiguration.attrHttp3;
        this.attrHttps = rosHttpsBasicConfiguration.attrHttps;
        this.attrOcspStapling = rosHttpsBasicConfiguration.attrOcspStapling;
        this.attrRule = rosHttpsBasicConfiguration.attrRule;
        this.attrRuleEnable = rosHttpsBasicConfiguration.attrRuleEnable;
        this.attrRuleName = rosHttpsBasicConfiguration.attrRuleName;
        this.attrSequence = rosHttpsBasicConfiguration.attrSequence;
        this.attrTls10 = rosHttpsBasicConfiguration.attrTls10;
        this.attrTls11 = rosHttpsBasicConfiguration.attrTls11;
        this.attrTls12 = rosHttpsBasicConfiguration.attrTls12;
        this.attrTls13 = rosHttpsBasicConfiguration.attrTls13;
    }
}
