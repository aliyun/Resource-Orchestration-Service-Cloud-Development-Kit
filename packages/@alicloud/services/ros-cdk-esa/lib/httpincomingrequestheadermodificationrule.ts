...
import { RosHttpIncomingRequestHeaderModificationRule } from './esa.generated';
// Generated from the AliCloud ROS Resource Specification
export { RosHttpIncomingRequestHeaderModificationRule as HttpIncomingRequestHeaderModificationRuleProperty };

/**
 * Properties for defining a `HttpIncomingRequestHeaderModificationRule`.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpincomingrequestheadermodificationrule
 */
export interface HttpIncomingRequestHeaderModificationRuleProps {
 ...
 */
export interface IHttpIncomingRequestHeaderModificationRule extends ros.IResource {
    readonly props: HttpIncomingRequestHeaderModificationRuleProps;
...
/**
 * This class encapsulates and extends the ROS resource type `ALIYUN::ESA::HttpIncomingRequestHeaderModificationRule`.
 * @Note This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosHttpIncomingRequestHeaderModificationRule`for a more convenient development experience.
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpincomingrequestheadermodificationrule
 */
export class HttpIncomingRequestHeaderModificationRule extends ros.Resource implements IHttpIncomingRequestHeaderModificationRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HttpIncomingRequestHeaderModificationRuleProps;
     ...
     * Attribute RequestHeaderModification: The configurations of modifying request headers. You can add, delete, or modify a request header.
     */
    public readonly attrRequestHeaderModification: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HttpIncomingRequestHeaderModificationRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHttpIncomingRequestHeaderModificationRule = new RosHttpIncomingRequestHeaderModificationRule(this, id,  {
            siteId: props.siteId,
            ruleEnable: props.ruleEnable,
            sequence: props.sequence,
            rule: props.rule,
            siteVersion: props.siteVersion,
            requestHeaderModification: props.requestHeaderModification,
            ruleName: props.ruleName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHttpIncomingRequestHeaderModificationRule;
        this.attrConfigId = rosHttpIncomingRequestHeaderModificationRule.attrConfigId;
        this.attrConfigType = rosHttpIncomingRequestHeaderModificationRule.attrConfigType;
        this.attrRequestHeaderModification = rosHttpIncomingRequestHeaderModificationRule.attrRequestHeaderModification;
        this.attrRule = rosHttpIncomingRequestHeaderModificationRule.attrRule;
        this.attrRuleEnable = rosHttpIncomingRequestHeaderModificationRule.attrRuleEnable;
        this.attrRuleName = rosHttpIncomingRequestHeaderModificationRule.attrRuleName;
        this.attrSequence = rosHttpIncomingRequestHeaderModificationRule.attrSequence;
        this.attrSiteVersion = rosHttpIncomingRequestHeaderModificationRule.attrSiteVersion;
    }
}
