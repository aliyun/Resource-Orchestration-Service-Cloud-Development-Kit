 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-customlist
 */
export class CustomList extends ros.Resource implements ICustomList {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: CustomListProps;
     ...
     * Attribute Items: The items in the custom list, which are displayed as an array.
     */
    public readonly attrItems: ros.IResolvable | string;
     ...
     * Attribute ListId: The id of the custom list .
     */
    public readonly attrListId: ros.IResolvable | string;

    /**
     * Attribute ListName: The name of the custom list.
     */
    public readonly attrListName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CustomListProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosCustomList = new RosCustomList(this, id,  {
            description: props.description,
            listName: props.listName,
            kind: props.kind,
            items: props.items,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosCustomList;
        this.attrDescription = rosCustomList.attrDescription;
        this.attrItems = rosCustomList.attrItems;
        this.attrKind = rosCustomList.attrKind;
        this.attrListId = rosCustomList.attrListId;
        this.attrListName = rosCustomList.attrListName;
        this.attrUpdateTime = rosCustomList.attrUpdateTime;
    }
}
