 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dns-customline
 */
export class CustomLine extends ros.Resource implements ICustomLine {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: CustomLineProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute LineId: The ID of the custom line.
     */
    public readonly attrLineId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CustomLineProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosCustomLine = new RosCustomLine(this, id,  {
