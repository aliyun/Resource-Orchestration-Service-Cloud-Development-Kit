 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dns-recoveryplan
 */
export class RecoveryPlan extends ros.Resource implements IRecoveryPlan {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: RecoveryPlanProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute RecoveryPlanId: The ID of the recovery plan.
     */
    public readonly attrRecoveryPlanId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RecoveryPlanProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosRecoveryPlan = new RosRecoveryPlan(this, id,  {
            lang: props.lang,
            faultAddrPool: props.faultAddrPool,
            name: props.name,
            remark: props.remark,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosRecoveryPlan;
        this.attrRecoveryPlanId = rosRecoveryPlan.attrRecoveryPlanId;
    }
}
