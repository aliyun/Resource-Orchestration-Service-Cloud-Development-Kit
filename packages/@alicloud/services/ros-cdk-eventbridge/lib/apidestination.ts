 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-eventbridge-apidestination
 */
export class ApiDestination extends ros.Resource implements IApiDestination {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ApiDestinationProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ApiDestinationName: The name of the api. The maximum length is 127 characters. Minimum length 2 characters.
     */
    public readonly attrApiDestinationName: ros.IResolvable | string;

    /**
     * Attribute ConnectionName: The connection configuration name. The maximum length is 127 characters. Minimum length 2 characters.
     */
    public readonly attrConnectionName: ros.IResolvable | string;
     ...
     * Attribute HttpApiParameters: Configuration information for API endpoints.
     */
    public readonly attrHttpApiParameters: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ApiDestinationProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosApiDestination = new RosApiDestination(this, id,  {
            connectionName: props.connectionName,
            description: props.description,
            httpApiParameters: props.httpApiParameters,
            apiDestinationName: props.apiDestinationName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosApiDestination;
        this.attrApiDestinationName = rosApiDestination.attrApiDestinationName;
        this.attrConnectionName = rosApiDestination.attrConnectionName;
        this.attrCreateTime = rosApiDestination.attrCreateTime;
        this.attrDescription = rosApiDestination.attrDescription;
        this.attrHttpApiParameters = rosApiDestination.attrHttpApiParameters;
    }
}
