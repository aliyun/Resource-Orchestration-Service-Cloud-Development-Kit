...
export class Connection extends ros.Resource implements IConnection {
     ...
     * Attribute AuthParameters: Authentication Data Structure.
     */
    public readonly attrAuthParameters: ros.IResolvable | string;
     ...
     * Attribute NetworkParameters: Network Configuration Data Structure.
     */
    public readonly attrNetworkParameters: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: ConnectionProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosConnection = new RosConnection(this, id,  {
            ...
            networkParameters: props.networkParameters,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosConnection;
        this.attrAuthParameters = rosConnection.attrAuthParameters;
        this.attrConnectionName = rosConnection.attrConnectionName;
        this.attrCreateTime = rosConnection.attrCreateTime;
        this.attrDescription = rosConnection.attrDescription;
        this.attrNetworkParameters = rosConnection.attrNetworkParameters;
    }
}
