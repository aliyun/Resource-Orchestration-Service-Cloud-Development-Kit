...
export class SearchLib extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SearchLibProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSearchLib = new RosSearchLib(this, id,  {
