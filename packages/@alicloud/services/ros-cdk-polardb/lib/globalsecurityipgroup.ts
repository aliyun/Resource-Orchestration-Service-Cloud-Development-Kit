...
/**
 * This class encapsulates and extends the ROS resource type `ALIYUN::POLARDB::GlobalSecurityIPGroup`, which is used to create a global IP whitelist template.
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-polardb-globalsecurityipgroup
 */
export class GlobalSecurityIPGroup extends ros.Resource implements IGlobalSecurityIPGroup {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: GlobalSecurityIPGroupProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute GlobalSecurityGroupId: The ID of the IP whitelist template.
     */
    public readonly attrGlobalSecurityGroupId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: GlobalSecurityIPGroupProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosGlobalSecurityIPGroup = new RosGlobalSecurityIPGroup(this, id,  {
