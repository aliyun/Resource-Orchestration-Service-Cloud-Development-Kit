 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-polardb-applicationendpointaddress
 */
export class ApplicationEndpointAddress extends ros.Resource implements IApplicationEndpointAddress {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ApplicationEndpointAddressProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ApplicationEndpointAddressProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosApplicationEndpointAddress = new RosApplicationEndpointAddress(this, id,  {
            endpointId: props.endpointId,
            applicationId: props.applicationId,
            netType: props.netType,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosApplicationEndpointAddress;
        this.attrPrivateEndpoint = rosApplicationEndpointAddress.attrPrivateEndpoint;
        this.attrPublicEndpoint = rosApplicationEndpointAddress.attrPublicEndpoint;
    }
}
