...
export class ClusterV2 extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ClusterV2Props, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosClusterV2 = new RosClusterV2(this, id,  {
