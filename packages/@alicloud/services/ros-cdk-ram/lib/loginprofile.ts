...
export class LoginProfile extends ros.Resource implements ILoginProfile {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: LoginProfileProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosLoginProfile = new RosLoginProfile(this, id,  {
            status: props.status,
