 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-schedulerx-workflow
 */
export class WorkFlow extends ros.Resource implements IWorkFlow {
     ...
     * Attribute MaxConcurrency: The maximum number of workflow instances running at the same time. The default value is 1, that is, the last trigger is not completed, and the next trigger will not be performed even when the running time is reached.
     */
    public readonly attrMaxConcurrency: ros.IResolvable | string;
     ...
     * Attribute TimeExpression: Time expression, which is set based on the selected time type.
     */
    public readonly attrTimeExpression: ros.IResolvable | string;

    /**
     * Attribute TimeType: Time type.
     */
    public readonly attrTimeType: ros.IResolvable | string;

    /**
     * Attribute WorkFlowId: workflow id.
     */
    public readonly attrWorkFlowId: ros.IResolvable | string;

    /**
     * Attribute WorkflowName: Workflow Name.
     */
    public readonly attrWorkflowName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WorkFlowProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosWorkFlow = new RosWorkFlow(this, id,  {
        ...
        this.resource = rosWorkFlow;
        this.attrDescription = rosWorkFlow.attrDescription;
        this.attrGroupId = rosWorkFlow.attrGroupId;
        this.attrMaxConcurrency = rosWorkFlow.attrMaxConcurrency;
        this.attrNamespace = rosWorkFlow.attrNamespace;
        this.attrTimeExpression = rosWorkFlow.attrTimeExpression;
        this.attrTimeType = rosWorkFlow.attrTimeType;
        this.attrWorkFlowId = rosWorkFlow.attrWorkFlowId;
        this.attrWorkflowName = rosWorkFlow.attrWorkflowName;
    }
}
