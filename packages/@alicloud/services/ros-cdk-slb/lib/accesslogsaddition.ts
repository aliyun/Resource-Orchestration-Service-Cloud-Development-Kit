 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-slb-accesslogsaddition
 */
export class AccessLogsAddition extends ros.Resource implements IAccessLogsAddition {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: AccessLogsAdditionProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AccessLogsAdditionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosAccessLogsAddition = new RosAccessLogsAddition(this, id,  {
