 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ess-scalingrule
 */
export class ScalingRule extends ros.Resource implements IScalingRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ScalingRuleProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ScalingRuleAri: Unique identifier of a scaling rule.
     */
    public readonly attrScalingRuleAri: ros.IResolvable | string;
