 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqosqueue
 */
export class TrafficQosQueue extends ros.Resource implements ITrafficQosQueue {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: TrafficQosQueueProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute BandwidthPercent: QoS queue bandwidth percentage.
     */
    public readonly attrBandwidthPercent: ros.IResolvable | string;
     ...
     * Attribute QueueDescription: The description of the QoS queue.
     */
    public readonly attrQueueDescription: ros.IResolvable | string;
     ...
     * Attribute QueueType: QoS queue type.
     */
    public readonly attrQueueType: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TrafficQosQueueProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosTrafficQosQueue = new RosTrafficQosQueue(this, id,  {
            qosId: props.qosId,
            bandwidthPercent: props.bandwidthPercent,
            queueDescription: props.queueDescription,
            queueName: props.queueName,
            queueType: props.queueType,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosTrafficQosQueue;
        this.attrBandwidthPercent = rosTrafficQosQueue.attrBandwidthPercent;
        this.attrQosId = rosTrafficQosQueue.attrQosId;
        this.attrQueueDescription = rosTrafficQosQueue.attrQueueDescription;
        this.attrQueueId = rosTrafficQosQueue.attrQueueId;
        this.attrQueueName = rosTrafficQosQueue.attrQueueName;
        this.attrQueueType = rosTrafficQosQueue.attrQueueType;
    }
}
