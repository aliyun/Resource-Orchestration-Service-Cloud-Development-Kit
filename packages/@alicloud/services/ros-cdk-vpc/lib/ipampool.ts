 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipampool
 */
export class IpamPool extends ros.Resource implements IIpamPool {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: IpamPoolProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosIpamPool = new RosIpamPool(this, id,  {
            ipv6Isp: props.ipv6Isp,
            resourceGroupId: props.resourceGroupId,
            ipamPoolName: props.ipamPoolName,
            sourceIpamPoolId: props.sourceIpamPoolId,
            ipVersion: props.ipVersion,
            allocationDefaultCidrMask: props.allocationDefaultCidrMask,
            allocationMinCidrMask: props.allocationMinCidrMask,
            ipamScopeId: props.ipamScopeId,
            ipamPoolDescription: props.ipamPoolDescription,
            poolRegionId: props.poolRegionId,
            autoImport: props.autoImport,
            tags: props.tags,
            allocationMaxCidrMask: props.allocationMaxCidrMask,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosIpamPool;
        this.attrIpamPoolId = rosIpamPool.attrIpamPoolId;
    }
}
