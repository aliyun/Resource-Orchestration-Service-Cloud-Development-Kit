 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipv6egressrule
 */
export class Ipv6EgressRule extends ros.Resource implements IIpv6EgressRule {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: Ipv6EgressRuleProps;
     ...
     * Attribute Ipv6EgressRuleId: The ID of the egress-only rule that you want to delete.
     */
    public readonly attrIpv6EgressRuleId: ros.IResolvable | string;

    /**
     * Attribute Ipv6EgressRuleName: The name of the egress-only rule.
     */
    public readonly attrIpv6EgressRuleName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: Ipv6EgressRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosIpv6EgressRule = new RosIpv6EgressRule(this, id,  {
            description: props.description,
            instanceId: props.instanceId,
            ipv6GatewayId: props.ipv6GatewayId,
            ipv6EgressRuleName: props.ipv6EgressRuleName,
            instanceType: props.instanceType,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosIpv6EgressRule;
        this.attrDescription = rosIpv6EgressRule.attrDescription;
        this.attrInstanceId = rosIpv6EgressRule.attrInstanceId;
        this.attrInstanceType = rosIpv6EgressRule.attrInstanceType;
        this.attrIpv6EgressRuleId = rosIpv6EgressRule.attrIpv6EgressRuleId;
        this.attrIpv6EgressRuleName = rosIpv6EgressRule.attrIpv6EgressRuleName;
    }
}
