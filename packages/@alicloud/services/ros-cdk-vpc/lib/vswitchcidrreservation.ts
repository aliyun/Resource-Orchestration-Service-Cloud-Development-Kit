...
export class VSwitchCidrReservation extends ros.Resource implements IVSwitchCidrReservation {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VSwitchCidrReservationProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosVSwitchCidrReservation = new RosVSwitchCidrReservation(this, id,  {
