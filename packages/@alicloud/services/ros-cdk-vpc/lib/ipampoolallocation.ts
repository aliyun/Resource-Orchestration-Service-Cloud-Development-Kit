 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipampoolallocation
 */
export class IpamPoolAllocation extends ros.Resource implements IIpamPoolAllocation {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: IpamPoolAllocationProps;
     ...
     * Attribute IpamPoolAllocationDescription: The description of the ipam pool alloctaion.
     */
    public readonly attrIpamPoolAllocationDescription: ros.IResolvable | string;

    /**
     * Attribute IpamPoolAllocationId: The instance ID of the ipam pool allocation.
     */
    public readonly attrIpamPoolAllocationId: ros.IResolvable | string;

    /**
     * Attribute IpamPoolAllocationName: The name of the ipam pool allocation.
     */
    public readonly attrIpamPoolAllocationName: ros.IResolvable | string;

    /**
     * Attribute IpamPoolId: The ID of the IPAM Pool.
     */
    public readonly attrIpamPoolId: ros.IResolvable | string;

    /**
     * Attribute ResourceOwnerId: The ID of the Alibaba Cloud account (primary account) to which the resource belongs.
     */
    public readonly attrResourceOwnerId: ros.IResolvable | string;
     ...
     * Attribute SourceCidr: The source address segment.
     */
    public readonly attrSourceCidr: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: IpamPoolAllocationProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosIpamPoolAllocation = new RosIpamPoolAllocation(this, id,  {
            cidr: props.cidr,
            ipamPoolAllocationDescription: props.ipamPoolAllocationDescription,
            ipamPoolId: props.ipamPoolId,
            cidrMask: props.cidrMask,
            ipamPoolAllocationName: props.ipamPoolAllocationName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosIpamPoolAllocation;
        this.attrCidr = rosIpamPoolAllocation.attrCidr;
        this.attrCreateTime = rosIpamPoolAllocation.attrCreateTime;
        this.attrIpamPoolAllocationDescription = rosIpamPoolAllocation.attrIpamPoolAllocationDescription;
        this.attrIpamPoolAllocationId = rosIpamPoolAllocation.attrIpamPoolAllocationId;
        this.attrIpamPoolAllocationName = rosIpamPoolAllocation.attrIpamPoolAllocationName;
        this.attrIpamPoolId = rosIpamPoolAllocation.attrIpamPoolId;
        this.attrResourceOwnerId = rosIpamPoolAllocation.attrResourceOwnerId;
        this.attrResourceType = rosIpamPoolAllocation.attrResourceType;
        this.attrSourceCidr = rosIpamPoolAllocation.attrSourceCidr;
    }
}
