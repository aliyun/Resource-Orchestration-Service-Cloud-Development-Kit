 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vcorouteentry
 */
export class VcoRouteEntry extends ros.Resource implements IVcoRouteEntry {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: VcoRouteEntryProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VcoRouteEntryProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        this.resource = rosVcoRouteEntry;
        this.attrVpnConnectionId = rosVcoRouteEntry.attrVpnConnectionId;
    }
}
