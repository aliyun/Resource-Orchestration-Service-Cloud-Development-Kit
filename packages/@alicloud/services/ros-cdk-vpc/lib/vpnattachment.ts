...
export class VpnAttachment extends ros.Resource {
    ...
    constructor(scope: ros.Construct, id: string, props: VpnAttachmentProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.resource = rosVpnAttachment;
        this.attrInternetIp = rosVpnAttachment.attrInternetIp;
        this.attrPeerVpnAttachmentConfig = rosVpnAttachment.attrPeerVpnAttachmentConfig;
        this.attrVpnAttachmentId = rosVpnAttachment.attrVpnAttachmentId;
    }
}
