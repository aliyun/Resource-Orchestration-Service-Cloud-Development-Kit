...
export class SchedulerRule extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SchedulerRuleProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSchedulerRule = new RosSchedulerRule(this, id,  {
