 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-resourcemanager-delegatedadministrator
 */
export class DelegatedAdministrator extends ros.Resource implements IDelegatedAdministrator {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: DelegatedAdministratorProps;
     ...
     * Attribute DelegationEnabledTime: Set as the timestamp of the delegated administrator account.
     */
    public readonly attrDelegationEnabledTime: ros.IResolvable | string;

    /**
     * Attribute ServicePrincipal: The identifier of the trusted service.
     */
    public readonly attrServicePrincipal: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DelegatedAdministratorProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosDelegatedAdministrator = new RosDelegatedAdministrator(this, id,  {
            accountId: props.accountId,
            servicePrincipal: props.servicePrincipal,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosDelegatedAdministrator;
        this.attrAccountId = rosDelegatedAdministrator.attrAccountId;
        this.attrDelegationEnabledTime = rosDelegatedAdministrator.attrDelegationEnabledTime;
        this.attrServicePrincipal = rosDelegatedAdministrator.attrServicePrincipal;
    }
}
