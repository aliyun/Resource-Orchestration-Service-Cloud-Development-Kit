 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-resourcemanager-savedquery
 */
export class SavedQuery extends ros.Resource implements ISavedQuery {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: SavedQueryProps;
     ...
     * Attribute Expression: Query Expression of the template.
     */
    public readonly attrExpression: ros.IResolvable | string;

    /**
     * Attribute SavedQueryId: The id of the template.
     */
    public readonly attrSavedQueryId: ros.IResolvable | string;

    /**
     * Attribute SavedQueryName: The name of the template.
     */
    public readonly attrSavedQueryName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SavedQueryProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSavedQuery = new RosSavedQuery(this, id,  {
            description: props.description,
            expression: props.expression,
            savedQueryName: props.savedQueryName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosSavedQuery;
        this.attrCreateTime = rosSavedQuery.attrCreateTime;
        this.attrDescription = rosSavedQuery.attrDescription;
        this.attrExpression = rosSavedQuery.attrExpression;
        this.attrSavedQueryId = rosSavedQuery.attrSavedQueryId;
        this.attrSavedQueryName = rosSavedQuery.attrSavedQueryName;
        this.attrUpdateTime = rosSavedQuery.attrUpdateTime;
    }
}
