 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-resourcemanager-messagecontact
 */
export class MessageContact extends ros.Resource implements IMessageContact {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: MessageContactProps;
     ...
     * Attribute EmailAddress: The email address of the contact.
     */
    public readonly attrEmailAddress: ros.IResolvable | string;

    /**
     * Attribute MessageContactId: The ID of Message Contact.
     */
    public readonly attrMessageContactId: ros.IResolvable | string;

    /**
     * Attribute MessageContactName: The name of the contact.
     */
    public readonly attrMessageContactName: ros.IResolvable | string;

    /**
     * Attribute MessageTypes: The types of messages received by the contact.
     */
    public readonly attrMessageTypes: ros.IResolvable | string;

    /**
     * Attribute PhoneNumber: The mobile phone number of the contact.
     */
    public readonly attrPhoneNumber: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: MessageContactProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosMessageContact = new RosMessageContact(this, id,  {
            messageTypes: props.messageTypes,
            phoneNumber: props.phoneNumber,
            title: props.title,
            messageContactName: props.messageContactName,
            emailAddress: props.emailAddress,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosMessageContact;
        this.attrCreateTime = rosMessageContact.attrCreateTime;
        this.attrEmailAddress = rosMessageContact.attrEmailAddress;
        this.attrMessageContactId = rosMessageContact.attrMessageContactId;
        this.attrMessageContactName = rosMessageContact.attrMessageContactName;
        this.attrMessageTypes = rosMessageContact.attrMessageTypes;
        this.attrPhoneNumber = rosMessageContact.attrPhoneNumber;
        this.attrTitle = rosMessageContact.attrTitle;
    }
}
