 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-asyncinvokeconfig
 */
export class AsyncInvokeConfig extends ros.Resource implements IAsyncInvokeConfig {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: AsyncInvokeConfigProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AsyncInvokeConfigProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
