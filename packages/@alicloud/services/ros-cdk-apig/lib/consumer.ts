 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apig-consumer
 */
export class Consumer extends ros.Resource implements IConsumer {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ConsumerProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ConsumerId: The ID of the consumer.
     */
    public readonly attrConsumerId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ConsumerProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosConsumer = new RosConsumer(this, id,  {
            description: props.description,
            jwtIdentityConfig: props.jwtIdentityConfig,
            enable: props.enable,
            gatewayType: props.gatewayType,
            apikeyIdentityConfig: props.apikeyIdentityConfig,
            akSkIdentityConfigs: props.akSkIdentityConfigs,
            name: props.name,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosConsumer;
        this.attrConsumerId = rosConsumer.attrConsumerId;
    }
}
