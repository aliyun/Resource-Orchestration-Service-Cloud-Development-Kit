...
export class HttpApi extends ros.Resource implements IHttpApi {
    ...
    constructor(scope: ros.Construct, id: string, props: HttpApiProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosHttpApi = new RosHttpApi(this, id,  {
            onlyChangeConfig: props.onlyChangeConfig,
            httpApiName: props.httpApiName,
            protocols: props.protocols,
            description: props.description,
            resourceGroupId: props.resourceGroupId,
            firstByteTimeout: props.firstByteTimeout,
            belongGatewayId: props.belongGatewayId,
            builtinRouteNames: props.builtinRouteNames,
            basePath: props.basePath,
            enableAuth: props.enableAuth,
            authConfig: props.authConfig,
            versionConfig: props.versionConfig,
            type: props.type,
            removeBasePathOnForward: props.removeBasePathOnForward,
            ingressConfig: props.ingressConfig,
            agentProtocols: props.agentProtocols,
            aiProtocols: props.aiProtocols,
            strategy: props.strategy,
            deployConfigs: props.deployConfigs,
