 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apig-source
 */
export class Source extends ros.Resource implements ISource {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: SourceProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SourceProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSource = new RosSource(this, id,  {
            nacosSourceConfig: props.nacosSourceConfig,
            k8SSourceConfig: props.k8SSourceConfig,
            type: props.type,
            resourceGroupId: props.resourceGroupId,
            gatewayId: props.gatewayId,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosSource;
        this.attrSourceId = rosSource.attrSourceId;
    }
}
