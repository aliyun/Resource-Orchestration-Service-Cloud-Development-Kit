 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-appflow-chatbotflow
 */
export class ChatbotFlow extends ros.Resource implements IChatbotFlow {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ChatbotFlowProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ChatbotFlowId: The ID of the chatbot flow.
     */
    public readonly attrChatbotFlowId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ChatbotFlowProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosChatbotFlow = new RosChatbotFlow(this, id,  {
