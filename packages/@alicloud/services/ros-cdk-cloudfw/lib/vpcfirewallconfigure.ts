...
export class VpcFirewallConfigure extends ros.Resource implements IVpcFirewallConfigure {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VpcFirewallConfigureProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosVpcFirewallConfigure = new RosVpcFirewallConfigure(this, id,  {
