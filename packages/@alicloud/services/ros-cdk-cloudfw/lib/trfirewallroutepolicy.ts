...
export class TrFirewallRoutePolicy extends ros.Resource implements ITrFirewallRoutePolicy {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TrFirewallRoutePolicyProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosTrFirewallRoutePolicy = new RosTrFirewallRoutePolicy(this, id,  {
