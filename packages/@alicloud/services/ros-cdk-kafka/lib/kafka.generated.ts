...
export class RosInstance extends ros.RosResource {
     ...
     * This parameter must be specified when the DeployType parameter is set to 4.
     */
    public eipMax: number | undefined;

    /**
     * @Property ioMax: The peak traffic to be configured for the Message Queue for Apache Kafka instance. 
     * For more information about the value range, see Billing.
     */
    public ioMax: number | undefined;
     ...
     *
     */
    public ioMaxSpec: string | undefined;
     ...
     * normal: Normal version
     */
    public specType: string | undefined;
    ...
    constructor(scope: ros.Construct, id: string, props: RosInstanceProps, enableResourcePropertyConstraint: boolean) {
        ...
        this.tags = new ros.TagManager(ros.TagType.STANDARD, "ALIYUN::KAFKA::Instance", props.tags, { tagPropertyName: 'tags' });
    }
