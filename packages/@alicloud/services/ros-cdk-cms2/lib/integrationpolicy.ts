 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms2-integrationpolicy
 */
export class IntegrationPolicy extends ros.Resource implements IIntegrationPolicy {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: IntegrationPolicyProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: IntegrationPolicyProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosIntegrationPolicy = new RosIntegrationPolicy(this, id,  {
        ...
        this.resource = rosIntegrationPolicy;
        this.attrPolicyId = rosIntegrationPolicy.attrPolicyId;
    }
}
