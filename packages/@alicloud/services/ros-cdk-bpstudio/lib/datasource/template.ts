...
export class Template extends ros.Resource implements ITemplate {
     ...
     * Attribute TopoUrl: Represents resource file address.
     */
    public readonly attrTopoUrl: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: TemplateProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.attrCreateTime = rosTemplate.attrCreateTime;
        this.attrDescription = rosTemplate.attrDescription;
        this.attrImageUrl = rosTemplate.attrImageUrl;
        ...
        this.attrTopoUrl = rosTemplate.attrTopoUrl;
    }
}
