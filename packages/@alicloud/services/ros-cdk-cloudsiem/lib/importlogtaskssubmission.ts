 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cloudsiem-importlogtaskssubmission
 */
export class ImportLogTasksSubmission extends ros.Resource implements IImportLogTasksSubmission {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ImportLogTasksSubmissionProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ImportLogTasksSubmissionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosImportLogTasksSubmission = new RosImportLogTasksSubmission(this, id,  {
