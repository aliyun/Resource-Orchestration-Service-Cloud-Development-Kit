...
export class SnapshotGroup extends ros.Resource implements ISnapshotGroup {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SnapshotGroupProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSnapshotGroup = new RosSnapshotGroup(this, id,  {
