...
export class ImagePipeline extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ImagePipelineProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosImagePipeline = new RosImagePipeline(this, id,  {
