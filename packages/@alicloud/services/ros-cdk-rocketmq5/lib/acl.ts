...
export class Acl extends ros.Resource implements IAcl {
     ...
     * Attribute Actions: The type of operation authorized.
     */
    public readonly attrActions: ros.IResolvable | string;

    /**
     * Attribute Decision: The decision result of the authorization.
     */
    public readonly attrDecision: ros.IResolvable | string;
     ...
     * Attribute IpWhitelists: The IP addresses in the whitelist.
     */
    public readonly attrIpWhitelists: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: AclProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosAcl = new RosAcl(this, id,  {
            ...
            ipWhitelists: props.ipWhitelists,
            resourceType: props.resourceType,
            decision: props.decision,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosAcl;
        this.attrActions = rosAcl.attrActions;
        this.attrDecision = rosAcl.attrDecision;
