...
export class MonitorGroup extends ros.Resource implements IMonitorGroup {
     ...
     * Attribute BindUrl: BindUrl.
     */
    public readonly attrBindUrl: ros.IResolvable | string;
     ...
     * Attribute MonitorGroupName: MonitorGroupName.
     */
    public readonly attrMonitorGroupName: ros.IResolvable | string;
     ...
     * Attribute TemplateIds: TemplateIds.
     */
    public readonly attrTemplateIds: ros.IResolvable | string;
