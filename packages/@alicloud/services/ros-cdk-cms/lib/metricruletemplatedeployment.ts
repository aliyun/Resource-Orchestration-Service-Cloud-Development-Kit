 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-metricruletemplatedeployment
 */
export class MetricRuleTemplateDeployment extends ros.Resource implements IMetricRuleTemplateDeployment {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: MetricRuleTemplateDeploymentProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: MetricRuleTemplateDeploymentProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosMetricRuleTemplateDeployment = new RosMetricRuleTemplateDeployment(this, id,  {
            silenceTime: props.silenceTime,
            notifyLevel: props.notifyLevel,
            appendMode: props.appendMode,
            applyMode: props.applyMode,
            enableEndTime: props.enableEndTime,
            webhook: props.webhook,
            templateIds: props.templateIds,
            enableStartTime: props.enableStartTime,
            groupId: props.groupId,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosMetricRuleTemplateDeployment;
        this.attrGroupId = rosMetricRuleTemplateDeployment.attrGroupId;
        this.attrRuleIds = rosMetricRuleTemplateDeployment.attrRuleIds;
    }
}
