...
export class EnterpriseDBCluster extends ros.Resource implements IEnterpriseDBCluster {
     ...
     * Attribute PrivateConnectionString: The private connection string.
     */
    public readonly attrPrivateConnectionString: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: EnterpriseDBClusterProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosEnterpriseDBCluster = new RosEnterpriseDBCluster(this, id,  {
            multiZone: props.multiZone,
            nodeScaleMin: props.nodeScaleMin,
            storageType: props.storageType === undefined || props.storageType === null ? 'oss' : props.storageType,
            zoneId: props.zoneId,
            ...
            deploySchema: props.deploySchema,
            vpcId: props.vpcId,
            nodeScaleMax: props.nodeScaleMax,
            publicConnectionSetting: props.publicConnectionSetting,
            storageQuota: props.storageQuota,
            dbInstanceDescription: props.dbInstanceDescription,
            engine: props.engine === undefined || props.engine === null ? 'clickhouse' : props.engine,
            tags: props.tags,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosEnterpriseDBCluster;
        this.attrDbInstanceId = rosEnterpriseDBCluster.attrDbInstanceId;
        this.attrPrivateConnectionString = rosEnterpriseDBCluster.attrPrivateConnectionString;
        this.attrPublicConnectionString = rosEnterpriseDBCluster.attrPublicConnectionString;
    }
}
