 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-clickhouse-enterprisedbclusteraccount
 */
export class EnterpriseDBClusterAccount extends ros.Resource implements IEnterpriseDBClusterAccount {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: EnterpriseDBClusterAccountProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute Account: The name of the database account.
     */
    public readonly attrAccount: ros.IResolvable | string;
     ...
     * Attribute DmlAuthSetting: The information about permissions.
     */
    public readonly attrDmlAuthSetting: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EnterpriseDBClusterAccountProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosEnterpriseDBClusterAccount = new RosEnterpriseDBClusterAccount(this, id,  {
            account: props.account,
            description: props.description,
            dbInstanceId: props.dbInstanceId,
            accountType: props.accountType,
            dmlAuthSetting: props.dmlAuthSetting,
            password: props.password,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosEnterpriseDBClusterAccount;
        this.attrAccount = rosEnterpriseDBClusterAccount.attrAccount;
        this.attrAccountType = rosEnterpriseDBClusterAccount.attrAccountType;
        this.attrDescription = rosEnterpriseDBClusterAccount.attrDescription;
        this.attrDmlAuthSetting = rosEnterpriseDBClusterAccount.attrDmlAuthSetting;
    }
}
