 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-clickhouse-enterprisedbcluster
 */
export class EnterpriseDBCluster extends ros.Resource implements IEnterpriseDBCluster {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: EnterpriseDBClusterProps;
     ...
     * Attribute ComputingGroupIds: The list of computing group IDs.
     */
    public readonly attrComputingGroupIds: ros.IResolvable | string;
     ...
     * Attribute DisabledPorts: The specified database port is disabled. Multiple ports separated by commas (,) are supported.
     */
    public readonly attrDisabledPorts: ros.IResolvable | string;
     ...
     * Attribute EngineMinorVersion: The minor version number of the cluster engine.
     */
    public readonly attrEngineMinorVersion: ros.IResolvable | string;
     ...
     * Attribute MultiZones: The information about the zones.
     */
    public readonly attrMultiZones: ros.IResolvable | string;

    /**
     * Attribute NodeCount: The number of nodes. The value range is 2-16. Required when you use NodeScaleMin and NodeScaleMax to configure an elastic interval.
     */
    public readonly attrNodeCount: ros.IResolvable | string;

    /**
     * Attribute NodeScaleMax: The maximum value of serverless node auto scaling.
     */
    public readonly attrNodeScaleMax: ros.IResolvable | string;

    /**
     * Attribute NodeScaleMin: Minimum number of Serverless nodes for auto-scaling.
     */
    public readonly attrNodeScaleMin: ros.IResolvable | string;
     ...
     * Attribute ObjectStoreSize: The size of the object storage space.
     */
    public readonly attrObjectStoreSize: ros.IResolvable | string;
     ...
     * Attribute ScaleMax: The maximum capacity for elastic scaling.
     */
    public readonly attrScaleMax: ros.IResolvable | string;

    /**
     * Attribute ScaleMin: The minimum capacity for elastic scaling.
     */
    public readonly attrScaleMin: ros.IResolvable | string;

    /**
     * Attribute StorageQuota: Storage Pre-purchased Capacity (GB).
     */
    public readonly attrStorageQuota: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EnterpriseDBClusterProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosEnterpriseDBCluster = new RosEnterpriseDBCluster(this, id,  {
            dbInstanceId: props.dbInstanceId,
            refreshOptions: props.refreshOptions === undefined || props.refreshOptions === null ? 'Never' : props.refreshOptions,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosEnterpriseDBCluster;
        this.attrCategory = rosEnterpriseDBCluster.attrCategory;
        this.attrChargeType = rosEnterpriseDBCluster.attrChargeType;
        this.attrComputingGroupIds = rosEnterpriseDBCluster.attrComputingGroupIds;
        this.attrCreateTime = rosEnterpriseDBCluster.attrCreateTime;
        this.attrDbInstanceId = rosEnterpriseDBCluster.attrDbInstanceId;
        this.attrDescription = rosEnterpriseDBCluster.attrDescription;
        this.attrDisabledPorts = rosEnterpriseDBCluster.attrDisabledPorts;
        this.attrEndpoints = rosEnterpriseDBCluster.attrEndpoints;
        this.attrEngine = rosEnterpriseDBCluster.attrEngine;
        this.attrEngineMinorVersion = rosEnterpriseDBCluster.attrEngineMinorVersion;
        this.attrEngineVersion = rosEnterpriseDBCluster.attrEngineVersion;
        this.attrInstanceNetworkType = rosEnterpriseDBCluster.attrInstanceNetworkType;
        this.attrMaintainEndTime = rosEnterpriseDBCluster.attrMaintainEndTime;
        this.attrMaintainStartTime = rosEnterpriseDBCluster.attrMaintainStartTime;
        this.attrMultiZones = rosEnterpriseDBCluster.attrMultiZones;
        this.attrNodeCount = rosEnterpriseDBCluster.attrNodeCount;
        this.attrNodeScaleMax = rosEnterpriseDBCluster.attrNodeScaleMax;
        this.attrNodeScaleMin = rosEnterpriseDBCluster.attrNodeScaleMin;
        this.attrNodes = rosEnterpriseDBCluster.attrNodes;
        this.attrObjectStoreSize = rosEnterpriseDBCluster.attrObjectStoreSize;
        this.attrResourceGroupId = rosEnterpriseDBCluster.attrResourceGroupId;
        this.attrScaleMax = rosEnterpriseDBCluster.attrScaleMax;
        this.attrScaleMin = rosEnterpriseDBCluster.attrScaleMin;
        this.attrStorageQuota = rosEnterpriseDBCluster.attrStorageQuota;
        this.attrStorageSize = rosEnterpriseDBCluster.attrStorageSize;
        this.attrStorageType = rosEnterpriseDBCluster.attrStorageType;
        this.attrTags = rosEnterpriseDBCluster.attrTags;
        this.attrVpcId = rosEnterpriseDBCluster.attrVpcId;
        this.attrVswitchId = rosEnterpriseDBCluster.attrVswitchId;
        this.attrZoneId = rosEnterpriseDBCluster.attrZoneId;
    }
}
