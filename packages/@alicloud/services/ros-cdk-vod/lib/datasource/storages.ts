 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-vod-storages
 */
export class Storages extends ros.Resource implements IStorages {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: StoragesProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute StorageLocations: The list of storage locations.
     */
    public readonly attrStorageLocations: ros.IResolvable | string;

    /**
     * Attribute Storages: The list of storages.
     */
    public readonly attrStorages: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: StoragesProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosStorages = new RosStorages(this, id,  {
