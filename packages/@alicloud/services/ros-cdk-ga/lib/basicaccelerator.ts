...
export class BasicAccelerator extends ros.Resource implements IBasicAccelerator {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: BasicAcceleratorProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosBasicAccelerator = new RosBasicAccelerator(this, id,  {
