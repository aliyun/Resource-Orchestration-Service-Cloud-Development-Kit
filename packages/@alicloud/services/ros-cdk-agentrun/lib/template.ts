...
export class Template extends ros.Resource implements ITemplate {
     ...
     * Attribute TemplateArn: The ARN of the template.
     */
    public readonly attrTemplateArn: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: TemplateProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosTemplate = new RosTemplate(this, id,  {
            ...
            cpu: props.cpu,
            armsConfiguration: props.armsConfiguration,
            templateConfiguration: props.templateConfiguration,
            templateType: props.templateType,
            credentialConfiguration: props.credentialConfiguration,
            containerConfiguration: props.containerConfiguration,
            logConfiguration: props.logConfiguration,
            ossConfiguration: props.ossConfiguration,
            enableAgent: props.enableAgent,
            executionRoleArn: props.executionRoleArn,
            environmentVariables: props.environmentVariables,
            diskSize: props.diskSize,
            templateName: props.templateName,
            allowAnonymousManage: props.allowAnonymousManage,
            networkConfiguration: props.networkConfiguration,
            sandboxIdleTimeoutInSeconds: props.sandboxIdleTimeoutInSeconds,
            nasConfig: props.nasConfig,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosTemplate;
        this.attrTemplateArn = rosTemplate.attrTemplateArn;
