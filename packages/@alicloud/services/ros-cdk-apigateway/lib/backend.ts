 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apigateway-backend
 */
export class Backend extends ros.Resource implements IBackend {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: BackendProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute BackendId: The ID of the backend service.
     */
    public readonly attrBackendId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: BackendProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosBackend = new RosBackend(this, id,  {
