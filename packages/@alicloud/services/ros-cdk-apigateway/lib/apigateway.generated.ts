 ...
 */
export interface RosBackendProps {
 ...
 * @returns the result of the validation.
 */
function RosBackendPropsValidator(properties: any): ros.ValidationResult {
    if (!ros.canInspect(properties)) { return ros.VALIDATION_SUCCESS; }
    const errors = new ros.ValidationResults();
 ...
 */
// @ts-ignore TS6133
function rosBackendPropsToRosTemplate(properties: any, enableResourcePropertyConstraint: boolean): any {
    if (!ros.canInspect(properties)) { return properties; }
    if(enableResourcePropertyConstraint) {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apigateway-backend
 */
export class RosBackend extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    public static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::ApiGateway::Backend";

    /**
     * @Attribute BackendId: The ID of the backend service.
     */
    public readonly attrBackendId: ros.IResolvable;
     ...
     * @Property backendName: The name of the backend service.
     */
    public backendName: string | ros.IResolvable;

    /**
     * @Property backendType: The type the backend service. Allowed values: HTTP, VPC, FC_EVENT, FC_EVENT_V3, FC_HTTP, FC_HTTP_V3, OSS, MOCK
     */
    public backendType: string | ros.IResolvable;
     ...
     * @Property tags: The list of tags in the form of key\/value pairs. You can define a maximum of 20 tags.
     */
    public tags: RosBackend.TagsProperty[] | undefined;
     ...
     * @param props - resource properties
     */
    constructor(scope: ros.Construct, id: string, props: RosBackendProps, enableResourcePropertyConstraint: boolean) {
 ...
 * @returns the result of the validation.
 */
function RosBackend_TagsPropertyValidator(properties: any): ros.ValidationResult {
    if (!ros.canInspect(properties)) { return ros.VALIDATION_SUCCESS; }
    const errors = new ros.ValidationResults();
 ...
 */
// @ts-ignore TS6133
function rosBackendTagsPropertyToRosTemplate(properties: any): any {
    if (!ros.canInspect(properties)) { return properties; }
