 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-otsbackupplan
 */
export class OtsBackupPlan extends ros.Resource implements IOtsBackupPlan {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: OtsBackupPlanProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: OtsBackupPlanProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosOtsBackupPlan = new RosOtsBackupPlan(this, id,  {
            ...
            otsDetail: props.otsDetail,
            rules: props.rules,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosOtsBackupPlan;
        this.attrPlanId = rosOtsBackupPlan.attrPlanId;
    }
}
