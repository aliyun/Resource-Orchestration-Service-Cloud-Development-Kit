 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-ossbackupplan
 */
export class OssBackupPlan extends ros.Resource implements IOssBackupPlan {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: OssBackupPlanProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: OssBackupPlanProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosOssBackupPlan = new RosOssBackupPlan(this, id,  {
        ...
        this.resource = rosOssBackupPlan;
        this.attrPlanId = rosOssBackupPlan.attrPlanId;
    }
}
