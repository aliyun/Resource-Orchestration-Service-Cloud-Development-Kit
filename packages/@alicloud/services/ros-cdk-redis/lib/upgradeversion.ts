 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-redis-upgradeversion
 */
export class UpgradeVersion extends ros.Resource implements IUpgradeVersion {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: UpgradeVersionProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: UpgradeVersionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosUpgradeVersion = new RosUpgradeVersion(this, id,  {
