...
export class Listener extends ros.Resource implements IListener {
     ...
     * Attribute ListenerDescription: The custom listener description.
     */
    public readonly attrListenerDescription: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: ListenerProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.attrListenerDescription = rosListener.attrListenerDescription;
        this.attrListenerId = rosListener.attrListenerId;
        this.attrLoadBalancerId = rosListener.attrLoadBalancerId;
        this.attrServerGroupId = rosListener.attrServerGroupId;
        this.attrTags = rosListener.attrTags;
    }
}
