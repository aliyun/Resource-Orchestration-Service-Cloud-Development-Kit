...
export class Template extends ros.Resource implements ITemplate {
     ...
     * Attribute HasTrigger: Specifies whether to query the template that is configured with a trigger.
     */
    public readonly attrHasTrigger: ros.IResolvable | string;

    /**
     * Attribute Hash: The SHA-256 value of the template content.
     */
    public readonly attrHash: ros.IResolvable | string;
...
YAML
     */
    public readonly attrTemplateFormat: ros.IResolvable | string;
...
Package: the template for software packages.
     */
    public readonly attrTemplateType: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: TemplateProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        this.attrContent = rosTemplate.attrContent;
        this.attrCreatedBy = rosTemplate.attrCreatedBy;
        this.attrCreatedDate = rosTemplate.attrCreatedDate;
        this.attrDescription = rosTemplate.attrDescription;
        this.attrHasTrigger = rosTemplate.attrHasTrigger;
        this.attrHash = rosTemplate.attrHash;
        this.attrResourceGroupId = rosTemplate.attrResourceGroupId;
        this.attrShareType = rosTemplate.attrShareType;
        this.attrTags = rosTemplate.attrTags;
        this.attrTemplateFormat = rosTemplate.attrTemplateFormat;
        this.attrTemplateId = rosTemplate.attrTemplateId;
        this.attrTemplateType = rosTemplate.attrTemplateType;
        this.attrUpdatedBy = rosTemplate.attrUpdatedBy;
        this.attrUpdatedDate = rosTemplate.attrUpdatedDate;
    }
}
