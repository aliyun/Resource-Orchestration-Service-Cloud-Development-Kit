 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-gatewaydomain
 */
export class GatewayDomain extends ros.Resource implements IGatewayDomain {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: GatewayDomainProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: GatewayDomainProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosGatewayDomain = new RosGatewayDomain(this, id,  {
        ...
        this.resource = rosGatewayDomain;
        this.attrDomainId = rosGatewayDomain.attrDomainId;
    }
}
