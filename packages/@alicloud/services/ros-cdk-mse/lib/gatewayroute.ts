 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-gatewayroute
 */
export class GatewayRoute extends ros.Resource implements IGatewayRoute {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: GatewayRouteProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: GatewayRouteProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        this.resource = rosGatewayRoute;
        this.attrRouteId = rosGatewayRoute.attrRouteId;
    }
}
