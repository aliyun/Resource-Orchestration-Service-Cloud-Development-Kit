 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-znode
 */
export class Znode extends ros.Resource implements IZnode {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ZnodeProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ZnodeProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosZnode = new RosZnode(this, id,  {
            path: props.path,
            type: props.type,
