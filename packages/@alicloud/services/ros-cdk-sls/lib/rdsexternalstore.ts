...
export class RdsExternalStore extends ros.Resource implements IRdsExternalStore {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RdsExternalStoreProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosRdsExternalStore = new RosRdsExternalStore(this, id,  {
