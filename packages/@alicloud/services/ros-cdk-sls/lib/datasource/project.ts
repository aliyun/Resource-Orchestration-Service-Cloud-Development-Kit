...
export class Project extends ros.Resource implements IProject {
     ...
     * Attribute DataRedundancyType: Data redundancy type.
     */
    public readonly attrDataRedundancyType: ros.IResolvable | string;
     ...
     * Attribute Quota: Project quota.
     */
    public readonly attrQuota: ros.IResolvable | string;

    /**
     * Attribute Region: The region to which the project belongs.
     */
    public readonly attrRegion: ros.IResolvable | string;
