 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cas-pcacertificate
 */
export class PcaCertificate extends ros.Resource implements IPcaCertificate {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: PcaCertificateProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute Algorithm: The key algorithm type of the root CA certificate. The key algorithm is expressed using the '<encryption algorithm >_< key length>' format.
     */
    public readonly attrAlgorithm: ros.IResolvable | string;

    /**
     * Attribute CertificateType: The type of CA.
     */
    public readonly attrCertificateType: ros.IResolvable | string;
     ...
     * Attribute CountryCode: The code of the country or region in which the organization is located, using a two-digit capital abbreviation. For example, **CN** represents China and **US** represents the United States.
     */
    public readonly attrCountryCode: ros.IResolvable | string;

    /**
     * Attribute Identifier: Certificate Identifier.
     */
    public readonly attrIdentifier: ros.IResolvable | string;

    /**
     * Attribute IssuerType: The institution issuing the CA.
     */
    public readonly attrIssuerType: ros.IResolvable | string;

    /**
     * Attribute Locality: Name of the city where the organization is located. Support the use of Chinese, English characters.
     */
    public readonly attrLocality: ros.IResolvable | string;

    /**
     * Attribute Organization: The name of the organization (corresponding to your enterprise or company) associated with the root CA certificate. Support the use of Chinese, English characters.
     */
    public readonly attrOrganization: ros.IResolvable | string;

    /**
     * Attribute OrganizationUnit: The name of the department or branch under the organization. Support the use of Chinese, English characters.
     */
    public readonly attrOrganizationUnit: ros.IResolvable | string;
     ...
     * Attribute Years: The validity period of the root CA certificate, in years.
     */
    public readonly attrYears: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PcaCertificateProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosPcaCertificate = new RosPcaCertificate(this, id,  {
            ...
            caStatus: props.caStatus,
            commonName: props.commonName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosPcaCertificate;
        this.attrAlgorithm = rosPcaCertificate.attrAlgorithm;
        this.attrCertificateType = rosPcaCertificate.attrCertificateType;
        this.attrCommonName = rosPcaCertificate.attrCommonName;
        this.attrCountryCode = rosPcaCertificate.attrCountryCode;
        this.attrIdentifier = rosPcaCertificate.attrIdentifier;
        this.attrIssuerType = rosPcaCertificate.attrIssuerType;
        this.attrLocality = rosPcaCertificate.attrLocality;
        this.attrOrganization = rosPcaCertificate.attrOrganization;
        this.attrOrganizationUnit = rosPcaCertificate.attrOrganizationUnit;
        this.attrState = rosPcaCertificate.attrState;
        this.attrYears = rosPcaCertificate.attrYears;
    }
}
