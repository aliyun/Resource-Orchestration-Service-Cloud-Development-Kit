 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dms-scriptexecution
 */
export class ScriptExecution extends ros.Resource implements IScriptExecution {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ScriptExecutionProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ScriptExecutionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosScriptExecution = new RosScriptExecution(this, id,  {
            script: props.script,
            dbId: props.dbId,
            logic: props.logic,
            tid: props.tid,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosScriptExecution;
    }
}
