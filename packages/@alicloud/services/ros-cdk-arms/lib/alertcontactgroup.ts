 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-arms-alertcontactgroup
 */
export class AlertContactGroup extends ros.Resource implements IAlertContactGroup {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: AlertContactGroupProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ContactGroupId: The ID of the alert contact group that you created.
     */
    public readonly attrContactGroupId: ros.IResolvable | string;
