...
export class GrafanaWorkspaces extends ros.Resource implements IGrafanaWorkspaces {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: GrafanaWorkspacesProps = {}, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosGrafanaWorkspaces = new RosGrafanaWorkspaces(this, id,  {
