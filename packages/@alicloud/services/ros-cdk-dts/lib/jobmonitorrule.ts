...
export class JobMonitorRule extends ros.Resource implements IJobMonitorRule {
     ...
     * Attribute Phones: The alarm is triggered after notification of the contact phone number, A plurality of phone numbers between them with a comma (,) to separate.
     */
    public readonly attrPhones: ros.IResolvable | string;
    ...
    constructor(scope: ros.Construct, id: string, props: JobMonitorRuleProps, enableResourcePropertyConstraint:boolean = true) {
        ...
        const rosJobMonitorRule = new RosJobMonitorRule(this, id,  {
            ...
            phones: props.phones,
            state: props.state === undefined || props.state === null ? 'Y' : props.state,
            times: props.times,
            period: props.period,
        ...
        this.attrPhones = rosJobMonitorRule.attrPhones;
