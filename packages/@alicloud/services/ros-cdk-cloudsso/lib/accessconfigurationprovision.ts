...
export class AccessConfigurationProvision extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AccessConfigurationProvisionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosAccessConfigurationProvision = new RosAccessConfigurationProvision(this, id,  {
