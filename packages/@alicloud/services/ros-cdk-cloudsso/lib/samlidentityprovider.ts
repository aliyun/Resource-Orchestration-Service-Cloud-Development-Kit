...
export class SAMLIdentityProvider extends ros.Resource implements ISAMLIdentityProvider {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SAMLIdentityProviderProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosSAMLIdentityProvider = new RosSAMLIdentityProvider(this, id,  {
