 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-bastionhost-usergroup
 */
export class UserGroup extends ros.Resource implements IUserGroup {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: UserGroupProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute UserGroupId: The ID of the user group.
     */
    public readonly attrUserGroupId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: UserGroupProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosUserGroup = new RosUserGroup(this, id,  {
