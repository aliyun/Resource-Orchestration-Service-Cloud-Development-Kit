 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-bastionhost-exportconfigjob
 */
export class ExportConfigJob extends ros.Resource implements IExportConfigJob {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ExportConfigJobProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute DownloadUrl: The download url of the export config job.
     */
    public readonly attrDownloadUrl: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ExportConfigJobProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosExportConfigJob = new RosExportConfigJob(this, id,  {
            instanceId: props.instanceId,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosExportConfigJob;
        this.attrDownloadUrl = rosExportConfigJob.attrDownloadUrl;
        this.attrJobId = rosExportConfigJob.attrJobId;
    }
}
