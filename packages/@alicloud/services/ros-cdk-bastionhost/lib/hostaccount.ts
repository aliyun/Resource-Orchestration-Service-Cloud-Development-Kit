 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-bastionhost-hostaccount
 */
export class HostAccount extends ros.Resource implements IHostAccount {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: HostAccountProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute HostAccountId: The ID of the host account.
     */
    public readonly attrHostAccountId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HostAccountProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosHostAccount = new RosHostAccount(this, id,  {
            protocolName: props.protocolName,
            hostAccountName: props.hostAccountName,
            privateKey: props.privateKey,
            instanceId: props.instanceId,
            rotationMode: props.rotationMode,
            hostId: props.hostId,
            passPhrase: props.passPhrase,
            hostShareKeyId: props.hostShareKeyId,
            privilegeType: props.privilegeType,
            password: props.password,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosHostAccount;
        this.attrHostAccountId = rosHostAccount.attrHostAccountId;
    }
}
