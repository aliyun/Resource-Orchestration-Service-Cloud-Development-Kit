 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-bastionhost-passwordtaskhostaccountattachment
 */
export class PasswordTaskHostAccountAttachment extends ros.Resource implements IPasswordTaskHostAccountAttachment {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: PasswordTaskHostAccountAttachmentProps;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PasswordTaskHostAccountAttachmentProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosPasswordTaskHostAccountAttachment = new RosPasswordTaskHostAccountAttachment(this, id,  {
            taskId: props.taskId,
            instanceId: props.instanceId,
            hostAccountIds: props.hostAccountIds,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosPasswordTaskHostAccountAttachment;
    }
}
