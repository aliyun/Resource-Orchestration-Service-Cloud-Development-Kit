 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-servicecatalog-productversion
 */
export class ProductVersion extends ros.Resource implements IProductVersion {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ProductVersionProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute Active: Specifies whether the product version is active.
     */
    public readonly attrActive: ros.IResolvable | string;
     ...
     * Attribute Guidance: The recommendation information.
     */
    public readonly attrGuidance: ros.IResolvable | string;
     ...
     * Attribute ProductVersionId: The ID of the product version.
     */
    public readonly attrProductVersionId: ros.IResolvable | string;

    /**
     * Attribute ProductVersionName: The name of the product version.
     */
    public readonly attrProductVersionName: ros.IResolvable | string;
     ...
     * Attribute TemplateUrl: The URL of the template.
     */
    public readonly attrTemplateUrl: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ProductVersionProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosProductVersion = new RosProductVersion(this, id,  {
        ...
        this.resource = rosProductVersion;
        this.attrActive = rosProductVersion.attrActive;
        this.attrCreateTime = rosProductVersion.attrCreateTime;
        this.attrDescription = rosProductVersion.attrDescription;
        this.attrGuidance = rosProductVersion.attrGuidance;
        this.attrProductId = rosProductVersion.attrProductId;
        this.attrProductVersionId = rosProductVersion.attrProductVersionId;
        this.attrProductVersionName = rosProductVersion.attrProductVersionName;
        this.attrTemplateType = rosProductVersion.attrTemplateType;
        this.attrTemplateUrl = rosProductVersion.attrTemplateUrl;
    }
}
