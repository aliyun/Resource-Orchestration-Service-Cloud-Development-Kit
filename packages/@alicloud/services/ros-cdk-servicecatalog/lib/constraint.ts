 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-servicecatalog-constraint
 */
export class Constraint extends ros.Resource implements IConstraint {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: ConstraintProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ConstraintId: The ID of the constraint.
     */
    public readonly attrConstraintId: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ConstraintProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosConstraint = new RosConstraint(this, id,  {
        ...
        this.resource = rosConstraint;
        this.attrConstraintId = rosConstraint.attrConstraintId;
    }
}
