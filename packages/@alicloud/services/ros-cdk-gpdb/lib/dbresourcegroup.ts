 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-dbresourcegroup
 */
export class DBResourceGroup extends ros.Resource implements IDBResourceGroup {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: DBResourceGroupProps;
    protected enableResourcePropertyConstraint: boolean;

    /**
     * Attribute ResourceGroupConfig: Resource group configuration.
     */
    public readonly attrResourceGroupConfig: ros.IResolvable | string;

    /**
     * Attribute ResourceGroupName: Resource group name.
     */
    public readonly attrResourceGroupName: ros.IResolvable | string;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DBResourceGroupProps, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosDBResourceGroup = new RosDBResourceGroup(this, id,  {
            resourceGroupConfig: props.resourceGroupConfig,
            dbInstanceId: props.dbInstanceId,
            resourceGroupName: props.resourceGroupName,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosDBResourceGroup;
        this.attrResourceGroupConfig = rosDBResourceGroup.attrResourceGroupConfig;
        this.attrResourceGroupName = rosDBResourceGroup.attrResourceGroupName;
    }
}
