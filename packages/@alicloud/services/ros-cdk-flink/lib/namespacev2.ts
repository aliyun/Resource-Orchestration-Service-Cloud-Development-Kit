 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-flink-namespacev2
 */
export class NamespaceV2 extends ros.Resource implements INamespaceV2 {
    protected scope: ros.Construct;
    protected id: string;
    public readonly props: NamespaceV2Props;
     ...
     */
    constructor(scope: ros.Construct, id: string, props: NamespaceV2Props, enableResourcePropertyConstraint:boolean = true) {
        super(scope, id);
        this.scope = scope;
        this.id = id;
        this.props = props;
        ...
        const rosNamespaceV2 = new RosNamespaceV2(this, id,  {
            instanceId: props.instanceId,
            resourceSpec: props.resourceSpec,
            namespace: props.namespace,
        }, enableResourcePropertyConstraint && this.stack.enableResourcePropertyConstraint);
        this.resource = rosNamespaceV2;
        this.attrInstanceId = rosNamespaceV2.attrInstanceId;
        this.attrNamespace = rosNamespaceV2.attrNamespace;
    }
}
