...
- Fixed ROCKETMQ5::Acl output attribute spelling error.
- Removed SAS package.

## [ros-cdk-cli 1.12.0] (2026-04-03)
### Features
- Update ROS resource sdk packages(Added the ALIYUN::ACS::ApplicationPod、ALIYUN::ACTIONTRAIL::AdvancedQueryTemplate、ALIYUN::ACTIONTRAIL::HistoryDeliveryJob、ALIYUN::ADB::BackupPolicy、ALIYUN::ALB::AccessLogEnable、ALIYUN::ALB::StartZone、ALIYUN::ALB::ZoneShift、ALIYUN::APIG::Source、ALIYUN::ApiGateway::AccessControl、ALIYUN::ARMS::EnvCustomJob、ALIYUN::ARMS::EnvPodMonitor、ALIYUN::ARMS::EnvServiceMonitor、ALIYUN::ARMS::Rum、ALIYUN::BastionHost::ExportConfigJob、ALIYUN::BastionHost::HostAccount、ALIYUN::BastionHost::HostAccountUserGroupAttachment、ALIYUN::BastionHost::PasswordTask、ALIYUN::BastionHost::PasswordTaskHostAccountAttachment、ALIYUN::BastionHost::UserGroup、ALIYUN::CDDC::DedicatedHostAccount、ALIYUN::CDN::DeliverTask、ALIYUN::CDN::FcTrigger、ALIYUN::CDN::StagingConfig、ALIYUN::CDN::SubTask、ALIYUN::CEN::InterRegionTrafficQosPolicy、ALIYUN::CEN::InterRegionTrafficQosQueue、ALIYUN::CEN::TransitRouterCidr、ALIYUN::CEN::TransitRouterGrantAttachment、ALIYUN::CEN::TransitRouterMulticastDomainAssociation、ALIYUN::ClickHouse::EnterpriseDBCluster、ALIYUN::ClickHouse::EnterpriseDBClusterAccount、ALIYUN::ClickHouse::EnterpriseDBClusterBackupPolicy、ALIYUN::ClickHouse::EnterpriseDBClusterSecurityIP、ALIYUN::CloudStorageGateway::ExpressSync、ALIYUN::CloudStorageGateway::Gateway、ALIYUN::CloudStorageGateway::GatewayLogging、ALIYUN::CR::ArtifactLifecycleRule、ALIYUN::CR::RepoSyncRule、ALIYUN::CR::ScanRule、ALIYUN::CR::StorageDomainRoutingRule、ALIYUN::DataWorks::Route、ALIYUN::DNS::AccessStrategy、ALIYUN::DNS::AddressPool、ALIYUN::DNS::CacheDomain、ALIYUN::DNS::CustomLine、ALIYUN::DNS::DomainAttachment、ALIYUN::DNS::MonitorConfig、ALIYUN::DNS::RecoveryPlan、ALIYUN::DTS::ConsumerChannel、ALIYUN::ECS::CloneDisks、ALIYUN::ECS::DedicatedHostCluster、ALIYUN::ECS::LaunchTemplateVersion、ALIYUN::EDAS::SwimmingLane、ALIYUN::EDAS::SwimmingLaneGroup、ALIYUN::ESA::CacheRule、ALIYUN::ESA::CustomResponseCodeRule、ALIYUN::ESA::HttpIncomingRequestHeaderModificationRule、ALIYUN::ESA::HttpIncomingResponseHeaderModificationRule、ALIYUN::ESA::OriginCaCertificate、ALIYUN::ESA::OriginClientCertificate、ALIYUN::ESA::OriginProtection、ALIYUN::ESA::RewriteUrlRule、ALIYUN::ESA::RoutineRoute、ALIYUN::ESA::ScheduledPreloadExecution、ALIYUN::ESA::SiteOriginClientCertificate、ALIYUN::ESA::UrlObservation、ALIYUN::ESA::VideoProcessing、ALIYUN::ESA::WafRule、ALIYUN::ESA::WaitingRoomEvent、ALIYUN::ESA::WaitingRoomRule、ALIYUN::FC3::FunctionVersion、ALIYUN::FC3::LayerVersion、ALIYUN::FC3::VpcBinding、ALIYUN::GPDB::Database、ALIYUN::GPDB::DBInstanceIPArray、ALIYUN::GPDB::ExternalDataService、ALIYUN::GPDB::JdbcDataSource、ALIYUN::GPDB::StreamingDataService、ALIYUN::HBR::CrossAccount、ALIYUN::HBR::EcsBackupPlan、ALIYUN::HBR::NasBackupPlan、ALIYUN::HBR::OssBackupPlan、ALIYUN::HBR::OtsBackupPlan、ALIYUN::HBR::Policy、ALIYUN::HBR::ReplicationVault、ALIYUN::HDR::SitePair、ALIYUN::MONGODB::AuditPolicy、ALIYUN::MONGODB::PrivateSrvNetworkAddress、ALIYUN::MONGODB::ShardingNetworkPrivateAddress、ALIYUN::MONGODB::ShardingNetworkPublicAddress、ALIYUN::MPS::TranscodeJob、ALIYUN::MSE::Znode、ALIYUN::OOS::ApplicationConnection、ALIYUN::OOS::ApplicationConnectionBind、ALIYUN::OSS::BucketAccessMonitor、ALIYUN::OSS::BucketCnameToken、ALIYUN::OSS::BucketLogging、ALIYUN::OSS::BucketOverwriteConfig、ALIYUN::OSS::BucketPublicAccessBlock、ALIYUN::OSS::BucketStyle、ALIYUN::OSS::BucketWorm、ALIYUN::PAI::Image、ALIYUN::PAI::Member、ALIYUN::PAI::ModelVersion、ALIYUN::PAI::UserConfig、ALIYUN::PAI::WorkspaceResource、ALIYUN::POLARDB::Application、ALIYUN::POLARDB::ApplicationEndpointAddress、ALIYUN::ResourceManager::DelegatedAdministrator、ALIYUN::ResourceManager::DeliveryChannel、ALIYUN::ResourceManager::MessageContact、ALIYUN::ResourceManager::MultiAccountDeliveryChannel、ALIYUN::ResourceManager::Role、ALIYUN::ResourceManager::SavedQuery、ALIYUN::ResourceManager::SharedTarget、ALIYUN::ROCKETMQ5::Acl、ALIYUN::SAE::NlbBinding、ALIYUN::SchedulerX::AppGroup、ALIYUN::SchedulerX::Job、ALIYUN::SchedulerX::Namespace、ALIYUN::ServiceCatalog::Constraint、ALIYUN::ServiceCatalog::ProductPortfolioAssociation、ALIYUN::ServiceCatalog::ProductVersion、ALIYUN::SLB::CaCertificate、ALIYUN::SWAS::RunCommand、ALIYUN::ThreatDetection::AttackPathSensitiveAssetConfig、ALIYUN::ThreatDetection::AttackPathWhitelist、ALIYUN::ThreatDetection::BaselineStrategy、ALIYUN::ThreatDetection::ClientFileProtect、ALIYUN::ThreatDetection::ContainerDefenseRule、ALIYUN::ThreatDetection::CustomCheckItem、ALIYUN::ThreatDetection::CustomCheckStandardPolicy、ALIYUN::ThreatDetection::CycleTask、ALIYUN::ThreatDetection::Group、ALIYUN::ThreatDetection::HoneyPot、ALIYUN::ThreatDetection::HoneypotNode、ALIYUN::ThreatDetection::HoneypotPreset、ALIYUN::ThreatDetection::HoneypotProbe、ALIYUN::ThreatDetection::ImageEventOperation、ALIYUN::ThreatDetection::VulWhitelist、ALIYUN::ThreatDetection::WebLockConfig、ALIYUN::VPC::IpamPool、ALIYUN::VPC::IpamResourceDiscovery、ALIYUN::VPC::Ipv6EgressRule、ALIYUN::VPC::RouteTableAttachment、ALIYUN::VPC::TrafficQos、ALIYUN::VPC::TrafficQosQueue、ALIYUN::VPC::TrafficQosRule、DATASOURCE::ARMS::Environment、DATASOURCE::ARMS::Environments、DATASOURCE::CEN::TransitRouterAttachments、DATASOURCE::CEN::TransitRouterPeerAttachments、DATASOURCE::ClickHouse::EnterpriseDBCluster、DATASOURCE::ClickHouse::EnterpriseDBClusters、DATASOURCE::SWAS::Instance、DATASOURCE::SWAS::Instances)

### Bug Fixes

- Fixed asset manifest destination key using resolved account/region values instead of placeholders during synth, causing mismatch with CLI deploy expectations.
- Fixed CDK Java release issue (pom update).
