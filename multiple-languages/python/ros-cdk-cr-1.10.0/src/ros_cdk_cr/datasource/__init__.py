...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cr.datasource.IInstance")
...
class _IInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cr.datasource.IInstance"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cr.datasource.IInstances")
...
class _IInstancesProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cr.datasource.IInstances"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cr.datasource.INamespaces")
...
class _INamespacesProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cr.datasource.INamespaces"
    ...
    def attr_namespace_names(
        ...
        '''Attribute NamespaceNames: The list of namespace names.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNamespaceNames"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cr.datasource.IRepositories")
class IRepositories(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "RepositoriesProps":
        ...


class _IRepositoriesProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``Repositories``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cr.datasource.IRepositories"
    ...
    def attr_repos(
        ...
        '''Attribute Repos: The list of repositories.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRepos"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IRepositories).__jsii_proxy_class__ = lambda : _IRepositoriesProxy
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"refresh_options": "refreshOptions", "status": "status"},
)
...
class RosInstance(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5aa35f978516c9429eccdd23ffdf4e4ac92b6a64492b9ddcc3f2f20951f83adf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosInstances(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__add97c8a71c8ccd00b6019c7cb9dae52af0b36c5fa0fad7d3cf6fa61d662852d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
class RosNamespaces(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0cce0ad3e2b4616e079004976316d36bcd5e47df8f8a1172f68029c19beada20)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
class RosRepositories(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3eadf03bf7d3adec21b9bc8ff5a2bafa76936b3c80e16ae23436c1282699b503)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
def _typecheckingstub__5aa35f978516c9429eccdd23ffdf4e4ac92b6a64492b9ddcc3f2f20951f83adf(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__add97c8a71c8ccd00b6019c7cb9dae52af0b36c5fa0fad7d3cf6fa61d662852d(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0cce0ad3e2b4616e079004976316d36bcd5e47df8f8a1172f68029c19beada20(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3eadf03bf7d3adec21b9bc8ff5a2bafa76936b3c80e16ae23436c1282699b503(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
