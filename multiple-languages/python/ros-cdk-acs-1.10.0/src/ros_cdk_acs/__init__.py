...
@jsii.interface(jsii_type="@alicloud/ros-cdk-acs.IVirtualCapacityReservation")
class IVirtualCapacityReservation(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "VirtualCapacityReservationProps":
        ...


class _IVirtualCapacityReservationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``VirtualCapacityReservation``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-acs.IVirtualCapacityReservation"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "VirtualCapacityReservationProps":
        return typing.cast("VirtualCapacityReservationProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IVirtualCapacityReservation).__jsii_proxy_class__ = lambda : _IVirtualCapacityReservationProxy
...
class RosVirtualCapacityReservation(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-acs.RosVirtualCapacityReservation",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::ACS::VirtualCapacityReservation``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``VirtualCapacityReservation`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosVirtualCapacityReservationProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5982a78e33e5176f117d077ed3a4bac0556c3f20431bfe47987867a1d2df514e)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad162373c20967497f8ca1cf245f06ce1b16120d63495d9ec95f53d5bc0d98b2)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__40b7f3444d73b843faa7aa3c54f9a2b9d3b907838a8a7fdbb02f84f20877f4eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def pod_postpaid_spec(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosVirtualCapacityReservation.PodPostpaidSpecProperty"]]:
        '''
        :Property: podPostpaidSpec: Postpaid pod spec for inquiry.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosVirtualCapacityReservation.PodPostpaidSpecProperty"]], jsii.get(self, "podPostpaidSpec"))

    @pod_postpaid_spec.setter
    def pod_postpaid_spec(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosVirtualCapacityReservation.PodPostpaidSpecProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__151b96f39ebc515ff6abf1498e83a49c90c4f90ba43367205a57414ead32e05f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "podPostpaidSpec", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-acs.RosVirtualCapacityReservation.GpuQuantityConfigsProperty",
        jsii_struct_bases=[],
        name_mapping={
            "arch": "arch",
            "compute_qos": "computeQos",
    ...
    class GpuQuantityConfigsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__5073b1949fb204487669b3f98feea27d3577b6d1018a84fcc5b89856212a4007)
                check_type(argname="argument arch", value=arch, expected_type=type_hints["arch"])
                check_type(argname="argument compute_qos", value=compute_qos, expected_type=type_hints["compute_qos"])
                check_type(argname="argument gpu_model", value=gpu_model, expected_type=type_hints["gpu_model"])
                check_type(argname="argument gpu_quantity", value=gpu_quantity, expected_type=type_hints["gpu_quantity"])
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-acs.RosVirtualCapacityReservation.PodPostpaidSpecProperty",
        jsii_struct_bases=[],
        name_mapping={
            "cpu_core": "cpuCore",
            "gpu_quantity_configs": "gpuQuantityConfigs",
    ...
    class PodPostpaidSpecProperty:
        def __init__(
            ...
            *,
            cpu_core: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            gpu_quantity_configs: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosVirtualCapacityReservation.GpuQuantityConfigsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
            mem_gib: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            replicas: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__935a329f8ece942a616ee8cdb5fe6a09b37b83fc8ac64ba69c0e4a9594ec88f0)
                check_type(argname="argument cpu_core", value=cpu_core, expected_type=type_hints["cpu_core"])
                check_type(argname="argument gpu_quantity_configs", value=gpu_quantity_configs, expected_type=type_hints["gpu_quantity_configs"])
                check_type(argname="argument mem_gib", value=mem_gib, expected_type=type_hints["mem_gib"])
                check_type(argname="argument replicas", value=replicas, expected_type=type_hints["replicas"])
        ...
        def gpu_quantity_configs(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosVirtualCapacityReservation.GpuQuantityConfigsProperty"]]:
            '''
            :Property: gpuQuantityConfigs: The GPU spec module.
            '''
            result = self._values.get("gpu_quantity_configs")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosVirtualCapacityReservation.GpuQuantityConfigsProperty"]], result)
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-acs.RosVirtualCapacityReservationProps",
    jsii_struct_bases=[],
    name_mapping={"pod_postpaid_spec": "podPostpaidSpec"},
)
class RosVirtualCapacityReservationProps:
    def __init__(
        self,
        *,
        pod_postpaid_spec: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosVirtualCapacityReservation.PodPostpaidSpecProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__62f2293800d3f5888df69b45d185b6dcf4401c9c8f712a43bc922bbe0b7ed113)
            check_type(argname="argument pod_postpaid_spec", value=pod_postpaid_spec, expected_type=type_hints["pod_postpaid_spec"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if pod_postpaid_spec is not None:
            self._values["pod_postpaid_spec"] = pod_postpaid_spec
    ...
    def pod_postpaid_spec(
        ...
        '''
        result = self._values.get("pod_postpaid_spec")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosVirtualCapacityReservation.PodPostpaidSpecProperty]], result)
    ...
    def __repr__(self) -> str:
        return "RosVirtualCapacityReservationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IVirtualCapacityReservation)
class VirtualCapacityReservation(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-acs.VirtualCapacityReservation",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::ACS::VirtualCapacityReservation``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosVirtualCapacityReservation``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-acs-virtualcapacityreservation
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union["VirtualCapacityReservationProps", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__643c05ed37f4f42a2379205f0290f000ad8377b58144ada5aa9c7c6459668c4c)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__65a6f8658a7bb9d0ca3bf3991b6caa57e0ded58d477306d5842d96904bb2f9a8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__108f0c046ffc30ac2f864ad39486f2a60ded08fa20bf0ff27f83dc2f55911efb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2e6779c557b9e8316b0a9d5c42751c657a44ef0def66c144651ae3215118c7eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-acs.VirtualCapacityReservationProps",
    jsii_struct_bases=[],
    name_mapping={"pod_postpaid_spec": "podPostpaidSpec"},
)
class VirtualCapacityReservationProps:
    def __init__(
        self,
        *,
        pod_postpaid_spec: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosVirtualCapacityReservation.PodPostpaidSpecProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__137abd482cf0c2d8da01f108494564bffe1990de068791232a040a93dde9eaeb)
            check_type(argname="argument pod_postpaid_spec", value=pod_postpaid_spec, expected_type=type_hints["pod_postpaid_spec"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if pod_postpaid_spec is not None:
            self._values["pod_postpaid_spec"] = pod_postpaid_spec
    ...
    def __repr__(self) -> str:
        return "VirtualCapacityReservationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
__all__ = [
    ...
    "RosCluster",
    "RosClusterProps",
    "RosVirtualCapacityReservation",
    "RosVirtualCapacityReservationProps",
    "VirtualCapacityReservation",
    "VirtualCapacityReservationProps",
]
...
def _typecheckingstub__5982a78e33e5176f117d077ed3a4bac0556c3f20431bfe47987867a1d2df514e(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosVirtualCapacityReservationProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__ad162373c20967497f8ca1cf245f06ce1b16120d63495d9ec95f53d5bc0d98b2(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__40b7f3444d73b843faa7aa3c54f9a2b9d3b907838a8a7fdbb02f84f20877f4eb(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__151b96f39ebc515ff6abf1498e83a49c90c4f90ba43367205a57414ead32e05f(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosVirtualCapacityReservation.PodPostpaidSpecProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5073b1949fb204487669b3f98feea27d3577b6d1018a84fcc5b89856212a4007(
    *,
    arch: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    compute_qos: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    gpu_model: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__935a329f8ece942a616ee8cdb5fe6a09b37b83fc8ac64ba69c0e4a9594ec88f0(
    *,
    cpu_core: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    gpu_quantity_configs: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosVirtualCapacityReservation.GpuQuantityConfigsProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
    mem_gib: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__62f2293800d3f5888df69b45d185b6dcf4401c9c8f712a43bc922bbe0b7ed113(
    *,
    pod_postpaid_spec: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosVirtualCapacityReservation.PodPostpaidSpecProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__643c05ed37f4f42a2379205f0290f000ad8377b58144ada5aa9c7c6459668c4c(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[VirtualCapacityReservationProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__65a6f8658a7bb9d0ca3bf3991b6caa57e0ded58d477306d5842d96904bb2f9a8(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__108f0c046ffc30ac2f864ad39486f2a60ded08fa20bf0ff27f83dc2f55911efb(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2e6779c557b9e8316b0a9d5c42751c657a44ef0def66c144651ae3215118c7eb(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__137abd482cf0c2d8da01f108494564bffe1990de068791232a040a93dde9eaeb(
    *,
    pod_postpaid_spec: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosVirtualCapacityReservation.PodPostpaidSpecProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
) -> None:
    """Type checking stubs"""
