...
class RosRule(
    ...
    '''This class is a base encapsulation around the ROS resource type ``DATASOURCE::SLB::Rule``, which is used to query the configuration details of a forwarding rule.
...
class RosZones(
    ...
    def address_type(
        ...
        addressType: The type of network.Valid values:
...
class ZonesProps:
    def __init__(
        ...
        *,
        ...
        :param address_type: Property addressType: The type of network.Valid values: vpc: an internal SLB instance that is deployed in a virtual private cloud (VPC). classic_internet: a public-facing SLB instance. classic_intranet: an internal SLB instance that is deployed in a classic network.
        :param refresh_options: Property refreshOptions: The refresh strategy for the datasource resource when the stack is updated. Valid values: - Never: Never refresh the datasource resource when the stack is updated. - Always: Always refresh the datasource resource when the stack is updated. Default is Never.
        '''
        if __debug__:
