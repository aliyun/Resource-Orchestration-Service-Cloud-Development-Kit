...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.datasource.ITransitRouterAttachments")
class ITransitRouterAttachments(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterAttachmentIds")
    def attr_transit_router_attachment_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterAttachments")
    def attr_transit_router_attachments(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterAttachmentsProps":
        ...


class _ITransitRouterAttachmentsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterAttachments``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.datasource.ITransitRouterAttachments"
    ...
    def attr_transit_router_attachment_ids(
        ...
        '''Attribute TransitRouterAttachmentIds: The list of The TransitRouterAttachment IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterAttachmentIds"))
    ...
    def attr_transit_router_attachments(
        ...
        '''Attribute TransitRouterAttachments: The information about TransitRouterAttachments.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterAttachments"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterAttachmentsProps":
        return typing.cast("TransitRouterAttachmentsProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterAttachments).__jsii_proxy_class__ = lambda : _ITransitRouterAttachmentsProxy


@jsii.interface(
    jsii_type="@alicloud/ros-cdk-cen.datasource.ITransitRouterPeerAttachments"
)
class ITransitRouterPeerAttachments(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterPeerAttachmentIds")
    def attr_transit_router_peer_attachment_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterPeerAttachments")
    def attr_transit_router_peer_attachments(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterPeerAttachmentsProps":
        ...


class _ITransitRouterPeerAttachmentsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterPeerAttachments``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.datasource.ITransitRouterPeerAttachments"
    ...
    def attr_transit_router_peer_attachment_ids(
        ...
        '''Attribute TransitRouterPeerAttachmentIds: The list of The TransitRouterPeerAttachment IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterPeerAttachmentIds"))
    ...
    def attr_transit_router_peer_attachments(
        ...
        '''Attribute TransitRouterPeerAttachments: The information about TransitRouterPeerAttachments.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterPeerAttachments"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterPeerAttachmentsProps":
        return typing.cast("TransitRouterPeerAttachmentsProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterPeerAttachments).__jsii_proxy_class__ = lambda : _ITransitRouterPeerAttachmentsProxy
...
class RosTransitRouterAttachments(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.datasource.RosTransitRouterAttachments",
):
    '''This class is a base encapsulation around the ROS resource type ``DATASOURCE::CEN::TransitRouterAttachments``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``TransitRouterAttachments`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosTransitRouterAttachmentsProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2e944d6c0c16da61852f3bffb88bdf52dc506f29a6d9955c9c936520fa2b624d)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ece98978bb0bbfefb65cea967bba53f2363e54771355cef7ed72c0d14fc42f8a)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterAttachmentIds")
    def attr_transit_router_attachment_ids(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: TransitRouterAttachmentIds: The list of The TransitRouterAttachment IDs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTransitRouterAttachmentIds"))

    @builtins.property
    @jsii.member(jsii_name="attrTransitRouterAttachments")
    def attr_transit_router_attachments(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: TransitRouterAttachments: The information about TransitRouterAttachments.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTransitRouterAttachments"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8d01a1144ec873df8d7b3ece382f4e001e1d2f07d9cbbedd9726bcf1681ff968)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def cen_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6b45bccc4ed7890b16916680a47ff06cc6f2d0720b2886a6c79ae3b6228393ef)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cenId", value)
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a0397a094fab1528ead998cc5a6c61c4076cb0a111b3b50092e301b7827b80b6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
    ...
    def region_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2f428aabdb626da78cfdf36ac1a5de2a707a45eeaf8c0a32453c1fe88328d4e1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def resource_types(
        ...
        resourceTypes: Specify the type of the network instance associated with the connection to be queried. Valid values:
        ...
        ** TR: Transit Router instance, indicating that cross-region connection information will be queried.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], jsii.get(self, "resourceTypes"))
    ...
    def resource_types(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__804e1eadc16e2612fe6b10ef475da29e7dd96cbac33d35aa7acb0a23836d946a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_router_attachment_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__62cdaaf467c88d6fccb11aed3f4fe03240faf51df73004422e5e9486cc480ce9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_router_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25c9dd741aeff7a6970e724363b306c6a6ba02a14607a3e39995043be1cd814b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.datasource.RosTransitRouterAttachmentsProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "refresh_options": "refreshOptions",
...
class RosTransitRouterAttachmentsProps:
    def __init__(
        self,
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a2f7edd47cedb0f829a9d38aba44dcb0fdbe5e323b4e99c7b8deebdfc481cbc4)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument refresh_options", value=refresh_options, expected_type=type_hints["refresh_options"])
    ...
    def __repr__(self) -> str:
        return "RosTransitRouterAttachmentsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosTransitRouterPeerAttachments(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.datasource.RosTransitRouterPeerAttachments",
):
    '''This class is a base encapsulation around the ROS resource type ``DATASOURCE::CEN::TransitRouterPeerAttachments``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``TransitRouterPeerAttachments`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosTransitRouterPeerAttachmentsProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__412b77f23a99ab3a40019dbcd6dfc0b89635acab26e50af64884a00241dd73e2)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3fcf6a62006372f94dd26b5f88c2899f81eb91c25966a960874f52b49eb8fca3)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def attr_transit_router_peer_attachment_ids(
        ...
        :Attribute: TransitRouterPeerAttachmentIds: The list of The TransitRouterPeerAttachment IDs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTransitRouterPeerAttachmentIds"))
    ...
    def attr_transit_router_peer_attachments(
        ...
        :Attribute: TransitRouterPeerAttachments: The information about TransitRouterPeerAttachments.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTransitRouterPeerAttachments"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0f836bf5f0bfc48ee00724bdd44e2bc0464950018a39f11fb0f1be6a7cbf2a86)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def cen_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__41cc1658c6d0a323f914d5f96f50d384470bcede9df2afe9ef706c34c8f2fccb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cenId", value)
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5fb4337890abf2db73b49af7f7c49a62f46e44d6dce76b223bea52924026a08c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
    ...
    def region_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__84f1302efba9e102cc5197076677ebd3034a6eb4c59615899ad9ddd10f8d5d5b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "regionId", value)
    ...
    def tag(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cd19f85a55ac740b31988b101b9bd87273375f582a8ce9d187717004a51500c4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def transit_router_attachment_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9dd6e13acce3b251f60a7957bff5dc08db6789c90f6783c430e4c60215bf1079)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterAttachmentId", value)
    ...
    def transit_router_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4081f85be10d85cc0cd7d16dc021d2f6c631d543bffe101007d324023e40a0ad)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterId", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cen.datasource.RosTransitRouterPeerAttachments.TagProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class TagProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__75549f1467de12540273cb49fc42fae45612ba820be48f8ef423042d047611b6)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "key": key,
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.datasource.RosTransitRouterPeerAttachmentsProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "refresh_options": "refreshOptions",
...
class RosTransitRouterPeerAttachmentsProps:
    def __init__(
        self,
        *,
        cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8151534b5d969e03b0bc0338f52cf090903b05458df81ac94519a5222455fff3)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument refresh_options", value=refresh_options, expected_type=type_hints["refresh_options"])
            check_type(argname="argument region_id", value=region_id, expected_type=type_hints["region_id"])
    ...
    def __repr__(self) -> str:
        return "RosTransitRouterPeerAttachmentsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.implements(ITransitRouterAttachments)
class TransitRouterAttachments(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.datasource.TransitRouterAttachments",
):
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::CEN::TransitRouterAttachments``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterAttachments``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/datasource-cen-transitrouterattachments
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union["TransitRouterAttachmentsProps", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d812925b8b5efd5c16a2bb31836763928efb00d22bae696a2344bb8dcdeb92cc)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9698c3d03d14bb07e7eecd5d2eefd1c5ea692cf155046763c5f4331519c738fa)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__462d5d3f2a8e21e3e401d78aff3c414ea2f43071201b03494e4fa7da4abd7a28)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1229d8f68e100328c582d205fa30bbc5658397525b0e1c691452c95d71517700)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.datasource.TransitRouterAttachmentsProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "refresh_options": "refreshOptions",
...
class TransitRouterAttachmentsProps:
    def __init__(
        self,
        *,
        cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param cen_id: Property cenId: The ID of the CEN instance.
        :param refresh_options: Property refreshOptions: The refresh strategy for the datasource resource when the stack is updated. Valid values: - Never: Never refresh the datasource resource when the stack is updated. - Always: Always refresh the datasource resource when the stack is updated. Default is Never.
        :param region_id: Property regionId: The ID of the region where the transit router is deployed.
        :param resource_types: Property resourceTypes: Specify the type of the network instance associated with the connection to be queried. Valid values: ** VPC: Virtual Private Cloud instance. ** CCN: Cloud Connect Network instance. ** VBR: Virtual Border Router instance. ** TR: Transit Router instance, indicating that cross-region connection information will be queried.
        :param transit_router_attachment_id: Property transitRouterAttachmentId: The ID of the peer connection.
        :param transit_router_id: Property transitRouterId: The ID of the enterprise edition transit router.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ddaf87aa6829ce5f81cfec8ff80a06e7cd47f90077f237e1bed355c1c09eb8e)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument refresh_options", value=refresh_options, expected_type=type_hints["refresh_options"])
            check_type(argname="argument region_id", value=region_id, expected_type=type_hints["region_id"])
            check_type(argname="argument resource_types", value=resource_types, expected_type=type_hints["resource_types"])
    ...
    def __repr__(self) -> str:
        return "TransitRouterAttachmentsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(ITransitRouterPeerAttachments)
class TransitRouterPeerAttachments(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.datasource.TransitRouterPeerAttachments",
):
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::CEN::TransitRouterPeerAttachments``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterPeerAttachments``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/datasource-cen-transitrouterpeerattachments
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union["TransitRouterPeerAttachmentsProps", typing.Dict[builtins.str, typing.Any]]] = None,
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa2648d75e7e5883e4cd74a561cd79a27362f2598ff5cf870bd4fa4b2bd514a6)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__617bca601fbfbf4eb59254d1cd0bd70e860becd8611334ccbcebc1a18b1d6e51)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9a60bbdcd243c0979b8e38dd86076a97bc64fe8376fee4998cd50754d1a91b15)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__355bee15834f70d15dcd9450e0139e36c76155e9486c3d10c14bf1a1ae9ecb5e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.datasource.TransitRouterPeerAttachmentsProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "refresh_options": "refreshOptions",
...
class TransitRouterPeerAttachmentsProps:
    def __init__(
        self,
        *,
        cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d5769614aaf3cd6dc541c897ab6e8ddc4b3bd42b1155de3de38ebcf737fae8c1)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument refresh_options", value=refresh_options, expected_type=type_hints["refresh_options"])
            check_type(argname="argument region_id", value=region_id, expected_type=type_hints["region_id"])
            check_type(argname="argument tag", value=tag, expected_type=type_hints["tag"])
    ...
    def __repr__(self) -> str:
        return "TransitRouterPeerAttachmentsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
__all__ = [
    ...
    "RosTransitRouterAttachments",
    "RosTransitRouterAttachmentsProps",
    "RosTransitRouterPeerAttachments",
    "RosTransitRouterPeerAttachmentsProps",
    "RosTransitRouterRouteTables",
    "RosTransitRouterRouteTablesProps",
    "RosTransitRouters",
    "RosTransitRoutersProps",
    "TransitRouterAttachments",
    "TransitRouterAttachmentsProps",
    "TransitRouterPeerAttachments",
    "TransitRouterPeerAttachmentsProps",
...
def _typecheckingstub__2e944d6c0c16da61852f3bffb88bdf52dc506f29a6d9955c9c936520fa2b624d(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosTransitRouterAttachmentsProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__ece98978bb0bbfefb65cea967bba53f2363e54771355cef7ed72c0d14fc42f8a(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8d01a1144ec873df8d7b3ece382f4e001e1d2f07d9cbbedd9726bcf1681ff968(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6b45bccc4ed7890b16916680a47ff06cc6f2d0720b2886a6c79ae3b6228393ef(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a0397a094fab1528ead998cc5a6c61c4076cb0a111b3b50092e301b7827b80b6(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2f428aabdb626da78cfdf36ac1a5de2a707a45eeaf8c0a32453c1fe88328d4e1(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__804e1eadc16e2612fe6b10ef475da29e7dd96cbac33d35aa7acb0a23836d946a(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__62cdaaf467c88d6fccb11aed3f4fe03240faf51df73004422e5e9486cc480ce9(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__25c9dd741aeff7a6970e724363b306c6a6ba02a14607a3e39995043be1cd814b(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a2f7edd47cedb0f829a9d38aba44dcb0fdbe5e323b4e99c7b8deebdfc481cbc4(
    *,
    cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    region_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__412b77f23a99ab3a40019dbcd6dfc0b89635acab26e50af64884a00241dd73e2(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosTransitRouterPeerAttachmentsProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__3fcf6a62006372f94dd26b5f88c2899f81eb91c25966a960874f52b49eb8fca3(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0f836bf5f0bfc48ee00724bdd44e2bc0464950018a39f11fb0f1be6a7cbf2a86(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__41cc1658c6d0a323f914d5f96f50d384470bcede9df2afe9ef706c34c8f2fccb(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5fb4337890abf2db73b49af7f7c49a62f46e44d6dce76b223bea52924026a08c(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__84f1302efba9e102cc5197076677ebd3034a6eb4c59615899ad9ddd10f8d5d5b(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cd19f85a55ac740b31988b101b9bd87273375f582a8ce9d187717004a51500c4(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, _ros_cdk_core_7adfd82f.RosTag]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9dd6e13acce3b251f60a7957bff5dc08db6789c90f6783c430e4c60215bf1079(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4081f85be10d85cc0cd7d16dc021d2f6c631d543bffe101007d324023e40a0ad(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__75549f1467de12540273cb49fc42fae45612ba820be48f8ef423042d047611b6(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__8151534b5d969e03b0bc0338f52cf090903b05458df81ac94519a5222455fff3(
    *,
    cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    region_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__d812925b8b5efd5c16a2bb31836763928efb00d22bae696a2344bb8dcdeb92cc(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[TransitRouterAttachmentsProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__9698c3d03d14bb07e7eecd5d2eefd1c5ea692cf155046763c5f4331519c738fa(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__462d5d3f2a8e21e3e401d78aff3c414ea2f43071201b03494e4fa7da4abd7a28(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1229d8f68e100328c582d205fa30bbc5658397525b0e1c691452c95d71517700(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0ddaf87aa6829ce5f81cfec8ff80a06e7cd47f90077f237e1bed355c1c09eb8e(
    *,
    cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    region_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__aa2648d75e7e5883e4cd74a561cd79a27362f2598ff5cf870bd4fa4b2bd514a6(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[TransitRouterPeerAttachmentsProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__617bca601fbfbf4eb59254d1cd0bd70e860becd8611334ccbcebc1a18b1d6e51(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9a60bbdcd243c0979b8e38dd86076a97bc64fe8376fee4998cd50754d1a91b15(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__355bee15834f70d15dcd9450e0139e36c76155e9486c3d10c14bf1a1ae9ecb5e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d5769614aaf3cd6dc541c897ab6e8ddc4b3bd42b1155de3de38ebcf737fae8c1(
    *,
    cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    region_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
