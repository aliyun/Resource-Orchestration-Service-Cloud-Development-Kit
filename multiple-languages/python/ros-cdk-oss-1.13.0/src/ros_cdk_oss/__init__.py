...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketAccessMonitorProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket"},
)
class BucketAccessMonitorProps:
    def __init__(
        self,
        *,
        ...
        :param bucket: Property bucket: The name of the bucket.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__24cc9587e004a9dd40e6e4aa44fa346c716348bd29565be6fc58794e27c05a49)
    ...
    def __repr__(self) -> str:
        return "BucketAccessMonitorProps(%s)" % ", ".join(
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketCnameTokenProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket", "domain": "domain"},
)
class BucketCnameTokenProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param bucket: Property bucket: The name of the bucket.
        :param domain: Property domain: The custom domain.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ef47cb0eeadf34d9ff4ddce8bb31b2e39b21ca6813462dd569042071a28c437)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
    ...
    def __repr__(self) -> str:
        return "BucketCnameTokenProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketLoggingProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
...
class BucketLoggingProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        target_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        logging_role: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param bucket: Property bucket: The name of the bucket.
        :param target_bucket: Property targetBucket: The bucket that stores access logs.
        :param logging_role: Property loggingRole: Authorization role used for bucket logging.
        :param target_prefix: Property targetPrefix: The prefix of the saved log objects. This element can be left empty.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d86d65f87c5aa0046ac448dbbff74cdad08c1a21ff23f65afc8de2822282aa6c)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
    ...
    def __repr__(self) -> str:
        return "BucketLoggingProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketOverwriteConfigProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket", "rule": "rule"},
)
class BucketOverwriteConfigProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        rule: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketOverwriteConfig.RuleProperty", typing.Dict[builtins.str, typing.Any]]]]]] = None,
    ) -> None:
        ...
        :param bucket: Property bucket: The name of the bucket.
        :param rule: Property rule: Forbid overwrite rule.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6c1a0638b8c3cefe2ff6de16566ad24ea9263c6ca44241a9c7820e9c16d4731b)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
    ...
    def rule(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.RuleProperty"]]]]:
        '''Property rule: Forbid overwrite rule.'''
        result = self._values.get("rule")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.RuleProperty"]]]], result)
    ...
    def __repr__(self) -> str:
        return "BucketOverwriteConfigProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class BucketProps:
    def __init__(
        ...
        *,
        ...
        block_public_access: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param block_public_access: Property blockPublicAccess: Whether to block public access.
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketPublicAccessBlockProps",
    jsii_struct_bases=[],
    name_mapping={"block_public_access": "blockPublicAccess", "bucket": "bucket"},
)
class BucketPublicAccessBlockProps:
    def __init__(
        self,
        *,
        block_public_access: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        ...
        :param block_public_access: Property blockPublicAccess: Whether AlibabaCloud OSS should block public bucket policies and ACL for this bucket.
        :param bucket: Property bucket: The name of the bucket.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2f7affef40bb2985f4e6f11bfe7237cbd885a902ac5c1b68772c0ef79390a102)
            check_type(argname="argument block_public_access", value=block_public_access, expected_type=type_hints["block_public_access"])
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    def block_public_access(
        ...
        result = self._values.get("block_public_access")
        assert result is not None, "Required property 'block_public_access' is missing"
    ...
    def __repr__(self) -> str:
        return "BucketPublicAccessBlockProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketReplicationProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket_name": "bucketName",
...
class BucketReplicationProps:
    def __init__(
        ...
        *,
        bucket_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        replication_configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.ReplicationConfigurationProperty", typing.Dict[builtins.str, typing.Any]]],
    ) -> None:
        ...
        :param bucket_name: Property bucketName: Bucket name.
        :param replication_configuration: Property replicationConfiguration: Replication configuration.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f8cfbd34341f1ab76eda2b858f6e695507efe543778ead827c961f6d60e123da)
            check_type(argname="argument bucket_name", value=bucket_name, expected_type=type_hints["bucket_name"])
    ...
    def replication_configuration(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.ReplicationConfigurationProperty"]:
        ...
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.ReplicationConfigurationProperty"], result)
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketStyleProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
        "content": "content",
...
class BucketStyleProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        content: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        style_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param bucket: Property bucket: Storage space to which the picture style belongs.
        :param content: Property content: The Image style content can contain single or multiple image processing parameters.
        :param style_name: Property styleName: Image Style Name.
        :param category: Property category: Style category, valid values: image, document, video.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c2d9cc8dc7af8631508a66600cc72800528896ed4408ab1af56bc77e99f9ee17)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
            check_type(argname="argument style_name", value=style_name, expected_type=type_hints["style_name"])
    ...
    def style_name(
        ...
        result = self._values.get("style_name")
        assert result is not None, "Required property 'style_name' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def __repr__(self) -> str:
        return "BucketStyleProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.BucketWormProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
...
class BucketWormProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        retention_period_in_days: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        ...
        :param bucket: Property bucket: The name of the bucket.
        :param retention_period_in_days: Property retentionPeriodInDays: The specified number of days to retain the Object.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__94d9f456f6c136c3b66049f0f2d0f513855b6513f5a286260139fce0f43d70e6)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketAccessMonitor")
class IBucketAccessMonitor(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketAccessMonitorProps:
        ...


class _IBucketAccessMonitorProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketAccessMonitor``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketAccessMonitor"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketAccessMonitorProps:
        return typing.cast(BucketAccessMonitorProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketAccessMonitor).__jsii_proxy_class__ = lambda : _IBucketAccessMonitorProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketCnameToken")
class IBucketCnameToken(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``BucketCnameToken``.'''

    @builtins.property
    @jsii.member(jsii_name="attrBucket")
    def attr_bucket(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketCnameTokenProps:
        ...


class _IBucketCnameTokenProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketCnameToken``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketCnameToken"
    ...
    def attr_bucket(
        ...
        '''Attribute Bucket: The name of the bucket.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrBucket"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> BucketCnameTokenProps:
        return typing.cast(BucketCnameTokenProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketCnameToken).__jsii_proxy_class__ = lambda : _IBucketCnameTokenProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketLogging")
class IBucketLogging(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``BucketLogging``.'''

    @builtins.property
    @jsii.member(jsii_name="attrLoggingRole")
    def attr_logging_role(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTargetBucket")
    def attr_target_bucket(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrTargetPrefix")
    def attr_target_prefix(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketLoggingProps:
        ...


class _IBucketLoggingProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketLogging``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketLogging"
    ...
    def attr_logging_role(
        ...
        '''Attribute LoggingRole: Authorization role used for bucket logging.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLoggingRole"))
    ...
    def attr_target_bucket(
        ...
        '''Attribute TargetBucket: The bucket that stores access logs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTargetBucket"))
    ...
    def attr_target_prefix(
        ...
        This element can be left empty.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTargetPrefix"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketLoggingProps:
        return typing.cast(BucketLoggingProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketLogging).__jsii_proxy_class__ = lambda : _IBucketLoggingProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketOverwriteConfig")
class IBucketOverwriteConfig(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketOverwriteConfigProps:
        ...


class _IBucketOverwriteConfigProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketOverwriteConfig``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketOverwriteConfig"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> BucketOverwriteConfigProps:
        return typing.cast(BucketOverwriteConfigProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketOverwriteConfig).__jsii_proxy_class__ = lambda : _IBucketOverwriteConfigProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketPublicAccessBlock")
class IBucketPublicAccessBlock(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrBlockPublicAccess")
    def attr_block_public_access(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketPublicAccessBlockProps:
        ...


class _IBucketPublicAccessBlockProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketPublicAccessBlock``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketPublicAccessBlock"
    ...
    def attr_block_public_access(
        ...
        '''Attribute BlockPublicAccess: Whether AlibabaCloud OSS should block public bucket policies and ACL for this bucket.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrBlockPublicAccess"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketPublicAccessBlockProps:
        return typing.cast(BucketPublicAccessBlockProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketPublicAccessBlock).__jsii_proxy_class__ = lambda : _IBucketPublicAccessBlockProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketReplication")
class IBucketReplication(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``BucketReplication``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketReplicationProps:
        ...


class _IBucketReplicationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketReplication``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketReplication"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketReplicationProps:
        return typing.cast(BucketReplicationProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketReplication).__jsii_proxy_class__ = lambda : _IBucketReplicationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketStyle")
class IBucketStyle(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrStyleName")
    def attr_style_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketStyleProps:
        ...


class _IBucketStyleProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketStyle``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketStyle"
    ...
    def attr_style_name(
        ...
        '''Attribute StyleName: Image Style Name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrStyleName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketStyleProps:
        return typing.cast(BucketStyleProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketStyle).__jsii_proxy_class__ = lambda : _IBucketStyleProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oss.IBucketWorm")
class IBucketWorm(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrExpirationDate")
    def attr_expiration_date(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrRetentionPeriodInDays")
    def attr_retention_period_in_days(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrWormId")
    def attr_worm_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketWormProps:
        ...


class _IBucketWormProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``BucketWorm``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oss.IBucketWorm"
    ...
    def attr_expiration_date(
        ...
        '''Attribute ExpirationDate: Retention Policy Expiration Time.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrExpirationDate"))
    ...
    def attr_retention_period_in_days(
        ...
        '''Attribute RetentionPeriodInDays: The specified number of days to retain the Object.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRetentionPeriodInDays"))
    ...
    def attr_worm_id(
        ...
        '''Attribute WormId: The ID of the retention policy.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrWormId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> BucketWormProps:
        return typing.cast(BucketWormProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IBucketWorm).__jsii_proxy_class__ = lambda : _IBucketWormProxy
...
class RosBucket(
    ...
    @builtins.property
    @jsii.member(jsii_name="blockPublicAccess")
    def block_public_access(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: blockPublicAccess: Whether to block public access.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "blockPublicAccess"))
    ...
    def block_public_access(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6fb685c7cfcc09883f1ce12f7236283bafd7aa96fc318eae4fa9367c5c4fa7cc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "blockPublicAccess", value)
    ...
    class RuleProperty:
        def __init__(
            ...
            *,
            ...
            transition: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucket.TransitionProperty", typing.Dict[builtins.str, typing.Any]]]]]] = None,
        ) -> None:
            '''
            :param prefix: 
        ...
        def transition(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucket.TransitionProperty"]]]]:
            '''
            :Property:

            transition: The change of the storage class of objects that match the lifecycle rule when the objects expire.
            In the child properties, you can only choose one between Days and CreatedBeforeDate.
            '''
            result = self._values.get("transition")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucket.TransitionProperty"]]]], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucket.TransitionProperty",
        jsii_struct_bases=[],
        name_mapping={
            "allow_small_file": "allowSmallFile",
            "created_before_date": "createdBeforeDate",
            "days": "days",
            "is_access_time": "isAccessTime",
            "return_to_std_when_visit": "returnToStdWhenVisit",
            "storage_class": "storageClass",
        },
    )
    class TransitionProperty:
        def __init__(
            self,
            *,
            allow_small_file: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            created_before_date: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            days: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            is_access_time: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            return_to_std_when_visit: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            storage_class: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            :param allow_small_file: 
            :param created_before_date: 
            :param days: 
            :param is_access_time: 
            :param return_to_std_when_visit: 
            :param storage_class: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__6710c0e27031ec8d1adb3898b7c4ca39f6322cab20ecb5f4e579ba017a8a7cdb)
                check_type(argname="argument allow_small_file", value=allow_small_file, expected_type=type_hints["allow_small_file"])
                check_type(argname="argument created_before_date", value=created_before_date, expected_type=type_hints["created_before_date"])
                check_type(argname="argument days", value=days, expected_type=type_hints["days"])
                check_type(argname="argument is_access_time", value=is_access_time, expected_type=type_hints["is_access_time"])
                check_type(argname="argument return_to_std_when_visit", value=return_to_std_when_visit, expected_type=type_hints["return_to_std_when_visit"])
                check_type(argname="argument storage_class", value=storage_class, expected_type=type_hints["storage_class"])
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if allow_small_file is not None:
                self._values["allow_small_file"] = allow_small_file
            if created_before_date is not None:
                self._values["created_before_date"] = created_before_date
            if days is not None:
                self._values["days"] = days
            if is_access_time is not None:
                self._values["is_access_time"] = is_access_time
            if return_to_std_when_visit is not None:
                self._values["return_to_std_when_visit"] = return_to_std_when_visit
            if storage_class is not None:
                self._values["storage_class"] = storage_class

        @builtins.property
        def allow_small_file(
            self,
        ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
            '''
            ...
            '''
            result = self._values.get("allow_small_file")
            return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
        ...
        def created_before_date(
            ...
            createdBeforeDate: Specify a date; OSS will apply lifecycle rules to data whose last modification time is earlier than this date. The date must conform to the ISO8601 format and must be at midnight UTC.
        ...
        def is_access_time(
            ...
            '''
            result = self._values.get("is_access_time")
            return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)

        @builtins.property
        def return_to_std_when_visit(
            self,
        ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
            '''
            ...
            '''
            result = self._values.get("return_to_std_when_visit")
            return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
...
class RosBucketAccessMonitor(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketAccessMonitor",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketAccessMonitor``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketAccessMonitor`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketaccessmonitor
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketAccessMonitorProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a04543a02bb27c9e947f909d07b156d72c4047d10863d0dbd2f33939392cbf71)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__652cdf97538adaf4e3d761542603494813e7f7bde8b21444baecbf7ff1654f91)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c35c7a4150eb7f455f8ea0b809561bc0058408acd4e60fe0c395a6cf219e998f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4fbdf1ef59210a582f1e0716b229a663dc6b63dafd73cf4587544473a7d4322b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketAccessMonitorProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket"},
)
class RosBucketAccessMonitorProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__348a202cfe84d3f6e03ed5031c1b232fa9265c2c93085ea84913471ed1cc2eb4)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "bucket": bucket,
        }
    ...
    def __repr__(self) -> str:
        return "RosBucketAccessMonitorProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosBucketCnameToken(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketCnameToken",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketCnameToken``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketCnameToken`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketcnametoken
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketCnameTokenProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__34b3b817643d0cb364763ada5c2b524075f7b75c2d0ccc4967d9fd127d287cd8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__63ce3923ad4a7429b8443b3494ffc7d209377c8fe0ed82ee57afc7e8f07ba691)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrBucket")
    def attr_bucket(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Bucket: The name of the bucket.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrBucket"))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6ab0319c550638a933400b36288a3b5f7b8d6c1985cca95572391aef96581819)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def domain(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ed2fd898a34c3fd767a9238ada74906fcec5dd9bfa5923b73e21fc4925cf9da)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__70b670fd13e7dc748998ddae98f77be5d57a3fa34e23e65d602ba82be0fc8fa7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketCnameTokenProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket", "domain": "domain"},
)
class RosBucketCnameTokenProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3fa4a1764ab58f5112ae53f00a81d93a285943bac925b4f331f4b469a2c5374f)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument domain", value=domain, expected_type=type_hints["domain"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "bucket": bucket,
    ...
    def __repr__(self) -> str:
        return "RosBucketCnameTokenProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosBucketLogging(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketLogging",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketLogging``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketLogging`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketlogging
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketLoggingProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ec583ec103ea0bab2df9655e5f8282565738c60725767246a4e9f1d1de3ac319)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__43318930f5721431ab45bcc35fde920e04f29641910f75df5efc9f8b6453c4df)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLoggingRole")
    def attr_logging_role(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LoggingRole: Authorization role used for bucket logging.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLoggingRole"))

    @builtins.property
    @jsii.member(jsii_name="attrTargetBucket")
    def attr_target_bucket(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: TargetBucket: The bucket that stores access logs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTargetBucket"))

    @builtins.property
    @jsii.member(jsii_name="attrTargetPrefix")
    def attr_target_prefix(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: TargetPrefix: The prefix of the saved log objects. This element can be left empty.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrTargetPrefix"))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3f53eaf56eb571c09abc7a1d0970a68f0c0f7118659b531e8499a29d9d1a6794)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__50a5e089a0636c32998fd921915961e709993baff0fc6010eba1f0459475ce6e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def target_bucket(
        ...
        :Property: targetBucket: The bucket that stores access logs.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "targetBucket"))
    ...
    def target_bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e63d3d5ec0798d6fed8ea7e6491df9d461b812df428659bb30e36e0a5ac60aa8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def logging_role(
        ...
        :Property: loggingRole: Authorization role used for bucket logging.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "loggingRole"))
    ...
    def logging_role(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c373c7d1023eb797d19b17a2ed722d5b504732ef2157f051ea8f7b2bd1da55bc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def target_prefix(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "targetPrefix"))
    ...
    def target_prefix(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d2c377458bbe3a4a2f774f9f34fa4a0607a787cb11701ee7cf2ba866131757e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "targetPrefix", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketLoggingProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
        "target_bucket": "targetBucket",
...
class RosBucketLoggingProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e2ea134d1a7febfbcff059d71e1b5f1b2c1a024ff4c59318719bae9f53d12ca8)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument target_bucket", value=target_bucket, expected_type=type_hints["target_bucket"])
            check_type(argname="argument logging_role", value=logging_role, expected_type=type_hints["logging_role"])
            check_type(argname="argument target_prefix", value=target_prefix, expected_type=type_hints["target_prefix"])
    ...
    def __repr__(self) -> str:
        return "RosBucketLoggingProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosBucketOverwriteConfig(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketOverwriteConfig",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketOverwriteConfig``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketOverwriteConfig`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketoverwriteconfig
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketOverwriteConfigProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__35cbe5190ac99daa89327e65a232e434079b1ad7d8b5656578049fca8d2edd3b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2fa401c80e0294b9380c46df49d6cc639c53771439f69de396fba6a09759f32d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__128faa444d10a560c729cbd52e9088067d77abbfbf40409f836e888b9b9af13d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__38821023719895943af22c36d46955549f984e227df9ecaae16bd817ed6a0910)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def rule(
        ...
        :Property: rule: Forbid overwrite rule.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.RuleProperty"]]]], jsii.get(self, "rule"))

    @rule.setter
    def rule(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.RuleProperty"]]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__408721dae900b2f47cd8e54a89b573e85ae768c2a9c7f124783437cccdf92aa5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "rule", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketOverwriteConfig.PrincipalsProperty",
        jsii_struct_bases=[],
        name_mapping={"principal": "principal"},
    )
    class PrincipalsProperty:
        def __init__(
            self,
            *,
            principal: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
        ) -> None:
            '''
            :param principal: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__6dd8b277df04563d3f6f3baf2ebc84f2862d3fc4f4e889452d8a5f40045080dc)
        ...
        def __repr__(self) -> str:
            return "PrincipalsProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketOverwriteConfig.RuleProperty",
        jsii_struct_bases=[],
        name_mapping={
            "action": "action",
            "identity": "identity",
    ...
    class RuleProperty:
        def __init__(
            ...
            *,
            ...
            prefix: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            principals: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketOverwriteConfig.PrincipalsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__f2c4dfb4a86b26c7c5dd2fc567158516ea3a58ce50886b04d0936d54b288e452)
        ...
        def principals(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.PrincipalsProperty"]]:
            '''
            ...
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketOverwriteConfig.PrincipalsProperty"]], result)
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketOverwriteConfigProps",
    jsii_struct_bases=[],
    name_mapping={"bucket": "bucket", "rule": "rule"},
)
class RosBucketOverwriteConfigProps:
    def __init__(
        self,
        *,
        bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2fb15d01b58240208c3f9e228fc3fdb288cba9f9b84e361291f09620966810df)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument rule", value=rule, expected_type=type_hints["rule"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "bucket": bucket,
    ...
    def __repr__(self) -> str:
        return "RosBucketOverwriteConfigProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosBucketPublicAccessBlock(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketPublicAccessBlock",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketPublicAccessBlock``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketPublicAccessBlock`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketpublicaccessblock
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketPublicAccessBlockProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6a54cfc54dca70aa96a07b3bc5ef16cd8387def3b880afaa52be4caec2250b9a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a1a5f547e30d9c9f23ea62fe0dd3374d07eb4db54f7f1f4e9b43e0a51cc45268)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrBlockPublicAccess")
    def attr_block_public_access(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: BlockPublicAccess: Whether AlibabaCloud OSS should block public bucket policies and ACL for this bucket.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrBlockPublicAccess"))
    ...
    def block_public_access(
        ...
        :Property: blockPublicAccess: Whether AlibabaCloud OSS should block public bucket policies and ACL for this bucket.
        '''
        return typing.cast(typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "blockPublicAccess"))
    ...
    def block_public_access(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d085420ab310c982e898c7e449ff3f1a54236913b047ca9dd11494f76dc9210e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "blockPublicAccess", value)
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7558ab6714d4c7ed6c16df25aae1f3bb02d243a04288505b0e25be2f94256ba8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1919c21294adb6f74b458d55898e565fc76760301d38e197d8ad6e5794f718f5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketPublicAccessBlockProps",
    jsii_struct_bases=[],
    name_mapping={"block_public_access": "blockPublicAccess", "bucket": "bucket"},
)
class RosBucketPublicAccessBlockProps:
    def __init__(
        self,
        *,
        block_public_access: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7c229159c92e94d793d0b24aac84e6e57d70ac519109dfe12ac187bb642958ce)
            check_type(argname="argument block_public_access", value=block_public_access, expected_type=type_hints["block_public_access"])
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "block_public_access": block_public_access,
    ...
    def __repr__(self) -> str:
        return "RosBucketPublicAccessBlockProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosBucketReplication(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``BucketReplication`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketreplication
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketReplicationProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5d7cab185284a6a0424f15d1b0f2ca1075e9b4e247d5906dd3e378797ce380e1)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4d3d6e7e3e6cc9025c08ae953ca91c94acadeea0a9e4067f61cdacece93273d4)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def bucket_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a705a5123337fe1d006e57eb4f9b4f5623423944dad6c0c6f843ed2984650324)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucketName", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0e7abcf71160f9e81bb14020c3bacfdebf927f89e4f69318249a2099b7598738)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def replication_configuration(
        ...
        :Property: replicationConfiguration: Replication configuration.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.ReplicationConfigurationProperty"], jsii.get(self, "replicationConfiguration"))

    @replication_configuration.setter
    def replication_configuration(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.ReplicationConfigurationProperty"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3c60e6724fb75ea04151108f726e02fab80c792b13cfb33dc8b3561a7975a014)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "replicationConfiguration", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.DestinationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "bucket": "bucket",
            "location": "location",
    ...
    class DestinationProperty:
        def __init__(
            ...
            *,
            ...
            transfer_type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ) -> None:
            '''
            :param bucket: 
            :param location: 
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__af016a6ced21212a6a871f800d44ffc5646a624f30ee8f018b7fe036ede1396e)
                check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
                check_type(argname="argument location", value=location, expected_type=type_hints["location"])
                check_type(argname="argument transfer_type", value=transfer_type, expected_type=type_hints["transfer_type"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "bucket": bucket,
                "location": location,
        ...
        def transfer_type(
            ...
            '''
            result = self._values.get("transfer_type")
            assert result is not None, "Required property 'transfer_type' is missing"
            return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.EncryptionConfigurationProperty",
        jsii_struct_bases=[],
    ...
    class EncryptionConfigurationProperty:
        def __init__(
            self,
            *,
            replica_kms_key_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            :param replica_kms_key_id: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__f99d3a9cb89b22f23c84872211dd0a34e0f5f6812d062c3f25b296863127d9ea)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.RTCProperty",
        jsii_struct_bases=[],
        name_mapping={"status": "status"},
    )
    class RTCProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__5d0b0a1412fb54da27f4d655b8f62433851b5b0262b04a65129d4789c031c520)
                check_type(argname="argument status", value=status, expected_type=type_hints["status"])
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if status is not None:
                self._values["status"] = status
        ...
        def __repr__(self) -> str:
            return "RTCProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.ReplicationConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={"rule": "rule"},
    )
    class ReplicationConfigurationProperty:
        def __init__(
            self,
            *,
            rule: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.RuleProperty", typing.Dict[builtins.str, typing.Any]]],
        ) -> None:
            '''
            :param rule: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__0be2e83c213263d489f132293e5355a6b95886a7743cdb2afc253909386a3ef4)
                check_type(argname="argument rule", value=rule, expected_type=type_hints["rule"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "rule": rule,
            }
        ...
        def rule(
            self,
        ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.RuleProperty"]:
            '''
            :Property: rule: Replication Rule
            '''
            result = self._values.get("rule")
            assert result is not None, "Required property 'rule' is missing"
            return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.RuleProperty"], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.RuleProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class RuleProperty:
        def __init__(
            self,
            *,
            destination: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.DestinationProperty", typing.Dict[builtins.str, typing.Any]]],
            action: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            encryption_configuration: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.EncryptionConfigurationProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
            historical_object_replication: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            identity: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            prefix_set: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
            rtc: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.RTCProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
            source_selection_criteria: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.SourceSelectionCriteriaProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
            sync_role: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            :param destination: 
            :param action: 
            :param encryption_configuration: 
            :param historical_object_replication: 
            :param identity: 
            :param prefix_set: 
            :param rtc: 
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__2ab51677aeea15e562449bb1da55f05a843bae043e3d22543e71d2488bc47784)
                check_type(argname="argument destination", value=destination, expected_type=type_hints["destination"])
                check_type(argname="argument action", value=action, expected_type=type_hints["action"])
                check_type(argname="argument encryption_configuration", value=encryption_configuration, expected_type=type_hints["encryption_configuration"])
                check_type(argname="argument historical_object_replication", value=historical_object_replication, expected_type=type_hints["historical_object_replication"])
                check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
                check_type(argname="argument prefix_set", value=prefix_set, expected_type=type_hints["prefix_set"])
                check_type(argname="argument rtc", value=rtc, expected_type=type_hints["rtc"])
            ...
            if historical_object_replication is not None:
                self._values["historical_object_replication"] = historical_object_replication
            if identity is not None:
                self._values["identity"] = identity
            if prefix_set is not None:
                self._values["prefix_set"] = prefix_set
            if rtc is not None:
                self._values["rtc"] = rtc
        ...
        def destination(
            self,
        ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.DestinationProperty"]:
            '''
            :Property: destination: Destination bucket and location for replication.
            '''
            result = self._values.get("destination")
            assert result is not None, "Required property 'destination' is missing"
            return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.DestinationProperty"], result)
        ...
        def encryption_configuration(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.EncryptionConfigurationProperty"]]:
            '''
            :Property: encryptionConfiguration: undefined
            '''
            result = self._values.get("encryption_configuration")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.EncryptionConfigurationProperty"]], result)

        @builtins.property
        def historical_object_replication(
            self,
        ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
            '''
            :Property: historicalObjectReplication: Whether to replicate existing objects.
            '''
            result = self._values.get("historical_object_replication")
            return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
        ...
        def prefix_set(
            ...
            '''
            result = self._values.get("prefix_set")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], result)

        @builtins.property
        def rtc(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.RTCProperty"]]:
            '''
            :Property: rtc: undefined
            '''
            result = self._values.get("rtc")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.RTCProperty"]], result)

        @builtins.property
        def source_selection_criteria(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.SourceSelectionCriteriaProperty"]]:
            '''
            :Property: sourceSelectionCriteria: Criteria for selecting source objects.
            '''
            result = self._values.get("source_selection_criteria")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.SourceSelectionCriteriaProperty"]], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.SourceSelectionCriteriaProperty",
        jsii_struct_bases=[],
    ...
    class SourceSelectionCriteriaProperty:
        def __init__(
            self,
            *,
            sse_kms_encrypted_objects: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosBucketReplication.SseKmsEncryptedObjectsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        ) -> None:
            '''
            :param sse_kms_encrypted_objects: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__b58598af19d66516b9a507e0f0acc59ede9b89d6268c93f283d0e3a00ee9ffbd)
        ...
        def sse_kms_encrypted_objects(
            self,
        ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.SseKmsEncryptedObjectsProperty"]]:
            '''
            :Property: sseKmsEncryptedObjects: undefined
            '''
            result = self._values.get("sse_kms_encrypted_objects")
            return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosBucketReplication.SseKmsEncryptedObjectsProperty"]], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oss.RosBucketReplication.SseKmsEncryptedObjectsProperty",
        jsii_struct_bases=[],
        name_mapping={"status": "status"},
    )
    class SseKmsEncryptedObjectsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__ea4576ea5e945ca272fbf931fa79984dd6230c5beb91e8445979b613a86d1c75)
                check_type(argname="argument status", value=status, expected_type=type_hints["status"])
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if status is not None:
                self._values["status"] = status
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketReplicationProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket_name": "bucketName",
        "replication_configuration": "replicationConfiguration",
...
class RosBucketReplicationProps:
    def __init__(
        self,
        *,
        bucket_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__81adccd0d1f1f0986d440174c465c2a682334c3043a0721022ffae838b74c990)
            check_type(argname="argument bucket_name", value=bucket_name, expected_type=type_hints["bucket_name"])
            check_type(argname="argument replication_configuration", value=replication_configuration, expected_type=type_hints["replication_configuration"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "bucket_name": bucket_name,
    ...
    def __repr__(self) -> str:
        return "RosBucketReplicationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosBucketStyle(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketStyle",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketStyle``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketStyle`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketstyle
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketStyleProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__44c89446c4836fc75905eb87d31e584eb9cb12b53ddb63498fdd43bd9dd5dfe8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3ecdc4f4bd866960545c07bc1e62676f106231f62f632c0bb4b906b32e91d354)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrStyleName")
    def attr_style_name(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: StyleName: Image Style Name.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrStyleName"))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9d199698a3b927ccf2873639ca2f455da318e9f2bb383413d1017513464be1d0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def content(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__55357c4baeec2204cdb529cd8942a7b2b4effb59f7c0bba6f986436cee506d47)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__572e6d51363683ff34eb9ee1d4537af821863c5b6c79423244e02038bf55cc7e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="styleName")
    def style_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: styleName: Image Style Name.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "styleName"))
    ...
    def style_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8dca416a26686ff6f7ce920bf0393114022ac0644cbcc66e3907852ce4e19910)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "styleName", value)
    ...
    def category(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c6fca06f1aded075df43a84f97baeccc8bbdfe2849cb2ea44b8445f93416b591)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "category", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketStyleProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
        "content": "content",
...
class RosBucketStyleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f9ecde5cce555208ee9203339a21b0a9cfc522e23b1a520e5dba41cea222a25)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument content", value=content, expected_type=type_hints["content"])
            check_type(argname="argument style_name", value=style_name, expected_type=type_hints["style_name"])
            check_type(argname="argument category", value=category, expected_type=type_hints["category"])
    ...
    def __repr__(self) -> str:
        return "RosBucketStyleProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosBucketWorm(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.RosBucketWorm",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OSS::BucketWorm``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``BucketWorm`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketworm
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosBucketWormProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__82f08188486d3f2d3f5487fb8dbccf04d4f229114cbfd2ab03da901e0ff727ec)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bfde3a2830c9a4e033318158a8e076d4c10373162c847047b3a8e9ce7e0564e7)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrExpirationDate")
    def attr_expiration_date(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ExpirationDate: Retention Policy Expiration Time.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrExpirationDate"))

    @builtins.property
    @jsii.member(jsii_name="attrRetentionPeriodInDays")
    def attr_retention_period_in_days(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: RetentionPeriodInDays: The specified number of days to retain the Object.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrRetentionPeriodInDays"))

    @builtins.property
    @jsii.member(jsii_name="attrWormId")
    def attr_worm_id(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: WormId: The ID of the retention policy.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrWormId"))
    ...
    def bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__20d648817c9b083cb9e91ee64bd05b683ee8bcae9790a5feed3af6edff00bee3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__697129bf7346c2a4183e75bb8020c1dac11b0b7df17ed1b89f26bd2771785e59)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def retention_period_in_days(
        ...
        :Property: retentionPeriodInDays: The specified number of days to retain the Object.
        '''
        return typing.cast(typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "retentionPeriodInDays"))
    ...
    def retention_period_in_days(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__06d8119308d895c5f50278e34c443e6e4431cac4c536945d0ba6f1523677e52b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "retentionPeriodInDays", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oss.RosBucketWormProps",
    jsii_struct_bases=[],
    name_mapping={
        "bucket": "bucket",
        "retention_period_in_days": "retentionPeriodInDays",
...
class RosBucketWormProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__17483ab522869bf80e1ffe1beee3ac499a5aacd4f0ee8c34fd338d91d2c3cc11)
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
            check_type(argname="argument retention_period_in_days", value=retention_period_in_days, expected_type=type_hints["retention_period_in_days"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "bucket": bucket,
    ...
    def __repr__(self) -> str:
        return "RosBucketWormProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class Bucket(
    ...
    def arn_for_objects(self, key_pattern: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2c6f116fc3f7d8a5e7dcdda8e22596c042865dce5c49af15fbe2671383e4e0ac)
    ...
    def grant_full_access(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4b8b451a9d1caf95816fe61e81c656d0bba9011e67f5207183f05c79821aff2c)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
            check_type(argname="argument objects_key_pattern", value=objects_key_pattern, expected_type=type_hints["objects_key_pattern"])
        return typing.cast(_ros_cdk_ram_c2c603f0.ManagedPolicy, jsii.invoke(self, "grantFullAccess", [identity, objects_key_pattern]))
    ...
    def grant_list(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3f9b7436590d51ee3bb8211565dc40a67ca1fbb38bb409b76b86037919dc01df)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
            check_type(argname="argument objects_key_pattern", value=objects_key_pattern, expected_type=type_hints["objects_key_pattern"])
        return typing.cast(_ros_cdk_ram_c2c603f0.ManagedPolicy, jsii.invoke(self, "grantList", [identity, objects_key_pattern]))
    ...
    def grant_read(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__919ca56288320ae91b97ed15719fce522b26e1a6991fa071ea1e3b8c397ad272)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
            check_type(argname="argument objects_key_pattern", value=objects_key_pattern, expected_type=type_hints["objects_key_pattern"])
        return typing.cast(_ros_cdk_ram_c2c603f0.ManagedPolicy, jsii.invoke(self, "grantRead", [identity, objects_key_pattern]))
    ...
    def grant_read_write(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__73df95b1a7660ff80a54acabc083c5d5337f4c569222766f99e219ac00f36ef4)
            check_type(argname="argument identity", value=identity, expected_type=type_hints["identity"])
            check_type(argname="argument objects_key_pattern", value=objects_key_pattern, expected_type=type_hints["objects_key_pattern"])
        return typing.cast(_ros_cdk_ram_c2c603f0.ManagedPolicy, jsii.invoke(self, "grantReadWrite", [identity, objects_key_pattern]))
...
@jsii.implements(IBucketAccessMonitor)
class BucketAccessMonitor(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketAccessMonitor",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketAccessMonitor``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketAccessMonitor``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketaccessmonitor
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketAccessMonitorProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__607f0d43e5a1cd39a63373de93bd985c57d1f46f80b1c1bde38ae0f1e63efe23)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa9e17751bd9e3b88d394140bffe88e7b7876b712bdfd116b1967c017062fd62)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__acaf292a07b8d31908d1553298512dc30b6260abb3039c546d6cffde61d49118)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a79de52264c4be7c3edf3d69e519ab931d97a05c32ee87cdae575d567cefc97e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketCnameToken)
class BucketCnameToken(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketCnameToken",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketCnameToken``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketCnameToken``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketcnametoken
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketCnameTokenProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dd51537cf4ce7857fe602eb72bbdd667038dec3d6f528f7e8f37b36d5052647b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__696da1079715df5f01db665a3c1f8af9809d5138712c347751622db735874540)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ddebc6edf2a723e978b3fe5366fd8d049716ac6b74acfe6ce17057b484409223)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3d14f3964009d8d14499436c011304b4d62bd191376b18ea3f4d898216fe90cc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketLogging)
class BucketLogging(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketLogging",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketLogging``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketLogging``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketlogging
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketLoggingProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7a16a09dfebd677d57f661f8df3434e732e08ab349b094c589dd2a44480b5a54)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4ab10679e7704f6e0c823955b47299f80567643fb8112a50e8b81d17cc18f677)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5023d7ef0642c813d2c199406cd0cb8d9a8d90eec7888ea1af4881765d0f4fa6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a299c91972be114c97dc186acc7e988232aa9220439dadc9543d1b48fa6b5a43)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketOverwriteConfig)
class BucketOverwriteConfig(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketOverwriteConfig",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketOverwriteConfig``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketOverwriteConfig``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketoverwriteconfig
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketOverwriteConfigProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__84f273d2996a4ae148a403678a1a8c33983e29ddf45a65e40ffd0e7aa7d73eb7)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c47a3d51e24f1593c33f3d7431aa5226a2feb2619779f11b63371e605fd381ef)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__89fb12b9f0706bfb36737c6265cae98ba81ba1ea928e952adf61e34d5e9733e2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0836f70415d1dd9ff5454d12fe5ca83883fa53d83e6900b42051228e97547875)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketPublicAccessBlock)
class BucketPublicAccessBlock(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketPublicAccessBlock",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketPublicAccessBlock``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketPublicAccessBlock``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketpublicaccessblock
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketPublicAccessBlockProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5d193adce00dd52d2ec0d5fb0c7a06c314e7200cb7280c7b1a706090f1b8f390)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__861b434c4acfbf3552ce6cc117235334863cad515a15dbdb39dd7bfe12b2dcb8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__13155583bbbf9871628ac13b9980941c12fe56ae6a7a91e892e85eee409d5a69)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__640e7885a0a3ce0de53e1c95e7d4a2e8234b52669200f1069bd50d691a6afe85)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketReplication)
class BucketReplication(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketReplication",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketReplication``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketreplication
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketReplicationProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7378dda37504be0cdeb9c4b8818c15e196db478d2e658d2ac5dee596382802d1)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__611f2767b4aef851bc8be6bd62d9487763c1a5e539a2e137be6e59bd5ea6ed19)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e3d68651742e3fc933df297e7f19ce1d9022139221722d763e389d6290a837e6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__98e0cebddfe13a2a1c36d61d5e8550125fe5ebb924d879683f5a0922cb6e9dda)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketStyle)
class BucketStyle(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketStyle",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketStyle``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketStyle``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketstyle
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketStyleProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4b1ad73f64a878f5424941669cb7f0fb17ebb656ce5fa60e71f8b5e410ee6ac0)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa4d4b3f73c7178a44d1b1ff1ff1cfa798a7e9fd57d91d3e6095d1c6d5225142)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7ab0ab5b01c548caa8e4c54c3122bde45559d251cd11ba260ea48acd1a8936c3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__61603e7f969160cc85bf5707bac58e23d45ccfc2fede0287ae292402406a8d02)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IBucketWorm)
class BucketWorm(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oss.BucketWorm",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::BucketWorm``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosBucketWorm``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketworm
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[BucketWormProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25f8574175e2f42264f434ab39c8352e7455217f8454a0ccaf01a61a611b01c8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa9afff7842e398a9acd3dec5b0f34b0157220bf2aeb9c90acaeb0a0a9829789)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8d6fffa31ffecfbc88858fed604310bf85c6989032e457322c1b04f08350d36d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5d8f0b84903d466fedacee68d363d29eb4d349df5d05da39660f15fae1d21b4d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class Directory(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OSS::Directory``.
...
__all__ = [
    "Bucket",
    "BucketAccessMonitor",
    "BucketAccessMonitorProps",
    "BucketAttributes",
    "BucketCnameToken",
    "BucketCnameTokenProps",
    "BucketLogging",
    "BucketLoggingProps",
    "BucketOverwriteConfig",
    "BucketOverwriteConfigProps",
    "BucketProps",
    "BucketPublicAccessBlock",
    "BucketPublicAccessBlockProps",
    "BucketReplication",
    ...
    "IBucketCnameToken",
    "IBucketLogging",
    "IBucketOverwriteConfig",
    "IBucketPublicAccessBlock",
    "IBucketReplication",
    "IBucketStyle",
    "IBucketWorm",
    "IDirectory",
    ...
    "ObjectAclProps",
    "RosBucket",
    "RosBucketAccessMonitor",
    "RosBucketAccessMonitorProps",
    "RosBucketCnameToken",
    "RosBucketCnameTokenProps",
    "RosBucketLogging",
    "RosBucketLoggingProps",
    "RosBucketOverwriteConfig",
    "RosBucketOverwriteConfigProps",
    "RosBucketProps",
    "RosBucketPublicAccessBlock",
    "RosBucketPublicAccessBlockProps",
    "RosBucketReplication",
...
def _typecheckingstub__24cc9587e004a9dd40e6e4aa44fa346c716348bd29565be6fc58794e27c05a49(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__2ef47cb0eeadf34d9ff4ddce8bb31b2e39b21ca6813462dd569042071a28c437(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    domain: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__d86d65f87c5aa0046ac448dbbff74cdad08c1a21ff23f65afc8de2822282aa6c(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    target_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logging_role: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__6c1a0638b8c3cefe2ff6de16566ad24ea9263c6ca44241a9c7820e9c16d4731b(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    rule: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketOverwriteConfig.RuleProperty, typing.Dict[builtins.str, typing.Any]]]]]] = None,
) -> None:
...
def _typecheckingstub__2f7affef40bb2985f4e6f11bfe7237cbd885a902ac5c1b68772c0ef79390a102(
    *,
    block_public_access: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__f8cfbd34341f1ab76eda2b858f6e695507efe543778ead827c961f6d60e123da(
    *,
    bucket_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    replication_configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.ReplicationConfigurationProperty, typing.Dict[builtins.str, typing.Any]]],
) -> None:
...
def _typecheckingstub__c2d9cc8dc7af8631508a66600cc72800528896ed4408ab1af56bc77e99f9ee17(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    content: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    style_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__94d9f456f6c136c3b66049f0f2d0f513855b6513f5a286260139fce0f43d70e6(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    retention_period_in_days: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__6fb685c7cfcc09883f1ce12f7236283bafd7aa96fc318eae4fa9367c5c4fa7cc(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__6710c0e27031ec8d1adb3898b7c4ca39f6322cab20ecb5f4e579ba017a8a7cdb(
    *,
    allow_small_file: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    created_before_date: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    days: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__a04543a02bb27c9e947f909d07b156d72c4047d10863d0dbd2f33939392cbf71(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketAccessMonitorProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__652cdf97538adaf4e3d761542603494813e7f7bde8b21444baecbf7ff1654f91(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c35c7a4150eb7f455f8ea0b809561bc0058408acd4e60fe0c395a6cf219e998f(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4fbdf1ef59210a582f1e0716b229a663dc6b63dafd73cf4587544473a7d4322b(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__348a202cfe84d3f6e03ed5031c1b232fa9265c2c93085ea84913471ed1cc2eb4(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__34b3b817643d0cb364763ada5c2b524075f7b75c2d0ccc4967d9fd127d287cd8(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketCnameTokenProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__63ce3923ad4a7429b8443b3494ffc7d209377c8fe0ed82ee57afc7e8f07ba691(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6ab0319c550638a933400b36288a3b5f7b8d6c1985cca95572391aef96581819(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2ed2fd898a34c3fd767a9238ada74906fcec5dd9bfa5923b73e21fc4925cf9da(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__70b670fd13e7dc748998ddae98f77be5d57a3fa34e23e65d602ba82be0fc8fa7(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3fa4a1764ab58f5112ae53f00a81d93a285943bac925b4f331f4b469a2c5374f(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    domain: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__ec583ec103ea0bab2df9655e5f8282565738c60725767246a4e9f1d1de3ac319(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketLoggingProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__43318930f5721431ab45bcc35fde920e04f29641910f75df5efc9f8b6453c4df(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3f53eaf56eb571c09abc7a1d0970a68f0c0f7118659b531e8499a29d9d1a6794(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__50a5e089a0636c32998fd921915961e709993baff0fc6010eba1f0459475ce6e(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e63d3d5ec0798d6fed8ea7e6491df9d461b812df428659bb30e36e0a5ac60aa8(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c373c7d1023eb797d19b17a2ed722d5b504732ef2157f051ea8f7b2bd1da55bc(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d2c377458bbe3a4a2f774f9f34fa4a0607a787cb11701ee7cf2ba866131757e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e2ea134d1a7febfbcff059d71e1b5f1b2c1a024ff4c59318719bae9f53d12ca8(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    target_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logging_role: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__35cbe5190ac99daa89327e65a232e434079b1ad7d8b5656578049fca8d2edd3b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketOverwriteConfigProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__2fa401c80e0294b9380c46df49d6cc639c53771439f69de396fba6a09759f32d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__128faa444d10a560c729cbd52e9088067d77abbfbf40409f836e888b9b9af13d(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__38821023719895943af22c36d46955549f984e227df9ecaae16bd817ed6a0910(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__408721dae900b2f47cd8e54a89b573e85ae768c2a9c7f124783437cccdf92aa5(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosBucketOverwriteConfig.RuleProperty]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6dd8b277df04563d3f6f3baf2ebc84f2862d3fc4f4e889452d8a5f40045080dc(
    *,
    principal: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__f2c4dfb4a86b26c7c5dd2fc567158516ea3a58ce50886b04d0936d54b288e452(
    *,
    action: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    identity: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    prefix: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__2fb15d01b58240208c3f9e228fc3fdb288cba9f9b84e361291f09620966810df(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    rule: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketOverwriteConfig.RuleProperty, typing.Dict[builtins.str, typing.Any]]]]]] = None,
) -> None:
...
def _typecheckingstub__6a54cfc54dca70aa96a07b3bc5ef16cd8387def3b880afaa52be4caec2250b9a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketPublicAccessBlockProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__a1a5f547e30d9c9f23ea62fe0dd3374d07eb4db54f7f1f4e9b43e0a51cc45268(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d085420ab310c982e898c7e449ff3f1a54236913b047ca9dd11494f76dc9210e(
    value: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7558ab6714d4c7ed6c16df25aae1f3bb02d243a04288505b0e25be2f94256ba8(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1919c21294adb6f74b458d55898e565fc76760301d38e197d8ad6e5794f718f5(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7c229159c92e94d793d0b24aac84e6e57d70ac519109dfe12ac187bb642958ce(
    *,
    block_public_access: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__5d7cab185284a6a0424f15d1b0f2ca1075e9b4e247d5906dd3e378797ce380e1(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketReplicationProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__4d3d6e7e3e6cc9025c08ae953ca91c94acadeea0a9e4067f61cdacece93273d4(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a705a5123337fe1d006e57eb4f9b4f5623423944dad6c0c6f843ed2984650324(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0e7abcf71160f9e81bb14020c3bacfdebf927f89e4f69318249a2099b7598738(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3c60e6724fb75ea04151108f726e02fab80c792b13cfb33dc8b3561a7975a014(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosBucketReplication.ReplicationConfigurationProperty],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__af016a6ced21212a6a871f800d44ffc5646a624f30ee8f018b7fe036ede1396e(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    location: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    transfer_type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__f99d3a9cb89b22f23c84872211dd0a34e0f5f6812d062c3f25b296863127d9ea(
    *,
    replica_kms_key_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__5d0b0a1412fb54da27f4d655b8f62433851b5b0262b04a65129d4789c031c520(
    *,
    status: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__0be2e83c213263d489f132293e5355a6b95886a7743cdb2afc253909386a3ef4(
    *,
    rule: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.RuleProperty, typing.Dict[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__2ab51677aeea15e562449bb1da55f05a843bae043e3d22543e71d2488bc47784(
    *,
    destination: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.DestinationProperty, typing.Dict[builtins.str, typing.Any]]],
    action: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    encryption_configuration: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.EncryptionConfigurationProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
...
def _typecheckingstub__b58598af19d66516b9a507e0f0acc59ede9b89d6268c93f283d0e3a00ee9ffbd(
    *,
    sse_kms_encrypted_objects: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.SseKmsEncryptedObjectsProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__ea4576ea5e945ca272fbf931fa79984dd6230c5beb91e8445979b613a86d1c75(
    *,
    status: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__81adccd0d1f1f0986d440174c465c2a682334c3043a0721022ffae838b74c990(
    *,
    bucket_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    replication_configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosBucketReplication.ReplicationConfigurationProperty, typing.Dict[builtins.str, typing.Any]]],
) -> None:
...
def _typecheckingstub__44c89446c4836fc75905eb87d31e584eb9cb12b53ddb63498fdd43bd9dd5dfe8(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketStyleProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__3ecdc4f4bd866960545c07bc1e62676f106231f62f632c0bb4b906b32e91d354(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9d199698a3b927ccf2873639ca2f455da318e9f2bb383413d1017513464be1d0(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__55357c4baeec2204cdb529cd8942a7b2b4effb59f7c0bba6f986436cee506d47(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__572e6d51363683ff34eb9ee1d4537af821863c5b6c79423244e02038bf55cc7e(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8dca416a26686ff6f7ce920bf0393114022ac0644cbcc66e3907852ce4e19910(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c6fca06f1aded075df43a84f97baeccc8bbdfe2849cb2ea44b8445f93416b591(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9f9ecde5cce555208ee9203339a21b0a9cfc522e23b1a520e5dba41cea222a25(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    content: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    style_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__82f08188486d3f2d3f5487fb8dbccf04d4f229114cbfd2ab03da901e0ff727ec(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosBucketWormProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__bfde3a2830c9a4e033318158a8e076d4c10373162c847047b3a8e9ce7e0564e7(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__20d648817c9b083cb9e91ee64bd05b683ee8bcae9790a5feed3af6edff00bee3(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__697129bf7346c2a4183e75bb8020c1dac11b0b7df17ed1b89f26bd2771785e59(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__06d8119308d895c5f50278e34c443e6e4431cac4c536945d0ba6f1523677e52b(
    value: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__17483ab522869bf80e1ffe1beee3ac499a5aacd4f0ee8c34fd338d91d2c3cc11(
    *,
    bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    retention_period_in_days: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__2c6f116fc3f7d8a5e7dcdda8e22596c042865dce5c49af15fbe2671383e4e0ac(
    key_pattern: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4b8b451a9d1caf95816fe61e81c656d0bba9011e67f5207183f05c79821aff2c(
    identity: _ros_cdk_ram_c2c603f0.IPrincipal,
    objects_key_pattern: typing.Optional[builtins.str] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__3f9b7436590d51ee3bb8211565dc40a67ca1fbb38bb409b76b86037919dc01df(
    identity: _ros_cdk_ram_c2c603f0.IPrincipal,
    objects_key_pattern: typing.Optional[builtins.str] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__919ca56288320ae91b97ed15719fce522b26e1a6991fa071ea1e3b8c397ad272(
    identity: _ros_cdk_ram_c2c603f0.IPrincipal,
    objects_key_pattern: typing.Optional[builtins.str] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__73df95b1a7660ff80a54acabc083c5d5337f4c569222766f99e219ac00f36ef4(
    identity: _ros_cdk_ram_c2c603f0.IPrincipal,
    objects_key_pattern: typing.Optional[builtins.str] = None,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__607f0d43e5a1cd39a63373de93bd985c57d1f46f80b1c1bde38ae0f1e63efe23(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketAccessMonitorProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__aa9e17751bd9e3b88d394140bffe88e7b7876b712bdfd116b1967c017062fd62(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__acaf292a07b8d31908d1553298512dc30b6260abb3039c546d6cffde61d49118(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a79de52264c4be7c3edf3d69e519ab931d97a05c32ee87cdae575d567cefc97e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dd51537cf4ce7857fe602eb72bbdd667038dec3d6f528f7e8f37b36d5052647b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketCnameTokenProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__696da1079715df5f01db665a3c1f8af9809d5138712c347751622db735874540(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ddebc6edf2a723e978b3fe5366fd8d049716ac6b74acfe6ce17057b484409223(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3d14f3964009d8d14499436c011304b4d62bd191376b18ea3f4d898216fe90cc(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7a16a09dfebd677d57f661f8df3434e732e08ab349b094c589dd2a44480b5a54(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketLoggingProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__4ab10679e7704f6e0c823955b47299f80567643fb8112a50e8b81d17cc18f677(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5023d7ef0642c813d2c199406cd0cb8d9a8d90eec7888ea1af4881765d0f4fa6(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a299c91972be114c97dc186acc7e988232aa9220439dadc9543d1b48fa6b5a43(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__84f273d2996a4ae148a403678a1a8c33983e29ddf45a65e40ffd0e7aa7d73eb7(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketOverwriteConfigProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__c47a3d51e24f1593c33f3d7431aa5226a2feb2619779f11b63371e605fd381ef(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__89fb12b9f0706bfb36737c6265cae98ba81ba1ea928e952adf61e34d5e9733e2(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0836f70415d1dd9ff5454d12fe5ca83883fa53d83e6900b42051228e97547875(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5d193adce00dd52d2ec0d5fb0c7a06c314e7200cb7280c7b1a706090f1b8f390(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketPublicAccessBlockProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__861b434c4acfbf3552ce6cc117235334863cad515a15dbdb39dd7bfe12b2dcb8(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__13155583bbbf9871628ac13b9980941c12fe56ae6a7a91e892e85eee409d5a69(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__640e7885a0a3ce0de53e1c95e7d4a2e8234b52669200f1069bd50d691a6afe85(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7378dda37504be0cdeb9c4b8818c15e196db478d2e658d2ac5dee596382802d1(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketReplicationProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__611f2767b4aef851bc8be6bd62d9487763c1a5e539a2e137be6e59bd5ea6ed19(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e3d68651742e3fc933df297e7f19ce1d9022139221722d763e389d6290a837e6(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__98e0cebddfe13a2a1c36d61d5e8550125fe5ebb924d879683f5a0922cb6e9dda(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4b1ad73f64a878f5424941669cb7f0fb17ebb656ce5fa60e71f8b5e410ee6ac0(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketStyleProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__aa4d4b3f73c7178a44d1b1ff1ff1cfa798a7e9fd57d91d3e6095d1c6d5225142(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7ab0ab5b01c548caa8e4c54c3122bde45559d251cd11ba260ea48acd1a8936c3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__61603e7f969160cc85bf5707bac58e23d45ccfc2fede0287ae292402406a8d02(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__25f8574175e2f42264f434ab39c8352e7455217f8454a0ccaf01a61a611b01c8(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[BucketWormProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__fa9afff7842e398a9acd3dec5b0f34b0157220bf2aeb9c90acaeb0a0a9829789(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8d6fffa31ffecfbc88858fed604310bf85c6989032e457322c1b04f08350d36d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5d8f0b84903d466fedacee68d363d29eb4d349df5d05da39660f15fae1d21b4d(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
