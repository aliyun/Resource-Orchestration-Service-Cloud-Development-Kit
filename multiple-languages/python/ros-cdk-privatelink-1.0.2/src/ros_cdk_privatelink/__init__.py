...
class RosVpcEndpointServiceAttachment(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosVpcEndpointServiceAttachment, self, [scope, id, props, enable_resource_property_constraint])
...
class VpcEndpointServiceAttachment(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(VpcEndpointServiceAttachment, self, [scope, id, props, enable_resource_property_constraint])
