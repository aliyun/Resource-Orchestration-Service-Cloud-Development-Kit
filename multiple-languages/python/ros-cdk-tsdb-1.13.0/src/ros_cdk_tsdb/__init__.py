...
class HiTSDBInstanceProps:
    def __init__(
        ...
        *,
        ...
        :param instance_class: Property instanceClass: The type of the instance.
        ...
        :param pay_type: Property payType: The billing method. Valid values: - **prepay**: The prepay value indicates the subscription method.
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-tsdb.IHiTSDBInstance")
class IHiTSDBInstance(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def props(self) -> HiTSDBInstanceProps:
        ...


class _IHiTSDBInstanceProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``HiTSDBInstance``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-tsdb.IHiTSDBInstance"
    ...
    def attr_engine_type(
        ...
        '''Attribute EngineType: Engine type of the instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrEngineType"))
    ...
    def attr_reverse_vpc_ip(
        ...
        '''Attribute ReverseVpcIp: Reverse vpc ip of the instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReverseVpcIp"))
    ...
    def attr_reverse_vpc_port(
        ...
        '''Attribute ReverseVpcPort: Reverse vpc port of the instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReverseVpcPort"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> HiTSDBInstanceProps:
        return typing.cast(HiTSDBInstanceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IHiTSDBInstance).__jsii_proxy_class__ = lambda : _IHiTSDBInstanceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-tsdb.IInfluxDBDatabase")
class IInfluxDBDatabase(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "InfluxDBDatabaseProps":
        ...


class _IInfluxDBDatabaseProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``InfluxDBDatabase``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-tsdb.IInfluxDBDatabase"
    ...
    def attr_db_name(
        ...
        '''Attribute DBName: The name of database.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDbName"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "InfluxDBDatabaseProps":
        return typing.cast("InfluxDBDatabaseProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IInfluxDBDatabase).__jsii_proxy_class__ = lambda : _IInfluxDBDatabaseProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-tsdb.IInfluxDBUser")
class IInfluxDBUser(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "InfluxDBUserProps":
        ...


class _IInfluxDBUserProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``InfluxDBUser``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-tsdb.IInfluxDBUser"
    ...
    def attr_user_type(
        ...
        '''Attribute UserType: The type of user.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrUserType"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "InfluxDBUserProps":
        return typing.cast("InfluxDBUserProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IInfluxDBUser).__jsii_proxy_class__ = lambda : _IInfluxDBUserProxy


@jsii.implements(IInfluxDBDatabase)
class InfluxDBDatabase(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosInfluxDBDatabase``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fd7f065141fb7efcf4f7c3a339fbf586cc55b15ba6f81aaff668cca5ad7e4d24)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2eb077d6c9133aeed7efed050835b6241ea5dbf4515ef7f5d7778316cf5dce6e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1b2de1d6b38d45bcfa7d4e7f5fbdb33285d66341747966e6679da2cc7a524652)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class InfluxDBUser(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosInfluxDBUser``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__517fe8e5600aa89b9fa1ead512c74de285663fe59192783912b630c24e095b52)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fec858f438b5cac8e55de8232988a5418a0d772982bdbbda392ba3f6952b2fb9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb18200afbaa4ce8cb25a47771c2d721bf47dfd583261034fe8072be2974ce71)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class RosHiTSDBInstance(
    ...
    This class does not contain additional functions, so it is recommended to use the ``HiTSDBInstance`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-tsdb-hitsdbinstance
    '''
...
class RosInfluxDBDatabase(
    ...
    This class does not contain additional functions, so it is recommended to use the ``InfluxDBDatabase`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-tsdb-influxdbdatabase
    '''
...
class RosInfluxDBUser(
    ...
    This class does not contain additional functions, so it is recommended to use the ``InfluxDBUser`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-tsdb-influxdbuser
    '''
...
@jsii.implements(IHiTSDBInstance)
class HiTSDBInstance(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosHiTSDBInstance``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-tsdb-hitsdbinstance
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__63882ffaae57e851237e7ef2174e2ae6f2287a171c0a84260690904f69a81b90)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__522c0acdba67874816cda23903107312f939b7a351dfbe3a088912a05206a460)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c4f026d2e1c7bc23ea60f6c4cacef02f452a2facc7551041a453bc3e9bc1d97c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
def _typecheckingstub__fd7f065141fb7efcf4f7c3a339fbf586cc55b15ba6f81aaff668cca5ad7e4d24(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2eb077d6c9133aeed7efed050835b6241ea5dbf4515ef7f5d7778316cf5dce6e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1b2de1d6b38d45bcfa7d4e7f5fbdb33285d66341747966e6679da2cc7a524652(
...
def _typecheckingstub__517fe8e5600aa89b9fa1ead512c74de285663fe59192783912b630c24e095b52(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fec858f438b5cac8e55de8232988a5418a0d772982bdbbda392ba3f6952b2fb9(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fb18200afbaa4ce8cb25a47771c2d721bf47dfd583261034fe8072be2974ce71(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__63882ffaae57e851237e7ef2174e2ae6f2287a171c0a84260690904f69a81b90(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__522c0acdba67874816cda23903107312f939b7a351dfbe3a088912a05206a460(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c4f026d2e1c7bc23ea60f6c4cacef02f452a2facc7551041a453bc3e9bc1d97c(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
