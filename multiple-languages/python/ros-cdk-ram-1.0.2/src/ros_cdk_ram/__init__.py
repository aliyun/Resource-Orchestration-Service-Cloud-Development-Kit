...
class RamAccountAlias(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RamAccountAlias, self, [scope, id, props, enable_resource_property_constraint])
...
class RamAccountAliasProps:
    def __init__(
        ...
        *,
        ...
        :param account_alias: Property accountAlias: The alias of the Alibaba Cloud account. The alias must be 3 to 32 characters in length, and can contain lowercase letters, digits, and hyphens (-). Note It cannot start or end with a hyphen (-), and cannot contain consecutive hyphens (-).
        '''
        self._values: typing.Dict[str, typing.Any] = {
...
class RosRamAccountAlias(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosRamAccountAlias, self, [scope, id, props, enable_resource_property_constraint])
...
class RosSecurityPreference(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosSecurityPreference, self, [scope, id, props, enable_resource_property_constraint])
...
class SecurityPreference(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(SecurityPreference, self, [scope, id, props, enable_resource_property_constraint])
