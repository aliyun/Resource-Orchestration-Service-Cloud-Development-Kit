...
class CloudAssembly(
    ...
    def get_stack(self, stack_name: builtins.str) -> "RosStackArtifact":
        ...
        '''
        if __debug__:
            def stub(stack_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument stack_name", value=stack_name, expected_type=type_hints["stack_name"])
...
class CloudAssemblyBuilder(
    ...
    def create_nested_assembly(
        ...
        '''
        if __debug__:
            def stub(artifact_id: builtins.str, display_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument artifact_id", value=artifact_id, expected_type=type_hints["artifact_id"])
...
class RuntimeInfo(ros_cdk_assembly_schema.RuntimeInfo):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(*, libraries: typing.Mapping[builtins.str, builtins.str]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
