...
class ClusterProps:
    def __init__(
        ...
        *,
        ...
        accept_language: typing.Optional[typing.Union[builtins.str, ros_cdk_core.IResolvable]] = None,
        ...
        mse_version: typing.Optional[typing.Union[builtins.str, ros_cdk_core.IResolvable]] = None,
