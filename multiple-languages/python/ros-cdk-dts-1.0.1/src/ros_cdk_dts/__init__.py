...
class ConsumerGroup(
    ...
    def __init__(
        ...
        '''
        jsii.create(ConsumerGroup, self, [scope, id, props, enable_resource_property_constraint])
...
class RosConsumerGroup(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosConsumerGroup, self, [scope, id, props, enable_resource_property_constraint])
...
class RosSubscriptionInstance(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosSubscriptionInstance, self, [scope, id, props, enable_resource_property_constraint])
...
class SubscriptionInstance(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(SubscriptionInstance, self, [scope, id, props, enable_resource_property_constraint])
...
class SubscriptionInstanceProps:
    def __init__(
        ...
        *,
        ...
        :param source_endpoint_instance_type: Property sourceEndpointInstanceType: Data subscription instance type, value is: MySQL, PolarDB, DRDS, Oracle. Default: MySQL.
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if configuration is not None:
            self._values["configuration"] = configuration
