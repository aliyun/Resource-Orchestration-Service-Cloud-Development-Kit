...
class Cluster(
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrInstanceModels")
    def attr_instance_models(self) -> ros_cdk_core.IResolvable:
        '''Attribute InstanceModels: instance nodes.'''
        return typing.cast(ros_cdk_core.IResolvable, jsii.get(self, "attrInstanceModels"))
...
class ClusterProps:
    def __init__(
        ...
        *,
        ...
        disk_capacity: typing.Optional[typing.Union[builtins.str, ros_cdk_core.IResolvable]] = None,
        ...
        :param disk_capacity: Property diskCapacity:.
...
class RosCluster(
    ...
    def disk_capacity(
        ...
        :Property: diskCapacity:
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, ros_cdk_core.IResolvable]], jsii.get(self, "diskCapacity"))
