...
@jsii.interface(jsii_type="@alicloud/ros-cdk-dns.datasource.IDomainGroups")
class IDomainGroups(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``DomainGroups``.'''

    @builtins.property
    @jsii.member(jsii_name="attrDomainGroupIds")
    def attr_domain_group_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def props(self) -> DomainGroupsProps:
        ...


class _IDomainGroupsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DomainGroups``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dns.datasource.IDomainGroups"
    ...
    def attr_domain_group_ids(
        ...
        '''Attribute DomainGroupIds: The list of The DNS domain group ids.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDomainGroupIds"))
    ...
    def attr_domain_groups(
        ...
        '''Attribute DomainGroups: The information about DNS domain groups.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDomainGroups"))
...
typing.cast(typing.Any, IDomainGroups).__jsii_proxy_class__ = lambda : _IDomainGroupsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-dns.datasource.IDomainRecords")
class IDomainRecords(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``DomainRecords``.'''

    @builtins.property
    @jsii.member(jsii_name="attrDomainRecordIds")
    def attr_domain_record_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DomainRecordsProps:
        ...


class _IDomainRecordsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DomainRecords``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dns.datasource.IDomainRecords"
    ...
    def attr_domain_record_ids(
        ...
        '''Attribute DomainRecordIds: The list of The DNS domain record ids.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDomainRecordIds"))
    ...
    def attr_domain_records(
        ...
        '''Attribute DomainRecords: The information about DNS records.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDomainRecords"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDomainRecords).__jsii_proxy_class__ = lambda : _IDomainRecordsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-dns.datasource.IDomains")
...
class _IDomainsProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dns.datasource.IDomains"
...
class RosDomainGroups(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c42e17ff248734532f7614cba994e5a9888e906364d46b06d7e53a9109258a3c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosDomainRecords(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4f406b4a7e35a491828f0d7581b7f075045426aef5e8ab4cc155353f885f7326)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
class RosDomains(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7c94574d362a0d98f611ea0afe1e3748ea88f0e39525655af88f9f5832cd6d14)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
@jsii.implements(IDomainRecords)
class DomainRecords(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
...
def _typecheckingstub__c42e17ff248734532f7614cba994e5a9888e906364d46b06d7e53a9109258a3c(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__4f406b4a7e35a491828f0d7581b7f075045426aef5e8ab4cc155353f885f7326(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__7c94574d362a0d98f611ea0afe1e3748ea88f0e39525655af88f9f5832cd6d14(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
