...
class Instance(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::ROCKETMQ::Instance``ALIYUN::ROCKETMQ::Group is used to create a Group ID on the ROCKETMQ client.
...
class RosInstance(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::ROCKETMQ::Instance``ALIYUN::ROCKETMQ::Group is used to create a Group ID on the ROCKETMQ client.
