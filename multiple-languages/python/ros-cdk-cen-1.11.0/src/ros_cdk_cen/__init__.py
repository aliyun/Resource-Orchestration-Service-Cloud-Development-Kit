...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.FlowlogProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "description": "description",
...
class FlowlogProps:
    def __init__(
        ...
        *,
        ...
        log_format_string: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union["RosFlowlog.TagsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        transit_router_attachment_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param cen_id: Property cenId: The ID of the CEN instance.
        :param description: Property description: The description of the flow log. The description is optional. If you enter a description, it must be 1 to 256 characters in length, and cannot start with http:// or https://.
        :param flow_log_name: Property flowLogName: The flow log name. The name can be empty or 1 to 128 characters in length, and cannot start with http:// or https://.
        :param interval: Property interval: The time window for collecting log data. Unit: seconds. Valid values: 60 and 600. Default value: 600.
        :param log_format_string: Property logFormatString: The strings that define the fields in the flow log. Format: ${Field 1}${Field 2}${Field 3}...{Field n} * If you do not configure this parameter, all fields are included in the flow log. * If you configure this parameter, start the string with ${srcaddr}${dstaddr}${bytes} because ${srcaddr}${dstaddr}${bytes} are required variables.
        :param log_store_name: Property logStoreName: The Logstore that stores the captured traffic data. - If a Logstore is already created in the selected region, enter the name of the Logstore. - If no Logstores are created in the selected region, enter a name and the system automatically creates a Logstore. The name of the Logstore. The name must meet the following requirements: ** The name must be unique in a project. ** The name can contain only lowercase letters, digits, hyphens (-), and underscores (_). ** The name must start and end with a lowercase letter or a digit. ** The name must be 3 to 63 characters in length.
        :param project_name: Property projectName: The project that stores the captured traffic data. - If a project is already created in the selected region, enter the name of the project. - If no projects are created in the selected region, enter a name and the system automatically creates a project. The project name must be unique in a region. You cannot change the name after the project is created. The name must meet the following requirements: ** The name must be globally unique. ** The name can contain only lowercase letters, digits, and hyphens (-). ** The name must start and end with a lowercase letter or a digit. ** The name must be 3 to 63 characters in length.
        :param tags: Property tags: Tags of flow log.
        :param transit_router_attachment_id: Property transitRouterAttachmentId: The ID of the VPC connection, VPN connection, VBR connection, ECR connection, or inter-region connection. If you create the flow log for a transfer router, skip this parameter.
        :param transit_router_id: Property transitRouterId: The ID of the transit router.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__89adf0cf93f4c7a9fa4f1ca0fd8f9d1eb9c2d1d8a4ce44aefdaf6f0c33070075)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument flow_log_name", value=flow_log_name, expected_type=type_hints["flow_log_name"])
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
            check_type(argname="argument log_format_string", value=log_format_string, expected_type=type_hints["log_format_string"])
        ...
        if log_format_string is not None:
            self._values["log_format_string"] = log_format_string
        ...
        if transit_router_attachment_id is not None:
            self._values["transit_router_attachment_id"] = transit_router_attachment_id
    ...
    def log_format_string(
        ...
        '''
        result = self._values.get("log_format_string")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    @builtins.property
    def tags(self) -> typing.Optional[typing.List["RosFlowlog.TagsProperty"]]:
        '''Property tags: Tags of flow log.'''
        result = self._values.get("tags")
        return typing.cast(typing.Optional[typing.List["RosFlowlog.TagsProperty"]], result)
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.IFlowlog")
class IFlowlog(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrFlowLogVersion")
    def attr_flow_log_version(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrInterval")
    def attr_interval(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLogFormatString")
    def attr_log_format_string(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IFlowlogProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.IFlowlog"
    ...
    def attr_flow_log_id(
        ...
        '''Attribute FlowLogId: The ID of the flow log.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFlowLogId"))
    ...
    def attr_flow_log_name(
        ...
        '''Attribute FlowLogName: The flow log name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFlowLogName"))
    ...
    def attr_flow_log_version(
        ...
        '''Attribute FlowLogVersion: The flow log version.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFlowLogVersion"))
    ...
    def attr_interval(
        ...
        '''Attribute Interval: The time window for collecting log data.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrInterval"))
    ...
    def attr_log_format_string(
        ...
        '''Attribute LogFormatString: The strings that define the fields in the flow log.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLogFormatString"))
...
@jsii.interface(
    jsii_type="@alicloud/ros-cdk-cen.ITransitRouterRouteTableAssociationReplacement"
)
class ITransitRouterRouteTableAssociationReplacement(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrOriginalTransitRouterRouteTableId")
    def attr_original_transit_router_route_table_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableAssociationReplacementProps":
        ...


class _ITransitRouterRouteTableAssociationReplacementProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterRouteTableAssociationReplacement``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterRouteTableAssociationReplacement"
    ...
    def attr_original_transit_router_route_table_id(
        ...
        '''Attribute OriginalTransitRouterRouteTableId: The original transit router route table ID before replacement.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrOriginalTransitRouterRouteTableId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableAssociationReplacementProps":
        return typing.cast("TransitRouterRouteTableAssociationReplacementProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterRouteTableAssociationReplacement).__jsii_proxy_class__ = lambda : _ITransitRouterRouteTableAssociationReplacementProxy
...
class RosFlowlog(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.RosFlowlog",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__afd8adb97daeeec3cff4b816e3ee8280917fe36e0f8afc62dae7d9c04c79023b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__541e2e67bcea4e5bc17950f2732c20b4c68538867543a88398ce8cc289e7cd0c)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrFlowLogVersion")
    def attr_flow_log_version(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: FlowLogVersion: The flow log version.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrFlowLogVersion"))

    @builtins.property
    @jsii.member(jsii_name="attrInterval")
    def attr_interval(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Interval: The time window for collecting log data.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrInterval"))

    @builtins.property
    @jsii.member(jsii_name="attrLogFormatString")
    def attr_log_format_string(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LogFormatString: The strings that define the fields in the flow log.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLogFormatString"))
    ...
    def cen_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__df3b3683e57e889a0ca39d3ee3cbd3761864252e85670e7fefa492e20b376ca7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cenId", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__10cae2b951f32b81f468c3960772ad050bc69e832d8875fdf0b545e51e759966)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__17a6609d59be00342a78ca0ff0fa5be91124a8f1ff96e327a8175bba19ee79f6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)
    ...
    def flow_log_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a85d03f9503530e30127d8eb1d2b352c0516938c2e062182d17aae1209fb7673)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def interval(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__44ec66c5ea93e5ae7275504395b29c72a818f888758c029a19f6501d98190220)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "interval", value)

    @builtins.property
    @jsii.member(jsii_name="logFormatString")
    def log_format_string(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        logFormatString: The strings that define the fields in the flow log.
        Format: ${Field 1}${Field 2}${Field 3}...{Field n}

        - If you do not configure this parameter, all fields are included in the flow log.
        - If you configure this parameter, start the string with ${srcaddr}${dstaddr}${bytes} because ${srcaddr}${dstaddr}${bytes} are required variables.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "logFormatString"))
    ...
    def log_format_string(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__97a0812ac8bdc6adb89cb03d87f83916564837529cb9bee10d618429c237d3d7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "logFormatString", value)
    ...
    def log_store_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__610d3935497668d1b5b8266435cc3ff7eeba27c1c63d004fd0c9773633dbe31d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project_name(
        ...
        projectName: The project that stores the captured traffic data.
    ...
    def project_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ff012552921d39033a4645fc2236e99b13c61dabc5e2c41a0816bebe7581f88c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self) -> typing.Optional[typing.List["RosFlowlog.TagsProperty"]]:
        ...
        :Property: tags: Tags of flow log.
        '''
        return typing.cast(typing.Optional[typing.List["RosFlowlog.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(
        self,
        value: typing.Optional[typing.List["RosFlowlog.TagsProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d8f55ae43cf47a765ebe319fce1ebdc13d717cf34ab9f485233ee7bf41082dcc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    def transit_router_attachment_id(
        ...
        transitRouterAttachmentId: The ID of the VPC connection, VPN connection, VBR connection, ECR connection, or inter-region connection.
        If you create the flow log for a transfer router, skip this parameter.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "transitRouterAttachmentId"))
    ...
    def transit_router_attachment_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2eaa6c02668afe9a1856ac9a001f224e543d7cb379af0964d7fd63a9c330cf7f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterAttachmentId", value)
    ...
    def transit_router_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__065d2834eadcc2855d61aae99a2245665b59e7cd9fd618765556a77085d54fb9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterId", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cen.RosFlowlog.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__14e30e1be9f51f97747b94e28270bb6ea257fc271e4561931dbdb0fd84ac2d90)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "key": key,
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.RosFlowlogProps",
    jsii_struct_bases=[],
    name_mapping={
        "cen_id": "cenId",
        "description": "description",
...
class RosFlowlogProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad374ef1c09f4bec34028740d4318c4e9c08695768650d6bfeb571a560617f69)
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument flow_log_name", value=flow_log_name, expected_type=type_hints["flow_log_name"])
            check_type(argname="argument interval", value=interval, expected_type=type_hints["interval"])
...
class RosTransitRouterRouteTableAssociationReplacement(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterRouteTableAssociationReplacement",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::CEN::TransitRouterRouteTableAssociationReplacement``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``TransitRouterRouteTableAssociationReplacement`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosTransitRouterRouteTableAssociationReplacementProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f55e94aa42de82686fe16d081eb9cdc7c625a1638bef103c974ff9018e425ac5)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a0023f73cf3284b29de1f52c96ce065dfa1bd4bdaba79df951c09c4932ed2713)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def attr_original_transit_router_route_table_id(
        ...
        :Attribute: OriginalTransitRouterRouteTableId: The original transit router route table ID before replacement.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrOriginalTransitRouterRouteTableId"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8897f0e560fab923dba5ff8bcf1eb6848008b626dca920f705551932c1ad6398)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def transit_router_attachment_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d7725346651ad65e48c4ca02704ea12025ffa38296e7236f963cf9f74e4edbb9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterAttachmentId", value)
    ...
    def transit_router_route_table_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8c5ea8697de01cb20fca5c4a01dc3d7cfa65dc2c9a077aacfd5574231609a44c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterRouteTableId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterRouteTableAssociationReplacementProps",
    jsii_struct_bases=[],
    name_mapping={
        "transit_router_attachment_id": "transitRouterAttachmentId",
        "transit_router_route_table_id": "transitRouterRouteTableId",
...
class RosTransitRouterRouteTableAssociationReplacementProps:
    def __init__(
        self,
        *,
        transit_router_attachment_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9fabbf96305e9d964da7679912429b2d3f82a907f9243c81c185873c3d686501)
            check_type(argname="argument transit_router_attachment_id", value=transit_router_attachment_id, expected_type=type_hints["transit_router_attachment_id"])
            check_type(argname="argument transit_router_route_table_id", value=transit_router_route_table_id, expected_type=type_hints["transit_router_route_table_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "transit_router_attachment_id": transit_router_attachment_id,
    ...
    def __repr__(self) -> str:
        return "RosTransitRouterRouteTableAssociationReplacementProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.implements(ITransitRouterRouteTableAssociationReplacement)
class TransitRouterRouteTableAssociationReplacement(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.TransitRouterRouteTableAssociationReplacement",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::CEN::TransitRouterRouteTableAssociationReplacement``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterRouteTableAssociationReplacement``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetableassociationreplacement
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["TransitRouterRouteTableAssociationReplacementProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__778d0c3197c775b7ffae055d97470f5209cc9278addf2eedb229bd551daa129a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__19e646b9d7aee946d96118753ce088c8cca2fb4a7533c2bcaa58be435c2ce86e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7856ca36f5ed99b5769ee7f288c35a1499952897e8aca0fb9436e4760d2cef1a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__85d6c33de4fdbc6d6e5db495d03c9f20dae9c97be23f442eb18df00df603bab6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.TransitRouterRouteTableAssociationReplacementProps",
    jsii_struct_bases=[],
    name_mapping={
        "transit_router_attachment_id": "transitRouterAttachmentId",
        "transit_router_route_table_id": "transitRouterRouteTableId",
...
class TransitRouterRouteTableAssociationReplacementProps:
    def __init__(
        self,
        *,
        transit_router_attachment_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param transit_router_attachment_id: Property transitRouterAttachmentId: The ID of the network instance connection.
        :param transit_router_route_table_id: Property transitRouterRouteTableId: The ID of the transit router route table to be associated.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__57d8dd1111ffead50f91af009893aaa0f04957be3f6a533c6d3e515a122af871)
            check_type(argname="argument transit_router_attachment_id", value=transit_router_attachment_id, expected_type=type_hints["transit_router_attachment_id"])
            check_type(argname="argument transit_router_route_table_id", value=transit_router_route_table_id, expected_type=type_hints["transit_router_route_table_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "transit_router_attachment_id": transit_router_attachment_id,
    ...
    def __repr__(self) -> str:
        return "TransitRouterRouteTableAssociationReplacementProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class TransitRouterVpcAttachmentProps:
    def __init__(
        ...
        *,
        ...
        :param cen_id: Property cenId: CenId.
        :param charge_type: Property chargeType: The charge type of the transit router vpc attachment.
...
class Flowlog(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.Flowlog",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__daa84d57d1c96cb35ea46a61baea5df6c65d9825b0d2f07b0737aca4b0ccae7c)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dbc567f05d1053e72d943dfa0c05478403ded815b9ad99cb6db8683dd333853a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4b8567fbf7228a59775357230216dbdf7f62f3e115a2bb2ee9f922d1a924cf28)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c280038452e9c0b9b5bdc2dd9fbb2a7959bf60e9edf01a6a5978ce62ceb73b16)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "RosTransitRouterRouteTableAssociationReplacement",
    "RosTransitRouterRouteTableAssociationReplacementProps",
    ...
    "TransitRouterRouteTableAssociationReplacementProps",
...
def _typecheckingstub__89adf0cf93f4c7a9fa4f1ca0fd8f9d1eb9c2d1d8a4ce44aefdaf6f0c33070075(
    *,
    cen_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    flow_log_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__afd8adb97daeeec3cff4b816e3ee8280917fe36e0f8afc62dae7d9c04c79023b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosFlowlogProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__541e2e67bcea4e5bc17950f2732c20b4c68538867543a88398ce8cc289e7cd0c(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__df3b3683e57e889a0ca39d3ee3cbd3761864252e85670e7fefa492e20b376ca7(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__10cae2b951f32b81f468c3960772ad050bc69e832d8875fdf0b545e51e759966(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__17a6609d59be00342a78ca0ff0fa5be91124a8f1ff96e327a8175bba19ee79f6(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a85d03f9503530e30127d8eb1d2b352c0516938c2e062182d17aae1209fb7673(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__44ec66c5ea93e5ae7275504395b29c72a818f888758c029a19f6501d98190220(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__97a0812ac8bdc6adb89cb03d87f83916564837529cb9bee10d618429c237d3d7(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__610d3935497668d1b5b8266435cc3ff7eeba27c1c63d004fd0c9773633dbe31d(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ff012552921d39033a4645fc2236e99b13c61dabc5e2c41a0816bebe7581f88c(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d8f55ae43cf47a765ebe319fce1ebdc13d717cf34ab9f485233ee7bf41082dcc(
    value: typing.Optional[typing.List[RosFlowlog.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2eaa6c02668afe9a1856ac9a001f224e543d7cb379af0964d7fd63a9c330cf7f(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__065d2834eadcc2855d61aae99a2245665b59e7cd9fd618765556a77085d54fb9(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__14e30e1be9f51f97747b94e28270bb6ea257fc271e4561931dbdb0fd84ac2d90(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__ad374ef1c09f4bec34028740d4318c4e9c08695768650d6bfeb571a560617f69(
    *,
    cen_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    flow_log_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__f55e94aa42de82686fe16d081eb9cdc7c625a1638bef103c974ff9018e425ac5(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosTransitRouterRouteTableAssociationReplacementProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__a0023f73cf3284b29de1f52c96ce065dfa1bd4bdaba79df951c09c4932ed2713(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8897f0e560fab923dba5ff8bcf1eb6848008b626dca920f705551932c1ad6398(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d7725346651ad65e48c4ca02704ea12025ffa38296e7236f963cf9f74e4edbb9(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8c5ea8697de01cb20fca5c4a01dc3d7cfa65dc2c9a077aacfd5574231609a44c(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9fabbf96305e9d964da7679912429b2d3f82a907f9243c81c185873c3d686501(
    *,
    transit_router_attachment_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    transit_router_route_table_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__778d0c3197c775b7ffae055d97470f5209cc9278addf2eedb229bd551daa129a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[TransitRouterRouteTableAssociationReplacementProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__19e646b9d7aee946d96118753ce088c8cca2fb4a7533c2bcaa58be435c2ce86e(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7856ca36f5ed99b5769ee7f288c35a1499952897e8aca0fb9436e4760d2cef1a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__85d6c33de4fdbc6d6e5db495d03c9f20dae9c97be23f442eb18df00df603bab6(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__57d8dd1111ffead50f91af009893aaa0f04957be3f6a533c6d3e515a122af871(
    *,
    transit_router_attachment_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    transit_router_route_table_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__daa84d57d1c96cb35ea46a61baea5df6c65d9825b0d2f07b0737aca4b0ccae7c(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[FlowlogProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__dbc567f05d1053e72d943dfa0c05478403ded815b9ad99cb6db8683dd333853a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4b8567fbf7228a59775357230216dbdf7f62f3e115a2bb2ee9f922d1a924cf28(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c280038452e9c0b9b5bdc2dd9fbb2a7959bf60e9edf01a6a5978ce62ceb73b16(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
