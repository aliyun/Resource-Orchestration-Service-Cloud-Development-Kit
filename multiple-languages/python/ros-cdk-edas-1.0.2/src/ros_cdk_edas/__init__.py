...
class K8sApplication(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(K8sApplication, self, [scope, id, props, enable_resource_property_constraint])
...
class K8sCluster(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(K8sCluster, self, [scope, id, props, enable_resource_property_constraint])
...
class RosK8sApplication(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosK8sApplication, self, [scope, id, props, enable_resource_property_constraint])
...
class RosK8sCluster(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosK8sCluster, self, [scope, id, props, enable_resource_property_constraint])
