...
class ApplicationProps:
    def __init__(
        ...
        *,
        ...
        deployment: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosApplication.DeploymentProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
    ...
    def deployment(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplication.DeploymentProperty"]]:
        '''Property deployment: Deploy application information to ECS clusters.'''
        result = self._values.get("deployment")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplication.DeploymentProperty"]], result)
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IApplication")
...
class _IApplicationProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IApplication"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.ICluster")
...
class _IClusterProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.ICluster"
    ...
    def attr_iaas_provider(
        ...
        '''Attribute IaasProvider: Provider.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIaasProvider"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IClusterMember")
class IClusterMember(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrEcuIds")
    def attr_ecu_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ClusterMemberProps:
        ...


class _IClusterMemberProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ClusterMember``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IClusterMember"
    ...
    def attr_cluster_member_ids(
        ...
        '''Attribute ClusterMemberIds: Cluster member IDs corresponding to the ECS instance IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrClusterMemberIds"))
    ...
    def attr_ecu_ids(
        ...
        '''Attribute EcuIds: ECU IDs corresponding to the ECS instance IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrEcuIds"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> ClusterMemberProps:
        return typing.cast(ClusterMemberProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IClusterMember).__jsii_proxy_class__ = lambda : _IClusterMemberProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IDeployGroup")
class IDeployGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DeployGroupProps:
        ...


class _IDeployGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DeployGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IDeployGroup"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> DeployGroupProps:
        return typing.cast(DeployGroupProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDeployGroup).__jsii_proxy_class__ = lambda : _IDeployGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IK8sApplication")
class IK8sApplication(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sApplicationProps":
        ...


class _IK8sApplicationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``K8sApplication``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IK8sApplication"
    ...
    def attr_cs_cluster_id(
        ...
        '''Attribute CsClusterId: The K8s cluster ID of the application.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCsClusterId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sApplicationProps":
        return typing.cast("K8sApplicationProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IK8sApplication).__jsii_proxy_class__ = lambda : _IK8sApplicationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IK8sCluster")
class IK8sCluster(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sClusterProps":
        ...


class _IK8sClusterProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``K8sCluster``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IK8sCluster"
    ...
    def attr_node_num(
        ...
        '''Attribute NodeNum: Number of nodes.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNodeNum"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sClusterProps":
        return typing.cast("K8sClusterProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IK8sCluster).__jsii_proxy_class__ = lambda : _IK8sClusterProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IK8sSlbBinding")
class IK8sSlbBinding(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sSlbBindingProps":
        ...


class _IK8sSlbBindingProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``K8sSlbBinding``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IK8sSlbBinding"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "K8sSlbBindingProps":
        return typing.cast("K8sSlbBindingProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IK8sSlbBinding).__jsii_proxy_class__ = lambda : _IK8sSlbBindingProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.ISwimmingLane")
class ISwimmingLane(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``SwimmingLane``.'''

    @builtins.property
    @jsii.member(jsii_name="attrLaneId")
    def attr_lane_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SwimmingLaneProps":
        ...


class _ISwimmingLaneProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SwimmingLane``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.ISwimmingLane"
    ...
    def attr_lane_id(
        ...
        '''Attribute LaneId: The ID of the swimming lane.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLaneId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SwimmingLaneProps":
        return typing.cast("SwimmingLaneProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISwimmingLane).__jsii_proxy_class__ = lambda : _ISwimmingLaneProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.ISwimmingLaneGroup")
class ISwimmingLaneGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SwimmingLaneGroupProps":
        ...


class _ISwimmingLaneGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SwimmingLaneGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.ISwimmingLaneGroup"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "SwimmingLaneGroupProps":
        return typing.cast("SwimmingLaneGroupProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISwimmingLaneGroup).__jsii_proxy_class__ = lambda : _ISwimmingLaneGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-edas.IUserDefineRegion")
class IUserDefineRegion(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "UserDefineRegionProps":
        ...


class _IUserDefineRegionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``UserDefineRegion``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-edas.IUserDefineRegion"
    ...
    def attr_debug_enable(
        ...
        '''Attribute DebugEnable: Whether debug is enable.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDebugEnable"))
    ...
    def attr_region_name(
        ...
        '''Attribute RegionName: Region name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRegionName"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "UserDefineRegionProps":
        return typing.cast("UserDefineRegionProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IUserDefineRegion).__jsii_proxy_class__ = lambda : _IUserDefineRegionProxy


@jsii.implements(IK8sApplication)
class K8sApplication(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosK8sApplication``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c5fea694621acc9c3ec91d547d1f8276401cfb627c2f2e93869b95b9332a489f)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0d987a89c47bb5131ce7c334aa18f8774baff0694ddeea3aa9bb016d7da9c721)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c70c826369f3e151fed38a043891c198d12fa3d33ebcd4b7766e603357793207)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class K8sCluster(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosK8sCluster``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a21015d32708d0029df2d20633d46341ff5382b95e239552b83fa8499dd07599)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__843a0db8128f5f38ecd65cdcf73b2cd24c6744889599d62e55883fb8f81249d4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8e365ae4373c54b9bfe7cb2af9c82d32463bc4feff276face1030f77b230ccb7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IK8sSlbBinding)
class K8sSlbBinding(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosK8sSlbBinding``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f896056ba9e44efcb5719fa51c2838acda5ff1326a9a954d2d3b6de46f004872)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2b10e74b9034d75808b3809c147b60e5896b0797c5e219385c59aee2cf06e2c1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b9821587ce63fb1234b4112bf417976db5613eb5ff02a93108ab28d49e4a7c25)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class RosApplication(
    ...
    def deployment(
        ...
        :Property: deployment: Deploy application information to ECS clusters
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplication.DeploymentProperty"]], jsii.get(self, "deployment"))

    @deployment.setter
    def deployment(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplication.DeploymentProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6ea612a32a6859199761893b2af2e3eb29fe1c4caf067043b39f6433d23519e1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-edas.RosApplication.DeploymentProperty",
        jsii_struct_bases=[],
        name_mapping={
            "package_version": "packageVersion",
            "war_url": "warUrl",
            "app_env": "appEnv",
            "batch": "batch",
            "batch_wait_time": "batchWaitTime",
            "desc": "desc",
            "gray": "gray",
            "group_id": "groupId",
            "release_type": "releaseType",
            "traffic_control_strategy": "trafficControlStrategy",
        },
    )
    class DeploymentProperty:
        def __init__(
            self,
            *,
            package_version: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            war_url: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            app_env: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            batch: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            batch_wait_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            desc: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            gray: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            group_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            release_type: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            traffic_control_strategy: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            ...
            :param group_id: 
            :param release_type: 
            :param traffic_control_strategy: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__5766bd80f410a4af5e5c2ef5f1d136d85688f778c3effa56fbf88c2689816e04)
                check_type(argname="argument package_version", value=package_version, expected_type=type_hints["package_version"])
                check_type(argname="argument war_url", value=war_url, expected_type=type_hints["war_url"])
                ...
                check_type(argname="argument batch_wait_time", value=batch_wait_time, expected_type=type_hints["batch_wait_time"])
                check_type(argname="argument desc", value=desc, expected_type=type_hints["desc"])
                check_type(argname="argument gray", value=gray, expected_type=type_hints["gray"])
                check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
                check_type(argname="argument release_type", value=release_type, expected_type=type_hints["release_type"])
                check_type(argname="argument traffic_control_strategy", value=traffic_control_strategy, expected_type=type_hints["traffic_control_strategy"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "package_version": package_version,
                "war_url": war_url,
            }
            if app_env is not None:
                self._values["app_env"] = app_env
            if batch is not None:
                self._values["batch"] = batch
            if batch_wait_time is not None:
                self._values["batch_wait_time"] = batch_wait_time
            if desc is not None:
                self._values["desc"] = desc
            if gray is not None:
                self._values["gray"] = gray
            if group_id is not None:
                self._values["group_id"] = group_id
            if release_type is not None:
                self._values["release_type"] = release_type
            if traffic_control_strategy is not None:
                self._values["traffic_control_strategy"] = traffic_control_strategy
        ...
        def package_version(
            ...
            packageVersion: Deployed application deployment package version,
        ...
        def war_url(
            ...
            warUrl: The URL address of the application deployment package (WAR or JAR).
            It is recommended to use the application deployment package path stored in OSS.
            '''
            result = self._values.get("war_url")
            assert result is not None, "Required property 'war_url' is missing"
            return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
        ...
        def app_env(
            ...
            appEnv: Deployment environment variables, the format must conform to
        ...
        def batch(
            ...
            batch: Each group of batches.When the GroupId of the specified application group is a specific application group ID,
        ...
        def batch_wait_time(
            ...
            batchWaitTime: Batch waiting time, unit: minute.
            ...
            '''
            result = self._values.get("batch_wait_time")
            return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)
        ...
        def release_type(
            ...
            releaseType: Batch mode.
            0 is automatic.
            1 means manual confirmation is required between batches.
            '''
            result = self._values.get("release_type")
            return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)
        ...
        def traffic_control_strategy(
            ...
            '''
            result = self._values.get("traffic_control_strategy")
            return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
...
class RosClusterMember(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ClusterMember`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-clustermember
    '''
    ...
    @builtins.property
    @jsii.member(jsii_name="attrEcuIds")
    def attr_ecu_ids(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: EcuIds: ECU IDs corresponding to the ECS instance IDs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrEcuIds"))
...
class RosDeployGroup(
    ...
    This class does not contain additional functions, so it is recommended to use the ``DeployGroup`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-deploygroup
    '''
...
class RosK8sApplication(
    ...
    This class does not contain additional functions, so it is recommended to use the ``K8sApplication`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-k8sapplication
    '''
...
class RosK8sCluster(
    ...
    This class does not contain additional functions, so it is recommended to use the ``K8sCluster`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-k8scluster
    '''
...
class RosK8sSlbBinding(
    ...
    This class does not contain additional functions, so it is recommended to use the ``K8sSlbBinding`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-k8sslbbinding
    '''
...
class RosSwimmingLane(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-edas.RosSwimmingLane",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::EDAS::SwimmingLane``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``SwimmingLane`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosSwimmingLaneProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c9cea8103c5019857b14ed1d0a64e3397129a4dd752bf18e6bb6fbff5a30fc81)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6647e0d519843facee7a17a957b416b3878c381d3b59ec17c689ecb41624fade)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLaneId")
    def attr_lane_id(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LaneId: The ID of the swimming lane.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLaneId"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2d87447fafd55080df0c0c49f404308d89484586ffca021a9aa9b6f5a552fd1f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="entryRules")
    def entry_rules(
        self,
        ...
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Mapping[builtins.str, typing.Any]]], jsii.get(self, "entryRules"))
    ...
    def entry_rules(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f0eb81ed171e8088820bd509e9ce0d85b0b41f80b44e57025d2dc798bd854e64)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "entryRules", value)
    ...
    def group_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2707ef2adbf562d060dcb4cb97f06b6b59cdb8e349a1b7a207107714bb3500e0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def logical_region_id(
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "logicalRegionId"))
    ...
    def logical_region_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__faac884b9ec56ff85eeb6411e9fc87f40a0651df1613c5147fe02f7f6a073e28)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "logicalRegionId", value)
    ...
    def name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__489ef19539c351e4b51ddfd8d32bb2c4c2536e3cba773a76917cf8d5aab7bd71)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tag(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "tag"))
    ...
    def tag(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d8b4e1d6b47919db0498cc6c8fb507e61ea4dd286cd22c9da8f255ef2e078f36)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tag", value)

    @builtins.property
    @jsii.member(jsii_name="appInfos")
    def app_infos(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], jsii.get(self, "appInfos"))
    ...
    def app_infos(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5c8d894c3b89f69b9cf0c50392110cef9f3fee71b2c9ae68110a5a830fabd8d3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "appInfos", value)

    @builtins.property
    @jsii.member(jsii_name="enableRules")
    def enable_rules(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "enableRules"))
    ...
    def enable_rules(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fc3c9d3f6cc82574d90cc28d7bc85a18237bf2dd4a5cdd3f57ce66fc6c099294)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableRules", value)


class RosSwimmingLaneGroup(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-edas.RosSwimmingLaneGroup",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::EDAS::SwimmingLaneGroup``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``SwimmingLaneGroup`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosSwimmingLaneGroupProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7df6ba5bef8430300e17d3015409d4e452ba49e8923c6033813e45703d2817d6)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5dffccee17026d18fa605238b8a44e3e97cac462baa3e35042ffa92e56abedc9)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def app_ids(
        ...
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "appIds"))
    ...
    def app_ids(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d6d53d9f53944930ce2f1e0eab6f84e65c0996df6a05e0dfb2a3d661bbee07a4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2eba4b56148d9bab6ed6f23d920979ea9b19aadb071ab9906979f478652372db)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="entryApp")
    def entry_app(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "entryApp"))
    ...
    def entry_app(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ef54003f649da73dc00d1172224ca2ed6c298b3b6c4ee31044d9e379727e3ca5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "entryApp", value)
    ...
    def logical_region_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f0f581e86908450dee1467260b70bad292528e18567db313e7771d9268f0ca8c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "logicalRegionId", value)
    ...
    def name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5172eefa79c57a793b78820fead1aac8dfde034d69c547405c7e7c2d97bce29f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-edas.RosSwimmingLaneGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "app_ids": "appIds",
        "entry_app": "entryApp",
...
class RosSwimmingLaneGroupProps:
    def __init__(
        self,
        *,
        app_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        entry_app: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        logical_region_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__00983e29432d3775f2d325047eaa4a3fffc4504d27221bf6432a296bad0b706b)
            check_type(argname="argument app_ids", value=app_ids, expected_type=type_hints["app_ids"])
            check_type(argname="argument entry_app", value=entry_app, expected_type=type_hints["entry_app"])
            check_type(argname="argument logical_region_id", value=logical_region_id, expected_type=type_hints["logical_region_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "app_ids": app_ids,
    ...
    def entry_app(
        ...
        :Property: entryApp: The entry application. Format: EDAS:{application ID}.
        '''
        result = self._values.get("entry_app")
        assert result is not None, "Required property 'entry_app' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def logical_region_id(
        ...
        '''
        result = self._values.get("logical_region_id")
        assert result is not None, "Required property 'logical_region_id' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def __repr__(self) -> str:
        return "RosSwimmingLaneGroupProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-edas.RosSwimmingLaneProps",
    jsii_struct_bases=[],
    name_mapping={
...
class RosSwimmingLaneProps:
    def __init__(
        self,
        *,
        entry_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
        ...
        app_infos: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
        enable_rules: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__447358d6afc188b9857fc782606a6be26bf260ea2d0c585d0b20837069a2f84f)
            check_type(argname="argument entry_rules", value=entry_rules, expected_type=type_hints["entry_rules"])
            check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
            check_type(argname="argument logical_region_id", value=logical_region_id, expected_type=type_hints["logical_region_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument tag", value=tag, expected_type=type_hints["tag"])
            check_type(argname="argument app_infos", value=app_infos, expected_type=type_hints["app_infos"])
            check_type(argname="argument enable_rules", value=enable_rules, expected_type=type_hints["enable_rules"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
        ...
        if app_infos is not None:
            self._values["app_infos"] = app_infos
        if enable_rules is not None:
            self._values["enable_rules"] = enable_rules
    ...
    def entry_rules(
        ...
        :Property: entryRules: The entry rules of the swimming lane.
        '''
        result = self._values.get("entry_rules")
        assert result is not None, "Required property 'entry_rules' is missing"
    ...
    def app_infos(
        ...
        :Property: appInfos: Application information involved in the swimming lane.
        '''
        result = self._values.get("app_infos")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], result)
    ...
    def enable_rules(
        ...
        :Property: enableRules: Whether to enable flow control rules.
        '''
        result = self._values.get("enable_rules")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "RosSwimmingLaneProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosUserDefineRegion(
    ...
    This class does not contain additional functions, so it is recommended to use the ``UserDefineRegion`` class instead of this class for a more convenient development experience.
...
@jsii.implements(ISwimmingLane)
class SwimmingLane(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-edas.SwimmingLane",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::EDAS::SwimmingLane``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosSwimmingLane``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-swimminglane
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["SwimmingLaneProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ce38015c0acda9be4f49ec640d8538b961a6c0b396b2dc09ab23fddb675afd49)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9a6455234281086b7f77e76604c3f92f70312f59e0136ccd136bfdf0df2ba80d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__63652c5978cdb77cafa51aee72bc4e5dbd8a105df48bd1957b8fbee0403a966f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8cb2b6e3d8cf743f8639e790b5fc673d87a4b74c79b065c1c6815182567c9d65)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ISwimmingLaneGroup)
class SwimmingLaneGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-edas.SwimmingLaneGroup",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::EDAS::SwimmingLaneGroup``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosSwimmingLaneGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-swimminglanegroup
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["SwimmingLaneGroupProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7a693f205193a1d7dfaa00ad00c48aed00a479cc73dfa5134ba5224c63554924)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__da2265f1408f6fc3420fc9888e9e113a062569196239ec18905d92552d25b96d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ed446f91ece695f404bece6b080aaeaea553c4a42e277d66e0bbef1893cd2c58)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__92663b433fe7f09cc6c7e820783fff33976a1cbc28eda364bd4b0055cd153e5b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-edas.SwimmingLaneGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "app_ids": "appIds",
        "entry_app": "entryApp",
...
class SwimmingLaneGroupProps:
    def __init__(
        ...
        *,
        ...
        :param app_ids: Property appIds: The list of application IDs involved in the swimming lane group.
        :param entry_app: Property entryApp: The entry application. Format: EDAS:{application ID}.
        :param logical_region_id: Property logicalRegionId: The RegionId of the custom namespace. Format: ``physical Region:custom namespace identifier``.
        :param name: Property name: The name of the swimming lane group. The value can be up to 64 characters in length.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c1f4cc7ef920b33407c63e6394f84e6863675930e401075eb9001362cd167435)
            check_type(argname="argument app_ids", value=app_ids, expected_type=type_hints["app_ids"])
            check_type(argname="argument entry_app", value=entry_app, expected_type=type_hints["entry_app"])
            check_type(argname="argument logical_region_id", value=logical_region_id, expected_type=type_hints["logical_region_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def __repr__(self) -> str:
        return "SwimmingLaneGroupProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-edas.SwimmingLaneProps",
    jsii_struct_bases=[],
    name_mapping={
        "entry_rules": "entryRules",
        "group_id": "groupId",
...
class SwimmingLaneProps:
    def __init__(
        ...
        *,
        ...
        :param entry_rules: Property entryRules: The entry rules of the swimming lane.
        :param group_id: Property groupId: The group ID of the swimming lane.
        :param logical_region_id: Property logicalRegionId: The RegionId of the logical region. Format: ``physicalRegion:customNamespaceIdentifier``.
        :param name: Property name: The name of the swimming lane.
        :param tag: Property tag: The tag of the swimming lane.
        :param app_infos: Property appInfos: Application information involved in the swimming lane.
        :param enable_rules: Property enableRules: Whether to enable flow control rules.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a4798f2774993bbae85526a897b1b59f6afec28e8b64d68d165c9d6d55c14080)
            check_type(argname="argument entry_rules", value=entry_rules, expected_type=type_hints["entry_rules"])
            check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
            check_type(argname="argument logical_region_id", value=logical_region_id, expected_type=type_hints["logical_region_id"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def __repr__(self) -> str:
        return "SwimmingLaneProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IUserDefineRegion)
class UserDefineRegion(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosUserDefineRegion``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-userdefineregion
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f808973c1bd3e2ce5e34eddbc66f0e7785973bdcd3cafafa52cadb834b0caa87)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__32bd5390377d14fbefdabd85635201bca9366c745b17e2d270a56e6fd4059019)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2e243e0cf028bb75d74d00d64c9732ef7995ad19b1e617b8d21bb94f540add1e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class Application(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__75336da2936d7455f6ca85916b14f140402d45b5f605a1d54af347bb463bdb81)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1f6cf73a3d44200c01a09e407c6e9026bfa4f7e7926051b270d07b9c14847abc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__df1b697bc655ceb1762debba8a8b4ad63d9a61b823ee117378bb18c5686e0950)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class Cluster(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ade5803b837a932043c99bb935c3b222bbeb256d1ac12da46d28d66ccf04940)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5deca96c51023d816dfb9a176c3246c8ff7b6c07729995722dcf5a483ba6a9e6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad2995f197a20c2ea46ba41cde8db777976b05b257066dcc12cc53be21a4b1f9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IClusterMember)
class ClusterMember(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosClusterMember``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-clustermember
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e9898b48fc838eb7ded8cb48e9278f690403e5b4560276f3c46d29a7421482d4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d0d13a5eaf2a0225a01d58e4fa877ab7057b9d6886bfea1fadb88b60aab6033)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b2dda26c4cd60de8b12ad97f3450ca7c687f710bdf5db5eb9597859a89ee8550)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IDeployGroup)
class DeployGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosDeployGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-deploygroup
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be3f1dd6230616cf4b3815583baeeb06215823c610a675aa5a4b1250f43c8aa3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4bf234508f95e7972679db3a1986714bc6a5bde66722c45b3f12fc7182b2edb9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c79d4f40b139e844b731ff101bd9b8074a5dbb8c36da80e1847abee684a22335)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "RosSwimmingLane",
    "RosSwimmingLaneGroup",
    "RosSwimmingLaneGroupProps",
    "RosSwimmingLaneProps",
    "RosUserDefineRegion",
    "RosUserDefineRegionProps",
    "SwimmingLane",
    "SwimmingLaneGroup",
    "SwimmingLaneGroupProps",
    "SwimmingLaneProps",
    "UserDefineRegion",
...
def _typecheckingstub__c5fea694621acc9c3ec91d547d1f8276401cfb627c2f2e93869b95b9332a489f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0d987a89c47bb5131ce7c334aa18f8774baff0694ddeea3aa9bb016d7da9c721(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c70c826369f3e151fed38a043891c198d12fa3d33ebcd4b7766e603357793207(
...
def _typecheckingstub__a21015d32708d0029df2d20633d46341ff5382b95e239552b83fa8499dd07599(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__843a0db8128f5f38ecd65cdcf73b2cd24c6744889599d62e55883fb8f81249d4(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8e365ae4373c54b9bfe7cb2af9c82d32463bc4feff276face1030f77b230ccb7(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__f896056ba9e44efcb5719fa51c2838acda5ff1326a9a954d2d3b6de46f004872(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2b10e74b9034d75808b3809c147b60e5896b0797c5e219385c59aee2cf06e2c1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b9821587ce63fb1234b4112bf417976db5613eb5ff02a93108ab28d49e4a7c25(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__6ea612a32a6859199761893b2af2e3eb29fe1c4caf067043b39f6433d23519e1(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosApplication.DeploymentProperty]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__5766bd80f410a4af5e5c2ef5f1d136d85688f778c3effa56fbf88c2689816e04(
    *,
    package_version: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    war_url: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    app_env: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__c9cea8103c5019857b14ed1d0a64e3397129a4dd752bf18e6bb6fbff5a30fc81(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosSwimmingLaneProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__6647e0d519843facee7a17a957b416b3878c381d3b59ec17c689ecb41624fade(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2d87447fafd55080df0c0c49f404308d89484586ffca021a9aa9b6f5a552fd1f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f0eb81ed171e8088820bd509e9ce0d85b0b41f80b44e57025d2dc798bd854e64(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Mapping[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2707ef2adbf562d060dcb4cb97f06b6b59cdb8e349a1b7a207107714bb3500e0(
    value: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__faac884b9ec56ff85eeb6411e9fc87f40a0651df1613c5147fe02f7f6a073e28(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__489ef19539c351e4b51ddfd8d32bb2c4c2536e3cba773a76917cf8d5aab7bd71(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d8b4e1d6b47919db0498cc6c8fb507e61ea4dd286cd22c9da8f255ef2e078f36(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5c8d894c3b89f69b9cf0c50392110cef9f3fee71b2c9ae68110a5a830fabd8d3(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fc3c9d3f6cc82574d90cc28d7bc85a18237bf2dd4a5cdd3f57ce66fc6c099294(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7df6ba5bef8430300e17d3015409d4e452ba49e8923c6033813e45703d2817d6(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosSwimmingLaneGroupProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__5dffccee17026d18fa605238b8a44e3e97cac462baa3e35042ffa92e56abedc9(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d6d53d9f53944930ce2f1e0eab6f84e65c0996df6a05e0dfb2a3d661bbee07a4(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2eba4b56148d9bab6ed6f23d920979ea9b19aadb071ab9906979f478652372db(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ef54003f649da73dc00d1172224ca2ed6c298b3b6c4ee31044d9e379727e3ca5(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f0f581e86908450dee1467260b70bad292528e18567db313e7771d9268f0ca8c(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5172eefa79c57a793b78820fead1aac8dfde034d69c547405c7e7c2d97bce29f(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__00983e29432d3775f2d325047eaa4a3fffc4504d27221bf6432a296bad0b706b(
    *,
    app_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    entry_app: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logical_region_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__447358d6afc188b9857fc782606a6be26bf260ea2d0c585d0b20837069a2f84f(
    *,
    entry_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
    group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    logical_region_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__ce38015c0acda9be4f49ec640d8538b961a6c0b396b2dc09ab23fddb675afd49(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[SwimmingLaneProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__9a6455234281086b7f77e76604c3f92f70312f59e0136ccd136bfdf0df2ba80d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__63652c5978cdb77cafa51aee72bc4e5dbd8a105df48bd1957b8fbee0403a966f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8cb2b6e3d8cf743f8639e790b5fc673d87a4b74c79b065c1c6815182567c9d65(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7a693f205193a1d7dfaa00ad00c48aed00a479cc73dfa5134ba5224c63554924(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[SwimmingLaneGroupProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__da2265f1408f6fc3420fc9888e9e113a062569196239ec18905d92552d25b96d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ed446f91ece695f404bece6b080aaeaea553c4a42e277d66e0bbef1893cd2c58(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__92663b433fe7f09cc6c7e820783fff33976a1cbc28eda364bd4b0055cd153e5b(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c1f4cc7ef920b33407c63e6394f84e6863675930e401075eb9001362cd167435(
    *,
    app_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    entry_app: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logical_region_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__a4798f2774993bbae85526a897b1b59f6afec28e8b64d68d165c9d6d55c14080(
    *,
    entry_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
    group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    logical_region_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__f808973c1bd3e2ce5e34eddbc66f0e7785973bdcd3cafafa52cadb834b0caa87(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__32bd5390377d14fbefdabd85635201bca9366c745b17e2d270a56e6fd4059019(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2e243e0cf028bb75d74d00d64c9732ef7995ad19b1e617b8d21bb94f540add1e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__75336da2936d7455f6ca85916b14f140402d45b5f605a1d54af347bb463bdb81(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1f6cf73a3d44200c01a09e407c6e9026bfa4f7e7926051b270d07b9c14847abc(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__df1b697bc655ceb1762debba8a8b4ad63d9a61b823ee117378bb18c5686e0950(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__5ade5803b837a932043c99bb935c3b222bbeb256d1ac12da46d28d66ccf04940(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5deca96c51023d816dfb9a176c3246c8ff7b6c07729995722dcf5a483ba6a9e6(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ad2995f197a20c2ea46ba41cde8db777976b05b257066dcc12cc53be21a4b1f9(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__e9898b48fc838eb7ded8cb48e9278f690403e5b4560276f3c46d29a7421482d4(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6d0d13a5eaf2a0225a01d58e4fa877ab7057b9d6886bfea1fadb88b60aab6033(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b2dda26c4cd60de8b12ad97f3450ca7c687f710bdf5db5eb9597859a89ee8550(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__be3f1dd6230616cf4b3815583baeeb06215823c610a675aa5a4b1250f43c8aa3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4bf234508f95e7972679db3a1986714bc6a5bde66722c45b3f12fc7182b2edb9(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c79d4f40b139e844b731ff101bd9b8074a5dbb8c36da80e1847abee684a22335(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
