...
class ASKCluster(
    ...
    def _props(self) -> "ASKClusterProps":
        return typing.cast("ASKClusterProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ASKClusterProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f00ebb2845a9c2c5a564aa190a67cacf157bdc657bb3f3dbcc13bb8b62efd3b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class AnyCluster(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "AnyClusterProps":
        return typing.cast("AnyClusterProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "AnyClusterProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be12a839e603cce81a7be66dd262649cd15925648acab21153b52484af1aef02)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ClusterAddons(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ClusterAddonsProps":
        return typing.cast("ClusterAddonsProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ClusterAddonsProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ede2d484694118483b0bbcd277df37fb4b07eebb1b867cbc1437037c16971caa)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ClusterApplication(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ClusterApplicationProps":
        return typing.cast("ClusterApplicationProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ClusterApplicationProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__65999ecd22b5b01e161aab8ac2ae422e15dc5ee8b4c80a915e2de9bb5e856974)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ClusterHelmApplication(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ClusterHelmApplicationProps":
        return typing.cast("ClusterHelmApplicationProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ClusterHelmApplicationProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__741edc426fee220cf34fed90eda55aece324976917e17a545afebe499ee760e0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ClusterNodePool(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ClusterNodePoolProps":
        return typing.cast("ClusterNodePoolProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ClusterNodePoolProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0b975c1391c8ce0437faa7662a495670aaf6c8925170096a3b7a5daabf9b6b65)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class GrantPermissions(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "GrantPermissionsProps":
        return typing.cast("GrantPermissionsProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "GrantPermissionsProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25278b52b2de4586e463c7d247d60af94689a09ed5527b4f4f03b7348ed7e0e4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ManagedEdgeKubernetesCluster(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ManagedEdgeKubernetesClusterProps":
        return typing.cast("ManagedEdgeKubernetesClusterProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ManagedEdgeKubernetesClusterProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e9a484b46338499089fa4ee41a688f1243b61d3ad7b9eba415a4a568a5842195)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
class ManagedEdgeKubernetesClusterProps:
    def __init__(
        ...
        *,
        ...
        :param name: Property name: The name of the cluster. The cluster name can use uppercase and lowercase letters, Chinese characters, numbers, and dashes.
        :param addons: Property addons: The add-ons to be installed for the cluster.
        :param auto_renew: Property autoRenew: Whether the cluster automatically renews. It takes effect when the value of ChargeType is PrePaid. The optional values are: true: automatic renewal false: do not renew automatically Default to true.Starting October 15, 2024, this field will only be effective for the load balancing CLB instance to which the API Server belongs. For the configuration of the working node ECS instance, please specify it in the node pool list parameters.
        :param auto_renew_period: Property autoRenewPeriod: Automatic renewal cycle, which takes effect when prepaid and automatic renewal are selected, and is required: When PeriodUnit = Week, the values are: {"1", "2", "3"} When PeriodUnit = Month, the value is {"1", "2", "3", "6", "12"} Default to 1.Starting October 15, 2024, this field will only be effective for the load balancing CLB instance to which the API Server belongs. For the configuration of the working node ECS instance, please specify it in the node pool list parameters.
        :param charge_type: Property chargeType: cluster payment type. The optional values are: PrePaid: prepaid PostPaid: Pay as you go Default to PostPaid. Starting October 15, 2024, this field will only be effective for the load balancing CLB instance to which the API Server belongs. For the configuration of the working node ECS instance, please specify it in the node pool list parameters.
        ...
        :param period: Property period: The duration of the annual subscription and monthly subscription. It takes effect when the ChargeType value is PrePaid and is a required value. The value range is: When PeriodUnit = Week, Period values are: {"1", "2", "3", "4"} When PeriodUnit = Month, Period values are: {"1", "2", "3", "4", "5", "6", "7", "8", "9", "12", "24", "36", "48", "60"} When PeriodUnit = Year, Period values are: {"1", "2", "3", "4", "5"} Default to 1.Starting October 15, 2024, this field will only be effective for the load balancing CLB instance to which the API Server belongs. For the configuration of the working node ECS instance, please specify it in the node pool list parameters.
        :param period_unit: Property periodUnit: When you specify PrePaid, you need to specify the period. The options are: Week: Time is measured in weeks Month: time in months Year: time in years Default to MonthStarting October 15, 2024, this field will only be effective for the load balancing CLB instance to which the API Server belongs. For the configuration of the working node ECS instance, please specify it in the node pool list parameters.
...
class ManagedKubernetesCluster(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ManagedKubernetesClusterProps":
        return typing.cast("ManagedKubernetesClusterProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ManagedKubernetesClusterProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1b863bc4a761abf8ffb462b29c7c3faba6194504637e8367bdcbc0379b791663)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__9f00ebb2845a9c2c5a564aa190a67cacf157bdc657bb3f3dbcc13bb8b62efd3b(
    value: ASKClusterProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__be12a839e603cce81a7be66dd262649cd15925648acab21153b52484af1aef02(
    value: AnyClusterProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__ede2d484694118483b0bbcd277df37fb4b07eebb1b867cbc1437037c16971caa(
    value: ClusterAddonsProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__65999ecd22b5b01e161aab8ac2ae422e15dc5ee8b4c80a915e2de9bb5e856974(
    value: ClusterApplicationProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__741edc426fee220cf34fed90eda55aece324976917e17a545afebe499ee760e0(
    value: ClusterHelmApplicationProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0b975c1391c8ce0437faa7662a495670aaf6c8925170096a3b7a5daabf9b6b65(
    value: ClusterNodePoolProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__25278b52b2de4586e463c7d247d60af94689a09ed5527b4f4f03b7348ed7e0e4(
    value: GrantPermissionsProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__e9a484b46338499089fa4ee41a688f1243b61d3ad7b9eba415a4a568a5842195(
    value: ManagedEdgeKubernetesClusterProps,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__1b863bc4a761abf8ffb462b29c7c3faba6194504637e8367bdcbc0379b791663(
    value: ManagedKubernetesClusterProps,
) -> None:
    """Type checking stubs"""
    pass
