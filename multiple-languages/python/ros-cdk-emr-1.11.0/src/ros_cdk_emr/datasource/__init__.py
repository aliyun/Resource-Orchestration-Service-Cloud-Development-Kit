...
@jsii.interface(jsii_type="@alicloud/ros-cdk-emr.datasource.ICluster2")
...
class _ICluster2Proxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-emr.datasource.ICluster2"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-emr.datasource.IFlowProjects")
class IFlowProjects(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``FlowProjects``.'''

    @builtins.property
    @jsii.member(jsii_name="attrFlowProjectIds")
    def attr_flow_project_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> FlowProjectsProps:
        ...


class _IFlowProjectsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``FlowProjects``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-emr.datasource.IFlowProjects"
    ...
    def attr_flow_project_ids(
        ...
        '''Attribute FlowProjectIds: The list of flow project IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFlowProjectIds"))
    ...
    def attr_flow_projects(
        ...
        '''Attribute FlowProjects: The list of flow projects.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFlowProjects"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IFlowProjects).__jsii_proxy_class__ = lambda : _IFlowProjectsProxy
...
class RosCluster2(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c8179045c1f7bf784e025b375d4feba03162d9162d04234d8d5f351d59bd5499)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosFlowProjects(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__92e0bb29beb5ba6b5ae6c027121e7e7be90acf958fe95af1338890d68c5d19b8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
def _typecheckingstub__c8179045c1f7bf784e025b375d4feba03162d9162d04234d8d5f351d59bd5499(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__92e0bb29beb5ba6b5ae6c027121e7e7be90acf958fe95af1338890d68c5d19b8(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
