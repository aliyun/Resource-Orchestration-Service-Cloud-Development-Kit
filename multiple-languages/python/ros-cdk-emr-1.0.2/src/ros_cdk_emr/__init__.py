...
class ClusterServiceConfigs(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(ClusterServiceConfigs, self, [scope, id, props, enable_resource_property_constraint])
...
class RosClusterServiceConfigs(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosClusterServiceConfigs, self, [scope, id, props, enable_resource_property_constraint])
