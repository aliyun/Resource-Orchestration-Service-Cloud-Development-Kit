...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "auto_renew": "autoRenew",
        "duration": "duration",
        "ha_resource_spec": "haResourceSpec",
        "ha_v_switch_ids": "haVSwitchIds",
...
class InstanceV2Props:
    def __init__(
        ...
        *,
        ...
        auto_renew: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        duration: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ha_resource_spec: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosInstanceV2.HaResourceSpecProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        ha_v_switch_ids: typing.Optional[typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]] = None,
        monitor_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        pricing_cycle: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        promotion_code: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param vpc_id: Property vpcId: VPC ID.
        :param v_switch_ids: Property vSwitchIds: Virtual switch ID.
        :param architecture_type: Property architectureType: The architecture type, the value of the value is as follows: X86, ARM.
        :param auto_renew: Property autoRenew: When the payment type is the monthly package, the value of the value is as follows: true: Automatic renewal. false: Manual renewal.
        :param duration: Property duration: Number of order cycle. When ChargeType is configured as PRE, the duration parameter must be filled. If PricingCycle is Month, the valid range is 1, 2, 3, 6, 7, 8, 9, 12, 24, 36 If PricingCycle is year, the valid range is 1 to 3
        :param ha_resource_spec: Property haResourceSpec: HA resource specifications. When ChargeType is configured as PRE, the resource specification parameters must be filled.
        :param ha_v_switch_ids: Property haVSwitchIds: HA VSwitch IDs.
        :param monitor_type: Property monitorType: The monitor type, the value of the value is as follows: TAIHAO, ARMS.
        :param pricing_cycle: Property pricingCycle: The ordering cycle only supports ordering in the year and month.
        :param promotion_code: Property promotionCode: Promo Code.
        :param resource_spec: Property resourceSpec: Resource specifications. When ChargeType is configured as PRE, the resource specification parameters must be filled.
        :param use_promotion_code: Property usePromotionCode: Whether to use coupons.The value is as follows: true: Use. false: Not in use.
        ...
        if __debug__:
            ...
            check_type(argname="argument auto_renew", value=auto_renew, expected_type=type_hints["auto_renew"])
            check_type(argname="argument duration", value=duration, expected_type=type_hints["duration"])
            check_type(argname="argument ha_resource_spec", value=ha_resource_spec, expected_type=type_hints["ha_resource_spec"])
            check_type(argname="argument ha_v_switch_ids", value=ha_v_switch_ids, expected_type=type_hints["ha_v_switch_ids"])
        ...
        if duration is not None:
            self._values["duration"] = duration
        if ha_resource_spec is not None:
            self._values["ha_resource_spec"] = ha_resource_spec
        if ha_v_switch_ids is not None:
            self._values["ha_v_switch_ids"] = ha_v_switch_ids
    ...
    @builtins.property
    def ha_resource_spec(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosInstanceV2.HaResourceSpecProperty"]]:
        '''Property haResourceSpec: HA resource specifications.

        When ChargeType is configured as PRE, the resource specification parameters must be filled.
        '''
        result = self._values.get("ha_resource_spec")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosInstanceV2.HaResourceSpecProperty"]], result)
    ...
    def ha_v_switch_ids(
        ...
        result = self._values.get("ha_v_switch_ids")
...
class RosInstanceV2(
    ...
    def architecture_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a37e70a1815bd2e45b69f70071a89f7d2ba40532370e48b748846223d209067e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @builtins.property
    @jsii.member(jsii_name="haResourceSpec")
    def ha_resource_spec(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosInstanceV2.HaResourceSpecProperty"]]:
        '''
        ...
        haResourceSpec: HA resource specifications.
        When ChargeType is configured as PRE, the resource specification parameters must be filled.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosInstanceV2.HaResourceSpecProperty"]], jsii.get(self, "haResourceSpec"))

    @ha_resource_spec.setter
    def ha_resource_spec(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosInstanceV2.HaResourceSpecProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4c5a3e13761fa909277fda6d8758756f730cad6dba16a53343e0432c0d4228de)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "haResourceSpec", value)

    @builtins.property
    @jsii.member(jsii_name="haVSwitchIds")
    def ha_v_switch_ids(
        self,
    ) -> typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: haVSwitchIds: HA VSwitch IDs.
        '''
        return typing.cast(typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "haVSwitchIds"))

    @ha_v_switch_ids.setter
    def ha_v_switch_ids(
        self,
        value: typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9e6fa3e25a7c4d063badef6d247ddf0e4be085a5d312202b420b1f9fd34cf4eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "haVSwitchIds", value)
    ...
    def monitor_type(
        ...
        :Property: monitorType: The monitor type, the value of the value is as follows: TAIHAO, ARMS
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "monitorType"))
    ...
    def monitor_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb53a366271c2f144679e114782270dae2ff9b3dfa80d58b68bbcc4011e1768a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-flink.RosInstanceV2.HaResourceSpecProperty",
        jsii_struct_bases=[],
        name_mapping={"cpu": "cpu", "memory_gb": "memoryGb"},
    )
    class HaResourceSpecProperty:
        def __init__(
            self,
            *,
            cpu: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__a5433e19eb30b4afa7659e47c1e35989c30e95040ec92a2cdff6f3d8416a8496)
                check_type(argname="argument cpu", value=cpu, expected_type=type_hints["cpu"])
                check_type(argname="argument memory_gb", value=memory_gb, expected_type=type_hints["memory_gb"])
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if cpu is not None:
        ...
        def __repr__(self) -> str:
            return "HaResourceSpecProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
...
class RosInstanceV2Props:
    def __init__(
        ...
        *,
        ...
        :param auto_renew: 
        :param duration: 
        :param ha_resource_spec: 
        :param ha_v_switch_ids: 
        :param monitor_type: 
        :param pricing_cycle: 
        :param promotion_code: 
        :param resource_spec: 
...
def _typecheckingstub__a37e70a1815bd2e45b69f70071a89f7d2ba40532370e48b748846223d209067e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__4c5a3e13761fa909277fda6d8758756f730cad6dba16a53343e0432c0d4228de(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosInstanceV2.HaResourceSpecProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9e6fa3e25a7c4d063badef6d247ddf0e4be085a5d312202b420b1f9fd34cf4eb(
    value: typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fb53a366271c2f144679e114782270dae2ff9b3dfa80d58b68bbcc4011e1768a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a5433e19eb30b4afa7659e47c1e35989c30e95040ec92a2cdff6f3d8416a8496(
    *,
    cpu: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    memory_gb: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
