...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-nlb.HdMonitorRegionConfigProps",
    jsii_struct_bases=[],
    name_mapping={"log_project": "logProject", "metric_store": "metricStore"},
)
class HdMonitorRegionConfigProps:
    def __init__(
        self,
        *,
        log_project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        metric_store: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        ...
        :param log_project: Property logProject: The name of the LogProject.
        :param metric_store: Property metricStore: The name of the MetricStore.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f348289c6b7be180148520b65f5ed78c9121f9a5e311de5ff52647b727c6cb74)
            check_type(argname="argument log_project", value=log_project, expected_type=type_hints["log_project"])
            check_type(argname="argument metric_store", value=metric_store, expected_type=type_hints["metric_store"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    def metric_store(
        ...
        result = self._values.get("metric_store")
        assert result is not None, "Required property 'metric_store' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def __repr__(self) -> str:
        return "HdMonitorRegionConfigProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-nlb.IHdMonitorRegionConfig")
class IHdMonitorRegionConfig(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrMetricStore")
    def attr_metric_store(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> HdMonitorRegionConfigProps:
        ...


class _IHdMonitorRegionConfigProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``HdMonitorRegionConfig``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-nlb.IHdMonitorRegionConfig"
    ...
    def attr_metric_store(
        ...
        '''Attribute MetricStore: The name of the MetricStore.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrMetricStore"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> HdMonitorRegionConfigProps:
        return typing.cast(HdMonitorRegionConfigProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IHdMonitorRegionConfig).__jsii_proxy_class__ = lambda : _IHdMonitorRegionConfigProxy
...
class ListenerProps:
    def __init__(
        ...
        *,
        ...
        server_group_tuples: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosListener.ServerGroupTuplesProperty", typing.Dict[builtins.str, typing.Any]]]]]] = None,
        ...
        :param listener_protocol: Property listenerProtocol: Listening protocol. Values: TCP, UDP, or TCPSSL.
        ...
        :param server_group_tuples: Property serverGroupTuples: Multi-server group list. When the number of destination server groups is 1, the default value is 100 if no weight is specified. When the number of destination server groups is greater than 1, the user needs to specify the weight value.
    ...
    def server_group_tuples(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosListener.ServerGroupTuplesProperty"]]]]:
        ...
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosListener.ServerGroupTuplesProperty"]]]], result)
...
class RosHdMonitorRegionConfig(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-nlb.RosHdMonitorRegionConfig",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::NLB::HdMonitorRegionConfig``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``HdMonitorRegionConfig`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-nlb-hdmonitorregionconfig
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosHdMonitorRegionConfigProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5f166948af292202c240b600e3a7f1d200a633e809c0461c5a6844e7b104dd0e)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bc672523662cae2eec512dc5cb1a4a899251e6ac79769ade056515b0b1e12f5d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrMetricStore")
    def attr_metric_store(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: MetricStore: The name of the MetricStore.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrMetricStore"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bb56522eff663d357f62e02fcb76783b28bc7c0494657426cd0939adfbe91695)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def log_project(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__06a2abeee5cff57ccff2b557b5fb83d57eb3c48c5f197c10303502b89fcb6f94)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "logProject", value)

    @builtins.property
    @jsii.member(jsii_name="metricStore")
    def metric_store(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: metricStore: The name of the MetricStore.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "metricStore"))
    ...
    def metric_store(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6c3ef0e3c4d86e12c01e9a9cc5e0a66e120dce280807477b8092fbe0ae9316e2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "metricStore", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-nlb.RosHdMonitorRegionConfigProps",
    jsii_struct_bases=[],
    name_mapping={"log_project": "logProject", "metric_store": "metricStore"},
)
class RosHdMonitorRegionConfigProps:
    def __init__(
        self,
        *,
        log_project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ceea3a4485b05613b26affa136cb05a423aa2cb3862cb83c042cbe39278a960)
            check_type(argname="argument log_project", value=log_project, expected_type=type_hints["log_project"])
            check_type(argname="argument metric_store", value=metric_store, expected_type=type_hints["metric_store"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "log_project": log_project,
    ...
    def __repr__(self) -> str:
        return "RosHdMonitorRegionConfigProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosListener(
    ...
    def server_group_id(
        ...
        :Property: serverGroupId: ID of the ServerGroup
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "serverGroupId"))
    ...
    @builtins.property
    @jsii.member(jsii_name="serverGroupTuples")
    def server_group_tuples(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosListener.ServerGroupTuplesProperty"]]]]:
        '''
        ...
        serverGroupTuples: Multi-server group list.
        When the number of destination server groups is 1, the default value is 100 if no weight is specified.
        When the number of destination server groups is greater than 1, the user needs to specify the weight value.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosListener.ServerGroupTuplesProperty"]]]], jsii.get(self, "serverGroupTuples"))

    @server_group_tuples.setter
    def server_group_tuples(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosListener.ServerGroupTuplesProperty"]]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ad6a4201c58aca7e9c0b3288a6622bc9c05b1ac3b7126607e38867662b44632)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "serverGroupTuples", value)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-nlb.RosListener.ServerGroupTuplesProperty",
        jsii_struct_bases=[],
    ...
    class ServerGroupTuplesProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__b2559b308d829e065e4eb1ad22427ecbd39a749ea9f9f649a974687da51059ab)
                check_type(argname="argument server_group_id", value=server_group_id, expected_type=type_hints["server_group_id"])
                check_type(argname="argument weight", value=weight, expected_type=type_hints["weight"])
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if server_group_id is not None:
    ...
    class HealthCheckConfigProperty:
        def __init__(
            ...
            *,
            ...
            http_check_method: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            ...
            if http_check_method is not None:
                self._values["http_check_method"] = http_check_method
...
class BackendServerAttachment(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::NLB::BackendServerAttachment``, which is used to add backend servers to a Network Load Balancer (NLB) server group.
...
@jsii.implements(IHdMonitorRegionConfig)
class HdMonitorRegionConfig(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-nlb.HdMonitorRegionConfig",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::NLB::HdMonitorRegionConfig``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosHdMonitorRegionConfig``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-nlb-hdmonitorregionconfig
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[HdMonitorRegionConfigProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__391e7dbaba0b8d808fdf2bdb1de6241da85d24c915d30811bf6279ab1adc6821)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__720517066a305b06b2f1f7dfd06cc1c643dda81f6981dacade48173dd60ed749)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ddefe1e0e53c5cf6eb4f1356e09cc2d66acce39e815ce5859d268e1860b089e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5702ab2a82bdda01a17c5eb85c9763f64c1de55399fb31429ca4a82bbeb8884e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "HdMonitorRegionConfig",
    "HdMonitorRegionConfigProps",
    "IBackendServerAttachment",
    "IHdMonitorRegionConfig",
    "IListener",
    "ILoadBalancer",
    ...
    "RosHdMonitorRegionConfig",
    "RosHdMonitorRegionConfigProps",
    "RosListener",
    "RosListenerProps",
    "RosLoadBalancer",
...
def _typecheckingstub__f348289c6b7be180148520b65f5ed78c9121f9a5e311de5ff52647b727c6cb74(
    *,
    log_project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    metric_store: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__5f166948af292202c240b600e3a7f1d200a633e809c0461c5a6844e7b104dd0e(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosHdMonitorRegionConfigProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__bc672523662cae2eec512dc5cb1a4a899251e6ac79769ade056515b0b1e12f5d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bb56522eff663d357f62e02fcb76783b28bc7c0494657426cd0939adfbe91695(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__06a2abeee5cff57ccff2b557b5fb83d57eb3c48c5f197c10303502b89fcb6f94(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6c3ef0e3c4d86e12c01e9a9cc5e0a66e120dce280807477b8092fbe0ae9316e2(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5ceea3a4485b05613b26affa136cb05a423aa2cb3862cb83c042cbe39278a960(
    *,
    log_project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    metric_store: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__0ad6a4201c58aca7e9c0b3288a6622bc9c05b1ac3b7126607e38867662b44632(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosListener.ServerGroupTuplesProperty]]]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__b2559b308d829e065e4eb1ad22427ecbd39a749ea9f9f649a974687da51059ab(
    *,
    server_group_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    weight: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__391e7dbaba0b8d808fdf2bdb1de6241da85d24c915d30811bf6279ab1adc6821(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[HdMonitorRegionConfigProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__720517066a305b06b2f1f7dfd06cc1c643dda81f6981dacade48173dd60ed749(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0ddefe1e0e53c5cf6eb4f1356e09cc2d66acce39e815ce5859d268e1860b089e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5702ab2a82bdda01a17c5eb85c9763f64c1de55399fb31429ca4a82bbeb8884e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
