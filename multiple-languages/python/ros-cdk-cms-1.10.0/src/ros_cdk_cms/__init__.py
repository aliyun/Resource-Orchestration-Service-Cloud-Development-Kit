...
class ContactProps:
    def __init__(
        self,
        *,
        channels: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosContact.ChannelsProperty", typing.Dict[builtins.str, typing.Any]]],
    ...
    def channels(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosContact.ChannelsProperty"]:
        ...
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosContact.ChannelsProperty"], result)
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IContact")
class IContact(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Contact``.'''

    @builtins.property
    @jsii.member(jsii_name="attrContactName")
    def attr_contact_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def props(self) -> ContactProps:
        ...


class _IContactProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``Contact``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IContact"
    ...
    def attr_contact_name(
        ...
        '''Attribute ContactName: The name of the alarm contact.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrContactName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ContactProps:
        return typing.cast(ContactProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IContact).__jsii_proxy_class__ = lambda : _IContactProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IContactGroup")
class IContactGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``ContactGroup``.'''

    @builtins.property
    @jsii.member(jsii_name="attrContactGroupName")
    def attr_contact_group_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ContactGroupProps:
        ...


class _IContactGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ContactGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IContactGroup"
    ...
    def attr_contact_group_name(
        ...
        '''Attribute ContactGroupName: The name of the alert contact group.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrContactGroupName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ContactGroupProps:
        return typing.cast(ContactGroupProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IContactGroup).__jsii_proxy_class__ = lambda : _IContactGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IDynamicTagGroup")
class IDynamicTagGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DynamicTagGroupProps:
        ...


class _IDynamicTagGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DynamicTagGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IDynamicTagGroup"
    ...
    def attr_tag_key(
        ...
        '''Attribute TagKey: Tag key.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTagKey"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DynamicTagGroupProps:
        return typing.cast(DynamicTagGroupProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDynamicTagGroup).__jsii_proxy_class__ = lambda : _IDynamicTagGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IEventRule")
class IEventRule(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> EventRuleProps:
        ...


class _IEventRuleProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``EventRule``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IEventRule"
    ...
    def attr_data(
        ...
        '''Attribute Data: Number of rows affected.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrData"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> EventRuleProps:
        return typing.cast(EventRuleProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IEventRule).__jsii_proxy_class__ = lambda : _IEventRuleProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IEventRuleTargets")
class IEventRuleTargets(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``EventRuleTargets``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> EventRuleTargetsProps:
        ...


class _IEventRuleTargetsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``EventRuleTargets``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IEventRuleTargets"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> EventRuleTargetsProps:
        return typing.cast(EventRuleTargetsProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IEventRuleTargets).__jsii_proxy_class__ = lambda : _IEventRuleTargetsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IGroupMetricRule")
class IGroupMetricRule(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> GroupMetricRuleProps:
        ...


class _IGroupMetricRuleProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``GroupMetricRule``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IGroupMetricRule"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> GroupMetricRuleProps:
        return typing.cast(GroupMetricRuleProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IGroupMetricRule).__jsii_proxy_class__ = lambda : _IGroupMetricRuleProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMetricRuleTargets")
class IMetricRuleTargets(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTargetsProps":
        ...


class _IMetricRuleTargetsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MetricRuleTargets``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMetricRuleTargets"
    ...
    def attr_arns(
        ...
        '''Attribute Arns: The ARN list of targets.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrArns"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTargetsProps":
        return typing.cast("MetricRuleTargetsProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMetricRuleTargets).__jsii_proxy_class__ = lambda : _IMetricRuleTargetsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMetricRuleTemplate")
class IMetricRuleTemplate(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTemplateProps":
        ...


class _IMetricRuleTemplateProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MetricRuleTemplate``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMetricRuleTemplate"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTemplateProps":
        return typing.cast("MetricRuleTemplateProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMetricRuleTemplate).__jsii_proxy_class__ = lambda : _IMetricRuleTemplateProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMetricRuleTemplateDeployment")
class IMetricRuleTemplateDeployment(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTemplateDeploymentProps":
        ...


class _IMetricRuleTemplateDeploymentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MetricRuleTemplateDeployment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMetricRuleTemplateDeployment"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "MetricRuleTemplateDeploymentProps":
        return typing.cast("MetricRuleTemplateDeploymentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMetricRuleTemplateDeployment).__jsii_proxy_class__ = lambda : _IMetricRuleTemplateDeploymentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMonitorGroup")
...
class _IMonitorGroupProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMonitorGroup"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMonitorGroupInstances")
class IMonitorGroupInstances(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitorGroupInstancesProps":
        ...


class _IMonitorGroupInstancesProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MonitorGroupInstances``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMonitorGroupInstances"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitorGroupInstancesProps":
        return typing.cast("MonitorGroupInstancesProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMonitorGroupInstances).__jsii_proxy_class__ = lambda : _IMonitorGroupInstancesProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMonitoringAgent")
class IMonitoringAgent(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``MonitoringAgent``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitoringAgentProps":
        ...


class _IMonitoringAgentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MonitoringAgent``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMonitoringAgent"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitoringAgentProps":
        return typing.cast("MonitoringAgentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMonitoringAgent).__jsii_proxy_class__ = lambda : _IMonitoringAgentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IMonitoringAgentProcess")
class IMonitoringAgentProcess(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitoringAgentProcessProps":
        ...


class _IMonitoringAgentProcessProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MonitoringAgentProcess``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IMonitoringAgentProcess"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "MonitoringAgentProcessProps":
        return typing.cast("MonitoringAgentProcessProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMonitoringAgentProcess).__jsii_proxy_class__ = lambda : _IMonitoringAgentProcessProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.INamespace")
...
class _INamespaceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.INamespace"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.IResourceMetricRule")
class IResourceMetricRule(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ResourceMetricRuleProps":
        ...


class _IResourceMetricRuleProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ResourceMetricRule``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.IResourceMetricRule"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "ResourceMetricRuleProps":
        return typing.cast("ResourceMetricRuleProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IResourceMetricRule).__jsii_proxy_class__ = lambda : _IResourceMetricRuleProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.ISiteMonitor")
class ISiteMonitor(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SiteMonitorProps":
        ...


class _ISiteMonitorProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SiteMonitor``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.ISiteMonitor"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "SiteMonitorProps":
        return typing.cast("SiteMonitorProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISiteMonitor).__jsii_proxy_class__ = lambda : _ISiteMonitorProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cms.ISlsGroup")
class ISlsGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupConfig")
    def attr_sls_group_config(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupDescription")
    def attr_sls_group_description(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupName")
    def attr_sls_group_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SlsGroupProps":
        ...


class _ISlsGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SlsGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cms.ISlsGroup"
    ...
    def attr_sls_group_config(
        ...
        '''Attribute SlsGroupConfig: The configurations of the Logstore group.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSlsGroupConfig"))
    ...
    def attr_sls_group_description(
        ...
        '''Attribute SlsGroupDescription: The description of the Logstore group.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSlsGroupDescription"))
    ...
    def attr_sls_group_name(
        ...
        '''Attribute SlsGroupName: The name of the Logstore group.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSlsGroupName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SlsGroupProps":
        return typing.cast("SlsGroupProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISlsGroup).__jsii_proxy_class__ = lambda : _ISlsGroupProxy


@jsii.implements(IMetricRuleTargets)
class MetricRuleTargets(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMetricRuleTargets``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__331ed83a12c34a904f7241859aef020fe2796a84405f43eb8d5101844b050488)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__642511b1800ab1c6f9c42dacf39c17166f2f74842e86f63c8e78c128ccebf799)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__14f5febcd05284c051ab488a635a30853d14f088af7c648387fa57818d349821)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.implements(IMetricRuleTemplate)
class MetricRuleTemplate(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMetricRuleTemplate``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a32a00a819ba5330b1f8597894f63f1ce68e2ee6e07ec5f8d12e158eef916b91)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8fe7d2cf5de22f83ac8ad7d08723388758f672de43f054ee2561a4a28724afd9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__364f65af65de80dfd8564faef81f8863765f76e22d911e0772abe2b0833cd418)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IMetricRuleTemplateDeployment)
class MetricRuleTemplateDeployment(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.MetricRuleTemplateDeployment",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMetricRuleTemplateDeployment``for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["MetricRuleTemplateDeploymentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__51cc36fbe9600def96abc9f48ef8cdbdbd99534cce6250ef7cbf0847720e7456)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fd6f4a4210be1ca0817c05698c32e22c76b2304d5b6f18972c454471f2ff955c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1eb0fa418131dd59e06174fc21eb288e768239566a04994ba9dddcc3afd75e42)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d359fca79bd1ced65f99c56b08b5233b3de37f6766d7e891cd89b8a2da98aae)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.MetricRuleTemplateDeploymentProps",
    jsii_struct_bases=[],
    name_mapping={
        "group_id": "groupId",
...
class MetricRuleTemplateDeploymentProps:
    def __init__(
        self,
        *,
        group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
        template_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        append_mode: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        apply_mode: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        enable_end_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        enable_start_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        notify_level: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        silence_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        webhook: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        :param group_id: Property groupId: Apply group ID. For how to get the application group ID, see DescribeMonitorGroups.
        :param template_ids: Property templateIds: The ID list of the Alarm Template to be applied. For how to get the alarm template ID, see DescribeMetricRuleTemplateList.
        :param append_mode: Property appendMode: Template application policy.Value: all: Delete all rules created by the alarm template on the selected group, and then create a new alarm rule by the template (default). append: Delete the rules created by the alarm template on the selected group, and then create a new alarm rule based on the current template.
        :param apply_mode: Property applyMode: How to apply templates.Value: GROUP_INSTANCE_FIRST: Application grouping instances are preferred.When applying an alarm template, the application grouping instance is preferred. If the instance does not exist in the application grouping, the rules in the template are ignored. ALARM_TEMPLATE_FIRST: Alarm template instances are preferred.When an alarm template is applied, an alarm rule is created regardless of whether the instance exists in the application group.
        :param enable_end_time: Property enableEndTime: The end time when the alarm takes effect.Value range: 0~23, indicating 00:59 to 23:59.
        :param enable_start_time: Property enableStartTime: The start time when the alarm takes effect.Value range: 0~23, indicating 00:00 to 23:00.
        :param notify_level: Property notifyLevel: Alarm notification method.Value: 2: Phone + SMS + Email + Wangwang + DingTalk Robot. 3: SMS + Email + Wangwang + DingTalk Robot. 4: Wangwang + Dingding Robot.
        :param silence_time: Property silenceTime: Channel silence period.Unit: seconds.Default value: 86400. Note When the monitoring data continues to exceed the alarm rule threshold, only one alarm notification will be sent during each silence cycle.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__633a8326a148e5af94c30ea5aa5056f5db9d60d2a6d6ae7ced5438a493c32b86)
            check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
            check_type(argname="argument template_ids", value=template_ids, expected_type=type_hints["template_ids"])
            check_type(argname="argument append_mode", value=append_mode, expected_type=type_hints["append_mode"])
            check_type(argname="argument apply_mode", value=apply_mode, expected_type=type_hints["apply_mode"])
            check_type(argname="argument enable_end_time", value=enable_end_time, expected_type=type_hints["enable_end_time"])
            check_type(argname="argument enable_start_time", value=enable_start_time, expected_type=type_hints["enable_start_time"])
            check_type(argname="argument notify_level", value=notify_level, expected_type=type_hints["notify_level"])
            check_type(argname="argument silence_time", value=silence_time, expected_type=type_hints["silence_time"])
            check_type(argname="argument webhook", value=webhook, expected_type=type_hints["webhook"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "group_id": group_id,
        ...
        if append_mode is not None:
            self._values["append_mode"] = append_mode
        if apply_mode is not None:
            self._values["apply_mode"] = apply_mode
        if enable_end_time is not None:
            self._values["enable_end_time"] = enable_end_time
        if enable_start_time is not None:
            self._values["enable_start_time"] = enable_start_time
        if notify_level is not None:
            self._values["notify_level"] = notify_level
        if silence_time is not None:
            self._values["silence_time"] = silence_time
        if webhook is not None:
            self._values["webhook"] = webhook
    ...
    def template_ids(
        ...
        assert result is not None, "Required property 'template_ids' is missing"
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], result)
    ...
    def append_mode(
        ...
        result = self._values.get("append_mode")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def apply_mode(
        ...
        result = self._values.get("apply_mode")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def notify_level(
        ...
        result = self._values.get("notify_level")
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "MetricRuleTemplateDeploymentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class MonitorGroup(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d5debb9d21e7c01fb769b94ae9890260e9c797564aadb9f53b0bf29b58cf8044)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d3d0898870200202264cf7f5c89a6c1a4c64b5ab2fc13789cf9f9166b4c94c3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2db7c206d440d2c06fa79c6754dd449d97b5701c7fe59c8927fcf44be1a1e192)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IMonitorGroupInstances)
class MonitorGroupInstances(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMonitorGroupInstances``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c44d97723a166ce8ce1ff1b1bda1a9477ec40287ba50f27d25e73620d959288c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__23d33c2251b2a6a7d825cfc8d8762c8b6b2fafdc30fe40a29f7acd0234c7879e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8ac74d6b5ae545545d88c5a023b61edaacb98ebc8a93de901bfaf1c9e79c2e53)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IMonitoringAgent)
class MonitoringAgent(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.MonitoringAgent",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMonitoringAgent``for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union["MonitoringAgentProps", typing.Dict[builtins.str, typing.Any]]] = None,
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__866d877b90c5459e51fa9de3dc4b00a3d4ac53d15be06c41b8ff67c010054717)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ef660dfa662a0271d39383d0564fd0870411affcdfc773f543a7acc287b59817)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f8b210e7a0ac7c987943ba24a4cc7f1e2492cab72de6722a9b871f36962d8976)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a8742171f17eacfe198b42a901f1873c251df663313c11453c4e0a23ae1531ba)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IMonitoringAgentProcess)
class MonitoringAgentProcess(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosMonitoringAgentProcess``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a1ce608b4275b9188b91a8cfcea944fbd2ea275dbcc8c58aa43091fd292774fc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__456e30c46c21268686c642bebf4821c105b1f16048babf415ecd64d9a0838958)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6fc7a8c1070f0ef1c80b41a3b683fef9dc2855df76eb5b7435d30661cef1038f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.MonitoringAgentProps",
    jsii_struct_bases=[],
    name_mapping={
        "force": "force",
...
class MonitoringAgentProps:
    def __init__(
        self,
        *,
        force: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        install_command: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param force: Property force: Specifies whether to install the CloudMonitor agent. Valid values: true (default value): yes false: no
        :param install_command: Property installCommand: Specifies whether to install the CloudMonitor agent on all ECS instances that belong to the current Alibaba Cloud account. Valid values: onlyInstallNotHasAgent: installs the latest version of the CloudMonitor agent only on ECS instances on which the agent is not installed. onlyUpgradeAgent: upgrades the CloudMonitor agent to the latest version only for ECS instances on which an earlier version of the agent is installed. installAndUpgrade: installs the latest version of the CloudMonitor agent on ECS instances on which the agent is not installed, and upgrades the CloudMonitor agent to the latest version for ECS instances on which an earlier version of the agent is installed. Note If you set the InstallCommand parameter, the InstanceIds parameter does not take effect.
        :param instance_ids: Property instanceIds: Alibaba Cloud host ID. The range of n: 1 ~ 10. Explain that InstallCommand and InstanceIds must be selected one by one.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b6068c8d27d399a806bf1191b21f0282d004acf3f7106c96072d45d451081386)
    ...
    def __repr__(self) -> str:
        return "MonitoringAgentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class Namespace(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.Namespace",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ce3f0a5a2c6efb0be9b108b1b0a4a4002b0c19f569c17a7d29ab9b320dcd20f)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4bd410d1a4accfbfc121f1d558798d0a93b26cc7995b2d3d34dc34956f0ccf75)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d7f775c691962199369bcc27928b30b867c36ef54cb5e4f7bad62d7170dd4789)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f0069e7d9b5eb64faf9e1c1befcd1147eecd8b3aaff3d394e7262a73204c9a9e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.NamespaceProps",
    jsii_struct_bases=[],
    name_mapping={
        "namespace": "namespace",
        "description": "description",
...
class NamespaceProps:
    def __init__(
        ...
        *,
        ...
        :param namespace: Property namespace: The name of the namespace. The name can contain lowercase letters, digits, and hyphens (-).
        :param description: Property description: The description of the namespace.
        :param specification: Property specification: The data retention period of the namespace. Valid values: - cms.s1.large: Data storage duration is 15 days. - cms.s1.xlarge: Data storage duration is 32 days. - cms.s1.2xlarge: Data storage duration 63 days. - cms.s1.3xlarge: Data storage duration 93 days. - cms.s1.6xlarge: Data storage duration 185 days. - cms.s1.12xlarge: Data storage duration 376 days.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__84d27dc65312685abb5e766f928eb2451037435b614657310c0b88e3c3e15bbd)
            check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
...
@jsii.implements(IResourceMetricRule)
class ResourceMetricRule(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosResourceMetricRule``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__393fcce4beb55ce7a50a70d52c67a5d43b14a58456196e13e943381f7501c5d0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9c45320e6094e7700f26134086bc090892d3289cdb21ef534699c85bee759200)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fdce6142db692204d119218111ab2363c2984065c84a0fb9d5af4b87b4b05eb7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class RosContact(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Contact`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-contact
    '''
    ...
    def channels(
        ...
        :Property: channels: undefined
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosContact.ChannelsProperty"], jsii.get(self, "channels"))

    @channels.setter
    def channels(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosContact.ChannelsProperty"],
    ) -> None:
        if __debug__:
...
class RosContactGroup(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ContactGroup`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-contactgroup
    '''
...
class RosDynamicTagGroup(
    ...
    This class does not contain additional functions, so it is recommended to use the ``DynamicTagGroup`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-dynamictaggroup
    '''
...
class RosEventRule(
    ...
    This class does not contain additional functions, so it is recommended to use the ``EventRule`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-eventrule
    '''
    ...
    class EventPatternProperty:
        def __init__(
            self,
            *,
            custom_filters: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            ...
            sql_filter: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
class RosEventRuleTargets(
    ...
    This class does not contain additional functions, so it is recommended to use the ``EventRuleTargets`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-eventruletargets
    '''
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={"identity": "identity", "queue": "queue", "region": "region"},
    )
...
class RosGroupMetricRule(
    ...
    This class does not contain additional functions, so it is recommended to use the ``GroupMetricRule`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-groupmetricrule
    '''
...
class RosMetricRuleTargets(
    ...
    This class does not contain additional functions, so it is recommended to use the ``MetricRuleTargets`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-metricruletargets
    '''
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={"arn": "arn", "identity": "identity", "level": "level"},
    )
...
class RosMetricRuleTemplate(
    ...
    This class does not contain additional functions, so it is recommended to use the ``MetricRuleTemplate`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-metricruletemplate
    '''
...
class RosMetricRuleTemplateDeployment(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.RosMetricRuleTemplateDeployment",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``MetricRuleTemplateDeployment`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-metricruletemplatedeployment
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosMetricRuleTemplateDeploymentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fd06bfc7abba65d2bafb9f5fea7ddb7d64c21ccfb5ee2f2d4a616e35091f77f4)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__348d82731c97df64a28729319fa874d616abab8a0911a314e7f8b46694e0ea2d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d7ad11259db1bf0b97f30ede71eb4401b063d3bc81dd40eccad87f4b233a3eb3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def group_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad1ef7c617104a8242c29d744c1e1aa2cc0a9a1d12f2a290fbe38f22a6f1433c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "groupId", value)
    ...
    def template_ids(
        ...
        templateIds: The ID list of the Alarm Template to be applied.
        For how to get the alarm template ID, see DescribeMetricRuleTemplateList.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "templateIds"))
    ...
    def template_ids(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0c9fa6f8fc02547a42d595ad84ea606518327707f1777c5dd9ec17ff6988bf8e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "templateIds", value)

    @builtins.property
    @jsii.member(jsii_name="appendMode")
    def append_mode(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        appendMode: Template application policy.Value:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "appendMode"))
    ...
    def append_mode(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5548bdce6dac6c2d2eeb468a6ce33212129dd0559c2fb7bbb1a46fdb5460ce02)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "appendMode", value)

    @builtins.property
    @jsii.member(jsii_name="applyMode")
    def apply_mode(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        applyMode: How to apply templates.Value:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "applyMode"))
    ...
    def apply_mode(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc3b46e9f5a39e6f0cf6b0c23d0037ff0cac4dadf8165c4b5595a54ffd3f02cb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applyMode", value)

    @builtins.property
    @jsii.member(jsii_name="enableEndTime")
    def enable_end_time(
        self,
    ) -> typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: enableEndTime: The end time when the alarm takes effect.Value range: 0~23, indicating 00:59 to 23:59.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "enableEndTime"))
    ...
    def enable_end_time(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9804b52ba317217ff6331cf9dac4bacb929e1533daf04e58bfe32e693ceac50f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableEndTime", value)

    @builtins.property
    @jsii.member(jsii_name="enableStartTime")
    def enable_start_time(
        self,
    ) -> typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: enableStartTime: The start time when the alarm takes effect.Value range: 0~23, indicating 00:00 to 23:00.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "enableStartTime"))
    ...
    def enable_start_time(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e749a4cd43987baa940a326cecbc7b0e29a7f90426d73164bcc039d39d9d3701)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableStartTime", value)

    @builtins.property
    @jsii.member(jsii_name="notifyLevel")
    def notify_level(
        self,
    ) -> typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        notifyLevel: Alarm notification method.Value:
        2: Phone + SMS + Email + Wangwang + DingTalk Robot.
        3: SMS + Email + Wangwang + DingTalk Robot.
        4: Wangwang + Dingding Robot.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "notifyLevel"))
    ...
    def notify_level(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__344da5bcc72e7e86d457e185389114310522ac77315406a6f5508fee5746890e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "notifyLevel", value)
    ...
    def silence_time(
        ...
        silenceTime: Channel silence period.Unit: seconds.Default value: 86400.
    ...
    def silence_time(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a6cba46304e379a8e75043f25bac82c9fa128d0d800592de86f3d728c2c78fd6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "silenceTime", value)
    ...
    def webhook(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d2930825e0086fe0753f7ca9e73e563f9c12779ec3a626882cfb216bbad91606)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "webhook", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.RosMetricRuleTemplateDeploymentProps",
    jsii_struct_bases=[],
    name_mapping={
        "group_id": "groupId",
        "template_ids": "templateIds",
...
class RosMetricRuleTemplateDeploymentProps:
    def __init__(
        self,
        *,
        group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param append_mode: 
        :param apply_mode: 
        :param enable_end_time: 
        :param enable_start_time: 
        :param notify_level: 
        :param silence_time: 
        :param webhook: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__730c3bba380910aec252ffdb8f2084300fa0c2ba0cb2482dc8a471a4fe1fed48)
            check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
            check_type(argname="argument template_ids", value=template_ids, expected_type=type_hints["template_ids"])
            check_type(argname="argument append_mode", value=append_mode, expected_type=type_hints["append_mode"])
            check_type(argname="argument apply_mode", value=apply_mode, expected_type=type_hints["apply_mode"])
    ...
    def __repr__(self) -> str:
        return "RosMetricRuleTemplateDeploymentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosMonitorGroupInstances(
    ...
    This class does not contain additional functions, so it is recommended to use the ``MonitorGroupInstances`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-monitorgroupinstances
    '''
...
class RosMonitoringAgent(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.RosMonitoringAgent",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``MonitoringAgent`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-monitoringagent
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosMonitoringAgentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__347033bd0a8df7cfd5ff03e1262db4595d234e57f8a5d007b5126c34ee19e222)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__81a5300c94a3ce29baae4d65b3498a6a3ca2d893f7a589f7217376cfc04f504e)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__67012519ca51380c5e7a037d5338949d745c721ed014259ff1cfcf1b6bb36a59)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def force(
        ...
        force: Specifies whether to install the CloudMonitor agent. Valid values:
        true (default value): yes
        false: no
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "force"))
    ...
    def force(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2758e18db33687f082166088d268967f35cfc90c26ee240e8b2bf0c1bb74c5d8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def install_command(
        ...
        installCommand: Specifies whether to install the CloudMonitor agent on all ECS instances that belong to the current Alibaba Cloud account. Valid values:
        onlyInstallNotHasAgent: installs the latest version of the CloudMonitor agent only on ECS instances on which the agent is not installed.
        onlyUpgradeAgent: upgrades the CloudMonitor agent to the latest version only for ECS instances on which an earlier version of the agent is installed.
        installAndUpgrade: installs the latest version of the CloudMonitor agent on ECS instances on which the agent is not installed, and upgrades the CloudMonitor agent to the latest version for ECS instances on which an earlier version of the agent is installed.
        Note If you set the InstallCommand parameter, the InstanceIds parameter does not take effect.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "installCommand"))
    ...
    def install_command(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__62b5905ca1c27503229a3c947b4c839ed00b7e27c26207d3b1455f62bb500cf8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def instance_ids(
        ...
        instanceIds: Alibaba Cloud host ID.
        The range of n: 1 ~ 10.
        Explain that InstallCommand and InstanceIds must be selected one by one.
        '''
    ...
    def instance_ids(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__775b197959d39cd4b630caa29f23e2f161a9e5a9a1c3a37052174525b2753931)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosMonitoringAgentProcess(
    ...
    This class does not contain additional functions, so it is recommended to use the ``MonitoringAgentProcess`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-monitoringagentprocess
    '''
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.RosMonitoringAgentProps",
    jsii_struct_bases=[],
    name_mapping={
        "force": "force",
        "install_command": "installCommand",
...
class RosMonitoringAgentProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__547ef09bcb5cc34c6bb88c0e4e89f8aec18a907c8dfea326aa24622be6edf2ef)
            check_type(argname="argument force", value=force, expected_type=type_hints["force"])
            check_type(argname="argument install_command", value=install_command, expected_type=type_hints["install_command"])
            check_type(argname="argument instance_ids", value=instance_ids, expected_type=type_hints["instance_ids"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "RosMonitoringAgentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosNamespace(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.RosNamespace",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__054ef03d146431bc9b67370bfbea264c132dc83b4169b4c89005ffce9bb0609b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__91d7101c85be24e65402a306120c0f4a148d832a1e888b96cba51d4615439a3d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def attr_create_time(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        ...
        CreateTime: The timestamp that was generated when the namespace was created.
        Unit: milliseconds.
        '''
    ...
    def attr_specification(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        ...
        Specification: The data retention period of the namespace. Valid values:
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2a600fccb334cfd868df5c4dfb0c2334eff823bcaed9cdc54f04a94699a891a0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def namespace(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ca92987f7e2099ee766357d80bb8c62d6b90ac4412d6f7df4b7595fdbe54c143)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "namespace", value)
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6b65217776bb0ec24f56297043e52c6df08709a21a0dc3fd7525f5d2dbf4f78a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)
    ...
    def specification(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bd44471a51ed011d08f727fd6f80c80bbe1852a90d1277ff626d598e924a943b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "specification", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.RosNamespaceProps",
    jsii_struct_bases=[],
    name_mapping={
        "namespace": "namespace",
        "description": "description",
...
class RosNamespaceProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25c923eff9195b0be0d13af3b67d4700bdee704f40a08f59c612683c963912a7)
            check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument specification", value=specification, expected_type=type_hints["specification"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
...
class RosResourceMetricRule(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ResourceMetricRule`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-resourcemetricrule
    '''
...
class RosSiteMonitor(
    ...
    This class does not contain additional functions, so it is recommended to use the ``SiteMonitor`` class instead of this class for a more convenient development experience.
...
class RosSlsGroup(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.RosSlsGroup",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``SlsGroup`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosSlsGroupProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f7d6e817cb2ed13ffa6efa92cb1da0b3b9ce75c9c0ed21f5122f3544273cd133)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__565757d772ab397387545344f11af475b135957063daa2a2ee6a30f444af6f17)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupConfig")
    def attr_sls_group_config(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: SlsGroupConfig: The configurations of the Logstore group.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrSlsGroupConfig"))

    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupDescription")
    def attr_sls_group_description(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: SlsGroupDescription: The description of the Logstore group.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrSlsGroupDescription"))

    @builtins.property
    @jsii.member(jsii_name="attrSlsGroupName")
    def attr_sls_group_name(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: SlsGroupName: The name of the Logstore group.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrSlsGroupName"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__884df8400f51f8cb9a1cf77c8e6a75597fac8e260dda8c664b512d76bbe3e93b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="slsGroupConfig")
    def sls_group_config(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosSlsGroup.SlsGroupConfigProperty"]]]:
        '''
        :Property: slsGroupConfig: The configurations of the Logstore group.Valid values of N: 1 to 25.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosSlsGroup.SlsGroupConfigProperty"]]], jsii.get(self, "slsGroupConfig"))

    @sls_group_config.setter
    def sls_group_config(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosSlsGroup.SlsGroupConfigProperty"]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7742f6d38bfc698c0953c0b04a95e835c4387d3b334015d1fb93888255ac39f5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "slsGroupConfig", value)
    ...
    def sls_group_name(
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "slsGroupName"))
    ...
    def sls_group_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3b75d1e1ff49744f12f2ed355fc11c6dadc71e83f3c48253fcb9f8aad61e59b4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "slsGroupName", value)

    @builtins.property
    @jsii.member(jsii_name="slsGroupDescription")
    def sls_group_description(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: slsGroupDescription: The description of the Logstore group.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "slsGroupDescription"))
    ...
    def sls_group_description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7914331f773f7ab670a1d35775e01689f2b4e02675f680a831fd0a19fb941b3a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "slsGroupDescription", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cms.RosSlsGroup.SlsGroupConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
            "sls_logstore": "slsLogstore",
            "sls_project": "slsProject",
            "sls_region": "slsRegion",
            "sls_user_id": "slsUserId",
        },
    )
    class SlsGroupConfigProperty:
        def __init__(
            self,
            *,
            ...
            sls_region: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            sls_user_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            :param sls_logstore: 
            :param sls_project: 
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__43b66963e9c0aecdd25587cc096e884cc32d755160a1e5a419f27f227fa4dce6)
                ...
                check_type(argname="argument sls_user_id", value=sls_user_id, expected_type=type_hints["sls_user_id"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
            ...
            if sls_user_id is not None:
                self._values["sls_user_id"] = sls_user_id
        ...
        def sls_region(
            ...
            assert result is not None, "Required property 'sls_region' is missing"
            return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
        ...
        def sls_user_id(
            ...
            '''
            result = self._values.get("sls_user_id")
            return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
        ...
        def __repr__(self) -> str:
            return "SlsGroupConfigProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.RosSlsGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "sls_group_config": "slsGroupConfig",
        "sls_group_name": "slsGroupName",
        "sls_group_description": "slsGroupDescription",
    },
)
class RosSlsGroupProps:
    def __init__(
        self,
        *,
        sls_group_config: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosSlsGroup.SlsGroupConfigProperty, typing.Dict[builtins.str, typing.Any]]]]],
        sls_group_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        sls_group_description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``RosSlsGroup``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-slsgroup

        :param sls_group_config: 
        :param sls_group_name: 
        :param sls_group_description: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3ebe3e9e67c594fdfc39c3766849fa251263e6aba750f5d11bc26b94a0c0ee4e)
            check_type(argname="argument sls_group_config", value=sls_group_config, expected_type=type_hints["sls_group_config"])
            check_type(argname="argument sls_group_name", value=sls_group_name, expected_type=type_hints["sls_group_name"])
            check_type(argname="argument sls_group_description", value=sls_group_description, expected_type=type_hints["sls_group_description"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "sls_group_config": sls_group_config,
            "sls_group_name": sls_group_name,
        }
        if sls_group_description is not None:
            self._values["sls_group_description"] = sls_group_description
    ...
    def sls_group_config(
        ...
        :Property: slsGroupConfig: The configurations of the Logstore group.Valid values of N: 1 to 25.
        '''
        result = self._values.get("sls_group_config")
        assert result is not None, "Required property 'sls_group_config' is missing"
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosSlsGroup.SlsGroupConfigProperty]]], result)
    ...
    def sls_group_name(
        ...
        assert result is not None, "Required property 'sls_group_name' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def sls_group_description(
        ...
        :Property: slsGroupDescription: The description of the Logstore group.
        '''
        result = self._values.get("sls_group_description")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "RosSlsGroupProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(ISiteMonitor)
class SiteMonitor(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosSiteMonitor``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-sitemonitor
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5b9d8331d0c1c9120df5b08a6144869492c3533b5335876ea9989cebb9e67884)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ff467fe381e068653f0d8b35a8ddc2e421ecccde731630e10974a1964cf73eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9a4eb98cba93fad6a6865453c0adc9c178a4b4d552474fa3b08551726ead5139)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ISlsGroup)
class SlsGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cms.SlsGroup",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosSlsGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-slsgroup
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["SlsGroupProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1e63b96682e3e9dd39ffde3e2d06e0db96d9e65e205c5fbaeafeaded708070ab)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6dbadac857c6742c0a161bc5bbc216e5c542ecb3796a289cd3ee492148873330)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f42a4baf76a4732f2431d2d5ecdbaae5c004f3e4aca83a30cb08f6d9b249f563)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__909b3587fd6eed35e7cfded0b4ed0cc14276bd361c97f81e8dcf3cc43e0238bd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cms.SlsGroupProps",
    jsii_struct_bases=[],
    name_mapping={
        "sls_group_config": "slsGroupConfig",
        "sls_group_name": "slsGroupName",
...
class SlsGroupProps:
    def __init__(
        ...
        *,
        ...
        :param sls_group_config: Property slsGroupConfig: The configurations of the Logstore group.Valid values of N: 1 to 25.
        :param sls_group_name: Property slsGroupName: The name of the Logstore group.The name must be 2 to 32 characters in length and can contain uppercase letters, lowercase letters, digits, and underscores (_). The name must start with a letter.
        :param sls_group_description: Property slsGroupDescription: The description of the Logstore group.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__319dad2eb301dadabc6bd2f1335b74282d6b1c0ad09ee72af6440cc4c5f86493)
            check_type(argname="argument sls_group_config", value=sls_group_config, expected_type=type_hints["sls_group_config"])
            check_type(argname="argument sls_group_name", value=sls_group_name, expected_type=type_hints["sls_group_name"])
            check_type(argname="argument sls_group_description", value=sls_group_description, expected_type=type_hints["sls_group_description"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    def __repr__(self) -> str:
        return "SlsGroupProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IContact)
class Contact(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosContact``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-contact
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4e933217156f501d8fdbbc9dc0332fa1af57d5923a9ed198b896a96e59fb8297)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6f4ff70b2695c94a5cf1c330eaad1005bfc44e9f2dd469aea231e9ec2f833326)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__16e04c558298df752fc81026ef63eadf9169ea932fe777198ce1a5d0fbe8c7b1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IContactGroup)
class ContactGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosContactGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-contactgroup
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__28d5fab2718f14080e1d2ec7f4f52440e23ce38c968845855c78b2c8dee4dbc5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4577b93426a97e3fa7737e9b84a10cae89a1ca23de44f1f0f7b5a3e92b36f9bc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ba0303c05a6bd291a068383cd739b02dc48e7016ca0963c56f0874890c054c2f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IDynamicTagGroup)
class DynamicTagGroup(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosDynamicTagGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-dynamictaggroup
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d8e9940d834ad136cb3ce982dc05516d087e435c262a1104477636d6d1e06b3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__36d073c3016dbe848ec276cc7add9b258eff35cff0d13970fab0c236fa15694c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6cdda6264e39b7341337e25390ea3f77284949b8ba8aedb6c3e5bcbd82ba59d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class EventRule(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosEventRule``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-eventrule
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__016c94a5b971e1d9b14dee91c364600765892cfd88dfa41bc0652e73dca19c00)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__09f720691dad313b129291c08312abbfd0edd117c34e0d2f5325b234328bf482)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7de929047d7785dfbb04b3dc0918c863da8571847314e7eb139163ffbd88a457)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IEventRuleTargets)
class EventRuleTargets(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosEventRuleTargets``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-eventruletargets
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0590d5cc2898a2662652d08ebb0521c70998315d33936cf02d1df0ed9d02158e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cf8c805dfdd8eaa9a0c0321899e3ef79475a96c7a3edafec57868ef67fe3fba2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ec8754c40a57c634412a44d1f0da991835177290504a1dd2b853ac6edc40efaf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IGroupMetricRule)
class GroupMetricRule(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosGroupMetricRule``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cms-groupmetricrule
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0287e7df13b40887c34eefc39e62a5c33987575c5736e912f6f4583ed693a85a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4c3521a0ac52f068b5b83a888193226e7633ca26e093f1cbeb405e23e9e6e5db)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dd0eb8d5f83f1c5163e2eb55416f8c8c71da3eece709f3f41c04f9e81284c1d3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "MetricRuleTemplateDeploymentProps",
    ...
    "RosMetricRuleTemplateDeployment",
    "RosMetricRuleTemplateDeploymentProps",
...
def _typecheckingstub__331ed83a12c34a904f7241859aef020fe2796a84405f43eb8d5101844b050488(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__642511b1800ab1c6f9c42dacf39c17166f2f74842e86f63c8e78c128ccebf799(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__14f5febcd05284c051ab488a635a30853d14f088af7c648387fa57818d349821(
...
def _typecheckingstub__a32a00a819ba5330b1f8597894f63f1ce68e2ee6e07ec5f8d12e158eef916b91(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8fe7d2cf5de22f83ac8ad7d08723388758f672de43f054ee2561a4a28724afd9(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__364f65af65de80dfd8564faef81f8863765f76e22d911e0772abe2b0833cd418(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__51cc36fbe9600def96abc9f48ef8cdbdbd99534cce6250ef7cbf0847720e7456(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[MetricRuleTemplateDeploymentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__fd6f4a4210be1ca0817c05698c32e22c76b2304d5b6f18972c454471f2ff955c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1eb0fa418131dd59e06174fc21eb288e768239566a04994ba9dddcc3afd75e42(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6d359fca79bd1ced65f99c56b08b5233b3de37f6766d7e891cd89b8a2da98aae(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__633a8326a148e5af94c30ea5aa5056f5db9d60d2a6d6ae7ced5438a493c32b86(
    *,
    group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    template_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    append_mode: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__d5debb9d21e7c01fb769b94ae9890260e9c797564aadb9f53b0bf29b58cf8044(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d3d0898870200202264cf7f5c89a6c1a4c64b5ab2fc13789cf9f9166b4c94c3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2db7c206d440d2c06fa79c6754dd449d97b5701c7fe59c8927fcf44be1a1e192(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__c44d97723a166ce8ce1ff1b1bda1a9477ec40287ba50f27d25e73620d959288c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__23d33c2251b2a6a7d825cfc8d8762c8b6b2fafdc30fe40a29f7acd0234c7879e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8ac74d6b5ae545545d88c5a023b61edaacb98ebc8a93de901bfaf1c9e79c2e53(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__866d877b90c5459e51fa9de3dc4b00a3d4ac53d15be06c41b8ff67c010054717(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[MonitoringAgentProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__ef660dfa662a0271d39383d0564fd0870411affcdfc773f543a7acc287b59817(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f8b210e7a0ac7c987943ba24a4cc7f1e2492cab72de6722a9b871f36962d8976(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a8742171f17eacfe198b42a901f1873c251df663313c11453c4e0a23ae1531ba(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a1ce608b4275b9188b91a8cfcea944fbd2ea275dbcc8c58aa43091fd292774fc(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__456e30c46c21268686c642bebf4821c105b1f16048babf415ecd64d9a0838958(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6fc7a8c1070f0ef1c80b41a3b683fef9dc2855df76eb5b7435d30661cef1038f(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__b6068c8d27d399a806bf1191b21f0282d004acf3f7106c96072d45d451081386(
    *,
    force: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    install_command: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    instance_ids: typing.Optional[typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__0ce3f0a5a2c6efb0be9b108b1b0a4a4002b0c19f569c17a7d29ab9b320dcd20f(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[NamespaceProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__4bd410d1a4accfbfc121f1d558798d0a93b26cc7995b2d3d34dc34956f0ccf75(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d7f775c691962199369bcc27928b30b867c36ef54cb5e4f7bad62d7170dd4789(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f0069e7d9b5eb64faf9e1c1befcd1147eecd8b3aaff3d394e7262a73204c9a9e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__84d27dc65312685abb5e766f928eb2451037435b614657310c0b88e3c3e15bbd(
    *,
    namespace: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    specification: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__393fcce4beb55ce7a50a70d52c67a5d43b14a58456196e13e943381f7501c5d0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9c45320e6094e7700f26134086bc090892d3289cdb21ef534699c85bee759200(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fdce6142db692204d119218111ab2363c2984065c84a0fb9d5af4b87b4b05eb7(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__fd06bfc7abba65d2bafb9f5fea7ddb7d64c21ccfb5ee2f2d4a616e35091f77f4(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosMetricRuleTemplateDeploymentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__348d82731c97df64a28729319fa874d616abab8a0911a314e7f8b46694e0ea2d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d7ad11259db1bf0b97f30ede71eb4401b063d3bc81dd40eccad87f4b233a3eb3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ad1ef7c617104a8242c29d744c1e1aa2cc0a9a1d12f2a290fbe38f22a6f1433c(
    value: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0c9fa6f8fc02547a42d595ad84ea606518327707f1777c5dd9ec17ff6988bf8e(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5548bdce6dac6c2d2eeb468a6ce33212129dd0559c2fb7bbb1a46fdb5460ce02(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dc3b46e9f5a39e6f0cf6b0c23d0037ff0cac4dadf8165c4b5595a54ffd3f02cb(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9804b52ba317217ff6331cf9dac4bacb929e1533daf04e58bfe32e693ceac50f(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e749a4cd43987baa940a326cecbc7b0e29a7f90426d73164bcc039d39d9d3701(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__344da5bcc72e7e86d457e185389114310522ac77315406a6f5508fee5746890e(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a6cba46304e379a8e75043f25bac82c9fa128d0d800592de86f3d728c2c78fd6(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d2930825e0086fe0753f7ca9e73e563f9c12779ec3a626882cfb216bbad91606(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__730c3bba380910aec252ffdb8f2084300fa0c2ba0cb2482dc8a471a4fe1fed48(
    *,
    group_id: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    template_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    append_mode: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__347033bd0a8df7cfd5ff03e1262db4595d234e57f8a5d007b5126c34ee19e222(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosMonitoringAgentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__81a5300c94a3ce29baae4d65b3498a6a3ca2d893f7a589f7217376cfc04f504e(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__67012519ca51380c5e7a037d5338949d745c721ed014259ff1cfcf1b6bb36a59(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2758e18db33687f082166088d268967f35cfc90c26ee240e8b2bf0c1bb74c5d8(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__62b5905ca1c27503229a3c947b4c839ed00b7e27c26207d3b1455f62bb500cf8(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__775b197959d39cd4b630caa29f23e2f161a9e5a9a1c3a37052174525b2753931(
    value: typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__547ef09bcb5cc34c6bb88c0e4e89f8aec18a907c8dfea326aa24622be6edf2ef(
    *,
    force: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    install_command: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    instance_ids: typing.Optional[typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__054ef03d146431bc9b67370bfbea264c132dc83b4169b4c89005ffce9bb0609b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosNamespaceProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__91d7101c85be24e65402a306120c0f4a148d832a1e888b96cba51d4615439a3d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2a600fccb334cfd868df5c4dfb0c2334eff823bcaed9cdc54f04a94699a891a0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ca92987f7e2099ee766357d80bb8c62d6b90ac4412d6f7df4b7595fdbe54c143(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6b65217776bb0ec24f56297043e52c6df08709a21a0dc3fd7525f5d2dbf4f78a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bd44471a51ed011d08f727fd6f80c80bbe1852a90d1277ff626d598e924a943b(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__25c923eff9195b0be0d13af3b67d4700bdee704f40a08f59c612683c963912a7(
    *,
    namespace: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    specification: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__f7d6e817cb2ed13ffa6efa92cb1da0b3b9ce75c9c0ed21f5122f3544273cd133(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosSlsGroupProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__565757d772ab397387545344f11af475b135957063daa2a2ee6a30f444af6f17(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__884df8400f51f8cb9a1cf77c8e6a75597fac8e260dda8c664b512d76bbe3e93b(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7742f6d38bfc698c0953c0b04a95e835c4387d3b334015d1fb93888255ac39f5(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosSlsGroup.SlsGroupConfigProperty]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3b75d1e1ff49744f12f2ed355fc11c6dadc71e83f3c48253fcb9f8aad61e59b4(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7914331f773f7ab670a1d35775e01689f2b4e02675f680a831fd0a19fb941b3a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__43b66963e9c0aecdd25587cc096e884cc32d755160a1e5a419f27f227fa4dce6(
    *,
    sls_logstore: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    sls_project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    sls_region: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__3ebe3e9e67c594fdfc39c3766849fa251263e6aba750f5d11bc26b94a0c0ee4e(
    *,
    sls_group_config: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosSlsGroup.SlsGroupConfigProperty, typing.Dict[builtins.str, typing.Any]]]]],
    sls_group_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    sls_group_description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__5b9d8331d0c1c9120df5b08a6144869492c3533b5335876ea9989cebb9e67884(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5ff467fe381e068653f0d8b35a8ddc2e421ecccde731630e10974a1964cf73eb(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9a4eb98cba93fad6a6865453c0adc9c178a4b4d552474fa3b08551726ead5139(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__1e63b96682e3e9dd39ffde3e2d06e0db96d9e65e205c5fbaeafeaded708070ab(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[SlsGroupProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__6dbadac857c6742c0a161bc5bbc216e5c542ecb3796a289cd3ee492148873330(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f42a4baf76a4732f2431d2d5ecdbaae5c004f3e4aca83a30cb08f6d9b249f563(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__909b3587fd6eed35e7cfded0b4ed0cc14276bd361c97f81e8dcf3cc43e0238bd(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__319dad2eb301dadabc6bd2f1335b74282d6b1c0ad09ee72af6440cc4c5f86493(
    *,
    sls_group_config: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosSlsGroup.SlsGroupConfigProperty, typing.Dict[builtins.str, typing.Any]]]]],
    sls_group_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    sls_group_description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__4e933217156f501d8fdbbc9dc0332fa1af57d5923a9ed198b896a96e59fb8297(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6f4ff70b2695c94a5cf1c330eaad1005bfc44e9f2dd469aea231e9ec2f833326(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__16e04c558298df752fc81026ef63eadf9169ea932fe777198ce1a5d0fbe8c7b1(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__28d5fab2718f14080e1d2ec7f4f52440e23ce38c968845855c78b2c8dee4dbc5(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4577b93426a97e3fa7737e9b84a10cae89a1ca23de44f1f0f7b5a3e92b36f9bc(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ba0303c05a6bd291a068383cd739b02dc48e7016ca0963c56f0874890c054c2f(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__6d8e9940d834ad136cb3ce982dc05516d087e435c262a1104477636d6d1e06b3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__36d073c3016dbe848ec276cc7add9b258eff35cff0d13970fab0c236fa15694c(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f6cdda6264e39b7341337e25390ea3f77284949b8ba8aedb6c3e5bcbd82ba59d(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__016c94a5b971e1d9b14dee91c364600765892cfd88dfa41bc0652e73dca19c00(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__09f720691dad313b129291c08312abbfd0edd117c34e0d2f5325b234328bf482(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7de929047d7785dfbb04b3dc0918c863da8571847314e7eb139163ffbd88a457(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0590d5cc2898a2662652d08ebb0521c70998315d33936cf02d1df0ed9d02158e(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cf8c805dfdd8eaa9a0c0321899e3ef79475a96c7a3edafec57868ef67fe3fba2(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ec8754c40a57c634412a44d1f0da991835177290504a1dd2b853ac6edc40efaf(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0287e7df13b40887c34eefc39e62a5c33987575c5736e912f6f4583ed693a85a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4c3521a0ac52f068b5b83a888193226e7633ca26e093f1cbeb405e23e9e6e5db(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dd0eb8d5f83f1c5163e2eb55416f8c8c71da3eece709f3f41c04f9e81284c1d3(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
