...
class RosVpcFirewallControlPolicy(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosVpcFirewallControlPolicy, self, [scope, id, props, enable_resource_property_constraint])
...
class VpcFirewallControlPolicy(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(VpcFirewallControlPolicy, self, [scope, id, props, enable_resource_property_constraint])
