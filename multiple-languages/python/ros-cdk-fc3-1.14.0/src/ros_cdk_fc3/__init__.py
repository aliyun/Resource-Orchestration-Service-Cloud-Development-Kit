...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.FunctionVersionProps",
    jsii_struct_bases=[],
    name_mapping={"function_name": "functionName", "description": "description"},
)
class FunctionVersionProps:
    def __init__(
        self,
        *,
        function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__539919c4849f71c5fa5bb3184b80385d01feb57863f253dcc0d11dcfcf221ab4)
            check_type(argname="argument function_name", value=function_name, expected_type=type_hints["function_name"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "function_name": function_name,
    ...
    def __repr__(self) -> str:
        return "FunctionVersionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-fc3.IFunctionVersion")
class IFunctionVersion(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> FunctionVersionProps:
        ...


class _IFunctionVersionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``FunctionVersion``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-fc3.IFunctionVersion"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> FunctionVersionProps:
        return typing.cast(FunctionVersionProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IFunctionVersion).__jsii_proxy_class__ = lambda : _IFunctionVersionProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-fc3.ILayerVersion")
class ILayerVersion(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``LayerVersion``.'''

    @builtins.property
    @jsii.member(jsii_name="attrAcl")
    def attr_acl(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCodeSize")
    def attr_code_size(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCompatibleRuntime")
    def attr_compatible_runtime(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLicense")
    def attr_license(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "LayerVersionProps":
        ...
...
class _ILayerVersionProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-fc3.ILayerVersion"
    ...
    def attr_acl(
        ...
        '''Attribute Acl: The access permission of the layer, 1: public, 0: private, default is private.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAcl"))
    ...
    def attr_code_size(
        ...
        '''Attribute CodeSize: The code package size of the layer, in bytes.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCodeSize"))
    ...
    def attr_compatible_runtime(
        ...
        '''Attribute CompatibleRuntime: List of runtime environments supported by the layer.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCompatibleRuntime"))
    ...
    def attr_layer_version_arn(
        ...
        The format is acs:fc:{region }:{ accountID}:layers/{layerName}/versions/{layerVersion}.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLayerVersionArn"))
    ...
    def attr_license(
        ...
        '''Attribute License: Layer License Agreement.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLicense"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "LayerVersionProps":
        return typing.cast("LayerVersionProps", jsii.get(self, "props"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-fc3.IVpcBinding")
class IVpcBinding(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "VpcBindingProps":
        ...


class _IVpcBindingProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``VpcBinding``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-fc3.IVpcBinding"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "VpcBindingProps":
        return typing.cast("VpcBindingProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IVpcBinding).__jsii_proxy_class__ = lambda : _IVpcBindingProxy
...
class LayerVersion(
    ...
    jsii_type="@alicloud/ros-cdk-fc3.LayerVersion",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::FC3::LayerVersion``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosLayerVersion``for a more convenient development experience.
    ...
    def __init__(
        ...
        id: builtins.str,
        props: typing.Union["LayerVersionProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__660967309bde1302de4f5a0f243e228cfec60e40a3322ab576761209f7fa60b0)
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__05f93c3a58d1a224e7d64d62bc293c537c2d9ba7c166c75747cbb2697b70ecc0)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dfba3679d30b70e68b429651ca75b1b8495e53c29213be21b5d6e6dfc9a513e1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1aa6dcb4f71ed5dbfea787a991c963442766e3bd3c8102f04bf9c4a49e911702)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.LayerVersionProps",
    jsii_struct_bases=[],
    name_mapping={
...
class LayerVersionProps:
    def __init__(
        ...
        *,
        ...
        acl: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        code: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosLayerVersion.CodeProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        compatible_runtime: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
        description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        license: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``LayerVersion``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-layerversion

        :param layer_name: Property layerName: Name of the layer.
        :param acl: Property acl: The access permission of the layer, 1: public, 0: private, default is private.
        :param code: Property code: Layer code configuration.
        :param compatible_runtime: Property compatibleRuntime: List of runtime environments supported by the layer.
        :param description: Property description: Description of the version.
        :param license: Property license: Layer License Agreement.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1a4e4b16f711a3a8e69964ceceb3ef8f9a044dece2f5e3f95b6487fa45b14f02)
    ...
    def code(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosLayerVersion.CodeProperty"]]:
        '''Property code: Layer code configuration.'''
        result = self._values.get("code")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosLayerVersion.CodeProperty"]], result)
...
class RosFunctionVersion(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-fc3.RosFunctionVersion",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::FC3::FunctionVersion``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``FunctionVersion`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-functionversion
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosFunctionVersionProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__846598069cf9f6ea1a2492db31792a13eec0a6cea2540807593618d43fcbe0e1)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__14e1ca4fc5a75a0510b1c240ae385f29ed43c0cb236f1fa29f65f202913b15d4)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e8ae9bbfc1bc20a8b6b07a61ab03dbedbc2957c6b9d8bd9ac7f7e0092d2a13e3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def function_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__218375fc4ac6fd613ea15628f8ca0cd230f6e19be45f14916bbd05f10f2eaca5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "functionName", value)
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea04792af7d3238222b31479612ba4361a3f09dbef165e2c1a24a80c25cacb2e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.RosFunctionVersionProps",
    jsii_struct_bases=[],
    name_mapping={"function_name": "functionName", "description": "description"},
)
class RosFunctionVersionProps:
    def __init__(
        self,
        *,
        function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5a3918fe4a18a9dee19da93c1414daab582bb75a1b8542717e0c2ffddea73722)
            check_type(argname="argument function_name", value=function_name, expected_type=type_hints["function_name"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "function_name": function_name,
    ...
    def __repr__(self) -> str:
        return "RosFunctionVersionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosLayerVersion(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-fc3.RosLayerVersion",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::FC3::LayerVersion``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``LayerVersion`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-layerversion
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosLayerVersionProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f3a96fa088d1bc260e1410c3a620a59851bffbc343c5782c4c9ca9284e2ec99a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f5203d35fd727d6ea7c7ae41cc19f72f1131d69dfd36dd4dea004a57cbbb0746)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrAcl")
    def attr_acl(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Acl: The access permission of the layer, 1: public, 0: private, default is private.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrAcl"))

    @builtins.property
    @jsii.member(jsii_name="attrCodeSize")
    def attr_code_size(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: CodeSize: The code package size of the layer, in bytes.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrCodeSize"))

    @builtins.property
    @jsii.member(jsii_name="attrCompatibleRuntime")
    def attr_compatible_runtime(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: CompatibleRuntime: List of runtime environments supported by the layer.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrCompatibleRuntime"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLayerVersionArn")
    def attr_layer_version_arn(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LayerVersionArn: Layer version ARN. The format is acs:fc:{region }:{ accountID}:layers/{layerName}/versions/{layerVersion}.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLayerVersionArn"))

    @builtins.property
    @jsii.member(jsii_name="attrLicense")
    def attr_license(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: License: Layer License Agreement.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLicense"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e40df475cba64647db8a91b75f4c90c4cf4e15b29c1c058873ce6d79bbad28c0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def layer_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f4a8d9f16ffa4e7d51c7f5934e359315772e6233573ebae33cc62c5b4a1bf4e3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def acl(
        ...
        :Property: acl: The access permission of the layer, 1: public, 0: private, default is private.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "acl"))
    ...
    def acl(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dd596eb265517abddd3fbbedfa5300f182037e6f421dfe043db47fc53a61fb9a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def code(
        ...
        :Property: code: Layer code configuration.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosLayerVersion.CodeProperty"]], jsii.get(self, "code"))

    @code.setter
    def code(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosLayerVersion.CodeProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2f24b4bc381db15bb0c6ecd39bad56e3f09e7829c7ced185f6a5a64c5ff2193a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "code", value)
    ...
    def compatible_runtime(
        ...
        :Property: compatibleRuntime: List of runtime environments supported by the layer.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], jsii.get(self, "compatibleRuntime"))
    ...
    def compatible_runtime(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e52c7cdc9901d4b41b34ab8bbca240cd5b031dadb75cfe7b8da91448e30264e4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__29824cee3ee76bb75ad96661a5b36ed17d2ce9901b7a30504da4ac1602883299)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)
    ...
    def license(
        ...
        :Property: license: Layer License Agreement.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "license"))
    ...
    def license(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__795b3304ea946543d0cb6b0f113069f4244523a93d269385b2a2ee4e93d4c693)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "license", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-fc3.RosLayerVersion.CodeProperty",
        jsii_struct_bases=[],
        name_mapping={
            "checksum": "checksum",
            "oss_bucket_name": "ossBucketName",
    ...
    class CodeProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__7166b4f9ec3cab818681599fe40c865b476170d5618dc749ff10cdf5ffb6a795)
                check_type(argname="argument checksum", value=checksum, expected_type=type_hints["checksum"])
                check_type(argname="argument oss_bucket_name", value=oss_bucket_name, expected_type=type_hints["oss_bucket_name"])
                check_type(argname="argument oss_object_name", value=oss_object_name, expected_type=type_hints["oss_object_name"])
                check_type(argname="argument zip_file", value=zip_file, expected_type=type_hints["zip_file"])
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.RosLayerVersionProps",
    jsii_struct_bases=[],
    name_mapping={
        "layer_name": "layerName",
        "acl": "acl",
...
class RosLayerVersionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__97dfe5d06a924a1bd03e4991613ece103a48b925ba3454840dc0595fec592a50)
            check_type(argname="argument layer_name", value=layer_name, expected_type=type_hints["layer_name"])
            check_type(argname="argument acl", value=acl, expected_type=type_hints["acl"])
            check_type(argname="argument code", value=code, expected_type=type_hints["code"])
            check_type(argname="argument compatible_runtime", value=compatible_runtime, expected_type=type_hints["compatible_runtime"])
    ...
    def __repr__(self) -> str:
        return "RosLayerVersionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosVpcBinding(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-fc3.RosVpcBinding",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::FC3::VpcBinding``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``VpcBinding`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosVpcBindingProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dfb9943515d074900971cc1b979be02715a1d691bcbb1afdc172f6009866f9e5)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__baa6538529f45641b187135e6b7d619b70fd4ca878cb14084745113c99e5ba16)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aabb65a0518edeb7187adbcd440ac295ec400465cc78609226f767241c2e2504)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def function_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__66a34af540a93fbd49ded39c199a3771366d917a663528a8d3a19012d41c8ef0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "functionName", value)
    ...
    def vpc_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9080de6954fde150e50f1972de08766b71cba72365cdeb81b2d4bcbd7f838c68)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vpcId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.RosVpcBindingProps",
    jsii_struct_bases=[],
    name_mapping={"function_name": "functionName", "vpc_id": "vpcId"},
)
class RosVpcBindingProps:
    def __init__(
        self,
        *,
        function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__225b7191b8a9aa5308db1298650c3833e13078087c2a99a6bc1cfc264e7f1f20)
            check_type(argname="argument function_name", value=function_name, expected_type=type_hints["function_name"])
            check_type(argname="argument vpc_id", value=vpc_id, expected_type=type_hints["vpc_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "function_name": function_name,
    ...
    def __repr__(self) -> str:
        return "RosVpcBindingProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.implements(IVpcBinding)
class VpcBinding(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-fc3.VpcBinding",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::FC3::VpcBinding``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosVpcBinding``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-vpcbinding
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["VpcBindingProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__428e540d1dab821902e22e55ab673d6ac486322c6e41e76280e53c7fe55d782b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__78ee5f719ed65fdd1cf8bf87804d4de7c2061bea8405302d796f958e56d8e86d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__89f8c7e0a0fd621f3b771e5f960415f284776c6a860beb2b62b2b83c369f76c9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__992bb3f4dd8900887a2fa6f101d890ad312fc606cb5c639bf5df671e6b2c2f2d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-fc3.VpcBindingProps",
    jsii_struct_bases=[],
    name_mapping={"function_name": "functionName", "vpc_id": "vpcId"},
)
class VpcBindingProps:
    def __init__(
        self,
        *,
        function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param function_name: Property functionName: Function Name.
        :param vpc_id: Property vpcId: VPC instance ID.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8c798b873757b3f1ba2582e9df4a8837754209c441ab437fff5adba19117a05e)
            check_type(argname="argument function_name", value=function_name, expected_type=type_hints["function_name"])
            check_type(argname="argument vpc_id", value=vpc_id, expected_type=type_hints["vpc_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "function_name": function_name,
...
@jsii.implements(IFunctionVersion)
class FunctionVersion(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-fc3.FunctionVersion",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::FC3::FunctionVersion``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosFunctionVersion``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-functionversion
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[FunctionVersionProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b2c122ecbd181c9b29e230010b841be5972407c1ff8cd3be8b1c1af1002aba6a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__eabf1db769eb26e6ee0b7926e366e71b219d3d42ac1e0bc304507b0c7fab4d9f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa7fb04677b99045ae3794a071ff245df6f9390ad800bd2a2cf9ce520a97f55c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0dae23fa3227714af320aee3ef4962fb65a0e7dcbcb76702fb3dff4312992a13)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "RosFunctionProps",
    "RosFunctionVersion",
    "RosFunctionVersionProps",
    "RosLayerVersion",
    "RosLayerVersionProps",
    "RosProvisionConfig",
...
def _typecheckingstub__539919c4849f71c5fa5bb3184b80385d01feb57863f253dcc0d11dcfcf221ab4(
    *,
    function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__660967309bde1302de4f5a0f243e228cfec60e40a3322ab576761209f7fa60b0(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[LayerVersionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__05f93c3a58d1a224e7d64d62bc293c537c2d9ba7c166c75747cbb2697b70ecc0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dfba3679d30b70e68b429651ca75b1b8495e53c29213be21b5d6e6dfc9a513e1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1aa6dcb4f71ed5dbfea787a991c963442766e3bd3c8102f04bf9c4a49e911702(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1a4e4b16f711a3a8e69964ceceb3ef8f9a044dece2f5e3f95b6487fa45b14f02(
    *,
    layer_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    acl: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    code: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosLayerVersion.CodeProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
...
def _typecheckingstub__846598069cf9f6ea1a2492db31792a13eec0a6cea2540807593618d43fcbe0e1(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosFunctionVersionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__14e1ca4fc5a75a0510b1c240ae385f29ed43c0cb236f1fa29f65f202913b15d4(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e8ae9bbfc1bc20a8b6b07a61ab03dbedbc2957c6b9d8bd9ac7f7e0092d2a13e3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__218375fc4ac6fd613ea15628f8ca0cd230f6e19be45f14916bbd05f10f2eaca5(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ea04792af7d3238222b31479612ba4361a3f09dbef165e2c1a24a80c25cacb2e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5a3918fe4a18a9dee19da93c1414daab582bb75a1b8542717e0c2ffddea73722(
    *,
    function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__f3a96fa088d1bc260e1410c3a620a59851bffbc343c5782c4c9ca9284e2ec99a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosLayerVersionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__f5203d35fd727d6ea7c7ae41cc19f72f1131d69dfd36dd4dea004a57cbbb0746(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e40df475cba64647db8a91b75f4c90c4cf4e15b29c1c058873ce6d79bbad28c0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f4a8d9f16ffa4e7d51c7f5934e359315772e6233573ebae33cc62c5b4a1bf4e3(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dd596eb265517abddd3fbbedfa5300f182037e6f421dfe043db47fc53a61fb9a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2f24b4bc381db15bb0c6ecd39bad56e3f09e7829c7ced185f6a5a64c5ff2193a(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosLayerVersion.CodeProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e52c7cdc9901d4b41b34ab8bbca240cd5b031dadb75cfe7b8da91448e30264e4(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__29824cee3ee76bb75ad96661a5b36ed17d2ce9901b7a30504da4ac1602883299(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__795b3304ea946543d0cb6b0f113069f4244523a93d269385b2a2ee4e93d4c693(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7166b4f9ec3cab818681599fe40c865b476170d5618dc749ff10cdf5ffb6a795(
    *,
    checksum: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    oss_bucket_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    oss_object_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__97dfe5d06a924a1bd03e4991613ece103a48b925ba3454840dc0595fec592a50(
    *,
    layer_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    acl: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    code: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosLayerVersion.CodeProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
...
def _typecheckingstub__dfb9943515d074900971cc1b979be02715a1d691bcbb1afdc172f6009866f9e5(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosVpcBindingProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__baa6538529f45641b187135e6b7d619b70fd4ca878cb14084745113c99e5ba16(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aabb65a0518edeb7187adbcd440ac295ec400465cc78609226f767241c2e2504(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__66a34af540a93fbd49ded39c199a3771366d917a663528a8d3a19012d41c8ef0(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9080de6954fde150e50f1972de08766b71cba72365cdeb81b2d4bcbd7f838c68(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__225b7191b8a9aa5308db1298650c3833e13078087c2a99a6bc1cfc264e7f1f20(
    *,
    function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    vpc_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__428e540d1dab821902e22e55ab673d6ac486322c6e41e76280e53c7fe55d782b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[VpcBindingProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__78ee5f719ed65fdd1cf8bf87804d4de7c2061bea8405302d796f958e56d8e86d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__89f8c7e0a0fd621f3b771e5f960415f284776c6a860beb2b62b2b83c369f76c9(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__992bb3f4dd8900887a2fa6f101d890ad312fc606cb5c639bf5df671e6b2c2f2d(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8c798b873757b3f1ba2582e9df4a8837754209c441ab437fff5adba19117a05e(
    *,
    function_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    vpc_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__b2c122ecbd181c9b29e230010b841be5972407c1ff8cd3be8b1c1af1002aba6a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[FunctionVersionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__eabf1db769eb26e6ee0b7926e366e71b219d3d42ac1e0bc304507b0c7fab4d9f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fa7fb04677b99045ae3794a071ff245df6f9390ad800bd2a2cf9ce520a97f55c(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0dae23fa3227714af320aee3ef4962fb65a0e7dcbcb76702fb3dff4312992a13(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
