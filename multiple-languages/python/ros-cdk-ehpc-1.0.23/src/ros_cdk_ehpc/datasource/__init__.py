...
class Nodes(
    ...
    def _props(self) -> "NodesProps":
        return typing.cast("NodesProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "NodesProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c54c8852a53203956a5243768f746653f8a484a8e7b1c2261d0a4bb8004cba8a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__c54c8852a53203956a5243768f746653f8a484a8e7b1c2261d0a4bb8004cba8a(
    value: NodesProps,
) -> None:
    """Type checking stubs"""
    pass
