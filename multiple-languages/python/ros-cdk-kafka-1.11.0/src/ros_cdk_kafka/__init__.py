...
class InstanceProps:
    def __init__(
        ...
        *,
        ...
        :param spec_type: Property specType: The edition of the Message Queue for Apache Kafka instance. Valid values: normal: Normal version professional: Professional Edition (high writing edition) professionalForHighRead: Professional Edition (high reading edition) basic: Basic Edition (only for serverless)
        :param tags: Property tags: Tags to attach to instance. Max support 20 tags to add during create instance. Each tag with two properties Key and Value, and Key is required.
