...
@jsii.interface(jsii_type="@alicloud/ros-cdk-eais.IClientInstanceAttachment")
...
class _IClientInstanceAttachmentProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-eais.IClientInstanceAttachment"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-eais.IInstance")
...
class _IInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-eais.IInstance"
