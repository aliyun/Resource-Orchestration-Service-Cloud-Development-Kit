...
class RosRuleAction(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosRuleAction, self, [scope, id, props, enable_resource_property_constraint])
...
class RuleAction(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RuleAction, self, [scope, id, props, enable_resource_property_constraint])
