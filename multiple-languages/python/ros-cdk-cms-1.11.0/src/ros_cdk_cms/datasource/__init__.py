...
class Namespaces(
    ...
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::CMS::Namespaces``.
...
class SlsGroups(
    ...
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::CMS::SlsGroups``.
