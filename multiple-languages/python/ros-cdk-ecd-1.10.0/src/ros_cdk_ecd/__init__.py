...
@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.IBundle")
class IBundle(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Bundle``.'''
...
class _IBundleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.IBundle"
    ...
    def attr_bundle_id(
        ...
        '''Attribute BundleId: Desktop bundle ID.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrBundleId"))
...
typing.cast(typing.Any, IBundle).__jsii_proxy_class__ = lambda : _IBundleProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.IDesktopGroup")
class IDesktopGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``DesktopGroup``.'''

    @builtins.property
    @jsii.member(jsii_name="attrDesktopGroupId")
    def attr_desktop_group_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DesktopGroupProps:
        ...


class _IDesktopGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DesktopGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.IDesktopGroup"
    ...
    def attr_desktop_group_id(
        ...
        '''Attribute DesktopGroupId: Id of created DesktopGroup.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDesktopGroupId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDesktopGroup).__jsii_proxy_class__ = lambda : _IDesktopGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.IDesktops")
class IDesktops(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DesktopsProps:
        ...


class _IDesktopsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``Desktops``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.IDesktops"
    ...
    def attr_desktop_id(
        ...
        IDs of the cloud desktops are returned.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDesktopId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDesktops).__jsii_proxy_class__ = lambda : _IDesktopsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.INetworkPackage")
class INetworkPackage(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``NetworkPackage``.'''

    @builtins.property
    @jsii.member(jsii_name="attrNetworkPackageId")
    def attr_network_package_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "NetworkPackageProps":
        ...


class _INetworkPackageProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``NetworkPackage``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.INetworkPackage"
    ...
    def attr_network_package_id(
        ...
        '''Attribute NetworkPackageId: The ID of the Internet access package.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNetworkPackageId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, INetworkPackage).__jsii_proxy_class__ = lambda : _INetworkPackageProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.INetworkPackageAssociation")
class INetworkPackageAssociation(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "NetworkPackageAssociationProps":
        ...


class _INetworkPackageAssociationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``NetworkPackageAssociation``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.INetworkPackageAssociation"
    ...
    def attr_office_site_id(
        ...
        '''Attribute OfficeSiteId: The ID of the workspace.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrOfficeSiteId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "NetworkPackageAssociationProps":
        return typing.cast("NetworkPackageAssociationProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, INetworkPackageAssociation).__jsii_proxy_class__ = lambda : _INetworkPackageAssociationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.ISimpleOfficeSite")
class ISimpleOfficeSite(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SimpleOfficeSiteProps":
        ...


class _ISimpleOfficeSiteProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SimpleOfficeSite``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.ISimpleOfficeSite"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISimpleOfficeSite).__jsii_proxy_class__ = lambda : _ISimpleOfficeSiteProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ecd.IUserDesktopGroupAddition")
class IUserDesktopGroupAddition(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrEndUserIds")
    def attr_end_user_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "UserDesktopGroupAdditionProps":
        ...


class _IUserDesktopGroupAdditionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``UserDesktopGroupAddition``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ecd.IUserDesktopGroupAddition"
    ...
    def attr_end_user_ids(
        ...
        '''Attribute EndUserIds: The regular users to whom you want to assign the desktop group.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrEndUserIds"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "UserDesktopGroupAdditionProps":
        return typing.cast("UserDesktopGroupAdditionProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IUserDesktopGroupAddition).__jsii_proxy_class__ = lambda : _IUserDesktopGroupAdditionProxy


@jsii.implements(INetworkPackage)
...
@jsii.implements(INetworkPackageAssociation)
class NetworkPackageAssociation(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ecd.NetworkPackageAssociation",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosNetworkPackageAssociation``for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["NetworkPackageAssociationProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cd7aab2749320bc9bab43a2396ee0561fab137c35f2a9c175e4b06d5c091f351)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7715e711db270ae044e38f29da53c001d852054d160a1bcd4a2c72b4c8fc7d68)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__27a8ac3c4673478851ba9863830070fccb6cc943cf2f93e9da37b47eea826ad1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__798cf1fb719782057378c7f8f7888bc66050e835eb407ecb5587616743b53f6e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ecd.NetworkPackageAssociationProps",
    jsii_struct_bases=[],
    name_mapping={
        "network_package_id": "networkPackageId",
        "office_site_id": "officeSiteId",
    },
)
class NetworkPackageAssociationProps:
    def __init__(
        self,
        *,
        network_package_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        office_site_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        ...
        :param network_package_id: Property networkPackageId: The ID of the Internet access package.
        :param office_site_id: Property officeSiteId: The ID of the workspace.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0391fe567f5412d79fd5f53ba60968f5821369ef8a3910fb2a5800ad09617b9e)
            check_type(argname="argument network_package_id", value=network_package_id, expected_type=type_hints["network_package_id"])
            check_type(argname="argument office_site_id", value=office_site_id, expected_type=type_hints["office_site_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    @builtins.property
    def network_package_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''Property networkPackageId: The ID of the Internet access package.'''
        result = self._values.get("network_package_id")
        assert result is not None, "Required property 'network_package_id' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def __repr__(self) -> str:
        return "NetworkPackageAssociationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosNetworkPackageAssociation(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ecd.RosNetworkPackageAssociation",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``NetworkPackageAssociation`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecd-networkpackageassociation
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosNetworkPackageAssociationProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f7eaca9389248c00fd589a410af29f35ab17fbb1db1ed559ea00612d17eddb3)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d06d2e92aa5fcd28adedf45296ee603e951ee8932d2da214a8fbc00014e7576)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__18663774b253e6abf29c70d7a02ddb62d86bd6d502be7ff9ff31be052d9c9e23)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="networkPackageId")
    def network_package_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: networkPackageId: The ID of the Internet access package.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "networkPackageId"))

    @network_package_id.setter
    def network_package_id(
        self,
        value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3ceee74766a5a371ab9c0a0c9da1073c832872175ce82f853c76c397fd44f73f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "networkPackageId", value)
    ...
    def office_site_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dbd2ab0f5588c476aaa72861fb0ff878e45ca213880f7e4f94008258451cbe6f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "officeSiteId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ecd.RosNetworkPackageAssociationProps",
    jsii_struct_bases=[],
    name_mapping={
        "network_package_id": "networkPackageId",
        "office_site_id": "officeSiteId",
...
class RosNetworkPackageAssociationProps:
    def __init__(
        self,
        *,
        network_package_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param network_package_id: 
        :param office_site_id: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fe870a5222cf183f9f070d1913f7d4a95ae79988c5b5b7cb1280955282f72055)
            check_type(argname="argument network_package_id", value=network_package_id, expected_type=type_hints["network_package_id"])
            check_type(argname="argument office_site_id", value=office_site_id, expected_type=type_hints["office_site_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "network_package_id": network_package_id,
    ...
    def __repr__(self) -> str:
        return "RosNetworkPackageAssociationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosSimpleOfficeSite(
    ...
    def vpc_type(
        ...
        vpcType: The type of office network.
        Enumeration value:
        standard: Advanced office network.
        basic: Basic office network.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "vpcType"))
    ...
    def vpc_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__449cbbb0fb963baea5661e5a8b49409dc5f87e2507e524ab3cd832e5216b2556)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosSimpleOfficeSiteProps:
    def __init__(
        ...
        *,
        ...
        vpc_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        if __debug__:
            ...
            check_type(argname="argument vpc_type", value=vpc_type, expected_type=type_hints["vpc_type"])
        ...
        if vpc_type is not None:
            self._values["vpc_type"] = vpc_type
    ...
    def vpc_type(
        ...
        basic: Basic office network.
        '''
        result = self._values.get("vpc_type")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
...
class RosUserDesktopGroupAddition(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ecd.RosUserDesktopGroupAddition",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``UserDesktopGroupAddition`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosUserDesktopGroupAdditionProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d2d0fc84f1a4aecff429aa1b9aa6a5c470d4d69dc9a21ec5b0c0f508ab732afe)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ddf0a01f32b42ac5856039cc52f7d04a2eca9f2f8642741a614b46af704c87e6)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrEndUserIds")
    def attr_end_user_ids(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: EndUserIds: The regular users to whom you want to assign the desktop group.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrEndUserIds"))
    ...
    @builtins.property
    @jsii.member(jsii_name="desktopGroupId")
    def desktop_group_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: desktopGroupId: The ID of the desktop group that you want to assign to more regular users.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "desktopGroupId"))

    @desktop_group_id.setter
    def desktop_group_id(
        self,
        value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0631b86f3709d7f98ece739b6a80a874aaee030acad49682adf893134783084b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "desktopGroupId", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__53b3389ee2133ab068417f4e88ff6f525b25ede7754c9cb17749c6aa01f9ef3f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def end_user_ids(
        ...
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "endUserIds"))
    ...
    def end_user_ids(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c61074ee279eeb51ea57c9caf92c1a6187150082d8c0e7a118658f384bb54f79)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "endUserIds", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ecd.RosUserDesktopGroupAdditionProps",
    jsii_struct_bases=[],
    name_mapping={"desktop_group_id": "desktopGroupId", "end_user_ids": "endUserIds"},
)
class RosUserDesktopGroupAdditionProps:
    def __init__(
        self,
        *,
        desktop_group_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        end_user_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    ) -> None:
        '''Properties for defining a ``RosUserDesktopGroupAddition``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecd-userdesktopgroupaddition

        :param desktop_group_id: 
        :param end_user_ids: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__15f14cc0d786b71d1793eb8ffef28e58ea8ed567cb093c1171095f3231ee0e81)
            check_type(argname="argument desktop_group_id", value=desktop_group_id, expected_type=type_hints["desktop_group_id"])
            check_type(argname="argument end_user_ids", value=end_user_ids, expected_type=type_hints["end_user_ids"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    def desktop_group_id(
        ...
        :Property: desktopGroupId: The ID of the desktop group that you want to assign to more regular users.
        '''
        result = self._values.get("desktop_group_id")
        assert result is not None, "Required property 'desktop_group_id' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def end_user_ids(
        ...
        '''
        result = self._values.get("end_user_ids")
        assert result is not None, "Required property 'end_user_ids' is missing"
    ...
    def __repr__(self) -> str:
        return "RosUserDesktopGroupAdditionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(ISimpleOfficeSite)
...
class SimpleOfficeSiteProps:
    def __init__(
        ...
        *,
        ...
        :param vpc_type: Property vpcType: The type of office network. Enumeration value: standard: Advanced office network. basic: Basic office network.
...
@jsii.implements(IUserDesktopGroupAddition)
class UserDesktopGroupAddition(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ecd.UserDesktopGroupAddition",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosUserDesktopGroupAddition``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecd-userdesktopgroupaddition
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["UserDesktopGroupAdditionProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__227392202828ec2d985f7f3d28426eab9c3b9a968a4c28c99f28f2ddc645568d)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__58da69709006be18f459654e734e3711470257d34ba1edaca24f12e3f1d38f23)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3aeb4d028c188c8a1437049569fe7f83469c66ef6b029bb376fb7ad96dbbba55)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b57fbd8f06e811cd8e49fd83c19e6bab7d2ea851851bc101a4288b16877eccfd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ecd.UserDesktopGroupAdditionProps",
    jsii_struct_bases=[],
    name_mapping={"desktop_group_id": "desktopGroupId", "end_user_ids": "endUserIds"},
)
class UserDesktopGroupAdditionProps:
    def __init__(
        self,
        *,
        desktop_group_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param desktop_group_id: Property desktopGroupId: The ID of the desktop group that you want to assign to more regular users.
        :param end_user_ids: Property endUserIds: The regular users to whom you want to assign the desktop group.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__23b00711ab7f246992550939545d68b420ae5e39c13539f185823f800e2e4747)
            check_type(argname="argument desktop_group_id", value=desktop_group_id, expected_type=type_hints["desktop_group_id"])
            check_type(argname="argument end_user_ids", value=end_user_ids, expected_type=type_hints["end_user_ids"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "desktop_group_id": desktop_group_id,
    ...
    def __repr__(self) -> str:
        return "UserDesktopGroupAdditionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IBundle)
class Bundle(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
...
__all__ = [
    ...
    "RosDesktopsProps",
    "RosNetworkPackage",
    "RosNetworkPackageAssociation",
    "RosNetworkPackageAssociationProps",
    "RosNetworkPackageProps",
    "RosSimpleOfficeSite",
    "RosSimpleOfficeSiteProps",
    "RosUserDesktopGroupAddition",
    "RosUserDesktopGroupAdditionProps",
    "SimpleOfficeSite",
    "SimpleOfficeSiteProps",
    "UserDesktopGroupAddition",
    "UserDesktopGroupAdditionProps",
]
...
def _typecheckingstub__cd7aab2749320bc9bab43a2396ee0561fab137c35f2a9c175e4b06d5c091f351(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[NetworkPackageAssociationProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__7715e711db270ae044e38f29da53c001d852054d160a1bcd4a2c72b4c8fc7d68(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__27a8ac3c4673478851ba9863830070fccb6cc943cf2f93e9da37b47eea826ad1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__798cf1fb719782057378c7f8f7888bc66050e835eb407ecb5587616743b53f6e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0391fe567f5412d79fd5f53ba60968f5821369ef8a3910fb2a5800ad09617b9e(
    *,
    network_package_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    office_site_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__7f7eaca9389248c00fd589a410af29f35ab17fbb1db1ed559ea00612d17eddb3(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosNetworkPackageAssociationProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__6d06d2e92aa5fcd28adedf45296ee603e951ee8932d2da214a8fbc00014e7576(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__18663774b253e6abf29c70d7a02ddb62d86bd6d502be7ff9ff31be052d9c9e23(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3ceee74766a5a371ab9c0a0c9da1073c832872175ce82f853c76c397fd44f73f(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dbd2ab0f5588c476aaa72861fb0ff878e45ca213880f7e4f94008258451cbe6f(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fe870a5222cf183f9f070d1913f7d4a95ae79988c5b5b7cb1280955282f72055(
    *,
    network_package_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    office_site_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__449cbbb0fb963baea5661e5a8b49409dc5f87e2507e524ab3cd832e5216b2556(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__d2d0fc84f1a4aecff429aa1b9aa6a5c470d4d69dc9a21ec5b0c0f508ab732afe(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosUserDesktopGroupAdditionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__ddf0a01f32b42ac5856039cc52f7d04a2eca9f2f8642741a614b46af704c87e6(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0631b86f3709d7f98ece739b6a80a874aaee030acad49682adf893134783084b(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__53b3389ee2133ab068417f4e88ff6f525b25ede7754c9cb17749c6aa01f9ef3f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c61074ee279eeb51ea57c9caf92c1a6187150082d8c0e7a118658f384bb54f79(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__15f14cc0d786b71d1793eb8ffef28e58ea8ed567cb093c1171095f3231ee0e81(
    *,
    desktop_group_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    end_user_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
...
def _typecheckingstub__227392202828ec2d985f7f3d28426eab9c3b9a968a4c28c99f28f2ddc645568d(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[UserDesktopGroupAdditionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__58da69709006be18f459654e734e3711470257d34ba1edaca24f12e3f1d38f23(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3aeb4d028c188c8a1437049569fe7f83469c66ef6b029bb376fb7ad96dbbba55(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b57fbd8f06e811cd8e49fd83c19e6bab7d2ea851851bc101a4288b16877eccfd(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__23b00711ab7f246992550939545d68b420ae5e39c13539f185823f800e2e4747(
    *,
    desktop_group_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    end_user_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
