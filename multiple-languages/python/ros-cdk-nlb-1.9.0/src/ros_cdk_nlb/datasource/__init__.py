...
@jsii.interface(jsii_type="@alicloud/ros-cdk-nlb.datasource.ILoadBalancer")
class ILoadBalancer(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCrossZoneEnabled")
    def attr_cross_zone_enabled(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrDeletionProtectionConfig")
    def attr_deletion_protection_config(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrIpv6AddressType")
    def attr_ipv6_address_type(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerBillingConfig")
    def attr_load_balancer_billing_config(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerBusinessStatus")
    def attr_load_balancer_business_status(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerStatus")
    def attr_load_balancer_status(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrModificationProtectionConfig")
    def attr_modification_protection_config(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _ILoadBalancerProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-nlb.datasource.ILoadBalancer"
    ...
    def attr_cps(
        ...
        '''Attribute Cps: The maximum number of new connections per second supported by the NLB instance in each zone (virtual IP address).'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCps"))
    ...
    def attr_cross_zone_enabled(
        ...
        '''Attribute CrossZoneEnabled: Indicates whether the NLB instance is accessible across zones.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCrossZoneEnabled"))
    ...
    def attr_deletion_protection_config(
        ...
        '''Attribute DeletionProtectionConfig: The configuration of the deletion protection feature.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDeletionProtectionConfig"))
    ...
    def attr_ipv6_address_type(
        ...
        '''Attribute Ipv6AddressType: The IPv6 network type of the NLB instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIpv6AddressType"))
    ...
    def attr_load_balancer_billing_config(
        ...
        '''Attribute LoadBalancerBillingConfig: The billing information of the NLB instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLoadBalancerBillingConfig"))
    ...
    def attr_load_balancer_business_status(
        ...
        '''Attribute LoadBalancerBusinessStatus: The status of workloads on the NLB instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLoadBalancerBusinessStatus"))
    ...
    def attr_load_balancer_status(
        ...
        '''Attribute LoadBalancerStatus: The NLB instance status.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLoadBalancerStatus"))
    ...
    def attr_modification_protection_config(
        ...
        '''Attribute ModificationProtectionConfig: The configuration of the configuration read-only mode.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrModificationProtectionConfig"))
    ...
    def attr_operation_locks(
        ...
        '''Attribute OperationLocks: The information about the locked NLB instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrOperationLocks"))
    ...
    def attr_security_group_ids(
        ...
        '''Attribute SecurityGroupIds: The ID of the security group associated with the NLB instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSecurityGroupIds"))
...
class LoadBalancer(
    ...
    jsii_type="@alicloud/ros-cdk-nlb.datasource.LoadBalancer",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea1cc7259bd3481634f97b56ad21706766c0ffe0c2cf83a555d729fa4150b621)
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__088263c8efe5304b37894652c9b47c398f4b800dc518e04dbc021622428fcf7f)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cf7bd6d0f2c7da5535a4ce86e4e4c755886e61846ddac0cddf30107d831e0467)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__54d356800b80a2ec6457548ef4b7d4984758443f5af2258f0c4b9b0ec3fe88a6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-nlb.datasource.LoadBalancerProps",
    jsii_struct_bases=[],
    name_mapping={
...
class LoadBalancerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__33ab113d2c14c8f0bac493f131ff153fe20d1f38d8f470b814a5d5cfb94b8ec8)
...
class RosLoadBalancer(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-nlb.datasource.RosLoadBalancer",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c093bdcdcf41ddd6dec6d707b22e1252c3f3a5ed1094da7ad813516dbdf8889f)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cd055b459f5a500f0f9cd63b61169a486285faca5472624a1aae91098f79cb59)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCps")
    def attr_cps(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Cps: The maximum number of new connections per second supported by the NLB instance in each zone (virtual IP address).
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrCps"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrCrossZoneEnabled")
    def attr_cross_zone_enabled(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: CrossZoneEnabled: Indicates whether the NLB instance is accessible across zones.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrCrossZoneEnabled"))

    @builtins.property
    @jsii.member(jsii_name="attrDeletionProtectionConfig")
    def attr_deletion_protection_config(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: DeletionProtectionConfig: The configuration of the deletion protection feature.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrDeletionProtectionConfig"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrIpv6AddressType")
    def attr_ipv6_address_type(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Ipv6AddressType: The IPv6 network type of the NLB instance.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrIpv6AddressType"))

    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerBillingConfig")
    def attr_load_balancer_billing_config(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LoadBalancerBillingConfig: The billing information of the NLB instance.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLoadBalancerBillingConfig"))

    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerBusinessStatus")
    def attr_load_balancer_business_status(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LoadBalancerBusinessStatus: The status of workloads on the NLB instance.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLoadBalancerBusinessStatus"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrLoadBalancerStatus")
    def attr_load_balancer_status(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: LoadBalancerStatus: The NLB instance status.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrLoadBalancerStatus"))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrModificationProtectionConfig")
    def attr_modification_protection_config(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ModificationProtectionConfig: The configuration of the configuration read-only mode.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrModificationProtectionConfig"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b9a34e89e2e57f759075026d461edff079ecd7a777b59f19a5e7b003d376cbf1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def load_balancer_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc81dfb6c1e586a94b44e72a54a0e2fc5c0f2cb428a2d02e627a336e57f9bd8b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2941d7115cca19d48738f25b06a5792d8abb49214d5b066cc7e930feb378923d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-nlb.datasource.RosLoadBalancerProps",
    jsii_struct_bases=[],
    name_mapping={
        "load_balancer_id": "loadBalancerId",
        "refresh_options": "refreshOptions",
...
class RosLoadBalancerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3b603f8f89aee6c07446c8a5bfcaa30774a8da6e428c6073dbd9be275846e1ed)
            check_type(argname="argument load_balancer_id", value=load_balancer_id, expected_type=type_hints["load_balancer_id"])
            check_type(argname="argument refresh_options", value=refresh_options, expected_type=type_hints["refresh_options"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if load_balancer_id is not None:
...
def _typecheckingstub__ea1cc7259bd3481634f97b56ad21706766c0ffe0c2cf83a555d729fa4150b621(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[LoadBalancerProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__088263c8efe5304b37894652c9b47c398f4b800dc518e04dbc021622428fcf7f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cf7bd6d0f2c7da5535a4ce86e4e4c755886e61846ddac0cddf30107d831e0467(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__54d356800b80a2ec6457548ef4b7d4984758443f5af2258f0c4b9b0ec3fe88a6(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__33ab113d2c14c8f0bac493f131ff153fe20d1f38d8f470b814a5d5cfb94b8ec8(
    *,
    load_balancer_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__c093bdcdcf41ddd6dec6d707b22e1252c3f3a5ed1094da7ad813516dbdf8889f(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosLoadBalancerProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__cd055b459f5a500f0f9cd63b61169a486285faca5472624a1aae91098f79cb59(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b9a34e89e2e57f759075026d461edff079ecd7a777b59f19a5e7b003d376cbf1(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dc81dfb6c1e586a94b44e72a54a0e2fc5c0f2cb428a2d02e627a336e57f9bd8b(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2941d7115cca19d48738f25b06a5792d8abb49214d5b066cc7e930feb378923d(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3b603f8f89aee6c07446c8a5bfcaa30774a8da6e428c6073dbd9be275846e1ed(
    *,
    load_balancer_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    refresh_options: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
