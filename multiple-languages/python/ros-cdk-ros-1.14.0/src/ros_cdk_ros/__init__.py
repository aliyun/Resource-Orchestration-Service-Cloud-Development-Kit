...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ros.AssertProps",
    jsii_struct_bases=[],
    name_mapping={
        "values": "values",
        "abort_creation": "abortCreation",
...
class AssertProps:
    def __init__(
        self,
        *,
        values: typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable],
        abort_creation: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        error_message: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        operation: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``Assert``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-assert

        :param values: Property values: A list of values to assert. The items in the list are compared in order. The range of length is one to three. - Three values are supported only if the operation is Equal or NotEqual. - One value is supported only if the operation is Not.
        :param abort_creation: Property abortCreation: Whether to abort creation when the assert fails. Default is True.
        :param error_message: Property errorMessage: The error message to be returned when the assert fails.
        :param operation: Property operation: The type of assertion to make. The supported operations are: Equal, NotEqual, Greater, GreaterOrEqual, Less, LessOrEqual, Contain, NotContain, And, Or, Not. Default is Equal.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0fb1688054c9203181fa1b2fefb4888565ee3602b76394141c47319638cb8cdc)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            check_type(argname="argument abort_creation", value=abort_creation, expected_type=type_hints["abort_creation"])
        ...
        if abort_creation is not None:
            self._values["abort_creation"] = abort_creation
    ...
    def abort_creation(
        ...
        Default is True.
        '''
        result = self._values.get("abort_creation")
...
class AutoEnableServiceProps:
    def __init__(
        ...
        *,
        ...
        :param service_name: Property serviceName: Which service to enable. Valid values: AHAS: Application High Availability Service ARMS: Realtime Monitoring Service ARMS/App: Application Monitoring: Basic Edition ARMS/Web: Front End Monitoring: Basic Edition ARMS/PrometheusMonitor: Prometheus Monitoring: Expert Edition ARMS/SyntheticPost: Cloud Dial Test: Expert Edition (pay as you go) ApiGateway: API Gateway BatchCompute: Batch Compute BrainIndustrial: Brain Industrial CloudStorageGateway: Cloud Storage Gateway CMS: Cloud Monitor Service CS: Container Service DataHub: Data Hub DataWorks: DataWorks DCDN: Dynamic Route for CDN EDAS: Enterprise Distributed Application Service EMAS: Enterprise Mobile Application Studio FC: Function Compute FNF: Serverless Workflow MaxCompute: MaxCompute NAS: Network Attached Storage MNS: Message Service (MNS) HBR: Hybrid Backup Recovery IMM: Intelligent Media Management KMS: Key Management Service NLP: Natural Language Processing OSS: Object Storage Service OTS: Table Store PrivateLink: Private Link PrivateZone: Private Zone RocketMQ: RocketMQ SAE: Serverless App Engine SLS: Log Service TrafficMirror: VPC Traffic Mirroring VS: Video Surveillance Xtrace: Tracing Anlaysis CDN: Content Delivery Network CDT: Cloud Data Transfer CDTCb: Cloud Data Transfer for Cross Border TransitRouter: Cen Transit Router PAI: Platform of Artificial Intelligence Config: Cloud Config TrustedService/ROS: Trusted Service for ROS CloudSSO: Cloud SSO ControlPolicy: Control Policy DSC: Data Security Center Free Edition Service
        '''
        if __debug__:
...
class CustomResourceProps:
    def __init__(
        ...
        *,
        ...
        :param service_token: Property serviceToken: The service token that was given to the template developer by the service provider to access the service. Allowed values: - Function Compute: acs:fc:<region_id>:<account_id>:services/<service_name>/functions/<function_name> - Function Compute 3: acs:fc:<region_id>:<account_id>:functions/<function_name> - MNS Queue: acs:mns:<region_id>:<account_id>:queues/<queue_name> or acs:mns:<region_id>:<account_id>:/queues/<queue_name> - MNS Topic: acs:mns:<region_id>:<account_id>:topics/<topic_name> or acs:mns:<region_id>:<account_id>:/topics/<topic_name> - HTTP&HTTPS: web[options]: Two options are supported: - sync: sync HTTP&HTTPS request. - idempotent: indicates that the Create request is idempotent. Update and Delete requests should be always idempotent. Examples: - acs:fc:cn-hangzhou:123456789:services/test-service/functions/test-function - acs:fc:cn-hangzhou:123456789:functions/test-function - acs:mns:cn-hangzhou:123456789:queues/test-queue - acs:mns:cn-hangzhou:123456789:/queues/test-queue - acs:mns:cn-hangzhou:123456789:topics/test-topic - acs:mns:cn-hangzhou:123456789:/topics/test-topic - web:https://abc.com - web[sync]:http://abc.com - web[sync,idempotent]:https://abc.com
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IAssert")
class IAssert(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Assert``.'''

    @builtins.property
    @jsii.member(jsii_name="attrFailureCause")
    def attr_failure_cause(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IAssertProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IAssert"
    ...
    def attr_failure_cause(
        ...
        '''Attribute FailureCause: The reason the assertion failed.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrFailureCause"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> AssertProps:
        return typing.cast(AssertProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAssert).__jsii_proxy_class__ = lambda : _IAssertProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IAutoEnableService")
class IAutoEnableService(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``AutoEnableService``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AutoEnableServiceProps:
        ...


class _IAutoEnableServiceProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``AutoEnableService``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IAutoEnableService"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AutoEnableServiceProps:
        return typing.cast(AutoEnableServiceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAutoEnableService).__jsii_proxy_class__ = lambda : _IAutoEnableServiceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.ICustomResource")
class ICustomResource(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CustomResourceProps:
        ...


class _ICustomResourceProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CustomResource``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.ICustomResource"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> CustomResourceProps:
        return typing.cast(CustomResourceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICustomResource).__jsii_proxy_class__ = lambda : _ICustomResourceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IResourceCleaner")
class IResourceCleaner(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``ResourceCleaner``.'''

    @builtins.property
    @jsii.member(jsii_name="attrCleanResult")
    def attr_clean_result(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_no_cleanup_resource_details(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_resource_partial_details(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ResourceCleanerProps":
        ...


class _IResourceCleanerProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ResourceCleaner``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IResourceCleaner"
    ...
    def attr_clean_result(
        ...
        - None: Cleanup is not triggered.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCleanResult"))
    ...
    def attr_no_cleanup_resource_details(
        ...
        The format is the same as ResourceDetails.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNoCleanupResourceDetails"))
    ...
    def attr_no_cleanup_resource_partial_details(
        ...
        The format is the same as ResourcePartialDetails.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNoCleanupResourcePartialDetails"))
    ...
    def attr_resource_details(
        ...
        - ResourceId: ID of the dependency resource.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrResourceDetails"))
    ...
    def attr_resource_partial_details(
        ...
        - ResourceStatusReason: The information of the related ResourceStatus.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrResourcePartialDetails"))
    ...
    def attr_resource_summary(
        ...
        - TotalCount: Number of total resources of the resource type.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrResourceSummary"))
    ...
    def attr_scan_errors(
        ...
        - ErrorMessage: Error message of scanning with specified resource type and region ID.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrScanErrors"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ResourceCleanerProps":
        return typing.cast("ResourceCleanerProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IResourceCleaner).__jsii_proxy_class__ = lambda : _IResourceCleanerProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.ISleep")
class ISleep(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Sleep``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SleepProps":
        ...
...
class _ISleepProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.ISleep"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SleepProps":
        return typing.cast("SleepProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISleep).__jsii_proxy_class__ = lambda : _ISleepProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IStack")
class IStack(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Stack``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StackProps":
        ...
...
class _IStackProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IStack"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StackProps":
        return typing.cast("StackProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IStack).__jsii_proxy_class__ = lambda : _IStackProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IStackGroup")
class IStackGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StackGroupProps":
        ...


class _IStackGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``StackGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IStackGroup"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "StackGroupProps":
        return typing.cast("StackGroupProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IStackGroup).__jsii_proxy_class__ = lambda : _IStackGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IStackInstances")
class IStackInstances(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``StackInstances``.'''

    @builtins.property
    @jsii.member(jsii_name="attrLastOperationId")
    def attr_last_operation_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StackInstancesProps":
        ...


class _IStackInstancesProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``StackInstances``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IStackInstances"
    ...
    def attr_last_operation_id(
        ...
        '''Attribute LastOperationId: undefined.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLastOperationId"))
    ...
    def attr_stacks(
        ...
        '''Attribute Stacks: undefined.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrStacks"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StackInstancesProps":
        return typing.cast("StackInstancesProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IStackInstances).__jsii_proxy_class__ = lambda : _IStackInstancesProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IWaitCondition")
class IWaitCondition(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "WaitConditionProps":
        ...


class _IWaitConditionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``WaitCondition``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IWaitCondition"
    ...
    def attr_error_data(
        ...
        '''Attribute ErrorData: JSON serialized dict containing data associated with wait condition error signals sent to the handle.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrErrorData"))
    ...
    def attr_joined_error_data(
        ...
        '''Attribute JoinedErrorData: String containing data associated with wait condition error signals sent to the handle.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrJoinedErrorData"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "WaitConditionProps":
        return typing.cast("WaitConditionProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IWaitCondition).__jsii_proxy_class__ = lambda : _IWaitConditionProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-ros.IWaitConditionHandle")
class IWaitConditionHandle(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "WaitConditionHandleProps":
        ...


class _IWaitConditionHandleProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``WaitConditionHandle``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ros.IWaitConditionHandle"
    ...
    def attr_headers(
        ...
        '''Attribute Headers: HTTP POST Headers used for signalling handle completion or failure.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrHeaders"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "WaitConditionHandleProps":
        return typing.cast("WaitConditionHandleProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IWaitConditionHandle).__jsii_proxy_class__ = lambda : _IWaitConditionHandleProxy


@jsii.implements(IResourceCleaner)
class ResourceCleaner(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosResourceCleaner``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__545f99e1f929e068b48406a316ad4d613573f8cfaf15547c8aab2ce2aebb253d)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__60da093525d400dc0b1c84b01b210b24b1ad7661e5b2d9835ce36ef2a4ecd4c4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f9ca927594b63a9bf5e60c0dd93809c1432c699897ef91ff21f06ddf79eb8643)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosAssert(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ros.RosAssert",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::ROS::Assert``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``Assert`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-assert
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosAssertProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a617beb6202613b45253b81fc50a204e7623b57a59dae082c60068839d95d392)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e405cb906c97e4d531d32c99b985372d83fddb37c1aaf05d1e7bc8933d44c65d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    @builtins.property
    @jsii.member(jsii_name="attrFailureCause")
    def attr_failure_cause(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: FailureCause: The reason the assertion failed
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrFailureCause"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__769e06a4cc146358d956997c91ad2b1c15dfadc9d64751367789f39cfbe3373c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def values(
        ...
        values: A list of values to assert. The items in the list are compared in order. The range of length is one to three.

        - Three values are supported only if the operation is Equal or NotEqual.
        - One value is supported only if the operation is Not.
        '''
        return typing.cast(typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "values"))
    ...
    def values(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__08eb3fa5631b91c08ee9a5ee9415eb4c57a6116156e58591dbe5e762aa8df0c9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "values", value)

    @builtins.property
    @jsii.member(jsii_name="abortCreation")
    def abort_creation(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "abortCreation"))

    @abort_creation.setter
    def abort_creation(
        self,
        value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0a6f20b0edecfb406083952108d9b9acb02f78342755c2285acc082bface7bb7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "abortCreation", value)
    ...
    def error_message(
        ...
        :Property: errorMessage: The error message to be returned when the assert fails.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "errorMessage"))
    ...
    def error_message(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c2b7e2742a9cd81f8e579e3ef415d2d6f78c7a8f4e3d9c7737395965daa4a38a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def operation(
        ...
        operation: The type of assertion to make. The supported operations are:
        Equal, NotEqual, Greater, GreaterOrEqual, Less, LessOrEqual, Contain, NotContain, And, Or, Not.
        Default is Equal.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "operation"))
    ...
    def operation(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__58d43c45e07deccbbba23d305b731f5b6f9ae4443304c945410602f2b48e9f25)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "operation", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-ros.RosAssertProps",
    jsii_struct_bases=[],
    name_mapping={
        "values": "values",
        "abort_creation": "abortCreation",
...
class RosAssertProps:
    def __init__(
        ...
        *,
        ...
        :param values: 
        :param abort_creation: 
        :param error_message: 
        :param operation: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__171250008cc5b59a2b8539ab0796352bd7fe2dce048b184efa7a38d5bffebf32)
            check_type(argname="argument values", value=values, expected_type=type_hints["values"])
            check_type(argname="argument abort_creation", value=abort_creation, expected_type=type_hints["abort_creation"])
            check_type(argname="argument error_message", value=error_message, expected_type=type_hints["error_message"])
            check_type(argname="argument operation", value=operation, expected_type=type_hints["operation"])
...
class RosAutoEnableService(
    ...
    This class does not contain additional functions, so it is recommended to use the ``AutoEnableService`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-autoenableservice
    '''
...
class RosCustomResource(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CustomResource`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-customresource
    '''
...
class RosResourceCleaner(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ResourceCleaner`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-resourcecleaner
    '''
...
class RosSleep(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Sleep`` class instead of this class for a more convenient development experience.
...
class RosStack(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Stack`` class instead of this class for a more convenient development experience.
...
class RosStackGroup(
    ...
    This class does not contain additional functions, so it is recommended to use the ``StackGroup`` class instead of this class for a more convenient development experience.
...
class RosStackInstances(
    ...
    This class does not contain additional functions, so it is recommended to use the ``StackInstances`` class instead of this class for a more convenient development experience.
...
class RosWaitCondition(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::ROS::WaitCondition``, which is used to wait for signals.
    ...
    This class does not contain additional functions, so it is recommended to use the ``WaitCondition`` class instead of this class for a more convenient development experience.
...
class RosWaitConditionHandle(
    ...
    This class does not contain additional functions, so it is recommended to use the ``WaitConditionHandle`` class instead of this class for a more convenient development experience.
...
class Sleep(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosSleep``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-sleep
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3676cd0ac02ec078af7124a11d0bda848811e6785acca47fa6dd6dcf8b00c8d0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d2080d911b2cb95afc3493b8877f4a378253dedd0ebac1edc745d53c92eaa382)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d02f229635582754a441f5ed33b1e17a33ffacebc04f306df991e5c2f1984761)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class Stack(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosStack``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-stack
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__706e3b9a948294158619d3259e037882de1bfc00bc72efdd7b8c94fca5f298a7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ff1b79656340ea210a929f68ac048304eb204c6747f5c0daae861130cbb3386d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9874c5f71c188bff913dd0f2256037674b2de1f29d4237454009a2d5c0322aa4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IStackGroup)
class StackGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosStackGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-stackgroup
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0e49e4ebded8c6f1c2404050917099ec4ddf7ea3de993e2916afce248289feee)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__977b817167f5af48738cd143aea9ec04fb1c1bf504b217d261c39ff2101b81bc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__73c09f93adb5ec790f092b5d89ecfd3194ab9afe69d165090782859e9bb14873)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IStackInstances)
class StackInstances(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosStackInstances``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-stackinstances
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f9d9fa484c8e1a0a2c6de2bdf15735d42b9a3d1fb77cd01fc4b7983b8a5cad47)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e13ea1166cbcdec66a7ac60c8792e5df71bafedeb4e6449974c5a0310b725aee)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__11719075818323f56d6059c2b3ac00c713013da0ef6ea91cd9b60a0fd35acec5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IWaitCondition)
class WaitCondition(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosWaitCondition``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-waitcondition
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__df859406953ad3ccf16c5895d6b0db9394246ffdbee7428372967ebf4ea796f1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__921dc4922c30c5f42d27143a89272d3d30394c8ee6c9c29b7a66fa8b4d4f8939)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b425668233b48be6eed77e50106d8d9bedb412b72a7160c960c5df721ecebcee)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IWaitConditionHandle)
class WaitConditionHandle(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosWaitConditionHandle``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-waitconditionhandle
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea9e80c718b660f4788b61e27b3aac5daa6653103756c4bbc3e18ac28be578cf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa31992380e072ccc9e0189492775f3bea83c5e71356fe49bf79920c2a30f61e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6a1116d6ced35687991a778ab47876557c42cb068cf3e412180955a34a35b56c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IAssert)
class Assert(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-ros.Assert",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::ROS::Assert``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosAssert``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-assert
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[AssertProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__50af3f5e8d3fa09e47699e2c0eba4ffa0be2edede5f6bdec00ce923e712299c8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1d803950a8da186ddbdef94d265f026ae40606bba5751f85a535864c562617d1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f0ebb66f55c4c50c0ec510a67cb3517589ea9228f8e56e1eda6b183443b4a7bf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bc46a50e69b1d2cebf8fff9788440d38d181b3e385a3b643de3d75743def55d8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IAutoEnableService)
class AutoEnableService(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosAutoEnableService``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-autoenableservice
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3889e9cacba065146b1749b708526b14f61efc16b9f1451b7a6ee5c537588e1b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e9385eaafd50464a7ccaf2cc413efa6136ae96d5b097bfae592bed39be821a99)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b4c1d11a143fcda79e119701711b3ec50353f67ca8ff45b8ec87cb80f9a60e51)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICustomResource)
class CustomResource(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCustomResource``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-customresource
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__55bf73c4a63e37c1ec3ea908cddda2fee5f9f8283135e622b63433161a489b9c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__43f4fb4951a906f411399a99b58784592bd05db961b5b416cfdd75b1b8326703)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cea68e6a03b5be89dd29b8995a9ad01c8b64f5929b51bd216065c11a78c802ad)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
def _typecheckingstub__0fb1688054c9203181fa1b2fefb4888565ee3602b76394141c47319638cb8cdc(
    *,
    values: typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable],
    abort_creation: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    error_message: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__545f99e1f929e068b48406a316ad4d613573f8cfaf15547c8aab2ce2aebb253d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__60da093525d400dc0b1c84b01b210b24b1ad7661e5b2d9835ce36ef2a4ecd4c4(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f9ca927594b63a9bf5e60c0dd93809c1432c699897ef91ff21f06ddf79eb8643(
...
def _typecheckingstub__a617beb6202613b45253b81fc50a204e7623b57a59dae082c60068839d95d392(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosAssertProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__e405cb906c97e4d531d32c99b985372d83fddb37c1aaf05d1e7bc8933d44c65d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__769e06a4cc146358d956997c91ad2b1c15dfadc9d64751367789f39cfbe3373c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__08eb3fa5631b91c08ee9a5ee9415eb4c57a6116156e58591dbe5e762aa8df0c9(
    value: typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0a6f20b0edecfb406083952108d9b9acb02f78342755c2285acc082bface7bb7(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c2b7e2742a9cd81f8e579e3ef415d2d6f78c7a8f4e3d9c7737395965daa4a38a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__58d43c45e07deccbbba23d305b731f5b6f9ae4443304c945410602f2b48e9f25(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__171250008cc5b59a2b8539ab0796352bd7fe2dce048b184efa7a38d5bffebf32(
    *,
    values: typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable],
    abort_creation: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    error_message: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__3676cd0ac02ec078af7124a11d0bda848811e6785acca47fa6dd6dcf8b00c8d0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d2080d911b2cb95afc3493b8877f4a378253dedd0ebac1edc745d53c92eaa382(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d02f229635582754a441f5ed33b1e17a33ffacebc04f306df991e5c2f1984761(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__706e3b9a948294158619d3259e037882de1bfc00bc72efdd7b8c94fca5f298a7(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ff1b79656340ea210a929f68ac048304eb204c6747f5c0daae861130cbb3386d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9874c5f71c188bff913dd0f2256037674b2de1f29d4237454009a2d5c0322aa4(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0e49e4ebded8c6f1c2404050917099ec4ddf7ea3de993e2916afce248289feee(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__977b817167f5af48738cd143aea9ec04fb1c1bf504b217d261c39ff2101b81bc(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__73c09f93adb5ec790f092b5d89ecfd3194ab9afe69d165090782859e9bb14873(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__f9d9fa484c8e1a0a2c6de2bdf15735d42b9a3d1fb77cd01fc4b7983b8a5cad47(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e13ea1166cbcdec66a7ac60c8792e5df71bafedeb4e6449974c5a0310b725aee(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__11719075818323f56d6059c2b3ac00c713013da0ef6ea91cd9b60a0fd35acec5(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__df859406953ad3ccf16c5895d6b0db9394246ffdbee7428372967ebf4ea796f1(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__921dc4922c30c5f42d27143a89272d3d30394c8ee6c9c29b7a66fa8b4d4f8939(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b425668233b48be6eed77e50106d8d9bedb412b72a7160c960c5df721ecebcee(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__ea9e80c718b660f4788b61e27b3aac5daa6653103756c4bbc3e18ac28be578cf(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fa31992380e072ccc9e0189492775f3bea83c5e71356fe49bf79920c2a30f61e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6a1116d6ced35687991a778ab47876557c42cb068cf3e412180955a34a35b56c(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__50af3f5e8d3fa09e47699e2c0eba4ffa0be2edede5f6bdec00ce923e712299c8(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[AssertProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__1d803950a8da186ddbdef94d265f026ae40606bba5751f85a535864c562617d1(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f0ebb66f55c4c50c0ec510a67cb3517589ea9228f8e56e1eda6b183443b4a7bf(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bc46a50e69b1d2cebf8fff9788440d38d181b3e385a3b643de3d75743def55d8(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3889e9cacba065146b1749b708526b14f61efc16b9f1451b7a6ee5c537588e1b(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e9385eaafd50464a7ccaf2cc413efa6136ae96d5b097bfae592bed39be821a99(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b4c1d11a143fcda79e119701711b3ec50353f67ca8ff45b8ec87cb80f9a60e51(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__55bf73c4a63e37c1ec3ea908cddda2fee5f9f8283135e622b63433161a489b9c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__43f4fb4951a906f411399a99b58784592bd05db961b5b416cfdd75b1b8326703(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cea68e6a03b5be89dd29b8995a9ad01c8b64f5929b51bd216065c11a78c802ad(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
