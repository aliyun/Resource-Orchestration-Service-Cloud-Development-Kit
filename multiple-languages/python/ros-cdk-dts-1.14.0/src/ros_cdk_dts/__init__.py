...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-dts.ConsumerChannelProps",
    jsii_struct_bases=[],
    name_mapping={
...
class ConsumerChannelProps:
    def __init__(
        ...
        *,
        ...
        :param consumer_group_name: Property consumerGroupName: Consumer group name, up to 128 characters.
        :param consumer_group_password: Property consumerGroupPassword: Consumer group password, composed of uppercase letters, lowercase letters, numbers, and special characters (at least two types), 8-32 characters long.
        :param consumer_group_user_name: Property consumerGroupUserName: Username, composed of uppercase letters, lowercase letters, numbers, and underscores, up to 16 characters.
        :param dts_instance_id: Property dtsInstanceId: DTS subscription instance ID. Either DtsInstanceId or DtsJobId must be provided.
        :param dts_job_id: Property dtsJobId: DTS subscription job ID. Either DtsInstanceId or DtsJobId must be provided.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5a5f9fa66eb37c97c68ec2a83fb61a3eea0286c4d1dedde29be7752cbebf17d5)
    ...
    def __repr__(self) -> str:
        return "ConsumerChannelProps(%s)" % ", ".join(
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.IConsumerChannel")
class IConsumerChannel(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrConsumerGroupUserName")
    def attr_consumer_group_user_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def props(self) -> ConsumerChannelProps:
        ...


class _IConsumerChannelProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ConsumerChannel``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.IConsumerChannel"
    ...
    def attr_consumer_group_name(
        ...
        '''Attribute ConsumerGroupName: Consumer group name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConsumerGroupName"))
    ...
    def attr_consumer_group_user_name(
        ...
        '''Attribute ConsumerGroupUserName: Consumer group username.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConsumerGroupUserName"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> ConsumerChannelProps:
        return typing.cast(ConsumerChannelProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IConsumerChannel).__jsii_proxy_class__ = lambda : _IConsumerChannelProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.IConsumerGroup")
class IConsumerGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_subscription_instance_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IConsumerGroupProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.IConsumerGroup"
    ...
    def attr_subscription_instance_id(
        ...
        '''Attribute SubscriptionInstanceId: Subscription instance ID.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSubscriptionInstanceId"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.IInstance")
...
class _IInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.IInstance"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.IJobMonitorRule")
class IJobMonitorRule(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrPhones")
    def attr_phones(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IJobMonitorRuleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.IJobMonitorRule"
    ...
    def attr_phones(
        ...
        '''Attribute Phones: The alarm is triggered after notification of the contact phone number, A plurality of phone numbers between them with a comma (,) to separate.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrPhones"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.IMigrationJob2")
class IMigrationJob2(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MigrationJob2Props":
        ...


class _IMigrationJob2Proxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MigrationJob2``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.IMigrationJob2"
    ...
    def attr_dts_job_name(
        ...
        '''Attribute DtsJobName: The name of the DTS job.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDtsJobName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MigrationJob2Props":
        return typing.cast("MigrationJob2Props", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMigrationJob2).__jsii_proxy_class__ = lambda : _IMigrationJob2Proxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.ISubscriptionJob2")
class ISubscriptionJob2(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SubscriptionJob2Props":
        ...


class _ISubscriptionJob2Proxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SubscriptionJob2``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.ISubscriptionJob2"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "SubscriptionJob2Props":
        return typing.cast("SubscriptionJob2Props", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISubscriptionJob2).__jsii_proxy_class__ = lambda : _ISubscriptionJob2Proxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-dts.ISynchronizationJob2")
class ISynchronizationJob2(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "SynchronizationJob2Props":
        ...


class _ISynchronizationJob2Proxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``SynchronizationJob2``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-dts.ISynchronizationJob2"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "SynchronizationJob2Props":
        return typing.cast("SynchronizationJob2Props", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ISynchronizationJob2).__jsii_proxy_class__ = lambda : _ISynchronizationJob2Proxy
...
class Instance(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea0f8fdfa8ca672b377f3504c88ebfeade64926b3c789861f7b88795a9aad60a)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8f88ccedd92aad37defa4ad28ae4bd4a1d2b2b1c06a7d8a0810446e6bc201c01)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__14f62ed1a019529fef39626335852a590a2d03e6e783b210fd39e906d40e66ab)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class InstanceProps:
    def __init__(
        ...
        *,
        ...
        insight_module: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        job_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        max_du: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        min_du: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param insight_module: Property insightModule: Whether to enable the insight module.
        ...
        :param max_du: Property maxDu: The upper limit of DU. .. epigraph:: Only Serverless instances are supported.
        :param min_du: Property minDu: The lower limit of DU. .. epigraph:: Only Serverless instances are supported.
        ...
        if __debug__:
            ...
            check_type(argname="argument insight_module", value=insight_module, expected_type=type_hints["insight_module"])
            check_type(argname="argument job_id", value=job_id, expected_type=type_hints["job_id"])
            check_type(argname="argument max_du", value=max_du, expected_type=type_hints["max_du"])
            check_type(argname="argument min_du", value=min_du, expected_type=type_hints["min_du"])
        ...
        if insight_module is not None:
            self._values["insight_module"] = insight_module
        if job_id is not None:
            self._values["job_id"] = job_id
        if max_du is not None:
            self._values["max_du"] = max_du
        if min_du is not None:
            self._values["min_du"] = min_du
    ...
    def insight_module(
        ...
        result = self._values.get("insight_module")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def max_du(
        ...
        '''
        result = self._values.get("max_du")
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def min_du(
        ...
        .. epigraph::
           ...
           Only Serverless instances are supported.
        '''
        result = self._values.get("min_du")
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)
...
class JobMonitorRule(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-dts.JobMonitorRule",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4fd05cc9dcacb15ba3251be4d16a9a0879fbe1d33f679fd96b4b723773e8f94e)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5c8ecb0cc3d8d218618890ee9fd200201c123b934769966c7d13754d51fd0ec3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f0d041d5f506b7a0eadc752e71bd583a60f444e91b2c892839cde3d2929e2c0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__74038a820b4fefff80376c8266ee358d7ff7a00bae5556dfd0513917cd11a0fe)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-dts.JobMonitorRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "dts_job_id": "dtsJobId",
        "type": "type",
...
class JobMonitorRuleProps:
    def __init__(
        ...
        *,
        ...
        phones: typing.Optional[typing.Union[typing.Sequence[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]] = None,
        state: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        times: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``JobMonitorRule``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-jobmonitorrule

        :param dts_job_id: Property dtsJobId: Migration, synchronization or subscription task ID can be by calling the [DescribeDtsJobs](~~ 209702 ~~) get.
        :param type: Property type: Monitoring rules of type, the return value: - **delay**: delay alarm. - **error**: abnormal alarm.
        :param delay_rule_time: Property delayRuleTime: Trigger delay alarm threshold, which is measured in seconds.
        :param period: Property period: The statistical period of the incremental verification task. Unit: minutes. .. epigraph:: currently supported values are 1 minute, 3 minutes, 5 minutes and 30 minutes.
        :param phones: Property phones: The alarm is triggered after notification of the contact phone number.
        :param state: Property state: Whether to enable monitoring rules, return value: - **Y**: enable. - **N**: Inactive.
        :param times: Property times: The number of cycles of the incremental verification task.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__da23652949bebf5455ca5941df3af4b6cbfc2d45a1d8ca3fe2550293c00c0c21)
            check_type(argname="argument dts_job_id", value=dts_job_id, expected_type=type_hints["dts_job_id"])
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
...
@jsii.implements(IMigrationJob2)
class MigrationJob2(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__85f65411b3bb43db201be72480a6f5f1ee1a7164a85c221d3fbaf9c656aa1096)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c9042770be0855765262cf200b77d47f2c012326271ca0b5665676fbfb6a575c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7de71edb46c459d61030d3e4bff2f953962821a86ce50465f81095218f9445a8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "delay_rule_time": "delayRuleTime",
        "dest_primary_vsw_id": "destPrimaryVswId",
        "dest_secondary_vsw_id": "destSecondaryVswId",
        ...
        "reserve": "reserve",
        "resource_group_id": "resourceGroupId",
        "src_primary_vsw_id": "srcPrimaryVswId",
        "src_secondary_vsw_id": "srcSecondaryVswId",
        "status": "status",
    },
)
class MigrationJob2Props:
    def __init__(
        ...
        *,
        ...
        delay_rule_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        dest_primary_vsw_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        dest_secondary_vsw_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        resource_group_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        src_primary_vsw_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        src_secondary_vsw_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param dest_primary_vsw_id: Property destPrimaryVswId: The primary VSW ID at the destination end of the VPC NAT.
        :param dest_secondary_vsw_id: Property destSecondaryVswId: The secondary VSW ID at the destination end of the VPC NAT.
        ...
        :param error_phone: Property errorPhone: The mobile numbers that receive status-related alerts. Separate multiple mobile numbers with commas (,). You can specify up to 10 mobile numbers. **Note**: You can also configure alert rules for DTS tasks in the CloudMonitor console.This parameter is available only for users of the China site (aliyun.com). Only mobile numbers in the Chinese mainland are supported. Users of the international site (alibabacloud.com) cannot receive alerts by using mobile numbers.
        ...
        :param max_du: Property maxDu: The upper limit of DU. This parameter is supported only for serverless instances.
        :param min_du: Property minDu: The lower limit of DU. This parameter is supported only for serverless instances.
        ...
        :param resource_group_id: Property resourceGroupId: The ID of the resource group.
        :param src_primary_vsw_id: Property srcPrimaryVswId: The primary VSW ID at the source end of the VPC NAT.
        :param src_secondary_vsw_id: Property srcSecondaryVswId: The secondary VSW ID at the source end of the VPC NAT.
        ...
        if __debug__:
            ...
            check_type(argname="argument delay_rule_time", value=delay_rule_time, expected_type=type_hints["delay_rule_time"])
            check_type(argname="argument dest_primary_vsw_id", value=dest_primary_vsw_id, expected_type=type_hints["dest_primary_vsw_id"])
            check_type(argname="argument dest_secondary_vsw_id", value=dest_secondary_vsw_id, expected_type=type_hints["dest_secondary_vsw_id"])
            ...
            check_type(argname="argument resource_group_id", value=resource_group_id, expected_type=type_hints["resource_group_id"])
            check_type(argname="argument src_primary_vsw_id", value=src_primary_vsw_id, expected_type=type_hints["src_primary_vsw_id"])
            check_type(argname="argument src_secondary_vsw_id", value=src_secondary_vsw_id, expected_type=type_hints["src_secondary_vsw_id"])
        ...
        if delay_rule_time is not None:
            self._values["delay_rule_time"] = delay_rule_time
        if dest_primary_vsw_id is not None:
            self._values["dest_primary_vsw_id"] = dest_primary_vsw_id
        if dest_secondary_vsw_id is not None:
            self._values["dest_secondary_vsw_id"] = dest_secondary_vsw_id
        ...
        if resource_group_id is not None:
            self._values["resource_group_id"] = resource_group_id
        if src_primary_vsw_id is not None:
            self._values["src_primary_vsw_id"] = src_primary_vsw_id
        if src_secondary_vsw_id is not None:
            self._values["src_secondary_vsw_id"] = src_secondary_vsw_id
...
class RosConsumerChannel(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-dts.RosConsumerChannel",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::DTS::ConsumerChannel``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ConsumerChannel`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-consumerchannel
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosConsumerChannelProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__216c88eb68e14339ef10b3702315d2489e6723cd1ce1b818e675acb17232cec3)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b6b392eafcb382b8c9a5a989d86bbba951c2a50872d151e76611f1b117111e0a)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    @builtins.property
    @jsii.member(jsii_name="attrConsumerGroupUserName")
    def attr_consumer_group_user_name(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ConsumerGroupUserName: Consumer group username
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrConsumerGroupUserName"))
    ...
    def consumer_group_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__270a474eafa7c8ed89a1d666bec29757b46a2eeff3415bfee768c0d81aed566f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def consumer_group_password(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cdff3039475601afe98de66064068b9e5f5ac14ab7aa93d6a578a9cbcd3f2b50)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def consumer_group_user_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c7cdf445713015a458419ba1b8bf83450f462a27af380e09559788ab5301cf13)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4148db2a1b04728ea2bc2a5ae1128a0bca1d74171e53562c7ea10a31aae24874)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def dts_instance_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1b4a2efb6da0ccba6c2c311f796030b1bf8d2ecd3162e515e74d5decc6560bad)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def dts_job_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4a9ea331f7b6abdde73e83c34aa856b7850714e186f49d0232b944ea8cd26b31)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "dtsJobId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-dts.RosConsumerChannelProps",
    jsii_struct_bases=[],
    name_mapping={
        "consumer_group_name": "consumerGroupName",
        "consumer_group_password": "consumerGroupPassword",
...
class RosConsumerChannelProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__00b126c682ce9189f120f1f744a23c42601642c47bd9ca9c6f469de17cdfb238)
            check_type(argname="argument consumer_group_name", value=consumer_group_name, expected_type=type_hints["consumer_group_name"])
            check_type(argname="argument consumer_group_password", value=consumer_group_password, expected_type=type_hints["consumer_group_password"])
            check_type(argname="argument consumer_group_user_name", value=consumer_group_user_name, expected_type=type_hints["consumer_group_user_name"])
            check_type(argname="argument dts_instance_id", value=dts_instance_id, expected_type=type_hints["dts_instance_id"])
    ...
    def __repr__(self) -> str:
        return "RosConsumerChannelProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosInstance(
    ...
    @builtins.property
    @jsii.member(jsii_name="insightModule")
    def insight_module(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: insightModule: Whether to enable the insight module.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "insightModule"))

    @insight_module.setter
    def insight_module(
        self,
        value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2a4a332ff745fb2282eec045ba4987b0e245911492efdd4c594fcb925dbf0896)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "insightModule", value)
    ...
    def max_du(
        ...
        maxDu: The upper limit of DU.
        .. epigraph::

        Only Serverless instances are supported.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "maxDu"))
    ...
    def max_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6fecb4c56f60dcc4679f7d3916f0f50871d7323210450f2b53c58ea09ddbba2e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "maxDu", value)

    @builtins.property
    @jsii.member(jsii_name="minDu")
    def min_du(
        self,
    ) -> typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        minDu: The lower limit of DU.
        .. epigraph::

        Only Serverless instances are supported.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "minDu"))
    ...
    def min_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2c1c0213bf0fdbc8dc2196d0b5dcd137eec80effe7f6f0ef2c03be023fc976da)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "minDu", value)
...
class RosJobMonitorRule(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-dts.RosJobMonitorRule",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7378b9a407349edb730baf41354de640e110b2de54c9920e30d6b27332b11769)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f1a05f5292230396ccdb009e8170cb6b203f5565c9a04346a2d25f4e94eb79d6)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrPhones")
    def attr_phones(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: Phones: The alarm is triggered after notification of the contact phone number, A plurality of phone numbers between them with a comma (,) to separate.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrPhones"))
    ...
    def dts_job_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7efbe22814a2ae3e226aa1991de7cfbf6239ec9c4caf9f9dbdbe3da7d8b87433)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "dtsJobId", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bddaa52ae12848d352ab7cd1661278e88c2ee68106e3d7a4fbdca7b77a3f2b30)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def type(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        ...
        type: Monitoring rules of type, the return value:
    ...
    def type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4cd6b34c67e7e34e45c0af33ca4e27f7f7f343dd4ab6a21a8b2a7cd2ab26743d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "type", value)
    ...
    def delay_rule_time(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ef0f49bb33861097d031eee90a51f5fad2362f19ef495b83cdb50a04b83697f6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def period(
        ...
        period: The statistical period of the incremental verification task. Unit: minutes.
        .. epigraph::
    ...
    def period(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7546b1e1b00fd7f4d38c2a23fcfaa42383c40f0df0d6ce84ff399b3a5bf41561)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "period", value)
    ...
    def phones(
        ...
        :Property: phones: The alarm is triggered after notification of the contact phone number.
        '''
        return typing.cast(typing.Optional[typing.Union[typing.List[typing.Any], _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "phones"))
    ...
    def phones(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__278a7f7b880f680d15c866d6a1781477c7614a2214889158d11b4b0218e6633d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "phones", value)
    ...
    def state(
        ...
        state: Whether to enable monitoring rules, return value:
    ...
    def state(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b2527c9395772de9398869bc93060f856ab96130eec4e0fe4d2f1a9089f3c028)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def times(
        ...
        :Property: times: The number of cycles of the incremental verification task.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "times"))
    ...
    def times(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8b13de8204f061da83635cc2bb3c122c460cfeea49c6c593319f55a7b3306f64)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "times", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-dts.RosJobMonitorRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "dts_job_id": "dtsJobId",
        "type": "type",
...
class RosJobMonitorRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5bf365e53e27650099fd8dc3eeb2c3f3b58e5686a1fc8895ebd354409961aa53)
            check_type(argname="argument dts_job_id", value=dts_job_id, expected_type=type_hints["dts_job_id"])
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument delay_rule_time", value=delay_rule_time, expected_type=type_hints["delay_rule_time"])
            check_type(argname="argument period", value=period, expected_type=type_hints["period"])
...
class RosMigrationJob2(
    ...
    def delay_phone(
        ...
        delayPhone: The mobile numbers that receive latency-related alerts. Separate multiple mobile numbers with commas (,). You can specify up to 10 mobile numbers.
        **Note**: You can also configure alert rules for DTS tasks in the CloudMonitor console.This parameter is available only for users of the China site (aliyun.com). Only mobile numbers in the Chinese mainland are supported. Users of the international site (alibabacloud.com) cannot receive alerts by using mobile numbers.
        '''
    ...
    @builtins.property
    @jsii.member(jsii_name="destPrimaryVswId")
    def dest_primary_vsw_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: destPrimaryVswId: The primary VSW ID at the destination end of the VPC NAT.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "destPrimaryVswId"))

    @dest_primary_vsw_id.setter
    def dest_primary_vsw_id(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__154f85915eb2ffa13e90165fb690da2b1d7a4801c487007375f90a83586c2872)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destPrimaryVswId", value)

    @builtins.property
    @jsii.member(jsii_name="destSecondaryVswId")
    def dest_secondary_vsw_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: destSecondaryVswId: The secondary VSW ID at the destination end of the VPC NAT.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "destSecondaryVswId"))

    @dest_secondary_vsw_id.setter
    def dest_secondary_vsw_id(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9a03924a444fb7f733b35ac2f75f5fe0a4348e20b7e24f8def7c8f0405129384)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destSecondaryVswId", value)
    ...
    def error_phone(
        ...
        errorPhone: The mobile numbers that receive status-related alerts. Separate multiple mobile numbers with commas (,). You can specify up to 10 mobile numbers.
        **Note**: You can also configure alert rules for DTS tasks in the CloudMonitor console.This parameter is available only for users of the China site (aliyun.com). Only mobile numbers in the Chinese mainland are supported. Users of the international site (alibabacloud.com) cannot receive alerts by using mobile numbers.
        '''
    ...
    def max_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__27e991f2b66c4a4e2008a17274728cb0178d21c63d19c5759514f403b91714ce)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "maxDu", value)
    ...
    def min_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2bdd6c679556c50e0e54994966fb50a237428dd68d9c02e18d92beb75719a9c8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "minDu", value)
    ...
    def resource_group_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a67a1a7496c67be5a20d26645b8194b0b09e6833255350f386568befc8998eab)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "resourceGroupId", value)

    @builtins.property
    @jsii.member(jsii_name="srcPrimaryVswId")
    def src_primary_vsw_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: srcPrimaryVswId: The primary VSW ID at the source end of the VPC NAT.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "srcPrimaryVswId"))

    @src_primary_vsw_id.setter
    def src_primary_vsw_id(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c75e86b1f7fdf66cbcfb0cf2f5c2eecf92b09834b9fb27a8455dd80c497ffbb0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcPrimaryVswId", value)

    @builtins.property
    @jsii.member(jsii_name="srcSecondaryVswId")
    def src_secondary_vsw_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: srcSecondaryVswId: The secondary VSW ID at the source end of the VPC NAT.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "srcSecondaryVswId"))

    @src_secondary_vsw_id.setter
    def src_secondary_vsw_id(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__15077c00d6b4ad41ad4a01661571ea664a9b494679ec6387f6ec298ddda976eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcSecondaryVswId", value)
...
class RosMigrationJob2Props:
    def __init__(
        ...
        *,
        ...
        :param delay_phone: 
        :param delay_rule_time: 
        :param dest_primary_vsw_id: 
        :param dest_secondary_vsw_id: 
        ...
        :param reserve: 
        :param resource_group_id: 
        :param src_primary_vsw_id: 
        :param src_secondary_vsw_id: 
        :param status: 
        '''
        if __debug__:
...
class RosSubscriptionJob2(
    ...
    def dest_primary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c22fc8850f7978e5c7e06ed63218764f3add42ee6e7e11df31b0c8e079ccd7cd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destPrimaryVswId", value)
    ...
    def dest_secondary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f274b5c61f1670d0202b97cba429da7b4a9671dccf5e65c9f49b31e4f3b300f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destSecondaryVswId", value)
    ...
    def max_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1bb3f10a65a247d8381b60dad71b1d79f8bbbb8c609e2cbbfc3fed289ba1d571)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "maxDu", value)
    ...
    def min_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4b022577ca76778e248f9c7b9a7c761ddf74c2d1d3f6ae44de18ce739ba46e96)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "minDu", value)
    ...
    def resource_group_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__377fbd1a3ee4717c935ca28fbc1f0ab65b25842f02f9e5c03016fc66756fcc3b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "resourceGroupId", value)
    ...
    def src_primary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c65296761bb6e2debfc260abbfcc108b2d5feab96f7f8b21752e33622fb6f054)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcPrimaryVswId", value)
    ...
    def src_secondary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__18067ea7189a0ba8b88d0279b95e2cb2162788946010451ee2ba9c39235617c4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcSecondaryVswId", value)
...
class RosSynchronizationJob2(
    ...
    def dest_primary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__77c72121be1bbda1baf59654e146e9aceb0f95791928555064faa4c72ecd34b0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destPrimaryVswId", value)
    ...
    def dest_secondary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6ba44db19faea655e4a57969c0bb9759ff952ffbbb0043c56fad8f4e31265113)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "destSecondaryVswId", value)
    ...
    def max_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__382aa49b9e215e99f2b050dc6f2deb1fb5a580be7b2e72ec0903812f5adf0d1f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "maxDu", value)
    ...
    def min_du(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__813b477308b43ecc1b03dada13b47a06d81b809395c156d395ad1b60954a054c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "minDu", value)
    ...
    def resource_group_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__21422ff08219651607cc739564a0e37e2b3cec6a2e828e14f2be75aeee3ba09a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "resourceGroupId", value)
    ...
    def src_primary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bf782fc61cfb75f6e8c039b589847efb959abf50f39f0dc397e37d2dd355bb9f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcPrimaryVswId", value)
    ...
    def src_secondary_vsw_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5879c1dd97cfd72abf42602fd7515d694c5d0811285088f26e931e7a2aec72c2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "srcSecondaryVswId", value)
...
@jsii.implements(ISubscriptionJob2)
class SubscriptionJob2(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1dcceef2e8b10695870e5209c48f73dc373f94a18224b6d803e1b5e6e53e1bee)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea60a0a5b543312de335673d71647be626831a8e907fa7c08810998d64ee92d6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ecf95138fa710e6b710867649909f839a6937fd07271e74aa10faaba88ffade4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ISynchronizationJob2)
class SynchronizationJob2(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0d1a20ffb6d4f590277aab6b1bc8ab45733152ce39162c1b8944dc812ae92895)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__addbe43e2a91a3126432eda921e6e23d7fa40594c8e1f71c39a5b04949402d4d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e4bcd22d652afc9d223a6dd08e5ae36e3a5ffb447a15f119442a06dfe3083b20)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IConsumerChannel)
class ConsumerChannel(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-dts.ConsumerChannel",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::DTS::ConsumerChannel``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosConsumerChannel``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-consumerchannel
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[ConsumerChannelProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aebffbc28084daa2108e51c582072566d384af4f60e45f65f6aaceb7474ce305)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a30345fbab8a528cdd44deec662c813f8b634a973a1386d57fa772c98aaba06d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__38bb088e7ce3d1df617b86d329a08a1123c2d2dae3e9c271ebe367beb0857746)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9c685a4d16007be4d228d4f4f0b94f9224d292a20c4f6467555e566d162d44f2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class ConsumerGroup(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4d130fc82901ac5068e9012c96e3117857a587ac0c33c679d2bb053654b3dc61)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d44085d566f9cd49bd00a599e2b7d9048fa13a9d4472b829e09b9e823754a256)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e14f5e8fcdaa79d586599c893e77da9ecde9059a15368b2d8bb49be250fb1310)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
def _typecheckingstub__5a5f9fa66eb37c97c68ec2a83fb61a3eea0286c4d1dedde29be7752cbebf17d5(
    *,
    consumer_group_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    consumer_group_password: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    consumer_group_user_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__ea0f8fdfa8ca672b377f3504c88ebfeade64926b3c789861f7b88795a9aad60a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8f88ccedd92aad37defa4ad28ae4bd4a1d2b2b1c06a7d8a0810446e6bc201c01(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub