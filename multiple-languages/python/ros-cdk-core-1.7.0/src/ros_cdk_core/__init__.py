...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-core.ResourceEnvironment",
    jsii_struct_bases=[],
    name_mapping={"account": "account", "region": "region"},
)
class ResourceEnvironment:
    def __init__(self, *, account: builtins.str, region: builtins.str) -> None:
        '''
        :param account: The Alibaba Cloud account ID that this resource belongs to. Since this can be a Token (for example, when the account is ROS's ALIYUN::AccountId intrinsic), make sure to use Token.compareStrings() instead of just comparing the values for equality.
        :param region: The Alibaba Cloud region that this resource belongs to. Since this can be a Token (for example, when the region is ROS's ALIYUN::Region intrinsic), make sure to use Token.compareStrings() instead of just comparing the values for equality.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__11a864a88714f2b75613b6e35a3ee437c7e723a61a9475fbe4d0c50383e5abe1)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "account": account,
...
def _typecheckingstub__11a864a88714f2b75613b6e35a3ee437c7e723a61a9475fbe4d0c50383e5abe1(
    *,
