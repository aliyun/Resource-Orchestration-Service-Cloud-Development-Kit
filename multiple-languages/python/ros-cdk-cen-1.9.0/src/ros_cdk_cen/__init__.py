...
class CenBandwidthLimitProps:
    def __init__(
        ...
        *,
        ...
        :param bandwidth_type: Property bandwidthType: Bandwidth allocation mode. Value: BandwidthPackage: Allocates bandwidth from the bandwidth package.
        '''
        if __debug__:
...
class CenBandwidthPackageProps:
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union["RosCenBandwidthPackage.TagsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
    ) -> None:
    ...
    def tags(
        self,
    ) -> typing.Optional[typing.List["RosCenBandwidthPackage.TagsProperty"]]:
        '''Property tags: Tags to attach to instance.

        Max support 20 tags to add during create instance. Each tag with two properties Key and Value, and Key is required.
        '''
        result = self._values.get("tags")
        return typing.cast(typing.Optional[typing.List["RosCenBandwidthPackage.TagsProperty"]], result)
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenBandwidthLimit")
class ICenBandwidthLimit(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``CenBandwidthLimit``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthLimitProps:
        ...


class _ICenBandwidthLimitProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenBandwidthLimit``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenBandwidthLimit"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthLimitProps:
        return typing.cast(CenBandwidthLimitProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenBandwidthLimit).__jsii_proxy_class__ = lambda : _ICenBandwidthLimitProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenBandwidthPackage")
class ICenBandwidthPackage(
    ...
    def attr_cen_bandwidth_package_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthPackageProps:
        ...


class _ICenBandwidthPackageProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenBandwidthPackage``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenBandwidthPackage"
    ...
    def attr_cen_bandwidth_package_id(
        ...
        '''Attribute CenBandwidthPackageId: The ID of the bandwidth package.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCenBandwidthPackageId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthPackageProps:
        return typing.cast(CenBandwidthPackageProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenBandwidthPackage).__jsii_proxy_class__ = lambda : _ICenBandwidthPackageProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenBandwidthPackageAssociation")
class ICenBandwidthPackageAssociation(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthPackageAssociationProps:
        ...


class _ICenBandwidthPackageAssociationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenBandwidthPackageAssociation``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenBandwidthPackageAssociation"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenBandwidthPackageAssociationProps:
        return typing.cast(CenBandwidthPackageAssociationProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenBandwidthPackageAssociation).__jsii_proxy_class__ = lambda : _ICenBandwidthPackageAssociationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenInstance")
class ICenInstance(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenInstanceProps:
        ...


class _ICenInstanceProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenInstance``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenInstance"
    ...
    def attr_cen_id(
        ...
        '''Attribute CenId: The ID of the request.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCenId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenInstanceProps:
        return typing.cast(CenInstanceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenInstance).__jsii_proxy_class__ = lambda : _ICenInstanceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenInstanceAttachment")
class ICenInstanceAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenInstanceAttachmentProps:
        ...


class _ICenInstanceAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenInstanceAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenInstanceAttachment"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenInstanceAttachmentProps:
        return typing.cast(CenInstanceAttachmentProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenInstanceAttachment).__jsii_proxy_class__ = lambda : _ICenInstanceAttachmentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenRouteMap")
class ICenRouteMap(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``CenRouteMap``.'''

    @builtins.property
    @jsii.member(jsii_name="attrRouteMapId")
    def attr_route_map_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenRouteMapProps:
        ...


class _ICenRouteMapProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenRouteMap``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenRouteMap"
    ...
    def attr_route_map_id(
        ...
        '''Attribute RouteMapId: The ID of the route map.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRouteMapId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenRouteMapProps:
        return typing.cast(CenRouteMapProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenRouteMap).__jsii_proxy_class__ = lambda : _ICenRouteMapProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenRouteService")
class ICenRouteService(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenRouteServiceProps:
        ...


class _ICenRouteServiceProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenRouteService``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenRouteService"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> CenRouteServiceProps:
        return typing.cast(CenRouteServiceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenRouteService).__jsii_proxy_class__ = lambda : _ICenRouteServiceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ICenVbrHealthCheck")
class ICenVbrHealthCheck(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_health_check_source_ip(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_health_check_target_ip(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_vbr_instance_owner_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_vbr_instance_region_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenVbrHealthCheckProps:
        ...


class _ICenVbrHealthCheckProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CenVbrHealthCheck``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ICenVbrHealthCheck"
    ...
    def attr_health_check_source_ip(
        ...
        Automatic IP Address: The system automatically assigns an IP address within the CIDR block 100.96.0.0/16 (recommended).  Custom IP Address: You can specify a source IP address that is available within the CIDR block 10.0.0.0/8, 192.168.0.0/16, or 172.16.0.0/12. The specified source IP address must not overlap with the IP addresses of the Alibaba Cloud-facing and client-facing interfaces on the VBR instance, or the IP addresses of the instances with which the VBR instance needs to communicate in the CEN.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrHealthCheckSourceIp"))
    ...
    def attr_health_check_target_ip(
        ...
        The destination IP address is the IP address of the client-facing interface on the VBR instance.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrHealthCheckTargetIp"))
    ...
    def attr_vbr_instance_id(
        ...
        '''Attribute VbrInstanceId: The ID of the VBR instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVbrInstanceId"))
    ...
    def attr_vbr_instance_owner_id(
        ...
        '''Attribute VbrInstanceOwnerId: The User ID (UID) of the account to which the VBR instance belongs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVbrInstanceOwnerId"))
    ...
    def attr_vbr_instance_region_id(
        ...
        You can call the DescribeRegionsoperation to query region IDs.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVbrInstanceRegionId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CenVbrHealthCheckProps:
        return typing.cast(CenVbrHealthCheckProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICenVbrHealthCheck).__jsii_proxy_class__ = lambda : _ICenVbrHealthCheckProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.IChildInstanceRouteEntryToAttachment")
class IChildInstanceRouteEntryToAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    def attr_destination_cidr_block(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_transit_router_attachment_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ChildInstanceRouteEntryToAttachmentProps:
        ...


class _IChildInstanceRouteEntryToAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ChildInstanceRouteEntryToAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.IChildInstanceRouteEntryToAttachment"
    ...
    def attr_destination_cidr_block(
        ...
        '''Attribute DestinationCidrBlock: The destination CIDR block of the route.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDestinationCidrBlock"))
    ...
    def attr_route_table_id(
        ...
        '''Attribute RouteTableId: The ID of the route table configured on the network instance.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRouteTableId"))
    ...
    def attr_transit_router_attachment_id(
        ...
        '''Attribute TransitRouterAttachmentId: The ID of the network instance connection.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterAttachmentId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ChildInstanceRouteEntryToAttachmentProps:
        return typing.cast(ChildInstanceRouteEntryToAttachmentProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IChildInstanceRouteEntryToAttachment).__jsii_proxy_class__ = lambda : _IChildInstanceRouteEntryToAttachmentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.IRouteEntry")
class IRouteEntry(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``RouteEntry``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "RouteEntryProps":
        ...


class _IRouteEntryProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``RouteEntry``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.IRouteEntry"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "RouteEntryProps":
        return typing.cast("RouteEntryProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IRouteEntry).__jsii_proxy_class__ = lambda : _IRouteEntryProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouter")
class ITransitRouter(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_transit_router_description(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterProps":
        ...


class _ITransitRouterProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouter``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouter"
    ...
    def attr_system_transit_router_route_table_id(
        ...
        '''Attribute SystemTransitRouterRouteTableId: The system route table ID of transit router.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSystemTransitRouterRouteTableId"))
    ...
    def attr_transit_router_description(
        ...
        '''Attribute TransitRouterDescription: TransitRouterDescription.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterDescription"))
    ...
    def attr_transit_router_id(
        ...
        '''Attribute TransitRouterId: TransitRouterId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterId"))
    ...
    def attr_transit_router_name(
        ...
        '''Attribute TransitRouterName: TransitRouterName.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterName"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterProps":
        return typing.cast("TransitRouterProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouter).__jsii_proxy_class__ = lambda : _ITransitRouterProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterPeerAttachment")
class ITransitRouterPeerAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterPeerAttachmentProps":
        ...


class _ITransitRouterPeerAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterPeerAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterPeerAttachment"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterPeerAttachmentProps":
        return typing.cast("TransitRouterPeerAttachmentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterPeerAttachment).__jsii_proxy_class__ = lambda : _ITransitRouterPeerAttachmentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterRouteEntry")
class ITransitRouterRouteEntry(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    def attr_transit_router_route_entry_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_transit_router_route_table_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteEntryProps":
        ...


class _ITransitRouterRouteEntryProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterRouteEntry``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterRouteEntry"
    ...
    def attr_transit_router_route_entry_description(
        ...
        '''Attribute TransitRouterRouteEntryDescription: TransitRouterRouteEntryDescription.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryDescription"))
    ...
    def attr_transit_router_route_entry_destination_cidr_block(
        ...
        '''Attribute TransitRouterRouteEntryDestinationCidrBlock: TransitRouterRouteEntryDestinationCidrBlock.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryDestinationCidrBlock"))
    ...
    def attr_transit_router_route_entry_id(
        ...
        '''Attribute TransitRouterRouteEntryId: The first ID of the resource.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryId"))
    ...
    def attr_transit_router_route_entry_name(
        ...
        '''Attribute TransitRouterRouteEntryName: TransitRouterRouteEntryName.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryName"))
    ...
    def attr_transit_router_route_entry_next_hop_id(
        ...
        '''Attribute TransitRouterRouteEntryNextHopId: TransitRouterRouteEntryNextHopId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryNextHopId"))
    ...
    def attr_transit_router_route_entry_next_hop_type(
        ...
        '''Attribute TransitRouterRouteEntryNextHopType: TransitRouterRouteEntryNextHopType.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryNextHopType"))
    ...
    def attr_transit_router_route_entry_type(
        ...
        '''Attribute TransitRouterRouteEntryType: TransitRouterRouteEntryType.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteEntryType"))
    ...
    def attr_transit_router_route_table_id(
        ...
        '''Attribute TransitRouterRouteTableId: TransitRouterRouteTableId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteTableId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteEntryProps":
        return typing.cast("TransitRouterRouteEntryProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterRouteEntry).__jsii_proxy_class__ = lambda : _ITransitRouterRouteEntryProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterRouteTable")
class ITransitRouterRouteTable(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableProps":
        ...


class _ITransitRouterRouteTableProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterRouteTable``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterRouteTable"
    ...
    def attr_client_token(
        ...
        '''Attribute ClientToken: ClientToken.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrClientToken"))
    ...
    def attr_transit_router_route_table_description(
        ...
        '''Attribute TransitRouterRouteTableDescription: TransitRouterRouteTableDescription.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteTableDescription"))
    ...
    def attr_transit_router_route_table_name(
        ...
        '''Attribute TransitRouterRouteTableName: TransitRouterRouteTableName.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteTableName"))
    ...
    def attr_transit_router_route_table_type(
        ...
        '''Attribute TransitRouterRouteTableType: TransitRouterRouteTableType.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterRouteTableType"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableProps":
        return typing.cast("TransitRouterRouteTableProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterRouteTable).__jsii_proxy_class__ = lambda : _ITransitRouterRouteTableProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterRouteTableAssociation")
class ITransitRouterRouteTableAssociation(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableAssociationProps":
        ...


class _ITransitRouterRouteTableAssociationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterRouteTableAssociation``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterRouteTableAssociation"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTableAssociationProps":
        return typing.cast("TransitRouterRouteTableAssociationProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterRouteTableAssociation).__jsii_proxy_class__ = lambda : _ITransitRouterRouteTableAssociationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterRouteTablePropagation")
class ITransitRouterRouteTablePropagation(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTablePropagationProps":
        ...


class _ITransitRouterRouteTablePropagationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterRouteTablePropagation``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterRouteTablePropagation"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterRouteTablePropagationProps":
        return typing.cast("TransitRouterRouteTablePropagationProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterRouteTablePropagation).__jsii_proxy_class__ = lambda : _ITransitRouterRouteTablePropagationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterVbrAttachment")
class ITransitRouterVbrAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    def attr_auto_publish_route_enabled(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_transit_router_attachment_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVbrAttachmentProps":
        ...


class _ITransitRouterVbrAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterVbrAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterVbrAttachment"
    ...
    def attr_auto_publish_route_enabled(
        ...
        '''Attribute AutoPublishRouteEnabled: AutoPublishRouteEnabled.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAutoPublishRouteEnabled"))
    ...
    def attr_transit_router_attachment_description(
        ...
        '''Attribute TransitRouterAttachmentDescription: TransitRouterAttachmentDescription.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterAttachmentDescription"))
    ...
    def attr_transit_router_attachment_name(
        ...
        '''Attribute TransitRouterAttachmentName: TransitRouterAttachmentName.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTransitRouterAttachmentName"))
    ...
    def attr_vbr_id(
        ...
        '''Attribute VbrId: VbrId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVbrId"))
    ...
    def attr_vbr_owner_id(
        ...
        '''Attribute VbrOwnerId: VbrOwnerId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVbrOwnerId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVbrAttachmentProps":
        return typing.cast("TransitRouterVbrAttachmentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterVbrAttachment).__jsii_proxy_class__ = lambda : _ITransitRouterVbrAttachmentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterVpcAttachment")
class ITransitRouterVpcAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVpcAttachmentProps":
        ...


class _ITransitRouterVpcAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterVpcAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterVpcAttachment"
    ...
    def attr_vpc_owner_id(
        ...
        '''Attribute VpcOwnerId: VpcOwnerId.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrVpcOwnerId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVpcAttachmentProps":
        return typing.cast("TransitRouterVpcAttachmentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterVpcAttachment).__jsii_proxy_class__ = lambda : _ITransitRouterVpcAttachmentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-cen.ITransitRouterVpnAttachment")
class ITransitRouterVpnAttachment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVpnAttachmentProps":
        ...


class _ITransitRouterVpnAttachmentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TransitRouterVpnAttachment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-cen.ITransitRouterVpnAttachment"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "TransitRouterVpnAttachmentProps":
        return typing.cast("TransitRouterVpnAttachmentProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITransitRouterVpnAttachment).__jsii_proxy_class__ = lambda : _ITransitRouterVpnAttachmentProxy
...
class RosCenBandwidthLimit(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenBandwidthLimit`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthlimit
    '''
    ...
    def bandwidth_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ec3acf3b6592d9fd029a23c1285a78cf80e6353e80d766de2f0425d1c99427b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosCenBandwidthPackage(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenBandwidthPackage`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthpackage
    '''
    ...
    def tags(
        ...
        '''
        return typing.cast(typing.Optional[typing.List["RosCenBandwidthPackage.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(
        self,
        value: typing.Optional[typing.List["RosCenBandwidthPackage.TagsProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__51abf05b622eb10d0ca442941d56b30455517aca79b05d11780a708089ddba31)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cen.RosCenBandwidthPackage.TagsProperty",
        jsii_struct_bases=[],
    ...
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__62bdb37133c64b857f4c28a749ca26a6d1e218f68a4b859a89cb5cdd2231e291)
...
class RosCenBandwidthPackageAssociation(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenBandwidthPackageAssociation`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthpackageassociation
    '''
...
class RosCenBandwidthPackageProps:
    ...
    @builtins.property
    def tags(self) -> typing.Optional[typing.List[RosCenBandwidthPackage.TagsProperty]]:
        '''
        :Property: tags: Tags to attach to instance. Max support 20 tags to add during create instance. Each tag with two properties Key and Value, and Key is required.
        '''
        result = self._values.get("tags")
...
class RosCenInstance(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenInstance`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-ceninstance
    '''
...
class RosCenInstanceAttachment(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenInstanceAttachment`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-ceninstanceattachment
    '''
...
class RosCenRouteMap(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenRouteMap`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenroutemap
    '''
...
class RosCenRouteService(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenRouteService`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenrouteservice
    '''
...
class RosCenVbrHealthCheck(
    ...
    This class does not contain additional functions, so it is recommended to use the ``CenVbrHealthCheck`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenvbrhealthcheck
    '''
...
class RosChildInstanceRouteEntryToAttachment(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ChildInstanceRouteEntryToAttachment`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-childinstancerouteentrytoattachment
    '''
...
class RosRouteEntry(
    ...
    This class does not contain additional functions, so it is recommended to use the ``RouteEntry`` class instead of this class for a more convenient development experience.
...
class RosTransitRouter(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouter`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterPeerAttachment(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterPeerAttachment`` class instead of this class for a more convenient development experience.
    ...
    def auto_publish_route_enabled(
        ...
        autoPublishRouteEnabled: Whether to make the enterprise version forwarding router automatically publish routes across regions to the peer region.
        false (default): No.
        true: Yes.
        '''
    ...
    def bandwidth(
        ...
        bandwidth: The bandwidth value for cross-region connections.Unit: Mbps.
    ...
    def bandwidth_type(
        ...
        bandwidthType: The bandwidth allocation method for cross-regional connections.Value:
    ...
    def bandwidth_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__099ee936bffd4781f8980d5b85a96c94a8977230e94e788da53e9ba3c8f96959)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bandwidthType", value)
    ...
    def cen_bandwidth_package_id(
        ...
        cenBandwidthPackageId: The bandwidth packet ID to bind to across regions.
    ...
    @builtins.property
    @jsii.member(jsii_name="defaultLinkType")
    def default_link_type(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "defaultLinkType"))
    ...
    def default_link_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__15885540a49f8040bbb9e4fb2928a4998b482d6928e341514822f953dcc346af)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "defaultLinkType", value)
    ...
    def tags(
        self,
    ) -> typing.Optional[typing.List["RosTransitRouterPeerAttachment.TagsProperty"]]:
        '''
        :Property: tags: The list of tags in the form of key/value pairs. You can define a maximum of 20 tags.
        '''
        return typing.cast(typing.Optional[typing.List["RosTransitRouterPeerAttachment.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(
        self,
        value: typing.Optional[typing.List["RosTransitRouterPeerAttachment.TagsProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1ecf896e7f084e4ab9baefdf609dfdd10a09d4cc639e9017e3aa0b9f8b57b5df)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    def transit_router_attachment_description(
        ...
        transitRouterAttachmentDescription: Description information for cross-region connections.
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterPeerAttachment.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__05614ff62b5e254328e5da54e580121300b6968c830bc0f0054b2d8900228e6f)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "key": key,
...
class RosTransitRouterPeerAttachmentProps:
    def __init__(
        ...
        *,
        ...
        default_link_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        peer_transit_router_region_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[RosTransitRouterPeerAttachment.TagsProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        if __debug__:
            ...
            check_type(argname="argument cen_bandwidth_package_id", value=cen_bandwidth_package_id, expected_type=type_hints["cen_bandwidth_package_id"])
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument default_link_type", value=default_link_type, expected_type=type_hints["default_link_type"])
        ...
        if default_link_type is not None:
            self._values["default_link_type"] = default_link_type
    ...
    def default_link_type(
        ...
        And it can only be configured as Platinum (Platinum) when the bandwidth allocation method is billed by traffic.
        '''
        result = self._values.get("default_link_type")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def tags(
        ...
        '''
        result = self._values.get("tags")
        return typing.cast(typing.Optional[typing.List[RosTransitRouterPeerAttachment.TagsProperty]], result)
...
class RosTransitRouterRouteEntry(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterRouteEntry`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterRouteTable(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterRouteTable`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterRouteTableAssociation(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterRouteTableAssociation`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterRouteTablePropagation(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterRouteTablePropagation`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterVbrAttachment(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterVbrAttachment`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterVpcAttachment(
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterVpcAttachment`` class instead of this class for a more convenient development experience.
...
class RosTransitRouterVpnAttachment(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterVpnAttachment",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``TransitRouterVpnAttachment`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosTransitRouterVpnAttachmentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5a0cd4189926118d5a11314ff21d47d99934f3941e74ed2169a4a6ec1ad40ffe)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__711d347132a06145c4d393cc312672eb6ec2173dccc491b302f001f5031dea19)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e18625157b96aba8b19ede5c8305aac1b0f9530636a7c88b823502946473bb7f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="vpnId")
    def vpn_id(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: vpnId: IPsec connection ID
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "vpnId"))
    ...
    def vpn_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__79d0f579db60f236a10d5f6038c1728b2a562445048a65c83441c76bf15f0c17)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vpnId", value)
    ...
    def zone_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4aa1e9d6dfae7fd1ad85c4fe3f0c008b37aa0c743226a9bdfaedc5842ede1f09)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def auto_publish_route_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e0b6953fafc3dd4d684026a087acbfe53c561f69c87a336333eb062990dc12da)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "autoPublishRouteEnabled", value)
    ...
    def cen_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__41d1e0514e00a85be605c7f623e0fe42ccfdb5624f26469b089cab82fa7faa68)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cenId", value)
    ...
    def deletion_force(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb162c30eebaf9f060e13a8e58e6f043e8fc3fe6a9aa8988bf94df61d5ba7e04)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deletionForce", value)
    ...
    def route_table_association_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0923370a5892da049508b9a64e671f8e30bf38960d5db0c33ea3bdac9d7d0534)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "routeTableAssociationEnabled", value)
    ...
    def route_table_propagation_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4bf4663048b1fc029ecee9adc07ce05f06edae9efe73bdc23a8326c8fbaa6a05)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "routeTablePropagationEnabled", value)
    ...
    def tags(
        self,
    ) -> typing.Optional[typing.List["RosTransitRouterVpnAttachment.TagsProperty"]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.List["RosTransitRouterVpnAttachment.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(
        self,
        value: typing.Optional[typing.List["RosTransitRouterVpnAttachment.TagsProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f3d4ba1224eeb449928ce4292453cc2d1dd7c1ac83641cff788c69cc4a750e43)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    def transit_router_attachment_description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cb49e241dbc33ed75c1bf2485eb115527e3afb90af88336a1127b8609709097e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterAttachmentDescription", value)
    ...
    def transit_router_attachment_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ec822a2c322bbadfda1467737ef61d81a288980165431abe7e44c661e73e683e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterAttachmentName", value)
    ...
    def transit_router_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c8c1902fedb18fca9842ef48ac757c22b4f9464d771baa967d5d166804c20036)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "transitRouterId", value)

    @builtins.property
    @jsii.member(jsii_name="vpnOwnerId")
    def vpn_owner_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "vpnOwnerId"))
    ...
    def vpn_owner_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c07daa8937b53b0172c1beb0133369f034c341a000fbd09ec59528639e7ef837)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vpnOwnerId", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterVpnAttachment.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__75da3fd483edcea493c41f7c51c0d6f5ade85c2704c0d2d2b0ae0325e4cfb8d8)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "key": key,
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.RosTransitRouterVpnAttachmentProps",
    jsii_struct_bases=[],
    name_mapping={
        "vpn_id": "vpnId",
        "zone_id": "zoneId",
        ...
        "transit_router_attachment_name": "transitRouterAttachmentName",
        "transit_router_id": "transitRouterId",
        "vpn_owner_id": "vpnOwnerId",
    },
)
class RosTransitRouterVpnAttachmentProps:
    def __init__(
        self,
        *,
        vpn_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        zone_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        auto_publish_route_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        cen_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        deletion_force: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        route_table_association_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        route_table_propagation_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        tags: typing.Optional[typing.Sequence[typing.Union[RosTransitRouterVpnAttachment.TagsProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
        transit_router_attachment_description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        transit_router_attachment_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        transit_router_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        vpn_owner_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f31efbdd09ad6e15ba0fc598a7c65298efd8f85184aaee7abbb2538cc57d36b8)
            check_type(argname="argument vpn_id", value=vpn_id, expected_type=type_hints["vpn_id"])
            check_type(argname="argument zone_id", value=zone_id, expected_type=type_hints["zone_id"])
            check_type(argname="argument auto_publish_route_enabled", value=auto_publish_route_enabled, expected_type=type_hints["auto_publish_route_enabled"])
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
            check_type(argname="argument deletion_force", value=deletion_force, expected_type=type_hints["deletion_force"])
            ...
            check_type(argname="argument transit_router_attachment_name", value=transit_router_attachment_name, expected_type=type_hints["transit_router_attachment_name"])
            check_type(argname="argument transit_router_id", value=transit_router_id, expected_type=type_hints["transit_router_id"])
            check_type(argname="argument vpn_owner_id", value=vpn_owner_id, expected_type=type_hints["vpn_owner_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "vpn_id": vpn_id,
            "zone_id": zone_id,
        }
        ...
        if vpn_owner_id is not None:
            self._values["vpn_owner_id"] = vpn_owner_id
    ...
    def vpn_id(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        ...
        :Property: vpnId: IPsec connection ID
        '''
        result = self._values.get("vpn_id")
        assert result is not None, "Required property 'vpn_id' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def tags(
        ...
        '''
        result = self._values.get("tags")
        return typing.cast(typing.Optional[typing.List[RosTransitRouterVpnAttachment.TagsProperty]], result)
    ...
    def vpn_owner_id(
        ...
        :Property: vpnOwnerId: Alibaba Cloud account (main account) ID to which the IPsec connection belongs.
        '''
        result = self._values.get("vpn_owner_id")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "RosTransitRouterVpnAttachmentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IRouteEntry)
class RouteEntry(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosRouteEntry``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-routeentry
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__28f17411bb30b2dbd0c2518c7f9b268bf3dc4f7c36835d2917a38bc26e0f8ac3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f4f5b82723798c25068653fafb08ae7b0b89f16a88f69ecb6d8c57a27c769a2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__10e369b38e42968adfcb244d08ee48c993e7f4dc6c80d6a22357418ba2517eb2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.implements(ITransitRouter)
class TransitRouter(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouter``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouter
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dbf4136ee5fa5b8723662bdc13f3b38337b73b4585e8c57fad081ce4ccd50bff)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e66e68b09cfb761b09147391f5a88849e523f7374830e9cae40dff14057782eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad2be26c298c5bdbcb639044bf12f8eb7192bfc4bd31fde20279276ad5c455c3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ITransitRouterPeerAttachment)
class TransitRouterPeerAttachment(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterPeerAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterpeerattachment
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__08e62b76c564d5b54735f97983e15fa138031874ecf6936ee28f17a3d1213bdf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7915406b8d195aa10f664908cc4c3da183b356945cf3a2f42aecd1bbab3955ea)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__65361339b55e83eeb7ddc4fb93405a4b2810cd6ea6636809414047aa5a89e579)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class TransitRouterPeerAttachmentProps:
    def __init__(
        ...
        *,
        ...
        :param peer_transit_router_id: Property peerTransitRouterId: Peer forwarding router instance ID.
        :param auto_publish_route_enabled: Property autoPublishRouteEnabled: Whether to make the enterprise version forwarding router automatically publish routes across regions to the peer region. false (default): No. true: Yes.
        ...
        :param bandwidth_type: Property bandwidthType: The bandwidth allocation method for cross-regional connections.Value: BandwidthPackage: Allocate bandwidth from bandwidth packets. DataTransfer: Do not allocate bandwidth for cross-region connections, and is billed based on usage traffic.
        :param cen_bandwidth_package_id: Property cenBandwidthPackageId: The bandwidth packet ID to bind to across regions. Note When the value of BandwidthType is DataTransfer, this item is not required.
        :param cen_id: Property cenId: Cloud Enterprise Network Instance ID.
        :param default_link_type: Property defaultLinkType: Default link type. Optional values are Platinum, Gold, and default to Gold. And it can only be configured as Platinum (Platinum) when the bandwidth allocation method is billed by traffic.
        :param peer_transit_router_region_id: Property peerTransitRouterRegionId: The region ID to which the peer forwarding router instance belongs.
        :param tags: Property tags: The list of tags in the form of key/value pairs. You can define a maximum of 20 tags.
        :param transit_router_attachment_description: Property transitRouterAttachmentDescription: Description information for cross-region connections. The description can be empty or has a length of 1 to 256 characters and cannot start with http:// or https://.
        :param transit_router_attachment_name: Property transitRouterAttachmentName: The name of the cross-region connection. The name can be empty or has a length of 1 to 128 characters, and cannot start with http:// or https://.
        :param transit_router_id: Property transitRouterId: Local Enterprise Edition forwarding router instance ID.
        '''
        if __debug__:
...
@jsii.implements(ITransitRouterRouteEntry)
class TransitRouterRouteEntry(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterRouteEntry``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterrouteentry
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d2ed3cb6c1df87cbef78e635fbc30e6fc41a0f4a240e4f76a52d7706bb066c9c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__532e193c842806687d37f9c2aab06dd385f577f5387a67a7729e6df1620de7dc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c36dd8a99a21f6afe3a506b597b621fc65ccdc2b8244abd720fcb3c6126ad6d1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ITransitRouterRouteTable)
class TransitRouterRouteTable(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterRouteTable``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetable
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bd8899daa2a349ce99151999acbf7b6509f644f0306dc7113ff5682f842c9dc5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f50f03e0f9c6d01ff76dbb176609f1a3500c470d20e8d71aab894ff1c53291c5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__49c234e31ba7fcecf92e4f30c2e142d71da568d0f45b6b6887952f0eb894215f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ITransitRouterRouteTableAssociation)
class TransitRouterRouteTableAssociation(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterRouteTableAssociation``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetableassociation
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4ed86f9e9212ac400701ff6c55d359ac0e300dbec858552c17adf39149da687a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__da301a483ee5a97122d45344142571eec359dc89dbcc8fe3ad71a4f2c9230fcd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__415f24c9a76d040e0423839cf30a6d7cf770af5a443430e3ea0ea96507616380)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ITransitRouterRouteTablePropagation)
class TransitRouterRouteTablePropagation(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterRouteTablePropagation``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetablepropagation
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e517ded4a5412a5f0a6c60229c4610ae2a544d97588018cbf349a16820789357)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__84bbaf7b9152c19bf61ca7e1cbda256b1ed845020322610dc21dfcb0e022ec22)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5822ba3c38cdaa7c3f74b3e5fab511fed482f6688a399367afa9c2103143e577)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ITransitRouterVbrAttachment)
class TransitRouterVbrAttachment(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterVbrAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutervbrattachment
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8204cb9193d1ae28d92fca81504d518cfbc9c8b4f85ae2d6fd7427bc98cf1359)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__872fe16a4f46c7a675b6960b03aed1e1e712e2ee7cea9e938f15a54d5fddf4de)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d6af91dd26b5be7e40679f0445fab3eadd30ec321fd86ee6ded4801dceb09f2e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ITransitRouterVpcAttachment)
class TransitRouterVpcAttachment(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterVpcAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutervpcattachment
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__334589c725df96dc59d08fee79a4f7103b5a26227dd0b2015ed4b0da7043bea5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6817298b9caaa4afa9864b88d9c29b3d1f1879eaebf7063e1fc9c3c23694b070)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa0c450a2c5b503872d5c827d02a31b9b7c9203928dfbc5c28c32ba28f078106)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(ITransitRouterVpnAttachment)
class TransitRouterVpnAttachment(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-cen.TransitRouterVpnAttachment",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTransitRouterVpnAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutervpnattachment
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["TransitRouterVpnAttachmentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__466a73de3e2b7f517edea16c573b16ecde68921426a45326ad513761a2f85c45)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cde06b02636245f2f9e582471d9b4360834adde69b62847d49cb2acaaf249f66)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__027879ce495a5b8ab287043b3c3718618590ffe3f01dd6334f061f3eb2040344)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__27b8a7c578068a9284c0b0494003d37e03ce95a74304ae4e3d95e4b174a771df)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-cen.TransitRouterVpnAttachmentProps",
    jsii_struct_bases=[],
    name_mapping={
        "vpn_id": "vpnId",
        "zone_id": "zoneId",
...
class TransitRouterVpnAttachmentProps:
    def __init__(
        self,
        *,
        vpn_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param vpn_id: Property vpnId: IPsec connection ID.
        :param zone_id: Property zoneId: Availability zone ID in the current region.
        :param auto_publish_route_enabled: Property autoPublishRouteEnabled: Whether to allow forwarding router instances to automatically publish route entries to IPsec connections. Default is true.
        :param cen_id: Property cenId: The ID of the CEN instance.
        :param deletion_force: Property deletionForce: Whether to forcefully delete the VPN connection.
        :param route_table_association_enabled: Property routeTableAssociationEnabled: Whether to enable route association and forwarding relationship.
        :param route_table_propagation_enabled: Property routeTablePropagationEnabled: Whether to enable route learning relationships.
        :param tags: Property tags: Tags to attach to TransitRouterVpnAttachment. Max support 20 tags to add during create TransitRouterVpnAttachment. Each tag with two properties Key and Value, and Key is required.
        :param transit_router_attachment_description: Property transitRouterAttachmentDescription: Description of the VPN connection.
        :param transit_router_attachment_name: Property transitRouterAttachmentName: The name of the VPN connection.
        :param transit_router_id: Property transitRouterId: Forwarding router instance ID.
        :param vpn_owner_id: Property vpnOwnerId: Alibaba Cloud account (main account) ID to which the IPsec connection belongs.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cf43779e5dfd70c341cc16b300c94c1e02b7a2bc094e8b7c7ed03a7b5ab92a77)
            check_type(argname="argument vpn_id", value=vpn_id, expected_type=type_hints["vpn_id"])
            check_type(argname="argument zone_id", value=zone_id, expected_type=type_hints["zone_id"])
            check_type(argname="argument auto_publish_route_enabled", value=auto_publish_route_enabled, expected_type=type_hints["auto_publish_route_enabled"])
            check_type(argname="argument cen_id", value=cen_id, expected_type=type_hints["cen_id"])
    ...
    def __repr__(self) -> str:
        return "TransitRouterVpnAttachmentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(ICenBandwidthLimit)
class CenBandwidthLimit(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenBandwidthLimit``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthlimit
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7ec0e42acc2cae9a9ee7154408aaa6cd8593d89fcbab07fbb55df904c4c4995a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d1e18ba7a8cd9a2b81348992dccabce89b5a03b9b64ea9e9d27d501b319727ae)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4589c4f527da2edc490991cf83b1b56171218593bb2134c007a0674f6b97d8f4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenBandwidthPackage)
class CenBandwidthPackage(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenBandwidthPackage``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthpackage
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b1da7804781e2f658a11963ad11911f1e915ca5474da94f5c912db8a23acef00)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f0a8b643744d300fff236326c3c43fe24ab1fbdadf9c2b87ccdbde1e236e8293)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f73525275811b55cb7ac3a6db0d704f04fd09ca6ba794844dd10ff563f40a3de)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenBandwidthPackageAssociation)
class CenBandwidthPackageAssociation(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenBandwidthPackageAssociation``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenbandwidthpackageassociation
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0b5e2a531faf100861b44a734c61e3932fb98c9c7da21a6666f880ec0140fc3d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ac7fbb4d76dce80ccf8399ec1119bd6e714bc01febfadef687799418f3447e3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c3799bd105756811c87aed9f41b748ec16b64d5ddff7a38bb8740a27dd8bceac)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenInstance)
class CenInstance(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenInstance``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-ceninstance
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ad6727abdb11f0eef0ab60a1e913c0ba17eeafde8e4a979a2da4e7d6c9e53296)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__36fac75e7075622762e0ec089e82189c882ab52c1062d6b1f44cee2d08df47d3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__755c4b050dd107ab0db28f95d950dd02db2d28261991c8b25074ea121323150f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenInstanceAttachment)
class CenInstanceAttachment(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenInstanceAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-ceninstanceattachment
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c91b656547c0969d85c3f4b5f5c1bab65e23b498ddd68e9279399233b3e776a1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__032c4941a935f72047a8ddd17a8b4cfb2e56e0f3831127b49e27db5c2c7105ec)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ed070f5a75e4866b5195dfb7a70fd621aeeed7088d1492ba673f16c8464538bc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenRouteMap)
class CenRouteMap(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenRouteMap``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenroutemap
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e5ccb491f5d066673f601f5e2cf47f1641b26dd069862647f9c9d5be357867f2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cfa1f59024a3dd8241b1086c50afaf575984e18f3c06c12692104cbf048550bd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc440b954d487a510819ed4153ad81946acbaa1f63f2761721953e311eb41d1d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenRouteService)
class CenRouteService(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenRouteService``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenrouteservice
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3883ee12170fe239e50280a1df5e6ffcdb00c37005df12e3252617123629d48b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c61b1024fbfe8df4221cba5de2f6988bb02bb5f25a25499951ff26fc8fc9d3ff)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f6ae4c7c7c8ac68f33a1136f4e0878a0a76d2b908f7d4b3b88ebdb5a3e4c6b4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(ICenVbrHealthCheck)
class CenVbrHealthCheck(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosCenVbrHealthCheck``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenvbrhealthcheck
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__17c8f991b60d3e8c490942bd7c1b74ed9a9d99cd5c42b7421e61803178a0b31f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2210b8be2a5e5f0c854fe377383f3dd3a501a2f2e584cab3a6defea78ebff39c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__07709a974c524b1c1a744e9bf51130454b909d0128d986456974882f57a3ce08)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IChildInstanceRouteEntryToAttachment)
class ChildInstanceRouteEntryToAttachment(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosChildInstanceRouteEntryToAttachment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-childinstancerouteentrytoattachment
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0052b87a4481217ee63f07a291856372c2c1d471c2ff623a1d5a014141878a0a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4c21ea97f7d26465c9de2c0a4ad4802c30a6b618cf5e0c63c7a0f36d23cc2132)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__42fa59837a2ed157a0834c516b2c3b7ddcf2efb38cf32e6432d7d1f440f932f7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "ICenBandwidthPackageAssociation",
    "ICenInstance",
    "ICenInstanceAttachment",
    "ICenRouteMap",
    "ICenRouteService",
    "ICenVbrHealthCheck",
    ...
    "ITransitRouterRouteEntry",
    "ITransitRouterRouteTable",
    "ITransitRouterRouteTableAssociation",
    "ITransitRouterRouteTablePropagation",
    "ITransitRouterVbrAttachment",
    "ITransitRouterVpcAttachment",
    "ITransitRouterVpnAttachment",
...
def _typecheckingstub__2ec3acf3b6592d9fd029a23c1285a78cf80e6353e80d766de2f0425d1c99427b(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__51abf05b622eb10d0ca442941d56b30455517aca79b05d11780a708089ddba31(
    value: typing.Optional[typing.List[RosCenBandwidthPackage.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__62bdb37133c64b857f4c28a749ca26a6d1e218f68a4b859a89cb5cdd2231e291(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__099ee936bffd4781f8980d5b85a96c94a8977230e94e788da53e9ba3c8f96959(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__15885540a49f8040bbb9e4fb2928a4998b482d6928e341514822f953dcc346af(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__1ecf896e7f084e4ab9baefdf609dfdd10a09d4cc639e9017e3aa0b9f8b57b5df(
    value: typing.Optional[typing.List[RosTransitRouterPeerAttachment.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__05614ff62b5e254328e5da54e580121300b6968c830bc0f0054b2d8900228e6f(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__5a0cd4189926118d5a11314ff21d47d99934f3941e74ed2169a4a6ec1ad40ffe(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosTransitRouterVpnAttachmentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__711d347132a06145c4d393cc312672eb6ec2173dccc491b302f001f5031dea19(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e18625157b96aba8b19ede5c8305aac1b0f9530636a7c88b823502946473bb7f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__79d0f579db60f236a10d5f6038c1728b2a562445048a65c83441c76bf15f0c17(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4aa1e9d6dfae7fd1ad85c4fe3f0c008b37aa0c743226a9bdfaedc5842ede1f09(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e0b6953fafc3dd4d684026a087acbfe53c561f69c87a336333eb062990dc12da(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__41d1e0514e00a85be605c7f623e0fe42ccfdb5624f26469b089cab82fa7faa68(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fb162c30eebaf9f060e13a8e58e6f043e8fc3fe6a9aa8988bf94df61d5ba7e04(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0923370a5892da049508b9a64e671f8e30bf38960d5db0c33ea3bdac9d7d0534(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4bf4663048b1fc029ecee9adc07ce05f06edae9efe73bdc23a8326c8fbaa6a05(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f3d4ba1224eeb449928ce4292453cc2d1dd7c1ac83641cff788c69cc4a750e43(
    value: typing.Optional[typing.List[RosTransitRouterVpnAttachment.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cb49e241dbc33ed75c1bf2485eb115527e3afb90af88336a1127b8609709097e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ec822a2c322bbadfda1467737ef61d81a288980165431abe7e44c661e73e683e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c8c1902fedb18fca9842ef48ac757c22b4f9464d771baa967d5d166804c20036(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c07daa8937b53b0172c1beb0133369f034c341a000fbd09ec59528639e7ef837(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__75da3fd483edcea493c41f7c51c0d6f5ade85c2704c0d2d2b0ae0325e4cfb8d8(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__f31efbdd09ad6e15ba0fc598a7c65298efd8f85184aaee7abbb2538cc57d36b8(
    *,
    vpn_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    zone_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    auto_publish_route_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__28f17411bb30b2dbd0c2518c7f9b268bf3dc4f7c36835d2917a38bc26e0f8ac3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9f4f5b82723798c25068653fafb08ae7b0b89f16a88f69ecb6d8c57a27c769a2(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__10e369b38e42968adfcb244d08ee48c993e7f4dc6c80d6a22357418ba2517eb2(
...
def _typecheckingstub__dbf4136ee5fa5b8723662bdc13f3b38337b73b4585e8c57fad081ce4ccd50bff(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e66e68b09cfb761b09147391f5a88849e523f7374830e9cae40dff14057782eb(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ad2be26c298c5bdbcb639044bf12f8eb7192bfc4bd31fde20279276ad5c455c3(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__08e62b76c564d5b54735f97983e15fa138031874ecf6936ee28f17a3d1213bdf(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7915406b8d195aa10f664908cc4c3da183b356945cf3a2f42aecd1bbab3955ea(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__65361339b55e83eeb7ddc4fb93405a4b2810cd6ea6636809414047aa5a89e579(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__d2ed3cb6c1df87cbef78e635fbc30e6fc41a0f4a240e4f76a52d7706bb066c9c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__532e193c842806687d37f9c2aab06dd385f577f5387a67a7729e6df1620de7dc(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c36dd8a99a21f6afe3a506b597b621fc65ccdc2b8244abd720fcb3c6126ad6d1(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__bd8899daa2a349ce99151999acbf7b6509f644f0306dc7113ff5682f842c9dc5(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f50f03e0f9c6d01ff76dbb176609f1a3500c470d20e8d71aab894ff1c53291c5(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__49c234e31ba7fcecf92e4f30c2e142d71da568d0f45b6b6887952f0eb894215f(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__4ed86f9e9212ac400701ff6c55d359ac0e300dbec858552c17adf39149da687a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__da301a483ee5a97122d45344142571eec359dc89dbcc8fe3ad71a4f2c9230fcd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__415f24c9a76d040e0423839cf30a6d7cf770af5a443430e3ea0ea96507616380(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__e517ded4a5412a5f0a6c60229c4610ae2a544d97588018cbf349a16820789357(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__84bbaf7b9152c19bf61ca7e1cbda256b1ed845020322610dc21dfcb0e022ec22(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5822ba3c38cdaa7c3f74b3e5fab511fed482f6688a399367afa9c2103143e577(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__8204cb9193d1ae28d92fca81504d518cfbc9c8b4f85ae2d6fd7427bc98cf1359(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__872fe16a4f46c7a675b6960b03aed1e1e712e2ee7cea9e938f15a54d5fddf4de(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d6af91dd26b5be7e40679f0445fab3eadd30ec321fd86ee6ded4801dceb09f2e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__334589c725df96dc59d08fee79a4f7103b5a26227dd0b2015ed4b0da7043bea5(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6817298b9caaa4afa9864b88d9c29b3d1f1879eaebf7063e1fc9c3c23694b070(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aa0c450a2c5b503872d5c827d02a31b9b7c9203928dfbc5c28c32ba28f078106(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__466a73de3e2b7f517edea16c573b16ecde68921426a45326ad513761a2f85c45(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[TransitRouterVpnAttachmentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__cde06b02636245f2f9e582471d9b4360834adde69b62847d49cb2acaaf249f66(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__027879ce495a5b8ab287043b3c3718618590ffe3f01dd6334f061f3eb2040344(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__27b8a7c578068a9284c0b0494003d37e03ce95a74304ae4e3d95e4b174a771df(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cf43779e5dfd70c341cc16b300c94c1e02b7a2bc094e8b7c7ed03a7b5ab92a77(
    *,
    vpn_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    zone_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    auto_publish_route_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__7ec0e42acc2cae9a9ee7154408aaa6cd8593d89fcbab07fbb55df904c4c4995a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d1e18ba7a8cd9a2b81348992dccabce89b5a03b9b64ea9e9d27d501b319727ae(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4589c4f527da2edc490991cf83b1b56171218593bb2134c007a0674f6b97d8f4(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__b1da7804781e2f658a11963ad11911f1e915ca5474da94f5c912db8a23acef00(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f0a8b643744d300fff236326c3c43fe24ab1fbdadf9c2b87ccdbde1e236e8293(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f73525275811b55cb7ac3a6db0d704f04fd09ca6ba794844dd10ff563f40a3de(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0b5e2a531faf100861b44a734c61e3932fb98c9c7da21a6666f880ec0140fc3d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5ac7fbb4d76dce80ccf8399ec1119bd6e714bc01febfadef687799418f3447e3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c3799bd105756811c87aed9f41b748ec16b64d5ddff7a38bb8740a27dd8bceac(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__ad6727abdb11f0eef0ab60a1e913c0ba17eeafde8e4a979a2da4e7d6c9e53296(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__36fac75e7075622762e0ec089e82189c882ab52c1062d6b1f44cee2d08df47d3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__755c4b050dd107ab0db28f95d950dd02db2d28261991c8b25074ea121323150f(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__c91b656547c0969d85c3f4b5f5c1bab65e23b498ddd68e9279399233b3e776a1(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__032c4941a935f72047a8ddd17a8b4cfb2e56e0f3831127b49e27db5c2c7105ec(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ed070f5a75e4866b5195dfb7a70fd621aeeed7088d1492ba673f16c8464538bc(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__e5ccb491f5d066673f601f5e2cf47f1641b26dd069862647f9c9d5be357867f2(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cfa1f59024a3dd8241b1086c50afaf575984e18f3c06c12692104cbf048550bd(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dc440b954d487a510819ed4153ad81946acbaa1f63f2761721953e311eb41d1d(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3883ee12170fe239e50280a1df5e6ffcdb00c37005df12e3252617123629d48b(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c61b1024fbfe8df4221cba5de2f6988bb02bb5f25a25499951ff26fc8fc9d3ff(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9f6ae4c7c7c8ac68f33a1136f4e0878a0a76d2b908f7d4b3b88ebdb5a3e4c6b4(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__17c8f991b60d3e8c490942bd7c1b74ed9a9d99cd5c42b7421e61803178a0b31f(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2210b8be2a5e5f0c854fe377383f3dd3a501a2f2e584cab3a6defea78ebff39c(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__07709a974c524b1c1a744e9bf51130454b909d0128d986456974882f57a3ce08(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__0052b87a4481217ee63f07a291856372c2c1d471c2ff623a1d5a014141878a0a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4c21ea97f7d26465c9de2c0a4ad4802c30a6b618cf5e0c63c7a0f36d23cc2132(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__42fa59837a2ed157a0834c516b2c3b7ddcf2efb38cf32e6432d7d1f440f932f7(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
