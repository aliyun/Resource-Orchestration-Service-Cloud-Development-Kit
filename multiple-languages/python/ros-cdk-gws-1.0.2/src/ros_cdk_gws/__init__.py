...
class InstanceProps:
    def __init__(
        ...
        *,
        ...
        :param internet_max_bandwidth_in: Property internetMaxBandwidthIn: Maximum inbound bandwidth of the public network (in Mbps). Value range: 1-200 Default: 200 This value is only valid when AllocatePublicAddress is true.
