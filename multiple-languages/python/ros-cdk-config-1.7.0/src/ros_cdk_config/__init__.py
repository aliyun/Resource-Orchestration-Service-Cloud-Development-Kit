...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "exclude_region_ids_scope": "excludeRegionIdsScope",
        "exclude_resource_group_ids_scope": "excludeResourceGroupIdsScope",
        ...
        "resource_ids_scope": "resourceIdsScope",
...
class AggregateCompliancePackProps:
    def __init__(
        ...
        *,
        ...
        config_rules: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosAggregateCompliancePack.ConfigRulesProperty", typing.Dict[builtins.str, typing.Any]]]]]] = None,
        default_enable: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        exclude_region_ids_scope: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        exclude_resource_group_ids_scope: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        resource_ids_scope: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param config_rules: Property configRules: List of rules in the compliance package. Note: Either this parameter or TemplateContent must be set.
        ...
        :param exclude_region_ids_scope: Property excludeRegionIdsScope: The compliance package is invalid for the specified region ID.
        :param exclude_resource_group_ids_scope: Property excludeResourceGroupIdsScope: The compliance package is invalid for the specified resource group ID.
        ...
        :param resource_ids_scope: Property resourceIdsScope: The compliance package only takes effect on the specified resource ID.
        ...
        :param template_content: Property templateContent: Template information used to generate compliance packages. Note: Either this parameter or ConfigRules must be set.
        '''
        if __debug__:
            ...
            check_type(argname="argument exclude_region_ids_scope", value=exclude_region_ids_scope, expected_type=type_hints["exclude_region_ids_scope"])
            check_type(argname="argument exclude_resource_group_ids_scope", value=exclude_resource_group_ids_scope, expected_type=type_hints["exclude_resource_group_ids_scope"])
            ...
            check_type(argname="argument resource_ids_scope", value=resource_ids_scope, expected_type=type_hints["resource_ids_scope"])
        ...
        if exclude_region_ids_scope is not None:
            self._values["exclude_region_ids_scope"] = exclude_region_ids_scope
        if exclude_resource_group_ids_scope is not None:
            self._values["exclude_resource_group_ids_scope"] = exclude_resource_group_ids_scope
        ...
        if resource_ids_scope is not None:
            self._values["resource_ids_scope"] = resource_ids_scope
    ...
    def config_rules(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosAggregateCompliancePack.ConfigRulesProperty"]]]]:
        ...
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosAggregateCompliancePack.ConfigRulesProperty"]]]], result)
...
class AggregatorProps:
    def __init__(
        ...
        *,
        ...
        :param aggregator_accounts: Property aggregatorAccounts: The member account in aggregator.When the AggregatorType is RD, this parameter can be empty, which means that all accounts in the resource directory will be added to the global account group.When the AggregatorType is FOLDER, this parameter can be empty,which means that all accounts in the resource folder will be added to the global account group.
        :param aggregator_type: Property aggregatorType: Account group type. Value: RD: Global account group. CUSTOM: Custom account group (default value). FOLDER: Folder account group. Must set FolderId if the AggregatorType is FOLDER. Please refer to ListAccounts for accessing FolderId.
        :param folder_id: Property folderId: The folder ID.
        '''
        if __debug__:
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-config.IAggregateCompliancePack")
class IAggregateCompliancePack(
    ...
    def props(self) -> AggregateCompliancePackProps:
        ...


class _IAggregateCompliancePackProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``AggregateCompliancePack``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.IAggregateCompliancePack"
    ...
    def attr_compliance_pack_id(
        ...
        '''Attribute CompliancePackId: The ID of the compliance pack id.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCompliancePackId"))
...
typing.cast(typing.Any, IAggregateCompliancePack).__jsii_proxy_class__ = lambda : _IAggregateCompliancePackProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-config.IAggregator")
class IAggregator(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Aggregator``.'''

    @builtins.property
    @jsii.member(jsii_name="attrAggregatorId")
    def attr_aggregator_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AggregatorProps:
        ...


class _IAggregatorProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``Aggregator``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.IAggregator"
    ...
    def attr_aggregator_id(
        ...
        '''Attribute AggregatorId: The ID of the aggregator.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAggregatorId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAggregator).__jsii_proxy_class__ = lambda : _IAggregatorProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-config.ICompliancePack")
class ICompliancePack(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_compliance_pack_template_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> CompliancePackProps:
        ...


class _ICompliancePackProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``CompliancePack``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.ICompliancePack"
    ...
    def attr_compliance_pack_name(
        ...
        '''Attribute CompliancePackName: Compliance Package Name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCompliancePackName"))
    ...
    def attr_compliance_pack_template_id(
        ...
        '''Attribute CompliancePackTemplateId: Compliance Package Template Id.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCompliancePackTemplateId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ICompliancePack).__jsii_proxy_class__ = lambda : _ICompliancePackProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-config.IDeliveryChannel")
...
class _IDeliveryChannelProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.IDeliveryChannel"
...
class IRule(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_config_rule_trigger_types(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_exclude_resource_ids_scope(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_maximum_execution_frequency(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def attr_resource_group_ids_scope(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IRuleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.IRule"
    ...
    def attr_config_rule_arn(
        ...
        '''Attribute ConfigRuleArn: config rule arn.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConfigRuleArn"))
    ...
    def attr_config_rule_id(
        ...
        '''Attribute ConfigRuleId: The ID of the rule.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConfigRuleId"))
    ...
    def attr_config_rule_trigger_types(
        ...
        Valid values:  ConfigurationItemChangeNotification: The rule is triggered upon configuration changes. ScheduledNotification: The rule is triggered as scheduled.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConfigRuleTriggerTypes"))
    ...
    def attr_event_source(
        ...
        '''Attribute EventSource: The event source of the rule.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrEventSource"))
    ...
    def attr_exclude_resource_ids_scope(
        ...
        '''Attribute ExcludeResourceIdsScope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrExcludeResourceIdsScope"))
    ...
    def attr_input_parameters(
        ...
        '''Attribute InputParameters: The settings of the input parameters for the rule.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrInputParameters"))
    ...
    def attr_maximum_execution_frequency(
        ...
        Valid values:  One_Hour Three_Hours Six_Hours Twelve_Hours TwentyFour_Hours
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrMaximumExecutionFrequency"))
    ...
    def attr_region_ids_scope(
        ...
        '''Attribute RegionIdsScope: The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRegionIdsScope"))
    ...
    def attr_resource_group_ids_scope(
        ...
        '''Attribute ResourceGroupIdsScope: The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrResourceGroupIdsScope"))
    ...
    def attr_resource_types_scope(
        ...
        '''Attribute ResourceTypesScope: The types of the resources to be evaluated against the rule.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrResourceTypesScope"))
    ...
    def attr_source_identifier(
        ...
        For a managed rule, the value is the name of the managed rule. For a custom rule, the value is the ARN of the custom rule
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSourceIdentifier"))
    ...
    def attr_source_owner(
        ...
        Valid values:  CUSTOM_FC: The rule is a custom rule and you own the rule. ALIYUN: The rule is a managed rule and Alibaba Cloud owns the rule
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSourceOwner"))
    ...
    def attr_tag_key_scope(
        ...
        '''Attribute TagKeyScope: The rule monitors the tag key, only applies to rules created based on managed rules.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTagKeyScope"))
    ...
    def attr_tag_value_scope(
        ...
        '''Attribute TagValueScope: The rule monitors the tag value, only applies to rules created based on managed rules.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTagValueScope"))
...
class RosAggregateCompliancePack(
    ...
    def config_rules(
        ...
        configRules: List of rules in the compliance package.
        Note: Either this parameter or TemplateContent must be set.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosAggregateCompliancePack.ConfigRulesProperty"]]]], jsii.get(self, "configRules"))

    @config_rules.setter
    def config_rules(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosAggregateCompliancePack.ConfigRulesProperty"]]]],
    ) -> None:
        if __debug__:
    ...
    @builtins.property
    @jsii.member(jsii_name="excludeRegionIdsScope")
    def exclude_region_ids_scope(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: excludeRegionIdsScope: The compliance package is invalid for the specified region ID.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "excludeRegionIdsScope"))
    ...
    def exclude_region_ids_scope(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e3b4270c5569f5d9e13e6cd7ebc739da0b8212c13bdad5070278745f9b6592d1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "excludeRegionIdsScope", value)

    @builtins.property
    @jsii.member(jsii_name="excludeResourceGroupIdsScope")
    def exclude_resource_group_ids_scope(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: excludeResourceGroupIdsScope: The compliance package is invalid for the specified resource group ID.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "excludeResourceGroupIdsScope"))
    ...
    def exclude_resource_group_ids_scope(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bcef7b312777f8780fe80fbb7f62773e69c8b5296718d552dbc3a3f1a6500463)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "excludeResourceGroupIdsScope", value)
    ...
    @builtins.property
    @jsii.member(jsii_name="resourceIdsScope")
    def resource_ids_scope(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: resourceIdsScope: The compliance package only takes effect on the specified resource ID.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "resourceIdsScope"))
    ...
    def resource_ids_scope(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6b41a8e43750a6dd0d80627937616107f163119202fd1bff6437d5abe835de53)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "resourceIdsScope", value)
    ...
    def template_content(
        ...
        templateContent: Template information used to generate compliance packages.
        Note: Either this parameter or ConfigRules must be set.
        '''
    ...
    def template_content(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cbecc15645bc88d04cb981b70813e8e2d5c2c808c07b126360fcfe4ea76c6c5c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosAggregateCompliancePackProps:
    def __init__(
        ...
        *,
        ...
        :param exclude_region_ids_scope: 
        :param exclude_resource_group_ids_scope: 
        :param exclude_resource_ids_scope: 
        :param region_ids_scope: 
        :param resource_group_ids_scope: 
        :param resource_ids_scope: 
        :param tag_key_scope: 
...
class RosAggregator(
    ...
    def folder_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a7e866d211adff0029d2006a5cf1b5f8e2fb5fe4ed4857f7fdd85d56ab4ad334)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.implements(IAggregateCompliancePack)
...
@jsii.implements(ICompliancePack)
...
def _typecheckingstub__e3b4270c5569f5d9e13e6cd7ebc739da0b8212c13bdad5070278745f9b6592d1(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bcef7b312777f8780fe80fbb7f62773e69c8b5296718d552dbc3a3f1a6500463(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__6b41a8e43750a6dd0d80627937616107f163119202fd1bff6437d5abe835de53(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__cbecc15645bc88d04cb981b70813e8e2d5c2c808c07b126360fcfe4ea76c6c5c(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a7e866d211adff0029d2006a5cf1b5f8e2fb5fe4ed4857f7fdd85d56ab4ad334(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
