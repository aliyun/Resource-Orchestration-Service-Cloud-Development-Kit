...
@jsii.interface(jsii_type="@alicloud/ros-cdk-ehpc.datasource.INodes")
class INodes(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Nodes``.'''
...
class _INodesProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-ehpc.datasource.INodes"
    ...
    def attr_node_ids(
        ...
        '''Attribute NodeIds: The list of node IDs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrNodeIds"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "NodesProps":
        return typing.cast("NodesProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, INodes).__jsii_proxy_class__ = lambda : _INodesProxy


@jsii.implements(INodes)
class Nodes(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosNodes``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4e0d85fbe16052747bd639fef7a0b279335310bdad8162d66c9102f2e79e90d0)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4ad560299d1eb2aa38f4731bbb7a4d87681bf846ef5bb0908ec00dec914f025b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__da7eaf1b592308208986decfa77e2df89fb09e6f030137c90d82db7bac3ead0f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosNodes(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Nodes`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/datasource-ehpc-nodes
    '''
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__877af74cf2ebb3750cd51629eb5509c78b3d2135ac11869307a1772f3ca8c1ef)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__4e0d85fbe16052747bd639fef7a0b279335310bdad8162d66c9102f2e79e90d0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4ad560299d1eb2aa38f4731bbb7a4d87681bf846ef5bb0908ec00dec914f025b(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__da7eaf1b592308208986decfa77e2df89fb09e6f030137c90d82db7bac3ead0f(
...
def _typecheckingstub__877af74cf2ebb3750cd51629eb5509c78b3d2135ac11869307a1772f3ca8c1ef(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
