...
class GatewayProps:
    def __init__(
        ...
        *,
        ...
        network_access_config: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosGateway.NetworkAccessConfigProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        if network_access_config is not None:
            self._values["network_access_config"] = network_access_config
        if vpc is not None:
    ...
    def network_access_config(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosGateway.NetworkAccessConfigProperty"]]:
        '''Property networkAccessConfig: Network Access Configuration.'''
        result = self._values.get("network_access_config")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosGateway.NetworkAccessConfigProperty"]], result)
...
class RosGateway(
    ...
    def network_access_config(
        ...
        :Property: networkAccessConfig: Network Access Configuration.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosGateway.NetworkAccessConfigProperty"]], jsii.get(self, "networkAccessConfig"))

    @network_access_config.setter
    def network_access_config(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosGateway.NetworkAccessConfigProperty"]],
    ) -> None:
        if __debug__:
