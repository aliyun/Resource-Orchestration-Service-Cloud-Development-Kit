...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kafka.datasource.IInstance")
...
class _IInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kafka.datasource.IInstance"
    ...
    def attr_all_config(
        ...
        '''Attribute AllConfig: The current configuration of the deployed message queue Kafka version.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAllConfig"))
    ...
    def attr_allowed_list(
        ...
        '''Attribute AllowedList: White list.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAllowedList"))
    ...
    def attr_disk_size(
        ...
        '''Attribute DiskSize: Disk size.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDiskSize"))
    ...
    def attr_eip_max(
        ...
        '''Attribute EipMax: Peak public network traffic.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrEipMax"))
    ...
    def attr_io_max(
        ...
        '''Attribute IoMax: Peak flow.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIoMax"))
    ...
    def attr_io_max_spec(
        ...
        '''Attribute IoMaxSpec: Flow specifications (recommended).'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIoMaxSpec"))
    ...
    def attr_msg_retain(
        ...
        '''Attribute MsgRetain: Message save time.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrMsgRetain"))
    ...
    def attr_service_version(
        ...
        The value is 0.10.2 or 2.2.0.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrServiceVersion"))
    ...
    def attr_spec_type(
        ...
        '''Attribute SpecType: Instance type.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSpecType"))
    ...
    def attr_topic_num_limit(
        ...
        '''Attribute TopicNumLimit: Maximum number of topic creation.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTopicNumLimit"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kafka.datasource.IInstances")
...
class _IInstancesProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kafka.datasource.IInstances"
...
class _ITopicProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kafka.datasource.ITopic"
    ...
    def attr_compact_topic(
        ...
        '''Attribute CompactTopic: Can log merge.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCompactTopic"))
    ...
    def attr_local_topic(
        ...
        '''Attribute LocalTopic: Whether to store locally.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrLocalTopic"))
    ...
    def attr_partition_num(
        ...
        '''Attribute PartitionNum: Number of partitions.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrPartitionNum"))
    ...
    def attr_status_name(
        ...
        '''Attribute StatusName: Meaning of status value.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrStatusName"))
    ...
    def attr_topic_status(
        ...
        '''Attribute TopicStatus: The Topic status.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTopicStatus"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kafka.datasource.ITopics")
...
class _ITopicsProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kafka.datasource.ITopics"
...
class RosInstance(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e43be9b09a876889f8dce58d0e80a6e0eab2ef2ef9e5ee19450bf5166aec7f54)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosInstances(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__408814ab3aa9278e8ab312ea9dec5d051d1f08df0c2222c959ed5bdb73103a57)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
class RosTopic(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__35a9baccf33284aeb9ff5a29d1b01193d1d5e3dd18eaa53e6bdff0125f6ed728)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
class RosTopics(
    ...
    def refresh_options(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a9701da6cd4b8f2395266b53ea9f51fcedeaf4e438081309c578b9c0046141ba)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "refreshOptions", value)
...
def _typecheckingstub__e43be9b09a876889f8dce58d0e80a6e0eab2ef2ef9e5ee19450bf5166aec7f54(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__408814ab3aa9278e8ab312ea9dec5d051d1f08df0c2222c959ed5bdb73103a57(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__35a9baccf33284aeb9ff5a29d1b01193d1d5e3dd18eaa53e6bdff0125f6ed728(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a9701da6cd4b8f2395266b53ea9f51fcedeaf4e438081309c578b9c0046141ba(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
