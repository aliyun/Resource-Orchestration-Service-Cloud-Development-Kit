...
@jsii.interface(jsii_type="@alicloud/ros-cdk-alb.datasource.ILoadBalancers")
...
class _ILoadBalancersProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-alb.datasource.ILoadBalancers"
