...
class ApplicationDeployment(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ApplicationDeploymentProps":
        return typing.cast("ApplicationDeploymentProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ApplicationDeploymentProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__779531879285cdf1963e2bc689f49b8f1b4258c75048401ef709e0a177394474)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__779531879285cdf1963e2bc689f49b8f1b4258c75048401ef709e0a177394474(
    value: ApplicationDeploymentProps,
) -> None:
    """Type checking stubs"""
    pass
