...
class NetworkPackageAssociation(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "NetworkPackageAssociationProps":
        return typing.cast("NetworkPackageAssociationProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "NetworkPackageAssociationProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0d8d609d6a2fc3456df295b80d873dd61c6996fa59d6703f80e864ec34b93063)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__0d8d609d6a2fc3456df295b80d873dd61c6996fa59d6703f80e864ec34b93063(
    value: NetworkPackageAssociationProps,
) -> None:
    """Type checking stubs"""
    pass
