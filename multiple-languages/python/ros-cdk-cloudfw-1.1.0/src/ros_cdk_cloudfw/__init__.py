...
class NatFirewallControlPolicy(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "NatFirewallControlPolicyProps":
        return typing.cast("NatFirewallControlPolicyProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "NatFirewallControlPolicyProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__66e78d767b7a7dbd766ab8578a0173a8078b7caaa1aa9f2422fa6480adcc263f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__66e78d767b7a7dbd766ab8578a0173a8078b7caaa1aa9f2422fa6480adcc263f(
    value: NatFirewallControlPolicyProps,
) -> None:
    """Type checking stubs"""
    pass
