...
@jsii.interface(jsii_type="@alicloud/ros-cdk-polardbx.IAccount")
...
class _IAccountProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-polardbx.IAccount"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-polardbx.IDBInstance")
...
class _IDBInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-polardbx.IDBInstance"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-polardbx.IDatabase")
...
class _IDatabaseProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-polardbx.IDatabase"
