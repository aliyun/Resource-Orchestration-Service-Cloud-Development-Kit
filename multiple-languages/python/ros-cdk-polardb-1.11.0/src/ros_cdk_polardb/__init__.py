...
class DBClusterProps:
    def __init__(
        ...
        *,
        ...
        :param db_node_num: Property dbNodeNum: The number of Standard Edition nodes. Valid values for PolarDB for MySQL Standard Edition: 1 to 8. Valid values for PolarDB for MySQL Enterprise Edition: 1 to 16.
...
class RosDBCluster(
    ...
    def db_node_num(
        ...
        dbNodeNum: The number of Standard Edition nodes.
        Valid values for PolarDB for MySQL Standard Edition: 1 to 8.
        Valid values for PolarDB for MySQL Enterprise Edition: 1 to 16.
        '''
...
class AccountPrivilege(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::POLARDB::AccountPrivilege``.
