...
@jsii.interface(jsii_type="@alicloud/ros-cdk-config.IReportTemplate")
class IReportTemplate(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``ReportTemplate``.'''

    @builtins.property
    @jsii.member(jsii_name="attrReportFileFormats")
    def attr_report_file_formats(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportGranularity")
    def attr_report_granularity(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportLanguage")
    def attr_report_language(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportScope")
    def attr_report_scope(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateDescription")
    def attr_report_template_description(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateId")
    def attr_report_template_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateName")
    def attr_report_template_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="attrSubscriptionFrequency")
    def attr_subscription_frequency(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ReportTemplateProps":
        ...


class _IReportTemplateProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ReportTemplate``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-config.IReportTemplate"
    ...
    def attr_report_file_formats(
        ...
        Currently only support ``excel``.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportFileFormats"))
    ...
    def attr_report_granularity(
        ...
        '''Attribute ReportGranularity: Report Aggregation Granularity.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportGranularity"))
    ...
    def attr_report_language(
        ...
        '''Attribute ReportLanguage: Report Content Language, Currently only support ``zh-CN`` or ``en-US``.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportLanguage"))
    ...
    def attr_report_scope(
        ...
        '''Attribute ReportScope: Report range, yes and logic between multiple sets of k-v pairs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportScope"))
    ...
    def attr_report_template_description(
        ...
        '''Attribute ReportTemplateDescription: Report Template Description.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportTemplateDescription"))
    ...
    def attr_report_template_id(
        ...
        '''Attribute ReportTemplateId: Report template Id.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportTemplateId"))
    ...
    def attr_report_template_name(
        ...
        '''Attribute ReportTemplateName: Report Template Name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrReportTemplateName"))
    ...
    def attr_subscription_frequency(
        ...
        If this field is not empty, it is a Cron expression in Quartz format triggered by the subscription notification.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSubscriptionFrequency"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ReportTemplateProps":
        return typing.cast("ReportTemplateProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IReportTemplate).__jsii_proxy_class__ = lambda : _IReportTemplateProxy
...
@jsii.implements(IReportTemplate)
class ReportTemplate(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-config.ReportTemplate",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::Config::ReportTemplate``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosReportTemplate``for a more convenient development experience.
    ...
    def __init__(
        ...
        id: builtins.str,
        props: typing.Union["ReportTemplateProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__78aeaf73749ec62d629ab58b376c333e3eacf061af413f502c0578d6cb118782)
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1e22385479f066e34f4e62528bfcdfc1cb42c9950b1ea04fa8ec98fe3091b709)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4cd93bb24623f8fddce2eaf127f77ec954a01fb689a72987039210c7139e935e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fee2910a956e9ee51621ddff4d7c0b29418813b0b89485a129165e5136db5a2e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-config.ReportTemplateProps",
    jsii_struct_bases=[],
    name_mapping={
        "report_template_name": "reportTemplateName",
        "report_file_formats": "reportFileFormats",
        "report_granularity": "reportGranularity",
        "report_language": "reportLanguage",
        "report_scope": "reportScope",
        "report_template_description": "reportTemplateDescription",
        "subscription_frequency": "subscriptionFrequency",
    },
)
class ReportTemplateProps:
    def __init__(
        self,
        *,
        report_template_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        report_file_formats: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        report_granularity: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        report_language: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        report_scope: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosReportTemplate.ReportScopeProperty", typing.Dict[builtins.str, typing.Any]]]]]] = None,
        report_template_description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        subscription_frequency: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``ReportTemplate``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-config-reporttemplate

        :param report_template_name: Property reportTemplateName: Report Template Name.
        :param report_file_formats: Property reportFileFormats: Report Format. Currently only support ``excel``.
        :param report_granularity: Property reportGranularity: Report Aggregation Granularity.
        :param report_language: Property reportLanguage: Report Content Language, Currently only support ``zh-CN`` or ``en-US``.
        :param report_scope: Property reportScope: Report range, yes and logic between multiple sets of k-v pairs.
        :param report_template_description: Property reportTemplateDescription: Report Template Description.
        :param subscription_frequency: Property subscriptionFrequency: Report subscription frequency. If this field is not empty, it is a Cron expression in Quartz format triggered by the subscription notification. The format is: Seconds, time, day, month, week. The following are examples of commonly used Cron expressions: - Execute at 0 o'clock every day: 0 0 0 * *? - Every Monday at 15: 30: 0 30 15? * MON - Execute at 2 o'clock on the 1st of each month: 0 0 2 1 *? Among them: - "*" Indicates any value - What-? Used for day and week fields, indicating that no specific value is specified - MON means Monday .. epigraph:: The trigger time is UTC +8, and the settings of the cron expression can be converted according to the time zone. It can only be triggered according to the cron expression time as much as possible. The cron expression limits the same template to trigger at most one notification per day.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2304b32946de851b07a05f42199b1a533405250f6779168dd82c802c93b3d5c3)
            check_type(argname="argument report_template_name", value=report_template_name, expected_type=type_hints["report_template_name"])
            check_type(argname="argument report_file_formats", value=report_file_formats, expected_type=type_hints["report_file_formats"])
            check_type(argname="argument report_granularity", value=report_granularity, expected_type=type_hints["report_granularity"])
            check_type(argname="argument report_language", value=report_language, expected_type=type_hints["report_language"])
            check_type(argname="argument report_scope", value=report_scope, expected_type=type_hints["report_scope"])
            check_type(argname="argument report_template_description", value=report_template_description, expected_type=type_hints["report_template_description"])
            check_type(argname="argument subscription_frequency", value=subscription_frequency, expected_type=type_hints["subscription_frequency"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "report_template_name": report_template_name,
        }
        if report_file_formats is not None:
            self._values["report_file_formats"] = report_file_formats
        if report_granularity is not None:
            self._values["report_granularity"] = report_granularity
        if report_language is not None:
            self._values["report_language"] = report_language
        if report_scope is not None:
            self._values["report_scope"] = report_scope
        if report_template_description is not None:
            self._values["report_template_description"] = report_template_description
        if subscription_frequency is not None:
            self._values["subscription_frequency"] = subscription_frequency

    @builtins.property
    def report_template_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''Property reportTemplateName: Report Template Name.'''
        result = self._values.get("report_template_name")
        assert result is not None, "Required property 'report_template_name' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)

    @builtins.property
    def report_file_formats(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        ...
        Currently only support ``excel``.
        '''
        result = self._values.get("report_file_formats")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def report_language(
        ...
        result = self._values.get("report_language")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)

    @builtins.property
    def report_scope(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosReportTemplate.ReportScopeProperty"]]]]:
        '''Property reportScope: Report range, yes and logic between multiple sets of k-v pairs.'''
        result = self._values.get("report_scope")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosReportTemplate.ReportScopeProperty"]]]], result)

    @builtins.property
    def report_template_description(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''Property reportTemplateDescription: Report Template Description.'''
        result = self._values.get("report_template_description")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def subscription_frequency(
        ...
        '''
        result = self._values.get("subscription_frequency")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "ReportTemplateProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosReportTemplate(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-config.RosReportTemplate",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::Config::ReportTemplate``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ReportTemplate`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-config-reporttemplate
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosReportTemplateProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__039b9c8944e1430fc1c9140956bd4196ff18f84b4e5877756b416730274e53f8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3c7a75816e67744b537c7131094c0a1703d2c1cbc590f95a4919010d1b515da8)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrReportFileFormats")
    def attr_report_file_formats(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportFileFormats: Report Format. Currently only support ``excel``.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportFileFormats"))

    @builtins.property
    @jsii.member(jsii_name="attrReportGranularity")
    def attr_report_granularity(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportGranularity: Report Aggregation Granularity.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportGranularity"))

    @builtins.property
    @jsii.member(jsii_name="attrReportLanguage")
    def attr_report_language(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportLanguage: Report Content Language, Currently only support ``zh-CN`` or ``en-US``.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportLanguage"))

    @builtins.property
    @jsii.member(jsii_name="attrReportScope")
    def attr_report_scope(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportScope: Report range, yes and logic between multiple sets of k-v pairs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportScope"))

    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateDescription")
    def attr_report_template_description(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportTemplateDescription: Report Template Description.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportTemplateDescription"))

    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateId")
    def attr_report_template_id(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportTemplateId: Report template Id.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportTemplateId"))

    @builtins.property
    @jsii.member(jsii_name="attrReportTemplateName")
    def attr_report_template_name(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ReportTemplateName: Report Template Name.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrReportTemplateName"))

    @builtins.property
    @jsii.member(jsii_name="attrSubscriptionFrequency")
    def attr_subscription_frequency(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        ...
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrSubscriptionFrequency"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1b6e385d3f6af28a869d1a6d38aa4d0167faee8e25ce54f14772c6ea6d9fe113)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="reportTemplateName")
    def report_template_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: reportTemplateName: Report Template Name.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "reportTemplateName"))
    ...
    def report_template_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a74186f8af24d32d1622d7fa8312aab744abeaa3bc72419c90b60d95744145d7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportTemplateName", value)

    @builtins.property
    @jsii.member(jsii_name="reportFileFormats")
    def report_file_formats(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "reportFileFormats"))
    ...
    def report_file_formats(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e59815fd8daa8829dee7c49691f503ff4928703d7628c06fb47fe706fd57d572)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportFileFormats", value)

    @builtins.property
    @jsii.member(jsii_name="reportGranularity")
    def report_granularity(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: reportGranularity: Report Aggregation Granularity.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "reportGranularity"))
    ...
    def report_granularity(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9f9dcde18316ad9566bbd1b45ab8a1511e9827767109878e9912a0ca0f7684d7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportGranularity", value)

    @builtins.property
    @jsii.member(jsii_name="reportLanguage")
    def report_language(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: reportLanguage: Report Content Language, Currently only support ``zh-CN`` or ``en-US``.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "reportLanguage"))
    ...
    def report_language(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d6465de5134d2a0544aeaf8ee59975214b24fe387cf4d8ac2a6531e3ce878e84)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportLanguage", value)

    @builtins.property
    @jsii.member(jsii_name="reportScope")
    def report_scope(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosReportTemplate.ReportScopeProperty"]]]]:
        '''
        :Property: reportScope: Report range, yes and logic between multiple sets of k-v pairs.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosReportTemplate.ReportScopeProperty"]]]], jsii.get(self, "reportScope"))

    @report_scope.setter
    def report_scope(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosReportTemplate.ReportScopeProperty"]]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ad6dcf5afd8584a9dbce09a52fc4e6079e7a9d2e3b889d32df99269ab3163eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportScope", value)

    @builtins.property
    @jsii.member(jsii_name="reportTemplateDescription")
    def report_template_description(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: reportTemplateDescription: Report Template Description.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "reportTemplateDescription"))
    ...
    def report_template_description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7a0123f364ee5880d6d7a256c61b67b7f6a418dff58417857437c95f5130729a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "reportTemplateDescription", value)

    @builtins.property
    @jsii.member(jsii_name="subscriptionFrequency")
    def subscription_frequency(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        It can only be triggered according to the cron expression time as much as possible. The cron expression limits the same template to trigger at most one notification per day.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "subscriptionFrequency"))
    ...
    def subscription_frequency(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ead7704ed77d2c083cabe45e6568de2b7c042099470e959c25ec5cdb3482d27d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "subscriptionFrequency", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-config.RosReportTemplate.ReportScopeProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "match_type": "matchType", "value": "value"},
    )
    class ReportScopeProperty:
        def __init__(
            self,
            *,
            key: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            match_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__43674c77f3ea7e5d757e90595b4292400a40511144251de26d387192433b0af9)
        ...
        def __repr__(self) -> str:
            return "ReportScopeProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-config.RosReportTemplateProps",
    jsii_struct_bases=[],
    name_mapping={
        "report_template_name": "reportTemplateName",
        "report_file_formats": "reportFileFormats",
...
class RosReportTemplateProps:
    def __init__(
        ...
        *,
        ...
        :param report_file_formats: 
        :param report_granularity: 
        :param report_language: 
        :param report_scope: 
        :param report_template_description: 
        :param subscription_frequency: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a39d92c7679e0d643732352215573cee55bca767540cdc6b5e8852b51e3bb054)
            check_type(argname="argument report_template_name", value=report_template_name, expected_type=type_hints["report_template_name"])
            check_type(argname="argument report_file_formats", value=report_file_formats, expected_type=type_hints["report_file_formats"])
            check_type(argname="argument report_granularity", value=report_granularity, expected_type=type_hints["report_granularity"])
            check_type(argname="argument report_language", value=report_language, expected_type=type_hints["report_language"])
    ...
    def __repr__(self) -> str:
        return "RosReportTemplateProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__78aeaf73749ec62d629ab58b376c333e3eacf061af413f502c0578d6cb118782(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[ReportTemplateProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__1e22385479f066e34f4e62528bfcdfc1cb42c9950b1ea04fa8ec98fe3091b709(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4cd93bb24623f8fddce2eaf127f77ec954a01fb689a72987039210c7139e935e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fee2910a956e9ee51621ddff4d7c0b29418813b0b89485a129165e5136db5a2e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2304b32946de851b07a05f42199b1a533405250f6779168dd82c802c93b3d5c3(
    *,
    report_template_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    report_file_formats: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    report_granularity: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__039b9c8944e1430fc1c9140956bd4196ff18f84b4e5877756b416730274e53f8(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosReportTemplateProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__3c7a75816e67744b537c7131094c0a1703d2c1cbc590f95a4919010d1b515da8(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1b6e385d3f6af28a869d1a6d38aa4d0167faee8e25ce54f14772c6ea6d9fe113(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a74186f8af24d32d1622d7fa8312aab744abeaa3bc72419c90b60d95744145d7(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e59815fd8daa8829dee7c49691f503ff4928703d7628c06fb47fe706fd57d572(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__9f9dcde18316ad9566bbd1b45ab8a1511e9827767109878e9912a0ca0f7684d7(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d6465de5134d2a0544aeaf8ee59975214b24fe387cf4d8ac2a6531e3ce878e84(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2ad6dcf5afd8584a9dbce09a52fc4e6079e7a9d2e3b889d32df99269ab3163eb(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosReportTemplate.ReportScopeProperty]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7a0123f364ee5880d6d7a256c61b67b7f6a418dff58417857437c95f5130729a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ead7704ed77d2c083cabe45e6568de2b7c042099470e959c25ec5cdb3482d27d(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__43674c77f3ea7e5d757e90595b4292400a40511144251de26d387192433b0af9(
    *,
    key: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    match_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__a39d92c7679e0d643732352215573cee55bca767540cdc6b5e8852b51e3bb054(
    *,
    report_template_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    report_file_formats: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    report_granularity: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
