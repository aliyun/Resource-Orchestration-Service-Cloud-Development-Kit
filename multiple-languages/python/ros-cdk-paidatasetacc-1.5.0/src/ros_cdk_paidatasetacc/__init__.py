...
class Endpoint(
    ...
    def _props(self) -> "EndpointProps":
        return typing.cast("EndpointProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "EndpointProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__686d3b08f6803c8662754136e5777ae2c10380f92922152fe3e1ee128b67dd1b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__686d3b08f6803c8662754136e5777ae2c10380f92922152fe3e1ee128b67dd1b(
    value: EndpointProps,
) -> None:
    """Type checking stubs"""
    pass
