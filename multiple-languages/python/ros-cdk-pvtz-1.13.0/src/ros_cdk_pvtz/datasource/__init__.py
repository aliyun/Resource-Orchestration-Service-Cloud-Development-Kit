...
class RosZones(
    ...
    def vpc_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__571aa3cee1a73614f8a02c026eb3ee1baabd8e1e5b0e3e21b07927a45ff69802)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ZonesProps:
    def __init__(
        ...
        *,
        ...
        :param vpc_id: Property vpcId: The ID of the VPC that is associated with the zone.
        '''
        if __debug__:
...
def _typecheckingstub__571aa3cee1a73614f8a02c026eb3ee1baabd8e1e5b0e3e21b07927a45ff69802(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
