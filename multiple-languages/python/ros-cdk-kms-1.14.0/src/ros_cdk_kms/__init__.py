...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.IAlias")
class IAlias(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Alias``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AliasProps:
        ...
...
class _IAliasProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.IAlias"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.IInstance")
...
class _IInstanceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.IInstance"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.IKey")
class IKey(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Key``.'''
...
class _IKeyProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.IKey"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.INetworkRule")
...
class _INetworkRuleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.INetworkRule"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.IPolicy")
class IPolicy(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Policy``.'''

    @builtins.property
    @jsii.member(jsii_name="attrAccessControlRules")
    def attr_access_control_rules(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IPolicyProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.IPolicy"
    ...
    def attr_access_control_rules(
        ...
        '''Attribute AccessControlRules: Network Rules info.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrAccessControlRules"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-kms.ISecret")
...
class _ISecretProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-kms.ISecret"
...
class KeyProps:
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union["RosKey.TagsProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
    ) -> None:
        '''Properties for defining a ``Key``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-kms-key

        :param deletion_protection: Property deletionProtection: Specifies whether to enable the release protection feature for the key. Default is false.
        ...
        :param tags: Property tags: Tags to attach to key. Max support 20 tags to add during create key. Each tag with two properties Key and Value, and Key is required.
        '''
        if __debug__:
    ...
    @builtins.property
    def tags(self) -> typing.Optional[typing.List["RosKey.TagsProperty"]]:
        ...
        return typing.cast(typing.Optional[typing.List["RosKey.TagsProperty"]], result)
...
class NetworkRule(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-kms.NetworkRule",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e774d34efbbf075da02ea2f6ed9b66bd79c7a6fad07feaa90d7aa7793a3834f0)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4f3bb75870d14471b6ae6184502c45fe2becd78f6e7f24b9a0e3f1b82680a49d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2c4c29bfb11777f9a2b497608fda34b9d596ff9008b9e7ff0228bdcb3fa8a079)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e5549e3797fd40c9b7b142f44f9f6528bee85d7b5b12a7c608ac531d0e9adae7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-kms.NetworkRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "network_rule_name": "networkRuleName",
        "type": "type",
        "description": "description",
        "source_private_ip": "sourcePrivateIp",
    },
)
class NetworkRuleProps:
    def __init__(
        ...
        *,
        ...
        description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        source_private_ip: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
    ) -> None:
        ...
        :param type: Property type: Network type. The value can be Private only, that is, only private IP addresses are supported.
        :param description: Property description: The description of the network rule.
        :param source_private_ip: Property sourcePrivateIp: VPC network whitelist, The private IP address or private CIDR block, Supports binding up to 800 CIDR blocks or IP addresses.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dd8c4948e09cff5fc894ca3a3da272d2c024466fdf69a4f6d89bd3183034c74f)
            ...
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument source_private_ip", value=source_private_ip, expected_type=type_hints["source_private_ip"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
        ...
        if source_private_ip is not None:
            self._values["source_private_ip"] = source_private_ip
    ...
    def source_private_ip(
        ...
        result = self._values.get("source_private_ip")
...
class Policy(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-kms.Policy",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fe55a91f7814388d50d5bcfccca9dea54ad51ace4a497e57df5b7fffce4be662)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__87684f7df1b5241924b13dcb2094d9c867c5e5de10dbbc6617742a48a8aba0b0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fd41b2f6d692ea684752033eb5c615c246b830bd51ca46c70b93615d4f992d9d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0d24a0acea58d9d660734e4e0ca9682751e785f9f98a9f3e3c78d4e7375b7f3f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-kms.PolicyProps",
    jsii_struct_bases=[],
    name_mapping={
        "access_control_rules": "accessControlRules",
        "kms_instance_id": "kmsInstanceId",
...
class PolicyProps:
    def __init__(
        self,
        *,
        access_control_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosPolicy.AccessControlRulesProperty", typing.Dict[builtins.str, typing.Any]]],
        kms_instance_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        permissions: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        policy_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        resources: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        :param access_control_rules: Property accessControlRules: Network Rules info.
        :param kms_instance_id: Property kmsInstanceId: The scope of the permission policy. You need to specify the KMS instance that you want to access.
        :param permissions: Property permissions: The operations that can be performed. Valid values: RbacPermission/Template/CryptoServiceKeyUser: allows you to perform cryptographic operations. RbacPermission/Template/CryptoServiceSecretUser: allows you to perform secret-related operations.
        :param policy_name: Property policyName: The name of the permission policy.
        :param resources: Property resources: The key and secret that are allowed to access. Supports a maximum of 30 key and secret. Key: Enter a key in the key/${KeyId} format. To allow access to all keys of a KMS instance, enter key/*. Secret: Enter a secret in the secret/${SecretName} format. To allow access to all secrets of a KMS instance, enter secret/*.
        :param description: Property description: The description of the permission policy.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bc05f58febfbbaae5446953707c3ab633c830c9b55c96e245ac861bbbda50497)
            check_type(argname="argument access_control_rules", value=access_control_rules, expected_type=type_hints["access_control_rules"])
            check_type(argname="argument kms_instance_id", value=kms_instance_id, expected_type=type_hints["kms_instance_id"])
    ...
    def access_control_rules(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosPolicy.AccessControlRulesProperty"]:
        '''Property accessControlRules: Network Rules info.'''
        result = self._values.get("access_control_rules")
        assert result is not None, "Required property 'access_control_rules' is missing"
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosPolicy.AccessControlRulesProperty"], result)
    ...
    def kms_instance_id(
        ...
        You need to specify the KMS instance that you want to access.
        '''
        result = self._values.get("kms_instance_id")
        assert result is not None, "Required property 'kms_instance_id' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
...
class RosKey(
    ...
    def deletion_protection(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__979ef078b9e8b0f9989999f9ac4fa580f148cc56098c59b2d67c5ba697de0995)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def tags(self) -> typing.Optional[typing.List["RosKey.TagsProperty"]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.List["RosKey.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(self, value: typing.Optional[typing.List["RosKey.TagsProperty"]]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9312ec07cf553e096728d0a36c0c738e4f84ccd1cda9bf9b3e6fd299b44c44f1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-kms.RosKey.TagsProperty",
        jsii_struct_bases=[],
    ...
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__30c24865da7b70959567b4db46226ebf692e5b7a54d0429dc23f74e769cc8920)
...
class RosNetworkRule(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-kms.RosNetworkRule",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ca2d5e2cfcda5fff9b34611a6dfb33508be068d156378500434d50b867d35c33)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4a103ef9c7bcaa130ee1b6bed48ab48827335956ba00c2a0f0ff1768b37026d0)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bf5528540f4a263624b240389e265639a4684456bd47cbca7708b26aead449ac)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def network_rule_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__da0906843f1d0c1ff85286b2def99433c174f9a85e76cc607613f62bb07dca64)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6a1033c0c6799550df8087d59bea8cc417886c5c4dceee75d7221b31eec3d938)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d3cb642906ac20f6d1c0028babc0054d3c9dcbd4241b10888e4e6b9a96ea75eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)

    @builtins.property
    @jsii.member(jsii_name="sourcePrivateIp")
    def source_private_ip(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]]:
        '''
        :Property: sourcePrivateIp: VPC network whitelist, The private IP address or private CIDR block, Supports binding up to 800 CIDR blocks or IP addresses.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]], jsii.get(self, "sourcePrivateIp"))

    @source_private_ip.setter
    def source_private_ip(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__36663191919cbfa7762004fd7fae40c4e6594fe134ea1b78051511803ad9b9af)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "sourcePrivateIp", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-kms.RosNetworkRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "network_rule_name": "networkRuleName",
        "type": "type",
...
class RosNetworkRuleProps:
    def __init__(
        ...
        *,
        ...
        :param type: 
        :param description: 
        :param source_private_ip: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7a64e4578144e441e12c3cd009312a354cd596956a06440059cc5ad3a0bacdb3)
            check_type(argname="argument network_rule_name", value=network_rule_name, expected_type=type_hints["network_rule_name"])
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument source_private_ip", value=source_private_ip, expected_type=type_hints["source_private_ip"])
...
class RosPolicy(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-kms.RosPolicy",
):
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9257cc2d1a8bfb09fe2e972af6d738ecdd7d029de60e6a70ee867959d0c51a5a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0e57031f6a9b01ab01af43c49f2a6ad4db5524d763460d78e0621e943af54c7c)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrAccessControlRules")
    def attr_access_control_rules(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: AccessControlRules: Network Rules info.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrAccessControlRules"))
    ...
    @builtins.property
    @jsii.member(jsii_name="accessControlRules")
    def access_control_rules(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosPolicy.AccessControlRulesProperty"]:
        '''
        :Property: accessControlRules: Network Rules info.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosPolicy.AccessControlRulesProperty"], jsii.get(self, "accessControlRules"))

    @access_control_rules.setter
    def access_control_rules(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosPolicy.AccessControlRulesProperty"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ec55901a388e6a58200a0548fe185295a3a76d325747832051b1a32a9c0b90df)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "accessControlRules", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5a19029260a85547256d48777b582d138c544e98557d9d97bb4610f1cddc0a29)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="kmsInstanceId")
    def kms_instance_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "kmsInstanceId"))
    ...
    def kms_instance_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__23d2da2c9138d4e76b6ee6067cd824eabb59f213f49b3583700303825bbd76b6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "kmsInstanceId", value)
    ...
    def permissions(
        ...
        permissions: The operations that can be performed. Valid values:
        RbacPermission/Template/CryptoServiceKeyUser: allows you to perform cryptographic operations.
        RbacPermission/Template/CryptoServiceSecretUser: allows you to perform secret-related operations.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "permissions"))
    ...
    def permissions(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__97f8d7e7befb24a4b3c750dc292d0cd76fa0a95379d314cbc7eb5b821083c744)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1e7059bec1fa525bb8873952bd5656138ff51f2d4ef5e2b1250826fb86b08391)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def resources(
        ...
        resources: The key and secret that are allowed to access. Supports a maximum of 30 key and secret.
        Key: Enter a key in the key/${KeyId} format. To allow access to all keys of a KMS instance, enter key/*.
        Secret: Enter a secret in the secret/${SecretName} format. To allow access to all secrets of a KMS instance, enter secret/*.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "resources"))
    ...
    def resources(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7713730d4717607fd2dad35f8e737746816bbd2f430e575ee38eea78019bc70a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ce4fb848d1849410c5a761cb8af38d4e7436835e7d32266f23f8f64c9a8a5dca)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-kms.RosPolicy.AccessControlRulesProperty",
        jsii_struct_bases=[],
        name_mapping={"network_rules": "networkRules"},
    )
    class AccessControlRulesProperty:
        def __init__(
            self,
            *,
            network_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        ) -> None:
            '''
            :param network_rules: 
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__c450aa7e5c5face97f1ef59eba721f1ee74102c833289bc8a6046e2cbbd1b18f)
        ...
        def network_rules(
            ...
            assert result is not None, "Required property 'network_rules' is missing"
            return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], result)
        ...
        def __repr__(self) -> str:
            return "AccessControlRulesProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-kms.RosPolicyProps",
    jsii_struct_bases=[],
    name_mapping={
        "access_control_rules": "accessControlRules",
        "kms_instance_id": "kmsInstanceId",
...
class RosPolicyProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__14d89f583a63b7c2bb094114da922116d4891d7e13c78d67d4ad0d797a0e94b8)
            check_type(argname="argument access_control_rules", value=access_control_rules, expected_type=type_hints["access_control_rules"])
            check_type(argname="argument kms_instance_id", value=kms_instance_id, expected_type=type_hints["kms_instance_id"])
            check_type(argname="argument permissions", value=permissions, expected_type=type_hints["permissions"])
            check_type(argname="argument policy_name", value=policy_name, expected_type=type_hints["policy_name"])
...
class RosSecret(
    ...
    def policy(
        ...
        policy: The specific content of the credential policy in JSON format. Maximum length is 32768 bytes.
    ...
    def policy(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2c09baaa5f21e91af34268d2e7b3955f527bfca10db187e3f1bf6ebca7368171)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "policy", value)
    ...
    @builtins.property
    @jsii.member(jsii_name="tags")
    def tags(self) -> typing.Optional[typing.List["RosSecret.TagsProperty"]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.List["RosSecret.TagsProperty"]], jsii.get(self, "tags"))

    @tags.setter
    def tags(
        self,
        value: typing.Optional[typing.List["RosSecret.TagsProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6a3dc26de9246c0180d35629563cdee21119d846a6e10636945b285b433f479)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "tags", value)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-kms.RosSecret.TagsProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class TagsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__2e47cfafd28ae09d9c594c117dee3927070a31e2f363ca6a772275d8fd1a8f19)
                check_type(argname="argument key", value=key, expected_type=type_hints["key"])
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
            self._values: typing.Dict[builtins.str, typing.Any] = {
                "key": key,
...
class RosSecretProps:
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Sequence[typing.Union[RosSecret.TagsProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
    ...
    def tags(self) -> typing.Optional[typing.List[RosSecret.TagsProperty]]:
        ...
        '''
        result = self._values.get("tags")
        return typing.cast(typing.Optional[typing.List[RosSecret.TagsProperty]], result)
...
class SecretProps:
    def __init__(
        ...
        *,
        ...
        :param policy: Property policy: The specific content of the credential policy in JSON format. Maximum length is 32768 bytes. If this parameter is not specified, the default credential policy is used. The policy content includes: - Version: The version of the policy. Currently, only version 1 is supported. - Statement: A list of statements, each containing: - Sid (optional): A custom statement identifier. Up to 128 characters, including letters, digits, and _/+=.@-. - Effect (required): Whether the statement allows or denies permissions. Valid values: Allow, Deny. - Principal (required): The entity to which the permissions are granted. Can be the current Alibaba Cloud account, RAM users or roles under the current or other accounts. - Action (required): The API actions allowed or denied. Must start with "kms:". For valid actions, see - Resource (required): Must be "*", representing this KMS secret. - Condition (optional): Conditions that limit when the policy is effective. Format: ``"Condition": {"condition operator": {"condition key": "condition value"}}``. See documentation for details. .. epigraph:: After granting permissions to RAM users or roles under another Alibaba Cloud account, you must also use RAM to authorize that user or role to use this secret.
        ...
        :param tags: Property tags: Tags to attach to secret. Max support 20 tags to add during create secret. Each tag with two properties Key and Value, and Key is required.
...
def _typecheckingstub__e774d34efbbf075da02ea2f6ed9b66bd79c7a6fad07feaa90d7aa7793a3834f0(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[NetworkRuleProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__4f3bb75870d14471b6ae6184502c45fe2becd78f6e7f24b9a0e3f1b82680a49d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2c4c29bfb11777f9a2b497608fda34b9d596ff9008b9e7ff0228bdcb3fa8a079(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e5549e3797fd40c9b7b142f44f9f6528bee85d7b5b12a7c608ac531d0e9adae7(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dd8c4948e09cff5fc894ca3a3da272d2c024466fdf69a4f6d89bd3183034c74f(
    *,
    network_rule_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__fe55a91f7814388d50d5bcfccca9dea54ad51ace4a497e57df5b7fffce4be662(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[PolicyProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__87684f7df1b5241924b13dcb2094d9c867c5e5de10dbbc6617742a48a8aba0b0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fd41b2f6d692ea684752033eb5c615c246b830bd51ca46c70b93615d4f992d9d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0d24a0acea58d9d660734e4e0ca9682751e785f9f98a9f3e3c78d4e7375b7f3f(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bc05f58febfbbaae5446953707c3ab633c830c9b55c96e245ac861bbbda50497(
    *,
    access_control_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosPolicy.AccessControlRulesProperty, typing.Dict[builtins.str, typing.Any]]],
    kms_instance_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    permissions: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
...
def _typecheckingstub__979ef078b9e8b0f9989999f9ac4fa580f148cc56098c59b2d67c5ba697de0995(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__9312ec07cf553e096728d0a36c0c738e4f84ccd1cda9bf9b3e6fd299b44c44f1(
    value: typing.Optional[typing.List[RosKey.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__30c24865da7b70959567b4db46226ebf692e5b7a54d0429dc23f74e769cc8920(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
...
def _typecheckingstub__ca2d5e2cfcda5fff9b34611a6dfb33508be068d156378500434d50b867d35c33(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosNetworkRuleProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__4a103ef9c7bcaa130ee1b6bed48ab48827335956ba00c2a0f0ff1768b37026d0(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bf5528540f4a263624b240389e265639a4684456bd47cbca7708b26aead449ac(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__da0906843f1d0c1ff85286b2def99433c174f9a85e76cc607613f62bb07dca64(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6a1033c0c6799550df8087d59bea8cc417886c5c4dceee75d7221b31eec3d938(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d3cb642906ac20f6d1c0028babc0054d3c9dcbd4241b10888e4e6b9a96ea75eb(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__36663191919cbfa7762004fd7fae40c4e6594fe134ea1b78051511803ad9b9af(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7a64e4578144e441e12c3cd009312a354cd596956a06440059cc5ad3a0bacdb3(
    *,
    network_rule_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__9257cc2d1a8bfb09fe2e972af6d738ecdd7d029de60e6a70ee867959d0c51a5a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosPolicyProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__0e57031f6a9b01ab01af43c49f2a6ad4db5524d763460d78e0621e943af54c7c(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ec55901a388e6a58200a0548fe185295a3a76d325747832051b1a32a9c0b90df(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosPolicy.AccessControlRulesProperty],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5a19029260a85547256d48777b582d138c544e98557d9d97bb4610f1cddc0a29(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__23d2da2c9138d4e76b6ee6067cd824eabb59f213f49b3583700303825bbd76b6(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__97f8d7e7befb24a4b3c750dc292d0cd76fa0a95379d314cbc7eb5b821083c744(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1e7059bec1fa525bb8873952bd5656138ff51f2d4ef5e2b1250826fb86b08391(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7713730d4717607fd2dad35f8e737746816bbd2f430e575ee38eea78019bc70a(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ce4fb848d1849410c5a761cb8af38d4e7436835e7d32266f23f8f64c9a8a5dca(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c450aa7e5c5face97f1ef59eba721f1ee74102c833289bc8a6046e2cbbd1b18f(
    *,
    network_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__14d89f583a63b7c2bb094114da922116d4891d7e13c78d67d4ad0d797a0e94b8(
    *,
    access_control_rules: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosPolicy.AccessControlRulesProperty, typing.Dict[builtins.str, typing.Any]]],
    kms_instance_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    permissions: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
...
def _typecheckingstub__2c09baaa5f21e91af34268d2e7b3955f527bfca10db187e3f1bf6ebca7368171(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__f6a3dc26de9246c0180d35629563cdee21119d846a6e10636945b285b433f479(
    value: typing.Optional[typing.List[RosSecret.TagsProperty]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__2e47cfafd28ae09d9c594c117dee3927070a31e2f363ca6a772275d8fd1a8f19(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
) -> None:
