...
@jsii.interface(jsii_type="@alicloud/ros-cdk-mps.IMediaWorkflow")
class IMediaWorkflow(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def props(self) -> "MediaWorkflowProps":
        ...


class _IMediaWorkflowProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MediaWorkflow``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-mps.IMediaWorkflow"
    ...
    def attr_media_workflow_id(
        ...
        '''Attribute MediaWorkflowId: The ID of the media workflow.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrMediaWorkflowId"))
    ...
    def attr_topology(
        ...
        '''Attribute Topology: The topology of the media workflow.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTopology"))
    ...
    def attr_trigger_mode(
        ...
        '''Attribute TriggerMode: The trigger mode of the media workflow.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTriggerMode"))
...
typing.cast(typing.Any, IMediaWorkflow).__jsii_proxy_class__ = lambda : _IMediaWorkflowProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-mps.IPipeline")
...
class _IPipelineProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-mps.IPipeline"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-mps.ITranscodeJob")
class ITranscodeJob(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``TranscodeJob``.'''

    @builtins.property
    @jsii.member(jsii_name="attrJobIds")
    def attr_job_ids(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TranscodeJobProps":
        ...


class _ITranscodeJobProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``TranscodeJob``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-mps.ITranscodeJob"
    ...
    def attr_job_ids(
        ...
        '''Attribute JobIds: The IDs of the jobs.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrJobIds"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "TranscodeJobProps":
        return typing.cast("TranscodeJobProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, ITranscodeJob).__jsii_proxy_class__ = lambda : _ITranscodeJobProxy


@jsii.implements(IMediaWorkflow)
class MediaWorkflow(
...
class Pipeline(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::MPS::Pipeline``.
...
class RosTranscodeJob(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-mps.RosTranscodeJob",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::MPS::TranscodeJob``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``TranscodeJob`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosTranscodeJobProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__577f4b580883d9c30580688d66202ee087823b5f1d835862d42e5d1594775c19)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3eb575061d7fadb6c41a367d097426af32bacaaa7ba65ccca665ced4aacef933)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrJobIds")
    def attr_job_ids(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: JobIds: The IDs of the jobs.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrJobIds"))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be41bf0573399c17443b0f5f05f05aa0089e7193c59e9bf4dfd909c9921014a4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def input(
        ...
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]], jsii.get(self, "input"))
    ...
    def input(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ec88e36f781138b8927ac1a28a162444c43aca06e63fff0a9ed6936e7f3827da)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def output_bucket(
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "outputBucket"))
    ...
    def output_bucket(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25b302e0fb7e2fcb78edca91a0c060ff144a3d735f3272b7e25d92acf9cf6258)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def outputs(
        ...
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Mapping[builtins.str, typing.Any]]], jsii.get(self, "outputs"))
    ...
    def outputs(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__94fb7da0cfd8b8c9b4c9dcfdb61fe09785fc67444f0c0885eecc7a53d4bc6f84)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def pipeline_id(
        ...
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "pipelineId"))
    ...
    def pipeline_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__69635b15a7bbba07ab6b3a285da56c7f46ea47835386a32d756cea9560578cb9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def output_location(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "outputLocation"))
    ...
    def output_location(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dde93af1c6478cfca464d710079fecd87a35e5edee29545292d7b3f800c36fdc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "outputLocation", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-mps.RosTranscodeJobProps",
    jsii_struct_bases=[],
    name_mapping={
        "input": "input",
...
class RosTranscodeJobProps:
    def __init__(
        self,
        *,
        input: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]],
        output_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        outputs: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
        pipeline_id: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        output_location: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__77dada63a9926e47508444103157e6075cc83a4e7b12b256a56f3f0308f2d99f)
    ...
    def __repr__(self) -> str:
        return "RosTranscodeJobProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(ITranscodeJob)
class TranscodeJob(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-mps.TranscodeJob",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::MPS::TranscodeJob``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosTranscodeJob``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mps-transcodejob
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["TranscodeJobProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ae839d656ed7b5e2a74cc4c499c9ff3412aa2f7bab02ebd87f54b5ce2a9424a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d56f9b40e57a17e891d41edf85e78abeff2b2734b716e6edbeb8ec9337bd18a0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aff2fb7027c6c7185e77e0b2bb3c2a024412029649cea378787c355f1303fd0e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a1ef5a9514d5e91b81ad1b55dd1072614aea128d46426b8554cb90074b502542)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-mps.TranscodeJobProps",
    jsii_struct_bases=[],
    name_mapping={
        "input": "input",
        "output_bucket": "outputBucket",
...
class TranscodeJobProps:
    def __init__(
        ...
        *,
        ...
        :param input: Property input: The input configuration of the job. For more information, see Input details.
        :param output_bucket: Property outputBucket: The name of the OSS bucket where the output files are stored.
        :param outputs: Property outputs: The output configuration of the job. Consists of a list of Output objects, JSON array, with a maximum size of 30.
        :param pipeline_id: Property pipelineId: The ID of the pipeline.
        :param output_location: Property outputLocation: The region of the OSS bucket where the output files are stored.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e5543aea642aded6b8e214f621335e885aee8f761c09a34fab343a61c74a8732)
            check_type(argname="argument input", value=input, expected_type=type_hints["input"])
            check_type(argname="argument output_bucket", value=output_bucket, expected_type=type_hints["output_bucket"])
            check_type(argname="argument outputs", value=outputs, expected_type=type_hints["outputs"])
            check_type(argname="argument pipeline_id", value=pipeline_id, expected_type=type_hints["pipeline_id"])
    ...
    def __repr__(self) -> str:
        return "TranscodeJobProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__577f4b580883d9c30580688d66202ee087823b5f1d835862d42e5d1594775c19(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosTranscodeJobProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__3eb575061d7fadb6c41a367d097426af32bacaaa7ba65ccca665ced4aacef933(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__be41bf0573399c17443b0f5f05f05aa0089e7193c59e9bf4dfd909c9921014a4(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ec88e36f781138b8927ac1a28a162444c43aca06e63fff0a9ed6936e7f3827da(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__25b302e0fb7e2fcb78edca91a0c060ff144a3d735f3272b7e25d92acf9cf6258(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__94fb7da0cfd8b8c9b4c9dcfdb61fe09785fc67444f0c0885eecc7a53d4bc6f84(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Mapping[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__69635b15a7bbba07ab6b3a285da56c7f46ea47835386a32d756cea9560578cb9(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dde93af1c6478cfca464d710079fecd87a35e5edee29545292d7b3f800c36fdc(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__77dada63a9926e47508444103157e6075cc83a4e7b12b256a56f3f0308f2d99f(
    *,
    input: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]],
    output_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    outputs: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
...
def _typecheckingstub__5ae839d656ed7b5e2a74cc4c499c9ff3412aa2f7bab02ebd87f54b5ce2a9424a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[TranscodeJobProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__d56f9b40e57a17e891d41edf85e78abeff2b2734b716e6edbeb8ec9337bd18a0(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aff2fb7027c6c7185e77e0b2bb3c2a024412029649cea378787c355f1303fd0e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a1ef5a9514d5e91b81ad1b55dd1072614aea128d46426b8554cb90074b502542(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e5543aea642aded6b8e214f621335e885aee8f761c09a34fab343a61c74a8732(
    *,
    input: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]],
    output_bucket: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    outputs: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Mapping[builtins.str, typing.Any]]],
