...
class FunctionProps:
    def __init__(
        ...
        *,
        ...
        :param instance_type: Property instanceType: Instance type. Value:- e1: Elastic Instance.- c1: Performance Instance.- fc.gpu.tesla.1: GPU Tesla Series Instance Type.- fc.gpu.ampere.1: GPU Ampere Series Instance Type.- fc.gpu.ada.1: GPU Ada Series Instance Type.- g1: Same as fc.gpu.tesla.1.
        :param memory_size: Property memorySize: The amount of memory that’s used to run function, in MB. Function Compute uses this value to allocate CPU resources proportionally. Defaults to 128 MB. It can be multiple of 64 MB and between 128 MB and 32768 MB.
...
class RosFunctionInvoker(
    ...
    def check_async_invocation(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__25b92ecebb3ecdeec31d1026555b793b2970f4ffcdd38b352382a3b9225bf586)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-fc.RosFunctionInvoker.CheckAsyncInvocationProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class CheckAsyncInvocationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__03c4f993a2f5ce471a24fc1954810324d1775a642c10c78cf2aabd3cd9cc8a54)
...
class CustomDomain(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::FC::CustomDomain``.
...
def _typecheckingstub__25b92ecebb3ecdeec31d1026555b793b2970f4ffcdd38b352382a3b9225bf586(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosFunctionInvoker.CheckAsyncInvocationProperty]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__03c4f993a2f5ce471a24fc1954810324d1775a642c10c78cf2aabd3cd9cc8a54(
    *,
    check_interval: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    check_times: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    enabled: typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable],
