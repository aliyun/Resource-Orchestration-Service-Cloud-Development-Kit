...
class ResourcePackage(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::CDT::ResourcePackage``The , which type creates a resource plan.
...
class RosResourcePackage(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::CDT::ResourcePackage``The , which type creates a resource plan.
