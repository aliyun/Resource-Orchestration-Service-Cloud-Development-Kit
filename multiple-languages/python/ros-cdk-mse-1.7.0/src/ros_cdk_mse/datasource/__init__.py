...
@jsii.interface(jsii_type="@alicloud/ros-cdk-mse.datasource.IClusters")
...
class _IClustersProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-mse.datasource.IClusters"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-mse.datasource.IGateways")
...
class _IGatewaysProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-mse.datasource.IGateways"
...
class Gateways(
    ...
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::MSE::Gateways``.
