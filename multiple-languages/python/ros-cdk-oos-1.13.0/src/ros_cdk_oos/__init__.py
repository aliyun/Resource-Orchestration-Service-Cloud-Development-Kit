...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.ApplicationConnectionBindProps",
    jsii_struct_bases=[],
    name_mapping={
...
class ApplicationConnectionBindProps:
    def __init__(
        self,
        *,
        connection_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        application_group_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param connection_ids: Property connectionIds: The list of connection IDs to bind. The maximum number of connections is 100.
        :param application_group_name: Property applicationGroupName: The name of the application group.
        :param application_name: Property applicationName: The name of the application.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__748ea2e7f5a1a5abf5132e7a812ce345ec7e19cce653bd7f442e677bb71caa7a)
            check_type(argname="argument connection_ids", value=connection_ids, expected_type=type_hints["connection_ids"])
            check_type(argname="argument application_group_name", value=application_group_name, expected_type=type_hints["application_group_name"])
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "connection_ids": connection_ids,
        }
        if application_group_name is not None:
            self._values["application_group_name"] = application_group_name
    ...
    def connection_ids(
        ...
        '''
        result = self._values.get("connection_ids")
        assert result is not None, "Required property 'connection_ids' is missing"
    ...
    def __repr__(self) -> str:
        return "ApplicationConnectionBindProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.ApplicationConnectionProps",
    jsii_struct_bases=[],
    name_mapping={
...
class ApplicationConnectionProps:
    def __init__(
        self,
        *,
        connection_category: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        connection_type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        env_vars: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosApplicationConnection.EnvVarsProperty", typing.Dict[builtins.str, typing.Any]]]]],
        ...
        :param connection_category: Property connectionCategory: The category of the application connection.
        :param connection_type: Property connectionType: The type of the application connection.
        :param env_vars: Property envVars: The environment variables of the application connection.
        :param name: Property name: The name of the application connection.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__18990f96805fa44a2cdb17fbeacadfecc14c513ea379ac205017aa54782bbedb)
            check_type(argname="argument connection_category", value=connection_category, expected_type=type_hints["connection_category"])
    ...
    def connection_category(
        ...
        result = self._values.get("connection_category")
        assert result is not None, "Required property 'connection_category' is missing"
    ...
    def env_vars(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationConnection.EnvVarsProperty"]]]:
        '''Property envVars: The environment variables of the application connection.'''
        result = self._values.get("env_vars")
        assert result is not None, "Required property 'env_vars' is missing"
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationConnection.EnvVarsProperty"]]], result)
    ...
    def __repr__(self) -> str:
        return "ApplicationConnectionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.ApplicationGroupDeploymentProps",
    jsii_struct_bases=[],
    name_mapping={
        "application_name": "applicationName",
        "name": "name",
...
class ApplicationGroupDeploymentProps:
    def __init__(
        self,
        *,
        application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        deploy_parameters: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        revision_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        :param application_name: Property applicationName: The name of the application.
        :param name: Property name: The name of the application group.
        :param deploy_parameters: Property deployParameters: The deploy parameters of the application group to be deployed.
        :param revision_id: Property revisionId: The ID of the revision.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__06890f9d91114503a1489d9d1cd21b539e7e76509b720f7e0fabeeab7203a863)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def __repr__(self) -> str:
        return "ApplicationGroupDeploymentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.DeployRevisionProps",
    jsii_struct_bases=[],
    name_mapping={
        "application_name": "applicationName",
...
class DeployRevisionProps:
    def __init__(
        self,
        *,
        application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        deploy_resource_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        hooks: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]] = None,
        location: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]] = None,
        revision_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        ...
        :param application_name: Property applicationName: The name of the application.
        :param deploy_resource_type: Property deployResourceType: The type of the deploy resource.
        :param description: Property description: The description of the revision.
        :param hooks: Property hooks: The hook of the code to be deployed.
        :param location: Property location: The location of the code to be deployed.
        :param revision_type: Property revisionType: The type of the revision.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c8967e0544bd07461caa03ee708fe51a4a9d8c2d08970757a072c22190f70ad2)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
            check_type(argname="argument deploy_resource_type", value=deploy_resource_type, expected_type=type_hints["deploy_resource_type"])
        ...
        if deploy_resource_type is not None:
            self._values["deploy_resource_type"] = deploy_resource_type
    ...
    def deploy_resource_type(
        ...
        result = self._values.get("deploy_resource_type")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "DeployRevisionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class ExecutionProps:
    def __init__(
        ...
        *,
        ...
        template_content: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param safety_check: Property safetyCheck: Security check mode. Allowed values: - Skip (default): This option means that customers understand the risks, you can do anything without confirmation Action, no matter what the level of risk. It takes effect only if Mode is Automatic. - ConfirmEveryHighRiskAction: This option would require customers to confirm each Action a high risk. NotifyExecution by calling customer interface to confirm or cancel.
        :param tags: Property tags: Tag value and the key mapping, the label of the key number can be up to 20.
        :param template_content: Property templateContent: The content of the template in the JSON or YAML format. This parameter is the same as the Content parameter that you can specify when you call the CreateTemplate operation. You can use this parameter to specify the tasks that you want to run. This way, you do not need to create a template before you start an execution. If you select an existing template, you do not need to specify this parameter.
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IApplicationConnection")
class IApplicationConnection(
    ...
    def props(self) -> ApplicationConnectionProps:
        ...


class _IApplicationConnectionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ApplicationConnection``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IApplicationConnection"
    ...
    def attr_connection_id(
        ...
        '''Attribute ConnectionId: The ID of the application connection.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrConnectionId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationConnectionProps:
        return typing.cast(ApplicationConnectionProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IApplicationConnection).__jsii_proxy_class__ = lambda : _IApplicationConnectionProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IApplicationConnectionBind")
class IApplicationConnectionBind(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationConnectionBindProps:
        ...


class _IApplicationConnectionBindProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ApplicationConnectionBind``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IApplicationConnectionBind"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationConnectionBindProps:
        return typing.cast(ApplicationConnectionBindProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IApplicationConnectionBind).__jsii_proxy_class__ = lambda : _IApplicationConnectionBindProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IApplicationGroupDeployment")
class IApplicationGroupDeployment(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationGroupDeploymentProps:
        ...


class _IApplicationGroupDeploymentProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ApplicationGroupDeployment``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IApplicationGroupDeployment"
    ...
    def attr_execution_id(
        ...
        '''Attribute ExecutionId: The execution ID of the application group deployment.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrExecutionId"))
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationGroupDeploymentProps:
        return typing.cast(ApplicationGroupDeploymentProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IApplicationGroupDeployment).__jsii_proxy_class__ = lambda : _IApplicationGroupDeploymentProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IDefaultPatchBaseline")
class IDefaultPatchBaseline(
    _ros_cdk_core_7adfd82f.IResource,
    typing_extensions.Protocol,
):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DefaultPatchBaselineProps:
        ...


class _IDefaultPatchBaselineProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DefaultPatchBaseline``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IDefaultPatchBaseline"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDefaultPatchBaseline).__jsii_proxy_class__ = lambda : _IDefaultPatchBaselineProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IDeployRevision")
class IDeployRevision(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``DeployRevision``.'''

    @builtins.property
    @jsii.member(jsii_name="attrRevisionId")
    def attr_revision_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DeployRevisionProps:
        ...


class _IDeployRevisionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DeployRevision``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IDeployRevision"
    ...
    def attr_revision_id(
        ...
        '''Attribute RevisionId: The ID of the revision.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrRevisionId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DeployRevisionProps:
        return typing.cast(DeployRevisionProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDeployRevision).__jsii_proxy_class__ = lambda : _IDeployRevisionProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IExecution")
class IExecution(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ExecutionProps:
        ...


class _IExecutionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``Execution``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IExecution"
    ...
    def attr_counters(
        ...
        '''Attribute Counters: Task statistics: FailedTasks, SuccessTasks, TotalTasks.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCounters"))
    ...
    def attr_curl_cli(
        ...
        You can also notify execution via ROS API SignalResource. API parameters Status and UniqueId are ignored. Use API parameter Data to pass data.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrCurlCli"))
    ...
    def attr_power_shell_curl_cli(
        ...
        For more parameters in data, refer to https://help.aliyun.com/document_detail/120777.html.You can also notify execution via ROS API SignalResource. API parameters Status and UniqueId are ignored. Use API parameter Data to pass data.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrPowerShellCurlCli"))
    ...
    def attr_windows_curl_cli(
        ...
        For more parameters in data, refer to https://help.aliyun.com/document_detail/120777.html.You can also notify execution via ROS API SignalResource. API parameters Status and UniqueId are ignored. Use API parameter Data to pass data.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrWindowsCurlCli"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IExecution).__jsii_proxy_class__ = lambda : _IExecutionProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IParameter")
class IParameter(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
...
class _IParameterProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IParameter"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IPatchBaseline")
...
class _IPatchBaselineProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IPatchBaseline"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.ISecretParameter")
...
class _ISecretParameterProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.ISecretParameter"
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IServiceSettings")
class IServiceSettings(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``ServiceSettings``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ServiceSettingsProps":
        ...


class _IServiceSettingsProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ServiceSettings``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IServiceSettings"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ServiceSettingsProps":
        return typing.cast("ServiceSettingsProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IServiceSettings).__jsii_proxy_class__ = lambda : _IServiceSettingsProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.IStateConfiguration")
class IStateConfiguration(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``StateConfiguration``.'''

    @builtins.property
    @jsii.member(jsii_name="attrStateConfigurationId")
    def attr_state_configuration_id(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "StateConfigurationProps":
        ...


class _IStateConfigurationProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``StateConfiguration``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.IStateConfiguration"
    ...
    def attr_state_configuration_id(
        ...
        '''Attribute StateConfigurationId: The ID of the desired-state configuration.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrStateConfigurationId"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IStateConfiguration).__jsii_proxy_class__ = lambda : _IStateConfigurationProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-oos.ITemplate")
class ITemplate(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Template``.'''

    @builtins.property
    @jsii.member(jsii_name="attrExecutionPolicy")
    def attr_execution_policy(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _ITemplateProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-oos.ITemplate"
    ...
    def attr_execution_policy(
        ...
        '''Attribute ExecutionPolicy: Execution Policy.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrExecutionPolicy"))
...
class ParameterProps:
    def __init__(
        ...
        *,
        ...
        :param name: Property name: The name of the parameter. The name must be 1 to 200 characters in length,and can contain letters, digits, hyphens (-), and underscores (_). It cannot start with ALIYUN, ALIBABA, ALICLOUD, ACS or OOS.
...
class RosApplicationConnection(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationConnection",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OOS::ApplicationConnection``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ApplicationConnection`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnection
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosApplicationConnectionProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1182d47d4115302666685948f28236cd22db78b510a416d7c0a93d2bde1a04e7)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6f7cf5b0c8c4f6b82c1fde5e8e41303f997e4d8e6ce06ef97b0f0c286f156790)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    @builtins.property
    @jsii.member(jsii_name="attrConnectionId")
    def attr_connection_id(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: ConnectionId: The ID of the application connection.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrConnectionId"))
    ...
    @builtins.property
    @jsii.member(jsii_name="connectionCategory")
    def connection_category(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: connectionCategory: The category of the application connection.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "connectionCategory"))

    @connection_category.setter
    def connection_category(
        self,
        value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__55c823412fbc02a463923d4b4c2b430179a2918e502fdf0a26735ea3efae2df2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "connectionCategory", value)
    ...
    def connection_type(
        ...
        :Property: connectionType: The type of the application connection.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "connectionType"))
    ...
    def connection_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c059ac3c3072942e6de4fc2309013f2e5aff1bfe1f89ca92cd64a718bb318fa4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cf2a921f508d9e6d08f73cb7db298227606ba04d13e52f3384ace0a446dfd543)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def env_vars(
        ...
        :Property: envVars: The environment variables of the application connection.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationConnection.EnvVarsProperty"]]], jsii.get(self, "envVars"))

    @env_vars.setter
    def env_vars(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationConnection.EnvVarsProperty"]]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc0c7e4ecfffab001e178d1f723df371d08d33ceb1ee84779165624f219d897f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "envVars", value)
    ...
    def name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c025c2d33b3f49ec273cf6fdcca5116b4c300dcdcbec3c1bf9c75a324116643a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-oos.RosApplicationConnection.EnvVarsProperty",
        jsii_struct_bases=[],
        name_mapping={"key": "key", "value": "value"},
    )
    class EnvVarsProperty:
        def __init__(
            self,
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__1b596d54d74f746a84075123b847ee84867bfbd6f397f9bc56f4c125e0c7513f)
        ...
        def __repr__(self) -> str:
            return "EnvVarsProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )


class RosApplicationConnectionBind(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationConnectionBind",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OOS::ApplicationConnectionBind``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ApplicationConnectionBind`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnectionbind
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosApplicationConnectionBindProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8121ccd5695c71d179d6ea4bb64e5b1f4f8aa1adc3da865cf29ddf65c8dbb8ac)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7b619f6c10c47f1f9f7411158cbf1f050dceb247dbcdbef9a874c358f91e88b7)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="connectionIds")
    def connection_ids(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]:
        '''
        ...
        connectionIds: The list of connection IDs to bind.
        The maximum number of connections is 100.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "connectionIds"))
    ...
    def connection_ids(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2534f183535a2a5852385a170cf30cfa195bf1f2471977b514f085e5987185a0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "connectionIds", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e95da766ad88d62239a201a09334e02e28de8a911837f094949b1b1441dad205)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="applicationGroupName")
    def application_group_name(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: applicationGroupName: The name of the application group.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "applicationGroupName"))
    ...
    def application_group_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3be0961040738c846b4c8c7760c4850cc1dbc5b40eebec2d0ee345e73a47a513)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applicationGroupName", value)
    ...
    def application_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ae613bc7020829fae03212134707c213515bbd7d938effa92ba0a0620563664e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applicationName", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationConnectionBindProps",
    jsii_struct_bases=[],
    name_mapping={
        "connection_ids": "connectionIds",
        "application_group_name": "applicationGroupName",
...
class RosApplicationConnectionBindProps:
    def __init__(
        self,
        *,
        connection_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
        ...
        :param application_group_name: 
        :param application_name: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d9779db8df9cf9117bea50847aea4b3d7a27a0b67078cb2c896f918bb2f9207)
            check_type(argname="argument connection_ids", value=connection_ids, expected_type=type_hints["connection_ids"])
            check_type(argname="argument application_group_name", value=application_group_name, expected_type=type_hints["application_group_name"])
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
    ...
    def __repr__(self) -> str:
        return "RosApplicationConnectionBindProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationConnectionProps",
    jsii_struct_bases=[],
    name_mapping={
        "connection_category": "connectionCategory",
        "connection_type": "connectionType",
...
class RosApplicationConnectionProps:
    def __init__(
        self,
        *,
        connection_category: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param connection_category: 
        :param connection_type: 
        :param env_vars: 
        :param name: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4d766b0849d040343444ac806121bbe1a2a80b6356903c7640a2ebc8c6f2828f)
            check_type(argname="argument connection_category", value=connection_category, expected_type=type_hints["connection_category"])
            check_type(argname="argument connection_type", value=connection_type, expected_type=type_hints["connection_type"])
            check_type(argname="argument env_vars", value=env_vars, expected_type=type_hints["env_vars"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
    ...
    def __repr__(self) -> str:
        return "RosApplicationConnectionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class RosApplicationGroupDeployment(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationGroupDeployment",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``ApplicationGroupDeployment`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationgroupdeployment
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosApplicationGroupDeploymentProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__02f9d5046c7a1ab20aec512506257d6d9a9601aeb1d53977ef003e5f2c0f65c9)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5176dcd59b5b3ace649a145f4cbbf03df749e8b9fef4d12580dc903967d1b0fb)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def application_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6e71dfd5ae9727f883025c5536e97ee36a99e9a1c4f9bb14bfa1c211abe2b05)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applicationName", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c36ff6d1f11747eb81f524a363595c02af07e214feca9addbac4e913f5dcb816)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4aaa9ed8acf55d036533fef5c146ddeda9336a8503a0e6832989c95a0c726e14)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)
    ...
    def deploy_parameters(
        ...
        :Property: deployParameters: The deploy parameters of the application group to be deployed.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deployParameters"))
    ...
    def deploy_parameters(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ac4f04ba0d6edd30362563f0afc5885452a2d5741d98c4248dd46e3339a24c3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def revision_id(
        ...
        :Property: revisionId: The ID of the revision.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "revisionId"))
    ...
    def revision_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d57cfedd1a3462e33865b22e32e3c4cb73b078cbbbc1e262c8cd89ca96377ee9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "revisionId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.RosApplicationGroupDeploymentProps",
    jsii_struct_bases=[],
    name_mapping={
        "application_name": "applicationName",
        "name": "name",
...
class RosApplicationGroupDeploymentProps:
    def __init__(
        self,
        *,
        application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param application_name: 
        :param name: 
        :param deploy_parameters: 
        :param revision_id: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a1cee09003615e654ee5553ea35d123c1b7c2f0ea776d2c2070416c62d75e850)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument deploy_parameters", value=deploy_parameters, expected_type=type_hints["deploy_parameters"])
            check_type(argname="argument revision_id", value=revision_id, expected_type=type_hints["revision_id"])
    ...
    def __repr__(self) -> str:
        return "RosApplicationGroupDeploymentProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosDeployRevision(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.RosDeployRevision",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OOS::DeployRevision``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``DeployRevision`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-deployrevision
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosDeployRevisionProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__724e9e30302a386097149563de7e46c0faa51ca5d14741a89cfbd376472de835)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__96294b47bd22e193c36cad2e60472ead286e9d1942331dcc9b9420e81ad18b9d)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    @builtins.property
    @jsii.member(jsii_name="attrRevisionId")
    def attr_revision_id(self) -> _ros_cdk_core_7adfd82f.IResolvable:
        '''
        :Attribute: RevisionId: The ID of the revision.
        '''
        return typing.cast(_ros_cdk_core_7adfd82f.IResolvable, jsii.get(self, "attrRevisionId"))
    ...
    def application_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__199140cec6c1f48c642a58854160923e4a75a98d26416a17c396ebe74eadf84c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "applicationName", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4327a399b9201df38c0f6b8fda78bfab822a35a6ff1ebe94fa7216b17445d20a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="deployResourceType")
    def deploy_resource_type(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: deployResourceType: The type of the deploy resource.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deployResourceType"))
    ...
    def deploy_resource_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__701998f09dc9a5c7d413592624ecce7e1d80ed3d689f1966c1ddda3589f10b8c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deployResourceType", value)
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0415231d97f9eb8bd8575e77d448256560f4c4312544164b667b0ab74ceb5ed5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def hooks(
        ...
        :Property: hooks: The hook of the code to be deployed.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]], jsii.get(self, "hooks"))
    ...
    def hooks(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bccab721389b79220441b94232ae88ff5de4cf5f4a8141ae12f8584396cf3c11)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "hooks", value)
    ...
    def location(
        ...
        :Property: location: The location of the code to be deployed.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]], jsii.get(self, "location"))
    ...
    def location(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0f09afe25d1084c1165db9d52135b099a5a438242b6a688627b8ce9d85a92e69)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "location", value)

    @builtins.property
    @jsii.member(jsii_name="revisionType")
    def revision_type(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: revisionType: The type of the revision.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "revisionType"))
    ...
    def revision_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f3f40e0ef1a0925cb49886d81d8308fc489e16d115eb9242a5fa44f7f7d4f0a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "revisionType", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.RosDeployRevisionProps",
    jsii_struct_bases=[],
    name_mapping={
        "application_name": "applicationName",
        "deploy_resource_type": "deployResourceType",
...
class RosDeployRevisionProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d2690a4c5fb914c6051b1d740978df74d4cd85a8199c2dfdb28992165dd21d5)
            check_type(argname="argument application_name", value=application_name, expected_type=type_hints["application_name"])
            check_type(argname="argument deploy_resource_type", value=deploy_resource_type, expected_type=type_hints["deploy_resource_type"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument hooks", value=hooks, expected_type=type_hints["hooks"])
    ...
    def __repr__(self) -> str:
        return "RosDeployRevisionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosExecution(
    ...
    def template_content(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "templateContent"))
    ...
    def template_content(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__12bc05cf245f1f2e7eed89d3ed85c079f86b554d44860272dedd6571b120ca59)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def template_url(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ca3c8ead7cf729d511ed72815d3386420eddb69b05928bd728f6ecdf69386485)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosServiceSettings(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.RosServiceSettings",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::OOS::ServiceSettings``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ServiceSettings`` class instead of this class for a more convenient development experience.
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosServiceSettingsProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__357d98856cca637b6a4bf88dce9fe165ab07072a8cbe1b4bb210011a5e155518)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8d36ee02ea7cd5decd739003ede625af2f0c0d70c0b486103fa2adf6d26cbd83)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ee95575189075f389e8d4954eb30b08514b985b8bd5d6d22da9d1c1c8214566)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)

    @builtins.property
    @jsii.member(jsii_name="deliveryOssBucketName")
    def delivery_oss_bucket_name(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: deliveryOssBucketName: OSS bucket name.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deliveryOssBucketName"))
    ...
    def delivery_oss_bucket_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2ab9ddfc99be30dff9629a846e05489ada68b397145ecdc27c09dac70d9b287d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deliveryOssBucketName", value)

    @builtins.property
    @jsii.member(jsii_name="deliveryOssEnabled")
    def delivery_oss_enabled(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: deliveryOssEnabled: Whether to enable the OSS delivery template execution logging feature. Defaults to false.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deliveryOssEnabled"))
    ...
    def delivery_oss_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a932e65adab8b495c507ba1b45d2e5bfe3fc681b9baa4b51b6b82c36a123e10b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deliveryOssEnabled", value)

    @builtins.property
    @jsii.member(jsii_name="deliveryOssKeyPrefix")
    def delivery_oss_key_prefix(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deliveryOssKeyPrefix"))
    ...
    def delivery_oss_key_prefix(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__823ea12884a9feefa1fff68ae3414e8612061f8fcd8b00d72c17dbafe5894912)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deliveryOssKeyPrefix", value)

    @builtins.property
    @jsii.member(jsii_name="deliverySlsEnabled")
    def delivery_sls_enabled(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: deliverySlsEnabled: Whether to enable the SLS delivery template execution logging feature. Defaults to false.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deliverySlsEnabled"))
    ...
    def delivery_sls_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa731bb0870e059a52b58107bef3d7745736173cfe7b8a24f64648d77470abb1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deliverySlsEnabled", value)

    @builtins.property
    @jsii.member(jsii_name="deliverySlsProjectName")
    def delivery_sls_project_name(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: deliverySlsProjectName: SLS project name.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "deliverySlsProjectName"))
    ...
    def delivery_sls_project_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__710d3446c6af6d4283ad28fcda327c6cd2ca6349e3043c69e5659d6c24c3c95e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deliverySlsProjectName", value)

    @builtins.property
    @jsii.member(jsii_name="rdcEnterpriseId")
    def rdc_enterprise_id(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: rdcEnterpriseId: Enterprise ID.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "rdcEnterpriseId"))

    @rdc_enterprise_id.setter
    def rdc_enterprise_id(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__192982af6e264ced93dcf06bc9a6cd584e0bb058b404a021eab17dee6b8063df)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "rdcEnterpriseId", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.RosServiceSettingsProps",
    jsii_struct_bases=[],
    name_mapping={
        "delivery_oss_bucket_name": "deliveryOssBucketName",
        "delivery_oss_enabled": "deliveryOssEnabled",
        "delivery_oss_key_prefix": "deliveryOssKeyPrefix",
        "delivery_sls_enabled": "deliverySlsEnabled",
        "delivery_sls_project_name": "deliverySlsProjectName",
        "rdc_enterprise_id": "rdcEnterpriseId",
    },
)
class RosServiceSettingsProps:
    def __init__(
        self,
        *,
        delivery_oss_bucket_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        delivery_oss_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        delivery_oss_key_prefix: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        delivery_sls_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        delivery_sls_project_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        rdc_enterprise_id: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    ) -> None:
        '''Properties for defining a ``RosServiceSettings``.

        See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-servicesettings

        :param delivery_oss_bucket_name: 
        :param delivery_oss_enabled: 
        :param delivery_oss_key_prefix: 
        :param delivery_sls_enabled: 
        :param delivery_sls_project_name: 
        :param rdc_enterprise_id: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4315c1ad709e34b10fbdbdfbebaeeac44303001fdfac8c7ed97e3e7c43936e3f)
            check_type(argname="argument delivery_oss_bucket_name", value=delivery_oss_bucket_name, expected_type=type_hints["delivery_oss_bucket_name"])
            check_type(argname="argument delivery_oss_enabled", value=delivery_oss_enabled, expected_type=type_hints["delivery_oss_enabled"])
            check_type(argname="argument delivery_oss_key_prefix", value=delivery_oss_key_prefix, expected_type=type_hints["delivery_oss_key_prefix"])
            check_type(argname="argument delivery_sls_enabled", value=delivery_sls_enabled, expected_type=type_hints["delivery_sls_enabled"])
            check_type(argname="argument delivery_sls_project_name", value=delivery_sls_project_name, expected_type=type_hints["delivery_sls_project_name"])
            check_type(argname="argument rdc_enterprise_id", value=rdc_enterprise_id, expected_type=type_hints["rdc_enterprise_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if delivery_oss_bucket_name is not None:
            self._values["delivery_oss_bucket_name"] = delivery_oss_bucket_name
        if delivery_oss_enabled is not None:
            self._values["delivery_oss_enabled"] = delivery_oss_enabled
        if delivery_oss_key_prefix is not None:
            self._values["delivery_oss_key_prefix"] = delivery_oss_key_prefix
        if delivery_sls_enabled is not None:
            self._values["delivery_sls_enabled"] = delivery_sls_enabled
        if delivery_sls_project_name is not None:
            self._values["delivery_sls_project_name"] = delivery_sls_project_name
        if rdc_enterprise_id is not None:
            self._values["rdc_enterprise_id"] = rdc_enterprise_id
    ...
    def delivery_oss_bucket_name(
        ...
        :Property: deliveryOssBucketName: OSS bucket name.
        '''
        result = self._values.get("delivery_oss_bucket_name")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def delivery_oss_enabled(
        ...
        :Property: deliveryOssEnabled: Whether to enable the OSS delivery template execution logging feature. Defaults to false.
        '''
        result = self._values.get("delivery_oss_enabled")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def delivery_oss_key_prefix(
        ...
        :Property: deliveryOssKeyPrefix: OSS storage space directory, such as "oos/execution", pass "" to indicate that no directory is needed, if set before set again do not need directory can be cleared by passing "".
        '''
        result = self._values.get("delivery_oss_key_prefix")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def delivery_sls_enabled(
        ...
        :Property: deliverySlsEnabled: Whether to enable the SLS delivery template execution logging feature. Defaults to false.
        '''
        result = self._values.get("delivery_sls_enabled")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def delivery_sls_project_name(
        ...
        :Property: deliverySlsProjectName: SLS project name.
        '''
        result = self._values.get("delivery_sls_project_name")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def rdc_enterprise_id(
        ...
        :Property: rdcEnterpriseId: Enterprise ID.
        '''
        result = self._values.get("rdc_enterprise_id")
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], result)
    ...
    def __repr__(self) -> str:
        return "RosServiceSettingsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosTemplate(
    ...
    def ignore_existing(
        ...
        ignoreExisting: Whether to ignore existing template
    ...
    def ignore_existing(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dd4e294d2e1829cd2a8198ca81c265898310aa992706351483d9f214d49e0dfa)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SecretParameterProps:
    def __init__(
        ...
        *,
        ...
        :param secret_parameter_name: Property secretParameterName: The name of the encryption parameter. The name must be 1 to 180 characters in length, and can contain letters, digits, hyphens (-), and underscores (_). It cannot start with ALIYUN, ALIBABA, ALICLOUD, ACS or OOS.
...
@jsii.implements(IServiceSettings)
class ServiceSettings(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.ServiceSettings",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OOS::ServiceSettings``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosServiceSettings``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-servicesettings
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union["ServiceSettingsProps", typing.Dict[builtins.str, typing.Any]]] = None,
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__42b6cd2c7c88a379b5806fe5e3a580dccb832c15c348c2776d5ef974932bfaac)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__80b820705b386b66cc2607e7f69500a2eb9f1bca8f52a1558176dcaecbd5c2dc)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c70b1c79acbdb17267e2a135acfb2f0bd81a82651dbe79d57ca3c8ae9531261b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__516c4a56eb9493bb42e262ee714e66d82b317a85e62bdb1e3fcd714eb0c066c2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-oos.ServiceSettingsProps",
    jsii_struct_bases=[],
    name_mapping={
        "delivery_oss_bucket_name": "deliveryOssBucketName",
        "delivery_oss_enabled": "deliveryOssEnabled",
...
class ServiceSettingsProps:
    def __init__(
        ...
        *,
        ...
        :param delivery_oss_bucket_name: Property deliveryOssBucketName: OSS bucket name.
        :param delivery_oss_enabled: Property deliveryOssEnabled: Whether to enable the OSS delivery template execution logging feature. Defaults to false.
        :param delivery_oss_key_prefix: Property deliveryOssKeyPrefix: OSS storage space directory, such as "oos/execution", pass "" to indicate that no directory is needed, if set before set again do not need directory can be cleared by passing "".
        :param delivery_sls_enabled: Property deliverySlsEnabled: Whether to enable the SLS delivery template execution logging feature. Defaults to false.
        :param delivery_sls_project_name: Property deliverySlsProjectName: SLS project name.
        :param rdc_enterprise_id: Property rdcEnterpriseId: Enterprise ID.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d80effbd687091db79cea73a27102533fd9dd4b5b39ff4898b38fd18055e49a)
            check_type(argname="argument delivery_oss_bucket_name", value=delivery_oss_bucket_name, expected_type=type_hints["delivery_oss_bucket_name"])
            check_type(argname="argument delivery_oss_enabled", value=delivery_oss_enabled, expected_type=type_hints["delivery_oss_enabled"])
            check_type(argname="argument delivery_oss_key_prefix", value=delivery_oss_key_prefix, expected_type=type_hints["delivery_oss_key_prefix"])
            check_type(argname="argument delivery_sls_enabled", value=delivery_sls_enabled, expected_type=type_hints["delivery_sls_enabled"])
    ...
    def __repr__(self) -> str:
        return "ServiceSettingsProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.implements(IStateConfiguration)
...
class TemplateProps:
    def __init__(
        ...
        *,
        ...
        :param template_name: Property templateName: The name of the template. The template name can be up to 200 characters in length. The name can contain letters, digits, hyphens (-), and underscores (_). It cannot start with ACS, ALIYUN, ALIBABA, or ALICLOUD.
...
@jsii.implements(IApplicationConnection)
class ApplicationConnection(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.ApplicationConnection",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OOS::ApplicationConnection``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosApplicationConnection``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnection
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[ApplicationConnectionProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__73804d8f1d6d8c5659583058552305c6a395f56b1d16e79ee195aa5a1562445c)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__24151118db1855f62b27b29d9b1e9796f924b4dbaf0bd0ab48180294a70ba7b3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__07b690230767bac74e12073d5cd9ee8d71b7f43253519cf3aa0b1c555b8c1a12)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__64c5a50594597858b440cdabe598ab8035f35c3203f1ffa35e684c6b80af0ef9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IApplicationConnectionBind)
class ApplicationConnectionBind(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.ApplicationConnectionBind",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OOS::ApplicationConnectionBind``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosApplicationConnectionBind``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnectionbind
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[ApplicationConnectionBindProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__964b1376ce93967cfa383804d4e44a9b7d5681991ed3bc5a61daf5d9187a9958)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c73c1281acf32e0a615512857adb6457dc384d29d3177a367556c07c67e27809)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__922ea7774b506d56899ccdde3f3eb472fa25440db1fe586eb5c8bd5bb5feeb4c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__124b81d80f25f8518f8c001d0bb83c56a0a4993a40860dcdc09d9a4a3e563c73)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IApplicationGroupDeployment)
class ApplicationGroupDeployment(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.ApplicationGroupDeployment",
):
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosApplicationGroupDeployment``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationgroupdeployment
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[ApplicationGroupDeploymentProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8c7d086c16c94c8454f67ae8857042e5c523d82ec8d8cf676f17184b35faab55)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8683ba4e4da5fff325c2222abe5eb59299d7273e31c8fb2226e3fe8c30df9f8a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__349374ace51c83037f67ff5eff0aaf6e440968ff9d945aa3363650439f69d668)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cb5d7a3cff7117bd0f92b69636d042e8543f407d852ba3f653ce388d4cc33e4e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IDefaultPatchBaseline)
...
@jsii.implements(IDeployRevision)
class DeployRevision(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-oos.DeployRevision",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::OOS::DeployRevision``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosDeployRevision``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-deployrevision
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[DeployRevisionProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__962b56dbe3caf9a1eddc6e03e4da756eb2b769e267a94361bb1eace587bdeb1a)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0ed2af7762b5f43139846ab09783a770161b32e73d754642ba11cc4b03b6dd76)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__074ca29664b04726e128f780f1c310ff1be8e3404cb35718de665074d9b98e1a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aab28a6161391de2ea4edcfa8d4aa8cf49de37b18206b9cdc2e29af40c0f8cbd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IExecution)
class Execution(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Optional[typing.Union[ExecutionProps, typing.Dict[builtins.str, typing.Any]]] = None,
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
...
__all__ = [
    ...
    "ApplicationConnectionBindProps",
    "ApplicationConnectionProps",
    "ApplicationGroupDeployment",
    "ApplicationGroupDeploymentProps",
    ...
    "PatchBaseline",
    "PatchBaselineProps",
    "RosApplicationConnection",
    "RosApplicationConnectionBind",
    "RosApplicationConnectionBindProps",
    "RosApplicationConnectionProps",
    "RosApplicationGroupDeployment",
    "RosApplicationGroupDeploymentProps",
    "RosDefaultPatchBaseline",
    "RosDefaultPatchBaselineProps",
    "RosDeployRevision",
    "RosDeployRevisionProps",
    "RosExecution",
    "RosExecutionProps",
    "RosParameter",
    "RosParameterProps",
...
def _typecheckingstub__748ea2e7f5a1a5abf5132e7a812ce345ec7e19cce653bd7f442e677bb71caa7a(
    *,
    connection_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    application_group_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    application_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__18990f96805fa44a2cdb17fbeacadfecc14c513ea379ac205017aa54782bbedb(
    *,
    connection_category: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    connection_type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    env_vars: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosApplicationConnection.EnvVarsProperty, typing.Dict[builtins.str, typing.Any]]]]],
...
def _typecheckingstub__06890f9d91114503a1489d9d1cd21b539e7e76509b720f7e0fabeeab7203a863(
    *,
    application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    deploy_parameters: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__c8967e0544bd07461caa03ee708fe51a4a9d8c2d08970757a072c22190f70ad2(
    *,
    application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    deploy_resource_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__1182d47d4115302666685948f28236cd22db78b510a416d7c0a93d2bde1a04e7(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosApplicationConnectionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__6f7cf5b0c8c4f6b82c1fde5e8e41303f997e4d8e6ce06ef97b0f0c286f156790(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__55c823412fbc02a463923d4b4c2b430179a2918e502fdf0a26735ea3efae2df2(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c059ac3c3072942e6de4fc2309013f2e5aff1bfe1f89ca92cd64a718bb318fa4(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cf2a921f508d9e6d08f73cb7db298227606ba04d13e52f3384ace0a446dfd543(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dc0c7e4ecfffab001e178d1f723df371d08d33ceb1ee84779165624f219d897f(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosApplicationConnection.EnvVarsProperty]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c025c2d33b3f49ec273cf6fdcca5116b4c300dcdcbec3c1bf9c75a324116643a(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1b596d54d74f746a84075123b847ee84867bfbd6f397f9bc56f4c125e0c7513f(
    *,
    key: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
...
def _typecheckingstub__8121ccd5695c71d179d6ea4bb64e5b1f4f8aa1adc3da865cf29ddf65c8dbb8ac(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosApplicationConnectionBindProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__7b619f6c10c47f1f9f7411158cbf1f050dceb247dbcdbef9a874c358f91e88b7(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2534f183535a2a5852385a170cf30cfa195bf1f2471977b514f085e5987185a0(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e95da766ad88d62239a201a09334e02e28de8a911837f094949b1b1441dad205(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3be0961040738c846b4c8c7760c4850cc1dbc5b40eebec2d0ee345e73a47a513(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ae613bc7020829fae03212134707c213515bbd7d938effa92ba0a0620563664e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d9779db8df9cf9117bea50847aea4b3d7a27a0b67078cb2c896f918bb2f9207(
    *,
    connection_ids: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]],
    application_group_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    application_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__4d766b0849d040343444ac806121bbe1a2a80b6356903c7640a2ebc8c6f2828f(
    *,
    connection_category: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    connection_type: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    env_vars: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosApplicationConnection.EnvVarsProperty, typing.Dict[builtins.str, typing.Any]]]]],
...
def _typecheckingstub__02f9d5046c7a1ab20aec512506257d6d9a9601aeb1d53977ef003e5f2c0f65c9(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosApplicationGroupDeploymentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__5176dcd59b5b3ace649a145f4cbbf03df749e8b9fef4d12580dc903967d1b0fb(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f6e71dfd5ae9727f883025c5536e97ee36a99e9a1c4f9bb14bfa1c211abe2b05(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c36ff6d1f11747eb81f524a363595c02af07e214feca9addbac4e913f5dcb816(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4aaa9ed8acf55d036533fef5c146ddeda9336a8503a0e6832989c95a0c726e14(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2ac4f04ba0d6edd30362563f0afc5885452a2d5741d98c4248dd46e3339a24c3(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d57cfedd1a3462e33865b22e32e3c4cb73b078cbbbc1e262c8cd89ca96377ee9(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a1cee09003615e654ee5553ea35d123c1b7c2f0ea776d2c2070416c62d75e850(
    *,
    application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    deploy_parameters: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__724e9e30302a386097149563de7e46c0faa51ca5d14741a89cfbd376472de835(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosDeployRevisionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__96294b47bd22e193c36cad2e60472ead286e9d1942331dcc9b9420e81ad18b9d(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__199140cec6c1f48c642a58854160923e4a75a98d26416a17c396ebe74eadf84c(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4327a399b9201df38c0f6b8fda78bfab822a35a6ff1ebe94fa7216b17445d20a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__701998f09dc9a5c7d413592624ecce7e1d80ed3d689f1966c1ddda3589f10b8c(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0415231d97f9eb8bd8575e77d448256560f4c4312544164b667b0ab74ceb5ed5(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bccab721389b79220441b94232ae88ff5de4cf5f4a8141ae12f8584396cf3c11(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0f09afe25d1084c1165db9d52135b099a5a438242b6a688627b8ce9d85a92e69(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Mapping[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7f3f40e0ef1a0925cb49886d81d8308fc489e16d115eb9242a5fa44f7f7d4f0a(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6d2690a4c5fb914c6051b1d740978df74d4cd85a8199c2dfdb28992165dd21d5(
    *,
    application_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    deploy_resource_type: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__12bc05cf245f1f2e7eed89d3ed85c079f86b554d44860272dedd6571b120ca59(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__ca3c8ead7cf729d511ed72815d3386420eddb69b05928bd728f6ecdf69386485(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__357d98856cca637b6a4bf88dce9fe165ab07072a8cbe1b4bb210011a5e155518(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosServiceSettingsProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__8d36ee02ea7cd5decd739003ede625af2f0c0d70c0b486103fa2adf6d26cbd83(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__0ee95575189075f389e8d4954eb30b08514b985b8bd5d6d22da9d1c1c8214566(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2ab9ddfc99be30dff9629a846e05489ada68b397145ecdc27c09dac70d9b287d(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a932e65adab8b495c507ba1b45d2e5bfe3fc681b9baa4b51b6b82c36a123e10b(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__823ea12884a9feefa1fff68ae3414e8612061f8fcd8b00d72c17dbafe5894912(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fa731bb0870e059a52b58107bef3d7745736173cfe7b8a24f64648d77470abb1(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__710d3446c6af6d4283ad28fcda327c6cd2ca6349e3043c69e5659d6c24c3c95e(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__192982af6e264ced93dcf06bc9a6cd584e0bb058b404a021eab17dee6b8063df(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4315c1ad709e34b10fbdbdfbebaeeac44303001fdfac8c7ed97e3e7c43936e3f(
    *,
    delivery_oss_bucket_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    delivery_oss_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    delivery_oss_key_prefix: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__dd4e294d2e1829cd2a8198ca81c265898310aa992706351483d9f214d49e0dfa(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__42b6cd2c7c88a379b5806fe5e3a580dccb832c15c348c2776d5ef974932bfaac(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Optional[typing.Union[ServiceSettingsProps, typing.Dict[builtins.str, typing.Any]]] = None,
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__80b820705b386b66cc2607e7f69500a2eb9f1bca8f52a1558176dcaecbd5c2dc(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c70b1c79acbdb17267e2a135acfb2f0bd81a82651dbe79d57ca3c8ae9531261b(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__516c4a56eb9493bb42e262ee714e66d82b317a85e62bdb1e3fcd714eb0c066c2(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d80effbd687091db79cea73a27102533fd9dd4b5b39ff4898b38fd18055e49a(
    *,
    delivery_oss_bucket_name: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    delivery_oss_enabled: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
    delivery_oss_key_prefix: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__73804d8f1d6d8c5659583058552305c6a395f56b1d16e79ee195aa5a1562445c(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[ApplicationConnectionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__24151118db1855f62b27b29d9b1e9796f924b4dbaf0bd0ab48180294a70ba7b3(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__07b690230767bac74e12073d5cd9ee8d71b7f43253519cf3aa0b1c555b8c1a12(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__64c5a50594597858b440cdabe598ab8035f35c3203f1ffa35e684c6b80af0ef9(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__964b1376ce93967cfa383804d4e44a9b7d5681991ed3bc5a61daf5d9187a9958(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[ApplicationConnectionBindProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__c73c1281acf32e0a615512857adb6457dc384d29d3177a367556c07c67e27809(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__922ea7774b506d56899ccdde3f3eb472fa25440db1fe586eb5c8bd5bb5feeb4c(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__124b81d80f25f8518f8c001d0bb83c56a0a4993a40860dcdc09d9a4a3e563c73(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__8c7d086c16c94c8454f67ae8857042e5c523d82ec8d8cf676f17184b35faab55(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[ApplicationGroupDeploymentProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__8683ba4e4da5fff325c2222abe5eb59299d7273e31c8fb2226e3fe8c30df9f8a(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__349374ace51c83037f67ff5eff0aaf6e440968ff9d945aa3363650439f69d668(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cb5d7a3cff7117bd0f92b69636d042e8543f407d852ba3f653ce388d4cc33e4e(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__962b56dbe3caf9a1eddc6e03e4da756eb2b769e267a94361bb1eace587bdeb1a(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[DeployRevisionProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__0ed2af7762b5f43139846ab09783a770161b32e73d754642ba11cc4b03b6dd76(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__074ca29664b04726e128f780f1c310ff1be8e3404cb35718de665074d9b98e1a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aab28a6161391de2ea4edcfa8d4aa8cf49de37b18206b9cdc2e29af40c0f8cbd(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
