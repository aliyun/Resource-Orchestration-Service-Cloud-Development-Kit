...
class ApplicationScalingRule(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "ApplicationScalingRuleProps":
        return typing.cast("ApplicationScalingRuleProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "ApplicationScalingRuleProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__221e3b484645b226a148c8a67728c2e7df707bc0006a92c40a939052895185a3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__221e3b484645b226a148c8a67728c2e7df707bc0006a92c40a939052895185a3(
    value: ApplicationScalingRuleProps,
) -> None:
    """Type checking stubs"""
    pass
