...
class Instances(
    ...
    '''This class encapsulates and extends the ROS resource type ``DATASOURCE::KMS::Instances``, which is used to query Key Management Service (KMS) instances that are created within the current Alibaba Cloud account in the current region.
...
class RosInstances(
    ...
    '''This class is a base encapsulation around the ROS resource type ``DATASOURCE::KMS::Instances``, which is used to query Key Management Service (KMS) instances that are created within the current Alibaba Cloud account in the current region.
...
class Secret(
    ...
    def _props(self, value: "SecretProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a14c4cbb449813b7df4f20d22b1ccfb0a39aaa8f28e0ab9ca363523ee5962114)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__a14c4cbb449813b7df4f20d22b1ccfb0a39aaa8f28e0ab9ca363523ee5962114(
    value: SecretProps,
) -> None:
    """Type checking stubs"""
    pass
