...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-sls.AnalyzeProductLogProps",
    jsii_struct_bases=[],
    name_mapping={
...
class AnalyzeProductLogProps:
    def __init__(
        self,
        *,
        cloud_product: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        :param cloud_product: Property cloudProduct: The cloud product name.
        :param logstore: Property logstore: The logstore name.
        :param project: Property project: The project name.
        :param overwrite: Property overwrite: Whether to overwrite the existing analysis rule.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4bc5e99ed75b672d354cbccc5e45f5aa97edd7d9ff0ccf0aabdd6e29c8b5eeeb)
    ...
    def __repr__(self) -> str:
        return "AnalyzeProductLogProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-sls.EtlV2Props",
    jsii_struct_bases=[],
    name_mapping={
        "configuration": "configuration",
        "display_name": "displayName",
...
class EtlV2Props:
    def __init__(
        self,
        *,
        configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosEtlV2.ConfigurationProperty", typing.Dict[builtins.str, typing.Any]]],
        display_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        description: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param configuration: Property configuration: The configuration of the etl job.
        :param display_name: Property displayName: The display name of the etl job.
        :param name: Property name: The name of the etl job.
        :param project: Property project: The name of the project.
        :param description: Property description: The description of the etl job.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c373b736082c1127425028427506ccb6c4f0880ae178ef39190398c0c900b1a6)
            check_type(argname="argument configuration", value=configuration, expected_type=type_hints["configuration"])
            check_type(argname="argument display_name", value=display_name, expected_type=type_hints["display_name"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument project", value=project, expected_type=type_hints["project"])
    ...
    def configuration(
        self,
    ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.ConfigurationProperty"]:
        '''Property configuration: The configuration of the etl job.'''
        result = self._values.get("configuration")
        assert result is not None, "Required property 'configuration' is missing"
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.ConfigurationProperty"], result)
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-sls.IAnalyzeProductLog")
class IAnalyzeProductLog(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``AnalyzeProductLog``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AnalyzeProductLogProps:
        ...


class _IAnalyzeProductLogProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``AnalyzeProductLog``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-sls.IAnalyzeProductLog"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> AnalyzeProductLogProps:
        return typing.cast(AnalyzeProductLogProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IAnalyzeProductLog).__jsii_proxy_class__ = lambda : _IAnalyzeProductLogProxy
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-sls.IEtlV2")
class IEtlV2(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``EtlV2``.'''
...
class _IEtlV2Proxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-sls.IEtlV2"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> EtlV2Props:
        return typing.cast(EtlV2Props, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IEtlV2).__jsii_proxy_class__ = lambda : _IEtlV2Proxy
...
class Index(
    ...
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::SLS::Index``, which is used to create an index for a Simple Log Service (SLS) Logstore.
...
class LogstoreProps:
    def __init__(
        ...
        *,
        ...
        :param ttl: Property ttl: The lifecycle of log in the logstore in days. Allowed Values: 1-3650, default to 30.
        '''
        if __debug__:
...
class RosAnalyzeProductLog(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-sls.RosAnalyzeProductLog",
):
    ...
    This class does not contain additional functions, so it is recommended to use the ``AnalyzeProductLog`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-analyzeproductlog
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosAnalyzeProductLogProps", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9fb2898d803ef5a285395fb8d2af1801b791b8868c937dad6ea7b9186a345b1e)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0c8f51a4e420889ca1f5182d6419743c864e8f38a42061e09f1c1a745fbb2aba)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def cloud_product(
        ...
        :Property: cloudProduct: The cloud product name.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "cloudProduct"))
    ...
    def cloud_product(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5f08b9b5d08367bb2a4783a5192eed55df8e96b22133f2753cc47d53d9a19633)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__40a284efacacf497b607197f6d2b28f157cb5a1b5af8057ffe86862b83efe298)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def logstore(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__151a599c840130442105159b7f5069249e4df3d804beb215ca69b3007130c18e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__62835e0d962fa740532b9d5d672fcb5dfdff17a33e4c2b0a8a41ce8dca47b0e2)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "project", value)
    ...
    def overwrite(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d128e28b15fa89a7809ff3d742225f25bee23634312e37dba99be296e86766de)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "overwrite", value)


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-sls.RosAnalyzeProductLogProps",
    jsii_struct_bases=[],
    name_mapping={
        "cloud_product": "cloudProduct",
        "logstore": "logstore",
...
class RosAnalyzeProductLogProps:
    def __init__(
        self,
        *,
        cloud_product: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__32757c7c72092b6b593c7f98ed97bfc9435ae6f0cfc9d7be115f3820d5261309)
            check_type(argname="argument cloud_product", value=cloud_product, expected_type=type_hints["cloud_product"])
            check_type(argname="argument logstore", value=logstore, expected_type=type_hints["logstore"])
            check_type(argname="argument project", value=project, expected_type=type_hints["project"])
            check_type(argname="argument overwrite", value=overwrite, expected_type=type_hints["overwrite"])
    ...
    def __repr__(self) -> str:
        return "RosAnalyzeProductLogProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosEtlV2(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-sls.RosEtlV2",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::SLS::EtlV2``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``EtlV2`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-etlv2
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union["RosEtlV2Props", typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: builtins.bool,
    ) -> None:
        '''
        :param scope: - scope in which this resource is defined.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6e724eec567945016c532a06d83b9ce317fb667b3e52d695e21d3e911128afa7)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6c5252568d5bd5662630b0d9f22f9df6e3803d8f1dbf89ae30aadb7abc61205)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(typing.Mapping[builtins.str, typing.Any], jsii.invoke(self, "renderProperties", [props]))
    ...
    def configuration(
        ...
        :Property: configuration: The configuration of the etl job.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.ConfigurationProperty"], jsii.get(self, "configuration"))

    @configuration.setter
    def configuration(
        self,
        value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.ConfigurationProperty"],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3c7915075a43bb04c7f1ba82e156bcf67f666355325d343add3b7b97db241a3a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "configuration", value)
    ...
    def display_name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c71b40c0c1f32b9adaa5108dc79f42307d4767e343bd20e42c03b0c9778e9128)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "displayName", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__15c8e8fb761398a955e018ee8fed73812abfe70d9750e6cb6689e91025586725)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def name(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__35321b489ecd3bd04bd5646487a33d1e07e854d1230bef7aeadebd19a013aafb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "name", value)
    ...
    def project(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a675b186a57c1fec5a028fcb6c914d2fe546785e0e42f29f86f6cf459e48cb27)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "project", value)
    ...
    def description(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__69eb9ec4924f9ec309ba47d412707ec781761cac01b6011aba06d117815739f1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "description", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-sls.RosEtlV2.ConfigurationProperty",
        jsii_struct_bases=[],
        name_mapping={
            "logstore": "logstore",
            "role_arn": "roleArn",
    ...
    class ConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            script: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            sinks: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosEtlV2.SinksProperty", typing.Dict[builtins.str, typing.Any]]]]],
            from_time: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__a0ea37be3cae8138b068b08bfdfe1c93ae91b62cdd314706746fe8d01f334c74)
                check_type(argname="argument logstore", value=logstore, expected_type=type_hints["logstore"])
                check_type(argname="argument role_arn", value=role_arn, expected_type=type_hints["role_arn"])
                check_type(argname="argument script", value=script, expected_type=type_hints["script"])
                check_type(argname="argument sinks", value=sinks, expected_type=type_hints["sinks"])
        ...
        def sinks(
            self,
        ) -> typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.SinksProperty"]]]:
            '''
            :Property: sinks: The processing result outputs the target list.
            '''
            result = self._values.get("sinks")
            assert result is not None, "Required property 'sinks' is missing"
            return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosEtlV2.SinksProperty"]]], result)
    ...
    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-sls.RosEtlV2.SinksProperty",
        jsii_struct_bases=[],
        name_mapping={
            "logstore": "logstore",
            "name": "name",
    ...
    class SinksProperty:
        def __init__(
            ...
            *,
            ...
            project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            role_arn: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
            datasets: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Sequence[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]]] = None,
            endpoint: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ) -> None:
            '''
            :param logstore: 
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__52f0f249bf23e4304f72de8d802e16063f5d1f372c684404a5aa47c203b959da)
                check_type(argname="argument logstore", value=logstore, expected_type=type_hints["logstore"])
                check_type(argname="argument name", value=name, expected_type=type_hints["name"])
                check_type(argname="argument project", value=project, expected_type=type_hints["project"])
                check_type(argname="argument role_arn", value=role_arn, expected_type=type_hints["role_arn"])
...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-sls.RosEtlV2Props",
    jsii_struct_bases=[],
    name_mapping={
        "configuration": "configuration",
        "display_name": "displayName",
...
class RosEtlV2Props:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7b2ad9a7821644539cfa911dcd4dbea37fbe16556848e0bea951a055f7dfe8e7)
            check_type(argname="argument configuration", value=configuration, expected_type=type_hints["configuration"])
            check_type(argname="argument display_name", value=display_name, expected_type=type_hints["display_name"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument project", value=project, expected_type=type_hints["project"])
...
class RosIndex(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::SLS::Index``, which is used to create an index for a Simple Log Service (SLS) Logstore.
...
class RosOssExternalStore(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::SLS::OssExternalStore``, which is used to create an Object Storage Service (OSS) external store.
...
class RosProject(
    ...
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::SLS::Project``, which is used to create a Simple Log Service (SLS) project.
...
@jsii.implements(IAnalyzeProductLog)
class AnalyzeProductLog(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-sls.AnalyzeProductLog",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::SLS::AnalyzeProductLog``, which is used to analyze the logs of a cloud service.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosAnalyzeProductLog``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-analyzeproductlog
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[AnalyzeProductLogProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f49e0927570406a2e87c91c1e4179f0ebd845bb440053a253adb5a3b685542b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e128d2781dad3daa085ddb3f503f021f235e58f666ad1995c2c940aba40e6bf7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fcff6cf46ba07bd4ee4747b3b9581a41607cace44b2cd3c4ef4f010a2d8c7d18)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__82323b9a4b2883749c3812f88dcc2e90548a7c0a36a5976621e37ce5648d74c7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
@jsii.implements(IEtlV2)
class EtlV2(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-sls.EtlV2",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::SLS::EtlV2``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosEtlV2``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-etlv2
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[EtlV2Props, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4d542c55f0f343755a8a50b57cb6318380afc08e08da116c487aad6f1a4d382f)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0cfc343a44822db0cd662c7ef57c4a2f605ff71151c58d31ba97d3796087fa8d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__38676f42c78b16960ec52f12f6f486f400603ce8d13dfca58790aa6f3d27ad43)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d20d3963039f307a5aff488f00269510d0efb42e40f54dc9cd3f3e1bdd6c3187)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
__all__ = [
    ...
    "RosAlert",
    "RosAlertProps",
    "RosAnalyzeProductLog",
    "RosAnalyzeProductLogProps",
...
def _typecheckingstub__4bc5e99ed75b672d354cbccc5e45f5aa97edd7d9ff0ccf0aabdd6e29c8b5eeeb(
    *,
    cloud_product: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logstore: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__c373b736082c1127425028427506ccb6c4f0880ae178ef39190398c0c900b1a6(
    *,
    configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosEtlV2.ConfigurationProperty, typing.Dict[builtins.str, typing.Any]]],
    display_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__9fb2898d803ef5a285395fb8d2af1801b791b8868c937dad6ea7b9186a345b1e(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosAnalyzeProductLogProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__0c8f51a4e420889ca1f5182d6419743c864e8f38a42061e09f1c1a745fbb2aba(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5f08b9b5d08367bb2a4783a5192eed55df8e96b22133f2753cc47d53d9a19633(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__40a284efacacf497b607197f6d2b28f157cb5a1b5af8057ffe86862b83efe298(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__151a599c840130442105159b7f5069249e4df3d804beb215ca69b3007130c18e(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__62835e0d962fa740532b9d5d672fcb5dfdff17a33e4c2b0a8a41ce8dca47b0e2(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d128e28b15fa89a7809ff3d742225f25bee23634312e37dba99be296e86766de(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__32757c7c72092b6b593c7f98ed97bfc9435ae6f0cfc9d7be115f3820d5261309(
    *,
    cloud_product: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    logstore: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__6e724eec567945016c532a06d83b9ce317fb667b3e52d695e21d3e911128afa7(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosEtlV2Props, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__f6c5252568d5bd5662630b0d9f22f9df6e3803d8f1dbf89ae30aadb7abc61205(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3c7915075a43bb04c7f1ba82e156bcf67f666355325d343add3b7b97db241a3a(
    value: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosEtlV2.ConfigurationProperty],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__c71b40c0c1f32b9adaa5108dc79f42307d4767e343bd20e42c03b0c9778e9128(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__15c8e8fb761398a955e018ee8fed73812abfe70d9750e6cb6689e91025586725(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__35321b489ecd3bd04bd5646487a33d1e07e854d1230bef7aeadebd19a013aafb(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a675b186a57c1fec5a028fcb6c914d2fe546785e0e42f29f86f6cf459e48cb27(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__69eb9ec4924f9ec309ba47d412707ec781761cac01b6011aba06d117815739f1(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a0ea37be3cae8138b068b08bfdfe1c93ae91b62cdd314706746fe8d01f334c74(
    *,
    logstore: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    role_arn: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    script: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__52f0f249bf23e4304f72de8d802e16063f5d1f372c684404a5aa47c203b959da(
    *,
    logstore: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    project: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__7b2ad9a7821644539cfa911dcd4dbea37fbe16556848e0bea951a055f7dfe8e7(
    *,
    configuration: typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union[RosEtlV2.ConfigurationProperty, typing.Dict[builtins.str, typing.Any]]],
    display_name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    name: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__7f49e0927570406a2e87c91c1e4179f0ebd845bb440053a253adb5a3b685542b(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[AnalyzeProductLogProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__e128d2781dad3daa085ddb3f503f021f235e58f666ad1995c2c940aba40e6bf7(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fcff6cf46ba07bd4ee4747b3b9581a41607cace44b2cd3c4ef4f010a2d8c7d18(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__82323b9a4b2883749c3812f88dcc2e90548a7c0a36a5976621e37ce5648d74c7(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__4d542c55f0f343755a8a50b57cb6318380afc08e08da116c487aad6f1a4d382f(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[EtlV2Props, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__0cfc343a44822db0cd662c7ef57c4a2f605ff71151c58d31ba97d3796087fa8d(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__38676f42c78b16960ec52f12f6f486f400603ce8d13dfca58790aa6f3d27ad43(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d20d3963039f307a5aff488f00269510d0efb42e40f54dc9cd3f3e1bdd6c3187(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
