...
@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IDevice")
class IDevice(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``Device``.'''

    @builtins.property
    @jsii.member(jsii_name="attrDeviceName")
    def attr_device_name(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IDeviceProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IDevice"
    ...
    def attr_device_name(
        ...
        '''Attribute DeviceName: Device name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDeviceName"))
    ...
    def attr_device_secret(
        ...
        '''Attribute DeviceSecret: Device key.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrDeviceSecret"))
    ...
    def attr_iot_id(
        ...
        Description Keep, do not leak.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIotId"))
    ...
    def attr_iot_instance_id(
        ...
        '''Attribute IotInstanceId: IOT instance ID.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrIotInstanceId"))
    ...
    def attr_product_key(
        ...
        '''Attribute ProductKey: Product key.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrProductKey"))
    ...
    def attr_product_name(
        ...
        '''Attribute ProductName: Product name.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrProductName"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DeviceProps:
        return typing.cast(DeviceProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDevice).__jsii_proxy_class__ = lambda : _IDeviceProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IDeviceGroup")
class IDeviceGroup(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> DeviceGroupProps:
        ...


class _IDeviceGroupProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``DeviceGroup``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IDeviceGroup"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> DeviceGroupProps:
        return typing.cast(DeviceGroupProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IDeviceGroup).__jsii_proxy_class__ = lambda : _IDeviceGroupProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IProduct")
class IProduct(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
...
class _IProductProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IProduct"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "ProductProps":
        return typing.cast("ProductProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IProduct).__jsii_proxy_class__ = lambda : _IProductProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IProductTopic")
class IProductTopic(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ProductTopicProps":
        ...


class _IProductTopicProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ProductTopic``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IProductTopic"
    ...
    def attr_topic_id(
        ...
        '''Attribute TopicId: Topic ID.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrTopicId"))

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "ProductTopicProps":
        return typing.cast("ProductTopicProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IProductTopic).__jsii_proxy_class__ = lambda : _IProductTopicProxy


@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IRule")
...
class _IRuleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IRule"
    ...
    def attr_action_id(
        ...
        '''Attribute ActionId: The ID of the rule action.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrActionId"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-iot.IRuleAction")
class IRuleAction(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "RuleActionProps":
        ...


class _IRuleActionProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``RuleAction``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-iot.IRuleAction"
    ...
    @jsii.member(jsii_name="props")
    def props(self) -> "RuleActionProps":
        return typing.cast("RuleActionProps", jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IRuleAction).__jsii_proxy_class__ = lambda : _IRuleActionProxy
...
class Product(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosProduct``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d356f14ad5ac951cc0760a90b8c1a71eeba69b60abf55f026a4ce84ab442f50c)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4ad9a55ed92691e4be62453aa1e41eae4a931a22bf105a8fe7261d8af6d5fbc1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7d66c9e9e37255be04c176f4a0bb734ed2d2ab61bcac5064345b1c50e60f1c38)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.implements(IProductTopic)
class ProductTopic(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-iot.ProductTopic",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::IOT::ProductTopic``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosProductTopic``for a more convenient development experience.
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6db6c9feb68f9c3417ff3ea4c4948492f52f5fa2a930ea8ec7852f3d1c6a1846)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fc9c7f816063d9c6ec1d354611008b40f7a820329842e3db63d71a04955d963f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__71ca40782c93107bcca2c1b8422bf9a59e33e39546881a4624d9eb2bfeb49dfd)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class RosDevice(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Device`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-device
    '''
...
class RosDeviceGroup(
    ...
    This class does not contain additional functions, so it is recommended to use the ``DeviceGroup`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-devicegroup
    '''
...
class RosProduct(
    ...
    This class does not contain additional functions, so it is recommended to use the ``Product`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-product
    '''
...
class RosProductTopic(
    ...
    This class does not contain additional functions, so it is recommended to use the ``ProductTopic`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-producttopic
    '''
...
class RosRuleAction(
    ...
    This class does not contain additional functions, so it is recommended to use the ``RuleAction`` class instead of this class for a more convenient development experience.
...
class Rule(
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__96bb0791624bfa62ccc3519b6dd40c7ad774f7609ddd7c2680b9cb60999924a5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4c7e33805e0ef3e7528fb4cc27c85483ecfc6db4df9f38fc493cc3c5130495f1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__03d4a6330f3f577a53efaa94a135a28465cf2441ec40433ae105a7f453859f48)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IRuleAction)
class RuleAction(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosRuleAction``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-ruleaction
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3ba21c01a337d26b22da0a65be28a4e40080facb7c169aa86ae72952edde9155)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__28065c5abec17fe13ad66f7983f68f91f15bdd611a883dd8f4fbda41b46a785e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__efb69362da89a7d692659ad95f976957973ffc9ef6ba79eb80792f5b7d2353e6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
class Device(
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosDevice``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-device
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__56289ac450cdc1d4cd63a9a3713073d97ccce49f312193f4771e2d21192c4d45)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e1477aa6ed4a7a28ffef2a32ba81b39d5ff321481e307820abca4e8dae96895b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea26b3b755b984d6a2e5afbab2f7d9b9e71cf510004174a4204ea70c120fbb66)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)


@jsii.implements(IDeviceGroup)
class DeviceGroup(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    ...
    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosDeviceGroup``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-iot-devicegroup
    '''
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f6dd6d5d30a2f9110be999505828a8fb5ad97938c1fa2710ff225720863f0ed6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2a3c2e06d4c689822486414630bcf13fc0acfc3b0dccfd57deae66ba5e36a6e3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__243c3cafabbe6b9e88b939bed5ba626a5fd01a74e88afa2b903d1062cbe084aa)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
def _typecheckingstub__d356f14ad5ac951cc0760a90b8c1a71eeba69b60abf55f026a4ce84ab442f50c(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4ad9a55ed92691e4be62453aa1e41eae4a931a22bf105a8fe7261d8af6d5fbc1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7d66c9e9e37255be04c176f4a0bb734ed2d2ab61bcac5064345b1c50e60f1c38(
...
def _typecheckingstub__6db6c9feb68f9c3417ff3ea4c4948492f52f5fa2a930ea8ec7852f3d1c6a1846(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fc9c7f816063d9c6ec1d354611008b40f7a820329842e3db63d71a04955d963f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__71ca40782c93107bcca2c1b8422bf9a59e33e39546881a4624d9eb2bfeb49dfd(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__96bb0791624bfa62ccc3519b6dd40c7ad774f7609ddd7c2680b9cb60999924a5(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4c7e33805e0ef3e7528fb4cc27c85483ecfc6db4df9f38fc493cc3c5130495f1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__03d4a6330f3f577a53efaa94a135a28465cf2441ec40433ae105a7f453859f48(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3ba21c01a337d26b22da0a65be28a4e40080facb7c169aa86ae72952edde9155(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__28065c5abec17fe13ad66f7983f68f91f15bdd611a883dd8f4fbda41b46a785e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__efb69362da89a7d692659ad95f976957973ffc9ef6ba79eb80792f5b7d2353e6(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__56289ac450cdc1d4cd63a9a3713073d97ccce49f312193f4771e2d21192c4d45(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e1477aa6ed4a7a28ffef2a32ba81b39d5ff321481e307820abca4e8dae96895b(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ea26b3b755b984d6a2e5afbab2f7d9b9e71cf510004174a4204ea70c120fbb66(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__f6dd6d5d30a2f9110be999505828a8fb5ad97938c1fa2710ff225720863f0ed6(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2a3c2e06d4c689822486414630bcf13fc0acfc3b0dccfd57deae66ba5e36a6e3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__243c3cafabbe6b9e88b939bed5ba626a5fd01a74e88afa2b903d1062cbe084aa(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
