...
class LogServiceEnable(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(LogServiceEnable, self, [scope, id, props, enable_resource_property_constraint])
...
class RosLogServiceEnable(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(RosLogServiceEnable, self, [scope, id, props, enable_resource_property_constraint])
