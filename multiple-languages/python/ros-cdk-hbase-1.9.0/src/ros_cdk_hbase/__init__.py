...
@jsii.interface(jsii_type="@alicloud/ros-cdk-hbase.ICluster")
class ICluster(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    def attr_ui_proxy_conn_addr_info(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
...
class _IClusterProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-hbase.ICluster"
    ...
    def attr_service_conn_addrs(
        ...
        '''Attribute ServiceConnAddrs: LIST of ServiceConnAddr.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrServiceConnAddrs"))
    ...
    def attr_slb_conn_addrs(
        ...
        '''Attribute SlbConnAddrs: LIST of SlbConnAddr.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrSlbConnAddrs"))
    ...
    def attr_thrift_conn(
        ...
        '''Attribute ThriftConn: Thrift Connection address list.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrThriftConn"))
    ...
    def attr_ui_proxy_conn_addr_info(
        ...
        '''Attribute UiProxyConnAddrInfo: WebUI connection information list.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrUiProxyConnAddrInfo"))
    ...
    def attr_zk_conn_addrs(
        ...
        '''Attribute ZkConnAddrs: List of ZkConnAddr.'''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrZkConnAddrs"))
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-hbase.IMultiZoneCluster")
class IMultiZoneCluster(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> "MultiZoneClusterProps":
        ...


class _IMultiZoneClusterProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``MultiZoneCluster``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-hbase.IMultiZoneCluster"
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IMultiZoneCluster).__jsii_proxy_class__ = lambda : _IMultiZoneClusterProxy


@jsii.implements(IMultiZoneCluster)
...
class RosCluster(
    ...
    def deletion_protection(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3b3dd6cfae76012256dc234c66aea87381b2a937e0fa3bb72c9a273b7a65d8ef)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class RosMultiZoneCluster(
    ...
    def deletion_protection(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3dd3e3d2992485f658eeccdd9681b06fb9463b33b3af53f3e396eda78e678582)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "deletionProtection", value)
...
def _typecheckingstub__3b3dd6cfae76012256dc234c66aea87381b2a937e0fa3bb72c9a273b7a65d8ef(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3dd3e3d2992485f658eeccdd9681b06fb9463b33b3af53f3e396eda78e678582(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
