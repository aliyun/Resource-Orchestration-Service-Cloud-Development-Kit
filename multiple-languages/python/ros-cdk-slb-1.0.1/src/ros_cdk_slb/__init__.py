...
class LoadBalancerProps:
    def __init__(
        ...
        *,
        ...
        :param duration: Property duration: Optional. The subscription duration of a Subscription Internet instance. Valid values: If PricingCycle is month, the valid range is 1 to 9 or 12, 24, 36. If PricingCycle is year, the value range is 1 to 3.
