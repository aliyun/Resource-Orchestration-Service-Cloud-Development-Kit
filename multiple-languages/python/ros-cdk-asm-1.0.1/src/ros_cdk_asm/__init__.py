...
class RosServiceMesh(
    ...
    def __init__(
        ...
        '''
        jsii.create(RosServiceMesh, self, [scope, id, props, enable_resource_property_constraint])
...
class ServiceMesh(
    ...
    def __init__(
        ...
        :param enable_resource_property_constraint: -
        '''
        jsii.create(ServiceMesh, self, [scope, id, props, enable_resource_property_constraint])
