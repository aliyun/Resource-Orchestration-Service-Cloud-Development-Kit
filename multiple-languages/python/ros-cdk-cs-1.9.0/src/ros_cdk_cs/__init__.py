...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "namespace": "namespace",
        "namespace_deletion": "namespaceDeletion",
        "role_policy": "rolePolicy",
        "validation_mode": "validationMode",
        "wait_until": "waitUntil",
    },
...
class ClusterHelmApplicationProps:
    def __init__(
        ...
        *,
        ...
        namespace_deletion: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        role_policy: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        validation_mode: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param namespace_deletion: Property namespaceDeletion: Whether to delete the namespace specified. If Namespace is in ('default', 'kube-node-lease', 'kube-public', 'kube-system', 'arms-prom'), no matter whether NamespaceDeletion is true or not, it will not be deleted.
        :param role_policy: Property rolePolicy: Before deploying the application, check the policies associated with the roles of the current user. Valid values: - EnsureAdminRoleAndBinding: Automatically create a role named "ros:application-admin:${user-id}" with administrator permissions and bind it to the current user. - None: Do nothing. The default value is EnsureAdminRoleAndBinding.
        :param validation_mode: Property validationMode: Validation modes include: - Basic: basic validation, such as verifying the existence of a cluster. - Strict: in addition to basic validation, also validate the legality of WaitUntil.
        :param wait_until: Property waitUntil: After starting a creation or update, wait until all conditions are met.
        '''
        if __debug__:
            ...
            check_type(argname="argument namespace", value=namespace, expected_type=type_hints["namespace"])
            check_type(argname="argument namespace_deletion", value=namespace_deletion, expected_type=type_hints["namespace_deletion"])
            check_type(argname="argument role_policy", value=role_policy, expected_type=type_hints["role_policy"])
            check_type(argname="argument validation_mode", value=validation_mode, expected_type=type_hints["validation_mode"])
            check_type(argname="argument wait_until", value=wait_until, expected_type=type_hints["wait_until"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
        ...
        if namespace_deletion is not None:
            self._values["namespace_deletion"] = namespace_deletion
        if role_policy is not None:
            self._values["role_policy"] = role_policy
        if validation_mode is not None:
            self._values["validation_mode"] = validation_mode
    ...
    def namespace_deletion(
        ...
        '''
        result = self._values.get("namespace_deletion")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], result)
...
class RosClusterHelmApplication(
    ...
    @builtins.property
    @jsii.member(jsii_name="namespaceDeletion")
    def namespace_deletion(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "namespaceDeletion"))

    @namespace_deletion.setter
    def namespace_deletion(
        self,
        value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5befafe355393ebd81a0eb554f4e655c0fc4dfd787121a362e0f3b402924ad0e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "namespaceDeletion", value)
...
class RosManagedKubernetesCluster(
    ...
    def v_switch_ids(
        ...
        :Property: vSwitchIds: The virtual switch ID of the worker node.
        '''
        return typing.cast(typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.List[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]], jsii.get(self, "vSwitchIds"))
...
def _typecheckingstub__5befafe355393ebd81a0eb554f4e655c0fc4dfd787121a362e0f3b402924ad0e(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
