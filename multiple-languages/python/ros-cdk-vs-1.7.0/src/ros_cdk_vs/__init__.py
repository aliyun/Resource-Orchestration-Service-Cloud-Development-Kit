...
@jsii.interface(jsii_type="@alicloud/ros-cdk-vs.IGroup")
...
class _IGroupProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-vs.IGroup"
    ...
    def attr_gb_id(
        ...
        (Applies only to access the space marked States)
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrGbId"))
    ...
    def attr_gb_ip(
        ...
        (Applies only to access the space marked States)
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrGbIp"))
    ...
    def attr_gb_port(
        ...
        (Applies only to access the space marked States)
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "attrGbPort"))
