...
@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-acs.ApplicationPodProps",
    jsii_struct_bases=[],
    name_mapping={
        ...
        "gpu_core_number": "gpuCoreNumber",
        "gpu_model_series": "gpuModelSeries",
        "gpu_type": "gpuType",
        "replicas": "replicas",
        "zone_id": "zoneId",
    },
)
class ApplicationPodProps:
    def __init__(
        self,
        *,
        compute_class: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        compute_qos: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        cpu_core_number: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
        ...
        disk_config: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, typing.Union["RosApplicationPod.DiskConfigProperty", typing.Dict[builtins.str, typing.Any]]]] = None,
        gpu_core_number: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        gpu_model_series: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
        ...
        :param compute_class: Property computeClass: Compute class of the application pod.
        :param compute_qos: Property computeQos: Compute QoS of the application pod.
        :param cpu_core_number: Property cpuCoreNumber: CPU core number required by the container.
        :param image: Property image: Container image for the application pod.
        :param kind: Property kind: Kind of the application pod (Job, CronJob, Deployment, StatefulSet).
        :param memory: Property memory: Memory size (in GB) required by the container.
        :param disk_config: Property diskConfig: Disk configurations for the application pod.
        :param gpu_core_number: Property gpuCoreNumber: GPU core number, if using GPU.
        :param gpu_model_series: Property gpuModelSeries: GPU model series, if using GPU.
        :param gpu_type: Property gpuType: GPU type, default is nvidia.com/gpu.
        :param replicas: Property replicas: Number of replicas for Deployment or StatefulSet.
        :param zone_id: Property zoneId: Zone ID for the application pod.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ed4cad489545566b1585baadf6fbe6ba3f563fe720e88babcec8e258128a722a)
            ...
            check_type(argname="argument cpu_core_number", value=cpu_core_number, expected_type=type_hints["cpu_core_number"])
            ...
            check_type(argname="argument gpu_core_number", value=gpu_core_number, expected_type=type_hints["gpu_core_number"])
            check_type(argname="argument gpu_model_series", value=gpu_model_series, expected_type=type_hints["gpu_model_series"])
        ...
        if gpu_core_number is not None:
            self._values["gpu_core_number"] = gpu_core_number
        if gpu_model_series is not None:
            self._values["gpu_model_series"] = gpu_model_series
    ...
    def compute_class(
        ...
        assert result is not None, "Required property 'compute_class' is missing"
    ...
    def compute_qos(
        ...
        assert result is not None, "Required property 'compute_qos' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)
    ...
    def cpu_core_number(
        ...
        result = self._values.get("cpu_core_number")
        assert result is not None, "Required property 'cpu_core_number' is missing"
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], result)

    @builtins.property
    def image(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
    ...
    def disk_config(
        self,
    ) -> typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationPod.DiskConfigProperty"]]:
        '''Property diskConfig: Disk configurations for the application pod.'''
        result = self._values.get("disk_config")
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationPod.DiskConfigProperty"]], result)
    ...
    def gpu_core_number(
        ...
        result = self._values.get("gpu_core_number")
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], result)

    @builtins.property
    def gpu_model_series(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''Property gpuModelSeries: GPU model series, if using GPU.'''
        result = self._values.get("gpu_model_series")
    ...
    def __repr__(self) -> str:
        return "ApplicationPodProps(%s)" % ", ".join(
...
@jsii.interface(jsii_type="@alicloud/ros-cdk-acs.IApplicationPod")
class IApplicationPod(_ros_cdk_core_7adfd82f.IResource, typing_extensions.Protocol):
    '''Represents a ``ApplicationPod``.'''

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationPodProps:
        ...


class _IApplicationPodProxy(
    jsii.proxy_for(_ros_cdk_core_7adfd82f.IResource), # type: ignore[misc]
):
    '''Represents a ``ApplicationPod``.'''

    __jsii_type__: typing.ClassVar[str] = "@alicloud/ros-cdk-acs.IApplicationPod"

    @builtins.property
    @jsii.member(jsii_name="props")
    def props(self) -> ApplicationPodProps:
        return typing.cast(ApplicationPodProps, jsii.get(self, "props"))

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IApplicationPod).__jsii_proxy_class__ = lambda : _IApplicationPodProxy
...
class RosApplicationPod(
    _ros_cdk_core_7adfd82f.RosResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-acs.RosApplicationPod",
):
    '''This class is a base encapsulation around the ROS resource type ``ALIYUN::ACS::ApplicationPod``.

    :Note:

    This class does not contain additional functions, so it is recommended to use the ``ApplicationPod`` class instead of this class for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-acs-applicationpod
    '''
    ...
    def __init__(
        ...
        id: builtins.str,
        props: typing.Union["RosApplicationPodProps", typing.Dict[builtins.str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a7d45f5cdc3ffa91d54f90c6d49e3014a44c3f002356df16d021ef74c7689df7)
    ...
    def _render_properties(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b2b2feb71d00562d049c9001addf2b1d8c50f06658883767b9bd1edfcc2b144c)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def compute_class(
        ...
        :Property: computeClass: Compute class of the application pod.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "computeClass"))
    ...
    def compute_class(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f4a70d9b0ba990d38d6efa47dcb77088524659c0ee98ec5cdbd60c1d39c9863d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "computeClass", value)

    @builtins.property
    @jsii.member(jsii_name="computeQos")
    def compute_qos(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: computeQos: Compute QoS of the application pod.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "computeQos"))
    ...
    def compute_qos(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b1e88276da2be86f00e5a95dd9f957afe7e10d0d763b9af61ea50448345d074e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "computeQos", value)

    @builtins.property
    @jsii.member(jsii_name="cpuCoreNumber")
    def cpu_core_number(
        self,
    ) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        '''
        :Property: cpuCoreNumber: CPU core number required by the container.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "cpuCoreNumber"))

    @cpu_core_number.setter
    def cpu_core_number(
        self,
        value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__27a0c4156c9ad5ef1ef545a0f22cd113261463d81fd99a17b66ac16d6fd4ebb5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cpuCoreNumber", value)
    ...
    def enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__669a0136a50916357ae5f68bfcc98316d2287a59ce9210a80c9679d466ef9430)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def image(self) -> typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]:
        ...
        :Property: image: Container image for the application pod.
        '''
        return typing.cast(typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable], jsii.get(self, "image"))
    ...
    def image(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e17ac63b599df39998baa3e346adde64aa9ab30b6d92195a533c74f855455b01)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def kind(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ed66f89b6f8e3dc0b7a9f70ab10529e99f5581e1244d24249130b620370fe4d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def memory(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3eafa4aac3b7b2ef1371cbcc73f0e7f771eba6bb3b560b09452f5397722a2a9e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def disk_config(
        ...
        :Property: diskConfig: Disk configurations for the application pod.
        '''
        return typing.cast(typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationPod.DiskConfigProperty"]], jsii.get(self, "diskConfig"))

    @disk_config.setter
    def disk_config(
        self,
        value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, "RosApplicationPod.DiskConfigProperty"]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cf278ed8e0b054406f5876b91f1cd20175726fedc387ea2e37c2d63ca00c2458)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "diskConfig", value)

    @builtins.property
    @jsii.member(jsii_name="gpuCoreNumber")
    def gpu_core_number(
        self,
    ) -> typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: gpuCoreNumber: GPU core number, if using GPU.
        '''
        return typing.cast(typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "gpuCoreNumber"))

    @gpu_core_number.setter
    def gpu_core_number(
        self,
        value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__621e287a135381786aab9589fb475b53e704271e72d95c306b18d5ffa4a48558)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "gpuCoreNumber", value)

    @builtins.property
    @jsii.member(jsii_name="gpuModelSeries")
    def gpu_model_series(
        self,
    ) -> typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]]:
        '''
        :Property: gpuModelSeries: GPU model series, if using GPU.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "gpuModelSeries"))

    @gpu_model_series.setter
    def gpu_model_series(
        self,
        value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d4dd674cd47e7f4f8f97c921800885864ec6249f178676989f04b3f673444311)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "gpuModelSeries", value)
    ...
    def gpu_type(
        ...
        :Property: gpuType: GPU type, default is nvidia.com/gpu.
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]], jsii.get(self, "gpuType"))
    ...
    def gpu_type(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__65b2d7416f658fa0c99283728650795446842ce0cec25f88b8e7df1fcc1ef088)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "gpuType", value)
    ...
    def replicas(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2b5a7629f4e38bbe51849b1b08e4341c8432038d0d10889825fe38bcc7c1f8ad)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def zone_id(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aad41aac7dc201d5cb4c643aef388f4eea6e7e8117591ae0e638670769bff5d0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "zoneId", value)

    @jsii.data_type(
        jsii_type="@alicloud/ros-cdk-acs.RosApplicationPod.DiskConfigProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class DiskConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                type_hints = typing.get_type_hints(_typecheckingstub__3914d16915d6ed714e5b423266922127b133f2bc0915d08ff2001ee6e9cf2b21)
        ...
        def __repr__(self) -> str:
            return "DiskConfigProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )


@jsii.data_type(
    jsii_type="@alicloud/ros-cdk-acs.RosApplicationPodProps",
    jsii_struct_bases=[],
    name_mapping={
        "compute_class": "computeClass",
        "compute_qos": "computeQos",
...
class RosApplicationPodProps:
    def __init__(
        ...
        *,
        ...
        :param compute_class: 
        :param compute_qos: 
        :param cpu_core_number: 
        :param image: 
        :param kind: 
        :param memory: 
        :param disk_config: 
        :param gpu_core_number: 
        :param gpu_model_series: 
        :param gpu_type: 
        :param replicas: 
        :param zone_id: 
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__33ed55e52ad6a0c1945f367354739a9e63e4372af73f1132c2afd55311a7efb1)
            check_type(argname="argument compute_class", value=compute_class, expected_type=type_hints["compute_class"])
            check_type(argname="argument compute_qos", value=compute_qos, expected_type=type_hints["compute_qos"])
            check_type(argname="argument cpu_core_number", value=cpu_core_number, expected_type=type_hints["cpu_core_number"])
            check_type(argname="argument image", value=image, expected_type=type_hints["image"])
    ...
    def __repr__(self) -> str:
        return "RosApplicationPodProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class RosCluster(
    ...
    def is_enterprise_security_group(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9a956942cf4add0fd887baf3b174e6a6c3ea7351db9514fc8d267f095a858761)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.implements(IApplicationPod)
class ApplicationPod(
    _ros_cdk_core_7adfd82f.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@alicloud/ros-cdk-acs.ApplicationPod",
):
    '''This class encapsulates and extends the ROS resource type ``ALIYUN::ACS::ApplicationPod``.

    :Note:

    This class may have some new functions to facilitate development, so it is recommended to use this class instead of ``RosApplicationPod``for a more convenient development experience.
    See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-acs-applicationpod
    '''
    ...
    def __init__(
        ...
        scope: _ros_cdk_core_7adfd82f.Construct,
        id: builtins.str,
        props: typing.Union[ApplicationPodProps, typing.Dict[builtins.str, typing.Any]],
        enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fee2e0c0fe4934cab359e79f9044461641a05f6a02b1cc455cbc59eb8ba7e6f4)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
            check_type(argname="argument enable_resource_property_constraint", value=enable_resource_property_constraint, expected_type=type_hints["enable_resource_property_constraint"])
    ...
    def _enable_resource_property_constraint(self, value: builtins.bool) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a8c815cbf98ff5588ea4f01e87319cb3031de00c506f054b60d724c2ee2d9f04)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enableResourcePropertyConstraint", value)
    ...
    def _id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__04ab3b06a5aee6a13f8bb24992e862c0a90aa9139ac770742fc72f68d0591331)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)
    ...
    def _scope(self, value: _ros_cdk_core_7adfd82f.Construct) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4cbb2a4e6aa6ec9d63dcc8bae02cabdadac282fd4d72779805c601633f0d5744)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "scope", value)
...
def _typecheckingstub__ed4cad489545566b1585baadf6fbe6ba3f563fe720e88babcec8e258128a722a(
    *,
    compute_class: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    compute_qos: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    cpu_core_number: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__a7d45f5cdc3ffa91d54f90c6d49e3014a44c3f002356df16d021ef74c7689df7(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[RosApplicationPodProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: builtins.bool,
...
def _typecheckingstub__b2b2feb71d00562d049c9001addf2b1d8c50f06658883767b9bd1edfcc2b144c(
    props: typing.Mapping[builtins.str, typing.Any],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f4a70d9b0ba990d38d6efa47dcb77088524659c0ee98ec5cdbd60c1d39c9863d(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__b1e88276da2be86f00e5a95dd9f957afe7e10d0d763b9af61ea50448345d074e(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__27a0c4156c9ad5ef1ef545a0f22cd113261463d81fd99a17b66ac16d6fd4ebb5(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__669a0136a50916357ae5f68bfcc98316d2287a59ce9210a80c9679d466ef9430(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e17ac63b599df39998baa3e346adde64aa9ab30b6d92195a533c74f855455b01(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5ed66f89b6f8e3dc0b7a9f70ab10529e99f5581e1244d24249130b620370fe4d(
    value: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3eafa4aac3b7b2ef1371cbcc73f0e7f771eba6bb3b560b09452f5397722a2a9e(
    value: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__cf278ed8e0b054406f5876b91f1cd20175726fedc387ea2e37c2d63ca00c2458(
    value: typing.Optional[typing.Union[_ros_cdk_core_7adfd82f.IResolvable, RosApplicationPod.DiskConfigProperty]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__621e287a135381786aab9589fb475b53e704271e72d95c306b18d5ffa4a48558(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__d4dd674cd47e7f4f8f97c921800885864ec6249f178676989f04b3f673444311(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__65b2d7416f658fa0c99283728650795446842ce0cec25f88b8e7df1fcc1ef088(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__2b5a7629f4e38bbe51849b1b08e4341c8432038d0d10889825fe38bcc7c1f8ad(
    value: typing.Optional[typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aad41aac7dc201d5cb4c643aef388f4eea6e7e8117591ae0e638670769bff5d0(
    value: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3914d16915d6ed714e5b423266922127b133f2bc0915d08ff2001ee6e9cf2b21(
    *,
    disk_category: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    size: typing.Union[jsii.Number, _ros_cdk_core_7adfd82f.IResolvable],
    performance_level: typing.Optional[typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable]] = None,
...
def _typecheckingstub__33ed55e52ad6a0c1945f367354739a9e63e4372af73f1132c2afd55311a7efb1(
    *,
    compute_class: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    compute_qos: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
    cpu_core_number: typing.Union[builtins.str, _ros_cdk_core_7adfd82f.IResolvable],
...
def _typecheckingstub__9a956942cf4add0fd887baf3b174e6a6c3ea7351db9514fc8d267f095a858761(
    value: typing.Optional[typing.Union[builtins.bool, _ros_cdk_core_7adfd82f.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__fee2e0c0fe4934cab359e79f9044461641a05f6a02b1cc455cbc59eb8ba7e6f4(
    scope: _ros_cdk_core_7adfd82f.Construct,
    id: builtins.str,
    props: typing.Union[ApplicationPodProps, typing.Dict[builtins.str, typing.Any]],
    enable_resource_property_constraint: typing.Optional[builtins.bool] = None,
...
def _typecheckingstub__a8c815cbf98ff5588ea4f01e87319cb3031de00c506f054b60d724c2ee2d9f04(
    value: builtins.bool,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__04ab3b06a5aee6a13f8bb24992e862c0a90aa9139ac770742fc72f68d0591331(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__4cbb2a4e6aa6ec9d63dcc8bae02cabdadac282fd4d72779805c601633f0d5744(
    value: _ros_cdk_core_7adfd82f.Construct,
) -> None:
    """Type checking stubs"""
    pass
