...
class DeliverTask(
    ...
    @builtins.property
    @jsii.member(jsii_name="props")
    def _props(self) -> "DeliverTaskProps":
        return typing.cast("DeliverTaskProps", jsii.get(self, "props"))

    @_props.setter
    def _props(self, value: "DeliverTaskProps") -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__032dc1460cdd2eb447486f605e6a6d27abad3a2ba8d67324a0a6641c43c7302e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "props", value)
...
def _typecheckingstub__032dc1460cdd2eb447486f605e6a6d27abad3a2ba8d67324a0a6641c43c7302e(
    value: DeliverTaskProps,
) -> None:
    """Type checking stubs"""
    pass
