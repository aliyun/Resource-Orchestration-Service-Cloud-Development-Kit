...
namespace AlibabaCloud.SDK.ROS.CDK.Acm.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(INamespaces), fullyQualifiedName: "@alicloud/ros-cdk-acm.datasource.INamespaces")]
    public interface INamespaces : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Acm.Datasource.INamespacesProps Props
        {
            get;
        }

        /// <summary>Represents a `Namespaces`.</summary>
        [JsiiTypeProxy(nativeType: typeof(INamespaces), fullyQualifiedName: "@alicloud/ros-cdk-acm.datasource.INamespaces")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Acm.Datasource.INamespaces
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-acm.datasource.NamespacesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Acm.Datasource.INamespacesProps Props
            {
