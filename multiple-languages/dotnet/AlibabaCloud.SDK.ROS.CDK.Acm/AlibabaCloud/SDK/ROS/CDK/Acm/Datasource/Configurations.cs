...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ACM::Configurations`.</summary>
    /// <remarks>
    ...
    public class Configurations : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Acm.Datasource.IConfigurations
    {
        ...
        public virtual object AttrConfigurations
        {
        ...
        public virtual object AttrDataIds
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-acm.datasource.ConfigurationsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Acm.Datasource.IConfigurationsProps Props
        {
