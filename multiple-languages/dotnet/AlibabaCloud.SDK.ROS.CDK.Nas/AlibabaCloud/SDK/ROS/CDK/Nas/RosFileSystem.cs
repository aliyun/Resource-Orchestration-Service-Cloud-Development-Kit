...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::NAS::FileSystem`, which is used to create a file system in Apsara File Storage NAS (NAS).</summary>
    /// <remarks>
    ...
    public class RosFileSystem : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosFileSystem(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IRosFileSystemProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IRosFileSystemProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: protocolType: Type of protocol used. Valid values: NFS, SMB, cpfs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: fileSystemType: File system type. Allowed values: standard(default), extreme, cpfs
        /// </remarks>
        [JsiiOptional]
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Nas.RosFileSystem.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-nas.RosFileSystem.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-nas.RosFileSystem.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Nas.RosFileSystem.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-nas.RosFileSystem.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Nas.RosFileSystem.ITagsProperty
        {
            private object _key;
