...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::NAS::MountTarget`You can use the , which resource to create a mount target.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `MountTarget` class instead of this class for a more convenient development experience.
    ...
    public class RosMountTarget : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosMountTarget(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IRosMountTargetProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IRosMountTargetProps props, bool enableResourcePropertyConstraint)
        {
