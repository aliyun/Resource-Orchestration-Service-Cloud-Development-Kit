...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NAS::AccessGroup`, which is used to create a permission group.</summary>
    /// <remarks>
    ...
    public class AccessGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        public AccessGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IAccessGroupProps props, bool? enableResourcePropertyConstraint = null): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Nas.IAccessGroupProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Nas.IAccessGroupProps Props
        {
