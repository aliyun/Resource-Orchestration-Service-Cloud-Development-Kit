...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::NAS::AccessGroups`, which is used to query the details of permission groups.</summary>
    /// <remarks>
    ...
    public class AccessGroups : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Nas.Datasource.IAccessGroupsProps Props
        {
