...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NAS::MountTarget`You can use the , which resource to create a mount target.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosMountTarget`for a more convenient development experience.
    ...
    public class MountTarget : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Nas.IMountTarget
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Nas.IMountTargetProps Props
        {
