...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ARMS::XTraceApps`, which is used to query all the application monitoring tasks in a region.</summary>
    /// <remarks>
