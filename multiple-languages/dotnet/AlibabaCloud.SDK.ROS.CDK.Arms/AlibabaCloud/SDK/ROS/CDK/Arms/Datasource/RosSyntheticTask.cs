...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::ARMS::SyntheticTask`, which is used to query the information about a scheduled synthetic monitoring task.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `SyntheticTask` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-arms-synthetictask
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.RosSyntheticTask), fullyQualifiedName: "@alicloud/ros-cdk-arms.datasource.RosSyntheticTask", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-arms.datasource.RosSyntheticTaskProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosSyntheticTask : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosSyntheticTask(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IRosSyntheticTaskProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IRosSyntheticTaskProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosSyntheticTask(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosSyntheticTask(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.RosSyntheticTask))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AvailableAssertions: The list of assertions.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CommonSetting: The general settings.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CustomPeriod: The custom cycle.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Frequency: The detection frequency.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MonitorCategory: The detection point type. 1: PC. 2: mobile device.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MonitorConf: The monitoring configurations.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Monitors: The list of monitoring points.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SyntheticTaskName: The name of synthetic task.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TaskId: The ID of the synthetic monitoring task.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TaskType: The type of the task.
        /// </remarks>
