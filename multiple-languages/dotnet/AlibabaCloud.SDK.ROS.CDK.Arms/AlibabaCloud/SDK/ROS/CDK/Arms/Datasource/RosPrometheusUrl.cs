...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::ARMS::PrometheusUrl`, which is used to query all URLs of a cluster, including the URLs for remote read, remote write, Pushgateway, and Grafana.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `PrometheusUrl` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-arms-prometheusurl
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.RosPrometheusUrl), fullyQualifiedName: "@alicloud/ros-cdk-arms.datasource.RosPrometheusUrl", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-arms.datasource.RosPrometheusUrlProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosPrometheusUrl : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosPrometheusUrl(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IRosPrometheusUrlProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IRosPrometheusUrlProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosPrometheusUrl(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosPrometheusUrl(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.RosPrometheusUrl))!;
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: GrafanaUrl: Internal HTTP API URL (Grafana read URL).
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetGrafanaUrl: Internet HTTP API URL (Grafana read URL).
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetOpenTelemetryUrl: Internet OpenTelemetry URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetPushGatewayUrl: Internet push gateway URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetRemoteReadUrl: Internet remote read URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetRemoteWriteUrl: Internet remote write URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: OpenTelemetryUrl: Internal OpenTelemetry URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PushGatewayUrl: Internal push gateway URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RemoteReadUrl: Internal remote read URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RemoteWriteUrl: Internal remote write URL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Token: The token for Grafana read URL.
        /// </remarks>
