...
namespace AlibabaCloud.SDK.ROS.CDK.Arms.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IEnvironments), fullyQualifiedName: "@alicloud/ros-cdk-arms.datasource.IEnvironments")]
    public interface IEnvironments : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IEnvironmentsProps Props
        {
            get;
        }

        /// <summary>Represents a `Environments`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEnvironments), fullyQualifiedName: "@alicloud/ros-cdk-arms.datasource.IEnvironments")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IEnvironments
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-arms.datasource.EnvironmentsProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IEnvironmentsProps Props
            {
