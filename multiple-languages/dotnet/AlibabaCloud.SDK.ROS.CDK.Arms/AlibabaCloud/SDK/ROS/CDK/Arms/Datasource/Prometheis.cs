...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ARMS::Prometheis`.</summary>
    /// <remarks>
    ...
    public class Prometheis : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IPrometheis
    {
        ...
        public virtual object AttrPrometheis
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-arms.datasource.PrometheisProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Arms.Datasource.IPrometheisProps Props
        {
