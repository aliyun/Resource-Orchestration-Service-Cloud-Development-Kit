...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ARMS::AlertContact`, which is used to create an alert contact.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosAlertContact`for a more convenient development experience.
    ...
    public class AlertContact : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Arms.IAlertContact
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Arms.IAlertContactProps Props
        {
