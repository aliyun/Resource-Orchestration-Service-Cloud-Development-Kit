...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ThreatDetection::Instance`, which is used to purchase Security Center (SAS).</summary>
    /// <remarks>
