...
namespace AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IAntiBruteForceRule), fullyQualifiedName: "@alicloud/ros-cdk-threatdetection.datasource.IAntiBruteForceRule")]
    public interface IAntiBruteForceRule : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IAntiBruteForceRuleProps Props
        {
            get;
        }

        /// <summary>Represents a `AntiBruteForceRule`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAntiBruteForceRule), fullyQualifiedName: "@alicloud/ros-cdk-threatdetection.datasource.IAntiBruteForceRule")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IAntiBruteForceRule
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-threatdetection.datasource.AntiBruteForceRuleProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IAntiBruteForceRuleProps Props
            {
