...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ThreatDetection::Instances`, which is used to query the basic information about instances in Security Center.</summary>
    /// <remarks>
    ...
    public class Instances : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IInstances
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-threatdetection.datasource.InstancesProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IInstancesProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IInstancesProps>()!;
        }
