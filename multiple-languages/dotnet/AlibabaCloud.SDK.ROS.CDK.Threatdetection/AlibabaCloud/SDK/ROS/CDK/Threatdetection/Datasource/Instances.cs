...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ThreatDetection::Instances`, which is used to query the basic information about instances in Security Center (SAS).</summary>
    /// <remarks>
    ...
    public class Instances : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Threatdetection.Datasource.IInstancesProps Props
        {
