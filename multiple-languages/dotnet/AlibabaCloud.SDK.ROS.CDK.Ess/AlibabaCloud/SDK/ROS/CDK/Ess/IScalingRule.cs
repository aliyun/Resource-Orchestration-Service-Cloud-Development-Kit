...
namespace AlibabaCloud.SDK.ROS.CDK.Ess
{
    ...
    [JsiiInterface(nativeType: typeof(IScalingRule), fullyQualifiedName: "@alicloud/ros-cdk-ess.IScalingRule")]
    public interface IScalingRule : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ess.IScalingRuleProps Props
        {
            get;
        }

        /// <summary>Represents a `ScalingRule`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IScalingRule), fullyQualifiedName: "@alicloud/ros-cdk-ess.IScalingRule")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ess.IScalingRule
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ess.ScalingRuleProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ess.IScalingRuleProps Props
            {
