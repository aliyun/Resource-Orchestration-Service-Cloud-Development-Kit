...
{
    /// <summary>Represents a `ScalingConfiguration`.</summary>
    [JsiiInterface(nativeType: typeof(IScalingConfiguration), fullyQualifiedName: "@alicloud/ros-cdk-ess.IScalingConfiguration")]
    public interface IScalingConfiguration : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ess.IScalingConfigurationProps Props
        {
            get;
        }

        /// <summary>Represents a `ScalingConfiguration`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IScalingConfiguration), fullyQualifiedName: "@alicloud/ros-cdk-ess.IScalingConfiguration")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ess.IScalingConfiguration
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ess.ScalingConfigurationProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ess.IScalingConfigurationProps Props
            {
