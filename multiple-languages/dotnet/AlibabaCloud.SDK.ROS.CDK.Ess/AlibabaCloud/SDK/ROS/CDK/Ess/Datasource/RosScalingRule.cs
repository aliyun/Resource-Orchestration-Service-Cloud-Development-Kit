...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::ESS::ScalingRule`, which is used to query the information about a scaling rule.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Ess.Datasource.RosScalingRule), fullyQualifiedName: "@alicloud/ros-cdk-ess.datasource.RosScalingRule", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-ess.datasource.RosScalingRuleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosScalingRule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosScalingRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ess.Datasource.IRosScalingRuleProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ess.Datasource.IRosScalingRuleProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Ess.Datasource.RosScalingRule))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AdjustmentType: The adjustment method of the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AdjustmentValue: The number of instances that must be scaled based on the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Alarms: The event-triggered tasks that are associated with the scaling rule. The value of this parameter is returned only if you set ShowAlarmRules to true. Otherwise, null is returned.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Cooldown: The cooldown period of the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DisableScaleIn: Indicates whether scale-in is disabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EstimatedInstanceWarmup: The warm-up period of instances.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InitialMaxSize: The maximum number of ECS instances that can be contained in the scaling group.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaxSize: The maximum number of ECS instances that can be contained in the scaling group.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MetricName: The name of the metric of the event-triggered task that is associated with the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MinAdjustmentMagnitude: The minimum number of instances that must be scaled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MinSize: The minimum number of ECS instances that must be contained in the scaling group.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PredictiveScalingMode: The mode of the predictive scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PredictiveTaskBufferTime: The amount of buffer time before prediction tasks are executed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PredictiveValueBehavior: The action on the predicted maximum value.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PredictiveValueBuffer: The ratio based on which the predicted value is increased when PredictiveValueBehavior is set to PredictiveValueOverrideMaxWithBuffer.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScaleInEvaluationCount: The number of consecutive times that the event-triggered task for scale-in purposes must meet the threshold conditions before an alert is triggered.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScaleOutEvaluationCount: The number of consecutive times that the event-triggered task created for scale-out purposes must meet the threshold conditions before an alert is triggered.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScalingRuleAri: The unique identifier of the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScalingRuleId: The ID of the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScalingRuleType: The type of the scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: StepAdjustments: The step adjustments of the step scaling rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TargetValue: The target value of the metric.
        /// </remarks>
        ...
        public virtual object ScalingRuleId
        {
