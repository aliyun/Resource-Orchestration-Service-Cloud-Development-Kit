...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESS::VServerGroupAttachment`, which is used to associate vServer groups of a Sever Load Balancer (SLB) instance with a scaling group.</summary>
    /// <remarks>
    ...
    public class VServerGroupAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ess.IVServerGroupAttachment
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ess.IVServerGroupAttachmentProps Props
        {
