...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ESS::ScalingRules`, which are used to query the information about scaling rules.</summary>
    /// <remarks>
