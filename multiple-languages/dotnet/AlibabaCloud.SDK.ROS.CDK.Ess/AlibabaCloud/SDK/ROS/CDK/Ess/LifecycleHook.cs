...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESS::LifecycleHook`, which is used to create a lifecycle hook for a scaling group.</summary>
    /// <remarks>
    ...
    public class LifecycleHook : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ess.ILifecycleHookProps Props
        {
