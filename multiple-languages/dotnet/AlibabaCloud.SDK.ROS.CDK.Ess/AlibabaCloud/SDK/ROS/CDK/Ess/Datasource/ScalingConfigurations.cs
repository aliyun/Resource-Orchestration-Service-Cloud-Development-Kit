...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ESS::ScalingConfigurations`, which is used to query the information about scaling configurations.</summary>
    /// <remarks>
    ...
    public class ScalingConfigurations : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ess.Datasource.IScalingConfigurationsProps Props
        {
