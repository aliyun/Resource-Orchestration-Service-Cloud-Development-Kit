...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESS::ScalingGroup`You can use the , which resource to create a scaling group.</summary>
    /// <remarks>
    ...
    public class ScalingGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ess.IScalingGroup
    {
        ...
        public virtual object AttrScalingGroupName
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ess.ScalingGroupProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ess.IScalingGroupProps Props
        {
