...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::EMR::FlowProjects`.</summary>
    /// <remarks>
    ...
    public class FlowProjects : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Emr.Datasource.IFlowProjects
    {
        ...
        public virtual object AttrFlowProjectIds
        {
        ...
        public virtual object AttrFlowProjects
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-emr.datasource.FlowProjectsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Emr.Datasource.IFlowProjectsProps Props
        {
