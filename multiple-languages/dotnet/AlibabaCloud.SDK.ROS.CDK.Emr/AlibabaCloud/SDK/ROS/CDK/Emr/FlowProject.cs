...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::EMR::FlowProject`, which is used to create a data development project.</summary>
    /// <remarks>
    ...
    public class FlowProject : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Emr.IFlowProjectProps Props
        {
