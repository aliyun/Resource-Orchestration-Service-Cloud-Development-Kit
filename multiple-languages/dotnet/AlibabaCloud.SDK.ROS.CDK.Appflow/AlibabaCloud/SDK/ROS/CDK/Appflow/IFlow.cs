...
namespace AlibabaCloud.SDK.ROS.CDK.Appflow
{
    ...
    [JsiiInterface(nativeType: typeof(IFlow), fullyQualifiedName: "@alicloud/ros-cdk-appflow.IFlow")]
    public interface IFlow : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "attrWebhookAddress", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        object AttrWebhookAddress
        {
            get;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-appflow.FlowProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Appflow.IFlowProps Props
        {
            get;
        }

        /// <summary>Represents a `Flow`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFlow), fullyQualifiedName: "@alicloud/ros-cdk-appflow.IFlow")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Appflow.IFlow
        {
            ...
            /// <summary>Attribute WebhookAddress: The webhook address of the flow.</summary>
            [JsiiProperty(name: "attrWebhookAddress", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrWebhookAddress
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-appflow.FlowProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Appflow.IFlowProps Props
            {
