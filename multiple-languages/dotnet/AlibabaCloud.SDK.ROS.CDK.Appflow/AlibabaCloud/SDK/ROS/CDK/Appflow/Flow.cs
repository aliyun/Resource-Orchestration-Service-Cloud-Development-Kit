...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::AppFlow::Flow`, which is used to create a flow.</summary>
    /// <remarks>
    ...
    public class Flow : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Appflow.IFlow
    {
        ...
        public virtual object AttrWebhookAddress
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-appflow.FlowProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Appflow.IFlowProps Props
        {
