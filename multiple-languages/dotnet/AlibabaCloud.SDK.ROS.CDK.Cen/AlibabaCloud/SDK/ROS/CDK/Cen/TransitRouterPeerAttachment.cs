...
{
    /// <summary>A ROS resource type:  `ALIYUN::CEN::TransitRouterPeerAttachment`.</summary>
    ...
    public class TransitRouterPeerAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public TransitRouterPeerAttachment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterPeerAttachmentProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
