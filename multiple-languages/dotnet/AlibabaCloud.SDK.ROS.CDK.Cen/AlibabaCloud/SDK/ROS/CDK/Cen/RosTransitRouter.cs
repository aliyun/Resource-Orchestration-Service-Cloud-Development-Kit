...
namespace AlibabaCloud.SDK.ROS.CDK.Cen
{
    ...
    public class RosTransitRouter : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTransitRouter(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
