...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CEN::TransitRouter`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `TransitRouter` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouter
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cen.RosTransitRouter), fullyQualifiedName: "@alicloud/ros-cdk-cen.RosTransitRouter", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cen.RosTransitRouterProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosTransitRouter : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosTransitRouter(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosTransitRouter(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosTransitRouter(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cen.RosTransitRouter))!;
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SystemTransitRouterRouteTableId: The system route table ID of transit router.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TransitRouterDescription: TransitRouterDescription
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TransitRouterName: TransitRouterName
        /// </remarks>
        ...
        public virtual object? TransitRouterDescription
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? TransitRouterName
        {
            get => GetInstanceProperty<object?>();
            set
            {
