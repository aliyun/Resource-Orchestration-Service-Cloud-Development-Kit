...
namespace AlibabaCloud.SDK.ROS.CDK.Cen.Datasource
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-cen.datasource.RosTransitRouterRouteTablesProps")]
    public class RosTransitRouterRouteTablesProps : AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.IRosTransitRouterRouteTablesProps
    {
        ...
        private object? _transitRouterRouteTableIds;
        ...
        {
            get => _transitRouterRouteTableIds;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterRouteTableIds = value;
            }
        }

        private object? _transitRouterRouteTableNames;
        ...
        {
            get => _transitRouterRouteTableNames;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterRouteTableNames = value;
            }
        }

        private object? _transitRouterRouteTableStatus;
        ...
        {
            get => _transitRouterRouteTableStatus;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterRouteTableStatus = value;
            }
        }

        private object? _transitRouterRouteTableType;
        ...
        {
            get => _transitRouterRouteTableType;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterRouteTableType = value;
            }
        }
    }
}
