...
namespace AlibabaCloud.SDK.ROS.CDK.Cen
{
    ...
    public class RosTransitRouterRouteTablePropagation : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTransitRouterRouteTablePropagation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterRouteTablePropagationProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
