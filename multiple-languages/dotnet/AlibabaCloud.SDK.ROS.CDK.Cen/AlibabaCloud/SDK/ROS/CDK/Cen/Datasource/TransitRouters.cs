...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CEN::TransitRouters`, which is used to query the information about transit routers of a Cloud Enterprise Network (CEN) instance.</summary>
    /// <remarks>
    ...
    public class TransitRouters : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.ITransitRouters
    {
        ...
        public virtual object AttrTransitRouterIds
        {
        ...
        public virtual object AttrTransitRouters
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cen.datasource.TransitRoutersProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.ITransitRoutersProps Props
        {
