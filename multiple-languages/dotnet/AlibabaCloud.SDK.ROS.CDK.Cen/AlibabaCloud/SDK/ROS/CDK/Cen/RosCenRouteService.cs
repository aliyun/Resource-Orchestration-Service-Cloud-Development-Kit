...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CEN::CenRouteService`, which is used to configure the access to an Alibaba Cloud service.</summary>
    /// <remarks>
