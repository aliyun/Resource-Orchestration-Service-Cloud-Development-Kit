...
{
    /// <summary>Represents a `TransitRouterVpcAttachment`.</summary>
    [JsiiInterface(nativeType: typeof(ITransitRouterVpcAttachment), fullyQualifiedName: "@alicloud/ros-cdk-cen.ITransitRouterVpcAttachment")]
    public interface ITransitRouterVpcAttachment : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterVpcAttachmentProps Props
        {
            get;
        }

        /// <summary>Represents a `TransitRouterVpcAttachment`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ITransitRouterVpcAttachment), fullyQualifiedName: "@alicloud/ros-cdk-cen.ITransitRouterVpcAttachment")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterVpcAttachment
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cen.TransitRouterVpcAttachmentProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterVpcAttachmentProps Props
            {
