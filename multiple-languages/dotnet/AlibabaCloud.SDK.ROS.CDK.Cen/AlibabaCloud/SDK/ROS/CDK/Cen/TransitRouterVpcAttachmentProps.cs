...
namespace AlibabaCloud.SDK.ROS.CDK.Cen
{
    ...
    public class TransitRouterVpcAttachmentProps : AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterVpcAttachmentProps
    {
        ...
        private object? _autoCreateVpcRoute;
        ...
        public object? AutoPublishRouteEnabled
        {
            ...
            set
            {
                ...
                _autoPublishRouteEnabled = value;
            }
        }
        ...
        private object? _routeTableAssociationEnabled;
        ...
        {
            get => _routeTableAssociationEnabled;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _routeTableAssociationEnabled = value;
            }
        }

        private object? _routeTablePropagationEnabled;
        ...
        {
            get => _routeTablePropagationEnabled;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _routeTablePropagationEnabled = value;
            }
        }
        ...
        {
            get => _transitRouterAttachmentDescription;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterAttachmentDescription = value;
            }
        }
        ...
        {
            get => _transitRouterAttachmentName;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterAttachmentName = value;
            }
        }
        ...
        private object? _transitRouterVpcAttachmentOptions;
        ...
        {
            get => _transitRouterVpcAttachmentOptions;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _transitRouterVpcAttachmentOptions = value;
            }
        }

        private object? _vpcOwnerId;
