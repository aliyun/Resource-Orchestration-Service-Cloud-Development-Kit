...
namespace AlibabaCloud.SDK.ROS.CDK.Cen
{
    ...
    public class RosCenVbrHealthCheck : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCenVbrHealthCheck(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosCenVbrHealthCheckProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
