...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CEN::CenVbrHealthCheck`, which is used to enable the health check feature or modify the health check configurations for a virtual border router (VBR).</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `CenVbrHealthCheck` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-cenvbrhealthcheck
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cen.RosCenVbrHealthCheck), fullyQualifiedName: "@alicloud/ros-cdk-cen.RosCenVbrHealthCheck", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cen.RosCenVbrHealthCheckProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosCenVbrHealthCheck : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosCenVbrHealthCheck(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosCenVbrHealthCheckProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosCenVbrHealthCheckProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosCenVbrHealthCheck(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosCenVbrHealthCheck(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cen.RosCenVbrHealthCheck))!;
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckInterval: Specifies the time interval at which probe packets are sent during the health check.  Default value: 2. Valid values: 2 to 3.  Unit: second.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckTargetIp: Specifies the destination IP address of the health check. The destination IP address is the IP address of the client-facing interface on the VBR instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthyThreshold: Specifies the number of probe packets to be sent during the health check.  Default value: 8. Valid values: 3 to 8.  Unit: packet.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VbrInstanceId: The ID of the VBR instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VbrInstanceOwnerId: The User ID (UID) of the account to which the VBR instance belongs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VbrInstanceRegionId: The ID of the region where the VBR instance is deployed. You can call the DescribeRegionsoperation to query region IDs.
        /// </remarks>
        ...
        public virtual object HealthCheckTargetIp
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object VbrInstanceId
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object VbrInstanceRegionId
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? HealthCheckSourceIp
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? VbrInstanceOwnerId
        {
            get => GetInstanceProperty<object?>();
            set
            {
