...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CEN::RouteEntry`, which is used to advertise a routing entry of an attached VPC or VBR to a CEN instance.</summary>
    /// <remarks>
    ...
    public class RosRouteEntry : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosRouteEntry(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosRouteEntryProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosRouteEntryProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object ChildInstanceRouteTableId
        {
            get => GetInstanceProperty<object>()!;
            set
            {
