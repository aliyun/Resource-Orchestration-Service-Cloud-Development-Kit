...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CEN::CenRouteMaps`, which is used to query the information about routing policies.</summary>
    /// <remarks>
    ...
    public class CenRouteMaps : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.ICenRouteMapsProps Props
        {
