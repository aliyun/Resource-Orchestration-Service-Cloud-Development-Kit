...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CEN::ChildInstanceRouteEntryToAttachment`.</summary>
    /// <remarks>
    ...
    public class ChildInstanceRouteEntryToAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cen.IChildInstanceRouteEntryToAttachment
    {
        ...
        public virtual object AttrDestinationCidrBlock
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Cen.IChildInstanceRouteEntryToAttachmentProps Props
        {
