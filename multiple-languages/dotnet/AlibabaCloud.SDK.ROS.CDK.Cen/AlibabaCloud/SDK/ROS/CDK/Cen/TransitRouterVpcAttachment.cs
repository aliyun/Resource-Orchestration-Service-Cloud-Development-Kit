...
{
    /// <summary>A ROS resource type:  `ALIYUN::CEN::TransitRouterVpcAttachment`.</summary>
    ...
    public class TransitRouterVpcAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public TransitRouterVpcAttachment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterVpcAttachmentProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
