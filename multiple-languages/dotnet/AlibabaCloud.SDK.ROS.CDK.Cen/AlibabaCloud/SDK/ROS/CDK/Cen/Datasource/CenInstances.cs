...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CEN::CenInstances`.</summary>
    /// <remarks>
    ...
    public class CenInstances : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.ICenInstances
    {
        ...
        public virtual object AttrCenIds
        {
        ...
        public virtual object AttrCens
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cen.datasource.CenInstancesProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cen.Datasource.ICenInstancesProps Props
        {
