...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CEN::CenBandwidthLimit`, which is used to configure the bandwidth for cross-region interconnection in a bandwidth plan.</summary>
    /// <remarks>
    ...
    public class CenBandwidthLimit : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cen.ICenBandwidthLimit
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Cen.ICenBandwidthLimitProps Props
        {
