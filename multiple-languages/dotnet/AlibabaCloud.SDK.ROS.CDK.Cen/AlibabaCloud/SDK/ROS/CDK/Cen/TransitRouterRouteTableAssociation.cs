...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CEN::TransitRouterRouteTableAssociation`, which is used to create an associated forwarding correlation.</summary>
    /// <remarks>
    ...
    public class TransitRouterRouteTableAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cen.ITransitRouterRouteTableAssociationProps Props
        {
