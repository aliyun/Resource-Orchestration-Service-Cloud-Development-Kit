...
namespace AlibabaCloud.SDK.ROS.CDK.Cen
{
    ...
    public class RosCenInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCenInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosCenInstanceProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
