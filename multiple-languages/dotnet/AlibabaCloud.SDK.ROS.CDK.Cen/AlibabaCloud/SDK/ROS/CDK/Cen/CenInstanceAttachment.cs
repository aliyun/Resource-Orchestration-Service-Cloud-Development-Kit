...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CEN::CenInstanceAttachment`, which is used to attach network instances to a CEN instance.</summary>
    /// <remarks>
    ...
    public class CenInstanceAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cen.ICenInstanceAttachmentProps Props
        {
