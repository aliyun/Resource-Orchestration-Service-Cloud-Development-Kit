...
{
    /// <summary>A ROS resource type:  `ALIYUN::CEN::CenBandwidthPackageAssociation`.</summary>
    ...
    public class CenBandwidthPackageAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public CenBandwidthPackageAssociation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.ICenBandwidthPackageAssociationProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
