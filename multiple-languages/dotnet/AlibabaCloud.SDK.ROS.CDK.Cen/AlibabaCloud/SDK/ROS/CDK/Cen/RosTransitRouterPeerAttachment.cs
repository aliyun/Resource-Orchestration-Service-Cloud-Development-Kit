...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CEN::TransitRouterPeerAttachment`The , which type creates an inter-region connection for an Enterprise Edition transit router.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `TransitRouterPeerAttachment` class instead of this class for a more convenient development experience.
    ...
    public class RosTransitRouterPeerAttachment : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTransitRouterPeerAttachment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterPeerAttachmentProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cen.IRosTransitRouterPeerAttachmentProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TransitRouterAttachmentId: Cross-region connection ID.
        /// </remarks>
        ...
        public virtual object? BandwidthType
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? DefaultLinkType
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        /// <remarks>
        /// <strong>Property</strong>: deletionForce: Whether to force delete the peer attachment.
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <strong>Property</strong>: routeTableAssociationEnabled: Whether to enable the association of route tables
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <strong>Property</strong>: routeTablePropagationEnabled: Whether to enable the propagation of route tables.
        /// </remarks>
        [JsiiOptional]
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Cen.RosTransitRouterPeerAttachment.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-cen.RosTransitRouterPeerAttachment.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-cen.RosTransitRouterPeerAttachment.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cen.RosTransitRouterPeerAttachment.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-cen.RosTransitRouterPeerAttachment.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Cen.RosTransitRouterPeerAttachment.ITagsProperty
        {
            private object _key;
