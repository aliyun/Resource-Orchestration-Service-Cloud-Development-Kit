...
namespace AlibabaCloud.SDK.ROS.CDK.Fc3
{
    ...
    [JsiiInterface(nativeType: typeof(IFunctionInvoker), fullyQualifiedName: "@alicloud/ros-cdk-fc3.IFunctionInvoker")]
    public interface IFunctionInvoker : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Fc3.IFunctionInvokerProps Props
        {
            get;
        }

        /// <summary>Represents a `FunctionInvoker`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFunctionInvoker), fullyQualifiedName: "@alicloud/ros-cdk-fc3.IFunctionInvoker")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Fc3.IFunctionInvoker
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-fc3.FunctionInvokerProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Fc3.IFunctionInvokerProps Props
            {
