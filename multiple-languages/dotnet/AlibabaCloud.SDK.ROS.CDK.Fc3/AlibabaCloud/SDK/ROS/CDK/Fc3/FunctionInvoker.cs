...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::FC3::FunctionInvoker`The , which resource type invokes a function in Function Compute (FC) 3.0.</summary>
    /// <remarks>
