...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::FC3::Trigger`.</summary>
    /// <remarks>
    ...
    public class Trigger : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Fc3.ITriggerProps Props
        {
