...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::IOT::ProductTopic`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `ProductTopic` class instead of this class for a more convenient development experience.
    ...
    public class RosProductTopic : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosProductTopic(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Iot.IRosProductTopicProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Iot.IRosProductTopicProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object TopicShortName
        {
            get => GetInstanceProperty<object>()!;
            set
            {
