...
namespace AlibabaCloud.SDK.ROS.CDK.Iot
{
    ...
    [JsiiInterface(nativeType: typeof(IProduct), fullyQualifiedName: "@alicloud/ros-cdk-iot.IProduct")]
    public interface IProduct : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Iot.IProductProps Props
        {
            get;
        }

        /// <summary>Represents a `Product`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IProduct), fullyQualifiedName: "@alicloud/ros-cdk-iot.IProduct")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Iot.IProduct
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-iot.ProductProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Iot.IProductProps Props
            {
