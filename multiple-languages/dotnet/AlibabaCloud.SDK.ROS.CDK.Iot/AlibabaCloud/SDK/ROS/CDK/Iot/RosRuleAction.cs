...
{
    /// <summary>A ROS template type:  `ALIYUN::IOT::RuleAction`.</summary>
    ...
    public class RosRuleAction : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosRuleAction(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Iot.IRosRuleActionProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
