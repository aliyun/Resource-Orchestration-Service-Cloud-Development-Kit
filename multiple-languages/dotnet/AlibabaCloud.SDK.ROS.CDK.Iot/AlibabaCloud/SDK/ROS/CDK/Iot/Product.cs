...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::IOT::Product`, which is used to create a product.</summary>
    /// <remarks>
    ...
    public class Product : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Iot.IProductProps Props
        {
