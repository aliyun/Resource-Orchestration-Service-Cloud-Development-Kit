...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DEVOPS::PipelineRun`, which is used to run a pipeline.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosPipelineRun`for a more convenient development experience.
    ...
    public class PipelineRun : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Devops.IPipelineRun
    {
        ...
        public virtual object AttrPipelineRunId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-devops.PipelineRunProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Devops.IPipelineRunProps Props
        {
