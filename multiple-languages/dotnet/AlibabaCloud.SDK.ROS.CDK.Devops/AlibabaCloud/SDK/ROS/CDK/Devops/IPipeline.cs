...
namespace AlibabaCloud.SDK.ROS.CDK.Devops
{
    ...
    [JsiiInterface(nativeType: typeof(IPipeline), fullyQualifiedName: "@alicloud/ros-cdk-devops.IPipeline")]
    public interface IPipeline : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Devops.IPipelineProps Props
        {
            get;
        }

        /// <summary>Represents a `Pipeline`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPipeline), fullyQualifiedName: "@alicloud/ros-cdk-devops.IPipeline")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Devops.IPipeline
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-devops.PipelineProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Devops.IPipelineProps Props
            {
