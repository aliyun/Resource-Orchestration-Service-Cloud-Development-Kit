...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VS::Group`, which is used to create a group.</summary>
    /// <remarks>
    ...
    public class RosGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vs.IRosGroupProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vs.IRosGroupProps props, bool enableResourcePropertyConstraint)
        {
