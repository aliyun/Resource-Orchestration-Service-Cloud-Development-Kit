...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VS::Group`, which is used to create a group.</summary>
    /// <remarks>
    ...
    public class Group : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vs.IGroupProps Props
        {
