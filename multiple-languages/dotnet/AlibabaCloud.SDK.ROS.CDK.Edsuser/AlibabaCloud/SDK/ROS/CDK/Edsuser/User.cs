...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::EdsUser::User`.</summary>
    /// <remarks>
    ...
    public class User : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Edsuser.IUser
    {
        ...
        public virtual object AttrEndUserId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-edsuser.UserProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Edsuser.IUserProps Props
        {
