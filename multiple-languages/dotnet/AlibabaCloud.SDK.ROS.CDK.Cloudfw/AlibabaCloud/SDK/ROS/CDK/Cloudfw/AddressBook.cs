...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CLOUDFW::AddressBook`, which is used to create access control address books.</summary>
    /// <remarks>
