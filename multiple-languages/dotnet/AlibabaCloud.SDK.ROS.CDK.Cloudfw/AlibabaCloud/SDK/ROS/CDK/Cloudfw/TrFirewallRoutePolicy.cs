...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CLOUDFW::TrFirewallRoutePolicy`, which is used to create a routing policy for a virtual private cloud (VPC) firewall of a transit router.</summary>
    /// <remarks>
    ...
    public class TrFirewallRoutePolicy : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cloudfw.ITrFirewallRoutePolicy
    {
        ...
        public virtual object AttrTrFirewallRoutePolicyId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cloudfw.TrFirewallRoutePolicyProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cloudfw.ITrFirewallRoutePolicyProps Props
        {
