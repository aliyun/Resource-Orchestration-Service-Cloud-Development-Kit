...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudfw
{
    ...
    public class RosAddressBookProps : AlibabaCloud.SDK.ROS.CDK.Cloudfw.IRosAddressBookProps
    {
        ...
        /// <remarks>
        /// <strong>Property</strong>: groupType: Type of the address book.
        /// </remarks>
        ...
        private object? _ackClusterConnectorId;

        /// <remarks>
        /// <strong>Property</strong>: ackClusterConnectorId: ACK cluster connector ID. Batch query ACK cluster connector list.
        /// </remarks>
        [JsiiOptional]
        ...
        public object? AckClusterConnectorId
        {
            ...
            set
            {
                ...
                _ackClusterConnectorId = value;
            }
        }

        private object? _ackLabels;

        /// <remarks>
        /// <strong>Property</strong>: ackLabels: ACK cluster container group label list.
        ///
        /// > Up to 10.
        /// </remarks>
        [JsiiOptional]
                            ...
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.IAckLabelsProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.IAckLabelsProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.IAckLabelsProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
        ...
        private object? _ackNamespaces;

        /// <remarks>
        /// <strong>Property</strong>: ackNamespaces: ACK cluster container group namespace list. Up to 10.
        /// </remarks>
        [JsiiOptional]
        ...
        public object? AckNamespaces
        {
            ...
            set
            {
                ...
                _ackNamespaces = value;
            }
        }

        private object? _addressList;
                        ...
                        case object[] cast_cd4240:
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.ITagListProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.ITagListProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cloudfw.RosAddressBook.ITagListProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
