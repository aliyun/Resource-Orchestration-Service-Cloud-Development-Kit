...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudfw
{
    ...
    public class RosControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public virtual string AclAction
        {
        ...
        public virtual double NewOrder
        {
        ...
        public virtual string? DestPort
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string? DestPortGroup
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string? DestPortType
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
