...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudfw
{
    ...
    public class RosControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosControlPolicy(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudfw.IRosControlPolicyProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudfw.IRosControlPolicyProps props, bool enableResourcePropertyConstraint)
        {
