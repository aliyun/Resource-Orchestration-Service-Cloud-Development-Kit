...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CLOUDFW::VpcFirewallControlPolicy`, which is used to add an access control policy to a specified policy group for a Virtual Private Cloud (VPC) firewall.</summary>
    /// <remarks>
    ...
    public class VpcFirewallControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cloudfw.IVpcFirewallControlPolicyProps Props
        {
