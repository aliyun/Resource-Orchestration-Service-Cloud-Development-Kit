...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudfw
{
    ...
    public class RosVpcFirewallControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosVpcFirewallControlPolicy(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudfw.IRosVpcFirewallControlPolicyProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
