...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudfw
{
    ...
    [JsiiInterface(nativeType: typeof(IControlPolicy), fullyQualifiedName: "@alicloud/ros-cdk-cloudfw.IControlPolicy")]
    public interface IControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cloudfw.IControlPolicyProps Props
        {
            get;
        }

        /// <summary>Represents a `ControlPolicy`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IControlPolicy), fullyQualifiedName: "@alicloud/ros-cdk-cloudfw.IControlPolicy")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cloudfw.IControlPolicy
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cloudfw.ControlPolicyProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cloudfw.IControlPolicyProps Props
            {
