...
namespace AlibabaCloud.SDK.ROS.CDK.Marketplace
{
    ...
    public class RosOrder : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosOrder(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Marketplace.IRosOrderProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Marketplace.IRosOrderProps props, bool enableResourcePropertyConstraint)
        {
