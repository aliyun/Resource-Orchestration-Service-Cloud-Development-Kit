...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::MarketPlace::Order`, which is used to purchase resources from Alibaba Cloud Marketplace.</summary>
    /// <remarks>
    ...
    public class Order : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Marketplace.IOrder
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Marketplace.IOrderProps Props
        {
