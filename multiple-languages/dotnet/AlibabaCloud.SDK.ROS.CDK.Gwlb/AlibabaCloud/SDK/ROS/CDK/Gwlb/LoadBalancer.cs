...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::GWLB::LoadBalancer`The , which type is used to create a Gateway Load Balancer (GWLB) instance.</summary>
    /// <remarks>
