...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::GWLB::ServerGroup`The , which type is used to create a server group.</summary>
    /// <remarks>
