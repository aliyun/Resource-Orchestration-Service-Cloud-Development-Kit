...
namespace AlibabaCloud.SDK.ROS.CDK.Gwlb
{
    ...
    [JsiiInterface(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-gwlb.IListener")]
    public interface IListener : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrListenerDescription
        {
            get;
        }
        ...
        AlibabaCloud.SDK.ROS.CDK.Gwlb.IListenerProps Props
        {
            get;
        }

        /// <summary>Represents a `Listener`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-gwlb.IListener")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Gwlb.IListener
        {
            ...
            /// <summary>Attribute ListenerDescription: The custom listener description.</summary>
            [JsiiProperty(name: "attrListenerDescription", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrListenerDescription
            {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-gwlb.ListenerProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Gwlb.IListenerProps Props
            {
