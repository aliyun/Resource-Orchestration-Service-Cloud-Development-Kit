...
namespace AlibabaCloud.SDK.ROS.CDK.Vod
{
    ...
    [JsiiInterface(nativeType: typeof(IStorage), fullyQualifiedName: "@alicloud/ros-cdk-vod.IStorage")]
    public interface IStorage : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vod.IStorageProps Props
        {
            get;
        }

        /// <summary>Represents a `Storage`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IStorage), fullyQualifiedName: "@alicloud/ros-cdk-vod.IStorage")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vod.IStorage
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vod.StorageProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vod.IStorageProps Props
            {
