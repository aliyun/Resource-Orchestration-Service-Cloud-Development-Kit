...
namespace AlibabaCloud.SDK.ROS.CDK.Vod.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IEditingProject), fullyQualifiedName: "@alicloud/ros-cdk-vod.datasource.IEditingProject")]
    public interface IEditingProject : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vod.Datasource.IEditingProjectProps Props
        {
            get;
        }

        /// <summary>Represents a `EditingProject`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEditingProject), fullyQualifiedName: "@alicloud/ros-cdk-vod.datasource.IEditingProject")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vod.Datasource.IEditingProject
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vod.datasource.EditingProjectProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vod.Datasource.IEditingProjectProps Props
            {
