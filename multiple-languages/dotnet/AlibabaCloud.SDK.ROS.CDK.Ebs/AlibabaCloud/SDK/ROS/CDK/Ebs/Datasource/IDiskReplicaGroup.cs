...
namespace AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IDiskReplicaGroup), fullyQualifiedName: "@alicloud/ros-cdk-ebs.datasource.IDiskReplicaGroup")]
    public interface IDiskReplicaGroup : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource.IDiskReplicaGroupProps Props
        {
            get;
        }

        /// <summary>Represents a `DiskReplicaGroup`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDiskReplicaGroup), fullyQualifiedName: "@alicloud/ros-cdk-ebs.datasource.IDiskReplicaGroup")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource.IDiskReplicaGroup
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ebs.datasource.DiskReplicaGroupProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource.IDiskReplicaGroupProps Props
            {
