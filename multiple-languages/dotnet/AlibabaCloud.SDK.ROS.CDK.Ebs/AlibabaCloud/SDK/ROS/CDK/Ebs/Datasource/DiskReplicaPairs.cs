...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::EBS::DiskReplicaPairs`, which is used to query the information about replication pairs.</summary>
    /// <remarks>
    ...
    public class DiskReplicaPairs : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource.IDiskReplicaPairs
    {
        ...
        public virtual object AttrDiskReplicaPairs
        {
        ...
        public virtual object AttrReplicaPairIds
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ebs.datasource.DiskReplicaPairsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ebs.Datasource.IDiskReplicaPairsProps Props
        {
