...
namespace AlibabaCloud.SDK.ROS.CDK.Ebs
{
    ...
    [JsiiInterface(nativeType: typeof(IDiskReplicaPair), fullyQualifiedName: "@alicloud/ros-cdk-ebs.IDiskReplicaPair")]
    public interface IDiskReplicaPair : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ebs.IDiskReplicaPairProps Props
        {
            get;
        }

        /// <summary>Represents a `DiskReplicaPair`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDiskReplicaPair), fullyQualifiedName: "@alicloud/ros-cdk-ebs.IDiskReplicaPair")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ebs.IDiskReplicaPair
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ebs.DiskReplicaPairProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ebs.IDiskReplicaPairProps Props
            {
