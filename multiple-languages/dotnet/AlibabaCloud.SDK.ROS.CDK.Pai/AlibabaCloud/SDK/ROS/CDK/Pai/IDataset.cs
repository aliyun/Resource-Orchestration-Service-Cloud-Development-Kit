...
namespace AlibabaCloud.SDK.ROS.CDK.Pai
{
    ...
    [JsiiInterface(nativeType: typeof(IDataset), fullyQualifiedName: "@alicloud/ros-cdk-pai.IDataset")]
    public interface IDataset : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.DatasetProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Pai.IDatasetProps Props
        {
            get;
        }

        /// <summary>Represents a `Dataset`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataset), fullyQualifiedName: "@alicloud/ros-cdk-pai.IDataset")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.IDataset
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.DatasetProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.IDatasetProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Pai.IDatasetProps>()!;
            }
