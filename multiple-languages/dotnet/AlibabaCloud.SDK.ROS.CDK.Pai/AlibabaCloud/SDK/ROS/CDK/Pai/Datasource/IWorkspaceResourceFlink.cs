...
namespace AlibabaCloud.SDK.ROS.CDK.Pai.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IWorkspaceResourceFlink), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaceResourceFlink")]
    public interface IWorkspaceResourceFlink : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.WorkspaceResourceFlinkProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceFlinkProps Props
        {
            get;
        }

        /// <summary>Represents a `WorkspaceResourceFlink`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWorkspaceResourceFlink), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaceResourceFlink")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceFlink
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.WorkspaceResourceFlinkProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceFlinkProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceFlinkProps>()!;
            }
