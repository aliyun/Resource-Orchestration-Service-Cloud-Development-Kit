...
namespace AlibabaCloud.SDK.ROS.CDK.Pai
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-pai.RosResourceGroupProps")]
    public class RosResourceGroupProps : AlibabaCloud.SDK.ROS.CDK.Pai.IRosResourceGroupProps
    {
        private object? _computingResourceProvider;
        ...
        {
            get => _computingResourceProvider;
            set
            {
                ...
                _computingResourceProvider = value;
            }
        }
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Pai.RosResourceGroup.IUserVpcProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Pai.RosResourceGroup.IUserVpcProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _userVpc = value;
            }
