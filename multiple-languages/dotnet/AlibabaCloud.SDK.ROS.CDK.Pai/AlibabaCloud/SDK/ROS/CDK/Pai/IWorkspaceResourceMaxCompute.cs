...
namespace AlibabaCloud.SDK.ROS.CDK.Pai
{
    ...
    [JsiiInterface(nativeType: typeof(IWorkspaceResourceMaxCompute), fullyQualifiedName: "@alicloud/ros-cdk-pai.IWorkspaceResourceMaxCompute")]
    public interface IWorkspaceResourceMaxCompute : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Pai.IWorkspaceResourceMaxComputeProps Props
        {
            get;
        }

        /// <summary>Represents a `WorkspaceResourceMaxCompute`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWorkspaceResourceMaxCompute), fullyQualifiedName: "@alicloud/ros-cdk-pai.IWorkspaceResourceMaxCompute")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.IWorkspaceResourceMaxCompute
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.WorkspaceResourceMaxComputeProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.IWorkspaceResourceMaxComputeProps Props
            {
