...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::PAI::Experiment`, which is used to create an experiment.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Experiment` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-pai-experiment
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Pai.RosExperiment), fullyQualifiedName: "@alicloud/ros-cdk-pai.RosExperiment", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-pai.RosExperimentProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosExperiment : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosExperiment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.IRosExperimentProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.IRosExperimentProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosExperiment(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosExperiment(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Pai.RosExperiment))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Accessibility: Experimental Visibility.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ArtifactUri: ArtifactUri is default OSS storage path of the output of trials in the experiment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: GmtCreateTime is time when this entity is created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExperimentId: ExperimentId is globally unique identifier of the experiment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExperimentName: Name is the name of the experiment, unique in a namespace.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: GmtModifiedTime: GmtModifiedTime is time when this entity is modified.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Labels: Labels are tags of the experiment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: OwnerId: OwnerId is the user account id which this entity belongs to.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TensorboardLogUri: TensorboardLogUri is the default OSS storage path of tensorboard log of trials in the experiment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserId: UserId is the user account id which created this entity.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: WorkspaceId: WorkspaceId is the workspace id which contains the experiment.
        /// </remarks>
        ...
        public virtual object ArtifactUri
        {
        ...
        public virtual object ExperimentName
        {
            get => GetInstanceProperty<object>()!;
            set
            {
