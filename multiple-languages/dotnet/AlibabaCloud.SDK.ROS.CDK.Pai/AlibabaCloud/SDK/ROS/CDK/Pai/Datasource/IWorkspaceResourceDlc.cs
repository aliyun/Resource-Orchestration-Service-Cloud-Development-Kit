...
namespace AlibabaCloud.SDK.ROS.CDK.Pai.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IWorkspaceResourceDlc), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaceResourceDlc")]
    public interface IWorkspaceResourceDlc : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.WorkspaceResourceDlcProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceDlcProps Props
        {
            get;
        }

        /// <summary>Represents a `WorkspaceResourceDlc`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWorkspaceResourceDlc), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaceResourceDlc")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceDlc
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.WorkspaceResourceDlcProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceDlcProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaceResourceDlcProps>()!;
            }
