...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::PAI::WorkspaceResourceDlc`, which is used to associate Deep Learning Containers (DLC) resources with a workspace.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `WorkspaceResourceDlc` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-pai-workspaceresourcedlc
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Pai.RosWorkspaceResourceDlc), fullyQualifiedName: "@alicloud/ros-cdk-pai.RosWorkspaceResourceDlc", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-pai.RosWorkspaceResourceDlcProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosWorkspaceResourceDlc : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosWorkspaceResourceDlc(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.IRosWorkspaceResourceDlcProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.IRosWorkspaceResourceDlcProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosWorkspaceResourceDlc(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosWorkspaceResourceDlc(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Pai.RosWorkspaceResourceDlc))!;
        ...
        [JsiiInterface(nativeType: typeof(IResourcesProperty), fullyQualifiedName: "@alicloud/ros-cdk-pai.RosWorkspaceResourceDlc.ResourcesProperty")]
        public interface IResourcesProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(IResourcesProperty), fullyQualifiedName: "@alicloud/ros-cdk-pai.RosWorkspaceResourceDlc.ResourcesProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.RosWorkspaceResourceDlc.IResourcesProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-pai.RosWorkspaceResourceDlc.ResourcesProperty")]
        public class ResourcesProperty : AlibabaCloud.SDK.ROS.CDK.Pai.RosWorkspaceResourceDlc.IResourcesProperty
        {
