...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::PAI::CodeSource`, which is used to create a code build in Platform for AI (PAI).</summary>
    /// <remarks>
