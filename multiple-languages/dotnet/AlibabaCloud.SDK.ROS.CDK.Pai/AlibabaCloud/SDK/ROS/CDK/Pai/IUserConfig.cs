...
{
    /// <summary>Represents a `UserConfig`.</summary>
    [JsiiInterface(nativeType: typeof(IUserConfig), fullyQualifiedName: "@alicloud/ros-cdk-pai.IUserConfig")]
    public interface IUserConfig : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Pai.IUserConfigProps Props
        {
            get;
        }

        /// <summary>Represents a `UserConfig`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IUserConfig), fullyQualifiedName: "@alicloud/ros-cdk-pai.IUserConfig")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.IUserConfig
        {
            ...
            /// <summary>Attribute CategoryName: Represents a resource attribute for a configuration category.</summary>
            [JsiiProperty(name: "attrCategoryName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrCategoryName
            {
            ...
            /// <summary>Attribute Configs: Represents a resource property for the configuration list.</summary>
            [JsiiProperty(name: "attrConfigs", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrConfigs
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.UserConfigProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.IUserConfigProps Props
            {
