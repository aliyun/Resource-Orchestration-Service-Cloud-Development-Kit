...
namespace AlibabaCloud.SDK.ROS.CDK.Pai.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IWorkspaces), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaces")]
    public interface IWorkspaces : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspacesProps Props
        {
            get;
        }

        /// <summary>Represents a `Workspaces`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWorkspaces), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.IWorkspaces")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspaces
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.WorkspacesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IWorkspacesProps Props
            {
