...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::PAI::Dataset`, which is used to query a dataset.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Dataset` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-pai-dataset
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.RosDataset), fullyQualifiedName: "@alicloud/ros-cdk-pai.datasource.RosDataset", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-pai.datasource.RosDatasetProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosDataset : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosDataset(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IRosDatasetProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.IRosDatasetProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosDataset(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosDataset(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Pai.Datasource.RosDataset))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Accessibility: Workspace visibility.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DatasetId: The first ID of the resource.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DatasetName: The name of the dataset.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DataSourceType: The data source type.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DataType: The dataset type. The default value is COMMON.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: Custom descriptions of datasets to distinguish between different datasets.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: GmtModifiedTime: Update time.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Options: The extended field, which is of the JsonString type.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: OwnerId: The ID of the primary account.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Property: The properties of the dataset.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SourceId: The data source ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SourceType: The data source type. The default value is USER.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Uri: The Uri configuration sample is as follows:.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserId: The ID of the user to which the dataset belongs.
        /// </remarks>
        ...
        public virtual object DatasetId
        {
