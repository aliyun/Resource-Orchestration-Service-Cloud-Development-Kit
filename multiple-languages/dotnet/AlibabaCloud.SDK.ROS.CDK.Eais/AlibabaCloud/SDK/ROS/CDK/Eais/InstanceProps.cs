...
namespace AlibabaCloud.SDK.ROS.CDK.Eais
{
    ...
    /// <summary>Properties for defining a `ALIYUN::EAIS::Instance`.</summary>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-eais.InstanceProps")]
    public class InstanceProps : AlibabaCloud.SDK.ROS.CDK.Eais.IInstanceProps
    {
        private object _createWithNotebook;

        /// <summary>Property createWithNotebook: When the value is true, CreateEaiJupyter is called to create an eais instance, and when the value is false, CreateEai is called to create an eais instance.</summary>
        ...
        public object CreateWithNotebook
        {
            ...
            set
            {
                ...
                _createWithNotebook = value;
            }
        }

        private object _instanceType;

        /// <summary>Property instanceType: EAIS instance type.</summary>
        ...
        /// <summary>Property environmentVar: Setting environment variables in eais instance on Initialization.</summary>
        [JsiiOptional]
                            ...
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Eais.RosInstance.IEnvironmentVarProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Eais.RosInstance.IEnvironmentVarProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Eais.RosInstance.IEnvironmentVarProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
        ...
        /// <summary>Property instanceName: Name of the instance.</summary>
        [JsiiOptional]
