...
namespace AlibabaCloud.SDK.ROS.CDK.Eais.Datasource
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-eais.datasource.ClientInstanceAttachmentProps")]
    public class ClientInstanceAttachmentProps : AlibabaCloud.SDK.ROS.CDK.Eais.Datasource.IClientInstanceAttachmentProps
    {
        private object _clientInstanceAttachmentId;
        ...
        {
            get => _clientInstanceAttachmentId;
            set
            {
                ...
                _clientInstanceAttachmentId = value;
            }
        }
