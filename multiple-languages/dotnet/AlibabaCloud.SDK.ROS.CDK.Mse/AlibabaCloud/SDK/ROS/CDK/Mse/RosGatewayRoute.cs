...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::MSE::GatewayRoute`The , which resource is used to add a gateway route.</summary>
    /// <remarks>
