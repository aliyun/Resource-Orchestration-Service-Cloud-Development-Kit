...
namespace AlibabaCloud.SDK.ROS.CDK.Mse
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-mse.RosGatewayDomainProps")]
    public class RosGatewayDomainProps : AlibabaCloud.SDK.ROS.CDK.Mse.IRosGatewayDomainProps
    {
        ...
        private object? _tlsCipherSuitesConfigJson;
        ...
        {
            get => _tlsCipherSuitesConfigJson;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Mse.RosGatewayDomain.ITlsCipherSuitesConfigJSONProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Mse.RosGatewayDomain.ITlsCipherSuitesConfigJSONProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _tlsCipherSuitesConfigJson = value;
            }
        }
