...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::MSE::Gateways`, which is used to query the information about gateways.</summary>
    /// <remarks>
    ...
    public class Gateways : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Mse.Datasource.IGateways
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Mse.Datasource.IGatewaysProps Props
        {
