...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::MSE::Clusters`, which is used to query the clusters of Microservices Registry.</summary>
    /// <remarks>
    ...
    public class Clusters : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Mse.Datasource.IClustersProps Props
        {
