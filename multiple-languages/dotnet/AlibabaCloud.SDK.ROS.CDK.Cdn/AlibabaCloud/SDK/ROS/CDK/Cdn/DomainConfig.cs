...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CDN::DomainConfig`, which is used to configure multiple domain names at a time.</summary>
    /// <remarks>
    ...
    public class DomainConfig : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cdn.IDomainConfig
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Cdn.IDomainConfigProps Props
        {
