...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CDN::Domains`, which is used to query the basic information about created accelerated domain names.</summary>
    /// <remarks>
