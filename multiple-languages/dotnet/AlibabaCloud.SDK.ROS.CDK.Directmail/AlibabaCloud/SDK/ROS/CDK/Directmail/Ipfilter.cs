...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DirectMail::Ipfilter`, which is used to add an IP filter.</summary>
    /// <remarks>
    ...
    public class Ipfilter : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Directmail.IIpfilter
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Directmail.IIpfilterProps Props
        {
