...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DirectMail::Domain`, which is used to create a domain name in Direct Mail.</summary>
    /// <remarks>
    ...
    public class Domain : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Directmail.IDomainProps Props
        {
