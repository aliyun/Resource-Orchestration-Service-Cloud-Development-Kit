...
namespace AlibabaCloud.SDK.ROS.CDK.Adb
{
    ...
    [JsiiInterface(nativeType: typeof(IDBCluster), fullyQualifiedName: "@alicloud/ros-cdk-adb.IDBCluster")]
    public interface IDBCluster : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Adb.IDBClusterProps Props
        {
            get;
        }

        /// <summary>Represents a `DBCluster`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDBCluster), fullyQualifiedName: "@alicloud/ros-cdk-adb.IDBCluster")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Adb.IDBCluster
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-adb.DBClusterProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Adb.IDBClusterProps Props
            {
