...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ADB::DBCluster`Use the , which resource type to create an AnalyticDB for MySQL cluster.</summary>
    /// <remarks>
