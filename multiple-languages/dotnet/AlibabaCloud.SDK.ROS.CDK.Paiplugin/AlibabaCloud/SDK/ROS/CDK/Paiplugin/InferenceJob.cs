...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::PAIPlugin::InferenceJob`, which is used to create a prediction job.</summary>
    /// <remarks>
    ...
    public class InferenceJob : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Paiplugin.IInferenceJobProps Props
        {
