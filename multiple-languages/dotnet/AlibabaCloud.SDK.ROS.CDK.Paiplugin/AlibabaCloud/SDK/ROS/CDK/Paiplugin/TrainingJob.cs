...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::PAIPlugin::TrainingJob`, which is used to create a training job.</summary>
    /// <remarks>
    ...
    public class TrainingJob : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Paiplugin.ITrainingJob
    {
        ...
        public virtual object AttrTrainingJobId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-paiplugin.TrainingJobProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Paiplugin.ITrainingJobProps Props
        {
