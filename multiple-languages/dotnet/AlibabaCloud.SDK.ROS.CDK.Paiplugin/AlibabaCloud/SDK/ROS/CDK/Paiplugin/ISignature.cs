...
namespace AlibabaCloud.SDK.ROS.CDK.Paiplugin
{
    ...
    [JsiiInterface(nativeType: typeof(ISignature), fullyQualifiedName: "@alicloud/ros-cdk-paiplugin.ISignature")]
    public interface ISignature : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Paiplugin.ISignatureProps Props
        {
            get;
        }

        /// <summary>Represents a `Signature`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISignature), fullyQualifiedName: "@alicloud/ros-cdk-paiplugin.ISignature")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Paiplugin.ISignature
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-paiplugin.SignatureProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Paiplugin.ISignatureProps Props
            {
