...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::PAIPlugin::Campaign`, which is used to create an operational activity.</summary>
    /// <remarks>
    ...
    public class Campaign : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Paiplugin.ICampaign
    {
        ...
        [JsiiProperty(name: "attrCampaignId", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        public virtual object AttrCampaignId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-paiplugin.CampaignProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Paiplugin.ICampaignProps Props
        {
