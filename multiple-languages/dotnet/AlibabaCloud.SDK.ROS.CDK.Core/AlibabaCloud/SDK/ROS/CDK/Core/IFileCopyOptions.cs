...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    [JsiiInterface(nativeType: typeof(IFileCopyOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.FileCopyOptions")]
    public interface IFileCopyOptions
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        AlibabaCloud.SDK.ROS.CDK.Core.SymlinkFollowMode? FollowSymlinks
        {
            get
            {
                return null;
        ...
        /// <summary>Options applied when copying directories into the staging location.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFileCopyOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.FileCopyOptions")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Core.IFileCopyOptions
        {
