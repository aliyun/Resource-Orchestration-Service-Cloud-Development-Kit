...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    [JsiiInterface(nativeType: typeof(IFileFingerprintOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.FileFingerprintOptions")]
    public interface IFileFingerprintOptions : AlibabaCloud.SDK.ROS.CDK.Core.IFileCopyOptions
    {
        ...
        /// <summary>Options related to calculating source hash.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFileFingerprintOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.FileFingerprintOptions")]
        new internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Core.IFileFingerprintOptions
        {
