...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    public abstract class Resource_ : AlibabaCloud.SDK.ROS.CDK.Core.Construct, AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiMethod(name: "getAtt", returnsJson: "{\"type\":{\"primitive\":\"string\"}}", parametersJson: "[{\"name\":\"name\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual string GetAtt(string name)
        {
        ...
        /// <summary>(experimental) Returns a string-encoded token that resolves to the physical name that&#xD; should be passed to the ROS resource.</summary>
        /// <remarks>
