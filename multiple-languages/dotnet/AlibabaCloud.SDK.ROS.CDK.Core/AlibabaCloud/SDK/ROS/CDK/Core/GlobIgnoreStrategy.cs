...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Core.GlobIgnoreStrategy), fullyQualifiedName: "@alicloud/ros-cdk-core.GlobIgnoreStrategy", parametersJson: "[{\"name\":\"absoluteRootPath\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"patterns\",\"type\":{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}}]")]
    public class GlobIgnoreStrategy : AlibabaCloud.SDK.ROS.CDK.Core.IgnoreStrategy
    {
        public GlobIgnoreStrategy(string absoluteRootPath, string[] patterns): base(_MakeDeputyProps(absoluteRootPath, patterns))
        {
        }
        ...
        protected GlobIgnoreStrategy(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GlobIgnoreStrategy(DeputyProps props): base(props)
        {
        }
