...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    [JsiiInterface(nativeType: typeof(IAssetOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.AssetOptions")]
    public interface IAssetOptions
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        AlibabaCloud.SDK.ROS.CDK.Core.AssetHashType? AssetHashType
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        AlibabaCloud.SDK.ROS.CDK.Core.IBundlingOptions? Bundling
        {
            get
            {
                return null;
        ...
        /// <summary>Asset hash options.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAssetOptions), fullyQualifiedName: "@alicloud/ros-cdk-core.AssetOptions")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Core.IAssetOptions
        {
