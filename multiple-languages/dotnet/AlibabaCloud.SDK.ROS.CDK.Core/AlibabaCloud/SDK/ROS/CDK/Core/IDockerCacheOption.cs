...
namespace AlibabaCloud.SDK.ROS.CDK.Core
{
    ...
    [JsiiInterface(nativeType: typeof(IDockerCacheOption), fullyQualifiedName: "@alicloud/ros-cdk-core.DockerCacheOption")]
    public interface IDockerCacheOption
    {
        ...
        /// <summary>Options for configuring the Docker cache backend.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDockerCacheOption), fullyQualifiedName: "@alicloud/ros-cdk-core.DockerCacheOption")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Core.IDockerCacheOption
        {
