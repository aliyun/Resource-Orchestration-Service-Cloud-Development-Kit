...
namespace AlibabaCloud.SDK.ROS.CDK.Ram
{
    ...
    public class RosSAMLProviderProps : AlibabaCloud.SDK.ROS.CDK.Ram.IRosSAMLProviderProps
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "samlProviderName", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "samlMetadataDocument", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "samlMetadataDocumentUrl", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
