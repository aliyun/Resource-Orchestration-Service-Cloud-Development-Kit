...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::RAM::User`, which is used to query the information about a Resource Access Management (RAM) user.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.RosUser), fullyQualifiedName: "@alicloud/ros-cdk-ram.datasource.RosUser", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-ram.datasource.RosUserProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosUser : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosUser(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IRosUserProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IRosUserProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.RosUser))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Comments: The comments of the RAM user.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DisplayName: The display name of the RAM user.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Email: The email address of the RAM user.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MobilePhone: The mobile phone number of the RAM user.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserId: The ID of the RAM user.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserName: The name of the RAM user.
        /// </remarks>
