...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RAM::AppSecret`, which is used to create an application secret.</summary>
    /// <remarks>
    ...
    public class AppSecret : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ram.IAppSecretProps Props
        {
