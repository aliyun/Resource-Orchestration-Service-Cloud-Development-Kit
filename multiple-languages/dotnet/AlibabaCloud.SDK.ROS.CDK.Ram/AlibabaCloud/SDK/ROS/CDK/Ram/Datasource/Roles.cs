...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::RAM::Roles`, which is used to query the information about Resource Access Management (RAM) roles.</summary>
    /// <remarks>
    ...
    public class Roles : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IRolesProps Props
        {
