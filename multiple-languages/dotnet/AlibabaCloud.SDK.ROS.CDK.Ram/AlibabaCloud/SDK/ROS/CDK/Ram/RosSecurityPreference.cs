...
namespace AlibabaCloud.SDK.ROS.CDK.Ram
{
    ...
    public class RosSecurityPreference : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSecurityPreference(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ram.IRosSecurityPreferenceProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
