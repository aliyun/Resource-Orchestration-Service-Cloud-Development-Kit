...
namespace AlibabaCloud.SDK.ROS.CDK.Ram.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IPolicies), fullyQualifiedName: "@alicloud/ros-cdk-ram.datasource.IPolicies")]
    public interface IPolicies : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IPoliciesProps Props
        {
            get;
        }

        /// <summary>Represents a `Policies`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPolicies), fullyQualifiedName: "@alicloud/ros-cdk-ram.datasource.IPolicies")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IPolicies
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ram.datasource.PoliciesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ram.Datasource.IPoliciesProps Props
            {
