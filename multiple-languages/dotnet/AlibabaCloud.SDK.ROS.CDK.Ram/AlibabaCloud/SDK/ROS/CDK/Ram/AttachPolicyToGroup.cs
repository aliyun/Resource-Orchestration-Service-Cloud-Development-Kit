...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RAM::AttachPolicyToGroup`, which is used to attach a policy to a user group.</summary>
    /// <remarks>
