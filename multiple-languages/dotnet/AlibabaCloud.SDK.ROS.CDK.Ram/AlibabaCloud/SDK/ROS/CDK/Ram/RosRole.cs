...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RAM::Role`The , which resource creates a RAM role.</summary>
    /// <remarks>
    ...
    public class RosRole : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ram.RosRole.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ram.RosRole.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ram.RosRole.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ram.RosRole.ITagsProperty
            {
                private _Proxy(ByRefValue reference): base(reference)
                {
                }
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-ram.RosRole.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Ram.RosRole.ITagsProperty
        {
            private object _key;
