...
namespace AlibabaCloud.SDK.ROS.CDK.Ram
{
    ...
    [JsiiInterface(nativeType: typeof(IUser), fullyQualifiedName: "@alicloud/ros-cdk-ram.IUser")]
    public interface IUser : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ram.IUserProps Props
        {
            get;
        }

        /// <summary>Represents a `User`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IUser), fullyQualifiedName: "@alicloud/ros-cdk-ram.IUser")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ram.IUser
        {
            ...
            /// <summary>Attribute LastLoginDate: Last login date of ram user.</summary>
            [JsiiProperty(name: "attrLastLoginDate", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrLastLoginDate
            {
                get => GetInstanceProperty<object>()!;
            }
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ram.UserProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ram.IUserProps Props
            {
