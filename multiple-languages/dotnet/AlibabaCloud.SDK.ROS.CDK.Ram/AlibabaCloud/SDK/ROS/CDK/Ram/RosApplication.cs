...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RAM::Application`ALIYUN::RAM::Group is used to create a Resource Access Management (RAM) user group.</summary>
    /// <remarks>
