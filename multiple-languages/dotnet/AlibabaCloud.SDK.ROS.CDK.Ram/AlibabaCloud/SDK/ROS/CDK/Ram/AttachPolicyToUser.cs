...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RAM::AttachPolicyToUser`, which is used to grant permissions to a specified user.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosAttachPolicyToUser`for a more convenient development experience.
    ...
    public class AttachPolicyToUser : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ram.IAttachPolicyToUser
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ram.IAttachPolicyToUserProps Props
        {
