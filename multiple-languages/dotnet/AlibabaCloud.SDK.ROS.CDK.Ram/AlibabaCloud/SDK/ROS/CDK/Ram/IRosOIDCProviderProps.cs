...
{
    /// <summary>Properties for defining a `RosOIDCProvider`.</summary>
    /// <remarks>
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ram-oidcprovider
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IRosOIDCProviderProps), fullyQualifiedName: "@alicloud/ros-cdk-ram.RosOIDCProviderProps")]
    public interface IRosOIDCProviderProps
    {
        /// <remarks>
        /// <strong>Property</strong>: fingerprints: The list of the fingerprints, max length is 5
        /// </remarks>
        ...
        /// <remarks>
        /// <strong></strong>: ). The URL cannot be a fragment URL that contains number signs (#).
        /// The URL can be up to 255 characters in length.
        ///
        /// <strong>Property</strong>: issuerUrl: The URL of the issuer, which is provided by the external IdP. The URL of the issuer must be unique within an Alibaba Cloud account.
        ...
        /// <remarks>
        /// <strong>Property</strong>: oidcProviderName: The name of the OIDC IdP.
        ...
        /// <remarks>
        /// <strong>Property</strong>: clientIds: The list of the client IDs, max length is 20
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: description: The description of the OIDC IdP.
        ...
        /// <remarks>
        /// <strong>Property</strong>: issuanceLimitTime: The earliest time when an external IdP can issue an ID token. If the value of the iat field in the ID token is later than the current time, the request is rejected. Unit: hours. Valid values: 1 to 168.
        /// </remarks>
        ...
        /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ram-oidcprovider
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IRosOIDCProviderProps), fullyQualifiedName: "@alicloud/ros-cdk-ram.RosOIDCProviderProps")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ram.IRosOIDCProviderProps
        {
