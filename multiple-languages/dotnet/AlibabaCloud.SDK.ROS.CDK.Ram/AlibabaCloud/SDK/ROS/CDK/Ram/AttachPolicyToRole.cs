...
{
    /// <summary>A ROS resource type:  `ALIYUN::RAM::AttachPolicyToRole`.</summary>
    ...
    public class AttachPolicyToRole : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public AttachPolicyToRole(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ram.IAttachPolicyToRoleProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
