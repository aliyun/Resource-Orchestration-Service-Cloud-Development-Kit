...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RAM::Role`, which is used to create a Resource Access Management (RAM) role.</summary>
    /// <remarks>
    ...
    public class Role : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ram.IRoleProps Props
        {
