...
namespace AlibabaCloud.SDK.ROS.CDK.Alb
{
    ...
    [JsiiInterface(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-alb.IListener")]
    public interface IListener : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        /// <summary>Represents a `Listener`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-alb.IListener")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Alb.IListener
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.ListenerProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Alb.IListenerProps Props
            {
