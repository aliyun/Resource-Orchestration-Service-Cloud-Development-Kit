...
{
    /// <summary>A ROS resource type:  `ALIYUN::ALB::SecurityPolicy`.</summary>
    ...
    public class SecurityPolicy : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        /// <summary>Create a new `ALIYUN::ALB::SecurityPolicy`.</summary>
        /// <remarks>
