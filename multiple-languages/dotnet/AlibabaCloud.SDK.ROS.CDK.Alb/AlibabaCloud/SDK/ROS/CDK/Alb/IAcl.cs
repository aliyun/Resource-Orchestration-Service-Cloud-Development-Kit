...
namespace AlibabaCloud.SDK.ROS.CDK.Alb
{
    ...
    [JsiiInterface(nativeType: typeof(IAcl), fullyQualifiedName: "@alicloud/ros-cdk-alb.IAcl")]
    public interface IAcl : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Alb.IAclProps Props
        {
            get;
        }

        /// <summary>Represents a `Acl`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAcl), fullyQualifiedName: "@alicloud/ros-cdk-alb.IAcl")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Alb.IAcl
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.AclProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Alb.IAclProps Props
            {
