...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ALB::LoadBalancer`The , which type is used to create an Application Load Balancer (ALB) instance.</summary>
    /// <remarks>
