...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ALB::AScript`.</summary>
    /// <remarks>
    ...
    public class AScript : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Alb.IAScript
    {
        ...
        public virtual object AttrAScriptId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.AScriptProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Alb.IAScriptProps Props
        {
