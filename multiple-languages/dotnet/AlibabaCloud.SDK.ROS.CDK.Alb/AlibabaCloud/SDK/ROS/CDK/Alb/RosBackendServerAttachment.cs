...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ALB::BackendServerAttachment`Use , which to add backend servers to a server group.</summary>
    /// <remarks>
