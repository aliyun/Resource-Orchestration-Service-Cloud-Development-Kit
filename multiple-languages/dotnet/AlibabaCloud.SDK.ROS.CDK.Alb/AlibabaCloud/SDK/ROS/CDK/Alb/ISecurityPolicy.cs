...
namespace AlibabaCloud.SDK.ROS.CDK.Alb
{
    ...
    [JsiiInterface(nativeType: typeof(ISecurityPolicy), fullyQualifiedName: "@alicloud/ros-cdk-alb.ISecurityPolicy")]
    public interface ISecurityPolicy : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Alb.ISecurityPolicyProps Props
        {
            get;
        }

        /// <summary>Represents a `SecurityPolicy`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISecurityPolicy), fullyQualifiedName: "@alicloud/ros-cdk-alb.ISecurityPolicy")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Alb.ISecurityPolicy
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.SecurityPolicyProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Alb.ISecurityPolicyProps Props
            {
