...
namespace AlibabaCloud.SDK.ROS.CDK.Alb.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(ILoadBalancers), fullyQualifiedName: "@alicloud/ros-cdk-alb.datasource.ILoadBalancers")]
    public interface ILoadBalancers : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Alb.Datasource.ILoadBalancersProps Props
        {
            get;
        }

        /// <summary>Represents a `LoadBalancers`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancers), fullyQualifiedName: "@alicloud/ros-cdk-alb.datasource.ILoadBalancers")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Alb.Datasource.ILoadBalancers
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.datasource.LoadBalancersProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Alb.Datasource.ILoadBalancersProps Props
            {
