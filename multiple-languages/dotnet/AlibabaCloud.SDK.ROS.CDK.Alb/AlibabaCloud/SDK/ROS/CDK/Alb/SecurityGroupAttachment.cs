...
namespace AlibabaCloud.SDK.ROS.CDK.Alb
{
    ...
    public class SecurityGroupAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Alb.ISecurityGroupAttachment
    {
        ...
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Alb.ISecurityGroupAttachmentProps props, bool? enableResourcePropertyConstraint = null)
        {
