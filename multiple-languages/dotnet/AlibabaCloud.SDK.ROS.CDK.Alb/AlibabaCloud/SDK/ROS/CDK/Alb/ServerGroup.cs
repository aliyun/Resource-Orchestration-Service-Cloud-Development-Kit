...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ALB::ServerGroup`, which is used to create a server group.</summary>
    /// <remarks>
    ...
    public class ServerGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Alb.IServerGroup
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-alb.ServerGroupProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Alb.IServerGroupProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Alb.IServerGroupProps>()!;
        }
