...
namespace AlibabaCloud.SDK.ROS.CDK.Alb
{
    ...
    public class ServerGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public ServerGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Alb.IServerGroupProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
