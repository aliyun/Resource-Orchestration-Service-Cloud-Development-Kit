...
namespace AlibabaCloud.SDK.ROS.CDK.Kms
{
    ...
    public class RosAlias : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosAlias(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kms.IRosAliasProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
