...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::KMS::Alias`, which is used to create an alias for a Customer Master Key (CMK).</summary>
    /// <remarks>
    ...
    public class Alias : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Kms.IAlias
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Kms.IAliasProps Props
        {
