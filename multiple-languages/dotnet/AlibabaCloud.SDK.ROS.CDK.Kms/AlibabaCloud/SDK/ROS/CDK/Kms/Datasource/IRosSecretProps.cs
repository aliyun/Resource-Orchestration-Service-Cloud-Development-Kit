...
namespace AlibabaCloud.SDK.ROS.CDK.Kms.Datasource
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IRosSecretProps), fullyQualifiedName: "@alicloud/ros-cdk-kms.datasource.RosSecretProps")]
    public interface IRosSecretProps
    {
        ...
        /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-kms-secret
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IRosSecretProps), fullyQualifiedName: "@alicloud/ros-cdk-kms.datasource.RosSecretProps")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.IRosSecretProps
        {
