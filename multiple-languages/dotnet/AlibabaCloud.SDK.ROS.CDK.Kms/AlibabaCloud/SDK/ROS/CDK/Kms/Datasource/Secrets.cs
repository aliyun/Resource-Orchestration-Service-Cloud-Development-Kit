...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::KMS::Secrets`, which is used to query all secrets that are created within the current account in the current region.</summary>
    /// <remarks>
    ...
    public class Secrets : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.ISecrets
    {
        ...
        public virtual object AttrSecretNames
        {
        ...
        public virtual object AttrSecrets
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-kms.datasource.SecretsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.ISecretsProps Props
        {
