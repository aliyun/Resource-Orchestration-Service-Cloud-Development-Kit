...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::KMS::Key`The , which resource creates a master key.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Key` class instead of this class for a more convenient development experience.
    ...
    public class RosKey : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosKey(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kms.IRosKeyProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kms.IRosKeyProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: deletionProtection: Specifies whether to enable the release protection feature for the key. Default is false.
        /// </remarks>
        [JsiiOptional]
        ...
        public virtual object? DkmsInstanceId
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        /// <remarks>
        /// <strong>Property</strong>: tags: Tags to attach to key. Max support 20 tags to add during create key. Each tag with two properties Key and Value, and Key is required.
        /// </remarks>
        [JsiiOptional]
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Kms.RosKey.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Kms.RosKey.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-kms.RosKey.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-kms.RosKey.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Kms.RosKey.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-kms.RosKey.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Kms.RosKey.ITagsProperty
        {
            private object _key;
