...
namespace AlibabaCloud.SDK.ROS.CDK.Kms
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-kms.RosInstanceProps")]
    public class RosInstanceProps : AlibabaCloud.SDK.ROS.CDK.Kms.IRosInstanceProps
    {
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Kms.RosInstance.IConnectionProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Kms.RosInstance.IConnectionProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _connection = value;
            }
