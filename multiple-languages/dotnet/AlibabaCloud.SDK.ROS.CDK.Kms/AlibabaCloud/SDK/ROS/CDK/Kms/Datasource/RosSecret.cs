...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::KMS::Secret`, which is used to query the information about a secret.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.RosSecret), fullyQualifiedName: "@alicloud/ros-cdk-kms.datasource.RosSecret", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-kms.datasource.RosSecretProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosSecret : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosSecret(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.IRosSecretProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.IRosSecretProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Kms.Datasource.RosSecret))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Arn: The Alibaba Cloud Resource Name (ARN) of the secret.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AutomaticRotation: Indicates whether automatic rotation is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time when the secret was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the secret.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DKMSInstanceId: The ID of the dedicated KMS instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EncryptionKeyId: The ID of the customer master key (CMK) that is used to encrypt the secret value.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExtendedConfig: The extended configuration of the secret.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LastRotationDate: The time when the last rotation was performed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NextRotationDate: The time when the next rotation will be performed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PlannedDeleteTime: The time when the secret is scheduled to be deleted.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecretType: The type of the secret.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UpdateTime: The time when the secret was updated.
        /// </remarks>
