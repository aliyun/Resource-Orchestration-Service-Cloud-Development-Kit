...
namespace AlibabaCloud.SDK.ROS.CDK.Kms
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-kms.RosPolicyProps")]
    public class RosPolicyProps : AlibabaCloud.SDK.ROS.CDK.Kms.IRosPolicyProps
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Kms.RosPolicy.IAccessControlRulesProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Kms.RosPolicy.IAccessControlRulesProperty).FullName}; received null", nameof(value));
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Kms.RosPolicy.IAccessControlRulesProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
