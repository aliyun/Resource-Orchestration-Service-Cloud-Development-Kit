...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::MNS::Queue`.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.RosQueue), fullyQualifiedName: "@alicloud/ros-cdk-mns.datasource.RosQueue", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-mns.datasource.RosQueueProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosQueue : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosQueue(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.IRosQueueProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.IRosQueueProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.RosQueue))!;

        /// <remarks>
        /// <strong>Attribute</strong>: ActiveMessages: The total number of active messages in the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time when the queue was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DelayMessages: The total number of delayed messages in the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DelaySeconds: The delay time after which all messages that are sent to the queue can be consumed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InactiveMessages: The total number of inactive messages in the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LastModifyTime: The most recent time when the queue was modified.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LoggingEnabled: Specifies whether to enable the log management feature.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaximumMessageSize: The maximum size of a message that can be sent to the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MessageRetentionPeriod: The maximum lifetime of a message in the queue. After the time that is specified by this parameter expires, the message is deleted, regardless of whether the message has been consumed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PollingWaitSeconds: The maximum time period that a ReceiveMessage request can wait till a message is in the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: QueueInternalUrl: The internal URL of the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: QueueName: The name of the MNS queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: QueueUrl: The URL of the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VisibilityTimeout: The duration for which a message stays in the Inactive state after it is consumed from the queue.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: queueName: The name of the MNS queue.
        /// </remarks>
