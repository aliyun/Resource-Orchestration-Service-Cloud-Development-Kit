...
namespace AlibabaCloud.SDK.ROS.CDK.Mns
{
    ...
    [JsiiInterface(nativeType: typeof(ISubscription), fullyQualifiedName: "@alicloud/ros-cdk-mns.ISubscription")]
    public interface ISubscription : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Mns.ISubscriptionProps Props
        {
            get;
        }

        /// <summary>Represents a `Subscription`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISubscription), fullyQualifiedName: "@alicloud/ros-cdk-mns.ISubscription")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Mns.ISubscription
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-mns.SubscriptionProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Mns.ISubscriptionProps Props
            {
