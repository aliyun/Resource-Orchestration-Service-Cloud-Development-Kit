...
{
    /// <summary>A ROS template type:  `ALIYUN::MNS::Queue`.</summary>
    ...
    public class RosQueue : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosQueue(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mns.IRosQueueProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
