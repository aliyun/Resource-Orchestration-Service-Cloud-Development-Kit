...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::MNS::Queue`, which is used to query the information about a created queue.</summary>
    /// <remarks>
