...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::MNS::Subscriptions`, which is used to query the information about the subscriptions.</summary>
    /// <remarks>
    ...
    public class Subscriptions : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.ISubscriptions
    {
        ...
        public virtual object AttrSubscriptionIds
        {
        ...
        public virtual object AttrSubscriptions
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-mns.datasource.SubscriptionsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Mns.Datasource.ISubscriptionsProps Props
        {
