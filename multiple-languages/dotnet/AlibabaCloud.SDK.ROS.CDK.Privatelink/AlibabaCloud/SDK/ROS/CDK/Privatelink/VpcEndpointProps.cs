...
namespace AlibabaCloud.SDK.ROS.CDK.Privatelink
{
    ...
    /// <summary>Properties for defining a `VpcEndpoint`.</summary>
    /// <remarks>
    ...
    public class VpcEndpointProps : AlibabaCloud.SDK.ROS.CDK.Privatelink.IVpcEndpointProps
    {
        ...
        private object? _endpointDescription;
        ...
        private object? _protectedEnabled;
        ...
        private object? _zonePrivateIpAddressCount;
        ...
        {
            get => _zonePrivateIpAddressCount;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _zonePrivateIpAddressCount = value;
            }
        }
    }
}
