...
namespace AlibabaCloud.SDK.ROS.CDK.Tsdb
{
    ...
    public class RosInfluxDBDatabase : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInfluxDBDatabase(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Tsdb.IRosInfluxDBDatabaseProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
