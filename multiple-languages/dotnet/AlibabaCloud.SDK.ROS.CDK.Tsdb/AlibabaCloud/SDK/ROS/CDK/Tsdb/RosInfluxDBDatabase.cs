...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::TSDB::InfluxDBDatabase`.</summary>
    /// <remarks>
    ...
    public class RosInfluxDBDatabase : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInfluxDBDatabase(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Tsdb.IRosInfluxDBDatabaseProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Tsdb.IRosInfluxDBDatabaseProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosInfluxDBDatabase(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosInfluxDBDatabase(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Tsdb.RosInfluxDBDatabase))!;

        /// <remarks>
        /// <strong>Attribute</strong>: DBName: The name of database.
        /// </remarks>
