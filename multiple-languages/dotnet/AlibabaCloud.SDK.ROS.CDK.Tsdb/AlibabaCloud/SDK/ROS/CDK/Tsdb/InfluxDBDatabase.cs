...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::TSDB::InfluxDBDatabase`, which is used to create a Time Series Database (TSDB) database.</summary>
    /// <remarks>
    ...
    public class InfluxDBDatabase : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Tsdb.IInfluxDBDatabaseProps Props
        {
