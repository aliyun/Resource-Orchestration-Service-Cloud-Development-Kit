...
namespace AlibabaCloud.SDK.ROS.CDK.Tsdb
{
    ...
    public class RosHiTSDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosHiTSDBInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Tsdb.IRosHiTSDBInstanceProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
