...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudstoragegateway
{
    ...
    [JsiiInterface(nativeType: typeof(IGateway), fullyQualifiedName: "@alicloud/ros-cdk-cloudstoragegateway.IGateway")]
    public interface IGateway : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cloudstoragegateway.IGatewayProps Props
        {
            get;
        }

        /// <summary>Represents a `Gateway`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IGateway), fullyQualifiedName: "@alicloud/ros-cdk-cloudstoragegateway.IGateway")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cloudstoragegateway.IGateway
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cloudstoragegateway.GatewayProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cloudstoragegateway.IGatewayProps Props
            {
