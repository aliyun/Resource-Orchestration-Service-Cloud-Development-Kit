...
namespace AlibabaCloud.SDK.ROS.CDK.Elasticsearch
{
    ...
    public class InstanceProps : AlibabaCloud.SDK.ROS.CDK.Elasticsearch.IInstanceProps
    {
        ...
        private object? _deleteType;

        /// <summary>Property deleteType: The release type.</summary>
        /// <remarks>
        /// Valid values:
        ///
        /// <list type="bullet">
        /// <description>immediate: The cluster is immediately deleted when it is released. After the cluster is deleted, the data stored in the cluster is deleted, and the system removes the cluster from the Logstash cluster list.</description>
        /// <description>protective (default): The instance is frozen for 24 hours before data is completely cleared. During this period, the instance is still displayed in the instance list. You can select Restore Instance or Release Now.</description>
        /// </list>
        /// </remarks>
        [JsiiOptional]
        ...
        private object? _enableKibanaPrivate;
        ...
        public object? EnableKibanaPrivate
        {
            ...
            set
            {
                ...
                _enableKibanaPrivate = value;
            }
        }

        private object? _enableKibanaPublic;
        ...
        public object? EnableKibanaPublic
        {
            ...
            set
            {
                ...
                _enableKibanaPublic = value;
            }
        }

        private object? _enablePublic;
        ...
        private object? _kibanaWhitelist;
        ...
        public object? KibanaWhitelist
        {
            ...
            set
            {
                ...
                _kibanaWhitelist = value;
            }
        }

        private object? _masterNode;
        ...
        private object? _privateWhitelist;
        ...
        public object? PrivateWhitelist
        {
            ...
            set
            {
                ...
                _privateWhitelist = value;
            }
        }

        private object? _publicWhitelist;
