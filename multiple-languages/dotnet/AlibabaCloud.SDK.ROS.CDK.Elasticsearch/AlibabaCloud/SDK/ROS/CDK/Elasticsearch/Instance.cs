...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ElasticSearch::Instance`, which is used to create an Elasticsearch cluster.</summary>
    /// <remarks>
