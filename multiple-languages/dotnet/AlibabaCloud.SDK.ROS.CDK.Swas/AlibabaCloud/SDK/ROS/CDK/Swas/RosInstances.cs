...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::SWAS::Instances`ALIYUN::SLB::BackendServerAttachment is used to attach backend servers to an SLB instance.</summary>
    /// <remarks>
