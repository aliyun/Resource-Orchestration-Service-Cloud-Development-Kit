...
namespace AlibabaCloud.SDK.ROS.CDK.Swas
{
    ...
    [JsiiInterface(nativeType: typeof(IRunCommand), fullyQualifiedName: "@alicloud/ros-cdk-swas.IRunCommand")]
    public interface IRunCommand : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrInvokeResult
        {
            get;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-swas.RunCommandProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Swas.IRunCommandProps Props
        {
            get;
        }

        /// <summary>Represents a `RunCommand`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRunCommand), fullyQualifiedName: "@alicloud/ros-cdk-swas.IRunCommand")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Swas.IRunCommand
        {
            ...
            /// <summary>Attribute InvokeResult: The result of the command execution.</summary>
            [JsiiProperty(name: "attrInvokeResult", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrInvokeResult
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-swas.RunCommandProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Swas.IRunCommandProps Props
            {
