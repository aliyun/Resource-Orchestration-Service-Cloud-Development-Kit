...
namespace AlibabaCloud.SDK.ROS.CDK.Cxapi
{
    ...
    {
        public TreeCloudArtifact(AlibabaCloud.SDK.ROS.CDK.Cxapi.CloudAssembly assembly, string name, AlibabaCloud.SDK.ROS.CDK.Assembly.Schema.IArtifactManifest artifact): base(_MakeDeputyProps(assembly, name, artifact))
        {
        }
