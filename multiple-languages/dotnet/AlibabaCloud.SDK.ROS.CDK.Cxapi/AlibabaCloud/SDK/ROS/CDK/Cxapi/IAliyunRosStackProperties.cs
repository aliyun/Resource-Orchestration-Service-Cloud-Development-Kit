...
namespace AlibabaCloud.SDK.ROS.CDK.Cxapi
{
    ...
    [JsiiInterface(nativeType: typeof(IAliyunRosStackProperties), fullyQualifiedName: "@alicloud/ros-cdk-cxapi.AliyunRosStackProperties")]
    public interface IAliyunRosStackProperties
    {
        ...
        /// <summary>Artifact properties for ROS stacks.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAliyunRosStackProperties), fullyQualifiedName: "@alicloud/ros-cdk-cxapi.AliyunRosStackProperties")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cxapi.IAliyunRosStackProperties
        {
