...
namespace AlibabaCloud.SDK.ROS.CDK.Aligreen
{
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Aligreen.RosKeywordLib), fullyQualifiedName: "@alicloud/ros-cdk-aligreen.RosKeywordLib", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-aligreen.RosKeywordLibProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosKeywordLib : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosKeywordLib(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Aligreen.IRosKeywordLibProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Aligreen.IRosKeywordLibProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosKeywordLib(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosKeywordLib(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Aligreen.RosKeywordLib))!;

        /// <remarks>
        /// <strong>Attribute</strong>: BizTypes: The business scenario.
        /// </remarks>
        [JsiiProperty(name: "attrBizTypes", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrBizTypes
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Category: The category of the text library.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Enable: Specifies whether to enable text library.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: KeywordLibId: The ID of the primary key of the keyword library.
        /// </remarks>
        [JsiiProperty(name: "attrKeywordLibId", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrKeywordLibId
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: KeywordLibName: The name of the keyword library defined by the customer.
        /// </remarks>
        [JsiiProperty(name: "attrKeywordLibName", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrKeywordLibName
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Language: Language used by the text Library.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LibType: The category of the text library in each moderation scenario.
        /// </remarks>
        [JsiiProperty(name: "attrLibType", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrLibType
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: MatchMode: The matching method.
        /// </remarks>
        [JsiiProperty(name: "attrMatchMode", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrMatchMode
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: ResourceType: The moderation scenario to which the text library applies.
        /// </remarks>
        ...
        public virtual object KeywordLibName
        {
        ...
        public virtual object? BizTypes
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? MatchMode
        {
            get => GetInstanceProperty<object?>();
            set
            {
