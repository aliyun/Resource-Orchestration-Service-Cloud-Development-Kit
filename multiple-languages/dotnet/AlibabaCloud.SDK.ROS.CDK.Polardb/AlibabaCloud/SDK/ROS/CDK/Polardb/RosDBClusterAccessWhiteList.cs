...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::POLARDB::DBClusterAccessWhiteList`, which is used to modify the IP address whitelist that allows access to a PolarDB cluster.</summary>
    /// <remarks>
    ...
    public class RosDBClusterAccessWhiteList : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDBClusterAccessWhiteList(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Polardb.IRosDBClusterAccessWhiteListProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Polardb.IRosDBClusterAccessWhiteListProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? DbClusterIpArrayName
        {
            get => GetInstanceProperty<object?>();
            set
            {
