...
namespace AlibabaCloud.SDK.ROS.CDK.Polardb
{
    ...
    public class DBInstance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-polardb.DBInstanceProps\"}")]
        protected virtual AlibabaCloud.SDK.ROS.CDK.Polardb.IDBInstanceProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Polardb.IDBInstanceProps>()!;
            set => SetInstanceProperty(value);
        }
