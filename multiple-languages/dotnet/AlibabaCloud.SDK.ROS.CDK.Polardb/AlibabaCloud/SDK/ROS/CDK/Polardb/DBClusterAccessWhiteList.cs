...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::POLARDB::DBClusterAccessWhiteList`, which is used to modify the IP address whitelist that allows access to a PolarDB cluster.</summary>
    /// <remarks>
