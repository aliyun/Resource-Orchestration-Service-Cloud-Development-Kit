...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::POLARDB::DBClusterAccessWhiteList`, which is used to modify the list of IP addresses that are allowed to access an ApsaraDB for POLARDB cluster.</summary>
    /// <remarks>
    ...
    public class DBClusterAccessWhiteList : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Polardb.IDBClusterAccessWhiteList
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Polardb.IDBClusterAccessWhiteListProps Props
        {
