...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::POLARDB::Account`The , which resource type creates accounts for PolarDB databases.</summary>
    /// <remarks>
