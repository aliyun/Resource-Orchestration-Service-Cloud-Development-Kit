...
{
    /// <summary>Represents a `DBNodes`.</summary>
    [JsiiInterface(nativeType: typeof(IDBNodes), fullyQualifiedName: "@alicloud/ros-cdk-polardb.IDBNodes")]
    public interface IDBNodes : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Polardb.IDBNodesProps Props
        {
            get;
        }

        /// <summary>Represents a `DBNodes`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDBNodes), fullyQualifiedName: "@alicloud/ros-cdk-polardb.IDBNodes")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Polardb.IDBNodes
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-polardb.DBNodesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Polardb.IDBNodesProps Props
            {
