...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::POLARDB::DBInstance`, which is used to create a database in a PolarDB cluster.</summary>
    /// <remarks>
    ...
    public class RosDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDBInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Polardb.IRosDBInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Polardb.IRosDBInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? DbDescription
        {
            get => GetInstanceProperty<object?>();
            set
            {
