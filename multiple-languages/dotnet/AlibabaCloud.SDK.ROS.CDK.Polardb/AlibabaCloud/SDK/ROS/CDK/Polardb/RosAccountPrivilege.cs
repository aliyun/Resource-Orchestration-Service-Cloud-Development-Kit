...
{
    /// <summary>A ROS template type:  `ALIYUN::POLARDB::AccountPrivilege`.</summary>
    ...
    public class RosAccountPrivilege : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosAccountPrivilege(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Polardb.IRosAccountPrivilegeProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
