...
{
    /// <summary>Represents a `ElasticDBInstance`.</summary>
    [JsiiInterface(nativeType: typeof(IElasticDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.IElasticDBInstance")]
    public interface IElasticDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Gpdb.IElasticDBInstanceProps Props
        {
            get;
        }

        /// <summary>Represents a `ElasticDBInstance`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IElasticDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.IElasticDBInstance")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Gpdb.IElasticDBInstance
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-gpdb.ElasticDBInstanceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Gpdb.IElasticDBInstanceProps Props
            {
