...
namespace AlibabaCloud.SDK.ROS.CDK.Gpdb
{
    ...
    [JsiiInterface(nativeType: typeof(IDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.IDBInstance")]
    public interface IDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Gpdb.IDBInstanceProps Props
        {
            get;
        }

        /// <summary>Represents a `DBInstance`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.IDBInstance")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Gpdb.IDBInstance
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-gpdb.DBInstanceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Gpdb.IDBInstanceProps Props
            {
