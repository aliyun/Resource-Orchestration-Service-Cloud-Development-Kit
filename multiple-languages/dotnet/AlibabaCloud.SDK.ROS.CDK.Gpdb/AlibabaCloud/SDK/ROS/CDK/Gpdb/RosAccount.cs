...
namespace AlibabaCloud.SDK.ROS.CDK.Gpdb
{
    ...
    public class RosAccount : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosAccount(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Gpdb.IRosAccountProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
