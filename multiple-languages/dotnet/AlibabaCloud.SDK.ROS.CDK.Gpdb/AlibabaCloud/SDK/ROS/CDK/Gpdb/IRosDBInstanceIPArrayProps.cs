...
{
    /// <summary>Properties for defining a `RosDBInstanceIPArray`.</summary>
    /// <remarks>
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-dbinstanceiparray
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IRosDBInstanceIPArrayProps), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.RosDBInstanceIPArrayProps")]
    public interface IRosDBInstanceIPArrayProps
    {
        /// <remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: dbInstanceIpArrayName: The name of the IP address whitelist. If you do not specify this parameter, the default whitelist is queried.
        ...
        /// <remarks>
        /// <strong>Property</strong>: securityIpList: The IP address whitelist contains a maximum of 1000 IP addresses separated by commas in the following three formats:
        /// - 0.0.0.0\/0
        /// - 10.23.12.24(IP)
        ...
        /// <remarks>
        /// <strong>Property</strong>: dbInstanceIpArrayAttribute: The default is empty. To distinguish between different attribute values, the console does not display groups with the 'hidden' attribute.
        /// </remarks>
        ...
        /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-dbinstanceiparray
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IRosDBInstanceIPArrayProps), fullyQualifiedName: "@alicloud/ros-cdk-gpdb.RosDBInstanceIPArrayProps")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Gpdb.IRosDBInstanceIPArrayProps
        {
