...
namespace AlibabaCloud.SDK.ROS.CDK.Ddospro
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-ddospro.ProInstanceProps")]
    public class ProInstanceProps : AlibabaCloud.SDK.ROS.CDK.Ddospro.IProInstanceProps
    {
        ...
        private object? _serviceBandwidth;
        ...
        public object? ServiceBandwidth
        {
            ...
            set
            {
                ...
                _serviceBandwidth = value;
            }
        }

        private object? _servicePartner;
