...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::BSS::ResourcePackage`, which is used to create an instance that uses a resource plan.</summary>
    /// <remarks>
    ...
    public class ResourcePackage : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Bss.IResourcePackageProps Props
        {
