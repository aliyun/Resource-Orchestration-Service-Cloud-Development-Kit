...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLB::TLSPolicies`, which is used to query Transport Layer Security (TLS) policies.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosTLSPolicies`for a more convenient development experience.
    ...
    public class TLSPolicies : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ITLSPolicies
    {
        ...
        public virtual object AttrTlsPolicies
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-slb.datasource.TLSPoliciesProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ITLSPoliciesProps Props
        {
