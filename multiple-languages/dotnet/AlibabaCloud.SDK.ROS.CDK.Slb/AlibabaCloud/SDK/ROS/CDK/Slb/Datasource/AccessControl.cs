...
namespace AlibabaCloud.SDK.ROS.CDK.Slb.Datasource
{
    ...
    public class AccessControl : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "attrRelatedListeners", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrRelatedListeners
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.IAccessControlProps Props
        {
