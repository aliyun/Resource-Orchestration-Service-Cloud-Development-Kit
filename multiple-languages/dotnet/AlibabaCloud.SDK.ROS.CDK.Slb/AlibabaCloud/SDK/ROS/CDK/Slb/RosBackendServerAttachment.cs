...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::SLB::BackendServerAttachment`The , which resource type adds backend servers to a Server Load Balancer (SLB) instance.</summary>
    /// <remarks>
    ...
    public class RosBackendServerAttachment : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosBackendServerAttachment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.IRosBackendServerAttachmentProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.IRosBackendServerAttachmentProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? BackendServerList
        {
            get => GetInstanceProperty<object?>();
            set
            {
