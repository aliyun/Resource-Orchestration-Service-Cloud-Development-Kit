...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SLB::LoadBalancer`Use the , which resource type to create an SLB instance.</summary>
    /// <remarks>
