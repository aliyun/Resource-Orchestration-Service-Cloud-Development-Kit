...
namespace AlibabaCloud.SDK.ROS.CDK.Slb.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(ILoadBalancersProps), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.LoadBalancersProps")]
    public interface ILoadBalancersProps
    {
        /// <summary>Property address: The service address of the load balancing instance.</summary>
        ...
        /// <summary>Property internetChargeType: Public network type instance payment method.</summary>
        ...
        /// <summary>Property loadBalancerId: ID of the load balancing instance.</summary>
        ...
        /// <summary>Property loadBalancerName: Name of the load balancing instance.</summary>
        ...
        /// <summary>Property masterZoneId: ID of the primary available area of the load balancing instance.</summary>
        ...
        /// <summary>Property networkType: The network type of the private network load balancing instance.</summary>
        ...
        /// <summary>Property paymentType: Load balancing instance payment type.</summary>
        ...
        /// <summary>Property slaveZoneId: ID of the ready-to-use zone of the load balancing instance.</summary>
        ...
        /// <summary>Property status: The status of SLB.</summary>
        ...
        /// <summary>Property vSwitchId: The ID of the switch.</summary>
        ...
        /// <summary>Properties for defining a `DATASOURCE::SLB::LoadBalancers`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancersProps), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.LoadBalancersProps")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ILoadBalancersProps
        {
