...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLB::LoadBalancer`, which is used to query the information about a Classic Load Balancer (CLB) instance.</summary>
    /// <remarks>
