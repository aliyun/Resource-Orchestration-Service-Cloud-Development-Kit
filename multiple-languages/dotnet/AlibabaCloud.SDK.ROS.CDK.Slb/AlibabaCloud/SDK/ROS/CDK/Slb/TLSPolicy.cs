...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SLB::TLSPolicy`, which is used to create a Transport Layer Security (TLS) policy.</summary>
    /// <remarks>
    ...
    public class TLSPolicy : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Slb.ITLSPolicyProps Props
        {
