...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::SLB::LoadBalancerTCPListener`, which is used to query the configurations of a TCP listener.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `LoadBalancerTCPListener` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-slb-loadbalancertcplistener
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.RosLoadBalancerTCPListener), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.RosLoadBalancerTCPListener", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-slb.datasource.RosLoadBalancerTCPListenerProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosLoadBalancerTCPListener : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosLoadBalancerTCPListener(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.IRosLoadBalancerTCPListenerProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.IRosLoadBalancerTCPListenerProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosLoadBalancerTCPListener(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosLoadBalancerTCPListener(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.RosLoadBalancerTCPListener))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AclId: The ID of the network ACL that is associated with the listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AclIds: The ID list of the network ACL that is associated with the listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AclStatus: Indicates whether access control is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AclType: The type of the ACL.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BackendServerPort: The backend port used by the CLB instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Bandwidth: The maximum bandwidth of the listener. Unit: Mbit/s.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConnectionDrain: Indicates whether connection draining is enabled. If ConnectionDrain is set to on, the parameter is returned.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConnectionDrainTimeout: The timeout period of connection draining. If ConnectionDrain is set to on, the parameter is returned.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EstablishedTimeout: The timeout period of a connection.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheck: Indicates whether the health check feature is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckConnectPort: The port that is used for health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckConnectTimeout: The timeout period. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckDomain: The domain name that is used for health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckHttpCode: The HTTP status code for a successful health check.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckInterval: The interval between two consecutive health checks. Valid values: 1 to 50. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckMethod: The health check method.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckType: The health check method that is used by the TCP listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckUri: The URL that is used for health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthyThreshold: The healthy threshold. The number of times that an unhealthy backend server must consecutively pass health checks before it is declared healthy. In this case, the health status is changed from fail to success. Valid values: 2 to 10.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ListenerPort: The frontend port used by the CLB instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MasterSlaveServerGroupId: The ID of the primary/secondary server group that is associated with the listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PersistenceTimeout: The timeout period of session persistence.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ProxyProtocolV2Enabled: Indicates whether the Proxy protocol is used to pass client IP addresses to backend servers.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SynProxy: Indicates whether the SynProxy feature of CLB is enabled for protection.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UnhealthyThreshold: The unhealthy threshold. The number of times that a healthy backend server must consecutively fail health checks before it is declared unhealthy. In this case, the health status is changed from success to fail. Valid values: 2 to 10.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VServerGroupId: The ID of the associated server group.
        /// </remarks>
