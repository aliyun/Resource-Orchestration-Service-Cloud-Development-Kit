...
namespace AlibabaCloud.SDK.ROS.CDK.Slb
{
    ...
    [JsiiInterface(nativeType: typeof(ITLSPolicy), fullyQualifiedName: "@alicloud/ros-cdk-slb.ITLSPolicy")]
    public interface ITLSPolicy : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Slb.ITLSPolicyProps Props
        {
            get;
        }

        /// <summary>Represents a `TLSPolicy`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ITLSPolicy), fullyQualifiedName: "@alicloud/ros-cdk-slb.ITLSPolicy")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Slb.ITLSPolicy
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-slb.TLSPolicyProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Slb.ITLSPolicyProps Props
            {
