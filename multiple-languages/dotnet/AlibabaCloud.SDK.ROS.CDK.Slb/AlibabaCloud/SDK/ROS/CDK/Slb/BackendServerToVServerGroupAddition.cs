...
{
    /// <summary>A ROS resource type:  `ALIYUN::SLB::BackendServerToVServerGroupAddition`.</summary>
    ...
    public class BackendServerToVServerGroupAddition : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public BackendServerToVServerGroupAddition(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.IBackendServerToVServerGroupAdditionProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
