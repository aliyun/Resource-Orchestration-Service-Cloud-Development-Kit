...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::SLB::Rule`, which is used to query the configuration details of a forwarding rule.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.RosRule), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.RosRule", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-slb.datasource.RosRuleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosRule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.IRosRuleProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.IRosRuleProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.RosRule))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Cookie: The cookie to be configured on the backend server.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CookieTimeout: The timeout period of a cookie.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Domain: The domain name that is configured in the forwarding rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheck: Specifies whether to enable health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckConnectPort: The port of the backend server that is used for health checks. Valid values: 1 to 65535.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckHttpCode: The HTTP status code that indicates a successful health check. Separate multiple HTTP status codes with commas (,). Default value: http_2xx.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckInterval: The time interval between two consecutive health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckTimeout: The timeout period of a health check response. If a backend ECS instance does not send an expected response within the specified period of time, the ECS instance is considered unhealthy.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthCheckUri: The URI that is used for health checks.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HealthyThreshold: The number of consecutive successful health checks that must occur before an unhealthy backend server is declared healthy. In this case, the health check state is changed from fail to success.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ListenerPort: The listener port that is used by the SLB instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ListenerSync: Indicates whether the forwarding rule uses the scheduling algorithm, session persistence, and health check configurations of the listener.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LoadBalancerId: The ID of the SLB instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RuleId: The ID of the forwarding rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RuleName: The name of the forwarding rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Scheduler: The scheduling algorithm.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: StickySession: Indicates whether session persistence is enabled.  Valid values: on and off.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: StickySessionType: The method that is used to handle a cookie.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UnhealthyThreshold: The number of consecutive failed health checks that must occur before a healthy backend server is declared unhealthy. In this case, the health check state is changed from success to fail.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Url: The URL that is configured in the forwarding rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VserverGroupId: The ID of the vServer group that is associated with the forwarding rule.
        /// </remarks>
