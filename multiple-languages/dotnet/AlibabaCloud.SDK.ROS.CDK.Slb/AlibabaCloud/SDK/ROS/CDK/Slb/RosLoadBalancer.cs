...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::SLB::LoadBalancer`Use the , which resource type to create an SLB instance.</summary>
    /// <remarks>
