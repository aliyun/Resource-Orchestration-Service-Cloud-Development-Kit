...
namespace AlibabaCloud.SDK.ROS.CDK.Slb.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(ILoadBalancers), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.ILoadBalancers")]
    public interface ILoadBalancers : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ILoadBalancersProps Props
        {
            get;
        }

        /// <summary>Represents a `LoadBalancers`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancers), fullyQualifiedName: "@alicloud/ros-cdk-slb.datasource.ILoadBalancers")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ILoadBalancers
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-slb.datasource.LoadBalancersProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Slb.Datasource.ILoadBalancersProps Props
            {
