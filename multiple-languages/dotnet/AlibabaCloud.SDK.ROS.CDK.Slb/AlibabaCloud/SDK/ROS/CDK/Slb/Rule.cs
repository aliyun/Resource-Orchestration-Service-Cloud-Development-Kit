...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SLB::Rule`, which is used to add forwarding rules to an HTTP or HTTPS listener.</summary>
    /// <remarks>
    ...
    public class Rule : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Slb.IRule
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Slb.IRuleProps Props
        {
