...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLB::Rule`, which is used to query the configuration details of a forwarding rule.</summary>
    /// <remarks>
