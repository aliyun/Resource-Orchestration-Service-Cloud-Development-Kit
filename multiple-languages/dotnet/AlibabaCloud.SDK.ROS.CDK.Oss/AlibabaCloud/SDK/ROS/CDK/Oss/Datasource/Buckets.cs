...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::OSS::Buckets`, which is used to query an Object Storage Service (OSS) bucket.</summary>
    /// <remarks>
    ...
    public class Buckets : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Oss.Datasource.IBucketsProps Props
        {
