...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::OSS::BucketReplication`The , which is used to specify data replication rules for an OSS bucket.</summary>
    /// <remarks>
