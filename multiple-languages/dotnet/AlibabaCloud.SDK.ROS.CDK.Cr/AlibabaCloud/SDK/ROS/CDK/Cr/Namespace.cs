...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CR::Namespace`, which is used to create a namespace.</summary>
    /// <remarks>
    ...
    public class Namespace : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cr.INamespaceProps Props
        {
