...
namespace AlibabaCloud.SDK.ROS.CDK.Cr
{
    ...
    [JsiiByValue(fqn: "@alicloud/ros-cdk-cr.RosInstanceVpcEndpointLinkedVpcProps")]
    public class RosInstanceVpcEndpointLinkedVpcProps : AlibabaCloud.SDK.ROS.CDK.Cr.IRosInstanceVpcEndpointLinkedVpcProps
    {
        ...
        private object? _enableCreateDnsRecordInPvzt;
        ...
        {
            get => _enableCreateDnsRecordInPvzt;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _enableCreateDnsRecordInPvzt = value;
            }
        }
