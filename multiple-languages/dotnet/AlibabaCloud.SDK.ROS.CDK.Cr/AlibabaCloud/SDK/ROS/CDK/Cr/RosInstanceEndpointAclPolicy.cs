...
{
    /// <summary>A ROS template type:  `ALIYUN::CR::InstanceEndpointAclPolicy`.</summary>
    ...
    public class RosInstanceEndpointAclPolicy : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInstanceEndpointAclPolicy(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cr.IRosInstanceEndpointAclPolicyProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
