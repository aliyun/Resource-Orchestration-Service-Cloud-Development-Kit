...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CR::ScanRule`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `ScanRule` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cr-scanrule
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cr.RosScanRule), fullyQualifiedName: "@alicloud/ros-cdk-cr.RosScanRule", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cr.RosScanRuleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosScanRule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosScanRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cr.IRosScanRuleProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cr.IRosScanRuleProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosScanRule(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosScanRule(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cr.RosScanRule))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: Creation time of the scan rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InstanceId: ACR Instance ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RepoNames: The list of repositories.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RepoTagFilterPattern: The tag that triggers the scan matches the regular expression.
        /// </remarks>
        [JsiiProperty(name: "attrRepoTagFilterPattern", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrRepoTagFilterPattern
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: RuleName: The scan rule name.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScanRuleId: The ID of the scan rule.
        /// </remarks>
        [JsiiProperty(name: "attrScanRuleId", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrScanRuleId
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: ScanScope: The scan scope.
        /// </remarks>
        [JsiiProperty(name: "attrScanScope", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrScanScope
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: ScanType: The scan type.
        /// </remarks>
        [JsiiProperty(name: "attrScanType", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrScanType
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: TriggerType: Trigger type.
        /// </remarks>
        [JsiiProperty(name: "attrTriggerType", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrTriggerType
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: UpdateTime: Change time of the scan rule.
        /// </remarks>
        ...
        public virtual object RepoTagFilterPattern
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object ScanScope
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object ScanType
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? RepoNames
        {
            get => GetInstanceProperty<object?>();
            set
            {
