...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ENS::Snapshot`, which is used to create a snapshot.</summary>
    /// <remarks>
    ...
    public class Snapshot : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ens.ISnapshotProps Props
        {
