...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ENS::Instances`, which is used to query the details of Edge Node Service (ENS) instances.</summary>
    /// <remarks>
