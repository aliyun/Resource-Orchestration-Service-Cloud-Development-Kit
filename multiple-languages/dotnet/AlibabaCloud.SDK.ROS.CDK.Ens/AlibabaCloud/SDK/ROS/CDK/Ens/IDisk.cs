...
namespace AlibabaCloud.SDK.ROS.CDK.Ens
{
    ...
    [JsiiInterface(nativeType: typeof(IDisk), fullyQualifiedName: "@alicloud/ros-cdk-ens.IDisk")]
    public interface IDisk : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ens.IDiskProps Props
        {
            get;
        }

        /// <summary>Represents a `Disk`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDisk), fullyQualifiedName: "@alicloud/ros-cdk-ens.IDisk")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ens.IDisk
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ens.DiskProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ens.IDiskProps Props
            {
