...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ENS::NetworkAclAssociation`.</summary>
    /// <remarks>
    ...
    public class NetworkAclAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ens.INetworkAclAssociationProps Props
        {
