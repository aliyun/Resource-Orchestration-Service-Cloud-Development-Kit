...
namespace AlibabaCloud.SDK.ROS.CDK.Ens.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-ens.datasource.IInstances")]
    public interface IInstances : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ens.Datasource.IInstancesProps Props
        {
            get;
        }

        /// <summary>Represents a `Instances`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-ens.datasource.IInstances")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ens.Datasource.IInstances
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ens.datasource.InstancesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ens.Datasource.IInstancesProps Props
            {
