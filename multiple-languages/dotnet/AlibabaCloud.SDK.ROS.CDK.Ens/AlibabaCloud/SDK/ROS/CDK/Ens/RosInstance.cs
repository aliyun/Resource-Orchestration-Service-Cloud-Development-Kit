...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ENS::Instance`, which is used to create Edge Node Service (ENS) instances.</summary>
    /// <remarks>
