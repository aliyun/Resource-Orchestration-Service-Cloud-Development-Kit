...
{
    /// <summary>A ROS template type:  `ALIYUN::SAE::Namespace`.</summary>
    ...
    public class RosNamespace : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosNamespace(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sae.IRosNamespaceProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
