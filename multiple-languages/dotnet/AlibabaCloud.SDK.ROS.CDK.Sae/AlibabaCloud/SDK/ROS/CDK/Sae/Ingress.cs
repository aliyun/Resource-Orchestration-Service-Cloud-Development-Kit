...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SAE::Ingress`, which is used to create a routing rule.</summary>
    /// <remarks>
    ...
    public class Ingress : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Sae.IIngressProps Props
        {
