...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::SAE::ApplicationScalingRule`, which is used to create an auto scaling policy for an application.</summary>
    /// <remarks>
