...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SAE::Application`The , which resource type creates a Serverless App Engine (SAE) application.</summary>
    /// <remarks>
