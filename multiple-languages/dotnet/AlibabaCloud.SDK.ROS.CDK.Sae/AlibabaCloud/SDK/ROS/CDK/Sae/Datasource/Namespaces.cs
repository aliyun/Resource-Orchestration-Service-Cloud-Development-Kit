...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SAE::Namespaces`, which is used to query namespaces.</summary>
    /// <remarks>
    ...
    public class Namespaces : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Sae.Datasource.INamespaces
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Sae.Datasource.INamespacesProps Props
        {
