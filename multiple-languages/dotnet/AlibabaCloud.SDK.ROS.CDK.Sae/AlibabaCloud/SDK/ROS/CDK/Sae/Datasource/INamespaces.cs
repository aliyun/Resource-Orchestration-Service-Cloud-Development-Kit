...
namespace AlibabaCloud.SDK.ROS.CDK.Sae.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(INamespaces), fullyQualifiedName: "@alicloud/ros-cdk-sae.datasource.INamespaces")]
    public interface INamespaces : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Sae.Datasource.INamespacesProps Props
        {
            get;
        }

        /// <summary>Represents a `Namespaces`.</summary>
        [JsiiTypeProxy(nativeType: typeof(INamespaces), fullyQualifiedName: "@alicloud/ros-cdk-sae.datasource.INamespaces")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Sae.Datasource.INamespaces
        {
            ...
            /// <summary>Attribute NamespaceIds: The list of namespace names.</summary>
            [JsiiProperty(name: "attrNamespaceIds", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrNamespaceIds
            {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-sae.datasource.NamespacesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Sae.Datasource.INamespacesProps Props
            {
