...
namespace AlibabaCloud.SDK.ROS.CDK.Cms2
{
    ...
    [JsiiInterface(nativeType: typeof(IServiceObservability), fullyQualifiedName: "@alicloud/ros-cdk-cms2.IServiceObservability")]
    public interface IServiceObservability : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cms2.IServiceObservabilityProps Props
        {
            get;
        }

        /// <summary>Represents a `ServiceObservability`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IServiceObservability), fullyQualifiedName: "@alicloud/ros-cdk-cms2.IServiceObservability")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cms2.IServiceObservability
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cms2.ServiceObservabilityProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cms2.IServiceObservabilityProps Props
            {
