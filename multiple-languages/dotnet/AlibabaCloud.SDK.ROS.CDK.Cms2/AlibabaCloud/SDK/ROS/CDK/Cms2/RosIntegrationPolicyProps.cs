...
namespace AlibabaCloud.SDK.ROS.CDK.Cms2
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-cms2.RosIntegrationPolicyProps")]
    public class RosIntegrationPolicyProps : AlibabaCloud.SDK.ROS.CDK.Cms2.IRosIntegrationPolicyProps
    {
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Cms2.RosIntegrationPolicy.IEntityGroupProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cms2.RosIntegrationPolicy.IEntityGroupProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _entityGroup = value;
            }
