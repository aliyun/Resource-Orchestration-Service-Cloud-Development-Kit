...
{
    /// <summary>Represents a `Logstore`.</summary>
    [JsiiInterface(nativeType: typeof(ILogstore), fullyQualifiedName: "@alicloud/ros-cdk-sls.ILogstore")]
    public interface ILogstore : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Sls.ILogstoreProps Props
        {
            get;
        }

        /// <summary>Represents a `Logstore`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILogstore), fullyQualifiedName: "@alicloud/ros-cdk-sls.ILogstore")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Sls.ILogstore
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-sls.LogstoreProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Sls.ILogstoreProps Props
            {
