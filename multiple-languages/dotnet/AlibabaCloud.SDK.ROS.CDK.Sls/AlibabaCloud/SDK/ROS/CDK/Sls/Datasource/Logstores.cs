...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLS::Logstores`.</summary>
    /// <remarks>
    ...
    public class Logstores : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Sls.Datasource.ILogstores
    {
        ...
        [JsiiProperty(name: "attrLogstores", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        public virtual object AttrLogstores
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-sls.datasource.LogstoresProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Sls.Datasource.ILogstoresProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Sls.Datasource.ILogstoresProps>()!;
        }
