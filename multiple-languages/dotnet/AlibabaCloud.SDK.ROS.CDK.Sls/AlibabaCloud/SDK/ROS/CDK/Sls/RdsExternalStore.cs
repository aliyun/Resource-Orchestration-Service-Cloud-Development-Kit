...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SLS::RdsExternalStore`, which is used to create an ApsaraDB RDS for MySQL external store.</summary>
    /// <remarks>
