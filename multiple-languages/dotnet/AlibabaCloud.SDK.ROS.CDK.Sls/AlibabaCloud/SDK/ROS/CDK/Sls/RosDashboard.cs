...
namespace AlibabaCloud.SDK.ROS.CDK.Sls
{
    ...
    public class RosDashboard : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDashboard(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sls.IRosDashboardProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
