...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SLS::Savedsearch`, which is used to save search results as a saved search.</summary>
    /// <remarks>
    ...
    public class Savedsearch : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Sls.ISavedsearch
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Sls.ISavedsearchProps Props
        {
