...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::SLS::Savedsearch`, which is used to save search results as a saved search.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Savedsearch` class instead of this class for a more convenient development experience.
    ...
    public class RosSavedsearch : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSavedsearch(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sls.IRosSavedsearchProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sls.IRosSavedsearchProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public class DetailProperty : AlibabaCloud.SDK.ROS.CDK.Sls.RosSavedsearch.IDetailProperty
        {
            ...
            private object _savedsearchName;
            ...
            public object SavedsearchName
            {
                ...
                set
                {
                    ...
                    _savedsearchName = value;
                }
            }

            private object _searchQuery;
