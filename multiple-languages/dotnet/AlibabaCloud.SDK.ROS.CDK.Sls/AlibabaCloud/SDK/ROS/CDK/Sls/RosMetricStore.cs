...
{
    /// <summary>A ROS template type:  `ALIYUN::SLS::MetricStore`.</summary>
    ...
    public class RosMetricStore : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosMetricStore(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sls.IRosMetricStoreProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
