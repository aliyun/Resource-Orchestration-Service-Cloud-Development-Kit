...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLS::Projects`, which is used to query the information about Simple Log Service (SLS) projects.</summary>
    /// <remarks>
