...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::SLS::Projects`, which is used to query Log Service projects.</summary>
    /// <remarks>
    ...
    public class Projects : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Sls.Datasource.IProjectsProps Props
        {
