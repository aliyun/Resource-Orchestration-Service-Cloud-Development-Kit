...
namespace AlibabaCloud.SDK.ROS.CDK.Apigateway.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-apigateway.datasource.IInstances")]
    public interface IInstances : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrApiGatewayInstanceIds
        {
            get;
        }
        ...
        object AttrApiGatewayInstances
        {
            get;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apigateway.datasource.InstancesProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Apigateway.Datasource.IInstancesProps Props
        {
            get;
        }

        /// <summary>Represents a `Instances`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-apigateway.datasource.IInstances")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apigateway.Datasource.IInstances
        {
            ...
            /// <summary>Attribute ApiGatewayInstanceIds: The list of The ApiGateway group ids.</summary>
            [JsiiProperty(name: "attrApiGatewayInstanceIds", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrApiGatewayInstanceIds
            {
            ...
            /// <summary>Attribute ApiGatewayInstances: The information about ApiGateway groups.</summary>
            [JsiiProperty(name: "attrApiGatewayInstances", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrApiGatewayInstances
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apigateway.datasource.InstancesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apigateway.Datasource.IInstancesProps Props
            {
