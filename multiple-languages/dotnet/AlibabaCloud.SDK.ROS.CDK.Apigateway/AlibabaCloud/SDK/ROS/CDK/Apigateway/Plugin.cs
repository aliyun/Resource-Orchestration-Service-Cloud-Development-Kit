...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ApiGateway::Plugin`.</summary>
    /// <remarks>
    ...
    public class Plugin : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Apigateway.IPlugin
    {
        ...
        public virtual object AttrPluginData
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrPluginName
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrPluginType
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apigateway.PluginProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Apigateway.IPluginProps Props
        {
