...
namespace AlibabaCloud.SDK.ROS.CDK.Apigateway
{
    ...
    public class RosDeployment : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDeployment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Apigateway.IRosDeploymentProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
