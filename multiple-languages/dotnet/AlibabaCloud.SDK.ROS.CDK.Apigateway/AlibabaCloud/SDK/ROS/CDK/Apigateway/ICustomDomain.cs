...
namespace AlibabaCloud.SDK.ROS.CDK.Apigateway
{
    ...
    [JsiiInterface(nativeType: typeof(ICustomDomain), fullyQualifiedName: "@alicloud/ros-cdk-apigateway.ICustomDomain")]
    public interface ICustomDomain : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apigateway.ICustomDomainProps Props
        {
            get;
        }

        /// <summary>Represents a `CustomDomain`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICustomDomain), fullyQualifiedName: "@alicloud/ros-cdk-apigateway.ICustomDomain")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apigateway.ICustomDomain
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apigateway.CustomDomainProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apigateway.ICustomDomainProps Props
            {
