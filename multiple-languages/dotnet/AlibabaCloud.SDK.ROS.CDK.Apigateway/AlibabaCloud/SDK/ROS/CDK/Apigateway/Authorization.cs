...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ApiGateway::Authorization`, which is used to authorize APIs to access applications.</summary>
    /// <remarks>
    ...
    public class Authorization : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Apigateway.IAuthorizationProps Props
        {
