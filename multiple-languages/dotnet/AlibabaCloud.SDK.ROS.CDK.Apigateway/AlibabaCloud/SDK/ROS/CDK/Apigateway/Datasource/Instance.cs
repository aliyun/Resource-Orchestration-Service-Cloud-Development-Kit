...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ApiGateway::Instance`, which is used to query the information about an instance.</summary>
    /// <remarks>
