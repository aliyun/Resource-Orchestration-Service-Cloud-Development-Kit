...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ApiGateway::CustomDomain`, which is used to bind a custom domain name and upload a Secure Sockets Layer (SSL) certificate to a specific API group.</summary>
    /// <remarks>
    ...
    public class RosCustomDomain : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCustomDomain(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Apigateway.IRosCustomDomainProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Apigateway.IRosCustomDomainProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? CertificateBody
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? CertificatePrivateKey
        {
            get => GetInstanceProperty<object?>();
            set
            {
