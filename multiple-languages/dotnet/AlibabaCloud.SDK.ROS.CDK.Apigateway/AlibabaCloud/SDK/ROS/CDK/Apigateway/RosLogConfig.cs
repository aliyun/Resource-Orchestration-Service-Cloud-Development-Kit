...
namespace AlibabaCloud.SDK.ROS.CDK.Apigateway
{
    ...
    public class RosLogConfig : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosLogConfig(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Apigateway.IRosLogConfigProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
