...
namespace AlibabaCloud.SDK.ROS.CDK.Flink
{
    ...
    [JsiiInterface(nativeType: typeof(IMember), fullyQualifiedName: "@alicloud/ros-cdk-flink.IMember")]
    public interface IMember : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrMemberInfo
        {
            get;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-flink.MemberProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Flink.IMemberProps Props
        {
            get;
        }

        /// <summary>Represents a `Member`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IMember), fullyQualifiedName: "@alicloud/ros-cdk-flink.IMember")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Flink.IMember
        {
            ...
            /// <summary>Attribute MemberInfo: The detailed info of the flink member.</summary>
            [JsiiProperty(name: "attrMemberInfo", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrMemberInfo
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-flink.MemberProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Flink.IMemberProps Props
            {
