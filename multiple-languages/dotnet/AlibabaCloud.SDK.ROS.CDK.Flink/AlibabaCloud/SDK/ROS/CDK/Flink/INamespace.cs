...
namespace AlibabaCloud.SDK.ROS.CDK.Flink
{
    ...
    [JsiiInterface(nativeType: typeof(INamespace), fullyQualifiedName: "@alicloud/ros-cdk-flink.INamespace")]
    public interface INamespace : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Flink.INamespaceProps Props
        {
            get;
        }

        /// <summary>Represents a `Namespace`.</summary>
        [JsiiTypeProxy(nativeType: typeof(INamespace), fullyQualifiedName: "@alicloud/ros-cdk-flink.INamespace")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Flink.INamespace
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-flink.NamespaceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Flink.INamespaceProps Props
            {
