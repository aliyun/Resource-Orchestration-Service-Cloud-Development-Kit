...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NLB::BackendServerAttachment`, which is used to add backend servers to a Network Load Balancer (NLB) server group.</summary>
    /// <remarks>
