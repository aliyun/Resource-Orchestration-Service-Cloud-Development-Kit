...
namespace AlibabaCloud.SDK.ROS.CDK.Nlb
{
    ...
    [JsiiInterface(nativeType: typeof(IBackendServerAttachment), fullyQualifiedName: "@alicloud/ros-cdk-nlb.IBackendServerAttachment")]
    public interface IBackendServerAttachment : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Nlb.IBackendServerAttachmentProps Props
        {
            get;
        }

        /// <summary>Represents a `BackendServerAttachment`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IBackendServerAttachment), fullyQualifiedName: "@alicloud/ros-cdk-nlb.IBackendServerAttachment")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Nlb.IBackendServerAttachment
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-nlb.BackendServerAttachmentProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Nlb.IBackendServerAttachmentProps Props
            {
