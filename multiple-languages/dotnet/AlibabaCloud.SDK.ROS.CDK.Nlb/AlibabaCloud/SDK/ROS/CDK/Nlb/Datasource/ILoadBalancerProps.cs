...
namespace AlibabaCloud.SDK.ROS.CDK.Nlb.Datasource
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(ILoadBalancerProps), fullyQualifiedName: "@alicloud/ros-cdk-nlb.datasource.LoadBalancerProps")]
    public interface ILoadBalancerProps
    {
        ...
        /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-nlb-loadbalancer
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancerProps), fullyQualifiedName: "@alicloud/ros-cdk-nlb.datasource.LoadBalancerProps")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Nlb.Datasource.ILoadBalancerProps
        {
