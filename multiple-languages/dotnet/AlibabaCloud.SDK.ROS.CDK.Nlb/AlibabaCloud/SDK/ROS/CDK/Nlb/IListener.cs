...
namespace AlibabaCloud.SDK.ROS.CDK.Nlb
{
    ...
    [JsiiInterface(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-nlb.IListener")]
    public interface IListener : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-nlb.ListenerProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Nlb.IListenerProps Props
        {
            get;
        }

        /// <summary>Represents a `Listener`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-nlb.IListener")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Nlb.IListener
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-nlb.ListenerProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Nlb.IListenerProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Nlb.IListenerProps>()!;
            }
