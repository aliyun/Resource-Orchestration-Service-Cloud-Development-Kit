...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NLB::Listener`Use the , which resource type to create a listener.</summary>
    /// <remarks>
    ...
    public class Listener : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Nlb.IListener
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Nlb.IListenerProps Props
        {
