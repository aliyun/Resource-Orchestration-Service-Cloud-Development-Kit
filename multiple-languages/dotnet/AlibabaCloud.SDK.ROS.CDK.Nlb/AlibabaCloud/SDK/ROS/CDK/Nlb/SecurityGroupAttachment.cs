...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NLB::SecurityGroupAttachment`, which is used to bind a security group to a Network Load Balancer (NLB) instance.</summary>
    /// <remarks>
    ...
    public class SecurityGroupAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Nlb.ISecurityGroupAttachment
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Nlb.ISecurityGroupAttachmentProps Props
        {
