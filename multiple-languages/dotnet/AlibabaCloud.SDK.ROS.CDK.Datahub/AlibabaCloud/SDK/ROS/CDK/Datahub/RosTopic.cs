...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::DATAHUB::Topic`, which is used to create a topic.</summary>
    /// <remarks>
    ...
    public class RosTopic : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTopic(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Datahub.IRosTopicProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Datahub.IRosTopicProps props, bool enableResourcePropertyConstraint)
        {
