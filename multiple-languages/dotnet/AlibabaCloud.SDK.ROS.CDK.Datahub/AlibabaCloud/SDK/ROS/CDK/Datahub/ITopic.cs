...
namespace AlibabaCloud.SDK.ROS.CDK.Datahub
{
    ...
    [JsiiInterface(nativeType: typeof(ITopic), fullyQualifiedName: "@alicloud/ros-cdk-datahub.ITopic")]
    public interface ITopic : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Datahub.ITopicProps Props
        {
            get;
        }

        /// <summary>Represents a `Topic`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ITopic), fullyQualifiedName: "@alicloud/ros-cdk-datahub.ITopic")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Datahub.ITopic
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-datahub.TopicProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Datahub.ITopicProps Props
            {
