...
{
    /// <summary>A ROS resource type:  `ALIYUN::ASM::ServiceMesh`.</summary>
    ...
    public class ServiceMesh : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public ServiceMesh(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Asm.IServiceMeshProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
