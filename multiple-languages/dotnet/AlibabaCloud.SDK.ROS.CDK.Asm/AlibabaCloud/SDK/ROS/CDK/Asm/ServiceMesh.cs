...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ASM::ServiceMesh`, which is used to create a Service Mesh (ASM) instance.</summary>
    /// <remarks>
    ...
    public class ServiceMesh : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Asm.IServiceMesh
    {
        ...
        public virtual object AttrServiceMeshId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-asm.ServiceMeshProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Asm.IServiceMeshProps Props
        {
