...
{
    /// <summary>Represents a `SaslUser`.</summary>
    [JsiiInterface(nativeType: typeof(ISaslUser), fullyQualifiedName: "@alicloud/ros-cdk-kafka.ISaslUser")]
    public interface ISaslUser : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Kafka.ISaslUserProps Props
        {
            get;
        }

        /// <summary>Represents a `SaslUser`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISaslUser), fullyQualifiedName: "@alicloud/ros-cdk-kafka.ISaslUser")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Kafka.ISaslUser
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-kafka.SaslUserProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Kafka.ISaslUserProps Props
            {
