...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::KAFKA::Instances`ALIYUN::KMS::Alias is used to create an alias for a Customer Master Key (CMK).</summary>
    /// <remarks>
