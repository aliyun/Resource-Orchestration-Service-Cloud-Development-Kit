...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::KAFKA::Topic`, which is used to create a topic.</summary>
    /// <remarks>
    ...
    public class RosTopic : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTopic(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kafka.IRosTopicProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Kafka.IRosTopicProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Kafka.RosTopic.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Kafka.RosTopic.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-kafka.RosTopic.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-kafka.RosTopic.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Kafka.RosTopic.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-kafka.RosTopic.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Kafka.RosTopic.ITagsProperty
        {
            private object _key;
