    ...
    public class InstanceProps : AlibabaCloud.SDK.ROS.CDK.Kafka.IInstanceProps
    {
        ...
        public object? OpenConnector
        {
            ...
            set
            {
                ...
                _openConnector = value;
            }
        }

        private object? _partitionNum;

        /// <summary>Property partitionNum: Number of partitions(recommended).</summary>
        /// <remarks>
        ...
        /// <summary>Property topicQuota: Number of topics (not recommended).</summary>
        /// <remarks>
