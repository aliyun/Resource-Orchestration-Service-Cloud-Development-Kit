...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::KAFKA::Acl`.</summary>
    /// <remarks>
    ...
    public class Acl : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Kafka.IAclProps Props
        {
