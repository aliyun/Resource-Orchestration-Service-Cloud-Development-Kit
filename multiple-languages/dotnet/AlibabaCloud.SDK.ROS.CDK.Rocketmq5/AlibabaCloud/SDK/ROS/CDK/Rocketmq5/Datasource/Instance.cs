...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ROCKETMQ5::Instance`, which is used to query the information about an instance.</summary>
    /// <remarks>
    ...
    public class Instance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Rocketmq5.Datasource.IInstance
    {
        ...
        public virtual object AttrExtConfig
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Rocketmq5.Datasource.IInstanceProps Props
        {
