...
namespace AlibabaCloud.SDK.ROS.CDK.Rocketmq5
{
    ...
    [JsiiInterface(nativeType: typeof(IConsumerGroup), fullyQualifiedName: "@alicloud/ros-cdk-rocketmq5.IConsumerGroup")]
    public interface IConsumerGroup : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Rocketmq5.IConsumerGroupProps Props
        {
            get;
        }

        /// <summary>Represents a `ConsumerGroup`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IConsumerGroup), fullyQualifiedName: "@alicloud/ros-cdk-rocketmq5.IConsumerGroup")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rocketmq5.IConsumerGroup
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-rocketmq5.ConsumerGroupProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Rocketmq5.IConsumerGroupProps Props
            {
