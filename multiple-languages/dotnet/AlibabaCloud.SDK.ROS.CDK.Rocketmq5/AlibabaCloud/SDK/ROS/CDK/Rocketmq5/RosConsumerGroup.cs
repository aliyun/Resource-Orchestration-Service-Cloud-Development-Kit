...
{
    /// <summary>A ROS template type:  `ALIYUN::ROCKETMQ5::ConsumerGroup`.</summary>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Rocketmq5.RosConsumerGroup), fullyQualifiedName: "@alicloud/ros-cdk-rocketmq5.RosConsumerGroup", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-rocketmq5.RosConsumerGroupProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosConsumerGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosConsumerGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rocketmq5.IRosConsumerGroupProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rocketmq5.IRosConsumerGroupProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Rocketmq5.RosConsumerGroup))!;

        /// <remarks>
        /// <strong>Attribute</strong>: ConsumerGroupId: The ID of the consumer group.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DeliveryOrderType: Delivery sequence of consumer group.
        /// </remarks>
        ...
        public virtual object ConsumerGroupId
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object DeliveryOrderType
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        [JsiiInterface(nativeType: typeof(IConsumeRetryPolicyProperty), fullyQualifiedName: "@alicloud/ros-cdk-rocketmq5.RosConsumerGroup.ConsumeRetryPolicyProperty")]
        public interface IConsumeRetryPolicyProperty
        {
            /// <remarks>
            /// <strong>Property</strong>: retryPolicy: Retry policy type.
            /// </remarks>
            [JsiiProperty(name: "retryPolicy", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            object RetryPolicy
            {
                get;
            }
            ...
            [JsiiTypeProxy(nativeType: typeof(IConsumeRetryPolicyProperty), fullyQualifiedName: "@alicloud/ros-cdk-rocketmq5.RosConsumerGroup.ConsumeRetryPolicyProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rocketmq5.RosConsumerGroup.IConsumeRetryPolicyProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-rocketmq5.RosConsumerGroup.ConsumeRetryPolicyProperty")]
        public class ConsumeRetryPolicyProperty : AlibabaCloud.SDK.ROS.CDK.Rocketmq5.RosConsumerGroup.IConsumeRetryPolicyProperty
        {
