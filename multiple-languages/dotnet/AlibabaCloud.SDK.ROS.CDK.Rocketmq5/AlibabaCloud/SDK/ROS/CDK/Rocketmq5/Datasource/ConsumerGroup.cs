...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ROCKETMQ5::ConsumerGroup`, which is used to query the information about a consumer group in ApsaraMQ for RocketMQ 5.0.</summary>
    /// <remarks>
