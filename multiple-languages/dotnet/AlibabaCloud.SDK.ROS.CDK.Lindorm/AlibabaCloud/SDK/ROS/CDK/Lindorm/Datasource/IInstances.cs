...
namespace AlibabaCloud.SDK.ROS.CDK.Lindorm.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-lindorm.datasource.IInstances")]
    public interface IInstances : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Lindorm.Datasource.IInstancesProps Props
        {
            get;
        }

        /// <summary>Represents a `Instances`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstances), fullyQualifiedName: "@alicloud/ros-cdk-lindorm.datasource.IInstances")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Lindorm.Datasource.IInstances
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-lindorm.datasource.InstancesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Lindorm.Datasource.IInstancesProps Props
            {
