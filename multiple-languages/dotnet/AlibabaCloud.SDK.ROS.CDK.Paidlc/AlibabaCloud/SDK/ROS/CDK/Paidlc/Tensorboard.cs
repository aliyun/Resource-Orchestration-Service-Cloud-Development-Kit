...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::PAIDLC::Tensorboard`, which is used to create a TensorBoard instance.</summary>
    /// <remarks>
    ...
    public class Tensorboard : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Paidlc.ITensorboardProps Props
        {
