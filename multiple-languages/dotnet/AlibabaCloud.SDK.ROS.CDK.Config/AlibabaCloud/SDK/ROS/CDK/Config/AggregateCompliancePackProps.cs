...
namespace AlibabaCloud.SDK.ROS.CDK.Config
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-config.AggregateCompliancePackProps")]
    public class AggregateCompliancePackProps : AlibabaCloud.SDK.ROS.CDK.Config.IAggregateCompliancePackProps
    {
