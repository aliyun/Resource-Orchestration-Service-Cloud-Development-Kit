...
{
    /// <summary>A ROS template type:  `ALIYUN::Config::DeliveryChannel`.</summary>
    ...
    public class RosDeliveryChannel : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDeliveryChannel(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Config.IRosDeliveryChannelProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
