...
namespace AlibabaCloud.SDK.ROS.CDK.Config
{
    ...
    {
        private object _configRuleTriggerTypes;
        ...
        public object ConfigRuleTriggerTypes
        {
            ...
            set
            {
                ...
                _configRuleTriggerTypes = value;
            }
        }

        private object _resourceTypesScope;
        ...
        {
            get => _maximumExecutionFrequency;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _maximumExecutionFrequency = value;
            }
        }
        ...
        private object? _tagKeyLogicScope;
