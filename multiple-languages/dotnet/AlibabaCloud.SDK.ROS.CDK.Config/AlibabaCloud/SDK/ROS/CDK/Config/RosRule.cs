...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::Config::Rule`.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Config.RosRule), fullyQualifiedName: "@alicloud/ros-cdk-config.RosRule", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-config.RosRuleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosRule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Config.IRosRuleProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Config.IRosRuleProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConfigRuleId: The ID of the rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConfigRuleTriggerTypes: The trigger type of the rule. Valid values:  ConfigurationItemChangeNotification: The rule is triggered upon configuration changes. ScheduledNotification: The rule is triggered as scheduled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EventSource: The event source of the rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExcludeResourceIdsScope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InputParameters: The settings of the input parameters for the rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaximumExecutionFrequency: The frequency of the compliance evaluations. Valid values:  One_Hour Three_Hours Six_Hours Twelve_Hours TwentyFour_Hours
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RegionIdsScope: The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ResourceGroupIdsScope: The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ResourceTypesScope: The types of the resources to be evaluated against the rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RiskLevel: The risk level of the resources that are not compliant with the rule. Valid values:  1: critical 2: warning 3: info
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RuleName: The name of the rule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SourceIdentifier: The identifier of the rule.  For a managed rule, the value is the name of the managed rule. For a custom rule, the value is the ARN of the custom rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SourceOwner: Specifies whether you or Alibaba Cloud owns and manages the rule. Valid values:  CUSTOM_FC: The rule is a custom rule and you own the rule. ALIYUN: The rule is a managed rule and Alibaba Cloud owns the rule
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TagKeyScope: The rule monitors the tag key, only applies to rules created based on managed rules
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TagValueScope: The rule monitors the tag value, only applies to rules created based on managed rules
        /// </remarks>
        ...
        public virtual object ConfigRuleTriggerTypes
        {
        ...
        public virtual object ResourceTypesScope
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object SourceOwner
        {
            get => GetInstanceProperty<object>()!;
            set
            {
