...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::Config::CompliancePack`, which is used to create a compliance package.</summary>
    /// <remarks>
    ...
    public class CompliancePack : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Config.ICompliancePackProps Props
        {
