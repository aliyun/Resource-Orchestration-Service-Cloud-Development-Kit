...
namespace AlibabaCloud.SDK.ROS.CDK.Apig.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IDomains), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IDomains")]
    public interface IDomains : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IDomainsProps Props
        {
            get;
        }

        /// <summary>Represents a `Domains`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDomains), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IDomains")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IDomains
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.datasource.DomainsProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IDomainsProps Props
            {
