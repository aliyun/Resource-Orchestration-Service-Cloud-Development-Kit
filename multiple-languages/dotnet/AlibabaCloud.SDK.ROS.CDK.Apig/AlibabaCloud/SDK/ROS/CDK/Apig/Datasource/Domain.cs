...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::APIG::Domain`Use DATASOURCE::APIG::Query domain names using domain type.</summary>
    /// <remarks>
