...
namespace AlibabaCloud.SDK.ROS.CDK.Apig.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IRoute), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IRoute")]
    public interface IRoute : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IRouteProps Props
        {
            get;
        }

        /// <summary>Represents a `Route`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRoute), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IRoute")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IRoute
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.datasource.RouteProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IRouteProps Props
            {
