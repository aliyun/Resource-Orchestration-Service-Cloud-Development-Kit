...
namespace AlibabaCloud.SDK.ROS.CDK.Apig
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-apig.ConsumerAuthorizationRuleProps")]
    public class ConsumerAuthorizationRuleProps : AlibabaCloud.SDK.ROS.CDK.Apig.IConsumerAuthorizationRuleProps
    {
        ...
        private object _resourceIdentifier;
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Apig.RosConsumerAuthorizationRule.IResourceIdentifierProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Apig.RosConsumerAuthorizationRule.IResourceIdentifierProperty).FullName}; received null", nameof(value));
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Apig.RosConsumerAuthorizationRule.IResourceIdentifierProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
        ...
        private object? _expireTimestamp;
