...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::APIG::Environments`The DATASOURCE::APIG:: Environments type is used to query environment list.</summary>
    /// <remarks>
