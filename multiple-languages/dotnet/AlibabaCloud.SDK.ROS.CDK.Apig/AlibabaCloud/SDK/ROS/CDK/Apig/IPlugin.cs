...
namespace AlibabaCloud.SDK.ROS.CDK.Apig
{
    ...
    [JsiiInterface(nativeType: typeof(IPlugin), fullyQualifiedName: "@alicloud/ros-cdk-apig.IPlugin")]
    public interface IPlugin : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.IPluginProps Props
        {
            get;
        }

        /// <summary>Represents a `Plugin`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPlugin), fullyQualifiedName: "@alicloud/ros-cdk-apig.IPlugin")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.IPlugin
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.PluginProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.IPluginProps Props
            {
