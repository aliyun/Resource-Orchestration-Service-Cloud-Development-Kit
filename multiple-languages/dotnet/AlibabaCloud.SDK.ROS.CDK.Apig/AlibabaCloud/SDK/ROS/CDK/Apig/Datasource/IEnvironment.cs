...
namespace AlibabaCloud.SDK.ROS.CDK.Apig.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IEnvironment), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IEnvironment")]
    public interface IEnvironment : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        /// <summary>Attribute Description: The description of the Environment.</summary>
        ...
        /// <summary>Attribute GatewayId: Cloud-native API Gateway ID.</summary>
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.datasource.EnvironmentProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IEnvironmentProps Props
        {
            get;
        }

        /// <summary>Represents a `Environment`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEnvironment), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IEnvironment")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IEnvironment
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.datasource.EnvironmentProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IEnvironmentProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IEnvironmentProps>()!;
            }
