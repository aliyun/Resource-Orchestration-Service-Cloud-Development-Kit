...
namespace AlibabaCloud.SDK.ROS.CDK.Apig
{
    ...
    [JsiiInterface(nativeType: typeof(IHttpApi), fullyQualifiedName: "@alicloud/ros-cdk-apig.IHttpApi")]
    public interface IHttpApi : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.IHttpApiProps Props
        {
            get;
        }

        /// <summary>Represents a `HttpApi`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IHttpApi), fullyQualifiedName: "@alicloud/ros-cdk-apig.IHttpApi")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.IHttpApi
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.HttpApiProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.IHttpApiProps Props
            {
