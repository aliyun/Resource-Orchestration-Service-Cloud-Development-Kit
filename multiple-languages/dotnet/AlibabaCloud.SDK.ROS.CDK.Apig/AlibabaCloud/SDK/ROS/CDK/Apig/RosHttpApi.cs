...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::APIG::HttpApi`.</summary>
    /// <remarks>
    ...
    public class RosHttpApi : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BasePath: The base path of the API.
        /// </remarks>
        [JsiiProperty(name: "attrBasePath", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrBasePath
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Description: Description of API.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Environments: Published Environmental Information of the API.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HttpApiId: The ID of the API.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HttpApiName: The name of the API.
        /// </remarks>
        [JsiiProperty(name: "attrHttpApiName", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrHttpApiName
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Protocols: List of API Access Protocols.
        /// </remarks>
        [JsiiProperty(name: "attrProtocols", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrProtocols
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Type: The type of HTTP API
        /// </remarks>
