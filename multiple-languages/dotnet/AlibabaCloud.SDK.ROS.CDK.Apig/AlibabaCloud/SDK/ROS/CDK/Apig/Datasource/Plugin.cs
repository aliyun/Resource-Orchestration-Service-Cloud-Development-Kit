...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::APIG::Plugin`, which is used to query the information about a plug-in.</summary>
    /// <remarks>
