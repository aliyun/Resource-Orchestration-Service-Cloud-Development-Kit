...
namespace AlibabaCloud.SDK.ROS.CDK.Apig.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IGateway), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IGateway")]
    public interface IGateway : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IGatewayProps Props
        {
            get;
        }

        /// <summary>Represents a `Gateway`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IGateway), fullyQualifiedName: "@alicloud/ros-cdk-apig.datasource.IGateway")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IGateway
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.datasource.GatewayProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.Datasource.IGatewayProps Props
            {
