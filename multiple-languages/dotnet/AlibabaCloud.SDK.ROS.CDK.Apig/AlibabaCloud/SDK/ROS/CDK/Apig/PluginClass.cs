...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::APIG::PluginClass`, which is used to create a plug-in class.</summary>
    /// <remarks>
    ...
    public class PluginClass : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Apig.IPluginClass
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Apig.IPluginClassProps Props
        {
