...
namespace AlibabaCloud.SDK.ROS.CDK.Apig
{
    ...
    [JsiiInterface(nativeType: typeof(IPluginClass), fullyQualifiedName: "@alicloud/ros-cdk-apig.IPluginClass")]
    public interface IPluginClass : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Apig.IPluginClassProps Props
        {
            get;
        }

        /// <summary>Represents a `PluginClass`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPluginClass), fullyQualifiedName: "@alicloud/ros-cdk-apig.IPluginClass")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Apig.IPluginClass
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-apig.PluginClassProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Apig.IPluginClassProps Props
            {
