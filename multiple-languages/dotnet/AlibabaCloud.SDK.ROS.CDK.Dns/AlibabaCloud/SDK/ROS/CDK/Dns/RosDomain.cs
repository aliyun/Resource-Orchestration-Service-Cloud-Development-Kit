...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::DNS::Domain`, which is used to add a domain name.</summary>
    /// <remarks>
    ...
    public class RosDomain : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDomain(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Dns.IRosDomainProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Dns.IRosDomainProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Dns.RosDomain.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Dns.RosDomain.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-dns.RosDomain.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-dns.RosDomain.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Dns.RosDomain.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-dns.RosDomain.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Dns.RosDomain.ITagsProperty
        {
            private object _key;
