...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DNS::DomainGroup`.</summary>
    /// <remarks>
    ...
    public class DomainGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Dns.IDomainGroup
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-dns.DomainGroupProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Dns.IDomainGroupProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Dns.IDomainGroupProps>()!;
        }
