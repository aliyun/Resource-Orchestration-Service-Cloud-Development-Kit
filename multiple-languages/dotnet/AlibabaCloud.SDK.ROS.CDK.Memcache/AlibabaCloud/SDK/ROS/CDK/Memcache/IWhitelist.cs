...
namespace AlibabaCloud.SDK.ROS.CDK.Memcache
{
    ...
    [JsiiInterface(nativeType: typeof(IWhitelist), fullyQualifiedName: "@alicloud/ros-cdk-memcache.IWhitelist")]
    public interface IWhitelist : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Memcache.IWhitelistProps Props
        {
            get;
        }

        /// <summary>Represents a `Whitelist`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWhitelist), fullyQualifiedName: "@alicloud/ros-cdk-memcache.IWhitelist")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Memcache.IWhitelist
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-memcache.WhitelistProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Memcache.IWhitelistProps Props
            {
