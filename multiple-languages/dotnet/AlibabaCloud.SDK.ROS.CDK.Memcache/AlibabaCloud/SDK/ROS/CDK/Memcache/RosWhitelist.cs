...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::Memcache::Whitelist`, which is used to create a Whitelist.</summary>
    /// <remarks>
    ...
    public class RosWhitelist : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosWhitelist(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Memcache.IRosWhitelistProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Memcache.IRosWhitelistProps props, bool enableResourcePropertyConstraint)
        {
