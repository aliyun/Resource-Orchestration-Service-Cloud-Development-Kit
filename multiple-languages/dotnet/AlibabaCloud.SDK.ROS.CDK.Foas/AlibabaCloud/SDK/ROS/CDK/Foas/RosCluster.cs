...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::FOAS::Cluster`, which is used to create a cluster for an order in exclusive mode.</summary>
    /// <remarks>
