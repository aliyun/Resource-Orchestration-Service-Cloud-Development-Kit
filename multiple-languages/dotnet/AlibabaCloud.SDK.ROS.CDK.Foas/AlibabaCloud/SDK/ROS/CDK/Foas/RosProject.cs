...
{
    /// <summary>A ROS template type:  `ALIYUN::FOAS::Project`.</summary>
    ...
    {
        /// <summary>Create a new `ALIYUN::FOAS::Project`.</summary>
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosProject(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Foas.IRosProjectProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        public virtual string DeployType
        {
        ...
        public virtual string ManagerIds
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
