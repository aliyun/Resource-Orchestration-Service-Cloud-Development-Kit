...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ICE::InsertMediaToSearchLib`, which is used to add a media asset to a search library.</summary>
    /// <remarks>
