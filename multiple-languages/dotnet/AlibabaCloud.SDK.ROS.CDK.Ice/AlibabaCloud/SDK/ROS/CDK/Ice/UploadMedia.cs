...
namespace AlibabaCloud.SDK.ROS.CDK.Ice
{
    ...
    public class UploadMedia : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ice.IUploadMedia
    {
        ...
        public virtual object AttrFileUrl
        {
        ...
        public virtual object AttrMediaUrl
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrUploadAddress
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrUploadAuth
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ice.UploadMediaProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ice.IUploadMediaProps Props
        {
