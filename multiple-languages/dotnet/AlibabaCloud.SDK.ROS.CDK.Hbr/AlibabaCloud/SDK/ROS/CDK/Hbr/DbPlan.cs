...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::HBR::DbPlan`, which is used to create a backup plan.</summary>
    /// <remarks>
    ...
    public class DbPlan : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Hbr.IDbPlanProps Props
        {
