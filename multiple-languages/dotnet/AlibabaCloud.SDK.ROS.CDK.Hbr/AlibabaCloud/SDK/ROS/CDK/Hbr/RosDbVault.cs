...
namespace AlibabaCloud.SDK.ROS.CDK.Hbr
{
    ...
    public class RosDbVault : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDbVault(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Hbr.IRosDbVaultProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
