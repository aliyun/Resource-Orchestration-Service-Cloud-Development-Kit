...
namespace AlibabaCloud.SDK.ROS.CDK.Hbr.Datasource
{
    ...
    /// <summary>Properties for defining a `RosVault`.</summary>
    /// <remarks>
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-hbr-vault
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-hbr.datasource.RosVaultProps")]
    public class RosVaultProps : AlibabaCloud.SDK.ROS.CDK.Hbr.Datasource.IRosVaultProps
    {
        private object _vaultId;

        /// <remarks>
        /// <strong>Property</strong>: vaultId: The ID of the backup vault.
        /// </remarks>
