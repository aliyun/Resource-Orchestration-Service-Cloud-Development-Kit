...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::HBR::DbAgent`, which is used to install a Cloud Backup backup client for a database.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `DbAgent` class instead of this class for a more convenient development experience.
    ...
    public class RosDbAgent : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDbAgent(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Hbr.IRosDbAgentProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Hbr.IRosDbAgentProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? CrossAccountRoleName
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? CrossAccountType
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? CrossAccountUserId
        {
            get => GetInstanceProperty<object?>();
            set
            {
