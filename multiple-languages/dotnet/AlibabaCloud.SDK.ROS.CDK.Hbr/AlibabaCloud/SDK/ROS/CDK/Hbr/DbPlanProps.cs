...
namespace AlibabaCloud.SDK.ROS.CDK.Hbr
{
    ...
    public class DbPlanProps : AlibabaCloud.SDK.ROS.CDK.Hbr.IDbPlanProps
    {
        ...
        private object? _continuousPlan;
        ...
        public object? ContinuousPlan
        {
            ...
            set
            {
                ...
                _continuousPlan = value;
            }
        }

        private object? _cumulativePlan;
        ...
        public object? CumulativePlan
        {
            ...
            set
            {
                ...
                _cumulativePlan = value;
            }
        }

        private object? _fullPlan;
        ...
        private object? _maxRetrySeconds;
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Hbr.RosDbPlan.ISourceProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Hbr.RosDbPlan.ISourceProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _source = value;
            }
