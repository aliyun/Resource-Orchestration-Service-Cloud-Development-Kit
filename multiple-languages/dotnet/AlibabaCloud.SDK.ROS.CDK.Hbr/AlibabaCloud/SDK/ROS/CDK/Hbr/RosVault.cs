...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::HBR::Vault`, which is used to create a backup vault.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Vault` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-vault
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Hbr.RosVault), fullyQualifiedName: "@alicloud/ros-cdk-hbr.RosVault", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-hbr.RosVaultProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosVault : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosVault(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Hbr.IRosVaultProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Hbr.IRosVaultProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosVault(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosVault(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Hbr.RosVault))!;

        /// <remarks>
        /// <strong>Attribute</strong>: BackupPlanStatistics: The statistics of backup plans that use the backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BytesDone: The amount of data that is backed up. Unit: bytes.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time when the backup vault was created. This value is a UNIX timestamp. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Dedup: Indicates whether the deduplication feature is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IndexAvailable: Indicates whether indexes are available. Indexes are available when they are not being updated.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IndexLevel: The index level.
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IndexUpdateTime: The time when the index was updated.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LatestReplicationTime: The time when the last remote backup was synchronized. This value is a UNIX timestamp. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PaymentType: PaymentType.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RedundancyType: The data redundancy type of the backup vault. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Replication: Indicates whether the backup vault is a remote backup vault. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReplicationProgress: The progress of data synchronization from the backup vault to the mirror vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReplicationSourceRegionId: The ID of the region where the remote backup vault resides.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReplicationSourceVaultId: The ID of the source vault that corresponds to the remote backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Retention: The retention period of the backup vault. Unit: days.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SearchEnabled: Indicates whether the backup search feature is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SourceTypes: The information about the data source.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: StorageSize: The usage of the backup vault. Unit: bytes.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The tags of the backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TrialInfo: The free trial information.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UpdatedTime: The time when the backup vault was updated. This value is a UNIX timestamp. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VaultId: The ID of the backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VaultName: The name of the backup vault.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VaultStatusMessage: The status message that is returned when the backup vault is in the ERROR state. This parameter is available only for remote backup vaults. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VaultStorageClass: The storage type of the backup vault. Valid value: **STANDARD**, which indicates standard storage.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VaultType: The type of the backup vault. Valid value: **STANDARD**, which indicates a standard backup vault.
        /// </remarks>
        ...
        public virtual object VaultName
        {
        ...
        public virtual object VaultType
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? EncryptType
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Hbr.RosVault.ITagsProperty[]? Tags
        {
        ...
        public virtual object? VaultStorageClass
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-hbr.RosVault.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-hbr.RosVault.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Hbr.RosVault.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-hbr.RosVault.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Hbr.RosVault.ITagsProperty
        {
            private object _key;
