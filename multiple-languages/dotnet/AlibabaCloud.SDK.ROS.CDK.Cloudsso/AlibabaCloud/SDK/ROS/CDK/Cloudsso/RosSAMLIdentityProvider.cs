...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CloudSSO::SAMLIdentityProvider`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `SAMLIdentityProvider` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cloudsso-samlidentityprovider
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cloudsso.RosSAMLIdentityProvider), fullyQualifiedName: "@alicloud/ros-cdk-cloudsso.RosSAMLIdentityProvider", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cloudsso.RosSAMLIdentityProviderProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosSAMLIdentityProvider : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosSAMLIdentityProvider(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudsso.IRosSAMLIdentityProviderProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudsso.IRosSAMLIdentityProviderProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosSAMLIdentityProvider(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosSAMLIdentityProvider(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cloudsso.RosSAMLIdentityProvider))!;
        ...
        public virtual object? EncodedMetadataDocument
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? LoginUrl
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? SsoStatus
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? WantRequestSigned
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? X509Certificate
        {
            get => GetInstanceProperty<object?>();
            set
            {
