...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CloudSSO::PermissionPolicyToAccessConfigurationAddition`, which is used to add a policy to an access configuration.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `PermissionPolicyToAccessConfigurationAddition` class instead of this class for a more convenient development experience.
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cloudsso.RosPermissionPolicyToAccessConfigurationAddition), fullyQualifiedName: "@alicloud/ros-cdk-cloudsso.RosPermissionPolicyToAccessConfigurationAddition", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cloudsso.RosPermissionPolicyToAccessConfigurationAdditionProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosPermissionPolicyToAccessConfigurationAddition : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosPermissionPolicyToAccessConfigurationAddition(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudsso.IRosPermissionPolicyToAccessConfigurationAdditionProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudsso.IRosPermissionPolicyToAccessConfigurationAdditionProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosPermissionPolicyToAccessConfigurationAddition(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosPermissionPolicyToAccessConfigurationAddition(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cloudsso.RosPermissionPolicyToAccessConfigurationAddition))!;
        ...
        public virtual object AccessConfigurationId
        {
        ...
        public virtual object PermissionPolicyName
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object PermissionPolicyType
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? InlinePolicyDocument
        {
            get => GetInstanceProperty<object?>();
            set
            {
