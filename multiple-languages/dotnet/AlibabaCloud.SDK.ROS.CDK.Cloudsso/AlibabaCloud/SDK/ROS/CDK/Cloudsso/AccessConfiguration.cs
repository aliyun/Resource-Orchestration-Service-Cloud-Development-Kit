...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CloudSSO::AccessConfiguration`, which is used to create an access configuration.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosAccessConfiguration`for a more convenient development experience.
    ...
    public class AccessConfiguration : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudsso.IAccessConfigurationProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected AccessConfiguration(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected AccessConfiguration(DeputyProps props): base(props)
        {
        }
