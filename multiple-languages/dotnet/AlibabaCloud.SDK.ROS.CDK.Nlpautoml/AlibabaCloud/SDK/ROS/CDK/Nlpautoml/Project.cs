...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::NLPAUTOML::Project`, which is used to create a project.</summary>
    /// <remarks>
    ...
    public class Project : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-nlpautoml.ProjectProps\"}")]
        protected virtual AlibabaCloud.SDK.ROS.CDK.Nlpautoml.IProjectProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Nlpautoml.IProjectProps>()!;
            set => SetInstanceProperty(value);
        }
