...
namespace AlibabaCloud.SDK.ROS.CDK.Nlpautoml
{
    ...
    public class Model : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-nlpautoml.ModelProps\"}")]
        protected virtual AlibabaCloud.SDK.ROS.CDK.Nlpautoml.IModelProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Nlpautoml.IModelProps>()!;
            set => SetInstanceProperty(value);
        }
