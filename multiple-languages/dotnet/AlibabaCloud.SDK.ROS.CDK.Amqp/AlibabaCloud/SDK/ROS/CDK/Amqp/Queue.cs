...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::AMQP::Queue`, which is used to create a queue.</summary>
    /// <remarks>
    ...
    public class Queue : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Amqp.IQueueProps Props
        {
