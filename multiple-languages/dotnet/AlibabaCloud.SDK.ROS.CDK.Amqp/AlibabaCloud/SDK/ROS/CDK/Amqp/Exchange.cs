...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::AMQP::Exchange`, which is used to create an exchange.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosExchange`for a more convenient development experience.
    ...
    public class Exchange : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Amqp.IExchange
    {
        ...
        public virtual object AttrExchangeName
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-amqp.ExchangeProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Amqp.IExchangeProps Props
        {
