...
namespace AlibabaCloud.SDK.ROS.CDK.Amqp
{
    ...
    [JsiiInterface(nativeType: typeof(IQueue), fullyQualifiedName: "@alicloud/ros-cdk-amqp.IQueue")]
    public interface IQueue : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Amqp.IQueueProps Props
        {
            get;
        }

        /// <summary>Represents a `Queue`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IQueue), fullyQualifiedName: "@alicloud/ros-cdk-amqp.IQueue")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Amqp.IQueue
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-amqp.QueueProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Amqp.IQueueProps Props
            {
