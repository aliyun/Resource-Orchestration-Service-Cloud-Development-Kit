...
namespace AlibabaCloud.SDK.ROS.CDK.Dts
{
    ...
    public class SubscriptionInstance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public SubscriptionInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Dts.ISubscriptionInstanceProps? props = null, bool? enableResourcePropertyConstraint = null): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Dts.ISubscriptionInstanceProps? props = null, bool? enableResourcePropertyConstraint = null)
        {
        ...
        /// <summary>Attribute SubscribeTopic: The topic of the change tracking instance.</summary>
