...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::DTS::SynchronizationJobs`, which is used to query the information about data synchronization tasks in Data Transmission Service (DTS).</summary>
    /// <remarks>
    ...
    public class SynchronizationJobs : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Dts.Datasource.ISynchronizationJobs
    {
        ...
        public virtual object AttrSynchronizationInstances
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-dts.datasource.SynchronizationJobsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Dts.Datasource.ISynchronizationJobsProps Props
        {
