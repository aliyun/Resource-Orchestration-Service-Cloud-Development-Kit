...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::DTS::MigrationJob`, which is used to query the execution information about a data migration task in Data Transmission Service (DTS).</summary>
    /// <remarks>
    ...
    public class MigrationJob : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Dts.Datasource.IMigrationJob
    {
        ...
        public virtual object AttrDestinationSourceEndpointRegion
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Dts.Datasource.IMigrationJobProps Props
        {
