...
{
    /// <summary>Represents a `SynchronizationJob2`.</summary>
    [JsiiInterface(nativeType: typeof(ISynchronizationJob2), fullyQualifiedName: "@alicloud/ros-cdk-dts.ISynchronizationJob2")]
    public interface ISynchronizationJob2 : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Dts.ISynchronizationJob2Props Props
        {
            get;
        }

        /// <summary>Represents a `SynchronizationJob2`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISynchronizationJob2), fullyQualifiedName: "@alicloud/ros-cdk-dts.ISynchronizationJob2")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Dts.ISynchronizationJob2
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-dts.SynchronizationJob2Props\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Dts.ISynchronizationJob2Props Props
            {
