...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DTS::SynchronizationJob2`, which is used to configure a data synchronization task.</summary>
    /// <remarks>
    ...
    public class SynchronizationJob2 : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Dts.ISynchronizationJob2Props Props
        {
