...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IKeyPairs), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IKeyPairs")]
    public interface IKeyPairs : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IKeyPairsProps Props
        {
            get;
        }

        /// <summary>Represents a `KeyPairs`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IKeyPairs), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IKeyPairs")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IKeyPairs
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.KeyPairsProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IKeyPairsProps Props
            {
