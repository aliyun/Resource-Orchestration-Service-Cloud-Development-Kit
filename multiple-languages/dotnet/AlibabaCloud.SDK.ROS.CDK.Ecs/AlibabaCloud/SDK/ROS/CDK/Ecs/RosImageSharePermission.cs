...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::ImageSharePermission`DATASOURCE::ECS::AutoSnapshotPolicies is used to query automatic snapshot policies.</summary>
    /// <remarks>
