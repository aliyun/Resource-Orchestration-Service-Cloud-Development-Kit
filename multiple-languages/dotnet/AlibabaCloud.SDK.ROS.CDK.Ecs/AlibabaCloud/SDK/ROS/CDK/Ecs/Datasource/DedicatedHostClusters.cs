...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::DedicatedHostClusters`.</summary>
    /// <remarks>
    ...
    public class DedicatedHostClusters : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDedicatedHostClusters
    {
        ...
        public virtual object AttrDedicatedHostClusterIds
        {
        ...
        public virtual object AttrDedicatedHostClusters
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.DedicatedHostClustersProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDedicatedHostClustersProps Props
        {
