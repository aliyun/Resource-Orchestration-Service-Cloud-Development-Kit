...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::Commands`, which is used to query all available commands that you created.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosCommands`for a more convenient development experience.
    ...
    public class Commands : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.ICommands
    {
        ...
        public virtual object AttrCommandIds
        {
        ...
        public virtual object AttrCommands
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.CommandsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.ICommandsProps Props
        {
