...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::Command`, which is used to create a Cloud Assistant command.</summary>
    /// <remarks>
    ...
    public class RosCommand : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCommand(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosCommandProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosCommandProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? Launcher
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.RosCommand.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosCommand.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosCommand.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.RosCommand.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-ecs.RosCommand.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Ecs.RosCommand.ITagsProperty
        {
            private object _key;
