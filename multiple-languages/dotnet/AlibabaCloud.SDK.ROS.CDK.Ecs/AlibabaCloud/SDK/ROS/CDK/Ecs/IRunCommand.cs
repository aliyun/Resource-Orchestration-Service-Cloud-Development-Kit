...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    [JsiiInterface(nativeType: typeof(IRunCommand), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IRunCommand")]
    public interface IRunCommand : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommandProps Props
        {
            get;
        }

        /// <summary>Represents a `RunCommand`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRunCommand), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IRunCommand")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommand
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.RunCommandProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommandProps Props
            {
