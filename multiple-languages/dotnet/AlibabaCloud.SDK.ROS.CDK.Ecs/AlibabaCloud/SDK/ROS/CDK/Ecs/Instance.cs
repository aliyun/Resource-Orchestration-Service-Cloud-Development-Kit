...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::Instance`The , which resource type creates an Elastic Compute Service (ECS) instance.</summary>
    /// <remarks>
    ...
    public class Instance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.IInstance
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceProps Props
        {
