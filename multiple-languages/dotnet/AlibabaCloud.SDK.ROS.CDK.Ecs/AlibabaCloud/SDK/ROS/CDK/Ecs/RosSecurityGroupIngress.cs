...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::SecurityGroupIngress`The , which resource type creates an inbound security group rule.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `SecurityGroupIngress` class instead of this class for a more convenient development experience.
    ...
    public class RosSecurityGroupIngress : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSecurityGroupIngress(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosSecurityGroupIngressProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosSecurityGroupIngressProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? Ipv6SourceCidrIp
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? SourceGroupId
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? SourceGroupOwnerId
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? SourcePrefixListId
        {
            get => GetInstanceProperty<object?>();
            set
            {
