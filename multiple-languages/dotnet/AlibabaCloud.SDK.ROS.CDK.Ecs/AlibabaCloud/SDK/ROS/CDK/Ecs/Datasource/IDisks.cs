...
{
    /// <summary>Represents a `Disks`.</summary>
    [JsiiInterface(nativeType: typeof(IDisks), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IDisks")]
    public interface IDisks : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDisksProps Props
        {
            get;
        }

        /// <summary>Represents a `Disks`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDisks), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IDisks")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDisks
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.DisksProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDisksProps Props
            {
