...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::RamRoleAttachment`.</summary>
    /// <remarks>
    ...
    public class RamRoleAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.IRamRoleAttachment
    {
        ...
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRamRoleAttachmentProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected RamRoleAttachment(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RamRoleAttachment(DeputyProps props): base(props)
        {
        }
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IRamRoleAttachmentProps Props
        {
