...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::KeyPairs`, which is used to query one or more key pairs.</summary>
    /// <remarks>
    ...
    public class KeyPairs : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IKeyPairsProps Props
        {
