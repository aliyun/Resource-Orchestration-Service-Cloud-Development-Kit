...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    {
        private object _repeatWeekdays;
        ...
        private object? _autoSnapshotPolicyName;
        ...
        public object? AutoSnapshotPolicyName
        {
            ...
            set
            {
                ...
                _autoSnapshotPolicyName = value;
            }
        }

        private object? _copiedSnapshotsRetentionDays;
        ...
        {
            get => _copiedSnapshotsRetentionDays;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _copiedSnapshotsRetentionDays = value;
            }
        }

        private object? _copyEncryptionConfiguration;
        ...
        {
            get => _copyEncryptionConfiguration;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Ecs.RosAutoSnapshotPolicy.ICopyEncryptionConfigurationProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Ecs.RosAutoSnapshotPolicy.ICopyEncryptionConfigurationProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _copyEncryptionConfiguration = value;
            }
        }
        ...
        private object? _enableCrossRegionCopy;
        ...
        private object? _targetCopyRegions;
