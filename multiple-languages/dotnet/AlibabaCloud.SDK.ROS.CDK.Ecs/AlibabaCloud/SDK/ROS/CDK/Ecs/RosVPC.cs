...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::VPC`, which is used to create a virtual private cloud (VPC).</summary>
    /// <remarks>
    ...
    public class RosVPC : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosVPC(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosVPCProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosVPCProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcName: The name of VPC
        /// </remarks>
        ...
        public virtual object? SecondaryCidrBlocks
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        /// <remarks>
        /// <strong>Property</strong>: vpcName: The value contains 1 to 128 characters and cannot start with http:\/\/ or https:\/\/
        /// </remarks>
        [JsiiOptional]
