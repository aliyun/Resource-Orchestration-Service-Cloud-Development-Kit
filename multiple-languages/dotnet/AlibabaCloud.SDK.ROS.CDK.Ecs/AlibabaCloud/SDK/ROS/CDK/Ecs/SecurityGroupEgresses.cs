...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::SecurityGroupEgresses`.</summary>
    /// <remarks>
    ...
    public class SecurityGroupEgresses : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.ISecurityGroupEgressesProps Props
        {
