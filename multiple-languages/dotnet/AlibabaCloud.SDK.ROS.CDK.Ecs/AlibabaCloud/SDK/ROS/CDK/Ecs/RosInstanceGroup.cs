...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::InstanceGroup`The , which resource creates a group of ECS instances that share identical configurations.</summary>
    /// <remarks>
