...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::Route`The , which resource type creates custom route entries.</summary>
    /// <remarks>
    ...
    public class RosRoute : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosRoute(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosRouteProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosRouteProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouteEntryId: The ID of the route entry.
        /// </remarks>
        ...
        public interface INextHopListProperty
        {
            ...
            /// <remarks>
            /// <strong>Property</strong>: nextHopType: Route entry next hop type. Now support 'RouterInterface'.
            /// </remarks>
            [JsiiProperty(name: "nextHopType", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}", isOptional: true)]
