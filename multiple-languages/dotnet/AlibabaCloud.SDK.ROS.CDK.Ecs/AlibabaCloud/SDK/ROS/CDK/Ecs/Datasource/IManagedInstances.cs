...
{
    /// <summary>Represents a `ManagedInstances`.</summary>
    [JsiiInterface(nativeType: typeof(IManagedInstances), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IManagedInstances")]
    public interface IManagedInstances : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IManagedInstancesProps Props
        {
            get;
        }

        /// <summary>Represents a `ManagedInstances`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IManagedInstances), fullyQualifiedName: "@alicloud/ros-cdk-ecs.datasource.IManagedInstances")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IManagedInstances
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.ManagedInstancesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IManagedInstancesProps Props
            {
