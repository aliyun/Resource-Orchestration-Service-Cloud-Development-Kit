...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::HpcCluster`, which is used to create a High Performance Computing (HPC) cluster.</summary>
    /// <remarks>
    ...
    public class HpcCluster : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.IHpcCluster
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IHpcClusterProps Props
        {
