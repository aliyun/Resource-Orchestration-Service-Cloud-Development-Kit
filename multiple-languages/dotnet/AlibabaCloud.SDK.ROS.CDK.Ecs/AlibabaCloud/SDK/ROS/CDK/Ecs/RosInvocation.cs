...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    public class RosInvocation : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInvocation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosInvocationProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
