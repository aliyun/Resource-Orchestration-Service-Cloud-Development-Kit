...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::ECS::Instances`, which is used to query the details of Elastic Compute Service (ECS) instances.</summary>
    /// <remarks>
