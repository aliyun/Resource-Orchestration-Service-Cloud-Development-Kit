...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::Disk`, which is used to create a cloud disk for an Elastic Compute Service (ECS) instance.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Disk` class instead of this class for a more convenient development experience.
    ...
    public class RosDisk : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDisk(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosDiskProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosDiskProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: instanceId: Create a cloud disk and automatically mount it to the specified InstanceId.
        ...
        /// <remarks>
        /// <strong>Property</strong>: zoneId: Create a pay-as-you-go cloud drive within the specified availability area.
