...
{
    /// <summary>Properties for defining a `DATASOURCE::ECS::AutoSnapshotPolicies`.</summary>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-ecs.datasource.RosAutoSnapshotPoliciesProps")]
    public class RosAutoSnapshotPoliciesProps : AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IRosAutoSnapshotPoliciesProps
    {
