...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::DeploymentSets`, which is used to query the information about deployment sets.</summary>
    /// <remarks>
    ...
    public class DeploymentSets : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDeploymentSets
    {
        ...
        public virtual object AttrDeploymentSetIds
        {
        ...
        public virtual object AttrDeploymentSets
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.DeploymentSetsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDeploymentSetsProps Props
        {
