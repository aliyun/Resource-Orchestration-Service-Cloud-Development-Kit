...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::RunCommand`, which is used to run a shell, PowerShell, or batch command on Elastic Compute Service (ECS) instances.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `RunCommand` class instead of this class for a more convenient development experience.
    ...
    public class RosRunCommand : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosRunCommand(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosRunCommandProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosRunCommandProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? RunAgainOn
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.RosRunCommand.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosRunCommand.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosRunCommand.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.RosRunCommand.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-ecs.RosRunCommand.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Ecs.RosRunCommand.ITagsProperty
        {
            private object _key;
