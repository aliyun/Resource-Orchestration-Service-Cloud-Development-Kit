...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECS::RunCommand`The , which resource type executes a Shell, PowerShell, or Batch script on one or more ECS instances.</summary>
    /// <remarks>
