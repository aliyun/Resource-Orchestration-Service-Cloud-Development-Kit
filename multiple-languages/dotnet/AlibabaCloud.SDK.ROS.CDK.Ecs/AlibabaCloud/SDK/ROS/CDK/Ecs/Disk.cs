...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::Disk`, which is used to create a cloud disk in Elastic Compute Service (ECS).</summary>
    /// <remarks>
    ...
    public class Disk : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.IDisk
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IDiskProps Props
        {
