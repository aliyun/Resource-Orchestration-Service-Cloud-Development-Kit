...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::RecommendInstanceTypes`, which is used to query the recommended Elastic Compute Service (ECS) instance types.</summary>
    /// <remarks>
    ...
    public class RecommendInstanceTypes : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IRecommendInstanceTypesProps Props
        {
