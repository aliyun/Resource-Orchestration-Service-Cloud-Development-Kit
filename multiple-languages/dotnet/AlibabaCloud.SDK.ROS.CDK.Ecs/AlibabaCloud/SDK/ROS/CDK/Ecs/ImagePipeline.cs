...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::ImagePipeline`.</summary>
    /// <remarks>
    ...
    public class ImagePipeline : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IImagePipelineProps Props
        {
