...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    public class RosDiskAttachment : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDiskAttachment(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosDiskAttachmentProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
