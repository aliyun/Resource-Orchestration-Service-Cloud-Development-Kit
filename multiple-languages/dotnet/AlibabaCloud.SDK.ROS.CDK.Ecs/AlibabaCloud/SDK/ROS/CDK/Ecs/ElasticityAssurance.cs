...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::ElasticityAssurance`.</summary>
    /// <remarks>
    ...
    public class ElasticityAssurance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IElasticityAssuranceProps Props
        {
