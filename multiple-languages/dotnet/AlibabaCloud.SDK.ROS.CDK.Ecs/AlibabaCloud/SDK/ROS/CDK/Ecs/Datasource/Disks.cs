...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::Disks`.</summary>
    /// <remarks>
    ...
    public class Disks : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDisks
    {
        ...
        public virtual object AttrDiskIds
        {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDisksProps Props
        {
