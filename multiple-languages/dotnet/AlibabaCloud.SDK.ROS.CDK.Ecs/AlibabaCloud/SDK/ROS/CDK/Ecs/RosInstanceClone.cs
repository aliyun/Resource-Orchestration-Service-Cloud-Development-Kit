...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    public class RosInstanceClone : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInstanceClone(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosInstanceCloneProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
