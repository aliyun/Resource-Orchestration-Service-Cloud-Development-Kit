...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    public class SecurityGroupIngressProps : AlibabaCloud.SDK.ROS.CDK.Ecs.ISecurityGroupIngressProps
    {
        ...
        ///
        /// <list type="bullet">
        /// <description>If a security group is in the classic network, you cannot configure prefix lists in the security group rules.</description>
        /// <description>If you specify the SourceCidrIp, Ipv6SourceCidrIp, or SourceGroupId parameter, this parameter is ignored.</description>
        /// </list>
        /// </remarks>
        [JsiiOptional]
