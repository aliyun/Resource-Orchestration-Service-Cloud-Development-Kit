...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::DeploymentSet`, which is used to create a deployment set in a specified region.</summary>
    /// <remarks>
