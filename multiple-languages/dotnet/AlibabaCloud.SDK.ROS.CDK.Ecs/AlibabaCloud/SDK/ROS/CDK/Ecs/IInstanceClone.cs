...
{
    /// <summary>Represents a `InstanceClone`.</summary>
    [JsiiInterface(nativeType: typeof(IInstanceClone), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IInstanceClone")]
    public interface IInstanceClone : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceCloneProps Props
        {
            get;
        }

        /// <summary>Represents a `InstanceClone`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstanceClone), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IInstanceClone")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceClone
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.InstanceCloneProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceCloneProps Props
            {
