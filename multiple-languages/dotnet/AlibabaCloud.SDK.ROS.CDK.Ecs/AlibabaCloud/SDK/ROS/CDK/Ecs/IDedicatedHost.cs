...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    [JsiiInterface(nativeType: typeof(IDedicatedHost), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IDedicatedHost")]
    public interface IDedicatedHost : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.IDedicatedHostProps Props
        {
            get;
        }

        /// <summary>Represents a `DedicatedHost`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDedicatedHost), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IDedicatedHost")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.IDedicatedHost
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.DedicatedHostProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.IDedicatedHostProps Props
            {
