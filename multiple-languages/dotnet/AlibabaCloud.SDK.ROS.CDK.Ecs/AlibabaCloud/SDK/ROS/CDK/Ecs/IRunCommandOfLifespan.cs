...
{
    /// <summary>Represents a `RunCommandOfLifespan`.</summary>
    [JsiiInterface(nativeType: typeof(IRunCommandOfLifespan), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IRunCommandOfLifespan")]
    public interface IRunCommandOfLifespan : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommandOfLifespanProps Props
        {
            get;
        }

        /// <summary>Represents a `RunCommandOfLifespan`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRunCommandOfLifespan), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IRunCommandOfLifespan")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommandOfLifespan
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.RunCommandOfLifespanProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.IRunCommandOfLifespanProps Props
            {
