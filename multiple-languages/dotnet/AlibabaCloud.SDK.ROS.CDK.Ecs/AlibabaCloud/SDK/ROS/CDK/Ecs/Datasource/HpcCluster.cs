...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::HpcCluster`, which is used to query a High Performance Computing (HPC) cluster.</summary>
    /// <remarks>
    ...
    public class HpcCluster : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IHpcClusterProps Props
        {
