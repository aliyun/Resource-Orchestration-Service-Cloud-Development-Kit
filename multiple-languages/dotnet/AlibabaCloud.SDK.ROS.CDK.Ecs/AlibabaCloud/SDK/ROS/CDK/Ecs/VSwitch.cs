...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::VSwitch`, which is used to create a vSwitch.</summary>
    /// <remarks>
    ...
    public class VSwitch : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.IVSwitchProps Props
        {
