...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::Zones`, which is used to query zones.</summary>
    /// <remarks>
    ...
    public class Zones : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IZones
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IZonesProps Props
        {
