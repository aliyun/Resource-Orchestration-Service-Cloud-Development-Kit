    ...
    public class RosSnapshotProps : AlibabaCloud.SDK.ROS.CDK.Ecs.IRosSnapshotProps
    {
        ...
        public object? InstantAccess
        {
            ...
            set
            {
                ...
                _instantAccess = value;
            }
        }

        private object? _instantAccessRetentionDays;
        ...
        {
            get => _instantAccessRetentionDays;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _instantAccessRetentionDays = value;
            }
        }
