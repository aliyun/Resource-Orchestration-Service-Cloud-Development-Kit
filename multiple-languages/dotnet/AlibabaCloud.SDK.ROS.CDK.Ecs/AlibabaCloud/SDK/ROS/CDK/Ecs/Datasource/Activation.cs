...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::Activation`, which is used to query the information about an activation code.</summary>
    /// <remarks>
