...
{
    /// <summary>Represents a `InstanceGroupClone`.</summary>
    [JsiiInterface(nativeType: typeof(IInstanceGroupClone), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IInstanceGroupClone")]
    public interface IInstanceGroupClone : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceGroupCloneProps Props
        {
            get;
        }

        /// <summary>Represents a `InstanceGroupClone`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstanceGroupClone), fullyQualifiedName: "@alicloud/ros-cdk-ecs.IInstanceGroupClone")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceGroupClone
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.InstanceGroupCloneProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ecs.IInstanceGroupCloneProps Props
            {
