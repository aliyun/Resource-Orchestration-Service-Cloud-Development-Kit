...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::SecurityGroup`The , which resource is used to create a security group.</summary>
    /// <remarks>
