...
{
    /// <summary>A ROS template type:  `ALIYUN::ECS::SNatEntry`.</summary>
    ...
    public class RosSNatEntry : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSNatEntry(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ecs.IRosSNatEntryProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        /// </remarks>
        [JsiiProperty(name: "attrSNatEntryId", typeJson: "{\"primitive\":\"any\"}")]
        ...
        public virtual string SNatTableId
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string? SnatEntryName
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string? SourceVSwitchId
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
