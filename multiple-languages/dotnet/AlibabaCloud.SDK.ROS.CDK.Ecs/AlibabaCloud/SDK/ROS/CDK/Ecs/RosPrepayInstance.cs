...
namespace AlibabaCloud.SDK.ROS.CDK.Ecs
{
    ...
    public class RosPrepayInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "tags", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"@alicloud/ros-cdk-ecs.RosPrepayInstance.TagsProperty\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.RosPrepayInstance.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Ecs.RosPrepayInstance.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosPrepayInstance.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-ecs.RosPrepayInstance.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ecs.RosPrepayInstance.ITagsProperty
            {
                private _Proxy(ByRefValue reference): base(reference)
                {
                }
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-ecs.RosPrepayInstance.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Ecs.RosPrepayInstance.ITagsProperty
        {
            /// <remarks>
            /// <strong>Property</strong>: key: undefined
            /// </remarks>
