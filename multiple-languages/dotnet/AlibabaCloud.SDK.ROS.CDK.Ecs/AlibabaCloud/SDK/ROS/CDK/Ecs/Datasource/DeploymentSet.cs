...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::ECS::DeploymentSet`, which is used to query the information about a deployment set.</summary>
    /// <remarks>
    ...
    public class DeploymentSet : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDeploymentSet
    {
        ...
        public virtual object AttrDeploymentSetName
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrGranularity
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrInstanceAmount
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrStrategy
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ecs.datasource.DeploymentSetProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecs.Datasource.IDeploymentSetProps Props
        {
