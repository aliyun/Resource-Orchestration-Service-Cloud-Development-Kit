...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECS::NetworkInterface`, which is used to create an elastic network interface (ENI).</summary>
    /// <remarks>
    ...
    public class NetworkInterface : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecs.INetworkInterfaceProps Props
        {
