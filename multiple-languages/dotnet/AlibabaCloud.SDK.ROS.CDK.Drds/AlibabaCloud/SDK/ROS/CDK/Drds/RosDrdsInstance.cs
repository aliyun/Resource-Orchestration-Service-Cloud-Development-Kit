...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::DRDS::DrdsInstance`, which is used to create a Distributed Relational Database Service (DRDS) instance of specific specifications.</summary>
    /// <remarks>
    ...
    public class RosDrdsInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDrdsInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Drds.IRosDrdsInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Drds.IRosDrdsInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object InstanceSeries
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? MySqlVersion
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Drds.RosDrdsInstance.ITagsProperty[]? Tags
        {
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-drds.RosDrdsInstance.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-drds.RosDrdsInstance.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Drds.RosDrdsInstance.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-drds.RosDrdsInstance.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Drds.RosDrdsInstance.ITagsProperty
        {
            private object _key;
