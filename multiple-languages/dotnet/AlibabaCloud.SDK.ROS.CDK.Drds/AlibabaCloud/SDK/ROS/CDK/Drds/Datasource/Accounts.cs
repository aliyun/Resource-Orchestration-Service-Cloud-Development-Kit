...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::DRDS::Accounts`ALIYUN::DTS::ConsumerGroup is used to create a consumer group for a change tracking instance.</summary>
    /// <remarks>
