...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECD::SimpleOfficeSite`, which is used to create a workspace of the convenience account type.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosSimpleOfficeSite`for a more convenient development experience.
    ...
    public class SimpleOfficeSite : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ecd.ISimpleOfficeSite
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Ecd.ISimpleOfficeSiteProps Props
        {
