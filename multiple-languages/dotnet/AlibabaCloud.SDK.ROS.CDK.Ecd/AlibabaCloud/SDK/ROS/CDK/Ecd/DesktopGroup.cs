...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ECD::DesktopGroup`.</summary>
    /// <remarks>
    ...
    public class DesktopGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ecd.IDesktopGroupProps Props
        {
