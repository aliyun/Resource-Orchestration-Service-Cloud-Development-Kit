...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::CompressionRule`The , which resource type creates a compression rule.</summary>
    /// <remarks>
