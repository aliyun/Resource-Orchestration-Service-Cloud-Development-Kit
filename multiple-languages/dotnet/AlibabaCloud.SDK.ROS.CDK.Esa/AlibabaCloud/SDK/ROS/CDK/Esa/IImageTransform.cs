...
{
    /// <summary>Represents a `ImageTransform`.</summary>
    [JsiiInterface(nativeType: typeof(IImageTransform), fullyQualifiedName: "@alicloud/ros-cdk-esa.IImageTransform")]
    public interface IImageTransform : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Esa.IImageTransformProps Props
        {
            get;
        }

        /// <summary>Represents a `ImageTransform`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IImageTransform), fullyQualifiedName: "@alicloud/ros-cdk-esa.IImageTransform")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Esa.IImageTransform
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.ImageTransformProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Esa.IImageTransformProps Props
            {
