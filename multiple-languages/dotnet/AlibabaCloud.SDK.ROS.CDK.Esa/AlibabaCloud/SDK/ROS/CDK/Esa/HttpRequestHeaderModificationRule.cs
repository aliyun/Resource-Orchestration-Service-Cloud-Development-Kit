...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::HttpRequestHeaderModificationRule`The , which type is used to create configurations that modify HTTP request headers.</summary>
    /// <remarks>
