...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::CustomScenePolicy`The , which resource type is used to create scenario-specific policies.</summary>
    /// <remarks>
