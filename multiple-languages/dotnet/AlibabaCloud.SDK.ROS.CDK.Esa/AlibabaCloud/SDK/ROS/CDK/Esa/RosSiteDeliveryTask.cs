...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ESA::SiteDeliveryTask`The , which type is used to create a real-time log delivery task.</summary>
    /// <remarks>
