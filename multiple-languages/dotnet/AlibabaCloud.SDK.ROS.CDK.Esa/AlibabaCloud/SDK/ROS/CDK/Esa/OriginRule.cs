...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::OriginRule`The , which type is used to add origin rules to a website.</summary>
    /// <remarks>
