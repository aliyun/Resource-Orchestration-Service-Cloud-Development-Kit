...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::SiteDeliveryTask`The , which type is used to create a real-time log delivery task.</summary>
    /// <remarks>
