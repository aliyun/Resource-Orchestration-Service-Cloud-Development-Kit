...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::SiteOriginClientCertificate`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosSiteOriginClientCertificate`for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-siteoriginclientcertificate
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Esa.SiteOriginClientCertificate), fullyQualifiedName: "@alicloud/ros-cdk-esa.SiteOriginClientCertificate", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-esa.SiteOriginClientCertificateProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"optional\":true,\"type\":{\"primitive\":\"boolean\"}}]")]
    public class SiteOriginClientCertificate : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificate
    {
        /// <summary>Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.</summary>
        public SiteOriginClientCertificate(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps props, bool? enableResourcePropertyConstraint = null): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected SiteOriginClientCertificate(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected SiteOriginClientCertificate(DeputyProps props): base(props)
        {
        }
        ...
        /// <summary>Attribute SiteOriginClientCertificateId: The certificate ID on ESA.</summary>
        [JsiiProperty(name: "attrSiteOriginClientCertificateId", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        public virtual object AttrSiteOriginClientCertificateId
        {
            get => GetInstanceProperty<object>()!;
        }

        /// <summary>Attribute SiteOriginClientCertificateName: The certificate name.</summary>
        [JsiiProperty(name: "attrSiteOriginClientCertificateName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        public virtual object AttrSiteOriginClientCertificateName
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.SiteOriginClientCertificateProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps>()!;
        }
