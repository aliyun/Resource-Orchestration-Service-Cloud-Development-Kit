...
{
    /// <summary>Represents a `CustomResponseCodeRule`.</summary>
    [JsiiInterface(nativeType: typeof(ICustomResponseCodeRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.ICustomResponseCodeRule")]
    public interface ICustomResponseCodeRule : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        /// <summary>Attribute PageId: The custom response page.</summary>
        ...
        /// <summary>Attribute ReturnCode: The custom response code.</summary>
        [JsiiProperty(name: "attrReturnCode", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
        object AttrReturnCode
        {
            get;
        }
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.CustomResponseCodeRuleProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Esa.ICustomResponseCodeRuleProps Props
        {
            get;
        }

        /// <summary>Represents a `CustomResponseCodeRule`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICustomResponseCodeRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.ICustomResponseCodeRule")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Esa.ICustomResponseCodeRule
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.CustomResponseCodeRuleProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Esa.ICustomResponseCodeRuleProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Esa.ICustomResponseCodeRuleProps>()!;
            }
