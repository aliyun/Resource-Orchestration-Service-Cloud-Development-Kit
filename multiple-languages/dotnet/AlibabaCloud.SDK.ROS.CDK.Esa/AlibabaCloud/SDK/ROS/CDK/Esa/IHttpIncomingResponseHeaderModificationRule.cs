...
{
    /// <summary>Represents a `HttpIncomingResponseHeaderModificationRule`.</summary>
    [JsiiInterface(nativeType: typeof(IHttpIncomingResponseHeaderModificationRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.IHttpIncomingResponseHeaderModificationRule")]
    public interface IHttpIncomingResponseHeaderModificationRule : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.HttpIncomingResponseHeaderModificationRuleProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingResponseHeaderModificationRuleProps Props
        {
            get;
        }

        /// <summary>Represents a `HttpIncomingResponseHeaderModificationRule`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IHttpIncomingResponseHeaderModificationRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.IHttpIncomingResponseHeaderModificationRule")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingResponseHeaderModificationRule
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.HttpIncomingResponseHeaderModificationRuleProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingResponseHeaderModificationRuleProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingResponseHeaderModificationRuleProps>()!;
            }
