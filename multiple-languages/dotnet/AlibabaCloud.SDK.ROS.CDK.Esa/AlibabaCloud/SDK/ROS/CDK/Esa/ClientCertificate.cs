...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::ClientCertificate`The , which type is used to create a client certificate.</summary>
    /// <remarks>
