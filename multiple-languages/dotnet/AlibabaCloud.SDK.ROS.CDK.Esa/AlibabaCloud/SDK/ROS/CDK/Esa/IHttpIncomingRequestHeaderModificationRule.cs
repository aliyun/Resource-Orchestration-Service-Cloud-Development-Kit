...
{
    /// <summary>Represents a `HttpIncomingRequestHeaderModificationRule`.</summary>
    [JsiiInterface(nativeType: typeof(IHttpIncomingRequestHeaderModificationRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.IHttpIncomingRequestHeaderModificationRule")]
    public interface IHttpIncomingRequestHeaderModificationRule : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.HttpIncomingRequestHeaderModificationRuleProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps Props
        {
            get;
        }

        /// <summary>Represents a `HttpIncomingRequestHeaderModificationRule`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IHttpIncomingRequestHeaderModificationRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.IHttpIncomingRequestHeaderModificationRule")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRule
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.HttpIncomingRequestHeaderModificationRuleProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps>()!;
            }
