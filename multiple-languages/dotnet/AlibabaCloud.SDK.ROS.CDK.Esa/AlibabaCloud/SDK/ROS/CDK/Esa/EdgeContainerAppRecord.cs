...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::EdgeContainerAppRecord`The , which type creates an associated domain name for an edge container application.</summary>
    /// <remarks>
