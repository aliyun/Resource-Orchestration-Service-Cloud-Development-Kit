...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::EdgeContainerApp`Use the , which resource type to create an edge container application.</summary>
    /// <remarks>
