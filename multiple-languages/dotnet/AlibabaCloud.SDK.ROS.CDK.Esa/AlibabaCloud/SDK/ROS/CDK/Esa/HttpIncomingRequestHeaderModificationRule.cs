...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::HttpIncomingRequestHeaderModificationRule`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosHttpIncomingRequestHeaderModificationRule`for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-httpincomingrequestheadermodificationrule
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Esa.HttpIncomingRequestHeaderModificationRule), fullyQualifiedName: "@alicloud/ros-cdk-esa.HttpIncomingRequestHeaderModificationRule", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-esa.HttpIncomingRequestHeaderModificationRuleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"optional\":true,\"type\":{\"primitive\":\"boolean\"}}]")]
    public class HttpIncomingRequestHeaderModificationRule : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRule
    {
        /// <summary>Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.</summary>
        public HttpIncomingRequestHeaderModificationRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps props, bool? enableResourcePropertyConstraint = null): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected HttpIncomingRequestHeaderModificationRule(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected HttpIncomingRequestHeaderModificationRule(DeputyProps props): base(props)
        {
        }
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Esa.IHttpIncomingRequestHeaderModificationRuleProps Props
        {
