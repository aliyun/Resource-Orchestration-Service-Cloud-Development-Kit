...
{
    /// <summary>Represents a `SiteOriginClientCertificate`.</summary>
    [JsiiInterface(nativeType: typeof(ISiteOriginClientCertificate), fullyQualifiedName: "@alicloud/ros-cdk-esa.ISiteOriginClientCertificate")]
    public interface ISiteOriginClientCertificate : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrSiteOriginClientCertificateId
        {
            get;
        }
        ...
        object AttrSiteOriginClientCertificateName
        {
            get;
        }
        ...
        AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps Props
        {
            get;
        }

        /// <summary>Represents a `SiteOriginClientCertificate`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISiteOriginClientCertificate), fullyQualifiedName: "@alicloud/ros-cdk-esa.ISiteOriginClientCertificate")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificate
        {
            ...
            /// <summary>Attribute SiteOriginClientCertificateId: The certificate ID on ESA.</summary>
            [JsiiProperty(name: "attrSiteOriginClientCertificateId", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrSiteOriginClientCertificateId
            {
                get => GetInstanceProperty<object>()!;
            }
            ...
            /// <summary>Attribute SiteOriginClientCertificateName: The certificate name.</summary>
            [JsiiProperty(name: "attrSiteOriginClientCertificateName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrSiteOriginClientCertificateName
            {
                get => GetInstanceProperty<object>()!;
            }
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-esa.SiteOriginClientCertificateProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Esa.ISiteOriginClientCertificateProps Props
            {
