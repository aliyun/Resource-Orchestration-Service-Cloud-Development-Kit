...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ESA::HttpsApplicationConfiguration`The , which resource is used to add an HTTPS application configuration for a website.</summary>
    /// <remarks>
