...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::CS::KubernetesCluster`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `KubernetesCluster` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-cs-kubernetescluster
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Cs.Datasource.RosKubernetesCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.datasource.RosKubernetesCluster", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-cs.datasource.RosKubernetesClusterProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosKubernetesCluster : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosKubernetesCluster(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cs.Datasource.IRosKubernetesClusterProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cs.Datasource.IRosKubernetesClusterProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cs.Datasource.RosKubernetesCluster))!;
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ClusterSpec: The type of the managed Kubernetes cluster. This parameter is returned for a managed Kubernetes cluster. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ClusterType: The type of the cluster. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Created: The time when the cluster was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CurrentVersion: The current Kubernetes version of the cluster. For more information about the Kubernetes versions supported by ACK, see Release notes for Kubernetes versions.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DeletionProtection: Indicates whether deletion protection is enabled. If deletion protection is enabled, the cluster cannot be deleted in the ACK console or by calling the API. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DockerVersion: The Docker version that is used by the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExternalLoadbalancerId: The ID of the Server Load Balancer (SLB) instance that is used for the Ingress of the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InitVersion: The Kubernetes version that is initially used by the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaintenanceWindow: The maintenance window of the cluster. This feature is available in only professional managed Kubernetes clusters.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MasterUrl: The address of the cluster. It includes an internal endpoint and a public endpoint.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MetaData: The metadata of the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Name: The name of the cluster. The name must be 1 to 63 characters in length, and can contain digits, letters, and hyphens (-). It cannot start with a hyphen (-).
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NetworkMode: The network mode of the cluster. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NextVersion: The Kubernetes version to which the cluster can be upgraded.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Parameters: A collection of cluster ROS parameters.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PrivateZone: Indicates whether Alibaba Cloud DNS PrivateZone is enabled.
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Profile: Indicates the scenario in which the cluster is used. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RegionId: The ID of the region where the cluster is deployed.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ResourceGroupId: The ID of the resource group to which the cluster belongs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityGroupId: The ID of the security group to which the instances of the cluster belong.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ServiceCidr: The cluster service cidr.
        /// </remarks>
        [JsiiProperty(name: "attrServiceCidr", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrServiceCidr
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <remarks>
        /// <strong>Attribute</strong>: Size: The number of nodes in the cluster. Master nodes and worker nodes are included.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: State: The state of the cluster. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SubnetCidr: The pod CIDR block. It must be a valid and private CIDR block, and must be one of the following CIDR blocks or their subnets:
        /// - 10.0.0.0/8
        /// - 172.16-31.0.0/12-16
        /// - 192.168.0.0/16
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The labels of the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Updated: The time when the cluster was updated.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The ID of the VPC where the cluster is deployed. This parameter is required when you create an ACK cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchId: The IDs of the vSwitches. You can select one to three vSwitches when you create an ACK cluster. vSwitches in different zones are recommended to ensure high availability.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchIds: The list of cluster control plane VSwitch ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: WorkerRamRoleName: The name of the worker RAM role.
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ZoneId: The ID of the zone where the cluster is deployed.
        /// </remarks>
