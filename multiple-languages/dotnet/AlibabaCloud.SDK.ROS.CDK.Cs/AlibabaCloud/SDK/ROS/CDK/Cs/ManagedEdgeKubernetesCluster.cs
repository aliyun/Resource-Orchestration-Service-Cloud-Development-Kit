...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ManagedEdgeKubernetesCluster`, which is used to create a managed edge cluster of Container Service for Kubernetes (ACK).</summary>
    /// <remarks>
    ...
    public class ManagedEdgeKubernetesCluster : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cs.IManagedEdgeKubernetesClusterProps Props
        {
