...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ManagedKubernetesCluster`The , which type creates ACK managed clusters.</summary>
    /// <remarks>
    ...
    public class ManagedKubernetesCluster : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cs.IManagedKubernetesCluster
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Cs.IManagedKubernetesClusterProps Props
        {
