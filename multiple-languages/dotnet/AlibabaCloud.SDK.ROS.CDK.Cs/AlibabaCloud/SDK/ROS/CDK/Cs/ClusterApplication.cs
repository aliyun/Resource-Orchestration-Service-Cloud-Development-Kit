...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ClusterApplication`The , which resource type deploys containerized applications.</summary>
    /// <remarks>
