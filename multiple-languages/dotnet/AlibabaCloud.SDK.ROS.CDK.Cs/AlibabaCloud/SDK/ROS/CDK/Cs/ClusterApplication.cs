...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ClusterApplication`, which is used to deploy an application in a Container Service for Kubernetes (ACK) cluster.</summary>
    /// <remarks>
    ...
    public class ClusterApplication : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cs.IClusterApplicationProps Props
        {
