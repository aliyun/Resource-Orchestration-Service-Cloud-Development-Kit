...
{
    /// <summary>Represents a `ManagedEdgeKubernetesCluster`.</summary>
    [JsiiInterface(nativeType: typeof(IManagedEdgeKubernetesCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IManagedEdgeKubernetesCluster")]
    public interface IManagedEdgeKubernetesCluster : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cs.IManagedEdgeKubernetesClusterProps Props
        {
            get;
        }

        /// <summary>Represents a `ManagedEdgeKubernetesCluster`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IManagedEdgeKubernetesCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IManagedEdgeKubernetesCluster")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cs.IManagedEdgeKubernetesCluster
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cs.ManagedEdgeKubernetesClusterProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cs.IManagedEdgeKubernetesClusterProps Props
            {
