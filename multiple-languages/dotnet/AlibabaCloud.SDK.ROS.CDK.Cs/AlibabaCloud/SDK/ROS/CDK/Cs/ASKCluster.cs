...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ASKCluster`The , which resource type creates an ACK Serverless cluster.</summary>
    /// <remarks>
