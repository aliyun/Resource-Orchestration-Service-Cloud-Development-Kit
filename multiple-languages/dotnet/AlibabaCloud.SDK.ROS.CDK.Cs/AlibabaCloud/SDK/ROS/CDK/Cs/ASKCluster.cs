...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ASKCluster`, which is used to create an ACK Serverless cluster of Container Service for Kubernetes (ACK).</summary>
    /// <remarks>
    ...
    public class ASKCluster : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cs.IASKClusterProps Props
        {
