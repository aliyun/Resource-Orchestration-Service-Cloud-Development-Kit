...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ASKCluster`, which is used to create a serverless Kubernetes (ASK) cluster.</summary>
    /// <remarks>
