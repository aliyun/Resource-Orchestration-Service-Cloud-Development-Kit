...
{
    /// <summary>Represents a `ASKCluster`.</summary>
    [JsiiInterface(nativeType: typeof(IASKCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IASKCluster")]
    public interface IASKCluster : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cs.IASKClusterProps Props
        {
            get;
        }

        /// <summary>Represents a `ASKCluster`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IASKCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IASKCluster")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cs.IASKCluster
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cs.ASKClusterProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cs.IASKClusterProps Props
            {
