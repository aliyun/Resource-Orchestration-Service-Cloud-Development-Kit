...
{
    /// <summary>Represents a `AnyCluster`.</summary>
    [JsiiInterface(nativeType: typeof(IAnyCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IAnyCluster")]
    public interface IAnyCluster : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cs.AnyClusterProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Cs.IAnyClusterProps Props
        {
            get;
        }

        /// <summary>Represents a `AnyCluster`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAnyCluster), fullyQualifiedName: "@alicloud/ros-cdk-cs.IAnyCluster")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cs.IAnyCluster
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cs.AnyClusterProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cs.IAnyClusterProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Cs.IAnyClusterProps>()!;
            }
