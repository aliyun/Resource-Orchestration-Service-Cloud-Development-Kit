...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CS::ClusterHelmApplication`The , which type is used to deploy an application using Helm.</summary>
    /// <remarks>
