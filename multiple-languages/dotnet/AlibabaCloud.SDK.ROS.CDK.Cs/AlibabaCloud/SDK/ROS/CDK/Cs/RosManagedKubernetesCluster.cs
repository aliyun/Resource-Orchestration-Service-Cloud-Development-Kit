...
namespace AlibabaCloud.SDK.ROS.CDK.Cs
{
    ...
    public class RosManagedKubernetesCluster : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public virtual object? WorkerAutoRenewPeriod
        {
            get => GetInstanceProperty<object?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual object? WorkerInstanceChargeType
        {
            get => GetInstanceProperty<object?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual object? WorkerPeriod
        {
            get => GetInstanceProperty<object?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual object? WorkerPeriodUnit
        {
            get => GetInstanceProperty<object?>();
            set => SetInstanceProperty(value);
        }
        ...
        public class WorkerDataDisksProperty : AlibabaCloud.SDK.ROS.CDK.Cs.RosManagedKubernetesCluster.IWorkerDataDisksProperty
        {
            ...
            /// <strong>Property</strong>: size: Data disk size in GiB.
            /// </remarks>
            [JsiiProperty(name: "size", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}", isOverride: true)]
            public object Size
            {
                get;
                set;
