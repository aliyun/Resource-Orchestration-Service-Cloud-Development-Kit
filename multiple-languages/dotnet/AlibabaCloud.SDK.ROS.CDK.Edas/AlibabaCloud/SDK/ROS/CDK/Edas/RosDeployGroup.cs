...
namespace AlibabaCloud.SDK.ROS.CDK.Edas
{
    ...
    public class RosDeployGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDeployGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Edas.IRosDeployGroupProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
