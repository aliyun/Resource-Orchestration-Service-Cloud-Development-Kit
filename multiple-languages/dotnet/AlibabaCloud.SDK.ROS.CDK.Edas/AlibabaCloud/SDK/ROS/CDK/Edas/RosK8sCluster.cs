...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::EDAS::K8sCluster`, which is used to create a cluster of Container Service for Kubernetes (ACK).</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `K8sCluster` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-k8scluster
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Edas.RosK8sCluster), fullyQualifiedName: "@alicloud/ros-cdk-edas.RosK8sCluster", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-edas.RosK8sClusterProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosK8sCluster : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosK8sCluster(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Edas.IRosK8sClusterProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Edas.IRosK8sClusterProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosK8sCluster(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosK8sCluster(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Edas.RosK8sCluster))!;
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CsClusterId: The ID of the K8s cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NetworkMode: Network node:
        /// 1: Classic network
        /// 2: VPC
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NodeNum: Number of nodes.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SubNetCidr: Sub net CIDR.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The ID of the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VswitchId: The ID of the cluster.
        /// </remarks>
        ...
        public virtual object CsClusterId
        {
        ...
        public virtual object? EnableAsm
        {
            get => GetInstanceProperty<object?>();
            set
            {
