...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::EDAS::UserDefineRegions`, which is used to query custom namespaces.</summary>
    /// <remarks>
    ...
    public class UserDefineRegions : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Edas.Datasource.IUserDefineRegions
    {
        ...
        public virtual object AttrUserDefineRegions
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-edas.datasource.UserDefineRegionsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Edas.Datasource.IUserDefineRegionsProps Props
        {
