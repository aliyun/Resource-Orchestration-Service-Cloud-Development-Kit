...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ACS::Cluster`The , which resource creates a Container Service for Kubernetes (ACK) cluster.</summary>
    /// <remarks>
