...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ACS::VirtualCapacityReservation`The , which resource type creates a capacity reservation task.</summary>
    /// <remarks>
