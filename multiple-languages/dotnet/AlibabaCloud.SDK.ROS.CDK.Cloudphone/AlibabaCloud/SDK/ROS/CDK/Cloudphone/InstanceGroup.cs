...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CloudPhone::InstanceGroup`, which is used to create and start Elastic Cloud Phone (ECP) instances.</summary>
    /// <remarks>
    ...
    public class InstanceGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cloudphone.IInstanceGroupProps Props
        {
