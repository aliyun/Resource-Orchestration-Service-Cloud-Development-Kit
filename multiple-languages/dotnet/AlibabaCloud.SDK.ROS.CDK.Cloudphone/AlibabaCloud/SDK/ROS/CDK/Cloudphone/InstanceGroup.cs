...
{
    /// <summary>A ROS resource type:  `ALIYUN::CloudPhone::InstanceGroup`.</summary>
    ...
    public class InstanceGroup : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public InstanceGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudphone.IInstanceGroupProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
