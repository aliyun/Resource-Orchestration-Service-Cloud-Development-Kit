...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::CloudPhone::InstanceGroup`, which is used to create and start Elastic Cloud Phone (ECP) instances.</summary>
    /// <remarks>
    ...
    public class RosInstanceGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInstanceGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudphone.IRosInstanceGroupProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudphone.IRosInstanceGroupProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Cloudphone.RosInstanceGroup))!;

        /// <remarks>
        /// <strong>Attribute</strong>: InstanceIds: instance ids
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: OrderId: oder id
        /// </remarks>
        ...
        public virtual object? Resolution
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? VncPassword
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        [JsiiInterface(nativeType: typeof(ITagProperty), fullyQualifiedName: "@alicloud/ros-cdk-cloudphone.RosInstanceGroup.TagProperty")]
        public interface ITagProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagProperty), fullyQualifiedName: "@alicloud/ros-cdk-cloudphone.RosInstanceGroup.TagProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cloudphone.RosInstanceGroup.ITagProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-cloudphone.RosInstanceGroup.TagProperty")]
        public class TagProperty : AlibabaCloud.SDK.ROS.CDK.Cloudphone.RosInstanceGroup.ITagProperty
        {
            private object _key;
