...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudphone
{
    ...
    public class RosInstanceGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosInstanceGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cloudphone.IRosInstanceGroupProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
