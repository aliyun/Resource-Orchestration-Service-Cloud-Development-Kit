...
namespace AlibabaCloud.SDK.ROS.CDK.Cloudphone.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IImages), fullyQualifiedName: "@alicloud/ros-cdk-cloudphone.datasource.IImages")]
    public interface IImages : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cloudphone.Datasource.IImagesProps Props
        {
            get;
        }

        /// <summary>Represents a `Images`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IImages), fullyQualifiedName: "@alicloud/ros-cdk-cloudphone.datasource.IImages")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cloudphone.Datasource.IImages
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cloudphone.datasource.ImagesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cloudphone.Datasource.IImagesProps Props
            {
