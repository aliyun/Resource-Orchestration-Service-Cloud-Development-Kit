...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::MONGODB::Instance`.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Mongodb.Datasource.RosInstance), fullyQualifiedName: "@alicloud/ros-cdk-mongodb.datasource.RosInstance", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-mongodb.datasource.RosInstanceProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mongodb.Datasource.IRosInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mongodb.Datasource.IRosInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Mongodb.Datasource.RosInstance))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AccountDescription: The description of the account.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AccountName: The name of the account. Value: **root * *.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AutoRenew: Indicates whether auto-renewal is enabled for the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AutoRenewDuration: Auto Renew Duration.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BackupInterval: The frequency at which high-frequency backup is created. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BackupRetentionPeriod: The retention period of the backup data. Unit: day.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The Database create time.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceDescription: The name of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceReleaseProtection: Indicates whether release protection is enabled for the instance. Valid values:
        /// true
        /// false
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DbInstanceStorage: The storage capacity of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceType: The architecture of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EnableBackupLog: Indicates whether the log backup feature is enabled. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Engine: The database engine of the instance. Default value: mongodb.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EngineVersion: The database engine version of the instance.
        /// 6.0
        /// 5.0
        /// 4.4
        /// 4.2
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExpireTime: The time when the subscription instance expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mmZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HiddenZoneId: The zone where the hidden node resides for multi-zone deployment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InstanceId: The ID of the mongos
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: KindCode: The kind code of the instance. Valid values:
        /// 0: physical machine
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LastDowngradeTime: The date when the last downgrade operation was performed on the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LockMode: The lock status of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LogBackupRetentionPeriod: The number of days for which log backups are retained. Valid values: 7 to 730.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaintainEndTime: The end time of the maintenance window. The time follows the ISO 8601 standard in the HH:mmZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaintainStartTime: The start time of the maintenance window. The time follows the ISO 8601 standard in the HH:mmZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MongosList: The information of the mongos nodes.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NetworkAddresses: The endpoints of ApsaraDB for MongoDB instances.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Parameters: The settings of the parameters that have taken effect.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PaymentType: The billing method of the Database. Valid values:  PrePaid: subscription PostPaid: pay-as-you-go.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PreferredBackupPeriod: The day of a week on which to back up data. Valid values:
        /// Monday
        /// Tuesday
        /// Wednesday
        /// Thursday
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PreferredBackupTime: The time range during which the backup was created. The time follows the ISO 8601 standard in the HH:mmZ-HH:mmZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ProtocolType: The access protocol type of the instance. Valid values:
        /// mongodb
        /// dynamodb
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReadonlyReplicas: The number of read-only nodes in the shard node. Valid values: 0 to 5. The value must be an integer.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReplicaSetsConnections: ReplicaSets Connections.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReplicationFactor: The number of nodes in the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecondaryZoneId: The zone where the secondary node resides for multi-zone deployment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityGroupId: The ID of the ECS security group.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityIpList: The name of the IP whitelist.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityIps: The IP addresses in the default whitelist.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ShardList: The information of the shard nodes.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SnapshotBackupType: The snapshot backup type. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SslExpiredTime: The time when the SSL certificate expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in Coordinated Universal Time (UTC).
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SslStatus: The status of the SSL feature. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: StorageEngine: The Storage Engine Of The Instance Type.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The details of the instance tags.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TdeStatus: The TDE status. Valid values:
        /// enabled
        /// disabled
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcAuthMode: Indicates whether password-free access within the VPC is enabled. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The VPC ID of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchId: The vSwitch ID of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ZoneId: The ID of the zone in which the instance resides.
        /// </remarks>
