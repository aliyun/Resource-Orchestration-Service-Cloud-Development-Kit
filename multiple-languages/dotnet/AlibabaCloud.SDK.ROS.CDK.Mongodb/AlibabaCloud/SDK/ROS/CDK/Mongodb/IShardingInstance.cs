...
{
    /// <summary>Represents a `ShardingInstance`.</summary>
    ...
    public interface IShardingInstance : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Mongodb.IShardingInstanceProps Props
        {
            get;
        }

        /// <summary>Represents a `ShardingInstance`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IShardingInstance), fullyQualifiedName: "@alicloud/ros-cdk-mongodb.IShardingInstance")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Mongodb.IShardingInstance
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-mongodb.ShardingInstanceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Mongodb.IShardingInstanceProps Props
            {
