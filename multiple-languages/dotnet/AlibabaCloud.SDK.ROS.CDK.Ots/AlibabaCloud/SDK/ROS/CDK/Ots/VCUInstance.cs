...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::OTS::VCUInstance`The , which resource creates a Virtual Compute Unit (VCU) instance.</summary>
    /// <remarks>
