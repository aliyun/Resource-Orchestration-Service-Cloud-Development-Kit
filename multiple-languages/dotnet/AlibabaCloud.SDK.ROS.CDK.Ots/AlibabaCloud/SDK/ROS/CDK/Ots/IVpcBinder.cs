...
{
    /// <summary>Represents a `VpcBinder`.</summary>
    [JsiiInterface(nativeType: typeof(IVpcBinder), fullyQualifiedName: "@alicloud/ros-cdk-ots.IVpcBinder")]
    public interface IVpcBinder : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ots.IVpcBinderProps Props
        {
            get;
        }

        /// <summary>Represents a `VpcBinder`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IVpcBinder), fullyQualifiedName: "@alicloud/ros-cdk-ots.IVpcBinder")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ots.IVpcBinder
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ots.VpcBinderProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ots.IVpcBinderProps Props
            {
