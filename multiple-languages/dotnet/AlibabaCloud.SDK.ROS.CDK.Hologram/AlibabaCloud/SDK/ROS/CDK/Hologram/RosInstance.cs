...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::Hologram::Instance`ALIYUN::IMM::Project is used to create an Intelligent Media Management (IMM) project.</summary>
    /// <remarks>
