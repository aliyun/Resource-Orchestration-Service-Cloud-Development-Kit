...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::Hologram::Instance`ALIYUN::IMM::Project is used to create an Intelligent Media Management (IMM) project.</summary>
    /// <remarks>
