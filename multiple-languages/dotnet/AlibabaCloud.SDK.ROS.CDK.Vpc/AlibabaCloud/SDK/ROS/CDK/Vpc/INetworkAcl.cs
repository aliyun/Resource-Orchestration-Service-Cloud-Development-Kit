...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(INetworkAcl), fullyQualifiedName: "@alicloud/ros-cdk-vpc.INetworkAcl")]
    public interface INetworkAcl : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrNetworkAclEntryName
        {
            get;
        }
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.INetworkAclProps Props
        {
            get;
        }

        /// <summary>Represents a `NetworkAcl`.</summary>
        [JsiiTypeProxy(nativeType: typeof(INetworkAcl), fullyQualifiedName: "@alicloud/ros-cdk-vpc.INetworkAcl")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.INetworkAcl
        {
            ...
            /// <summary>Attribute NetworkAclEntryName: The name of the inbound rule.</summary>
            [JsiiProperty(name: "attrNetworkAclEntryName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrNetworkAclEntryName
            {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.NetworkAclProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.INetworkAclProps Props
            {
