...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    public class RosVpnPbrRouteEntry : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosVpnPbrRouteEntry(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosVpnPbrRouteEntryProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
