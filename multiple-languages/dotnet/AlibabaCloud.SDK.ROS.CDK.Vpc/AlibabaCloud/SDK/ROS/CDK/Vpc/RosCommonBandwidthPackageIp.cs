...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::CommonBandwidthPackageIp`, which is used to add EIPs to the Internet shared bandwidth instance.</summary>
    /// <remarks>
    ...
    public class RosCommonBandwidthPackageIp : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCommonBandwidthPackageIp(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosCommonBandwidthPackageIpProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosCommonBandwidthPackageIpProps props, bool enableResourcePropertyConstraint)
        {
