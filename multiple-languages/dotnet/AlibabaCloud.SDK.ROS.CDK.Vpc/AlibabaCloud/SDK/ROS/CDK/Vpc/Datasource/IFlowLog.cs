...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IFlowLog), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.IFlowLog")]
    public interface IFlowLog : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        object AttrAggregationInterval
        {
            get;
        }
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IFlowLogProps Props
        {
            get;
        }

        /// <summary>Represents a `FlowLog`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFlowLog), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.IFlowLog")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IFlowLog
        {
            ...
            /// <summary>Attribute AggregationInterval: Data aggregation interval.</summary>
            [JsiiProperty(name: "attrAggregationInterval", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrAggregationInterval
            {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.FlowLogProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IFlowLogProps Props
            {
