...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    /// <summary>Properties for defining a `RosIpamPoolAllocation`.</summary>
    /// <remarks>
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipampoolallocation
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-vpc.RosIpamPoolAllocationProps")]
    public class RosIpamPoolAllocationProps : AlibabaCloud.SDK.ROS.CDK.Vpc.IRosIpamPoolAllocationProps
    {
        private object _ipamPoolId;

        /// <remarks>
        /// <strong>Property</strong>: ipamPoolId: The ID of the IPAM Pool.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: cidr: The allocated address segment.
        /// </remarks>
        [JsiiOptional]
        ...
        private object? _cidrMask;

        /// <remarks>
        /// <strong>Property</strong>: cidrMask: Create a custom reserved network segment from The IPAM address pool by entering a mask.
        ...
        private object? _ipamPoolAllocationDescription;

        /// <remarks>
        /// <strong>Property</strong>: ipamPoolAllocationDescription: The description of the ipam pool alloctaion.
        ...
        {
            get => _ipamPoolAllocationDescription;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _ipamPoolAllocationDescription = value;
            }
        }

        private object? _ipamPoolAllocationName;

        /// <remarks>
        /// <strong>Property</strong>: ipamPoolAllocationName: The name of the ipam pool allocation.
