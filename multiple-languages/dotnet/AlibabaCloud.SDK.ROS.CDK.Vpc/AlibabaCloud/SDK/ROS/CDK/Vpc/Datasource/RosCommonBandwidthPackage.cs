...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::VPC::CommonBandwidthPackage`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `CommonBandwidthPackage` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-vpc-commonbandwidthpackage
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosCommonBandwidthPackage), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.RosCommonBandwidthPackage", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.RosCommonBandwidthPackageProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosCommonBandwidthPackage : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosCommonBandwidthPackage(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosCommonBandwidthPackageProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosCommonBandwidthPackageProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosCommonBandwidthPackage(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosCommonBandwidthPackage(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosCommonBandwidthPackage))!;

        /// <remarks>
        /// <strong>Attribute</strong>: Bandwidth: The maximum bandwidth of the Internet Shared Bandwidth instance. Unit: Mbit/s.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BusinessStatus: The service status of the Internet Shared Bandwidth instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CommonBandwidthPackageId: The ID of the Internet shared bandwidth.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CommonBandwidthPackageName: The name of the Internet Shared Bandwidth instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreationTime: The time when the Internet Shared Bandwidth instance was created. The time is displayed in the YYYY-MM-DDThh:mm:ssZ format.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DeletionProtection: Indicates whether deletion protection is enabled. Valid values:
        /// false
        /// true
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the Internet Shared Bandwidth instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExpiredTime: The time when the Internet Shared Bandwidth instance expired. The time is displayed in the YYYY-MM-DDThh:mm:ssZ format.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: HasReservationData: Indicates whether the information about pending orders is returned. Valid values:
        /// false
        /// true
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InstanceChargeType: The billing method of the Internet Shared Bandwidth instance. Valid value:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetChargeType: The metering method of the Internet Shared Bandwidth instance. Valid value:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Isp: The line type. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PublicIpAddresses: The elastic IP addresses (EIPs) that are associated with the Internet Shared Bandwidth instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Ratio: The percentage of the minimum bandwidth commitment. Only 20 is returned.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReservationActiveTime: The time when the renewal took effect. The time is displayed in the YYYY-MM-DDThh:mm:ssZ format.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReservationBandwidth: The new maximum bandwidth after the configurations are changed. Unit: Mbit/s.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReservationInternetChargeType: The metering method after the configurations are changed. Valid value:
        /// PayBy95: Charged by Enhanced 95th Percentile.
        /// PayByBandwidth: Charged by Bandwidth.
        /// PayByDominantTraffic: Charged by Dominant Traffic.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReservationOrderType: The renewal method. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ServiceManaged: Indicates whether the resource is created by the service account. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Status: The status of the Internet Shared Bandwidth instance. Valid values:
