...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::EIPAssociation`Use , which to associate an Elastic IP Address (EIP) with a cloud service instance.</summary>
    /// <remarks>
    ...
    public class EIPAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPAssociation
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPAssociationProps Props
        {
