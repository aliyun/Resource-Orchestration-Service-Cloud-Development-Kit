...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IPrefixList), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IPrefixList")]
    public interface IPrefixList : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixListProps Props
        {
            get;
        }

        /// <summary>Represents a `PrefixList`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPrefixList), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IPrefixList")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixList
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.PrefixListProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixListProps Props
            {
