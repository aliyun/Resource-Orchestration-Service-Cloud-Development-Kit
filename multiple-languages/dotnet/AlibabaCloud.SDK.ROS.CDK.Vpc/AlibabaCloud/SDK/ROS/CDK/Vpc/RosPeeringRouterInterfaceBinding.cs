...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::PeeringRouterInterfaceBinding`, which is used to bind a router interface with another router interface.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `PeeringRouterInterfaceBinding` class instead of this class for a more convenient development experience.
    ...
    public class RosPeeringRouterInterfaceBinding : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosPeeringRouterInterfaceBinding(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosPeeringRouterInterfaceBindingProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosPeeringRouterInterfaceBindingProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object OppositeInterfaceId
        {
        ...
        public virtual object RouterInterfaceId
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? OppositeInterfaceOwnerId
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? OppositeRouterId
        {
            get => GetInstanceProperty<object?>();
            set
            {
