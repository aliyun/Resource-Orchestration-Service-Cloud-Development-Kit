...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::IpamPoolAllocation`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosIpamPoolAllocation`for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipampoolallocation
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.IpamPoolAllocation), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IpamPoolAllocation", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.IpamPoolAllocationProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"optional\":true,\"type\":{\"primitive\":\"boolean\"}}]")]
    public class IpamPoolAllocation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpamPoolAllocation
    {
        /// <summary>Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.</summary>
        public IpamPoolAllocation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpamPoolAllocationProps props, bool? enableResourcePropertyConstraint = null): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpamPoolAllocationProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected IpamPoolAllocation(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected IpamPoolAllocation(DeputyProps props): base(props)
        {
        }
        ...
        public virtual object AttrIpamPoolAllocationDescription
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrIpamPoolAllocationId
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrIpamPoolAllocationName
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrResourceOwnerId
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrSourceCidr
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.IpamPoolAllocationProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IIpamPoolAllocationProps Props
        {
