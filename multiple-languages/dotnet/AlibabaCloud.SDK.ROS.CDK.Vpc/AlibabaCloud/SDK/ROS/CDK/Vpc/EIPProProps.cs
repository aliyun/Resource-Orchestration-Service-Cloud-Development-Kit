...
{
    /// <summary>Properties for defining a `EIPPro`.</summary>
    /// <remarks>
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-eippro
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-vpc.EIPProProps")]
    public class EIPProProps : AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPProProps
    {
        ...
        /// <summary>Property instanceId: The ID of the requested EIP.</summary>
        [JsiiOptional]
        ...
        private object? _securityProtectionTypes;
        ...
        public object? SecurityProtectionTypes
        {
            ...
            set
            {
                ...
                _securityProtectionTypes = value;
            }
        }
