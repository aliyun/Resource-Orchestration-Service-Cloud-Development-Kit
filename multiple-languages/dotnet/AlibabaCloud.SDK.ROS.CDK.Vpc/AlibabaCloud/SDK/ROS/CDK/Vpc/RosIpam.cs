...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::Ipam`.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Ipam` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipam
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosIpam", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.RosIpamProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosIpam : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosIpam(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosIpamProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosIpamProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosIpam(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosIpam(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The creation time of the IPAM.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DefaultResourceDiscoveryAssociationId: After an IPAM is created, the association between the resource discovery created by the system by default and the IPAM.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DefaultResourceDiscoveryId: After IPAM is created, the system creates resource discovery by default.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IpamDescription: The description of IPAM.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IpamId: The first ID of the resource.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IpamName: The name of the IPAM.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: OperatingRegionList: List of IPAM effective regions.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PrivateDefaultScopeId: After an IPAM is created, the scope of the private network IPAM created by the system by default.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PublicDefaultScopeId: After an IPAM is created, the public network IPAM is created by default.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ResourceDiscoveryAssociationCount: The number of resource discovery objects associated with IPAM.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The tag of the IPAM.
        /// </remarks>
        ...
        public virtual object? IpamDescription
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? IpamName
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosIpam.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosIpam.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-vpc.RosIpam.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Vpc.RosIpam.ITagsProperty
        {
            private object _key;
