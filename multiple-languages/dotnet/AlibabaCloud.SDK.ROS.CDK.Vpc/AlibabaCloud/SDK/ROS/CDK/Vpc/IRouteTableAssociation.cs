...
{
    /// <summary>Represents a `RouteTableAssociation`.</summary>
    [JsiiInterface(nativeType: typeof(IRouteTableAssociation), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IRouteTableAssociation")]
    public interface IRouteTableAssociation : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.IRouteTableAssociationProps Props
        {
            get;
        }

        /// <summary>Represents a `RouteTableAssociation`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRouteTableAssociation), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IRouteTableAssociation")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IRouteTableAssociation
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.RouteTableAssociationProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IRouteTableAssociationProps Props
            {
