...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::VPC::Vpcs`, which is used to query created virtual private clouds (VPCs).</summary>
    /// <remarks>
