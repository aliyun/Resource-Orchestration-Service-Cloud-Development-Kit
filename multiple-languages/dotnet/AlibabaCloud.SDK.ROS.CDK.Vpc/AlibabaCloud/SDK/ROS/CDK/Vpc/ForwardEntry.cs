...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::ForwardEntry`.</summary>
    /// <remarks>
    ...
    public class ForwardEntry : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IForwardEntryProps Props
        {
