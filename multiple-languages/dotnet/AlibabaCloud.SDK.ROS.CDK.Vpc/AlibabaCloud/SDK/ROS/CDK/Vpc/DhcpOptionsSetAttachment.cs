...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::DhcpOptionsSetAttachment`, which is used to associate a Dynamic Host Configuration Protocol (DHCP) options set with a virtual private cloud (VPC).</summary>
    /// <remarks>
    ...
    public class DhcpOptionsSetAttachment : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IDhcpOptionsSetAttachmentProps Props
        {
