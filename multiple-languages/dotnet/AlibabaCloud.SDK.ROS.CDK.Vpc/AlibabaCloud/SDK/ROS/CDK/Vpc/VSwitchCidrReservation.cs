...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::VSwitchCidrReservation`, which is used to create a reserved CIDR block for a vSwitch.</summary>
    /// <remarks>
    ...
    public class VSwitchCidrReservation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "attrVSwitchCidrReservationId", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrVSwitchCidrReservationId
        {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IVSwitchCidrReservationProps Props
        {
