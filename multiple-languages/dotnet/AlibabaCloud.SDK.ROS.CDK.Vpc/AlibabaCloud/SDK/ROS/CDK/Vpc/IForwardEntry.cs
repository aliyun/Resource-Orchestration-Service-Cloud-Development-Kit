...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IForwardEntry), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IForwardEntry")]
    public interface IForwardEntry : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.IForwardEntryProps Props
        {
            get;
        }

        /// <summary>Represents a `ForwardEntry`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IForwardEntry), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IForwardEntry")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IForwardEntry
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.ForwardEntryProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IForwardEntryProps Props
            {
