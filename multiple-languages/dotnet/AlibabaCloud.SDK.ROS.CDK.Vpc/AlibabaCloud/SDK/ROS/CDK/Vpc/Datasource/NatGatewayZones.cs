...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::VPC::NatGatewayZones`, which is used to query the zones of a NAT gateway.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosNatGatewayZones`for a more convenient development experience.
    ...
    public class NatGatewayZones : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.INatGatewayZones
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.INatGatewayZonesProps Props
        {
