...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::EIP`.</summary>
    /// <remarks>
    ...
    public class Eip : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPProps Props
        {
