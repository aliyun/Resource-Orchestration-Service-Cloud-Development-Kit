...
{
    /// <summary>Represents a `VSwitches`.</summary>
    [JsiiInterface(nativeType: typeof(IVSwitches), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.IVSwitches")]
    public interface IVSwitches : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IVSwitchesProps Props
        {
            get;
        }

        /// <summary>Represents a `VSwitches`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IVSwitches), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.IVSwitches")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IVSwitches
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.VSwitchesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IVSwitchesProps Props
            {
