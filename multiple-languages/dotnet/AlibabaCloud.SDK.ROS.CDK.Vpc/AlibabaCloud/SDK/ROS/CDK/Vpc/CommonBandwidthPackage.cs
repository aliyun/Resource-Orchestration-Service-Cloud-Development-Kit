...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::CommonBandwidthPackage`, which is used to create an Internet Shared Bandwidth instance.</summary>
    /// <remarks>
