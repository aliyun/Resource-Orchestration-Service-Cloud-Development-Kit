...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::VpcCidrBlockAssociation`, which is used to add a secondary CIDR block to a virtual private cloud (VPC).</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `VpcCidrBlockAssociation` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpccidrblockassociation
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.RosVpcCidrBlockAssociation), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosVpcCidrBlockAssociation", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.RosVpcCidrBlockAssociationProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosVpcCidrBlockAssociation : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosVpcCidrBlockAssociation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosVpcCidrBlockAssociationProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosVpcCidrBlockAssociationProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosVpcCidrBlockAssociation(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosVpcCidrBlockAssociation(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.RosVpcCidrBlockAssociation))!;

        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The ID of the VPC to which you want to add a secondary CIDR block.
        /// </remarks>
        ...
        public virtual object? IpamPoolId
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        /// <remarks>
        /// <strong>Property</strong>: ipv6CidrMask: Add an IPv6 network segment to the VPC from the IPAM address pool by specifying a mask.
        ...
        public virtual object? Ipv6CidrMask
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual object? SecondaryCidrMask
        {
            get => GetInstanceProperty<object?>();
            set
            {
