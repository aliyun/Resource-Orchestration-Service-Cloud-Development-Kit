...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::NatIpCidr`.</summary>
    /// <remarks>
    ...
    public class NatIpCidr : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.INatIpCidrProps Props
        {
