...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::VPC::VSwitch`, which is used to query the information about a vSwitch.</summary>
    /// <remarks>
