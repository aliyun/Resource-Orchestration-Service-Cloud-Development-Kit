...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::VPC::RouteTables`, which is used to query route tables.</summary>
    /// <remarks>
    ...
    public class RouteTables : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRouteTablesProps Props
        {
