...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::PrefixList`, which is used to create a prefix list.</summary>
    /// <remarks>
    ...
    public class PrefixList : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixList
    {
        ...
        public virtual object AttrEntries
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrMaxEntries
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrPrefixListDescription
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrPrefixListName
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.PrefixListProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixListProps Props
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Vpc.IPrefixListProps>()!;
        }
