...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    public class NetworkAcl : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public NetworkAcl(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.INetworkAclProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
