...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::IpamScope`, which is used to create an IP Address Manager (IPAM) scope.</summary>
    /// <remarks>
