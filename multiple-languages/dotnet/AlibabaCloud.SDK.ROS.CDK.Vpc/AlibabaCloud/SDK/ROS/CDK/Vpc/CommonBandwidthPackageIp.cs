...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::CommonBandwidthPackageIp`The , which resource adds one or more EIPs to a shared bandwidth instance.</summary>
    /// <remarks>
    ...
    public class CommonBandwidthPackageIp : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.ICommonBandwidthPackageIp
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.ICommonBandwidthPackageIpProps Props
        {
