...
{
    /// <summary>Represents a `EIPPro`.</summary>
    [JsiiInterface(nativeType: typeof(IEIPPro), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IEIPPro")]
    public interface IEIPPro : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPProProps Props
        {
            get;
        }

        /// <summary>Represents a `EIPPro`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEIPPro), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IEIPPro")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPPro
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.EIPProProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IEIPProProps Props
            {
