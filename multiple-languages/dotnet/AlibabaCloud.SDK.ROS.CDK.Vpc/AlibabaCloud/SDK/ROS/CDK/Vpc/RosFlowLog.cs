...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    public class RosFlowLog : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosFlowLog(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosFlowLogProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
