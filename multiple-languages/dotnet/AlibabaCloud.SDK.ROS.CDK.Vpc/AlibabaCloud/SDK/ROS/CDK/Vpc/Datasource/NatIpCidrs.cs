...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::VPC::NatIpCidrs`, which is used to query the CIDR blocks of a NAT gateway.</summary>
    /// <remarks>
    ...
    public class NatIpCidrs : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.INatIpCidrs
    {
        ...
        public virtual object AttrNatIpCidrIds
        {
        ...
        public virtual object AttrNatIpCidrs
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.NatIpCidrsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.INatIpCidrsProps Props
        {
