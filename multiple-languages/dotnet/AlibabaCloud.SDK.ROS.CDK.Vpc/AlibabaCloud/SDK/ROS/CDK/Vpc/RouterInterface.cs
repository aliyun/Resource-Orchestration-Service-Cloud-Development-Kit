...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::RouterInterface`, which is used to create a router interface.</summary>
    /// <remarks>
    ...
    public class RouterInterface : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IRouterInterfaceProps Props
        {
