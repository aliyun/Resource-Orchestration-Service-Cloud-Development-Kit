...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::Ipv4Gateway`, which is used to create an IPv4 gateway.</summary>
    /// <remarks>
    ...
    public class Ipv4Gateway : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4Gateway
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4GatewayProps Props
        {
