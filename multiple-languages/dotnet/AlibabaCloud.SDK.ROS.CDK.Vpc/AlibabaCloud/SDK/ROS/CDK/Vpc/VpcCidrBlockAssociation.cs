...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::VpcCidrBlockAssociation`, which is used to add a secondary CIDR block to a virtual private cloud (VPC).</summary>
    /// <remarks>
    ...
    public class VpcCidrBlockAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IVpcCidrBlockAssociationProps Props
        {
