...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::FullNatEntry`, which is used to add a FULLNAT entry to a FULLNAT table.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosFullNatEntry`for a more convenient development experience.
    ...
    public class FullNatEntry : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IFullNatEntryProps props, bool? enableResourcePropertyConstraint = null)
        {
        ...
        protected FullNatEntry(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected FullNatEntry(DeputyProps props): base(props)
        {
        }
