...
{
    /// <summary>Represents a `Ipv6Gateway`.</summary>
    ...
    public interface IIpv6Gateway : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv6GatewayProps Props
        {
            get;
        }

        /// <summary>Represents a `Ipv6Gateway`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IIpv6Gateway), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IIpv6Gateway")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv6Gateway
        {
            ...
            /// <summary>Attribute Ipv6GatewayId: ID IPv6 gateway.</summary>
            [JsiiProperty(name: "attrIpv6GatewayId", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}]}}")]
            public object AttrIpv6GatewayId
            {
                get => GetInstanceProperty<object>()!;
            }

            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.Ipv6GatewayProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv6GatewayProps Props
            {
