...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::VPC::Vpc`, which is used to query the information about a virtual private cloud (VPC).</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `Vpc` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-vpc-vpc
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosVpc), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.RosVpc", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.RosVpcProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosVpc : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosVpc(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosVpcProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosVpcProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosVpc))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CidrBlock: The IPv4 CIDR block of the VPC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ClassicLinkEnabled: status of vpc  ClassicLink..
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time at which the VPC was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the VPC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DhcpOptionsSetId: The ID of the DHCP option set.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Ipv6CidrBlock: The ipv6 cidr block of vpc.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Ipv6CidrBlocks: The IPv6 network segment of the VPC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IsDefault: Indicates whether to query the default VPC in the specified region. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouterId: The ID of the VRouter.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecondaryCidrBlocks: Additional network segment information.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The tags of Vpc.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserCidrs: A list of user CIDRs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcName: The name of the VPC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchIds: A list of VSwitches in the VPC.
        /// </remarks>
