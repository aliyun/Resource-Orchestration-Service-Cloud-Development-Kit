...
{
    /// <summary>A ROS resource type:  `ALIYUN::VPC::RouteTableAssociation`.</summary>
    ...
    public class RouteTableAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public RouteTableAssociation(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRouteTableAssociationProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
