...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::SnatEntry`, which is used to add SNAT entries to an SNAT table.</summary>
    /// <remarks>
