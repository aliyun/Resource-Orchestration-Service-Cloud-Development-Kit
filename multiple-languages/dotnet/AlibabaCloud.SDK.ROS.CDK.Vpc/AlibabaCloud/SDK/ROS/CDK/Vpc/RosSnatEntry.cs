...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::SnatEntry`The , which resource is used to add an SNAT entry to an SNAT table.</summary>
    /// <remarks>
    ...
    public class RosSnatEntry : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSnatEntry(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosSnatEntryProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosSnatEntryProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? EipAffinity
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        /// <remarks>
        /// <strong>Property</strong>: networkInterfaceId: The ID of the elastic network interface.
        ...
        /// <remarks>
        /// <strong>Property</strong>: sourceVSwitchIds: The ID of the VSwitch to access the Internet. When updating this list parameter, a new item will lead to a creation of new Snat Entry with latest properties, a removed item will lead to a deletion of the attached SnatEntry
        /// </remarks>
        [JsiiOptional]
