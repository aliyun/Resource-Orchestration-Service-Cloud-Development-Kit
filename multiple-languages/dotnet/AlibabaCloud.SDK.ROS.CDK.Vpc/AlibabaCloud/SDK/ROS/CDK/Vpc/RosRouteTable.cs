...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::RouteTable`, which is used to create a custom route table.</summary>
    /// <remarks>
    ...
    public class RosRouteTable : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosRouteTable(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosRouteTableProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosRouteTableProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? AssociateType
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.RosRouteTable.ITagsProperty[]? Tags
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Vpc.RosRouteTable.ITagsProperty[]?>();
            set => SetInstanceProperty(value);
        }
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosRouteTable.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosRouteTable.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.RosRouteTable.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-vpc.RosRouteTable.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Vpc.RosRouteTable.ITagsProperty
        {
            private object _key;
