...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::VPC::NatGateway`, which is used to query the information about a NAT gateway.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `NatGateway` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-vpc-natgateway
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosNatGateway), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.RosNatGateway", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.RosNatGatewayProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosNatGateway : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosNatGateway(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosNatGatewayProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosNatGatewayProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosNatGateway))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AutoPay: Indicates whether automatic payment is enabled. Valid values:
        /// false: no
        /// true: yes
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BusinessStatus: The status of the NAT gateway. Valid values:
        /// Normal: normal
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time when the NAT gateway was created. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DeletionProtection: Indicates whether the deletion protection feature is enabled. Valid values:
        /// true: yes
        /// false: no
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EipBindMode: The mode in which the NAT gateway is associated with an elastic IP address (EIP). Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExpiredTime: The time when the NAT gateway expires.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ForwardTableIds: The ID of the Destination Network Address Translation (DNAT) table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IcmpReplyEnabled: Indicates whether the ICMP non-retrieval feature is enabled. Valid values:
        /// true: yes
        /// false: no
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InternetChargeType: The metering method of the NAT gateway. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IpLists: The list of elastic IP addresses (EIPs) that are associated with the Internet NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NatGatewayId: The ID of the NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NatGatewayName: The name of the NAT gateway. The name must be 1 to 128 characters in length, and cannot start with http:// or https://. If this parameter is not set, the system automatically assigns a name to the NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NatGatewayPrivateInfo: The private network information about the enhanced Internet NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NatType: The type of the NAT gateway. The value is set to Enhanced (enhanced NAT gateway).
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: NetworkType: The type of NAT gateway. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PaymentType: The billing method of the NAT gateway. Valid values:  PrePaid: subscription PostPaid: pay-as-you-go.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityProtectionEnabled: Indicates whether the firewall feature is enabled. Valid values:
        /// false: no
        /// true: yes
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SnatTableIds: The ID of the SNAT table of the NAT gateway.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Spec: The size of the NAT gateway. An empty value is returned for the parameter. If InternetChargeType is set to PayByLcu, an empty value is returned.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The ID of the VPC where the NAT gateway is deployed.
        /// </remarks>
