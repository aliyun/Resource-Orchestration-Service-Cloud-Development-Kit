...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::EIPAssociation`Use , which to associate an Elastic IP Address (EIP) with a cloud service instance.</summary>
    /// <remarks>
