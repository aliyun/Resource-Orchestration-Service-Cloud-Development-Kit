...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::BgpPeer`.</summary>
    /// <remarks>
    ...
    public class BgpPeer : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IBgpPeerProps Props
        {
