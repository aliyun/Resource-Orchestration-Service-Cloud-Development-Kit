...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::VirtualBorderRouter`Use the , which resource to create a virtual border router (VBR).</summary>
    /// <remarks>
