...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::VirtualBorderRouter`.</summary>
    /// <remarks>
    ...
    public class VirtualBorderRouter : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IVirtualBorderRouterProps Props
        {
