...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::AnycastEIPAssociation`.</summary>
    /// <remarks>
    ...
    public class AnycastEIPAssociation : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.IAnycastEIPAssociation
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.IAnycastEIPAssociationProps Props
        {
