...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::VPC::RouteTable`, which is used to query the information about a route table.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `RouteTable` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-vpc-routetable
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosRouteTable), fullyQualifiedName: "@alicloud/ros-cdk-vpc.datasource.RosRouteTable", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-vpc.datasource.RosRouteTableProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosRouteTable : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosRouteTable(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosRouteTableProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.IRosRouteTableProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Vpc.Datasource.RosRouteTable))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The creation time of the routing table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: Description of the routing table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouterId: The router ID to which the routing table belongs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouterType: The router type to which the routing table belongs.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouteTableId: The ID of the routing table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouteTableName: The name of the routing table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RouteTableType: The type of routing table.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tags: The tag.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The ID of VPC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchIds: The ID of the switch.
        /// </remarks>
