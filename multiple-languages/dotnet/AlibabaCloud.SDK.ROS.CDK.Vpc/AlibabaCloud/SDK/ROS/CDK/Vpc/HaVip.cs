...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::HaVip`, which is used to apply for a high-availability virtual IP address (HAVIP).</summary>
    /// <remarks>
