...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::VirtualBorderRouter`, which is used to create a virtual border router (VBR).</summary>
    /// <remarks>
