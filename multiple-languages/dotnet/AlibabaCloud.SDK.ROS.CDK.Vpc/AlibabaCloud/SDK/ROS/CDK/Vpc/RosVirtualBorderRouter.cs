...
{
    /// <summary>A ROS template type:  `ALIYUN::VPC::VirtualBorderRouter`.</summary>
    ...
    public class RosVirtualBorderRouter : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosVirtualBorderRouter(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosVirtualBorderRouterProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
