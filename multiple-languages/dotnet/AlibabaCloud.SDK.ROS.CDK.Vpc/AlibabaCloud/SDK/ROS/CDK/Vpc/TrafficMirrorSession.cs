...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::TrafficMirrorSession`, which is used to create a traffic image session.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosTrafficMirrorSession`for a more convenient development experience.
    ...
    public class TrafficMirrorSession : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Vpc.ITrafficMirrorSession
    {
        ...
        public virtual object AttrTrafficMirrorSessionId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.TrafficMirrorSessionProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.ITrafficMirrorSessionProps Props
        {
