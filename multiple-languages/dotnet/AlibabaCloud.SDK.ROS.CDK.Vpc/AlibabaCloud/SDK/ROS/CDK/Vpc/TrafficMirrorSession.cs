...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::VPC::TrafficMirrorSession`DATASOURCE::VPC::NatGateways is used to query NAT gateways.</summary>
    /// <remarks>
