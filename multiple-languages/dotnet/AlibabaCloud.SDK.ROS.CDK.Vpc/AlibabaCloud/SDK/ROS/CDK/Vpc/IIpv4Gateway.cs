...
namespace AlibabaCloud.SDK.ROS.CDK.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IIpv4Gateway), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IIpv4Gateway")]
    public interface IIpv4Gateway : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.Ipv4GatewayProps\"}")]
        AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4GatewayProps Props
        {
            get;
        }

        /// <summary>Represents a `Ipv4Gateway`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IIpv4Gateway), fullyQualifiedName: "@alicloud/ros-cdk-vpc.IIpv4Gateway")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4Gateway
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-vpc.Ipv4GatewayProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4GatewayProps Props
            {
                get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Vpc.IIpv4GatewayProps>()!;
            }
