...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::VPC::EIP`The , which resource type requests an Elastic IP Address (EIP).</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `EIP` class instead of this class for a more convenient development experience.
    ...
    public class RosEIP : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosEIP(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosEIPProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Vpc.IRosEIPProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: instanceId: The instance ID of the requested EIP.
        ///
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Vpc.RosEIP.ITagsProperty[]? Tags
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: zone: Availability zone of the elastic public network IP.
        /// </remarks>
        [JsiiOptional]
        ...
        [JsiiInterface(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosEIP.TagsProperty")]
        public interface ITagsProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(ITagsProperty), fullyQualifiedName: "@alicloud/ros-cdk-vpc.RosEIP.TagsProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Vpc.RosEIP.ITagsProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-vpc.RosEIP.TagsProperty")]
        public class TagsProperty : AlibabaCloud.SDK.ROS.CDK.Vpc.RosEIP.ITagsProperty
        {
            private object _key;
