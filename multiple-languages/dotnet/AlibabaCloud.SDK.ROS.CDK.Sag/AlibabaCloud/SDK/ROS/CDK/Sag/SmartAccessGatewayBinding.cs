...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SAG::SmartAccessGatewayBinding`, which is used to bind a Smart Access Gateway (SAG) instance to a specified Cloud Connect Network (CCN) instance.</summary>
    /// <remarks>
    ...
    public class SmartAccessGatewayBinding : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Sag.ISmartAccessGatewayBindingProps Props
        {
