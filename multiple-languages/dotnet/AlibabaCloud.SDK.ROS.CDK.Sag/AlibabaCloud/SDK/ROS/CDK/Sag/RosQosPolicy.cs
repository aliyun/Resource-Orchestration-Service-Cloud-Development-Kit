...
namespace AlibabaCloud.SDK.ROS.CDK.Sag
{
    ...
    public class RosQosPolicy : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosQosPolicy(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosQosPolicyProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosQosPolicyProps props, bool enableResourcePropertyConstraint)
        {
