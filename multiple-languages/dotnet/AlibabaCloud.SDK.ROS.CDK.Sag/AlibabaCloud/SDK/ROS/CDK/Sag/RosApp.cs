...
{
    /// <summary>A ROS template type:  `ALIYUN::SAG::App`.</summary>
    ...
    public class RosApp : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosApp(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosAppProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
