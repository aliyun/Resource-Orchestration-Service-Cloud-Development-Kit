...
{
    /// <summary>A ROS template type:  `ALIYUN::SAG::QosCar`.</summary>
    ...
    public class RosQosCar : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosQosCar(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosQosCarProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
