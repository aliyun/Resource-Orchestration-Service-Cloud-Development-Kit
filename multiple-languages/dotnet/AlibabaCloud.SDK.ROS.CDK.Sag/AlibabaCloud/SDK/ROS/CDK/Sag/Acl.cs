...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::SAG::ACL`, which is used to create an access control list (ACL).</summary>
    /// <remarks>
    ...
    public class Acl : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Sag.IAcl
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Sag.IACLProps Props
        {
