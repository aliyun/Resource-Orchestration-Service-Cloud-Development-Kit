...
namespace AlibabaCloud.SDK.ROS.CDK.Sag
{
    ...
    public class RosAppUser : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosAppUser(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosAppUserProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: UserName: <heat.engine.properties.Schema object at 0x7f9b8661a510>
        /// </remarks>
