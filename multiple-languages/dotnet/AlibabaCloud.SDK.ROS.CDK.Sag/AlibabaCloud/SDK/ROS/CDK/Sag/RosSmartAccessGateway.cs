...
{
    /// <summary>A ROS template type:  `ALIYUN::SAG::SmartAccessGateway`.</summary>
    ...
    public class RosSmartAccessGateway : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosSmartAccessGateway(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Sag.IRosSmartAccessGatewayProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
