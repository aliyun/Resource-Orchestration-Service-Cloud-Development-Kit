...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CMS::MonitorGroup`, which is used to query the information about an application group.</summary>
    /// <remarks>
