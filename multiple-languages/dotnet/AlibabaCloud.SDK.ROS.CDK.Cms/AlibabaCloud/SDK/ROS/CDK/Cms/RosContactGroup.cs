...
namespace AlibabaCloud.SDK.ROS.CDK.Cms
{
    ...
    public class RosContactGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosContactGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cms.IRosContactGroupProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cms.IRosContactGroupProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object ContactNames
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        public virtual object? EnableSubscribed
        {
            get => GetInstanceProperty<object?>();
            set
            {
