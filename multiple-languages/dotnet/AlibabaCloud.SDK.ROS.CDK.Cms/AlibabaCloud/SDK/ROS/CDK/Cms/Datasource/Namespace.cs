...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CMS::Namespace`.</summary>
    /// <remarks>
    ...
    public class Namespace : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.INamespaceProps Props
        {
