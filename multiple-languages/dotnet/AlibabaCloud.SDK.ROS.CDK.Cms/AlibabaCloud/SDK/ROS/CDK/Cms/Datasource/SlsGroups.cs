...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CMS::SlsGroups`, which is used to query the information about Logstore groups.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosSlsGroups`for a more convenient development experience.
    ...
    public class SlsGroups : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.ISlsGroups
    {
        ...
        public virtual object AttrSlsGroupNames
        {
        ...
        public virtual object AttrSlsGroups
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cms.datasource.SlsGroupsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.ISlsGroupsProps Props
        {
