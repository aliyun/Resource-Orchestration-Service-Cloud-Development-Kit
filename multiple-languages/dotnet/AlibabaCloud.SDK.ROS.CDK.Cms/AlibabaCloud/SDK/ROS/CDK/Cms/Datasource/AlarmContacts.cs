...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CMS::AlarmContacts`, which is used to query the information about alert contacts.</summary>
    /// <remarks>
    ...
    public class AlarmContacts : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.IAlarmContacts
    {
        ...
        public virtual object AttrAlarmContactNames
        {
        ...
        public virtual object AttrAlarmContacts
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cms.datasource.AlarmContactsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.IAlarmContactsProps Props
        {
