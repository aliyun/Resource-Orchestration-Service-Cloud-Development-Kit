...
namespace AlibabaCloud.SDK.ROS.CDK.Cms
{
    ...
    /// <summary>Properties for defining a `EventRuleTargets`.</summary>
    /// <remarks>
    ...
    public class EventRuleTargetsProps : AlibabaCloud.SDK.ROS.CDK.Cms.IEventRuleTargetsProps
    {
        ...
        private object? _contactParameters;
        ...
        public object? ContactParameters
        {
            ...
            set
            {
                ...
                _contactParameters = value;
            }
        }

        private object? _fcParameters;
        ...
        public object? MnsParameters
        {
            ...
            set
            {
                ...
                _mnsParameters = value;
            }
        }

        private object? _openApiParameters;

        /// <summary>Property openApiParameters: API callback notification parameter list.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "openApiParameters", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"},{\"collection\":{\"elementtype\":{\"union\":{\"types\":[{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"},{\"fqn\":\"@alicloud/ros-cdk-cms.RosEventRuleTargets.OpenApiParametersProperty\"}]}},\"kind\":\"array\"}}]}}", isOptional: true)]
        public object? OpenApiParameters
        {
            get => _openApiParameters;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                        ...
                        case object[] cast_cd4240:
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Cms.RosEventRuleTargets.IOpenApiParametersProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cms.RosEventRuleTargets.IOpenApiParametersProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Cms.RosEventRuleTargets.IOpenApiParametersProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                ...
                _openApiParameters = value;
            }
        }

        private object? _slsParameters;
        ...
        public object? SlsParameters
        {
            ...
            set
            {
                ...
                _slsParameters = value;
            }
        }

        private object? _webhookParameters;
