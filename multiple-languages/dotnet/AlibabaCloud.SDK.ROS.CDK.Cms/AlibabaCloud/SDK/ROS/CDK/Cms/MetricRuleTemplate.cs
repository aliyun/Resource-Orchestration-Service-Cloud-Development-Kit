...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CMS::MetricRuleTemplate`, which is used to create an alert rule template.</summary>
    /// <remarks>
    ...
    public class MetricRuleTemplate : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cms.IMetricRuleTemplateProps Props
        {
