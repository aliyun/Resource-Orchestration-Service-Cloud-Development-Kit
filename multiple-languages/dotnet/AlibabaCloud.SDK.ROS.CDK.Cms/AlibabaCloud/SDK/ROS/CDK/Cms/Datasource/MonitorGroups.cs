...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CMS::MonitorGroups`, which is used to query the information about application groups.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosMonitorGroups`for a more convenient development experience.
    ...
    public class MonitorGroups : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.IMonitorGroups
    {
        ...
        public virtual object AttrGroupIds
        {
        ...
        public virtual object AttrMonitorGroups
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cms.datasource.MonitorGroupsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cms.Datasource.IMonitorGroupsProps Props
        {
