...
{
    /// <summary>A ROS template type:  `ALIYUN::CMS::GroupMetricRule`.</summary>
    ...
    public class RosGroupMetricRule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosGroupMetricRule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cms.IRosGroupMetricRuleProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        public virtual string? EffectiveInterval
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual string? NoEffectiveInterval
        {
            get => GetInstanceProperty<string?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual double? SilenceTime
        {
            get => GetInstanceProperty<double?>();
            set => SetInstanceProperty(value);
        }
        ...
        public interface ICriticalProperty
        {
            ...
            /// </remarks>
            [JsiiProperty(name: "times", typeJson: "{\"primitive\":\"number\"}")]
            double Times
            {
                get;
            }
        ...
        public class CriticalProperty : AlibabaCloud.SDK.ROS.CDK.Cms.RosGroupMetricRule.ICriticalProperty
        {
            ...
            /// metric.
            /// </remarks>
            [JsiiProperty(name: "statistics", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
            public string Statistics
            {
                get;
                set;
            ...
            /// critical-level alerts before an alert is triggered.
            /// </remarks>
            [JsiiProperty(name: "times", typeJson: "{\"primitive\":\"number\"}", isOverride: true)]
            public double Times
            {
                get;
                set;
        ...
        public class EscalationsProperty : AlibabaCloud.SDK.ROS.CDK.Cms.RosGroupMetricRule.IEscalationsProperty
        {
            ...
            /// </remarks>
            [JsiiOptional]
            [JsiiProperty(name: "critical", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"},{\"fqn\":\"@alicloud/ros-cdk-cms.RosGroupMetricRule.CriticalProperty\"}]}}", isOptional: true, isOverride: true)]
            public object? Critical
            {
                get;
                set;
            ...
            /// </remarks>
            [JsiiOptional]
            [JsiiProperty(name: "info", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"},{\"fqn\":\"@alicloud/ros-cdk-cms.RosGroupMetricRule.InfoProperty\"}]}}", isOptional: true, isOverride: true)]
            public object? Info
            {
                get;
                set;
            ...
            /// </remarks>
            [JsiiOptional]
            [JsiiProperty(name: "warn", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"},{\"fqn\":\"@alicloud/ros-cdk-cms.RosGroupMetricRule.WarnProperty\"}]}}", isOptional: true, isOverride: true)]
            public object? Warn
            {
                get;
                set;
