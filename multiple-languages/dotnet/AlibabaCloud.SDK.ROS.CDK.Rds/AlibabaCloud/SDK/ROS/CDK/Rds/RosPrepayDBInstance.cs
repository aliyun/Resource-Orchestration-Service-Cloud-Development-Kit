...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RDS::PrepayDBInstance`, which is used to create subscription ApsaraDB RDS instances.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `PrepayDBInstance` class instead of this class for a more convenient development experience.
    ...
    public class RosPrepayDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosPrepayDBInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosPrepayDBInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosPrepayDBInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        [JsiiInterface(nativeType: typeof(IServerlessConfigProperty), fullyQualifiedName: "@alicloud/ros-cdk-rds.RosPrepayDBInstance.ServerlessConfigProperty")]
        public interface IServerlessConfigProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(IServerlessConfigProperty), fullyQualifiedName: "@alicloud/ros-cdk-rds.RosPrepayDBInstance.ServerlessConfigProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rds.RosPrepayDBInstance.IServerlessConfigProperty
            {
                private _Proxy(ByRefValue reference): base(reference)
                {
                }
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-rds.RosPrepayDBInstance.ServerlessConfigProperty")]
        public class ServerlessConfigProperty : AlibabaCloud.SDK.ROS.CDK.Rds.RosPrepayDBInstance.IServerlessConfigProperty
        {
