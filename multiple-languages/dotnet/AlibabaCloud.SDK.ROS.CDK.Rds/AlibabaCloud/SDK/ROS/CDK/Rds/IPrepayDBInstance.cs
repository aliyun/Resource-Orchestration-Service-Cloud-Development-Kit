...
{
    /// <summary>Represents a `PrepayDBInstance`.</summary>
    [JsiiInterface(nativeType: typeof(IPrepayDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-rds.IPrepayDBInstance")]
    public interface IPrepayDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Rds.IPrepayDBInstanceProps Props
        {
            get;
        }

        /// <summary>Represents a `PrepayDBInstance`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPrepayDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-rds.IPrepayDBInstance")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rds.IPrepayDBInstance
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-rds.PrepayDBInstanceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Rds.IPrepayDBInstanceProps Props
            {
