...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RDS::DBInstance`The , which type is used to create an ApsaraDB RDS database instance.</summary>
    /// <remarks>
    ...
    public class DBInstance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Rds.IDBInstance
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Rds.IDBInstanceProps Props
        {
