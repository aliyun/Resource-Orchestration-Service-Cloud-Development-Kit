...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RDS::Database`The , which resource type creates a database in an RDS instance.</summary>
    /// <remarks>
