...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RDS::Database`, which is used to create a database in an ApsaraDB for RDS instance.</summary>
    /// <remarks>
    ...
    public class Database : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Rds.IDatabaseProps Props
        {
