...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::RDS::PostgresExtensions`.</summary>
    /// <remarks>
    ...
    public class PostgresExtensions : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Rds.IPostgresExtensions
    {
        ...
        public virtual object AttrInstalledExtensionNames
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-rds.PostgresExtensionsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Rds.IPostgresExtensionsProps Props
        {
