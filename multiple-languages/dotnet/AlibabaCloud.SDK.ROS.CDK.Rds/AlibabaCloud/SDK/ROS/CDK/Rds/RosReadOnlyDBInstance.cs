...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RDS::ReadOnlyDBInstance`, which is used to create a read-only ApsaraDB RDS instance.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `ReadOnlyDBInstance` class instead of this class for a more convenient development experience.
    ...
    public class RosReadOnlyDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosReadOnlyDBInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosReadOnlyDBInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosReadOnlyDBInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        /// <remarks>
        /// <strong>Property</strong>: engineVersion: The version of the database. The database and the master instance must have the same database version. Valid values: 5.6, 5.7, 8.0, 2017_ent, 2019_ent
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Property</strong>: category: The RDS edition of the read-only instance. Valid values:
        /// Basic: Basic Edition.
        ...
        /// <remarks>
        /// <strong>Property</strong>: dbInstanceStorageType: The type of storage media that is used by the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Property</strong>: dedicatedHostGroupId: The ID of the dedicated cluster to which the read-only instance belongs. This parameter is valid when you create the read-only instance in a dedicated cluster.
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <strong>Property</strong>: deletionProtection: Specifies whether to enable the release protection feature for the read-only instance. Valid values:- **true**: enables the feature.- **false** (default): disables the feature.
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <strong>Property</strong>: targetDedicatedHostIdForMaster: The ID of the host on which the primary instance resides. This parameter is valid when you create the read-only instance in a dedicated cluster.
        /// </remarks>
        [JsiiOptional]
