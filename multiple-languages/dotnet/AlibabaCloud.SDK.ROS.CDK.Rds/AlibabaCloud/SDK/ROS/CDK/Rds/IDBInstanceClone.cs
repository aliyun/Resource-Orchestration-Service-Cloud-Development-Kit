...
{
    /// <summary>Represents a `DBInstanceClone`.</summary>
    [JsiiInterface(nativeType: typeof(IDBInstanceClone), fullyQualifiedName: "@alicloud/ros-cdk-rds.IDBInstanceClone")]
    public interface IDBInstanceClone : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Rds.IDBInstanceCloneProps Props
        {
            get;
        }

        /// <summary>Represents a `DBInstanceClone`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDBInstanceClone), fullyQualifiedName: "@alicloud/ros-cdk-rds.IDBInstanceClone")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rds.IDBInstanceClone
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-rds.DBInstanceCloneProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Rds.IDBInstanceCloneProps Props
            {
