...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RDS::Database`The , which resource type creates a database in an RDS instance.</summary>
    /// <remarks>
    ...
    public class RosDatabase : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDatabase(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosDatabaseProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.IRosDatabaseProps props, bool enableResourcePropertyConstraint)
        {
