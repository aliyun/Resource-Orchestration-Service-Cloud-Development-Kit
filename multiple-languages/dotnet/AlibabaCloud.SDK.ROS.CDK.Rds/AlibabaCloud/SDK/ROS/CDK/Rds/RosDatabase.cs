...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::RDS::Database`, which is used to create a database in an ApsaraDB for RDS instance.</summary>
    /// <remarks>
