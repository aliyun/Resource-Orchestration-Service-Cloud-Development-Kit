...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::RDS::Zones`, which is used to query the zones of an ApsaraDB RDS instance.</summary>
    /// <remarks>
    ...
    public class Zones : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IZones
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IZonesProps Props
        {
