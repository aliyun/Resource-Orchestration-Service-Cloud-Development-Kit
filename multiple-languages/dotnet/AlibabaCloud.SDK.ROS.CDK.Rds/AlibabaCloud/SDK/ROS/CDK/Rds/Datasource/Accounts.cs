...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::RDS::Accounts`, which is used to query the information about database accounts of an ApsaraDB RDS instance.</summary>
    /// <remarks>
