...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::RDS::DBInstance`ALIYUN::REDIS::Account is used to create an account that has the specified permissions on an ApsaraDB for Redis instance.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.RosDBInstance), fullyQualifiedName: "@alicloud/ros-cdk-rds.datasource.RosDBInstance", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-rds.datasource.RosDBInstanceProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosDBInstance : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosDBInstance(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IRosDBInstanceProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IRosDBInstanceProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.RosDBInstance))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AccountMaxQuantity: The maximum number of accounts that can be created on the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AdvancedFeatures: The advanced features that are enabled for the instance. If multiple advanced features are enabled, the advanced features are separated by commas (,). This parameter is available only to instances that run SQL Server. Valid values:
        /// LinkedServer
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AutoUpgradeMinorVersion: The method that is used to update the minor engine version of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AvailabilityValue: The availability status of the instance in percentage.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BabelfishConfig: The configuration of the Babelfish feature for the ApsaraDB RDS for PostgreSQL instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Category: The RDS edition of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Collation: The character set collation of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConnectionMode: The connection mode of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConnectionString: The internal endpoint of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ConsoleVersion: The type of the proxy that is used by the instance. Valid values:
        /// 1: shared proxy
        /// 2: dedicated proxy
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreationTime: The creation time. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CurrentKernelVersion: The minor engine version of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBClusterNodes: The information about the node in the cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceClass: The instance type of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceClassType: The instance family to which the instance belongs. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceCPU: The number of CPU cores.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceDescription: The description of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceDiskUsed: The disk usage of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceId: The instance ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceMemory: The memory capacity of the instance. Unit: MB.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceNetType: The type of the network over which the instance is connected. Valid values:
        /// Internet: Internet
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceStatus: The status of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceStorage: The storage capacity of the instance. Unit: GB.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceStorageType: The storage type of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBInstanceType: The type of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DBMaxQuantity: The maximum number of databases that can be created on the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DedicatedHostGroupId: The ID of the dedicated cluster.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: DeletionProtection: Indicates whether the release protection feature is enabled. Valid values:
        /// true
        /// false
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Engine: The database engine of the instance. Valid values:
        /// MySQL
        /// PostgreSQL
        /// SQLServer
        /// MariaDB
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: EngineVersion: The database engine version.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExpireTime: The expiration time. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Extra: The extended information of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: GeneralGroupName: The name of the dedicated cluster to which the instance belongs. This parameter is returned only when the instance is created in an ApsaraDB MyBase cluster that runs MySQL on Standard Edition.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: GuardDBInstanceId: The ID of the disaster recovery instance that is attached to the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IncrementSourceDBInstanceId: The ID of the instance from which incremental data comes. The incremental data of a disaster recovery instance or read-only instance comes from its primary instance. If this parameter is not returned, the instance is a primary instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InstanceNetworkType: The network type of the instance. Valid values:
        /// Classic
        /// VPC
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: InstructionSetArch: The architecture type of the instance. Valid values:
        /// x86
        /// arm
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: IPType: The type of the IP address. Only IPv4 addresses are supported.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LatestKernelVersion: The latest minor engine version that is supported by the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LockMode: The lock mode of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LockReason: The reason why the instance was locked.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaintainTime: The maintenance window of the instance. The time is displayed in UTC. Take note that the maintenance window displayed in the ApsaraDB RDS console is equal to the value of this parameter plus 8 hours.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MasterInstanceId: The ID of the primary instance.
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MasterZone: The zone ID of the primary instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaxConnections: The maximum number of concurrent connections.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaxIOMBPS: The maximum I/O throughput. Unit: MB/s.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MaxIOPS: The maximum number of I/O requests per second.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PayType: The billing method of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PGBouncerEnabled: Indicates whether PgBouncer is enabled.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Port: The port that is used to connect to the instance over an internal network.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ProxyType: The type of the proxy that is supported by the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReadOnlyDBInstanceIds: The IDs of the read-only instances that are attached to the primary instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ReadonlyInstanceSQLDelayedTime: The latency at which the system replicates data to read-only instances. The system replicates data from the primary instance to the read-only instances at the latency that is specified by the ReadonlyInstanceSQLDelayedTime parameter. Unit: seconds.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ResourceGroupId: The resource group ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityIPList: The IP addresses in the IP address whitelist.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SecurityIPMode: The whitelist mode of the instance. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ServerlessConfig: The settings of the serverless instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SlaveZones: The information about the zone of the secondary instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: SuperPermissionMode: Indicates whether the instance supports superuser accounts, such as the system administrator (SA) account, the Active Directory (AD) account, and the host account.
        /// Enable
        /// Disabled
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TempDBInstanceId: The ID of the temporary instance that is attached to the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TimeZone: The time zone of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Tips: The information about the exception that is detected on the instance. This parameter is returned only when the instance is created in an ApsaraDB MyBase cluster that runs MySQL on Standard Edition.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TipsLevel: The severity level of the exception that is detected on the instance. This parameter is returned only when the instance is created in an ApsaraDB MyBase cluster that runs MySQL on Standard Edition. Valid values:
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcCloudInstanceId: The VPC ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VpcId: The virtual private cloud (VPC) ID of the instance.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: VSwitchId: The vSwitch ID.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ZoneId: The zone ID.
        /// </remarks>
