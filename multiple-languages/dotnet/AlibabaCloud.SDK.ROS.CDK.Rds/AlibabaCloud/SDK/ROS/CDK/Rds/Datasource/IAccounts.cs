...
namespace AlibabaCloud.SDK.ROS.CDK.Rds.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IAccounts), fullyQualifiedName: "@alicloud/ros-cdk-rds.datasource.IAccounts")]
    public interface IAccounts : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IAccountsProps Props
        {
            get;
        }

        /// <summary>Represents a `Accounts`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAccounts), fullyQualifiedName: "@alicloud/ros-cdk-rds.datasource.IAccounts")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IAccounts
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-rds.datasource.AccountsProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Rds.Datasource.IAccountsProps Props
            {
