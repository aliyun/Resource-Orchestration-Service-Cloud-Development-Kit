...
namespace AlibabaCloud.SDK.ROS.CDK.Dfs
{
    ...
    public class RosFileSystemProps : AlibabaCloud.SDK.ROS.CDK.Dfs.IRosFileSystemProps
    {
        ...
        private object? _dataRedundancyType;
        ...
        private object? _fileSystemName;
        ...
        private object? _partitionNumber;
        ...
        {
            get => _provisionedThroughputInMiBps;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _provisionedThroughputInMiBps = value;
            }
        }

        private object? _storageSetName;
