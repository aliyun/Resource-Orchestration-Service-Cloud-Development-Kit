...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DFS::MountPoint`.</summary>
    /// <remarks>
    ...
    public class MountPoint : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Dfs.IMountPoint
    {
        ...
        public virtual object AttrMountPointId
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-dfs.MountPointProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Dfs.IMountPointProps Props
        {
