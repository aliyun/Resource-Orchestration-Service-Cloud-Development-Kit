...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ROS::AutoEnableService`ALIYUN::ROS::CustomResource is used to create a custom resource.</summary>
    /// <remarks>
