...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ROS::CustomResource`, which is used to create a custom resource.</summary>
    /// <remarks>
    ...
    public class CustomResource : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ros.ICustomResourceProps Props
        {
