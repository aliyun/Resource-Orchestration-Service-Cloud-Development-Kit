...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ElasticSearchServerless::Endpoint`The , which is used to create an endpoint.</summary>
    /// <remarks>
