...
{
    /// <summary>A ROS template type:  `ALIYUN::WAF::DomainConfig`.</summary>
    ...
    public class RosDomainConfig : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDomainConfig(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Waf.IRosDomainConfigProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        /// </remarks>
        [JsiiProperty(name: "attrProtocolType", typeJson: "{\"primitive\":\"any\"}")]
        ...
        public virtual double IsAccessProduct
        {
        ...
        public virtual double? HttpsRedirect
        {
            get => GetInstanceProperty<double?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual double? HttpToUserIp
        {
            get => GetInstanceProperty<double?>();
            set => SetInstanceProperty(value);
        }
        ...
        public virtual double? LoadBalancing
        {
            get => GetInstanceProperty<double?>();
            set => SetInstanceProperty(value);
        }
