...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::WAF::LogServiceEnable`, which is used to enable the log collection feature for a specific domain name.</summary>
    /// <remarks>
    ...
    public class LogServiceEnable : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Waf.ILogServiceEnableProps Props
        {
