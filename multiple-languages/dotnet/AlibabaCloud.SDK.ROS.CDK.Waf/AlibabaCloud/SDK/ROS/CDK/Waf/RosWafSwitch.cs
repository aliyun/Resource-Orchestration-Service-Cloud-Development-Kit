...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::WAF::WafSwitch`, which is used to enable or disable Web attack protection.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `WafSwitch` class instead of this class for a more convenient development experience.
    ...
    public class RosWafSwitch : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosWafSwitch(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Waf.IRosWafSwitchProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Waf.IRosWafSwitchProps props, bool enableResourcePropertyConstraint)
        {
