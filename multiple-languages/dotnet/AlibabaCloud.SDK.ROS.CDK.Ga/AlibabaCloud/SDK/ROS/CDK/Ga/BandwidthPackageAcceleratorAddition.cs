...
{
    /// <summary>A ROS resource type:  `ALIYUN::GA::BandwidthPackageAcceleratorAddition`.</summary>
    ...
    public class BandwidthPackageAcceleratorAddition : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public BandwidthPackageAcceleratorAddition(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ga.IBandwidthPackageAcceleratorAdditionProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
