...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::GA::EndpointGroups`.</summary>
    /// <remarks>
    ...
    public class EndpointGroups : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Ga.IEndpointGroups
    {
        ...
        public virtual object AttrEndpointGroupIds
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ga.EndpointGroupsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Ga.IEndpointGroupsProps Props
        {
