...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::GA::BandwidthPackageAcceleratorAddition`.</summary>
    /// <remarks>
    ...
    public class RosBandwidthPackageAcceleratorAddition : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosBandwidthPackageAcceleratorAddition(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ga.IRosBandwidthPackageAcceleratorAdditionProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ga.IRosBandwidthPackageAcceleratorAdditionProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosBandwidthPackageAcceleratorAddition(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosBandwidthPackageAcceleratorAddition(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Ga.RosBandwidthPackageAcceleratorAddition))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AcceleratorId: The ID of the Global Accelerator instance
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BandwidthPackageId: The ID of the bandwidth package which is associated
        /// </remarks>
