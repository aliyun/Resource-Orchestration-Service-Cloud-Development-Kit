...
namespace AlibabaCloud.SDK.ROS.CDK.Ga
{
    ...
    [JsiiInterface(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-ga.IListener")]
    public interface IListener : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Ga.IListenerProps Props
        {
            get;
        }

        /// <summary>Represents a `Listener`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IListener), fullyQualifiedName: "@alicloud/ros-cdk-ga.IListener")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Ga.IListener
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-ga.ListenerProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Ga.IListenerProps Props
            {
