...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::GA::BandwidthPackage`, which is used to query the information about a bandwidth plan.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `BandwidthPackage` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/datasource-ga-bandwidthpackage
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Ga.Datasource.RosBandwidthPackage), fullyQualifiedName: "@alicloud/ros-cdk-ga.datasource.RosBandwidthPackage", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-ga.datasource.RosBandwidthPackageProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosBandwidthPackage : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosBandwidthPackage(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ga.Datasource.IRosBandwidthPackageProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Ga.Datasource.IRosBandwidthPackageProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Ga.Datasource.RosBandwidthPackage))!;

        /// <remarks>
        /// <strong>Attribute</strong>: AutoRenew: Whether to enable automatic renewal.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: AutoRenewDuration: The duration of automatic renewal. Unit: Month.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Bandwidth: The bandwidth value of the bandwidth package. Unit: Mbps. Value range: 2~2000.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BandwidthType: Bandwidth type.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: BillingType: Post-payment billing method.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CbnGeographicRegionIdA: The interworking region A of cross-region acceleration packages. The value is China-mainland only.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CbnGeographicRegionIdB: The interworking Region B of cross-region acceleration packages. The value is Global only.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: Bandwidth package creation time.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: the description of bandwidth package.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ExpiredTime: Bandwidth package expiration time.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: PaymentType: Type of payment.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Ratio: 95 Billing guaranteed percentage. Value range: 30~100.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: RenewalStatus: Renewal status.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Type: The type of the bandwidth package.
        /// </remarks>
