...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::GA::Acl`, which is used to query the information about an access control list (ACL).</summary>
    /// <remarks>
    ...
    public class Acl : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Ga.Datasource.IAclProps Props
        {
