...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::OOS::Template`The , which type is used to query the details of a single template.</summary>
    /// <remarks>
