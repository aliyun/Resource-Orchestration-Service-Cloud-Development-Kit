...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::OOS::SecretParameter`, which is used to query the information about an encryption parameter.</summary>
    /// <remarks>
    ...
    public class SecretParameter : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Oos.Datasource.ISecretParameter
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Oos.Datasource.ISecretParameterProps Props
        {
