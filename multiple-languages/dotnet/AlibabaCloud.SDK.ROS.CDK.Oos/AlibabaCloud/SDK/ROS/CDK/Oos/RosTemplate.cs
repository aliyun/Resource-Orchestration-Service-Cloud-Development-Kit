...
namespace AlibabaCloud.SDK.ROS.CDK.Oos
{
    ...
    public class RosTemplate : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosTemplate(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Oos.IRosTemplateProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
