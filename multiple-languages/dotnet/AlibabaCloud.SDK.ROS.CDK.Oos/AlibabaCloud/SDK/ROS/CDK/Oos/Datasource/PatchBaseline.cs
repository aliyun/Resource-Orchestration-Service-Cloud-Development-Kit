...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::OOS::PatchBaseline`, which is used to query a patch baseline.</summary>
    /// <remarks>
    ...
    public class PatchBaseline : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Oos.Datasource.IPatchBaseline
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Oos.Datasource.IPatchBaselineProps Props
        {
