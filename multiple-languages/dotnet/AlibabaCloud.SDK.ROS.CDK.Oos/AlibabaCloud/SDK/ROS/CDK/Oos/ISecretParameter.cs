...
namespace AlibabaCloud.SDK.ROS.CDK.Oos
{
    ...
    [JsiiInterface(nativeType: typeof(ISecretParameter), fullyQualifiedName: "@alicloud/ros-cdk-oos.ISecretParameter")]
    public interface ISecretParameter : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Oos.ISecretParameterProps Props
        {
            get;
        }

        /// <summary>Represents a `SecretParameter`.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISecretParameter), fullyQualifiedName: "@alicloud/ros-cdk-oos.ISecretParameter")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Oos.ISecretParameter
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-oos.SecretParameterProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Oos.ISecretParameterProps Props
            {
