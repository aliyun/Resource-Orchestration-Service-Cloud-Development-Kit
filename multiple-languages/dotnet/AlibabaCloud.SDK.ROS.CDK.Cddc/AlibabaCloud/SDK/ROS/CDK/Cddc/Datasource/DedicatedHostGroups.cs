...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::CDDC::DedicatedHostGroups`.</summary>
    /// <remarks>
    ...
    public class DedicatedHostGroups : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Cddc.Datasource.IDedicatedHostGroups
    {
        ...
        public virtual object AttrDedicatedHostGroupIds
        {
        ...
        public virtual object AttrDedicatedHostGroups
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cddc.datasource.DedicatedHostGroupsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Cddc.Datasource.IDedicatedHostGroupsProps Props
        {
