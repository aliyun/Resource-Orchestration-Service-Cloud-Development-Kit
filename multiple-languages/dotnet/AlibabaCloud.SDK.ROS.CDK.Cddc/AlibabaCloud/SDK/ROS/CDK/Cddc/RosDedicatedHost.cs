...
namespace AlibabaCloud.SDK.ROS.CDK.Cddc
{
    ...
    public class RosDedicatedHost : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDedicatedHost(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cddc.IRosDedicatedHostProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
