...
namespace AlibabaCloud.SDK.ROS.CDK.Cddc
{
    ...
    [JsiiInterface(nativeType: typeof(IDedicatedHostGroup), fullyQualifiedName: "@alicloud/ros-cdk-cddc.IDedicatedHostGroup")]
    public interface IDedicatedHostGroup : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Cddc.IDedicatedHostGroupProps Props
        {
            get;
        }

        /// <summary>Represents a `DedicatedHostGroup`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDedicatedHostGroup), fullyQualifiedName: "@alicloud/ros-cdk-cddc.IDedicatedHostGroup")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Cddc.IDedicatedHostGroup
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-cddc.DedicatedHostGroupProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Cddc.IDedicatedHostGroupProps Props
            {
