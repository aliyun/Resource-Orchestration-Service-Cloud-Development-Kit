...
namespace AlibabaCloud.SDK.ROS.CDK.Cddc
{
    ...
    public class RosDedicatedHostGroup : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosDedicatedHostGroup(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cddc.IRosDedicatedHostGroupProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
