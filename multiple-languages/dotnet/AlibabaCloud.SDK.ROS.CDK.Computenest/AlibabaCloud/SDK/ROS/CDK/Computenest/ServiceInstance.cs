...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ComputeNest::ServiceInstance`The , which type is used to create and deploy a service instance.</summary>
    /// <remarks>
