...
namespace AlibabaCloud.SDK.ROS.CDK.Computenest
{
    ...
    public class RosServiceInstanceProps : AlibabaCloud.SDK.ROS.CDK.Computenest.IRosServiceInstanceProps
    {
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_cd4240:
                            break;
                        case AlibabaCloud.SDK.ROS.CDK.Computenest.RosServiceInstance.ICommodityProperty cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Computenest.RosServiceInstance.ICommodityProperty).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _commodity = value;
            }
        ...
        private object? _enableInstanceOps;
        ...
        public object? EnableInstanceOps
        {
            ...
            set
            {
                ...
                _enableInstanceOps = value;
            }
        }

        private object? _enableUserPrometheus;
        ...
        private object? _predefinedParameterName;
        ...
        public object? PredefinedParameterName
        {
            ...
            set
            {
                ...
                _predefinedParameterName = value;
            }
        }
        ...
        private object? _specificationCode;
