...
{
    /// <summary>A ROS resource type:  `ALIYUN::PVTZ::UserVpcAuthorization`.</summary>
    ...
    public class UserVpcAuthorization : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public UserVpcAuthorization(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Pvtz.IUserVpcAuthorizationProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
