...
namespace AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IZones), fullyQualifiedName: "@alicloud/ros-cdk-pvtz.datasource.IZones")]
    public interface IZones : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource.IZonesProps Props
        {
            get;
        }

        /// <summary>Represents a `Zones`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IZones), fullyQualifiedName: "@alicloud/ros-cdk-pvtz.datasource.IZones")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource.IZones
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-pvtz.datasource.ZonesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource.IZonesProps Props
            {
