...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PVTZ::Zone`, which is used to query the information about a built-in authoritative zone.</summary>
    /// <remarks>
