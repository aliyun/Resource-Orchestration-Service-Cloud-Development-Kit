...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PVTZ::Zones`, which is used to query built-in authoritative zones.</summary>
    /// <remarks>
    ...
    public class Zones : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource.IZonesProps Props
        {
