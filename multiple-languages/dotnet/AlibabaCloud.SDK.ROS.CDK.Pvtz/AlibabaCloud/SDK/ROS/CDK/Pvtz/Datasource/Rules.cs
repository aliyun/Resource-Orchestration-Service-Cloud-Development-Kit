...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PVTZ::Rules`, which is used to query forwarding rules.</summary>
    /// <remarks>
    ...
    public class Rules : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Pvtz.Datasource.IRulesProps Props
        {
