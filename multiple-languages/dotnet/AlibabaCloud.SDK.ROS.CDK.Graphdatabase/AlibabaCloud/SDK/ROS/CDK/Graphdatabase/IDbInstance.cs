...
namespace AlibabaCloud.SDK.ROS.CDK.Graphdatabase
{
    ...
    [JsiiInterface(nativeType: typeof(IDbInstance), fullyQualifiedName: "@alicloud/ros-cdk-graphdatabase.IDbInstance")]
    public interface IDbInstance : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Graphdatabase.IDbInstanceProps Props
        {
            get;
        }

        /// <summary>Represents a `DbInstance`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDbInstance), fullyQualifiedName: "@alicloud/ros-cdk-graphdatabase.IDbInstance")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Graphdatabase.IDbInstance
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-graphdatabase.DbInstanceProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Graphdatabase.IDbInstanceProps Props
            {
