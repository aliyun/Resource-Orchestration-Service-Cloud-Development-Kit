...
namespace AlibabaCloud.SDK.ROS.CDK.Graphdatabase
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-graphdatabase.DbInstanceProps")]
    public class DbInstanceProps : AlibabaCloud.SDK.ROS.CDK.Graphdatabase.IDbInstanceProps
    {
        ...
        public object DbInstanceCategory
        {
            ...
            set
            {
                ...
                _dbInstanceCategory = value;
            }
        }

        private object _dbInstanceNetworkType;
        ...
        public object DbNodeStorage
        {
            ...
            set
            {
                ...
                _dbNodeStorage = value;
            }
        }

        private object _dbVersion;
        ...
        private object? _dbInstanceIpArray;
        ...
        public object? DbInstanceIpArray
        {
            ...
            set
            {
                            ...
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IDBInstanceIPArrayProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IDBInstanceIPArrayProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IDBInstanceIPArrayProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                ...
                _dbInstanceIpArray = value;
            }
        }

        private object? _ecsSecurityGroupRelations;
        ...
        {
            get => _ecsSecurityGroupRelations;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                        ...
                        case object[] cast_cd4240:
                            for (var __idx_f64a5c = 0 ; __idx_f64a5c < cast_cd4240.Length ; __idx_f64a5c++)
                            {
                                switch (cast_cd4240[__idx_f64a5c])
                                {
                                    case AlibabaCloud.SDK.ROS.CDK.Core.IResolvable cast_201718:
                                        break;
                                    case AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IEcsSecurityGroupRelationsProperty cast_201718:
                                        break;
                                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_201718:
                                        // Not enough information to type-check...
                                        break;
                                    case null:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IEcsSecurityGroupRelationsProperty).FullName}; received null", nameof(value));
                                    default:
                                        throw new System.ArgumentException($"Expected {nameof(value)}[{__idx_f64a5c}] to be one of: {typeof(AlibabaCloud.SDK.ROS.CDK.Core.IResolvable).FullName}, {typeof(AlibabaCloud.SDK.ROS.CDK.Graphdatabase.RosDbInstance.IEcsSecurityGroupRelationsProperty).FullName}; received {cast_cd4240[__idx_f64a5c].GetType().FullName}", nameof(value));
                                }
                            }
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                ...
                _ecsSecurityGroupRelations = value;
            }
        }
        ...
        private object? _sourceDbInstanceId;
