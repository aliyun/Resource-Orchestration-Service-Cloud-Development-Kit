...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::DataLakeFormation::Permissions`The , which resource type is used to grant permissions in a batch.</summary>
    /// <remarks>
