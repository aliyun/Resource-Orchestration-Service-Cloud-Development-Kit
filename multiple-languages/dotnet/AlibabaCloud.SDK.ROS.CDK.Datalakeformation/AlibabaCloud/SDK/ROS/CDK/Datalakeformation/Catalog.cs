...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::DataLakeFormation::Catalog`The , which type creates a data catalog in Data Lake Formation.</summary>
    /// <remarks>
