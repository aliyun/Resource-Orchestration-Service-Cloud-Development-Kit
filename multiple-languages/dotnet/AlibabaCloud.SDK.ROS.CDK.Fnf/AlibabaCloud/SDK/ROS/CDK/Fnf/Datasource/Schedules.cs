...
namespace AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource
{
    ...
    public class Schedules : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.ISchedules
    {
        ...
        public virtual object AttrScheduleNames
        {
        ...
        public virtual object AttrSchedules
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-fnf.datasource.SchedulesProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.ISchedulesProps Props
        {
