...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `DATASOURCE::FNF::Schedule`, which is used to query the information about a time-based schedule.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.RosSchedule), fullyQualifiedName: "@alicloud/ros-cdk-fnf.datasource.RosSchedule", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-fnf.datasource.RosScheduleProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosSchedule : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosSchedule(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.IRosScheduleProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.IRosScheduleProps props, bool enableResourcePropertyConstraint)
        {
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.RosSchedule))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CreateTime: The time when the time-based schedule was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: CronExpression: The CRON expression of the time-based schedule to be created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Description: The description of the time-based schedule to be created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: LastModifiedTime: The time when the time-based schedule was last updated.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Payload: The trigger message of the time-based schedule to be created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScheduleId: The ID of the time-based schedule.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: ScheduleName: The name of the time-based schedule to be created.
        /// </remarks>
