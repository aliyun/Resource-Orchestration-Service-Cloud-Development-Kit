...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::FNF::Flows`, which is used to query multiple flows at a time.</summary>
    /// <remarks>
    ...
    public class Flows : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Fnf.Datasource.IFlowsProps Props
        {
