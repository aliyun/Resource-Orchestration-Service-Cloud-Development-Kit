...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::DMS::Database`The , which data source queries the details of a specific database.</summary>
    /// <remarks>
