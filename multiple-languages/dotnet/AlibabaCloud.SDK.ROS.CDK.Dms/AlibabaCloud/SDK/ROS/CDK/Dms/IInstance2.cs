...
{
    /// <summary>Represents a `Instance2`.</summary>
    [JsiiInterface(nativeType: typeof(IInstance2), fullyQualifiedName: "@alicloud/ros-cdk-dms.IInstance2")]
    public interface IInstance2 : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Dms.IInstance2Props Props
        {
            get;
        }

        /// <summary>Represents a `Instance2`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IInstance2), fullyQualifiedName: "@alicloud/ros-cdk-dms.IInstance2")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Dms.IInstance2
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-dms.Instance2Props\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Dms.IInstance2Props Props
            {
