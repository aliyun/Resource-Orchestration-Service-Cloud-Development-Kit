...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::DMS::Instance2`, which is used to register a database instance in new Data Management (DMS).</summary>
    /// <remarks>
