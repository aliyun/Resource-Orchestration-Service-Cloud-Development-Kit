...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PolarDBX::Database`, which is used to query the information about a PolarDB for Xscale (PolarDB-X) database.</summary>
    /// <remarks>
