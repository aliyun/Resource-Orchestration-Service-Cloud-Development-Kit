...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PolarDBX::Accounts`, which is used to query PolarDB for Xscale (PolarDB-X) accounts.</summary>
    /// <remarks>
