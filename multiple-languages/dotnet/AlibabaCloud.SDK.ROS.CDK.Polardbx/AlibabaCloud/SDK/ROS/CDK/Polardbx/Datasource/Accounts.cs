...
namespace AlibabaCloud.SDK.ROS.CDK.Polardbx.Datasource
{
    ...
    public class Accounts : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "attrPolarDbxAccountNames", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrPolarDbxAccountNames
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }

        /// <summary>Attribute PolarDBXAccounts: The list of PolarDB-X 2.0 accounts.</summary>
        [JsiiProperty(name: "attrPolarDbxAccounts", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrPolarDbxAccounts
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Polardbx.Datasource.IAccountsProps Props
        {
