...
namespace AlibabaCloud.SDK.ROS.CDK.Polardbx.Datasource
{
    ...
    public class Account : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        [JsiiProperty(name: "attrPolarDbxAccountName", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-core.IResolvable\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Core.IResolvable AttrPolarDbxAccountName
        {
            get => GetInstanceProperty<AlibabaCloud.SDK.ROS.CDK.Core.IResolvable>()!;
        }
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Polardbx.Datasource.IAccountProps Props
        {
