...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::PolarDBX::Account`, which is used to query the information about a PolarDB for Xscale (PolarDB-X) account.</summary>
    /// <remarks>
