...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::ECI::ImageCache`.</summary>
    /// <remarks>
    ...
    public class RosImageCache : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosImageCache(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Eci.IRosImageCacheProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Eci.IRosImageCacheProps props, bool enableResourcePropertyConstraint)
        {
        ...
        public virtual object? ImageCacheSize
        {
            get => GetInstanceProperty<object?>();
            set
            {
        ...
        [JsiiInterface(nativeType: typeof(IAcrRegistryInfoProperty), fullyQualifiedName: "@alicloud/ros-cdk-eci.RosImageCache.AcrRegistryInfoProperty")]
        public interface IAcrRegistryInfoProperty
        {
            ...
            [JsiiTypeProxy(nativeType: typeof(IAcrRegistryInfoProperty), fullyQualifiedName: "@alicloud/ros-cdk-eci.RosImageCache.AcrRegistryInfoProperty")]
            internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Eci.RosImageCache.IAcrRegistryInfoProperty
            {
        ...
        [JsiiByValue(fqn: "@alicloud/ros-cdk-eci.RosImageCache.AcrRegistryInfoProperty")]
        public class AcrRegistryInfoProperty : AlibabaCloud.SDK.ROS.CDK.Eci.RosImageCache.IAcrRegistryInfoProperty
        {
