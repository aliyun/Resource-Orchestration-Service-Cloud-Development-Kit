...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::WAF3::TGW`, which is used to add a resource to Web Application Firewall (WAF) in transparent proxy mode.</summary>
    /// <remarks>
