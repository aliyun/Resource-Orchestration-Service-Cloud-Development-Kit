...
namespace AlibabaCloud.SDK.ROS.CDK.Resourcemanager.Datasource
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "@alicloud/ros-cdk-resourcemanager.datasource.ResourceGroupProps")]
    public class ResourceGroupProps : AlibabaCloud.SDK.ROS.CDK.Resourcemanager.Datasource.IResourceGroupProps
    {
        private object? _includeTags;

        /// <summary>Property includeTags: Whether to include the tags of the resource group in the query results.</summary>
        [JsiiOptional]
