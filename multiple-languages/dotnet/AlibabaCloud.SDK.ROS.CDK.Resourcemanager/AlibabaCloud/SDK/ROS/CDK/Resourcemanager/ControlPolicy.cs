...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::ResourceManager::ControlPolicy`, which is used to create a custom control policy.</summary>
    /// <remarks>
    ...
    public class ControlPolicy : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Resourcemanager.IControlPolicyProps Props
        {
