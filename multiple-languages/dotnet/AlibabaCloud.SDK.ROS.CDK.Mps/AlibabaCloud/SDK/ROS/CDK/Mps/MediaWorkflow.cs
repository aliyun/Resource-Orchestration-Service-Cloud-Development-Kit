...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::MPS::MediaWorkflow`.</summary>
    /// <remarks>
    ...
    public class MediaWorkflow : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Mps.IMediaWorkflow
    {
        ...
        public virtual object AttrMediaWorkflowId
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrTopology
        {
            get => GetInstanceProperty<object>()!;
        }
        ...
        public virtual object AttrTriggerMode
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-mps.MediaWorkflowProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Mps.IMediaWorkflowProps Props
        {
