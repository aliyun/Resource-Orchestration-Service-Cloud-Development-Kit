...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::MPS::MediaWorkflow`, which is used to add a media workflow.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class does not contain additional functions, so it is recommended to use the `MediaWorkflow` class instead of this class for a more convenient development experience.
    /// See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mps-mediaworkflow
    /// </remarks>
    [JsiiClass(nativeType: typeof(AlibabaCloud.SDK.ROS.CDK.Mps.RosMediaWorkflow), fullyQualifiedName: "@alicloud/ros-cdk-mps.RosMediaWorkflow", parametersJson: "[{\"docs\":{\"summary\":\"- scope in which this resource is defined.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-core.Construct\"}},{\"docs\":{\"summary\":\"- scoped id of the resource.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"- resource properties.\"},\"name\":\"props\",\"type\":{\"fqn\":\"@alicloud/ros-cdk-mps.RosMediaWorkflowProps\"}},{\"name\":\"enableResourcePropertyConstraint\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class RosMediaWorkflow : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        /// <param name="scope">- scope in which this resource is defined.</param>
        /// <param name="id">- scoped id of the resource.</param>
        /// <param name="props">- resource properties.</param>
        public RosMediaWorkflow(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mps.IRosMediaWorkflowProps props, bool enableResourcePropertyConstraint): base(_MakeDeputyProps(scope, id, props, enableResourcePropertyConstraint))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Mps.IRosMediaWorkflowProps props, bool enableResourcePropertyConstraint)
        {
        ...
        protected RosMediaWorkflow(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RosMediaWorkflow(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(AlibabaCloud.SDK.ROS.CDK.Mps.RosMediaWorkflow))!;

        /// <remarks>
        /// <strong>Attribute</strong>: CreationTime: The time when the media workflow was created.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: MediaWorkflowId: The ID of the media workflow.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Name: The name of the media workflow.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: State: The state of the media workflow.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: Topology: The topology of the media workflow.
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Attribute</strong>: TriggerMode: The trigger mode of the media workflow.
        /// </remarks>
        ...
        public virtual object? TriggerMode
        {
            get => GetInstanceProperty<object?>();
            set
            {
