...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CAS::Order`, which is used to create a certificate order.</summary>
    /// <remarks>
    ...
    public class Order : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cas.IOrderProps Props
        {
