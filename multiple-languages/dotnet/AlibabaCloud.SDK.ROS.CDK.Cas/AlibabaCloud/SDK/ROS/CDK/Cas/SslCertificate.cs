...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::CAS::SslCertificate`, which is used to create an SSL certificate.</summary>
    /// <remarks>
    ...
    public class SslCertificate : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Cas.ISslCertificateProps Props
        {
