...
namespace AlibabaCloud.SDK.ROS.CDK.Cas
{
    ...
    public class RosCertificate : AlibabaCloud.SDK.ROS.CDK.Core.RosResource
    {
        ...
        public RosCertificate(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Cas.IRosCertificateProps props, bool enableResourcePropertyConstraint): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
