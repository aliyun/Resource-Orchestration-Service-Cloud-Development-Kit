...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::REDIS::AuditLogConfig`, which is used to modify the audit log settings of a Tair (Redis OSS-compatible) instance.</summary>
    /// <remarks>
    ...
    public class AuditLogConfig : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Redis.IAuditLogConfig
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Redis.IAuditLogConfigProps Props
        {
