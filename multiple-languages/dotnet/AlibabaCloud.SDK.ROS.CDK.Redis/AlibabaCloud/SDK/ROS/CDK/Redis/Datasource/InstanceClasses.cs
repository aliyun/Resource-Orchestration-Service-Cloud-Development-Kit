...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::REDIS::InstanceClasses`DATASOURCE::REDIS::Instances is used to query the information about ApsaraDB for Redis instances.</summary>
    /// <remarks>
