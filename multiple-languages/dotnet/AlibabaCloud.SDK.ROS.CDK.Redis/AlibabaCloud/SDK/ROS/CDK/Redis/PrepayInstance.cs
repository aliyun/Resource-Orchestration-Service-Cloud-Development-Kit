...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::REDIS::PrepayInstance`, which is used to create a subscription Tair (Redis OSS-compatible) instance.</summary>
    /// <remarks>
    ...
    public class PrepayInstance : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Redis.IPrepayInstance
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Redis.IPrepayInstanceProps Props
        {
