...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::REDIS::Whitelist`The , which type sets the IP whitelist for a Redis instance.</summary>
    /// <remarks>
