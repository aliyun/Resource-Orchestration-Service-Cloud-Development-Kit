...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::REDIS::Instance`, which is used to create an ApsaraDB for Redis instance.</summary>
    /// <remarks>
