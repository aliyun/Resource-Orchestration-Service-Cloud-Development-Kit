...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::REDIS::Instances`, which is used to query the information about Tair (Redis OSS-compatible) instances.</summary>
    /// <remarks>
    ...
    public class Instances : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Redis.Datasource.IInstances
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Redis.Datasource.IInstancesProps Props
        {
