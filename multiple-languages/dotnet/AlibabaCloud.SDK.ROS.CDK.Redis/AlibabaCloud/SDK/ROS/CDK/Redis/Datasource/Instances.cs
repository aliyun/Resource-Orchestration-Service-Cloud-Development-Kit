...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::REDIS::Instances`, which is used to query the information about ApsaraDB for Redis instances.</summary>
    /// <remarks>
    ...
    public class Instances : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Redis.Datasource.IInstancesProps Props
        {
