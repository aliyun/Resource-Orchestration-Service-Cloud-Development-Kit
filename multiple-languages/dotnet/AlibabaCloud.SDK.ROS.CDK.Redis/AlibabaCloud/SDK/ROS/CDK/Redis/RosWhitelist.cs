...
{
    /// <summary>This class is a base encapsulation around the ROS resource type `ALIYUN::REDIS::Whitelist`The , which type sets the IP whitelist for a Redis instance.</summary>
    /// <remarks>
