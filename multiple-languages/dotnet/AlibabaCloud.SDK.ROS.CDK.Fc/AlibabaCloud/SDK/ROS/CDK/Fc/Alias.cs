...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::FC::Alias`The , which type creates an alias for a service version in Function Compute.</summary>
    /// <remarks>
    ...
    public class Alias : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Fc.IAlias
    {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Fc.IAliasProps Props
        {
