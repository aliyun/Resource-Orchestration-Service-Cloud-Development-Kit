...
namespace AlibabaCloud.SDK.ROS.CDK.Fc.Datasource
{
    ...
    [JsiiInterface(nativeType: typeof(IServices), fullyQualifiedName: "@alicloud/ros-cdk-fc.datasource.IServices")]
    public interface IServices : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.IServicesProps Props
        {
            get;
        }

        /// <summary>Represents a `Services`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IServices), fullyQualifiedName: "@alicloud/ros-cdk-fc.datasource.IServices")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.IServices
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-fc.datasource.ServicesProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.IServicesProps Props
            {
