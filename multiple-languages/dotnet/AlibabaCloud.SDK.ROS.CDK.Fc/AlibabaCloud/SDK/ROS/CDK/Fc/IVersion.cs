...
{
    /// <summary>Represents a `Version`.</summary>
    [JsiiInterface(nativeType: typeof(IVersion), fullyQualifiedName: "@alicloud/ros-cdk-fc.IVersion")]
    public interface IVersion : AlibabaCloud.SDK.ROS.CDK.Core.IResource
    {
        ...
        AlibabaCloud.SDK.ROS.CDK.Fc.IVersionProps Props
        {
            get;
        }

        /// <summary>Represents a `Version`.</summary>
        [JsiiTypeProxy(nativeType: typeof(IVersion), fullyQualifiedName: "@alicloud/ros-cdk-fc.IVersion")]
        internal sealed class _Proxy : DeputyBase, AlibabaCloud.SDK.ROS.CDK.Fc.IVersion
        {
            ...
            [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-fc.VersionProps\"}")]
            public AlibabaCloud.SDK.ROS.CDK.Fc.IVersionProps Props
            {
