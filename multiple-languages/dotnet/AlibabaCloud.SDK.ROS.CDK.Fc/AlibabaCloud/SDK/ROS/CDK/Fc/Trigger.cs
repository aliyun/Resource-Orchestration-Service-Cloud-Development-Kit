...
namespace AlibabaCloud.SDK.ROS.CDK.Fc
{
    ...
    public class Trigger : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        /// </remarks>
        public Trigger(AlibabaCloud.SDK.ROS.CDK.Core.Construct scope, string id, AlibabaCloud.SDK.ROS.CDK.Fc.ITriggerProps props, bool? enableResourcePropertyConstraint = null): base(new DeputyProps(new object?[]{scope, id, props, enableResourcePropertyConstraint}))
        {
        }
        ...
        [JsiiProperty(name: "attrTriggerId", typeJson: "{\"primitive\":\"any\"}")]
        ...
        [JsiiProperty(name: "attrTriggerName", typeJson: "{\"primitive\":\"any\"}")]
