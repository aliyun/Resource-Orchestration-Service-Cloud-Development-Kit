...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::FC::Functions`.</summary>
    /// <remarks>
    ...
    public class Functions : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.IFunctions
    {
        ...
        public virtual object AttrFunctionNames
        {
        ...
        public virtual object AttrFunctions
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "props", typeJson: "{\"fqn\":\"@alicloud/ros-cdk-fc.datasource.FunctionsProps\"}")]
        public virtual AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.IFunctionsProps Props
        {
