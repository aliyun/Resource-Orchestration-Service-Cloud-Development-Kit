...
{
    /// <summary>This class encapsulates and extends the ROS resource type `ALIYUN::FC::Function`, which is used to create a function.</summary>
    /// <remarks>
    ...
    public class Function : AlibabaCloud.SDK.ROS.CDK.Core.Resource_
    {
        ...
        protected virtual AlibabaCloud.SDK.ROS.CDK.Fc.IFunctionProps Props
        {
