...
{
    /// <summary>This class encapsulates and extends the ROS resource type `DATASOURCE::FC::CustomDomains`, which is used to query custom domain names in Function Compute.</summary>
    /// <remarks>
    /// <strong>Note</strong>: This class may have some new functions to facilitate development, so it is recommended to use this class instead of `RosCustomDomains`for a more convenient development experience.
    ...
    public class CustomDomains : AlibabaCloud.SDK.ROS.CDK.Core.Resource_, AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.ICustomDomains
    {
        ...
        public virtual object AttrCustomDomains
        {
        ...
        public virtual AlibabaCloud.SDK.ROS.CDK.Fc.Datasource.ICustomDomainsProps Props
        {
