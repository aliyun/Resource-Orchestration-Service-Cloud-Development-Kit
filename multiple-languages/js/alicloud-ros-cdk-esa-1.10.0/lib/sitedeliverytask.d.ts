 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-sitedeliverytask
 */
export declare class SiteDeliveryTask extends ros.Resource implements ISiteDeliveryTask {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SiteDeliveryTaskProps, enableResourcePropertyConstraint?: boolean);
}
