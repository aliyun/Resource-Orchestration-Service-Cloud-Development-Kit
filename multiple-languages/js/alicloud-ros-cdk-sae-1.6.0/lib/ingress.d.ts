 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sae-ingress
 */
export declare class Ingress extends ros.Resource implements IIngress {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: IngressProps, enableResourcePropertyConstraint?: boolean);
}
