 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ros-assert
 */
export declare class RosAssert extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::ROS::Assert";
    /**
     * @Attribute FailureCause: The reason the assertion failed
     */
    readonly attrFailureCause: ros.IResolvable;
    /**
     ...
     * - One value is supported only if the operation is Not.
     */
    values: Array<any | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property abortCreation: Whether to abort creation when the assert fails. Default is True.
     */
    abortCreation: boolean | ros.IResolvable | undefined;
    /**
     * @Property errorMessage: The error message to be returned when the assert fails.
     */
    errorMessage: string | ros.IResolvable | undefined;
    /**
     * @Property operation: The type of assertion to make. The supported operations are:
     * Equal, NotEqual, Greater, GreaterOrEqual, Less, LessOrEqual, Contain, NotContain, And, Or, Not.
     * Default is Equal.
     */
    operation: string | ros.IResolvable | undefined;
    /**
...
export declare class RosStack extends ros.RosResource {
     ...
     * @Property tags: The tags of nested stack. If it is specified, it will be passed to all tag-supported resources in the nested stack.
     */
    tags: RosStack.TagsProperty[] | undefined;
    /**
     * @Property templateBody: Structure containing the template body.
     * It is just to facilitate the passing of template. It is raw content.Functions in TemplateBody will not be resolved in parent stack.
     * You must specify either the TemplateBody or the TemplateURL property. If both are specified, TemplateBody will be used.
...
export declare namespace RosStack {
    /**
     * @stability external
     */
    interface TagsProperty {
