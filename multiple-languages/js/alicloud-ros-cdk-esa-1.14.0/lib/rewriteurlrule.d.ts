 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-rewriteurlrule
 */
export declare class RewriteUrlRule extends ros.Resource implements IRewriteUrlRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RewriteUrlRuleProps, enableResourcePropertyConstraint?: boolean);
}
