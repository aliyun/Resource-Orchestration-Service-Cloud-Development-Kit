 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-datalakeformation-permissions
 */
export declare class Permissions extends ros.Resource implements IPermissions {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PermissionsProps, enableResourcePropertyConstraint?: boolean);
}
