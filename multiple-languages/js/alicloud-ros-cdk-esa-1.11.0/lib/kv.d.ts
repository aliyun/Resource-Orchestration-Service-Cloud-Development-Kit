 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-kv
 */
export declare class Kv extends ros.Resource implements IKv {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: KvProps, enableResourcePropertyConstraint?: boolean);
}
