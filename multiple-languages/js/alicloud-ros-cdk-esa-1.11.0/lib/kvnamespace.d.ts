 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-kvnamespace
 */
export declare class KvNamespace extends ros.Resource implements IKvNamespace {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: KvNamespaceProps, enableResourcePropertyConstraint?: boolean);
}
