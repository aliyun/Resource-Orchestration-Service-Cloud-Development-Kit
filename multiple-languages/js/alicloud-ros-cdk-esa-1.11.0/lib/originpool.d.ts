 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-originpool
 */
export declare class OriginPool extends ros.Resource implements IOriginPool {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: OriginPoolProps, enableResourcePropertyConstraint?: boolean);
}
