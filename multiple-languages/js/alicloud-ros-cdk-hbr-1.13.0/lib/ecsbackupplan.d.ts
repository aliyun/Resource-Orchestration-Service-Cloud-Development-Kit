 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-ecsbackupplan
 */
export declare class EcsBackupPlan extends ros.Resource implements IEcsBackupPlan {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EcsBackupPlanProps, enableResourcePropertyConstraint?: boolean);
}
