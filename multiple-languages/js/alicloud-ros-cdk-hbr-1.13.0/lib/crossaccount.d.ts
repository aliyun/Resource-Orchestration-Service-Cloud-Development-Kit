 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-crossaccount
 */
export declare class CrossAccount extends ros.Resource implements ICrossAccount {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: CrossAccountProps, enableResourcePropertyConstraint?: boolean);
}
