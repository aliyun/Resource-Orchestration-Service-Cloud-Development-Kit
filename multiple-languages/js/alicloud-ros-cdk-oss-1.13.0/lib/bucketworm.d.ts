 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketworm
 */
export declare class BucketWorm extends ros.Resource implements IBucketWorm {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: BucketWormProps, enableResourcePropertyConstraint?: boolean);
}
