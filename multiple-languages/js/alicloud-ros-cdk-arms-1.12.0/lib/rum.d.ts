 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-arms-rum
 */
export declare class Rum extends ros.Resource implements IRum {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RumProps, enableResourcePropertyConstraint?: boolean);
}
