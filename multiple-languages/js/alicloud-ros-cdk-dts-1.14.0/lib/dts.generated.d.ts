 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-consumerchannel
 */
export declare class RosConsumerChannel extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::DTS::ConsumerChannel";
    /**
     ...
     */
    readonly attrConsumerGroupUserName: ros.IResolvable;
    /**
...
export declare class RosInstance extends ros.RosResource {
     ...
     * @Property insightModule: Whether to enable the insight module.
     */
    insightModule: boolean | ros.IResolvable | undefined;
    /**
     * @Property jobId: The ID of the task.
     * **Note**: If this parameter is specified, you do not need to specify the SourceRegion, DestinationRegion, SourceEndpointEngineName, or DestinationEndpointEngineName parameter. Even if these parameters are specified, the value of the JobId parameter takes precedence.
     */
...
export declare class RosJobMonitorRule extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::DTS::JobMonitorRule";
    /**
     ...
     */
    readonly attrPhones: ros.IResolvable;
    /**
     ...
     * @Property phones: The alarm is triggered after notification of the contact phone number.
     */
    phones: Array<any | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property state: Whether to enable monitoring rules, return value:
     * - **Y**: enable.
     * - **N**: Inactive.
     ...
     * @Property times: The number of cycles of the incremental verification task.
     */
    times: number | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
