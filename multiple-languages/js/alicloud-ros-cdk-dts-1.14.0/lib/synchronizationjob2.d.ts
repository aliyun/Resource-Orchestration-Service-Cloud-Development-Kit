...
import { RosSynchronizationJob2 } from './dts.generated';
export { RosSynchronizationJob2 as SynchronizationJob2Property };
/**
 ...
 */
export interface SynchronizationJob2Props {
    /**
 ...
 */
export interface ISynchronizationJob2 extends ros.IResource {
    readonly props: SynchronizationJob2Props;
    /**
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-synchronizationjob2
 */
export declare class SynchronizationJob2 extends ros.Resource implements ISynchronizationJob2 {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SynchronizationJob2Props, enableResourcePropertyConstraint?: boolean);
}
