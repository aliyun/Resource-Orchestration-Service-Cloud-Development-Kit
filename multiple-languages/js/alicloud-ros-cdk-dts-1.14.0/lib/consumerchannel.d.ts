 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dts-consumerchannel
 */
export declare class ConsumerChannel extends ros.Resource implements IConsumerChannel {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ConsumerChannelProps, enableResourcePropertyConstraint?: boolean);
}
