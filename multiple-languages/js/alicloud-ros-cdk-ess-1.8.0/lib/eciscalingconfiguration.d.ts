...
/**
 * This class encapsulates and extends the ROS resource type `ALIYUN::ESS::EciScalingConfiguration`, which is used to define a scaling configuration of the Elastic Container Instance type.
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ess-eciscalingconfiguration
 */
export declare class EciScalingConfiguration extends ros.Resource implements IEciScalingConfiguration {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EciScalingConfigurationProps, enableResourcePropertyConstraint?: boolean);
}
