 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpcgatewayendpoint
 */
export declare class VpcGatewayEndpoint extends ros.Resource implements IVpcGatewayEndpoint {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VpcGatewayEndpointProps, enableResourcePropertyConstraint?: boolean);
}
