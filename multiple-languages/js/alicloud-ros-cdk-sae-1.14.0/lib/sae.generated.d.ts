...
export declare class RosApplication extends ros.RosResource {
     ...
     * @Property enableNewArms: Whether to enable the new ARMS feature.
     */
    enableNewArms: boolean | ros.IResolvable | undefined;
    /**
     * @Property enableSidecarResourceIsolated: Whether to enable sidecar resource isolation.
     */
    enableSidecarResourceIsolated: boolean | ros.IResolvable | undefined;
    /**
     * @Property envs: Container environment variable parameters. For example: [{ "name": "envtmp", "value": "0"}]
     */
     ...
     * @Property initContainersConfig: Init container config.
     */
    initContainersConfig: Array<RosApplication.InitContainersConfigProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property jarStartArgs: Jar package startup application parameters. Apply the default startup command: $ JAVA_HOME \/ bin \/ java $ JarStartOptions -jar $ CATALINA_OPTS "$ package_path"
     * $ JarStartArgs
     */
     ...
     * @Property newSaeVersion: The new SAE version. Supported versions: lite, std, pro.
     */
    newSaeVersion: string | ros.IResolvable | undefined;
    /**
     * @Property ossAkId: AccessKey ID of the OSS.
     */
     ...
     * @Property sidecarContainersConfig: Sidecar container config.
     */
    sidecarContainersConfig: Array<RosApplication.SidecarContainersConfigProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property slsConfigs: Log collection configuration file
     */
...
export declare namespace RosApplication {
     ...
     * @stability external
     */
    interface InitContainersConfigProperty {
        /**
...
export declare namespace RosApplication {
     ...
     * @stability external
     */
    interface SidecarContainersConfigProperty {
        /**
         * @Property commandArgs: The command arguments to run in the init container.
         */
        readonly commandArgs?: string | ros.IResolvable;
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sae-nlbbinding
 */
export declare class RosNlbBinding extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::SAE::NlbBinding";
    /**
     * @Attribute NlbId: The ID of the Network Load Balancer (NLB).
     */
    readonly attrNlbId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property appId: The ID of the SAE application.
     */
     ...
     * @Property listeners: The listeners of the NLB.
     */
    listeners: Array<RosNlbBinding.ListenersProperty | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property nlbId: The ID of the Network Load Balancer (NLB).
     */
    nlbId: string | ros.IResolvable;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosNlbBinding {
    /**
     * @stability external
     */
...
export declare class RosSecret extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::SAE::Secret";
    /**
     ...
     */
    readonly attrSecretId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property namespaceId: The namespace ID where the Secret instance resides. If the namespace you are in is the default namespace, you just need to fill in the RegionId.
     */
     ...
     * kubernetes.io\/dockerconfigjson: A confidential dictionary that stores the username and password of the mirror repository, used to pull mirror authentication during deployment.
     */
    secretType: string | ros.IResolvable;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
