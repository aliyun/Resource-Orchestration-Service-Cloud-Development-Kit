 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-natipcidr
 */
export declare class NatIpCidr extends ros.Resource implements INatIpCidr {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: NatIpCidrProps, enableResourcePropertyConstraint?: boolean);
}
