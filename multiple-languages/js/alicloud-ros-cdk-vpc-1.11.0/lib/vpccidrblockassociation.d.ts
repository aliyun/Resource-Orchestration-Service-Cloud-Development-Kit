 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpccidrblockassociation
 */
export declare class VpcCidrBlockAssociation extends ros.Resource implements IVpcCidrBlockAssociation {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VpcCidrBlockAssociationProps, enableResourcePropertyConstraint?: boolean);
}
