 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-ecs-securitygroups
 */
export declare class SecurityGroups extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: SecurityGroupsProps, enableResourcePropertyConstraint?: boolean);
}
