 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecs-capacityreservation
 */
export declare class CapacityReservation extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CapacityReservationProps, enableResourcePropertyConstraint?: boolean);
}
