 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecd-networkpackage
 */
export declare class NetworkPackage extends ros.Resource implements INetworkPackage {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: NetworkPackageProps, enableResourcePropertyConstraint?: boolean);
}
