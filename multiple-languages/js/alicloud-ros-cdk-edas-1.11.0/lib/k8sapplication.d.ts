 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-k8sapplication
 */
export declare class K8sApplication extends ros.Resource implements IK8sApplication {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: K8sApplicationProps, enableResourcePropertyConstraint?: boolean);
}
