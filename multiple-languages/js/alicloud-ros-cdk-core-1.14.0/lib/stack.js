...
class Stack extends construct_compat_1.Construct {
    ...
    addDependency(target, reason) {
        (0, deps_1.addDependency)(this, target, reason);
    }
    /**
...
function makeStackName(components) {
    ...
    return (0, uniqueid_1.makeUniqueId)(components);
}
