...
export declare class RosRoute extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::DataWorks::Route";
    /**
     ...
     */
    readonly attrDestinationCidr: ros.IResolvable;
    /**
     * @Attribute DwResourceGroupId: ID of the resource group to which the route belongs.
     */
    readonly attrDwResourceGroupId: ros.IResolvable;
    /**
     ...
     * @Property destinationCidr: The CIDR blocks of the destination-based route.
     */
    destinationCidr: string | ros.IResolvable;
    /**
     * @Property networkId: The ID of the network resource to which the route belongs.
     */
    networkId: number | ros.IResolvable;
    /**
     * @Property dwResourceGroupId: ID of the resource group to which the route belongs.
     */
    dwResourceGroupId: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
