...
export declare class RosDedicatedBlockStorageCluster extends ros.RosResource {
     ...
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::EBS::DedicatedBlockStorageCluster";
    /**
     ...
     * @Property dbscName: The name of the dedicated block storage cluster.
     */
    dbscName: string | ros.IResolvable;
    /**
     * @Property period: The subscription duration of the dedicated block storage cluster. Valid values: 6, 7, 8, 9, 10, 11, 12, 24, and 36.
     */
...
export declare namespace RosDedicatedBlockStorageCluster {
    /**
     * @stability external
     */
