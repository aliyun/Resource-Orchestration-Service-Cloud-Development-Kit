 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-gateway2
 */
export declare class Gateway2 extends ros.Resource implements IGateway2 {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: Gateway2Props, enableResourcePropertyConstraint?: boolean);
}
