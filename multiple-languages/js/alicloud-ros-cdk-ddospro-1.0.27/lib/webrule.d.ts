 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ddospro-webrule
 */
export declare class WebRule extends ros.Resource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WebRuleProps, enableResourcePropertyConstraint?: boolean);
}
