 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-routetableattachment
 */
export declare class RouteTableAttachment extends ros.Resource implements IRouteTableAttachment {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RouteTableAttachmentProps, enableResourcePropertyConstraint?: boolean);
}
