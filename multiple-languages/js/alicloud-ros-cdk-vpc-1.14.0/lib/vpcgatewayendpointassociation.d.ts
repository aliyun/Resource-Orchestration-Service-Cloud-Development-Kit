 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpcgatewayendpointassociation
 */
export declare class VpcGatewayEndpointAssociation extends ros.Resource implements IVpcGatewayEndpointAssociation {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VpcGatewayEndpointAssociationProps, enableResourcePropertyConstraint?: boolean);
}
