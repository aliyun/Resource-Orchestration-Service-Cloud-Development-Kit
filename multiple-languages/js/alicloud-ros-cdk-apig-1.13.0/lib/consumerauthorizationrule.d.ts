 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apig-consumerauthorizationrule
 */
export declare class ConsumerAuthorizationRule extends ros.Resource implements IConsumerAuthorizationRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ConsumerAuthorizationRuleProps, enableResourcePropertyConstraint?: boolean);
}
