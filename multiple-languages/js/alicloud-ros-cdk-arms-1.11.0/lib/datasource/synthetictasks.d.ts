 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-arms-synthetictasks
 */
export declare class SyntheticTasks extends ros.Resource implements ISyntheticTasks {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: SyntheticTasksProps, enableResourcePropertyConstraint?: boolean);
}
