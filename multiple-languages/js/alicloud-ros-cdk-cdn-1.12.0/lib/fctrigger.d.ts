 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cdn-fctrigger
 */
export declare class FcTrigger extends ros.Resource implements IFcTrigger {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: FcTriggerProps, enableResourcePropertyConstraint?: boolean);
}
