 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-fullnatentry
 */
export declare class FullNatEntry extends ros.Resource implements IFullNatEntry {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: FullNatEntryProps, enableResourcePropertyConstraint?: boolean);
}
