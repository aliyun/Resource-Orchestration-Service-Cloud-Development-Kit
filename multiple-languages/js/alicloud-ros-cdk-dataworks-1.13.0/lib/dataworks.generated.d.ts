 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dataworks-datasourcesharedrule
 */
export declare class RosDataSourceSharedRule extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::DataWorks::DataSourceSharedRule";
    /**
     ...
     */
    readonly attrCreateUser: ros.IResolvable;
    /**
     ...
     */
    readonly attrDataSourceSharedRuleId: ros.IResolvable;
    /**
     ...
     * @Property targetProjectId: The ID of the project to which the data source is shared.
     */
    targetProjectId: number | ros.IResolvable;
    /**
     * @Property sharedUser: The target user of the data source permission policy, which is null to share to the project.
     */
    sharedUser: string | ros.IResolvable | undefined;
    /**
