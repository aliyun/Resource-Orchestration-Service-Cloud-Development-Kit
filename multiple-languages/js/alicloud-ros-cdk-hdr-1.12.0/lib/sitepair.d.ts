 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hdr-sitepair
 */
export declare class SitePair extends ros.Resource implements ISitePair {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SitePairProps, enableResourcePropertyConstraint?: boolean);
}
