 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-rds-dbproxy
 */
export declare class DBProxy extends ros.Resource implements IDBProxy {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DBProxyProps, enableResourcePropertyConstraint?: boolean);
}
