...
export declare class RosInstanceV2 extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::Flink::InstanceV2";
    /**
     * @Attribute InstanceId: Instance ID.
     */
    readonly attrInstanceId: ros.IResolvable;
     ...
     * When ChargeType is configured as PRE, the resource specification parameters must be filled.
     */
    storage: RosInstanceV2.StorageProperty | ros.IResolvable;
    /**
     * @Property vpcId: VPC ID.
     */
    vpcId: string | ros.IResolvable;
     ...
     * When ChargeType is configured as PRE, the resource specification parameters must be filled.
     */
    resourceSpec: RosInstanceV2.ResourceSpecProperty | ros.IResolvable | undefined;
    /**
     * @Property usePromotionCode: Whether to use coupons.The value is as follows:
     * true: Use.
     * false: Not in use.
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-flink-namespacev2
 */
export declare class RosNamespaceV2 extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::Flink::NamespaceV2";
    /**
     * @Attribute InstanceId: Instance ID.
     */
    readonly attrInstanceId: ros.IResolvable;
     ...
     * @Property resourceSpec: Resource specifications.
     */
    resourceSpec: RosNamespaceV2.ResourceSpecProperty | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosNamespaceV2 {
    /**
     * @stability external
     */
    interface ResourceSpecProperty {
