 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-alb-ascript
 */
export declare class AScript extends ros.Resource implements IAScript {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AScriptProps, enableResourcePropertyConstraint?: boolean);
}
