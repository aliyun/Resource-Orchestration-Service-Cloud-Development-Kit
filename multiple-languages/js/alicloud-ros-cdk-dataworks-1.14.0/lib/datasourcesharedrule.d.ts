 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dataworks-datasourcesharedrule
 */
export declare class DataSourceSharedRule extends ros.Resource implements IDataSourceSharedRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DataSourceSharedRuleProps, enableResourcePropertyConstraint?: boolean);
}
