...
export declare class RosApplicationConnectionBind extends ros.RosResource {
     ...
     * @Property parameters: The parameters of the application connection bind.
     */
    parameters: Array<RosApplicationConnectionBind.ParametersProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosApplicationConnectionBind {
    /**
     * @stability external
     */
