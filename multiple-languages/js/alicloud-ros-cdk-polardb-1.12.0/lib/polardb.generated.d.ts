...
export declare class RosAccount extends ros.RosResource {
     ...
     * - 1: Authorization.
     */
    privForAllDb: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare class RosApplication extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::POLARDB::Application";
    /**
     ...
     * @Property applicationType: The type of the application. This parameter is required.
     */
    applicationType: string | ros.IResolvable;
    /**
     * @Property architecture: The architecture of the application. This parameter is required.
     */
    architecture: string | ros.IResolvable;
    /**
     * @Property dbClusterId: The ID of the database cluster.
     */
    dbClusterId: string | ros.IResolvable;
     ...
     * @Property autoCreatePolarFs: Whether to auto create PolarFS.
     */
    autoCreatePolarFs: boolean | ros.IResolvable | undefined;
    /**
     * @Property components: The list of components.
     */
    components: Array<RosApplication.ComponentsProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property description: The description of the application.
     */
     ...
     * @Property polarFsInstanceId: The ID of the PolarFS instance.
     */
    polarFsInstanceId: string | ros.IResolvable | undefined;
    /**
     * @Property securityGroupId: The ID of the security group.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-polardb-applicationendpointaddress
 */
export declare class RosApplicationEndpointAddress extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::POLARDB::ApplicationEndpointAddress";
    /**
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-polardb-backup
 */
export declare class RosBackup extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::POLARDB::Backup";
    /**
     * @Attribute BackupJobId: The ID of the backup set.
     */
    readonly attrBackupJobId: ros.IResolvable;
    /**
...
export declare class RosDBNodes extends ros.RosResource {
     ...
     * @Property endpointBindList: Address IDs that specifies the cluster connection address to which the new node should join.
     */
    endpointBindList: Array<string | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property imciSwitch: Specifies whether to enable the In-Memory Column Index (IMCI) feature.
     */
     ...
     * @Property plannedEndTime: The latest time at which a new node task can be added to start executing a timed (that is, within the target time period). The format is YYYY-MM-DDThh:mm:ssZ (UTC).
     */
    plannedEndTime: string | ros.IResolvable | undefined;
    /**
     * @Property plannedStartTime: The earliest time at which a new node task can be added to start executing a timed (that is, within the target time period). The format is YYYY-MM-DDThh:mm:ssZ (UTC).
     */
    plannedStartTime: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: Resource group id.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
...
export declare class RosDatabase extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::POLARDB::Database";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property characterSetName: The character set of the database. For more information, see Character sets.
     */
...
export declare class RosGlobalSecurityIPGroup extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::POLARDB::GlobalSecurityIPGroup";
    /**
     ...
     * You can create up to 1,000 IP addresses or CIDR blocks for all IP whitelists.
     */
    gIpList: Array<string | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property globalIgName: The name of the IP whitelist template. The name must meet the following requirements:
     * The name can contain lowercase letters, digits, and underscores (_).
     * The name must start with a letter and end with a letter or digit.
