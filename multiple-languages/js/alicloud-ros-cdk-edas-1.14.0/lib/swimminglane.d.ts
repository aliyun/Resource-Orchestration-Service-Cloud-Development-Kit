 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-edas-swimminglane
 */
export declare class SwimmingLane extends ros.Resource implements ISwimmingLane {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SwimmingLaneProps, enableResourcePropertyConstraint?: boolean);
}
