 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-alb-accesslogenable
 */
export declare class AccessLogEnable extends ros.Resource implements IAccessLogEnable {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AccessLogEnableProps, enableResourcePropertyConstraint?: boolean);
}
