 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oss-bucketoverwriteconfig
 */
export declare class BucketOverwriteConfig extends ros.Resource implements IBucketOverwriteConfig {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: BucketOverwriteConfigProps, enableResourcePropertyConstraint?: boolean);
}
