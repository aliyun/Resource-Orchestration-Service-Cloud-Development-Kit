 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-analyzeproductlog
 */
export declare class RosAnalyzeProductLog extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::SLS::AnalyzeProductLog";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property cloudProduct: The cloud product name.
     */
    cloudProduct: string | ros.IResolvable;
    /**
     * @Property logstore: The logstore name.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-etlv2
 */
export declare class RosEtlV2 extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::SLS::EtlV2";
    /**
     * @Attribute Name: ETL name.
     */
    readonly attrName: ros.IResolvable;
     ...
     * @Property configuration: The configuration of the etl job.
     */
    configuration: RosEtlV2.ConfigurationProperty | ros.IResolvable;
    /**
     * @Property displayName: The display name of the etl job.
     */
    displayName: string | ros.IResolvable;
...
export declare namespace RosEtlV2 {
    /**
     * @stability external
     */
    interface ConfigurationProperty {
