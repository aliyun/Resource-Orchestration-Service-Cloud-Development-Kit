 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ess-loadbalancerattachment
 */
export declare class LoadBalancerAttachment extends ros.Resource implements ILoadBalancerAttachment {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: LoadBalancerAttachmentProps, enableResourcePropertyConstraint?: boolean);
}
