 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-page
 */
export declare class Page extends ros.Resource implements IPage {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PageProps, enableResourcePropertyConstraint?: boolean);
}
