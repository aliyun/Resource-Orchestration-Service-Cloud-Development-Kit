 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-waitingroomrule
 */
export declare class WaitingRoomRule extends ros.Resource implements IWaitingRoomRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: WaitingRoomRuleProps, enableResourcePropertyConstraint?: boolean);
}
