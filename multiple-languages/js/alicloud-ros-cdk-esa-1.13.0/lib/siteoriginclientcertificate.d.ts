 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-esa-siteoriginclientcertificate
 */
export declare class SiteOriginClientCertificate extends ros.Resource implements ISiteOriginClientCertificate {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SiteOriginClientCertificateProps, enableResourcePropertyConstraint?: boolean);
}
