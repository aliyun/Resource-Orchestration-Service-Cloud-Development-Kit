 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mongodb-privatesrvnetworkaddress
 */
export declare class PrivateSrvNetworkAddress extends ros.Resource implements IPrivateSrvNetworkAddress {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PrivateSrvNetworkAddressProps, enableResourcePropertyConstraint?: boolean);
}
