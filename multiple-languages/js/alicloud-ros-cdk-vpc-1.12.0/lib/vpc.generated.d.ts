...
export declare class RosAnycastEIPAssociation extends ros.RosResource {
     ...
     * @Property associationMode: The association mode.
     */
    associationMode: string | ros.IResolvable | undefined;
    /**
     * @Property popLocations: The pop locations.
     */
    popLocations: Array<RosAnycastEIPAssociation.PopLocationsProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property privateIpAddress: The private IP address.
     */
...
export declare namespace RosAnycastEIPAssociation {
    /**
     * @stability external
     */
    interface PopLocationsProperty {
        /**
...
export declare class RosBgpPeer extends ros.RosResource {
     ...
     * When using BFD in a multi-cloud environment or direct fiber connection without intermediate bridging devices, change the default BFD hop count from **255** to **1**.
     */
    bfdMultiHop: number | ros.IResolvable | undefined;
    /**
     * @Property enableBfd: Specifies whether to enable the Bidirectional Forwarding Detection (BFD) feature.
     * Valid values:
     * true: enables BFD.
...
export declare class RosDhcpOptionsSet extends ros.RosResource {
     ...
     * When specifying parameter values, you must include the unit.
     */
    ipv6LeaseTime: string | ros.IResolvable | undefined;
    /**
     * @Property leaseTime: The lease time of the IPv4 DHCP options set.
     *
     * - When setting lease time in hours: unit: h. Valid values: **24h~1176h**, **87600h~175200h**. Default value: **87600h**.
     ...
     * When specifying parameter values, you must include the unit.
     */
    leaseTime: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The ID of the resource group to which the DHCP options set belongs.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
...
export declare class RosFullNatEntry extends ros.RosResource {
     ...
     * @Property accessDomain: The domain name of the backend for FULLNAT address translation.
     */
    accessDomain: string | ros.IResolvable | undefined;
    /**
     * @Property fullNatEntryDescription: The description of the FULLNAT entry.
     * This parameter is optional. If you enter a description, the description must be 2 to 256 characters in length, and cannot start with http:\/\/ or https:\/\/.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipam
 */
export declare class RosIpam extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::Ipam";
    /**
     ...
     */
    readonly attrDefaultResourceDiscoveryAssociationId: ros.IResolvable;
    /**
     * @Attribute DefaultResourceDiscoveryId: After IPAM is created, the system creates resource discovery by default.
     */
    readonly attrDefaultResourceDiscoveryId: ros.IResolvable;
    /**
     * @Attribute IpamDescription: The description of IPAM.
     */
    readonly attrIpamDescription: ros.IResolvable;
    /**
     ...
     */
    readonly attrIpamName: ros.IResolvable;
    /**
     * @Attribute OperatingRegionList: List of IPAM effective regions.
     */
    readonly attrOperatingRegionList: ros.IResolvable;
    /**
     ...
     * @Property operatingRegionList: List of IPAM effective regions.
     */
    operatingRegionList: Array<string | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property ipamDescription: The description of IPAM.
     * It must be 2 to 256 characters in length and must start with an uppercase letter or a Chinese character, but cannot start with 'http:\/\/ 'or 'https. If the description is not filled in, it is blank. The default value is blank.
     */
    ipamDescription: string | ros.IResolvable | undefined;
    /**
     * @Property ipamName: The name of the IPAM.
     */
    ipamName: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The ID of the resource group.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
     ...
     * @Property tags: Tags of ipam.
     */
    tags: RosIpam.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosIpam {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipampool
 */
export declare class RosIpamPool extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::IpamPool";
    /**
     * @Attribute IpamPoolId: The ID of the IPAM pool.
     */
    readonly attrIpamPoolId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property ipamScopeId: The ID of the IPAM scope. This parameter is required.
     */
    ipamScopeId: string | ros.IResolvable;
    /**
     * @Property allocationDefaultCidrMask: The default CIDR mask for allocation.
     */
    allocationDefaultCidrMask: number | ros.IResolvable | undefined;
    /**
     * @Property allocationMaxCidrMask: The maximum CIDR mask for allocation.
     */
    allocationMaxCidrMask: number | ros.IResolvable | undefined;
    /**
     * @Property allocationMinCidrMask: The minimum CIDR mask for allocation.
     */
    allocationMinCidrMask: number | ros.IResolvable | undefined;
    /**
     * @Property autoImport: Whether to automatically import the IPAM pool.
     */
    autoImport: boolean | ros.IResolvable | undefined;
    /**
     * @Property ipamPoolDescription: The description of the IPAM pool.
     */
    ipamPoolDescription: string | ros.IResolvable | undefined;
    /**
     * @Property ipamPoolName: The name of the IPAM pool.
     */
    ipamPoolName: string | ros.IResolvable | undefined;
    /**
     * @Property ipv6Isp: The IPv6 ISP for the IPAM pool.
     */
     ...
     * @Property poolRegionId: The ID of the region where the IPAM pool is located.
     */
    poolRegionId: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The ID of the resource group to which the IPAM pool belongs.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
     ...
     * @Property sourceIpamPoolId: The ID of the source IPAM pool.
     */
    sourceIpamPoolId: string | ros.IResolvable | undefined;
    /**
     * @Property tags: The tags of the IPAM pool. The maximum length is 21.
     */
    tags: RosIpamPool.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosIpamPool {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipamresourcediscovery
 */
export declare class RosIpamResourceDiscovery extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::IpamResourceDiscovery";
    /**
     ...
     */
    readonly attrIpamResourceDiscoveryDescription: ros.IResolvable;
    /**
     * @Attribute IpamResourceDiscoveryId: The ID of the resource discovery instance.
     */
    readonly attrIpamResourceDiscoveryId: ros.IResolvable;
    /**
     * @Attribute IpamResourceDiscoveryName: The name of the resource discovery.
     */
    readonly attrIpamResourceDiscoveryName: ros.IResolvable;
    /**
     ...
     * @Property ipamResourceDiscoveryDescription: The description of the resource discovery.
     */
    ipamResourceDiscoveryDescription: string | ros.IResolvable | undefined;
    /**
     * @Property ipamResourceDiscoveryName: The name of the resource discovery.
     */
    ipamResourceDiscoveryName: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The ID of the resource group.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
     ...
     * @Property tags: Tags of ipam resource discovery.
     */
    tags: RosIpamResourceDiscovery.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosIpamResourceDiscovery {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipamscope
 */
export declare class RosIpamScope extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::IpamScope";
    /**
     ...
     * @Property ipamId: The id of the Ipam instance.
     */
    ipamId: string | ros.IResolvable;
    /**
     * @Property ipamScopeDescription: The description of the IPAM's scope of action.
     * It must be 2 to 256 characters in length and must start with a lowercase letter, but cannot start with 'http:\/\/ 'or 'https. If it is not filled in, it is empty. The default value is empty.
     */
    ipamScopeDescription: string | ros.IResolvable | undefined;
    /**
     * @Property ipamScopeName: The name of the IPAM scope.
     */
    ipamScopeName: string | ros.IResolvable | undefined;
    /**
     * @Property ipamScopeType: IPAM scope of action type:
     * **private**.
     *
     * > Currently, only the role scope of the private network is supported.
     */
    ipamScopeType: string | ros.IResolvable | undefined;
    /**
     * @Property tags: Tags of ipam scope.
     */
    tags: RosIpamScope.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosIpamScope {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-ipv6egressrule
 */
export declare class RosIpv6EgressRule extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::Ipv6EgressRule";
    /**
     ...
     */
    readonly attrIpv6EgressRuleId: ros.IResolvable;
    /**
     * @Attribute Ipv6EgressRuleName: The name of the egress-only rule.
     */
    readonly attrIpv6EgressRuleName: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property instanceId: The ID of the IPv6 address for which you want to create an egress-only rule.
     */
     ...
     * The name must be 0 to 128 characters in length and cannot start with `http:\/\/` or `https:\/\/`.
     */
    ipv6EgressRuleName: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare class RosNatGateway extends ros.RosResource {
     ...
     * @Property accessMode: Reverse access mode to the VPC NAT gateway.
     */
    accessMode: RosNatGateway.AccessModeProperty | ros.IResolvable | undefined;
    /**
     * @Property availabilityMode: The availability mode of the NAT gateway. Valid values: CrossAZ, SingleAZ
     */
    availabilityMode: string | ros.IResolvable | undefined;
    /**
     * @Property deletionForce: Whether force delete the relative snat and dnat entries in the net gateway and unbind eips. Default value is false.
     */
     ...
     * @Property ipv4Prefix: The IPv4 prefix.
     */
    ipv4Prefix: string | ros.IResolvable | undefined;
    /**
     * @Property natGatewayName: Display name of the NAT gateway, [2, 128] English or Chinese characters, must start with a letter or Chinese in size, can contain numbers, '_' or '.', '-'
     */
     ...
     * @Property privateLinkEnabled: Whether to support private network connection.
     */
    privateLinkEnabled: boolean | ros.IResolvable | undefined;
    /**
     * @Property securityProtectionEnabled: Specifies whether to enable the firewall feature. Default: False
     */
...
export declare class RosPublicIpAddressPool extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::PublicIpAddressPool";
    /**
     ...
     * @Property tags: The list of container group tags in the form of key\/value pairs. You can define a maximum of 20 tags for each container group.
     */
    tags: RosPublicIpAddressPool.TagsProperty[] | undefined;
    /**
     * @Property zones: The available areas of the IP address pool.
     * The Biztype value is Cloudbox, that is, when the type of IP address pool is a cloud box, the parameter must be filled.
     */
    zones: Array<string | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosPublicIpAddressPool {
    /**
     * @stability external
     */
    interface TagsProperty {
...
export declare class RosRouteTable extends ros.RosResource {
     ...
     * @Property associateType: The type of the route table.
     */
    associateType: string | ros.IResolvable | undefined;
    /**
     * @Property description: The description of the route table.
     * The description must be 2 to 256 characters in length. The description must start with a letter, but cannot start with http:\/\/ or https:\/\/.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-routetableattachment
 */
export declare class RosRouteTableAttachment extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::RouteTableAttachment";
    /**
     * @Attribute RouteTableId: The ID of the route table.
     */
    readonly attrRouteTableId: ros.IResolvable;
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-routetablewithgatewayassociation
 */
export declare class RosRouteTableWithGatewayAssociation extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::RouteTableWithGatewayAssociation";
    /**
     ...
     * @Property gatewayType: Types of the associated gateway instance.
     */
    gatewayType: string | ros.IResolvable;
    /**
     * @Property routeTableId: The ID of route table that gateway is to be bound.
     */
    routeTableId: string | ros.IResolvable;
...
export declare class RosRouterInterface extends ros.RosResource {
     ...
     * - When the value of the **FastLinkMode** parameter is **true**, the value of the **Role** parameter must be **InitiatingSide**, and the **AccessPointId**, **OppositeRouterType**, **OppsiteRouterId**, and **OppositeInterfaceOwnerId** parameters are required.
     */
    fastLinkMode: boolean | ros.IResolvable | undefined;
    /**
     * @Property healthCheckSourceIp: Source IP address of the packet for leased line HealthCheck in leased line disaster tolerance and ECMP scenarios. It is valid only for a VRouter RouterInterface with a peer on a VBR. The source IP address must be in the VPC of the local VRouter and is not used. HealthCheckSourceIp and HealthCheckTargetIp parameters must be both specified or left unspecified.
     */
...
export declare class RosSnatEntry extends ros.RosResource {
     ...
     * The IPv4 addresses of the elastic network interface will be used as the SNAT IP addresses.
     */
    networkInterfaceId: string | ros.IResolvable | undefined;
    /**
     * @Property snatEntryName: he name of the SNAT rule is 2-128 characters long and must start with a letter or Chinese, but cannot begin with HTTP:\/\/ or https:\/\/.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqos
 */
export declare class RosTrafficQos extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::TrafficQos";
    /**
     * @Attribute Progressing: The configuration progress of the QoS policy. The value range is **0** to **100 * *.
     */
    readonly attrProgressing: ros.IResolvable;
    /**
     * @Attribute QosDescription: The description of the QoS policy.
     */
    readonly attrQosDescription: ros.IResolvable;
    /**
     ...
     */
    readonly attrQosName: ros.IResolvable;
    /**
     * @Attribute ResourceGroupId: The ID of the resource group.
     */
    readonly attrResourceGroupId: ros.IResolvable;
     ...
     * The name must be 0 to 128 characters in length and cannot start with http:\/\/ or https:\/\/.
     */
    qosName: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The ID of the resource group.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
     ...
     * @Property tags: Tags of traffic qos.
     */
    tags: RosTrafficQos.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosTrafficQos {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqosqueue
 */
export declare class RosTrafficQosQueue extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::TrafficQosQueue";
    /**
     * @Attribute BandwidthPercent: QoS queue bandwidth percentage.
     */
    readonly attrBandwidthPercent: ros.IResolvable;
    /**
     ...
     */
    readonly attrQueueDescription: ros.IResolvable;
    /**
     * @Attribute QueueId: The ID of the QoS queue.
     */
    readonly attrQueueId: ros.IResolvable;
    /**
     ...
     */
    readonly attrQueueType: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property qosId: The ID of the QoS policy.
     */
     ...
     * > Default priority queue cannot be created.
     */
    queueType: string | ros.IResolvable;
    /**
     * @Property bandwidthPercent: QoS queue bandwidth percentage.
     * * When the QoS queue type is **Medium**, this field must be entered. Valid values: 1 to 100.
     * * When the QoS queue type is **Default**, this field is "-".
     */
    bandwidthPercent: string | ros.IResolvable | undefined;
    /**
     * @Property queueDescription: The description of the QoS queue.
     * The length is 0 to 256 characters and cannot start with 'http:\/\/ 'or 'https.
     */
    queueDescription: string | ros.IResolvable | undefined;
    /**
     * @Property queueName: The name of the QoS queue.
     * The length is 0 to 128 characters and cannot start with 'http:\/\/ 'or 'https.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqosrule
 */
export declare class RosTrafficQosRule extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::TrafficQosRule";
    /**
     * @Attribute DstCidr: The destination IPv4 CIDR block that matches the QoS rule traffic.
     */
    readonly attrDstCidr: ros.IResolvable;
    /**
     * @Attribute DstIpv6Cidr: The QoS rule traffic matches the Destination IPv6 network segment.
     */
    readonly attrDstIpv6Cidr: ros.IResolvable;
    /**
     ...
     */
    readonly attrRemarkingDscp: ros.IResolvable;
    /**
     * @Attribute RuleDescription: The description of the QoS rule.
     */
    readonly attrRuleDescription: ros.IResolvable;
    /**
     ...
     */
    readonly attrSrcPortRange: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property priority: The priority of the QoS rule. Valid values: 1 to 9000. A larger value indicates a higher priority. The priority of each QoS rule must be unique in the same QoS policy.
     */
     ...
     * @Property queueId: The QoS queue ID.
     */
    queueId: string | ros.IResolvable;
    /**
     * @Property dstCidr: The destination IPv4 CIDR block that matches the QoS rule traffic.
     * > If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
     */
    dstCidr: string | ros.IResolvable | undefined;
    /**
     * @Property dstIpv6Cidr: The QoS rule traffic matches the Destination IPv6 network segment.
     * > If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
     */
    dstIpv6Cidr: string | ros.IResolvable | undefined;
    /**
     * @Property dstPortRange: QoS rule traffic matches the destination port number range. Value range: **0** to **65535**. If not, the value is -1. Currently, only a single port number is supported, and the start and end of the port number must be the same. The corresponding destination port number range is fixed for different protocol types. The values are as follows:
     * - **ALL**:-1\/-1, not editable.
     * - **ICMP(IPv4)**:-1\/-1, non-editable.
     ...
     * - **Redis**:6379\/6379, non-editable.
     */
    dstPortRange: string | ros.IResolvable | undefined;
    /**
     * @Property matchDscp: The DSCP value that matches the QoS rule traffic. Valid values: 0 to 63. If no value is matched, the value is -1.
     */
    matchDscp: number | ros.IResolvable | undefined;
    /**
     * @Property remarkingDscp: The new DSCP value. Valid values: 0 to 63. If you do not change the value, set the value to -1.
     */
    remarkingDscp: number | ros.IResolvable | undefined;
    /**
     * @Property ruleDescription: The description of the QoS rule.
     * The length is 0 to 256 characters and cannot start with 'http:\/\/ 'or 'https.
     */
    ruleDescription: string | ros.IResolvable | undefined;
    /**
     * @Property ruleName: The name of the QoS rule.
     * The length is 0 to 128 characters and cannot start with 'http:\/\/ 'or 'https.
     */
     ...
     * > If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
     */
    srcCidr: string | ros.IResolvable | undefined;
    /**
     * @Property srcIpv6Cidr: The QoS rule traffic matches the source IPv6 network segment.
     * > If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
     */
    srcIpv6Cidr: string | ros.IResolvable | undefined;
    /**
     * @Property srcPortRange: The source port number of the QoS rule traffic matching. The value range is **0** to **65535**. If the traffic does not match, the value is -1. Currently, only a single port number is supported, and the start and end of the port number must be the same.
     */
    srcPortRange: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vcorouteentry
 */
export declare class RosVcoRouteEntry extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::VcoRouteEntry";
    /**
     ...
     * @Property vpnConnectionId: IPsec Connection ID.
     */
    vpnConnectionId: string | ros.IResolvable;
    /**
     * @Property weight: The weight value of the destination routing entry.Value:
     * 0: Indicates low priority.
     * 100: Indicates high priority.
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpccidrblockassociation
 */
export declare class RosVpcCidrBlockAssociation extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::VpcCidrBlockAssociation";
    /**
     ...
     * @Property ipamPoolId: The ID of the IP Address Manager (IPAM) pool that contains IPv4 addresses.
     */
    ipamPoolId: string | ros.IResolvable | undefined;
    /**
     * @Property iPv6CidrBlock: The IPv6 CIDR block to be added.
     * Note You must and can specify only one of SecondaryCidrBlock and Ipv6CidrBlock.
     */
     ...
     * Note When adding an additional IPv6 network segment to the VPC from the specified IPAM address pool, at least one of Ipv6CidrBlock or Ipv6CidrMask must be specified.
     */
    ipv6CidrMask: number | ros.IResolvable | undefined;
    /**
     * @Property ipv6Isp: The type of the IPv6 CIDR block. Valid values:
     * BGP (default)
     * ChinaMobile
     ...
     * Explain that the designated iPam address pool adds additional network segments to VPC, and the parameter SecondaryCidrblock or SecondaryCidrmask inputs at least one.
     */
    secondaryCidrMask: number | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpcgatewayendpoint
 */
export declare class RosVpcGatewayEndpoint extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::VpcGatewayEndpoint";
    /**
     ...
     * Whether the terminal node service supports setting access policies can be obtained through the ListVpcEndpointServicesByEndUser interface. SupportPolicy is true to indicate support, otherwise it is not supported.
     */
    policyDocument: string | ros.IResolvable | undefined;
    /**
     * @Property resourceGroupId: The resource group ID to which the gateway endpoint belongs.
     */
    resourceGroupId: string | ros.IResolvable | undefined;
     ...
     * @Property tags: The list of tags in the form of key\/value pairs. You can define a maximum of 20 tags.
     */
    tags: RosVpcGatewayEndpoint.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosVpcGatewayEndpoint {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpcgatewayendpointassociation
 */
export declare class RosVpcGatewayEndpointAssociation extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::VpcGatewayEndpointAssociation";
    /**
     ...
     * @Property routeTableIds: The routing table ID to associate.The value range of N is 1~20, that is, a maximum of 20 routing tables can be bound at a time.
     */
    routeTableIds: Array<string | ros.IResolvable> | ros.IResolvable;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-vpcipv6cidrallocation
 */
export declare class RosVpcIpv6CidrAllocation extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::VPC::VpcIpv6CidrAllocation";
    /**
     ...
     * Note This parameter is required.
     */
    addressPoolType: string | ros.IResolvable | undefined;
    /**
     * @Property ipv6CidrBlock: The IPv6 CIDR block that you want to reserve.
     */
    ipv6CidrBlock: string | ros.IResolvable | undefined;
...
export declare class RosVpcPeerConnection extends ros.RosResource {
     ...
     * If you specify this parameter, make sure that you are creating an inter-region VPC peering connection.
     */
    linkType: string | ros.IResolvable | undefined;
    /**
     * @Property name: The name of the VPC peering connection.
     * The name must be 2 to 128 characters in length and can contain digits, underscores
     * (_), and hyphens (-). It must start with a letter.
...
export declare class RosVpnAttachment extends ros.RosResource {
     ...
     * Large: Large type, default bandwidth 3Gbps
     */
    tunnelBandwidth: string | ros.IResolvable | undefined;
    /**
     * @Property tunnelOptionsSpecification: Configuration of tunnels.
     * - When creating dual-tunnel mode IPsec-VPN connections, you can configure parameters under **TunnelOptionsSpecification** array.
     * - When creating dual-tunnel mode IPsec-VPN connections, you must add two tunnels for the IPsec-VPN connection simultaneously to ensure the IPsec-VPN connection has link redundancy capability. Only two tunnels are supported under an IPsec-VPN connection.
     */
    tunnelOptionsSpecification: Array<RosVpnAttachment.TunnelOptionsSpecificationProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
