 ...
 */
export declare class Desktops extends ros.Resource {
    /**
...
Note This parameter is returned only when the ChargeType parameter is set to PrePaid.
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DesktopsProps, enableResourcePropertyConstraint?: boolean);
}
