 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-config-reporttemplate
 */
export declare class ReportTemplate extends ros.Resource implements IReportTemplate {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ReportTemplateProps, enableResourcePropertyConstraint?: boolean);
}
