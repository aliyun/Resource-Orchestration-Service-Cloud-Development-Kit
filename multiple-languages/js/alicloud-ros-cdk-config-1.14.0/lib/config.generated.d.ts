...
export declare class RosAggregateCompliancePack extends ros.RosResource {
     ...
     * Note: Either this parameter or TemplateContent must be set.
     */
    configRules: Array<RosAggregateCompliancePack.ConfigRulesProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property defaultEnable: Whether the rule supports quick activation. Value:
     * true: This rule will be enabled when the compliance package is quickly enabled.
     * false (default): disable
     ...
     * @Property excludeRegionIdsScope: The compliance package is invalid for the specified region ID.
     */
    excludeRegionIdsScope: string | ros.IResolvable | undefined;
    /**
     * @Property excludeResourceGroupIdsScope: The compliance package is invalid for the specified resource group ID.
     */
    excludeResourceGroupIdsScope: string | ros.IResolvable | undefined;
    /**
     * @Property excludeResourceIdsScope: The compliance package is invalid for the specified resource ID, that is, no evaluation is performed on the resource.
     */
     ...
     * @Property resourceIdsScope: The compliance package only takes effect on the specified resource ID.
     */
    resourceIdsScope: string | ros.IResolvable | undefined;
    /**
     * @Property tagKeyScope: Compliance packages only take effect on resources bound to the specified tag key.
     */
...
export declare class RosReportTemplate extends ros.RosResource {
     ...
     */
    readonly attrSubscriptionFrequency: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property reportTemplateName: Report Template Name.
     */
    reportTemplateName: string | ros.IResolvable;
    /**
     * @Property reportFileFormats: Report Format. Currently only support `excel`.
     */
    reportFileFormats: string | ros.IResolvable | undefined;
    /**
     * @Property reportGranularity: Report Aggregation Granularity.
     */
    reportGranularity: string | ros.IResolvable | undefined;
    /**
     * @Property reportLanguage: Report Content Language, Currently only support `zh-CN` or `en-US`.
     */
    reportLanguage: string | ros.IResolvable | undefined;
    /**
     * @Property reportScope: Report range, yes and logic between multiple sets of k-v pairs.
     */
    reportScope: Array<RosReportTemplate.ReportScopeProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property reportTemplateDescription: Report Template Description.
     */
    reportTemplateDescription: string | ros.IResolvable | undefined;
    /**
     * @Property subscriptionFrequency: Report subscription frequency. If this field is not empty, it is a Cron expression in Quartz format triggered by the subscription notification.
     * The format is: Seconds, time, day, month, week. The following are examples of commonly used Cron expressions:
     * - Execute at 0 o'clock every day: 0 0 0 * *?
     ...
     * > It can only be triggered according to the cron expression time as much as possible. The cron expression limits the same template to trigger at most one notification per day.
     */
    subscriptionFrequency: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosReportTemplate {
    /**
     * @stability external
     */
    interface ReportScopeProperty {
        /**
