 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-functionversion
 */
export declare class FunctionVersion extends ros.Resource implements IFunctionVersion {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: FunctionVersionProps, enableResourcePropertyConstraint?: boolean);
}
