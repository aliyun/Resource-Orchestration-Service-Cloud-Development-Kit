 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-ecs-managedinstances
 */
export declare class ManagedInstances extends ros.Resource implements IManagedInstances {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: ManagedInstancesProps, enableResourcePropertyConstraint?: boolean);
}
