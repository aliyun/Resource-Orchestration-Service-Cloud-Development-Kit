 ...
 */
export interface IInstanceClone extends ros.IResource {
    readonly props: InstanceCloneProps;
    /**
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecs-instanceclone
 */
export declare class InstanceClone extends ros.Resource implements IInstanceClone {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: InstanceCloneProps, enableResourcePropertyConstraint?: boolean);
}
