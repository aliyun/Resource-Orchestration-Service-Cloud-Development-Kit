 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-jdbcdatasource
 */
export declare class JdbcDataSource extends ros.Resource implements IJdbcDataSource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: JdbcDataSourceProps, enableResourcePropertyConstraint?: boolean);
}
