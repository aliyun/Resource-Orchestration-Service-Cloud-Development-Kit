 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-supabaseproject
 */
export declare class SupabaseProject extends ros.Resource implements ISupabaseProject {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: SupabaseProjectProps, enableResourcePropertyConstraint?: boolean);
}
