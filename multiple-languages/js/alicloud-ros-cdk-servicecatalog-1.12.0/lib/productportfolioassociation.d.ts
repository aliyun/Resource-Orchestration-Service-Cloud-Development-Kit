 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-servicecatalog-productportfolioassociation
 */
export declare class ProductPortfolioAssociation extends ros.Resource implements IProductPortfolioAssociation {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ProductPortfolioAssociationProps, enableResourcePropertyConstraint?: boolean);
}
