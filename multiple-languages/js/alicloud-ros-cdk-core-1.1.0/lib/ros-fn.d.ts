...
export declare class Fn {
     ...
     */
    static marketplaceImage(imageProductCode: string | ros.IResolvable): string;
    /**
     ...
     */
    static any(values: any[] | ros.IResolvable): string;
    /**
     * Returns true if at least one member of the list matches the specified value and false otherwise.
     * @param values An array of values.
     * @param value A value.
     */
    static contains(values: any[] | ros.IResolvable, value: any): string;
    /**
     ...
     */
    static eachMemberIn(values1: any[] | ros.IResolvable, values2: any[] | ros.IResolvable): string;
    /**
     * Returns true if a specified string matches a specified pattern.
     * @param pattern A regular expression in string form.
     * @param value The string to match.
     */
    static matchPattern(pattern: string | ros.IResolvable, value: string | ros.IResolvable): string;
    /**
     ...
     */
    static cidr(ipBlock: string | ros.IResolvable, count: number | ros.IResolvable, cidrBits: number | ros.IResolvable): string;
    /**
...
export declare class FnIndent extends FnBase {
    /**
