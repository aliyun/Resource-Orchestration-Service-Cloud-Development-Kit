 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqosrule
 */
export declare class TrafficQosRule extends ros.Resource implements ITrafficQosRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TrafficQosRuleProps, enableResourcePropertyConstraint?: boolean);
}
