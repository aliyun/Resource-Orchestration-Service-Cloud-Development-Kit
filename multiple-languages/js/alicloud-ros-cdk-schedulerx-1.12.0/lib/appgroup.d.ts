 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-schedulerx-appgroup
 */
export declare class AppGroup extends ros.Resource implements IAppGroup {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AppGroupProps, enableResourcePropertyConstraint?: boolean);
}
