 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dns-accessstrategy
 */
export declare class AccessStrategy extends ros.Resource implements IAccessStrategy {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AccessStrategyProps, enableResourcePropertyConstraint?: boolean);
}
