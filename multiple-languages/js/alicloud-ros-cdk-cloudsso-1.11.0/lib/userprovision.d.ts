 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cloudsso-userprovision
 */
export declare class UserProvision extends ros.Resource implements IUserProvision {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: UserProvisionProps, enableResourcePropertyConstraint?: boolean);
}
