 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-nlb-hdmonitorregionconfig
 */
export declare class RosHdMonitorRegionConfig extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::NLB::HdMonitorRegionConfig";
    /**
     ...
     */
    readonly attrMetricStore: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property logProject: The name of the LogProject.
     */
     ...
     * @Property metricStore: The name of the MetricStore.
     */
    metricStore: string | ros.IResolvable;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare class RosListener extends ros.RosResource {
     ...
     * @Property serverGroupId: ID of the ServerGroup
     */
    serverGroupId: string | ros.IResolvable | undefined;
    /**
     * @Property serverGroupTuples: Multi-server group list.
     * When the number of destination server groups is 1, the default value is 100 if no weight is specified.
     * When the number of destination server groups is greater than 1, the user needs to specify the weight value.
     */
    serverGroupTuples: Array<RosListener.ServerGroupTuplesProperty | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property startPort: StartPort of the portRange
     */
