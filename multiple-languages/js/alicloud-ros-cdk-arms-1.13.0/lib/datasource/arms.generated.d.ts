...
export declare class RosEnvironment extends ros.RosResource {
     ...
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "DATASOURCE::ARMS::Environment";
    /**
     * @Attribute BindResourceId: The id or vpcId of the bound container instance.
     */
    readonly attrBindResourceId: ros.IResolvable;
    /**
     * @Attribute BindResourceType: Binding resource type.
     */
    readonly attrBindResourceType: ros.IResolvable;
    /**
     * @Attribute BindVpcCidr: The network segment of the bound vpc.
     */
    readonly attrBindVpcCidr: ros.IResolvable;
    /**
     ...
     */
    readonly attrGrafanaDatasourceUid: ros.IResolvable;
    /**
     * @Attribute GrafanaFolderUid: Binding Grafana directory uid.
     */
    readonly attrGrafanaFolderUid: ros.IResolvable;
    /**
...
export declare class RosEnvironments extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "DATASOURCE::ARMS::Environments";
    /**
     ...
     * @Property bindResourceId: The bound resource ID.
     */
    bindResourceId: string | ros.IResolvable | undefined;
    /**
     * @Property environmentType: Type of environment.
     */
    environmentType: string | ros.IResolvable | undefined;
    /**
     * @Property refreshOptions: The refresh strategy for the datasource resource when the stack is updated. Valid values:
     * - Never: Never refresh the datasource resource when the stack is updated.
     * - Always: Always refresh the datasource resource when the stack is updated.
