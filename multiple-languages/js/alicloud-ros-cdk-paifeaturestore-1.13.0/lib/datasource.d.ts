 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-paifeaturestore-datasource
 */
export declare class Datasource extends ros.Resource implements IDatasource {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DatasourceProps, enableResourcePropertyConstraint?: boolean);
}
