 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-deployrevision
 */
export declare class DeployRevision extends ros.Resource implements IDeployRevision {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DeployRevisionProps, enableResourcePropertyConstraint?: boolean);
}
