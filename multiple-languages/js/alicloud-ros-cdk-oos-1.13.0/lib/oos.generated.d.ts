 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnection
 */
export declare class RosApplicationConnection extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::OOS::ApplicationConnection";
    /**
     * @Attribute ConnectionId: The ID of the application connection.
     */
    readonly attrConnectionId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property connectionCategory: The category of the application connection.
     */
    connectionCategory: string | ros.IResolvable;
    /**
     * @Property connectionType: The type of the application connection.
     */
     ...
     * @Property envVars: The environment variables of the application connection.
     */
    envVars: Array<RosApplicationConnection.EnvVarsProperty | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property name: The name of the application connection.
     */
...
export declare namespace RosApplicationConnection {
    /**
     * @stability external
     */
    interface EnvVarsProperty {
        /**
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationconnectionbind
 */
export declare class RosApplicationConnectionBind extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::OOS::ApplicationConnectionBind";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property connectionIds: The list of connection IDs to bind.
     * The maximum number of connections is 100.
     */
    connectionIds: Array<string | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property applicationGroupName: The name of the application group.
     */
    applicationGroupName: string | ros.IResolvable | undefined;
    /**
     * @Property applicationName: The name of the application.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-applicationgroupdeployment
 */
export declare class RosApplicationGroupDeployment extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::OOS::ApplicationGroupDeployment";
    /**
     ...
     * @Property deployParameters: The deploy parameters of the application group to be deployed.
     */
    deployParameters: string | ros.IResolvable | undefined;
    /**
     * @Property revisionId: The ID of the revision.
     */
    revisionId: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-deployrevision
 */
export declare class RosDeployRevision extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::OOS::DeployRevision";
    /**
     * @Attribute RevisionId: The ID of the revision.
     */
    readonly attrRevisionId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property applicationName: The name of the application.
     */
     ...
     * @Property deployResourceType: The type of the deploy resource.
     */
    deployResourceType: string | ros.IResolvable | undefined;
    /**
     * @Property description: The description of the revision.
     */
     ...
     * @Property revisionType: The type of the revision.
     */
    revisionType: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
For more parameters in data, refer to https://help.aliyun.com/document_detail/120777.html.You can also notify execution via ROS API SignalResource. API parameters Status and UniqueId are ignored. Use API parameter Data to pass data.
     ...
     * @Property templateContent: The content of the template in the JSON or YAML format. This parameter is the same as the Content parameter that you can specify when you call the CreateTemplate operation. You can use this parameter to specify the tasks that you want to run. This way, you do not need to create a template before you start an execution. If you select an existing template, you do not need to specify this parameter.
     */
    templateContent: string | ros.IResolvable | undefined;
    /**
     * @Property templateName: Template name. Content is limited to letters, numbers, underlined, underline, the length of 200 characters.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-servicesettings
 */
export declare class RosServiceSettings extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::OOS::ServiceSettings";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property deliveryOssBucketName: OSS bucket name.
     */
    deliveryOssBucketName: string | ros.IResolvable | undefined;
    /**
     * @Property deliveryOssEnabled: Whether to enable the OSS delivery template execution logging feature. Defaults to false.
     */
    deliveryOssEnabled: boolean | ros.IResolvable | undefined;
    /**
     * @Property deliveryOssKeyPrefix: OSS storage space directory, such as "oos\/execution", pass "" to indicate that no directory is needed, if set before set again do not need directory can be cleared by passing "".
     */
    deliveryOssKeyPrefix: string | ros.IResolvable | undefined;
    /**
     * @Property deliverySlsEnabled: Whether to enable the SLS delivery template execution logging feature. Defaults to false.
     */
    deliverySlsEnabled: boolean | ros.IResolvable | undefined;
    /**
     * @Property deliverySlsProjectName: SLS project name.
     */
    deliverySlsProjectName: string | ros.IResolvable | undefined;
    /**
     * @Property rdcEnterpriseId: Enterprise ID.
     */
    rdcEnterpriseId: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
