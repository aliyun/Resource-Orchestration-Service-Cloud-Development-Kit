...
export declare class CdkToolkit {
    ...
    publishAssets(assetsJson: {
        [key: string]: any;
    }, outdir: string): Promise<any>;
    ...
    handleDel(client: any, name: string): Promise<any>;
    deleteProjects(client: any): Promise<void>;
    deleteBucket(client: any, bucketName: string): Promise<void>;
