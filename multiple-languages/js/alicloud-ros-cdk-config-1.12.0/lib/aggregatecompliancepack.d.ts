 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-config-aggregatecompliancepack
 */
export declare class AggregateCompliancePack extends ros.Resource implements IAggregateCompliancePack {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AggregateCompliancePackProps, enableResourcePropertyConstraint?: boolean);
}
