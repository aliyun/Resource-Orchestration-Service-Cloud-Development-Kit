...
export declare class RosAccessControl extends ros.RosResource {
     ...
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::ApiGateway::AccessControl";
    /**
     * @Attribute AccessControlListName: The name of the ACL.
     */
    readonly attrAccessControlListName: ros.IResolvable;
    /**
     * @Attribute AclEntrys: Information list of access control policies.
     */
    readonly attrAclEntrys: ros.IResolvable;
    /**
     ...
     * @Property accessControlListName: The name of the ACL. The name must be 1 to 30 characters in length, and can contain letters, digits, periods (.), hyphens (-), forward slashes (\/), and underscores (_). The name must be unique within the region.
     */
    accessControlListName: string | ros.IResolvable;
    /**
     * @Property aclEntrys: Information list of access control policies. You can add at most 50 IP addresses or CIDR blocks to an ACL in each call. If the IP address or CIDR block that you want to add to an ACL already exists, the IP address or CIDR block is not added. The entries that you add must be CIDR blocks.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apigateway-backend
 */
export declare class RosBackend extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::ApiGateway::Backend";
    /**
     * @Attribute BackendId: The ID of the backend service.
     */
    readonly attrBackendId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property backendName: The name of the backend service.
     */
    backendName: string | ros.IResolvable;
    /**
     * @Property backendType: The type the backend service. Allowed values: HTTP, VPC, FC_EVENT, FC_EVENT_V3, FC_HTTP, FC_HTTP_V3, OSS, MOCK
     */
    backendType: string | ros.IResolvable;
    /**
     * @Property description: The description.
     */
    description: string | ros.IResolvable | undefined;
     ...
     * @Property tags: The list of tags in the form of key\/value pairs. You can define a maximum of 20 tags.
     */
    tags: RosBackend.TagsProperty[] | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
...
export declare namespace RosBackend {
    /**
     * @stability external
     */
    interface TagsProperty {
