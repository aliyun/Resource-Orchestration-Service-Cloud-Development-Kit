 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-adblake-resourcegroupaccountbinding
 */
export declare class ResourceGroupAccountBinding extends ros.Resource implements IResourceGroupAccountBinding {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ResourceGroupAccountBindingProps, enableResourcePropertyConstraint?: boolean);
}
