...
export declare class RosInstanceV2 extends ros.RosResource {
     ...
     * When ChargeType is configured as PRE, the resource specification parameters must be filled.
     */
    haResourceSpec: RosInstanceV2.HaResourceSpecProperty | ros.IResolvable | undefined;
    /**
     * @Property haVSwitchIds: HA VSwitch IDs.
     */
    haVSwitchIds: Array<any | ros.IResolvable> | ros.IResolvable | undefined;
    /**
     * @Property monitorType: The monitor type, the value of the value is as follows: TAIHAO, ARMS
     */
    monitorType: string | ros.IResolvable | undefined;
    /**
     * @Property pricingCycle: The ordering cycle only supports ordering in the year and month.
     */
    pricingCycle: string | ros.IResolvable | undefined;
...
export declare namespace RosInstanceV2 {
     ...
     * @stability external
     */
    interface HaResourceSpecProperty {
        /**
         * @Property cpu: CPU number.
         */
        readonly cpu?: number | ros.IResolvable;
