 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-clickhouse-enterprisedbclusterbackuppolicy
 */
export declare class EnterpriseDBClusterBackupPolicy extends ros.Resource implements IEnterpriseDBClusterBackupPolicy {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EnterpriseDBClusterBackupPolicyProps, enableResourcePropertyConstraint?: boolean);
}
