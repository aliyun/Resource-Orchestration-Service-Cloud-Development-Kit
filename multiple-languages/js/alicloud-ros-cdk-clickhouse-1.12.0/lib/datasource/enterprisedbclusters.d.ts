 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-clickhouse-enterprisedbclusters
 */
export declare class EnterpriseDBClusters extends ros.Resource implements IEnterpriseDBClusters {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: EnterpriseDBClustersProps, enableResourcePropertyConstraint?: boolean);
}
