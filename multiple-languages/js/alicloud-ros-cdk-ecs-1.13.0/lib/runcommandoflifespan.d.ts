 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecs-runcommandoflifespan
 */
export declare class RunCommandOfLifespan extends ros.Resource implements IRunCommandOfLifespan {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RunCommandOfLifespanProps, enableResourcePropertyConstraint?: boolean);
}
