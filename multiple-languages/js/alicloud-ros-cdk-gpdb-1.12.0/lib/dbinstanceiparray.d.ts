 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-gpdb-dbinstanceiparray
 */
export declare class DBInstanceIPArray extends ros.Resource implements IDBInstanceIPArray {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: DBInstanceIPArrayProps, enableResourcePropertyConstraint?: boolean);
}
