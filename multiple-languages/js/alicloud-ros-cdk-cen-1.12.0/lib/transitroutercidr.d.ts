 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutercidr
 */
export declare class TransitRouterCidr extends ros.Resource implements ITransitRouterCidr {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: TransitRouterCidrProps, enableResourcePropertyConstraint?: boolean);
}
