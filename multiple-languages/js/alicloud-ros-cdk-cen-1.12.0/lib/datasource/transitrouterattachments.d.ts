 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/datasource-cen-transitrouterattachments
 */
export declare class TransitRouterAttachments extends ros.Resource implements ITransitRouterAttachments {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: TransitRouterAttachmentsProps, enableResourcePropertyConstraint?: boolean);
}
