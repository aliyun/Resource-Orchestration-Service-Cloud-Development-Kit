 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-pluginconfig
 */
export declare class PluginConfig extends ros.Resource implements IPluginConfig {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PluginConfigProps, enableResourcePropertyConstraint?: boolean);
}
