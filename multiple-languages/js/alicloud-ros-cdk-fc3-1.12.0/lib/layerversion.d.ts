 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-fc3-layerversion
 */
export declare class LayerVersion extends ros.Resource implements ILayerVersion {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: LayerVersionProps, enableResourcePropertyConstraint?: boolean);
}
