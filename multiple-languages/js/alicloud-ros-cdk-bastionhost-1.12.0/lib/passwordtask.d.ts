 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-bastionhost-passwordtask
 */
export declare class PasswordTask extends ros.Resource implements IPasswordTask {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: PasswordTaskProps, enableResourcePropertyConstraint?: boolean);
}
