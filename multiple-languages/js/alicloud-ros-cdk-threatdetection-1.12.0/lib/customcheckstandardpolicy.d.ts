 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-customcheckstandardpolicy
 */
export declare class CustomCheckStandardPolicy extends ros.Resource implements ICustomCheckStandardPolicy {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: CustomCheckStandardPolicyProps, enableResourcePropertyConstraint?: boolean);
}
