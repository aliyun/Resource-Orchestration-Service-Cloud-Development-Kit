 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-threatdetection-honeypotnode
 */
export declare class HoneypotNode extends ros.Resource implements IHoneypotNode {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: HoneypotNodeProps, enableResourcePropertyConstraint?: boolean);
}
