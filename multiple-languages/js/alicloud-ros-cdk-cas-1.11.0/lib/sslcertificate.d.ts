 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cas-sslcertificate
 */
export declare class SslCertificate extends ros.Resource implements ISslCertificate {
     ...
     */
    constructor(scope: ros.Construct, id: string, props?: SslCertificateProps, enableResourcePropertyConstraint?: boolean);
}
