 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-oos-stateconfiguration
 */
export declare class StateConfiguration extends ros.Resource implements IStateConfiguration {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: StateConfigurationProps, enableResourcePropertyConstraint?: boolean);
}
