 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-acs-applicationpod
 */
export declare class ApplicationPod extends ros.Resource implements IApplicationPod {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ApplicationPodProps, enableResourcePropertyConstraint?: boolean);
}
