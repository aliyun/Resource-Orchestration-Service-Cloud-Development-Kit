 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-eflo-vpd
 */
export declare class Vpd extends ros.Resource implements IVpd {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: VpdProps, enableResourcePropertyConstraint?: boolean);
}
