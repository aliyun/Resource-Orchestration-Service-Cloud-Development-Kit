 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-etlv2
 */
export declare class EtlV2 extends ros.Resource implements IEtlV2 {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: EtlV2Props, enableResourcePropertyConstraint?: boolean);
}
