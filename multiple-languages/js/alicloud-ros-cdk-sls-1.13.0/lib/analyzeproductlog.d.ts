 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-sls-analyzeproductlog
 */
export declare class AnalyzeProductLog extends ros.Resource implements IAnalyzeProductLog {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: AnalyzeProductLogProps, enableResourcePropertyConstraint?: boolean);
}
