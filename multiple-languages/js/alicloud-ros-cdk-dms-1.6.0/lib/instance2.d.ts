 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-dms-instance2
 */
export declare class Instance2 extends ros.Resource implements IInstance2 {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: Instance2Props, enableResourcePropertyConstraint?: boolean);
}
