 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-hbr-nasbackupplan
 */
export declare class NasBackupPlan extends ros.Resource implements INasBackupPlan {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: NasBackupPlanProps, enableResourcePropertyConstraint?: boolean);
}
