 ...
 */
export interface IForwardEntry extends ros.IResource {
    readonly props: ForwardEntryProps;
    /**
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ecs-forwardentry
 */
export declare class ForwardEntry extends ros.Resource implements IForwardEntry {
