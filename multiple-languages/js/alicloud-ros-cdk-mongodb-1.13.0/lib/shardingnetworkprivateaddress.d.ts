 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mongodb-shardingnetworkprivateaddress
 */
export declare class ShardingNetworkPrivateAddress extends ros.Resource implements IShardingNetworkPrivateAddress {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: ShardingNetworkPrivateAddressProps, enableResourcePropertyConstraint?: boolean);
}
