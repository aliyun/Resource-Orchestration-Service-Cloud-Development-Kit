 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-mse-gatewayservice
 */
export declare class GatewayService extends ros.Resource implements IGatewayService {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: GatewayServiceProps, enableResourcePropertyConstraint?: boolean);
}
