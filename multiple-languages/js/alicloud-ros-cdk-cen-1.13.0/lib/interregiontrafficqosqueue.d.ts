 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-interregiontrafficqosqueue
 */
export declare class InterRegionTrafficQosQueue extends ros.Resource implements IInterRegionTrafficQosQueue {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: InterRegionTrafficQosQueueProps, enableResourcePropertyConstraint?: boolean);
}
