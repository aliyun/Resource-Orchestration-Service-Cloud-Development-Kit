...
export declare class RosFlowlog extends ros.RosResource {
     ...
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::Flowlog";
    /**
     * @Attribute CenId: The ID of the CEN instance.
     */
    readonly attrCenId: ros.IResolvable;
     ...
     */
    readonly attrFlowLogVersion: ros.IResolvable;
    /**
     ...
     */
    readonly attrLogFormatString: ros.IResolvable;
    /**
     ...
     *     * If you configure this parameter, start the string with ${srcaddr}${dstaddr}${bytes} because ${srcaddr}${dstaddr}${bytes} are required variables.
     */
    logFormatString: string | ros.IResolvable | undefined;
    /**
     * @Property logStoreName: The Logstore that stores the captured traffic data.
     * * If a Logstore is already created in the selected region, enter the name of the Logstore.
     * * If no Logstores are created in the selected region, enter a name and the system automatically creates a Logstore. The name of the Logstore. The name must meet the following requirements:
     ...
     * @Property tags: Tags of flow log.
     */
    tags: RosFlowlog.TagsProperty[] | undefined;
    /**
     * @Property transitRouterAttachmentId: The ID of the VPC connection, VPN connection, VBR connection, ECR connection, or inter-region connection.
     * If you create the flow log for a transfer router, skip this parameter.
     */
    transitRouterAttachmentId: string | ros.IResolvable | undefined;
    /**
     * @Property transitRouterId: The ID of the transit router.
     */
...
export declare namespace RosFlowlog {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-interregiontrafficqospolicy
 */
export declare class RosInterRegionTrafficQosPolicy extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::InterRegionTrafficQosPolicy";
    /**
     * @Attribute BandwidthGuaranteeMode: The allocation mode of the guaranteed bandwidth.
     */
    readonly attrBandwidthGuaranteeMode: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosPolicyDescription: The description of the QoS policy.
     */
    readonly attrInterRegionTrafficQosPolicyDescription: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosPolicyId: The ID of the QoS policy.
     */
    readonly attrInterRegionTrafficQosPolicyId: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosPolicyName: The name of the QoS policy.
     */
    readonly attrInterRegionTrafficQosPolicyName: ros.IResolvable;
    /**
     ...
     *  * byBandwidthPercent (default): allocates a bandwidth percentage for the OoS queue.
     */
    bandwidthGuaranteeMode: string | ros.IResolvable | undefined;
    /**
     * @Property interRegionTrafficQosPolicyDescription: The description of the QoS policy. This parameter is optional. If you enter a description, it must be 1 to 256 characters in length, and cannot start with http:\/\/ or https:\/\/.
     */
    interRegionTrafficQosPolicyDescription: string | ros.IResolvable | undefined;
    /**
     * @Property interRegionTrafficQosPolicyName: The name of the QoS policy. The name can be empty or 1 to 128 characters in length, and cannot start with http:\/\/ or https:\/\/.
     */
    interRegionTrafficQosPolicyName: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-interregiontrafficqosqueue
 */
export declare class RosInterRegionTrafficQosQueue extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::InterRegionTrafficQosQueue";
    /**
     ...
     */
    readonly attrDscps: ros.IResolvable;
    /**
     * @Attribute EffectiveBandwidth: The actual bandwidth value of the current queue.
     */
    readonly attrEffectiveBandwidth: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosQueueDescription: The description of the queue.
     */
    readonly attrInterRegionTrafficQosQueueDescription: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosQueueId: The ID of the queue.
     */
    readonly attrInterRegionTrafficQosQueueId: ros.IResolvable;
    /**
     * @Attribute InterRegionTrafficQosQueueName: The name of the queue.
     */
    readonly attrInterRegionTrafficQosQueueName: ros.IResolvable;
    /**
     * @Attribute RemainBandwidthPercent: The maximum percentage of inter-region bandwidth that can be allocated to the queue.
     */
    readonly attrRemainBandwidthPercent: ros.IResolvable;
    /**
     * @Attribute TrafficQosPolicyId: The ID of the QoS policy.
     */
    readonly attrTrafficQosPolicyId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property dscps: The DSCP value of the traffic packet to be matched in the current queue, ranging from 0 to 63.
     */
    dscps: Array<number | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property trafficQosPolicyId: The ID of the QoS policy.
     */
    trafficQosPolicyId: string | ros.IResolvable;
    /**
     * @Property bandwidth: The maximum absolute bandwidth value that can be allocated to the queue. Unit: Mbit\/s.
     *  * The value specifies an absolute bandwidth. For example, a value of 20 specifies that the queue can consume at most 20 Mbit\/s of bandwidth.
     *  * The sum of the bandwidth values specified for all queues that belong to the same inter-region connection cannot exceed the maximum bandwidth of the inter-region connection.
     ...
     * @Property interRegionTrafficQosQueueDescription: The description of the queue. This parameter is optional. If you enter a description, it must be 1 to 256 characters in length and cannot start with http:\/\/ or https:\/\/.
     */
    interRegionTrafficQosQueueDescription: string | ros.IResolvable | undefined;
    /**
     * @Property interRegionTrafficQosQueueName: The name of the queue. The name can be empty or 1 to 128 characters in length, and cannot start with http:\/\/ or https:\/\/.
     */
    interRegionTrafficQosQueueName: string | ros.IResolvable | undefined;
    /**
     * @Property remainBandwidthPercent: The maximum percentage of inter-region bandwidth that can be allocated to the queue.
     *  * Unit: percentage. For example, a value of 20 specifies that the queue can consume at most 20% of inter-region bandwidth.
     *  * The sum of the percentage values specified for all queues that belong to the same inter-region connection cannot exceed 100%.
     */
    remainBandwidthPercent: number | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutercidr
 */
export declare class RosTransitRouterCidr extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::TransitRouterCidr";
    /**
     ...
     */
    readonly attrFamily: ros.IResolvable;
    /**
     ...
     */
    readonly attrPublishCidrRoute: ros.IResolvable;
    /**
     * @Attribute TransitRouterCidrId: The ID of the CIDR block.
     */
    readonly attrTransitRouterCidrId: ros.IResolvable;
    /**
     * @Attribute TransitRouterCidrName: The new name of the transit router CIDR block.
     */
    readonly attrTransitRouterCidrName: ros.IResolvable;
    /**
     * @Attribute TransitRouterId: The ID of the transit router.
     */
    readonly attrTransitRouterId: ros.IResolvable;
     ...
     * * false.
     */
    publishCidrRoute: boolean | ros.IResolvable | undefined;
    /**
     * @Property transitRouterCidrName: The new name of the transit router CIDR block.
     * The name must be 1 to 128 characters in length, and cannot start with http:\/\/ or https:\/\/. You can also leave this parameter empty.
     */
    transitRouterCidrName: string | ros.IResolvable | undefined;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutergrantattachment
 */
export declare class RosTransitRouterGrantAttachment extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::TransitRouterGrantAttachment";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property cenId: The ID of the Cloud Enterprise Network (CEN) instance.
     */
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitroutermulticastdomainassociation
 */
export declare class RosTransitRouterMulticastDomainAssociation extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::TransitRouterMulticastDomainAssociation";
    /**
     ...
     */
    readonly attrTransitRouterMulticastDomainId: ros.IResolvable;
    /**
     ...
     * @Property transitRouterMulticastDomainId: The ID of the multicast domain.
     */
    transitRouterMulticastDomainId: string | ros.IResolvable;
    /**
     * @Property vSwitchId: The ID of the VSwitch.
     */
...
export declare class RosTransitRouterPeerAttachment extends ros.RosResource {
     ...
     * And it can only be configured as Platinum (Platinum) when the bandwidth allocation method is billed by traffic.
     */
    defaultLinkType: string | ros.IResolvable | undefined;
    /**
     * @Property deletionForce: Whether to force delete the peer attachment.
     */
     ...
     * @Property tags: The list of tags in the form of key\/value pairs. You can define a maximum of 20 tags.
     */
    tags: RosTransitRouterPeerAttachment.TagsProperty[] | undefined;
    /**
     * @Property transitRouterAttachmentDescription: Description information for cross-region connections.
     * The description can be empty or has a length of 1 to 256 characters and cannot start with http:\/\/ or https:\/\/.
     */
...
export declare namespace RosTransitRouterPeerAttachment {
    /**
     * @stability external
     */
    interface TagsProperty {
 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cen-transitrouterroutetableassociationreplacement
 */
export declare class RosTransitRouterRouteTableAssociationReplacement extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::CEN::TransitRouterRouteTableAssociationReplacement";
    /**
     * @Attribute OriginalTransitRouterRouteTableId: The original transit router route table ID before replacement.
     */
    readonly attrOriginalTransitRouterRouteTableId: ros.IResolvable;
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property transitRouterAttachmentId: The ID of the network instance connection.
     */
