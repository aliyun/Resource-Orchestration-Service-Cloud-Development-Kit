 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cr-reposyncrule
 */
export declare class RepoSyncRule extends ros.Resource implements IRepoSyncRule {
     ...
     */
    constructor(scope: ros.Construct, id: string, props: RepoSyncRuleProps, enableResourcePropertyConstraint?: boolean);
}
