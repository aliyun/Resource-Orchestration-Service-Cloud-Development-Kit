 ...
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-ga-logstoretoendpointgroupattachment
 */
export declare class RosLogStoreToEndpointGroupAttachment extends ros.RosResource {
    /**
     * The resource type name for this resource class.
     */
    static readonly ROS_RESOURCE_TYPE_NAME = "ALIYUN::GA::LogStoreToEndpointGroupAttachment";
    enableResourcePropertyConstraint: boolean;
    /**
     * @Property acceleratorId: Global Acceleration Instance ID.
     */
     ...
     * @Property endpointGroupIds: Endpoint Group ID List.
     */
    endpointGroupIds: Array<string | ros.IResolvable> | ros.IResolvable;
    /**
     * @Property listenerId: Listener ID.
     */
    listenerId: string | ros.IResolvable;
     ...
     * @Property slsLogStoreName: SLS log library name.
     */
    slsLogStoreName: string | ros.IResolvable;
    /**
     * @Property slsProjectName: SLS project name.
     */
    slsProjectName: string | ros.IResolvable;
    /**
     * @Property slsRegionId: SLS Region ID.
     */
    slsRegionId: string | ros.IResolvable;
    /**
     * @param scope - scope in which this resource is defined
     * @param id    - scoped id of the resource
     * @param props - resource properties
