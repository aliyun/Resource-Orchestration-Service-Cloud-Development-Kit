...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::KAFKA::SaslUser</code>, which is used to create a Simple Authentication and Security Layer (SASL) user.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:17.674Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.kafka.$Module.class, fqn = "@alicloud/ros-cdk-kafka.SaslUser")
public class SaslUser extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.kafka.ISaslUser {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.kafka.SaslUserProps getProps() {
