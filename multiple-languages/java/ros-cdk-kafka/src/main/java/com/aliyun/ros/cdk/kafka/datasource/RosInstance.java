...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::KAFKA::Instance</code>, which is used to query the information about an ApsaraMQ for Kafka instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:41.010Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.kafka.$Module.class, fqn = "@alicloud/ros-cdk-kafka.datasource.RosInstance")
public class RosInstance extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.kafka.datasource.RosInstance.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.kafka.datasource.RosInstance}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.kafka.datasource.RosInstance> {
        /**
        ...
        private final com.aliyun.ros.cdk.kafka.datasource.RosInstanceProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.kafka.datasource.RosInstanceProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.kafka.datasource.RosInstance}.
         */
        @Override
        public com.aliyun.ros.cdk.kafka.datasource.RosInstance build() {
            return new com.aliyun.ros.cdk.kafka.datasource.RosInstance(
                this.scope,
                this.id,
                this.props.build(),
