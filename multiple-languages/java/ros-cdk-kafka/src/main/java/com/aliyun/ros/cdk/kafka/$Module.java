...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/kafka/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-kafka", "1.0.12", $Module.class, "ros-cdk-kafka@1.0.12.jsii.tgz");
    }
