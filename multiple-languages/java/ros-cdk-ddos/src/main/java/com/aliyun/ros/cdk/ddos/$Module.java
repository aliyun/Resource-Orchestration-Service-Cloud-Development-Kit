...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/ddos/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-ddos", "1.0.26", $Module.class, "ros-cdk-ddos@1.0.26.jsii.tgz");
    }
