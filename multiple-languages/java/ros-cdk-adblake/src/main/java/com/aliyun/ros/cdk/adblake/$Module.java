...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/adblake/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-adblake", "1.0.25", $Module.class, "ros-cdk-adblake@1.0.25.jsii.tgz");
    }
