 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:43.166Z")
...
public interface DBClusterProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DBClusterProps> {
        ...
        /**
         * Sets the value of {@link DBClusterProps#getCloneSourceRegionId}
         * @param cloneSourceRegionId Property cloneSourceRegionId: The ID of the source region where the cluster is located.
         * @return {@code this}
         */
         ...
         * @param computeResource Property computeResource: The amount of reserved computing resources.
         *                        Unit: ACUs. Valid values: 0ACU to 4096ACU. The value must be in increments of 16 ACUs. Each ACU is equivalent to 1 core and 4 GB memory.
         *                        Note This parameter must be specified with a unit.
         * @return {@code this}
         */
         ...
         * @param dbClusterNetworkType Property dbClusterNetworkType: The network type of the cluster.
         *                             Valid values:
         *                             VPC
         * @return {@code this}
         */
         ...
         * @param diskEncryption Property diskEncryption: Specifies whether to encrypt the disk.
         *                       Valid values:
         *                       true
         *                       false (default)
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DBClusterProps#getProductForm}
         * @param productForm Property productForm: Valid values: IntegrationForm LegacyForm.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DBClusterProps#getProductVersion}
         * @param productVersion Property productVersion: The version of the cluster.Note If only ProductForm is set to IntegrationForm, enter this parameter.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DBClusterProps#getReservedNodeCount}
         * @param reservedNodeCount Property reservedNodeCount: The number of reserved nodes.
         *                          Must be 1 for basic version and multiple
         *                          of 3 for enterprise version.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DBClusterProps#getReservedNodeSize}
         * @param reservedNodeSize Property reservedNodeSize: The size of each reserved node.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DBClusterProps#getSecondaryVSwitchId}
         * @param secondaryVSwitchId Property secondaryVSwitchId: The secondary vSwitch ID of the cluster.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DBClusterProps#getSecondaryZoneId}
         * @param secondaryZoneId Property secondaryZoneId: The secondary zone ID.
         * @return {@code this}
         */
         ...
         * @param storageResource Property storageResource: The amount of reserved storage resources.
         *                        Unit: AnalyticDB compute units (ACUs). Valid values: 0ACU to 2064ACU. The value must be in increments of 24 ACUs. Each ACU is equivalent to 1 core and 4 GB memory.
         *                        Note This parameter must be specified with a unit.
         * @return {@code this}
         */
