...
/**
 * Properties for defining a <code>RosPermissions</code>.
 * <p>
...
public interface RosPermissionsProps extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * A builder for {@link RosPermissionsProps}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RosPermissionsProps> {
        ...
        /**
         * Sets the value of {@link RosPermissionsProps#getPermissions}
         ...
         */
        @Override
        public RosPermissionsProps build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RosPermissionsProps}
     */
