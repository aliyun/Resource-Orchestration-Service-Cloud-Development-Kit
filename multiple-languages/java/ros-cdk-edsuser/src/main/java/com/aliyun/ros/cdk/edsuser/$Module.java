...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/edsuser/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-edsuser", "1.10.0", $Module.class, "ros-cdk-edsuser@1.10.0.jsii.tgz");
    }
