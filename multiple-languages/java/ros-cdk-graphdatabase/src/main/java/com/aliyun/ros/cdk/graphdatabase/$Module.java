...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/graphdatabase/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-graphdatabase", "1.0.21", $Module.class, "ros-cdk-graphdatabase@1.0.21.jsii.tgz");
    }
