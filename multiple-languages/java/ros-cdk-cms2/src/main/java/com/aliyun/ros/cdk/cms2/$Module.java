...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/cms2/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-cms2", "1.13.0", $Module.class, "ros-cdk-cms2@1.13.0.jsii.tgz");
    }
