...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::EMR::Cluster</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:56.231Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.emr.$Module.class, fqn = "@alicloud/ros-cdk-emr.Cluster")
public class Cluster extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.emr.ICluster {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.emr.ClusterProps getProps() {
