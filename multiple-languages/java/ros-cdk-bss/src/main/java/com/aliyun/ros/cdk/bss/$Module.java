...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/bss/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-bss", "1.0.20", $Module.class, "ros-cdk-bss@1.0.20.jsii.tgz");
    }
