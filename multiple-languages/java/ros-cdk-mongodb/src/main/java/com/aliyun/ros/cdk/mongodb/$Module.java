...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/mongodb/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-mongodb", "1.0.26", $Module.class, "ros-cdk-mongodb@1.0.26.jsii.tgz");
    }
