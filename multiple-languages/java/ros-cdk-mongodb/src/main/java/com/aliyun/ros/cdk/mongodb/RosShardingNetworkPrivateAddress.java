...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::MONGODB::ShardingNetworkPrivateAddress</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:31.646Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.mongodb.$Module.class, fqn = "@alicloud/ros-cdk-mongodb.RosShardingNetworkPrivateAddress")
public class RosShardingNetworkPrivateAddress extends com.aliyun.ros.cdk.core.RosResource {

    protected RosShardingNetworkPrivateAddress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosShardingNetworkPrivateAddress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosShardingNetworkPrivateAddress(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddressProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrCompatibleConnections() {
        return software.amazon.jsii.Kernel.get(this, "attrCompatibleConnections", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress> {
        /**
        ...
        private final com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddressProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddressProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress}.
         */
        @Override
        public com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress build() {
            return new com.aliyun.ros.cdk.mongodb.RosShardingNetworkPrivateAddress(
                this.scope,
                this.id,
                this.props.build(),
