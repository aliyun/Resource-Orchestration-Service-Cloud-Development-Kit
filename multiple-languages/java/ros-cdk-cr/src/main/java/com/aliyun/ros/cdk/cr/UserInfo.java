...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CR::UserInfo</code>, which is used to create the information about a user.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:13.496Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cr.$Module.class, fqn = "@alicloud/ros-cdk-cr.UserInfo")
public class UserInfo extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cr.IUserInfo {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrLoginName() {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cr.UserInfoProps getProps() {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cr.UserInfo> {
         ...
         * <p>
         * @return {@code this}
         * @param instanceId Property instanceId: The ID of enterprise edition ACR instance. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cr.UserInfo}.
         */
        @Override
