...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::CR::Repositories</code>, which is used to query the information about image repositories.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:36.418Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cr.$Module.class, fqn = "@alicloud/ros-cdk-cr.datasource.Repositories")
public class Repositories extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cr.datasource.IRepositories {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrRepos() {
        return software.amazon.jsii.Kernel.get(this, "attrRepos", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cr.datasource.RepositoriesProps getProps() {
