...
/**
 * Properties for defining a <code>RosInstanceEndpointAclPolicy</code>.
 * <p>
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-cr-instanceendpointaclpolicy
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:45.086Z")
...
public interface RosInstanceEndpointAclPolicyProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RosInstanceEndpointAclPolicyProps> {
        ...
        /**
         * Sets the value of {@link RosInstanceEndpointAclPolicyProps#getAutoEnableType}
         * @param autoEnableType the value to be set.
         * @return {@code this}
         */
