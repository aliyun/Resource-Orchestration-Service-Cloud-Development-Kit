...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CR::Repository</code>, which is used to create an image repository.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-12T02:20:24.789Z")
...
public class RosRepository extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cr.RosRepository> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cr.RosRepository}.
         */
        @Override
