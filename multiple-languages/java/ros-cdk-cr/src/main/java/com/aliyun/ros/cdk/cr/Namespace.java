...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CR::Namespace</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:53.971Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cr.$Module.class, fqn = "@alicloud/ros-cdk-cr.Namespace")
public class Namespace extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cr.INamespace {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cr.NamespaceProps getProps() {
