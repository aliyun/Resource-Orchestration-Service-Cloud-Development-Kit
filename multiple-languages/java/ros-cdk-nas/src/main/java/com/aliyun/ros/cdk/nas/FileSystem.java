...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::NAS::FileSystem</code>, which is used to create a file system in Apsara File Storage NAS (NAS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-03T08:19:52.954Z")
...
public class FileSystem extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.nas.FileSystemProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.nas.FileSystemProps value) {
