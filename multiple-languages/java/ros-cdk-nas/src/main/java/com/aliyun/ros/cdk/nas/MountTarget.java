...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::NAS::MountTarget</code>You can use the , which resource to create a mount target.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:27.997Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.nas.$Module.class, fqn = "@alicloud/ros-cdk-nas.MountTarget")
public class MountTarget extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.nas.IMountTarget {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.nas.MountTargetProps getProps() {
