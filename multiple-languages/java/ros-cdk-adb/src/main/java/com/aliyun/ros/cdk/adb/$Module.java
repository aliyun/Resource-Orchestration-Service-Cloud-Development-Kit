...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/adb/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-adb", "1.10.0", $Module.class, "ros-cdk-adb@1.10.0.jsii.tgz");
    }
