...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/dfs/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-dfs", "1.0.15", $Module.class, "ros-cdk-dfs@1.0.15.jsii.tgz");
    }
