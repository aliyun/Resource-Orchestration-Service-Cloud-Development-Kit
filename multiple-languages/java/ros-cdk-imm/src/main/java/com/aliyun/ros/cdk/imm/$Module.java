...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/imm/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-imm", "1.0.10", $Module.class, "ros-cdk-imm@1.0.10.jsii.tgz");
    }
