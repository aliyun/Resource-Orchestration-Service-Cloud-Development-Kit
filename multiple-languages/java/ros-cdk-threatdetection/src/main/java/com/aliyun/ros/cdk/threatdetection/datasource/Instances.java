...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::ThreatDetection::Instances</code>, which is used to query the basic information about instances in Security Center (SAS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:12.549Z")
...
public class Instances extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.threatdetection.datasource.InstancesProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.threatdetection.datasource.InstancesProps value) {
