...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::ThreatDetection::AntiBruteForceRule</code>, which is used to query the information about a created defense rule against brute-force attacks.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T13:59:58.610Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.threatdetection.$Module.class, fqn = "@alicloud/ros-cdk-threatdetection.datasource.RosAntiBruteForceRule")
public class RosAntiBruteForceRule extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosAntiBruteForceRule(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRuleProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getAntiBruteForceRuleId() {
        return software.amazon.jsii.Kernel.get(this, "antiBruteForceRuleId", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setAntiBruteForceRuleId(final @org.jetbrains.annotations.NotNull java.lang.Number value) {
        software.amazon.jsii.Kernel.set(this, "antiBruteForceRuleId", java.util.Objects.requireNonNull(value, "antiBruteForceRuleId is required"));
    }

    /**
     */
    public void setAntiBruteForceRuleId(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "antiBruteForceRuleId", java.util.Objects.requireNonNull(value, "antiBruteForceRuleId is required"));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule> {
        /**
        ...
        private final com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRuleProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRuleProps.Builder();
        }

        /**
         * @return {@code this}
         * @param antiBruteForceRuleId This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule}.
         */
        @Override
        public com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule build() {
            return new com.aliyun.ros.cdk.threatdetection.datasource.RosAntiBruteForceRule(
                this.scope,
                this.id,
                this.props.build(),
