...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::KMS::Secret</code>, which is used to create a secret and store the initial version of the secret.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-03-01T09:16:52.975Z")
