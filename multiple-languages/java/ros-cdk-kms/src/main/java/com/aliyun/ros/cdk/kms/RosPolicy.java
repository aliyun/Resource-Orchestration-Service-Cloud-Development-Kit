...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::KMS::Policy</code>, which is used to create a permission policy to configure the keys and secrets that applications are allowed to access.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:27.569Z")
