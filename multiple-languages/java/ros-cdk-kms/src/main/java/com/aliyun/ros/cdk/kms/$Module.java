...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/kms/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-kms", "1.0.13", $Module.class, "ros-cdk-kms@1.0.13.jsii.tgz");
    }
