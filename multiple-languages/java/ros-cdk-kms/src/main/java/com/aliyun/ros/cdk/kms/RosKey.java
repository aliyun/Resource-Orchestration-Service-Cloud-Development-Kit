...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::KMS::Key</code>The , which resource creates a master key.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:51.513Z")
...
public class RosKey extends com.aliyun.ros.cdk.core.RosResource {
    ...
    /**
     */
    public @org.jetbrains.annotations.Nullable java.util.List<com.aliyun.ros.cdk.kms.RosKey.TagsProperty> getTags() {
        return java.util.Optional.ofNullable((java.util.List<com.aliyun.ros.cdk.kms.RosKey.TagsProperty>)(software.amazon.jsii.Kernel.get(this, "tags", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.kms.RosKey.TagsProperty.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }

    /**
     */
    public void setTags(final @org.jetbrains.annotations.Nullable java.util.List<com.aliyun.ros.cdk.kms.RosKey.TagsProperty> value) {
        software.amazon.jsii.Kernel.set(this, "tags", value);
    }
    /**
     */
    @software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.kms.$Module.class, fqn = "@alicloud/ros-cdk-kms.RosKey.TagsProperty")
    ...
    public static interface TagsProperty extends software.amazon.jsii.JsiiSerializable {
        ...
        final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TagsProperty {
            ...
            public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
                ...
                struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-kms.RosKey.TagsProperty"));
