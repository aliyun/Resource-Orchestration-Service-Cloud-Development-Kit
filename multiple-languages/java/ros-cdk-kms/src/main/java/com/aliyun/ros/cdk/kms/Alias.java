...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::KMS::Alias</code>, which is used to create an alias for a Customer Master Key (CMK).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-12T02:20:28.192Z")
...
public class Alias extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.kms.AliasProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.kms.AliasProps value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.kms.Alias> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.kms.Alias}.
         */
        @Override
