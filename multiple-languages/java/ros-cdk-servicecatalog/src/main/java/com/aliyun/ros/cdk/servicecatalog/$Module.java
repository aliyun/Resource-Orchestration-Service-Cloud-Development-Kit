...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/servicecatalog/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-servicecatalog", "1.14.0", $Module.class, "ros-cdk-servicecatalog@1.14.0.jsii.tgz");
    }
