 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:16.700Z")
...
public class RosScalingGroup extends com.aliyun.ros.cdk.core.RosResource {
    ...
    /**
     */
    public @org.jetbrains.annotations.Nullable java.lang.Object getServerGroups() {
        return software.amazon.jsii.Kernel.get(this, "serverGroups", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setServerGroups(final @org.jetbrains.annotations.Nullable com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "serverGroups", value);
    }

    /**
     */
    public void setServerGroups(final @org.jetbrains.annotations.Nullable java.util.List<java.lang.Object> value) {
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                final java.lang.Object __val_ac66f0 = value.get(__idx_ac66f0);
                if (
                     !(__val_ac66f0 instanceof com.aliyun.ros.cdk.core.IResolvable)
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.ess.RosScalingGroup.ServerGroupsProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.ess.RosScalingGroup.ServerGroupsProperty; received ")
                            .append(__val_ac66f0.getClass()).toString());
                }
            }
        }
    ...
    /**
     */
    @software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ess.$Module.class, fqn = "@alicloud/ros-cdk-ess.RosScalingGroup.ServerGroupsProperty")
    ...
    public static interface ServerGroupsProperty extends software.amazon.jsii.JsiiSerializable {
        ...
        final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServerGroupsProperty {
            ...
            public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
                ...
                final com.fasterxml.jackson.databind.node.ObjectNode struct = com.fasterxml.jackson.databind.node.JsonNodeFactory.instance.objectNode();
                struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-ess.RosScalingGroup.ServerGroupsProperty"));
                struct.set("data", data);
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ess.RosScalingGroup> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ess.RosScalingGroup}.
         */
        @Override
