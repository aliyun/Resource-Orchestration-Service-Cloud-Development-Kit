...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/apig/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-apig", "1.11.0", $Module.class, "ros-cdk-apig@1.11.0.jsii.tgz");
    }
