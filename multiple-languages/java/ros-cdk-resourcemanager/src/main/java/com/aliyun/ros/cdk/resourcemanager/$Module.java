...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/resourcemanager/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-resourcemanager", "1.0.17", $Module.class, "ros-cdk-resourcemanager@1.0.17.jsii.tgz");
    }
