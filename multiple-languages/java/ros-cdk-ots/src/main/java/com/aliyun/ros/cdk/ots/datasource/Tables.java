...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::OTS::Tables</code>, which is used to query the names of all tables that are created in a Tablestore instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-03-01T09:16:53.545Z")
...
public class Tables extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ots.datasource.TablesProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ots.datasource.TablesProps value) {
