...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::SLS::ServiceLog</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:50.967Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.sls.$Module.class, fqn = "@alicloud/ros-cdk-sls.ServiceLog")
public class ServiceLog extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.sls.IServiceLog {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.sls.ServiceLogProps getProps() {
