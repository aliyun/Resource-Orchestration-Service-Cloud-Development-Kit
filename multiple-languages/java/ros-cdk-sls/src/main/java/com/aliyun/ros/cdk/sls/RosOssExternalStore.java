...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLS::OssExternalStore</code>, which is used to create an Object Storage Service (OSS) external store.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T13:57:03.266Z")
