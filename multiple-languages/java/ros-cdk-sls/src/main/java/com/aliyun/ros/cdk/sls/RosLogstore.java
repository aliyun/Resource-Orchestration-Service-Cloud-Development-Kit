...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLS::Logstore</code>, which is used to create a Logstore in a Simple Log Service (SLS) project.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-12-13T06:45:12.477Z")
...
public class RosLogstore extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.sls.RosLogstore> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.sls.RosLogstore}.
         */
        @Override
