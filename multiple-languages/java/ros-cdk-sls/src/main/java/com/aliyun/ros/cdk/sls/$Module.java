...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/sls/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-sls", "1.0.13", $Module.class, "ros-cdk-sls@1.0.13.jsii.tgz");
    }
