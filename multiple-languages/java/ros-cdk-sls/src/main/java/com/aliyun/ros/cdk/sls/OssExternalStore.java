...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::SLS::OssExternalStore</code>, which is used to create an Object Storage Service (OSS) external store.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:54.425Z")
