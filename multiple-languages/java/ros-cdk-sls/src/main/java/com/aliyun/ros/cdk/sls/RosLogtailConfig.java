...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLS::LogtailConfig</code>, which is used to configure Logtail properties for data collection.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:14.366Z")
...
public class RosLogtailConfig extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.sls.RosLogtailConfig> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.sls.RosLogtailConfig}.
         */
        @Override
