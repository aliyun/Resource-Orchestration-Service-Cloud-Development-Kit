...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::SLS::Alert</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:25:00.542Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.sls.$Module.class, fqn = "@alicloud/ros-cdk-sls.Alert")
public class Alert extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.sls.IAlert {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.sls.AlertProps getProps() {
