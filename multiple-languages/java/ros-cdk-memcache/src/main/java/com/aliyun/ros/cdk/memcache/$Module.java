...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/memcache/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-memcache", "1.0.14", $Module.class, "ros-cdk-memcache@1.0.14.jsii.tgz");
    }
