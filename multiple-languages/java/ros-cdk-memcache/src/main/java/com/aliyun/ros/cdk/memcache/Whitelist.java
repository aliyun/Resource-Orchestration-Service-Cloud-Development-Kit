...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::Memcache::Whitelist</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:07.996Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.memcache.$Module.class, fqn = "@alicloud/ros-cdk-memcache.Whitelist")
public class Whitelist extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.memcache.IWhitelist {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.memcache.WhitelistProps getProps() {
