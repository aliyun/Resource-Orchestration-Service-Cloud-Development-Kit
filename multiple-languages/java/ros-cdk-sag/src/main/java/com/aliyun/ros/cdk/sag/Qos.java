...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::SAG::Qos</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:20.425Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.sag.$Module.class, fqn = "@alicloud/ros-cdk-sag.Qos")
public class Qos extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.sag.IQos {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.sag.QosProps getProps() {
