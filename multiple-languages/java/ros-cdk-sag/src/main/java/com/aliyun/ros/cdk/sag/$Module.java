...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/sag/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-sag", "1.0.11", $Module.class, "ros-cdk-sag@1.0.11.jsii.tgz");
    }
