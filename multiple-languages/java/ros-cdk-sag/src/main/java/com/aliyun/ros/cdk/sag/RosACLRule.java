...
/**
 * A ROS template type:  <code>ALIYUN::SAG::ACLRule</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.88.0 (build eaabd08)", date = "2023-09-01T09:26:39.571Z")
...
public class RosACLRule extends com.aliyun.ros.cdk.core.RosResource {
    ...
    /**
     * Create a new <code>ALIYUN::SAG::ACLRule</code>.
     * <p>
