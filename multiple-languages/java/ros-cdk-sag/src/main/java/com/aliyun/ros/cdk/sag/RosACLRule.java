...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SAG::ACLRule</code>, which is used to add an access control list (ACL) rule.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-06T03:35:17.385Z")
...
public class RosACLRule extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.sag.RosACLRule> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.sag.RosACLRule}.
         */
        @Override
