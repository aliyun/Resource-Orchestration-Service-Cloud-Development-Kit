...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/config/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-config", "1.0.23", $Module.class, "ros-cdk-config@1.0.23.jsii.tgz");
    }
