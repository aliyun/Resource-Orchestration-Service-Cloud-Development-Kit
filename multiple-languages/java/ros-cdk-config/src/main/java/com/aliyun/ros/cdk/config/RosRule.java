...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::Config::Rule</code>, which is used to create or modify a rule.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:18.809Z")
...
public class RosRule extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.config.RosRule> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.config.RosRule}.
         */
        @Override
