...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/agentrun/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-agentrun", "1.14.0", $Module.class, "ros-cdk-agentrun@1.14.0.jsii.tgz");
    }
