...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::GA::BasicAcceleratorIpEndpointRelation</code>, which is used to create a mapping between an accelerated IP address and an endpoint for a basic Global Accelerator (GA) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:40.503Z")
