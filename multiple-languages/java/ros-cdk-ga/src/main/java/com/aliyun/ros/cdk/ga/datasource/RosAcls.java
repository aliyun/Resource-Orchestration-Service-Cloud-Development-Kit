...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::GA::Acls</code>, which is used to query access control lists (ACLs).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:30.878Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ga.$Module.class, fqn = "@alicloud/ros-cdk-ga.datasource.RosAcls")
public class RosAcls extends com.aliyun.ros.cdk.core.RosResource {

    protected RosAcls(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosAcls(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.ga.datasource.RosAcls.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosAcls(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ga.datasource.RosAclsProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.ga.datasource.RosAcls}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ga.datasource.RosAcls> {
        /**
        ...
        private final com.aliyun.ros.cdk.ga.datasource.RosAclsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.ga.datasource.RosAclsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ga.datasource.RosAcls}.
         */
        @Override
        public com.aliyun.ros.cdk.ga.datasource.RosAcls build() {
            return new com.aliyun.ros.cdk.ga.datasource.RosAcls(
                this.scope,
                this.id,
                this.props.build(),
