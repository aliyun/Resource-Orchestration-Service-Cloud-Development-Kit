...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::GA::Acl</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:57.227Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ga.$Module.class, fqn = "@alicloud/ros-cdk-ga.Acl")
public class Acl extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.ga.IAcl {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ga.AclProps getProps() {
