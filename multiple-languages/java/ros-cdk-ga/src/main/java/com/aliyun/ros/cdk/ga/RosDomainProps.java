 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:07.172Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ga.$Module.class, fqn = "@alicloud/ros-cdk-ga.RosDomainProps")
...
public interface RosDomainProps extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     */
    @org.jetbrains.annotations.NotNull java.lang.Object getAcceleratorIds();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RosDomainProps> {
        java.lang.Object acceleratorIds;
        java.lang.Object domain;

        /**
         * Sets the value of {@link RosDomainProps#getAcceleratorIds}
         * @param acceleratorIds the value to be set. This parameter is required.
         * @return {@code this}
         */
        public Builder acceleratorIds(com.aliyun.ros.cdk.core.IResolvable acceleratorIds) {
         ...
         * @return {@code this}
         */
        public Builder acceleratorIds(java.util.List<? extends java.lang.Object> acceleratorIds) {
            this.acceleratorIds = acceleratorIds;
            return this;
        }

        /**
         * Sets the value of {@link RosDomainProps#getDomain}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RosDomainProps {
        private final java.lang.Object acceleratorIds;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.acceleratorIds = software.amazon.jsii.Kernel.get(this, "acceleratorIds", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.acceleratorIds = java.util.Objects.requireNonNull(builder.acceleratorIds, "acceleratorIds is required");
            this.domain = java.util.Objects.requireNonNull(builder.domain, "domain is required");
        }

        @Override
        public final java.lang.Object getAcceleratorIds() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            data.set("acceleratorIds", om.valueToTree(this.getAcceleratorIds()));
            data.set("domain", om.valueToTree(this.getDomain()));

            final com.fasterxml.jackson.databind.node.ObjectNode struct = com.fasterxml.jackson.databind.node.JsonNodeFactory.instance.objectNode();
            struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-ga.RosDomainProps"));
        ...
        public final boolean equals(final Object o) {
            ...
            if (!acceleratorIds.equals(that.acceleratorIds)) return false;
            return this.domain.equals(that.domain);
        }

        @Override
        public final int hashCode() {
            int result = this.acceleratorIds.hashCode();
