...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/cloudsso/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-cloudsso", "1.10.0", $Module.class, "ros-cdk-cloudsso@1.10.0.jsii.tgz");
    }
