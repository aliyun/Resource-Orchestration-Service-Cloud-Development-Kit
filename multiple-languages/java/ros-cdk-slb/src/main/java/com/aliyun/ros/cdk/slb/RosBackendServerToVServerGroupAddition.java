...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLB::BackendServerToVServerGroupAddition</code>, which is used to add backend servers to an existing server group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-02-28T02:53:30.784Z")
...
public class RosBackendServerToVServerGroupAddition extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.slb.RosBackendServerToVServerGroupAddition> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.slb.RosBackendServerToVServerGroupAddition}.
         */
        @Override
