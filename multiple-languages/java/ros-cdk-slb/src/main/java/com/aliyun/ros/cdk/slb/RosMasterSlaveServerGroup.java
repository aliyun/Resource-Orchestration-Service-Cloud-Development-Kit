...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLB::MasterSlaveServerGroup</code>, which is used to create a primary/secondary server group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:33.542Z")
...
public class RosMasterSlaveServerGroup extends com.aliyun.ros.cdk.core.RosResource {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.slb.RosMasterSlaveServerGroup.MasterSlaveBackendServersProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.slb.RosMasterSlaveServerGroup.MasterSlaveBackendServersProperty; received ")
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.slb.RosMasterSlaveServerGroup> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.slb.RosMasterSlaveServerGroup}.
         */
        @Override
