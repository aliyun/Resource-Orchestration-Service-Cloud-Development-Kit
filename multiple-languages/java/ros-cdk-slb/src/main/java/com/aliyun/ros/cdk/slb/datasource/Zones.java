...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::SLB::Zones</code>, which is used to query the zones of Server Load Balancer (SLB) instances.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:44.465Z")
...
public class Zones extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.slb.datasource.IZones {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.slb.datasource.ZonesProps getProps() {
