...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::SLB::Rule</code>, which is used to query the configuration details of a forwarding rule.
 */
