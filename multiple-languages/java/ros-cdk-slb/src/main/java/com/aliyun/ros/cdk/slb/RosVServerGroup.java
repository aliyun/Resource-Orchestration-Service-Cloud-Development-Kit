...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLB::VServerGroup</code>, which is used to create a vServer group and attach backend servers to a Server Load Balancer (SLB) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-02-28T02:53:30.806Z")
