...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::SLB::LoadBalancer</code>, which is used to query the information about a Classic Load Balancer (CLB) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:54.325Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.slb.$Module.class, fqn = "@alicloud/ros-cdk-slb.datasource.RosLoadBalancer")
public class RosLoadBalancer extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer> {
        /**
        ...
        private final com.aliyun.ros.cdk.slb.datasource.RosLoadBalancerProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.slb.datasource.RosLoadBalancerProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer}.
         */
        @Override
        public com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer build() {
            return new com.aliyun.ros.cdk.slb.datasource.RosLoadBalancer(
                this.scope,
                this.id,
                this.props.build(),
