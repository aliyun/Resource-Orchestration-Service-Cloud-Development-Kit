...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SLB::Listener</code>You can use , which to create a Server Load Balancer (SLB) listener.
 */
