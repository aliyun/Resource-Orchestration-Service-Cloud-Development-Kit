...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CEN::RouteEntry</code>, which is used to advertise a routing entry of an attached VPC or VBR to a CEN instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:18.210Z")
...
public class RouteEntry extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cen.RouteEntryProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cen.RouteEntryProps value) {
