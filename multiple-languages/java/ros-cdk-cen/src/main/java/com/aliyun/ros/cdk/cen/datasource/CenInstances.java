...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::CEN::CenInstances</code>, which is used to query the information about Cloud Enterprise Network (CEN) instances within the current Alibaba Cloud account.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:12.651Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cen.$Module.class, fqn = "@alicloud/ros-cdk-cen.datasource.CenInstances")
public class CenInstances extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cen.datasource.ICenInstances {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrCenIds() {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrCens() {
        return software.amazon.jsii.Kernel.get(this, "attrCens", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cen.datasource.CenInstancesProps getProps() {
