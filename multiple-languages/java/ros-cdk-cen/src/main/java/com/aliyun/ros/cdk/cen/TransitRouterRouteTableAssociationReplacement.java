...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CEN::TransitRouterRouteTableAssociationReplacement</code>The , which resource replaces the transit router route table associated with a network instance connection.
 */
