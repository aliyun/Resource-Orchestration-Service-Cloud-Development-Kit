...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CEN::CenRouteService</code>, which is used to configure the access to an Alibaba Cloud service.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:18.176Z")
...
public class RosCenRouteService extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cen.RosCenRouteService> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cen.RosCenRouteService}.
         */
        @Override
