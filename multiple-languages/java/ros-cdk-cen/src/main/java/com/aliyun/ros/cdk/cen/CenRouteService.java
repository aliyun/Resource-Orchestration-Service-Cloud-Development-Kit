...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CEN::CenRouteService</code>, which is used to access an Alibaba Cloud service.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:44.292Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cen.$Module.class, fqn = "@alicloud/ros-cdk-cen.CenRouteService")
public class CenRouteService extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cen.ICenRouteService {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cen.CenRouteServiceProps getProps() {
