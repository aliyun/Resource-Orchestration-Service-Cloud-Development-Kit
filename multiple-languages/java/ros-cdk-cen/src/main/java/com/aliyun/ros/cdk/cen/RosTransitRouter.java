...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CEN::TransitRouter</code>, which is used to create an Enterprise Edition transit router.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:27.266Z")
...
public class RosTransitRouter extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cen.RosTransitRouter> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cen.RosTransitRouter}.
         */
        @Override
