...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CEN::CenVbrHealthCheck</code>, which is used to enable the health check feature or modify the health check configuration for a virtual border router (VBR).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:52.894Z")
