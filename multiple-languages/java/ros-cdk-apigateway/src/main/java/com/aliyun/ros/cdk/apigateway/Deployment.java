...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ApiGateway::Deployment</code>, which is used to release an API to a specified runtime environment, or switch a released API to a specified version.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:07.328Z")
...
public class Deployment extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.apigateway.DeploymentProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.apigateway.DeploymentProps value) {
