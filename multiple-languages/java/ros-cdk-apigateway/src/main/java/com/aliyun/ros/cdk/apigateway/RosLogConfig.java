...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ApiGateway::LogConfig</code>, which is used to create a log configuration.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:07.486Z")
...
public class RosLogConfig extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.apigateway.RosLogConfig> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.apigateway.RosLogConfig}.
         */
        @Override
