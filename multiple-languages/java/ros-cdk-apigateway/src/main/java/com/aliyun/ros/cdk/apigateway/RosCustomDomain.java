...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ApiGateway::CustomDomain</code>, which is used to bind a custom domain name and upload a Secure Sockets Layer (SSL) certificate to a specific API group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:36.257Z")
...
public class RosCustomDomain extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.apigateway.RosCustomDomain> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.apigateway.RosCustomDomain}.
         */
        @Override
