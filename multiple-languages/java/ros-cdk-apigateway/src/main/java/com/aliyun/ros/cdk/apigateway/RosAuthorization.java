...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ApiGateway::Authorization</code>, which is used to authorize applications to call APIs.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:36.255Z")
...
public class RosAuthorization extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.apigateway.RosAuthorization> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.apigateway.RosAuthorization}.
         */
        @Override
