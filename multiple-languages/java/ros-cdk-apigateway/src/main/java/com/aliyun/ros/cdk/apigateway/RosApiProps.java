...
/**
 * Properties for defining a <code>RosApi</code>.
 * <p>
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-apigateway-api
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:01.806Z")
...
public interface RosApiProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RosApiProps> {
        ...
        /**
         * Sets the value of {@link RosApiProps#getAllowSignatureMethod}
         * @param allowSignatureMethod the value to be set.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link RosApiProps#getResultBodyModel}
         * @param resultBodyModel the value to be set.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link RosApiProps#getResultDescriptions}
         * @param resultDescriptions the value to be set.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link RosApiProps#getWebSocketApiType}
         * @param webSocketApiType the value to be set.
         * @return {@code this}
         */
