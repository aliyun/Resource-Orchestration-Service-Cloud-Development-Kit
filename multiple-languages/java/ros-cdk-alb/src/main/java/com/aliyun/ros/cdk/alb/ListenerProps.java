...
/**
 * Properties for defining a <code>ALIYUN::ALB::Listener</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.84.0 (build 5404dcf)", date = "2023-06-28T08:22:26.565Z")
...
public interface ListenerProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ListenerProps> {
        ...
        /**
         * Sets the value of {@link ListenerProps#getListenerStatus}
         * @param listenerStatus Property listenerStatus: The status of the listener.
         * @return {@code this}
         */
