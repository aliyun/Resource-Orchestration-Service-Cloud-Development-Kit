...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ALB::AclAssociation</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:51.986Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.alb.$Module.class, fqn = "@alicloud/ros-cdk-alb.AclAssociation")
public class AclAssociation extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.alb.IAclAssociation {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.alb.AclAssociationProps getProps() {
