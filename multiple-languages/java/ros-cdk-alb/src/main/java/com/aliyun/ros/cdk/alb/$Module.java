...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/alb/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-alb", "1.0.10", $Module.class, "ros-cdk-alb@1.0.10.jsii.tgz");
    }
