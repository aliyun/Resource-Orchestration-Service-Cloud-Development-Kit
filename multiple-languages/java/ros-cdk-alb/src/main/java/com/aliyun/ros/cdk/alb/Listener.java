...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ALB::Listener</code>The , which resource type creates an HTTP, HTTPS, or QUIC listener for an Application Load Balancer (ALB) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:45.094Z")
...
public class Listener extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.alb.IListener {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.alb.ListenerProps getProps() {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.alb.Listener> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.alb.Listener}.
         */
        @Override
