...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ALB::ZoneShift</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T10:22:24.280Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.alb.$Module.class, fqn = "@alicloud/ros-cdk-alb.RosZoneShift")
public class RosZoneShift extends com.aliyun.ros.cdk.core.RosResource {

    protected RosZoneShift(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosZoneShift(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.alb.RosZoneShift.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosZoneShift(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.alb.RosZoneShiftProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.alb.RosZoneShift.ZoneMappingsProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.alb.RosZoneShift.ZoneMappingsProperty; received ")
    ...
    /**
     */
    @software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.alb.$Module.class, fqn = "@alicloud/ros-cdk-alb.RosZoneShift.ZoneMappingsProperty")
    ...
    public static interface ZoneMappingsProperty extends software.amazon.jsii.JsiiSerializable {
        ...
        final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ZoneMappingsProperty {
            ...
            public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
                ...
                struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-alb.RosZoneShift.ZoneMappingsProperty"));
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.alb.RosZoneShift}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.alb.RosZoneShift> {
        /**
        ...
        private final com.aliyun.ros.cdk.alb.RosZoneShiftProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.alb.RosZoneShiftProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.alb.RosZoneShift}.
         */
        @Override
        public com.aliyun.ros.cdk.alb.RosZoneShift build() {
            return new com.aliyun.ros.cdk.alb.RosZoneShift(
                this.scope,
                this.id,
                this.props.build(),
