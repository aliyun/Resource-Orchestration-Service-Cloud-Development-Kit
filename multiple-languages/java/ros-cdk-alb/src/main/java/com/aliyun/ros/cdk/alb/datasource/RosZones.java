...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::ALB::Zones</code>This data source provides information about the zones that are available for Application Load Balancer (ALB) in a region.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:45.219Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.alb.$Module.class, fqn = "@alicloud/ros-cdk-alb.datasource.RosZones")
public class RosZones extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.alb.datasource.RosZones.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.alb.datasource.RosZones}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.alb.datasource.RosZones> {
        /**
        ...
        private final com.aliyun.ros.cdk.alb.datasource.RosZonesProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.alb.datasource.RosZonesProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.alb.datasource.RosZones}.
         */
        @Override
        public com.aliyun.ros.cdk.alb.datasource.RosZones build() {
            return new com.aliyun.ros.cdk.alb.datasource.RosZones(
                this.scope,
                this.id,
                this.props.build(),
