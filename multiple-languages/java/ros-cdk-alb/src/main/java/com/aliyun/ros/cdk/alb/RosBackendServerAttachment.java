...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ALB::BackendServerAttachment</code>Use , which to add backend servers to a server group.
 */
