...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/ossdeployment/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-ossdeployment", "1.0.25", $Module.class, "ros-cdk-ossdeployment@1.0.25.jsii.tgz");
    }

    @Override
    public List<Class<? extends JsiiModule>> getDependencies() {
        return asList(com.aliyun.ros.cdk.core.$Module.class, com.aliyun.ros.cdk.fc.$Module.class, com.aliyun.ros.cdk.oss.$Module.class, com.aliyun.ros.cdk.ossassets.$Module.class, com.aliyun.ros.cdk.ram.$Module.class, com.aliyun.ros.cdk.ros.$Module.class, com.aliyun.ros.cdk.sls.$Module.class, software.constructs.$Module.class);
    }
