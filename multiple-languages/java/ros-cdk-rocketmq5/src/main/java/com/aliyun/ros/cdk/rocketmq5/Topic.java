...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ROCKETMQ5::Topic</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:20.073Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.rocketmq5.$Module.class, fqn = "@alicloud/ros-cdk-rocketmq5.Topic")
public class Topic extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.rocketmq5.ITopic {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.rocketmq5.TopicProps getProps() {
