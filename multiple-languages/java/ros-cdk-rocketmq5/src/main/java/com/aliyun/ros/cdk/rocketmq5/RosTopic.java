...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ROCKETMQ5::Topic</code>, which is used to create a topic for a Message Queue for Apache RocketMQ V5.0 instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-24T05:57:09.057Z")
...
public class RosTopic extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rocketmq5.RosTopic> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rocketmq5.RosTopic}.
         */
        @Override
