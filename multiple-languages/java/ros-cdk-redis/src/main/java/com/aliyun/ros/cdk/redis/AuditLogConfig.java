...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::REDIS::AuditLogConfig</code>, which is used to modify the audit log settings of a Tair (Redis OSS-compatible) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:53.375Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.redis.$Module.class, fqn = "@alicloud/ros-cdk-redis.AuditLogConfig")
public class AuditLogConfig extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.redis.IAuditLogConfig {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.redis.AuditLogConfigProps getProps() {
