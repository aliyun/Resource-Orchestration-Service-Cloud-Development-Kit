...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::REDIS::Instances</code>, which is used to query the information about Tair (Redis OSS-compatible) instances.
 */
