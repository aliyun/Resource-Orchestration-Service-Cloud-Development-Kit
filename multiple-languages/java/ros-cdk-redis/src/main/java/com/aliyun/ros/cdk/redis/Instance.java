...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::REDIS::Instance</code>, which is used to create a Tair (Redis OSS-compatible) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:43.478Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.redis.$Module.class, fqn = "@alicloud/ros-cdk-redis.Instance")
public class Instance extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.redis.IInstance {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.redis.InstanceProps getProps() {
