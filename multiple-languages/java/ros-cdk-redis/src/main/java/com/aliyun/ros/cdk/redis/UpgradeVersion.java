...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::REDIS::UpgradeVersion</code>, which is used to upgrade the major version of a Tair (Redis OSS-compatible) instance.
 */
