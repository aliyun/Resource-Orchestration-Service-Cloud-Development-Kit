...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::REDIS::InstanceClasses</code>DATASOURCE::REDIS::Instances is used to query the information about ApsaraDB for Redis instances.
 */
