...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::REDIS::Account</code>, which is used to create an account that has the specified permissions on an ApsaraDB for Redis instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:32.952Z")
