...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::REDIS::Account</code>, which is used to create an account that has specific permissions for a Tair (Redis OSS-compatible) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:43.515Z")
