...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ECS::NetworkInterfaceAttachment</code>, which is used to bind an elastic network interface (ENI) to an Elastic Compute Service (ECS) instance in a virtual private cloud (VPC).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:29.345Z")
...
public class RosNetworkInterfaceAttachment extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ecs.RosNetworkInterfaceAttachment> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ecs.RosNetworkInterfaceAttachment}.
         */
        @Override
