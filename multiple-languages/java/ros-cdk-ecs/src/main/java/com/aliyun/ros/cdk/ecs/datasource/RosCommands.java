...
/**
 * A ROS template type:  <code>DATASOURCE::ECS::Commands</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2023-11-07T09:08:35.137Z")
...
public class RosCommands extends com.aliyun.ros.cdk.core.RosResource {
    ...
    protected RosCommands(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosCommands(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.ecs.datasource.RosCommands.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.ecs.datasource.RosCommands}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ecs.datasource.RosCommands> {
        /**
        ...
        private final com.aliyun.ros.cdk.ecs.datasource.RosCommandsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.ecs.datasource.RosCommandsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ecs.datasource.RosCommands}.
         */
        @Override
        public com.aliyun.ros.cdk.ecs.datasource.RosCommands build() {
            return new com.aliyun.ros.cdk.ecs.datasource.RosCommands(
                this.scope,
                this.id,
                this.props.build(),
