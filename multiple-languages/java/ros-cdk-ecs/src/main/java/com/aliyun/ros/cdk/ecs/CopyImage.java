...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ECS::CopyImage</code>, which is used to copy a custom image from one region to another region.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:09.012Z")
...
public class CopyImage extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.CopyImageProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.CopyImageProps value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ecs.CopyImage> {
         ...
         * <p>
         * @return {@code this}
         * @param allowCopyInSameRegion Property allowCopyInSameRegion: Whether to allow copying images in the same region. This parameter is required.
         */
