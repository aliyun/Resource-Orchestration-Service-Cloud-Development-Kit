...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::ECS::RecommendInstanceTypes</code>, which is used to query the recommended instance types of Elastic Compute Service (ECS) instances.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:16.017Z")
