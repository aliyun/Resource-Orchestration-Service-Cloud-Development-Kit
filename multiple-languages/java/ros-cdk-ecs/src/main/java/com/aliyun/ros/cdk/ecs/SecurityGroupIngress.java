...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ECS::SecurityGroupIngress</code>The , which resource type creates an inbound security group rule.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T11:36:38.258Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ecs.$Module.class, fqn = "@alicloud/ros-cdk-ecs.SecurityGroupIngress")
public class SecurityGroupIngress extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.ecs.ISecurityGroupIngress {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.SecurityGroupIngressProps getProps() {
