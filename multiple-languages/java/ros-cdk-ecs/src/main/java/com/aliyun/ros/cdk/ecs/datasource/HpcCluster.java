...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::ECS::HpcCluster</code>, which is used to query a High Performance Computing (HPC) cluster.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:15.755Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ecs.$Module.class, fqn = "@alicloud/ros-cdk-ecs.datasource.HpcCluster")
public class HpcCluster extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.ecs.datasource.IHpcCluster {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrHpcClusterName() {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.datasource.HpcClusterProps getProps() {
