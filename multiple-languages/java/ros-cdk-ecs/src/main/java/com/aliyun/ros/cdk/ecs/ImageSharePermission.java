...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ECS::ImageSharePermission</code>DATASOURCE::ECS::AutoSnapshotPolicies is used to query automatic snapshot policies.
 */
