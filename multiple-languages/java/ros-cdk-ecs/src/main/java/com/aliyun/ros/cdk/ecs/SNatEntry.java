...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ECS::SNatEntry</code>, which is used to configure the Source Network Address Translation (SNAT) table of a NAT gateway.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:09.399Z")
...
public class SNatEntry extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.SNatEntryProps getProps() {
        return software.amazon.jsii.Kernel.get(this, "props", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.ecs.SNatEntryProps.class));
    }

    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ecs.SNatEntryProps value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ecs.SNatEntry> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ecs.SNatEntry}.
         */
        @Override
