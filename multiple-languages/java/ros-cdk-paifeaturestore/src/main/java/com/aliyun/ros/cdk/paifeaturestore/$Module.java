...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/paifeaturestore/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-paifeaturestore", "1.13.0", $Module.class, "ros-cdk-paifeaturestore@1.13.0.jsii.tgz");
    }
