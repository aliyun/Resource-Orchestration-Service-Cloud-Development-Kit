...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/ddospro/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-ddospro", "1.0.23", $Module.class, "ros-cdk-ddospro@1.0.23.jsii.tgz");
    }
