...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CLOUDFW::Instance</code>, which is used to create a Cloud Firewall instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:22.093Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cloudfw.$Module.class, fqn = "@alicloud/ros-cdk-cloudfw.Instance")
public class Instance extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cloudfw.IInstance {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cloudfw.InstanceProps getProps() {
