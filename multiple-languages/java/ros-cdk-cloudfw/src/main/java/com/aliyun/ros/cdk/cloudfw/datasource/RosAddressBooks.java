...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::CLOUDFW::AddressBooks</code>, which is used to query the information about address books that are used for access control in Cloud Firewall (CFW).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:53.108Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cloudfw.$Module.class, fqn = "@alicloud/ros-cdk-cloudfw.datasource.RosAddressBooks")
public class RosAddressBooks extends com.aliyun.ros.cdk.core.RosResource {

    protected RosAddressBooks(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosAddressBooks(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosAddressBooks(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooksProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks> {
        /**
        ...
        private final com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooksProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooksProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks}.
         */
        @Override
        public com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks build() {
            return new com.aliyun.ros.cdk.cloudfw.datasource.RosAddressBooks(
                this.scope,
                this.id,
                this.props.build(),
