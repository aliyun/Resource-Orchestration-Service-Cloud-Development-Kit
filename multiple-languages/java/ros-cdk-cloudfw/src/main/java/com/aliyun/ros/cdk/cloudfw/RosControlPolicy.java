...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CLOUDFW::ControlPolicy</code>, which is used to add an access control policy.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-03-01T09:16:50.522Z")
...
public class RosControlPolicy extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cloudfw.RosControlPolicy> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cloudfw.RosControlPolicy}.
         */
        @Override
