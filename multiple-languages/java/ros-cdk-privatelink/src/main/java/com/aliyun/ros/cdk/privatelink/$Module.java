...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/privatelink/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-privatelink", "1.0.16", $Module.class, "ros-cdk-privatelink@1.0.16.jsii.tgz");
    }
