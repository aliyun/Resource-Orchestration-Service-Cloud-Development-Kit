...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::DNS::DomainGroup</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:54.578Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.dns.$Module.class, fqn = "@alicloud/ros-cdk-dns.DomainGroup")
public class DomainGroup extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.dns.IDomainGroup {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.dns.DomainGroupProps getProps() {
