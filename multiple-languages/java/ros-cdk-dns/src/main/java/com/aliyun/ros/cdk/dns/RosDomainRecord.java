...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::DNS::DomainRecord</code>, which is used to add a domain name system (DNS) record.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:09.180Z")
...
public class RosDomainRecord extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.dns.RosDomainRecord> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.dns.RosDomainRecord}.
         */
        @Override
