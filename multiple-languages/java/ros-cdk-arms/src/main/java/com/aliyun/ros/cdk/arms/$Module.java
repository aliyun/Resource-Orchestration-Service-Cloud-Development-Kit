...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/arms/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-arms", "1.0.13", $Module.class, "ros-cdk-arms@1.0.13.jsii.tgz");
    }
