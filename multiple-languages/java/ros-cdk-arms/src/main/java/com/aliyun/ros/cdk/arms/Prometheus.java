...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ARMS::Prometheus</code>, which is used to create a Prometheus instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:43.974Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.arms.$Module.class, fqn = "@alicloud/ros-cdk-arms.Prometheus")
public class Prometheus extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.arms.IPrometheus {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.arms.PrometheusProps getProps() {
