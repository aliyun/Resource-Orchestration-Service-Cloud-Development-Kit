...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CS::ClusterHelmApplication</code>The , which type is used to deploy an application using Helm.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T11:04:30.553Z")
...
public class ClusterHelmApplication extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cs.IClusterHelmApplication {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cs.ClusterHelmApplicationProps getProps() {
