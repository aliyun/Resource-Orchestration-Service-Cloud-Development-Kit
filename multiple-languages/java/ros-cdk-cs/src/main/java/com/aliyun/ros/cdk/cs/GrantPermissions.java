...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::CS::GrantPermissions</code>, which is used to grant role-based access control (RBAC) permissions to a Resource Access Management (RAM) user or RAM role.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:45.146Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.cs.$Module.class, fqn = "@alicloud/ros-cdk-cs.GrantPermissions")
public class GrantPermissions extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.cs.IGrantPermissions {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cs.GrantPermissionsProps getProps() {
