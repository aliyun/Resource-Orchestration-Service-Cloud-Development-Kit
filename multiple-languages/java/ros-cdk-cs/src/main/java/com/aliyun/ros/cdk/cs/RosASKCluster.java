...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CS::ASKCluster</code>, which is used to create an ACK Serverless cluster of Container Service for Kubernetes (ACK).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-12-13T06:45:06.017Z")
