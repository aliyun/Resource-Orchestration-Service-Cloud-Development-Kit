...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::CS::ClusterNodePools</code>, which is used to query the information about all node pools in a Container Service for Kubernetes (ACK) cluster.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:03.596Z")
...
public class RosClusterNodePools extends com.aliyun.ros.cdk.core.RosResource {
    ...
    protected RosClusterNodePools(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosClusterNodePools(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosClusterNodePools(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.cs.datasource.RosClusterNodePoolsProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools> {
        /**
        ...
        private final com.aliyun.ros.cdk.cs.datasource.RosClusterNodePoolsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.cs.datasource.RosClusterNodePoolsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools}.
         */
        @Override
        public com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools build() {
            return new com.aliyun.ros.cdk.cs.datasource.RosClusterNodePools(
                this.scope,
                this.id,
                this.props.build(),
