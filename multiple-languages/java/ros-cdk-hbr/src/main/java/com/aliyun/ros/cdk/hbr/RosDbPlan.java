...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::HBR::DbPlan</code>, which is used to create a backup plan.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:21.980Z")
...
public class RosDbPlan extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.hbr.RosDbPlan> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.hbr.RosDbPlan}.
         */
        @Override
