...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/hbr/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-hbr", "1.0.22", $Module.class, "ros-cdk-hbr@1.0.22.jsii.tgz");
    }
