...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ACTIONTRAIL::Trail</code>, which is used to create a trail to deliver events to Simple Log Service or Object Storage Service (OSS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-04-09T06:05:30.014Z")
...
public class RosTrail extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.actiontrail.RosTrail> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.actiontrail.RosTrail}.
         */
        @Override
