...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::TSDB::InfluxDBDatabase</code>, which is used to create a Time Series Database (TSDB) database.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:12.555Z")
...
public class InfluxDBDatabase extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.tsdb.InfluxDBDatabaseProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.tsdb.InfluxDBDatabaseProps value) {
