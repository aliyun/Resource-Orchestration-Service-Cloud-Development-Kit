...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/searchengine/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-searchengine", "1.0.18", $Module.class, "ros-cdk-searchengine@1.0.18.jsii.tgz");
    }
