...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::DTS::MigrationInstances</code>, which is used to query information about Data Transmission Service (DTS) tasks.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:23.604Z")
...
public class MigrationInstances extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.dts.datasource.IMigrationInstances {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.dts.datasource.MigrationInstancesProps getProps() {
        return software.amazon.jsii.Kernel.get(this, "props", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.dts.datasource.MigrationInstancesProps.class));
    }
