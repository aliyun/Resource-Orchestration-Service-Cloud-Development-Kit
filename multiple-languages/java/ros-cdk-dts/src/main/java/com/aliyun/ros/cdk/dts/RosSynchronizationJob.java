...
/**
 * A ROS template type:  <code>ALIYUN::DTS::SynchronizationJob</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.88.0 (build eaabd08)", date = "2023-09-15T07:33:47.513Z")
...
public class RosSynchronizationJob extends com.aliyun.ros.cdk.core.RosResource {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.dts.RosSynchronizationJob.SynchronizationObjectsProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.dts.RosSynchronizationJob.SynchronizationObjectsProperty; received ")
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.dts.RosSynchronizationJob> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.dts.RosSynchronizationJob}.
         */
        @Override
