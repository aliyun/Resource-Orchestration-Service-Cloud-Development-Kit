...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::DTS::MigrationJobs</code>, which is used to query the information about data migration tasks in Data Transmission Service (DTS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-08-12T08:28:45.854Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.dts.$Module.class, fqn = "@alicloud/ros-cdk-dts.datasource.RosMigrationJobs")
public class RosMigrationJobs extends com.aliyun.ros.cdk.core.RosResource {

    protected RosMigrationJobs(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosMigrationJobs(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosMigrationJobs(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.dts.datasource.RosMigrationJobsProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs> {
        /**
        ...
        private final com.aliyun.ros.cdk.dts.datasource.RosMigrationJobsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.dts.datasource.RosMigrationJobsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs}.
         */
        @Override
        public com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs build() {
            return new com.aliyun.ros.cdk.dts.datasource.RosMigrationJobs(
                this.scope,
                this.id,
                this.props.build(),
