...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/fc/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-fc", "1.0.26", $Module.class, "ros-cdk-fc@1.0.26.jsii.tgz");
    }

    @Override
    public List<Class<? extends JsiiModule>> getDependencies() {
        return asList(com.aliyun.ros.cdk.core.$Module.class, com.aliyun.ros.cdk.oss.$Module.class, com.aliyun.ros.cdk.ossassets.$Module.class, software.constructs.$Module.class);
    }
