...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/rocketmq/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-rocketmq", "1.0.24", $Module.class, "ros-cdk-rocketmq@1.0.24.jsii.tgz");
    }
