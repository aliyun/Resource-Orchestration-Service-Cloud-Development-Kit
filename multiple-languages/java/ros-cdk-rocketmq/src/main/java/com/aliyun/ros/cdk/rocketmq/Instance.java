...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::ROCKETMQ::Instance</code>ALIYUN::ROCKETMQ::Group is used to create a Group ID on the ROCKETMQ client.
 * <p>
 * The Group ID that you create is used to publish and subscribe to messages.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-02-28T02:53:30.533Z")
