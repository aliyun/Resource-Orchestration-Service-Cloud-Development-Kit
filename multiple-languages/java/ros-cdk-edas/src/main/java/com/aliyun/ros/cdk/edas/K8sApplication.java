...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::EDAS::K8sApplication</code>, which is used to create an application in a Kubernetes cluster.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:05.883Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.edas.$Module.class, fqn = "@alicloud/ros-cdk-edas.K8sApplication")
public class K8sApplication extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.edas.IK8sApplication {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.edas.K8sApplicationProps getProps() {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.edas.K8sApplication> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.edas.K8sApplication}.
         */
        @Override
