...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::BrainIndustrial::PidOrganization</code>, which is used to configure the architecture of a project.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-03-01T09:16:50.142Z")
...
public class PidOrganization extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.brainindustrial.PidOrganizationProps getProps() {
        return software.amazon.jsii.Kernel.get(this, "props", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.brainindustrial.PidOrganizationProps.class));
    }

    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.brainindustrial.PidOrganizationProps value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.brainindustrial.PidOrganization> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.brainindustrial.PidOrganization}.
         */
        @Override
