...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/mse/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-mse", "1.0.12", $Module.class, "ros-cdk-mse@1.0.12.jsii.tgz");
    }
