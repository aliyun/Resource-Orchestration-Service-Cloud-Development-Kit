...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::RDS::ADInfo</code>, which is used to configure Active Directory Domain Services (AD DS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-03T08:19:53.733Z")
...
public class ADInfo extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.rds.ADInfoProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.rds.ADInfoProps value) {
