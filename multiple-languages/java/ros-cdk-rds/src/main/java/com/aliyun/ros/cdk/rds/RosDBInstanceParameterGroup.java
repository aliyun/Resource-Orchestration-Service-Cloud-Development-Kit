...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RDS::DBInstanceParameterGroup</code>, which is used to modify the parameters of an ApsaraDB RDS instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:41.906Z")
...
public class RosDBInstanceParameterGroup extends com.aliyun.ros.cdk.core.RosResource {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.rds.RosDBInstanceParameterGroup.ParametersProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.rds.RosDBInstanceParameterGroup.ParametersProperty; received ")
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.RosDBInstanceParameterGroup> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.RosDBInstanceParameterGroup}.
         */
        @Override
