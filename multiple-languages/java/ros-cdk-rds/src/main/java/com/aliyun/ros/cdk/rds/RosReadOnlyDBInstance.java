...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RDS::ReadOnlyDBInstance</code>, which is used to create a read-only ApsaraDB RDS instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:11.875Z")
...
public class RosReadOnlyDBInstance extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.RosReadOnlyDBInstance> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.RosReadOnlyDBInstance}.
         */
        @Override
