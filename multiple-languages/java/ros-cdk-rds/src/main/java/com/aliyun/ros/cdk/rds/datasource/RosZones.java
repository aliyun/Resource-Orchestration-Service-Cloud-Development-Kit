...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::RDS::Zones</code>, which is used to query the zones that are available to an ApsaraDB RDS instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-04-09T06:05:34.855Z")
