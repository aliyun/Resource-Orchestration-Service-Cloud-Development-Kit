...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RDS::ADInfo</code>, which is used to configure Active Directory Domain Services (AD DS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:57.010Z")
...
public class RosADInfo extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.RosADInfo> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.RosADInfo}.
         */
        @Override
