...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::RDS::Account</code>, which creates accounts for managing databases.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:53.130Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.rds.$Module.class, fqn = "@alicloud/ros-cdk-rds.Account")
public class Account extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.rds.IAccount {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.rds.AccountProps getProps() {
