...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RDS::PrepayDBInstance</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:24:59.594Z")
...
public class RosPrepayDBInstance extends com.aliyun.ros.cdk.core.RosResource {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.rds.RosPrepayDBInstance.DBMappingsProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.rds.RosPrepayDBInstance.DBMappingsProperty; received ")
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.RosPrepayDBInstance> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.RosPrepayDBInstance}.
         */
        @Override
