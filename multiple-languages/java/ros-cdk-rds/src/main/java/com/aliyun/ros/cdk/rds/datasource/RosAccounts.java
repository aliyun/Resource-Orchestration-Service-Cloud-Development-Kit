...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::RDS::Accounts</code>, which is used to query the database accounts of an ApsaraDB RDS instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:23.635Z")
...
public class RosAccounts extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.rds.datasource.RosAccounts.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.rds.datasource.RosAccounts}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.datasource.RosAccounts> {
        /**
        ...
        private final com.aliyun.ros.cdk.rds.datasource.RosAccountsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.rds.datasource.RosAccountsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.datasource.RosAccounts}.
         */
        @Override
        public com.aliyun.ros.cdk.rds.datasource.RosAccounts build() {
            return new com.aliyun.ros.cdk.rds.datasource.RosAccounts(
                this.scope,
                this.id,
                this.props.build(),
