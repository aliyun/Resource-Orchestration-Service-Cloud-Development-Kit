...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RDS::Account</code>, which is used to create a database account for an ApsaraDB for RDS instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-03-01T09:16:54.088Z")
...
public class RosAccount extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.rds.RosAccount> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.rds.RosAccount}.
         */
        @Override
