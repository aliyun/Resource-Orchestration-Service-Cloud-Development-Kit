...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::DMS::User</code>, which is used to add a user to Data Management (DMS).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:09.164Z")
...
public class User extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.dms.UserProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.dms.UserProps value) {
