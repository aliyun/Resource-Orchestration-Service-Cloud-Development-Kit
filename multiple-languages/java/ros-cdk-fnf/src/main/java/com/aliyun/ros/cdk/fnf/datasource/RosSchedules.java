...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::FNF::Schedules</code>, which is used to query time-based schedules.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:26.025Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.fnf.$Module.class, fqn = "@alicloud/ros-cdk-fnf.datasource.RosSchedules")
public class RosSchedules extends com.aliyun.ros.cdk.core.RosResource {

    protected RosSchedules(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosSchedules(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.fnf.datasource.RosSchedules.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.fnf.datasource.RosSchedules}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.fnf.datasource.RosSchedules> {
        /**
        ...
        private final com.aliyun.ros.cdk.fnf.datasource.RosSchedulesProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.fnf.datasource.RosSchedulesProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.fnf.datasource.RosSchedules}.
         */
        @Override
        public com.aliyun.ros.cdk.fnf.datasource.RosSchedules build() {
            return new com.aliyun.ros.cdk.fnf.datasource.RosSchedules(
                this.scope,
                this.id,
                this.props.build(),
