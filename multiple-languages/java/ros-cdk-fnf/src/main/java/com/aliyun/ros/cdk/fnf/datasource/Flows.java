...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::FNF::Flows</code>, which is used to query multiple flows at a time.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:16.976Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.fnf.$Module.class, fqn = "@alicloud/ros-cdk-fnf.datasource.Flows")
public class Flows extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.fnf.datasource.IFlows {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrFlowNames() {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrFlows() {
        return software.amazon.jsii.Kernel.get(this, "attrFlows", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.fnf.datasource.FlowsProps getProps() {
