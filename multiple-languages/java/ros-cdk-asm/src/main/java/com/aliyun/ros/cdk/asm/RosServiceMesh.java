...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ASM::ServiceMesh</code>, which is used to create an Alibaba Cloud Service Mesh (ASM) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-08T09:17:07.724Z")
