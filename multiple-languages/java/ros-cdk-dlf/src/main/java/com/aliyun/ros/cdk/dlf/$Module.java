...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/dlf/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-dlf", "1.0.16", $Module.class, "ros-cdk-dlf@1.0.16.jsii.tgz");
    }
