...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RAM::AccessKey</code>, which is used to obtain the AccessKey pair (AccessKey ID and AccessKey secret) of a specified user and its status.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-06T03:35:16.833Z")
...
public class RosAccessKey extends com.aliyun.ros.cdk.core.RosResource {
    ...
    protected RosAccessKey(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosAccessKey(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.ram.RosAccessKey.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosAccessKey(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ram.RosAccessKeyProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.ram.RosAccessKey}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ram.RosAccessKey> {
        /**
        ...
        private final com.aliyun.ros.cdk.ram.RosAccessKeyProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.ram.RosAccessKeyProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ram.RosAccessKey}.
         */
        @Override
        public com.aliyun.ros.cdk.ram.RosAccessKey build() {
            return new com.aliyun.ros.cdk.ram.RosAccessKey(
                this.scope,
                this.id,
                this.props.build(),
