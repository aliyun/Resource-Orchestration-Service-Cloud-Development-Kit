 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T13:33:51.295Z")
...
public interface RoleProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RoleProps> {
        ...
        /**
         * Sets the value of {@link RoleProps#getTags}
         * @param tags Property tags: Tags to attach to role.
         *             Max support 20 tags to add during create role. Each tag with two properties Key and Value, and Key is required.
         * @return {@code this}
         */
