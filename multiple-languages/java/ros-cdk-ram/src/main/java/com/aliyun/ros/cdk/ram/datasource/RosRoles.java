...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::RAM::Roles</code>, which is used to query the information about Resource Access Management (RAM) roles.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:43.099Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ram.$Module.class, fqn = "@alicloud/ros-cdk-ram.datasource.RosRoles")
public class RosRoles extends com.aliyun.ros.cdk.core.RosResource {

    protected RosRoles(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosRoles(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.ram.datasource.RosRoles.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosRoles(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ram.datasource.RosRolesProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.ram.datasource.RosRoles}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ram.datasource.RosRoles> {
        /**
        ...
        private final com.aliyun.ros.cdk.ram.datasource.RosRolesProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.ram.datasource.RosRolesProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ram.datasource.RosRoles}.
         */
        @Override
        public com.aliyun.ros.cdk.ram.datasource.RosRoles build() {
            return new com.aliyun.ros.cdk.ram.datasource.RosRoles(
                this.scope,
                this.id,
                this.props.build(),
