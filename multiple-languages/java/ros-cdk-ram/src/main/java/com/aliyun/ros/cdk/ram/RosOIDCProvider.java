...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::RAM::OIDCProvider</code>, which is used to create an OpenID Connect (OIDC) identity provider (IdP).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:29.008Z")
