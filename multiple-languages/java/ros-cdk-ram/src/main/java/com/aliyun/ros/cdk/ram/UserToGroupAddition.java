...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::RAM::UserToGroupAddition</code>, which is used to add users to a RAM group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:43.048Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ram.$Module.class, fqn = "@alicloud/ros-cdk-ram.UserToGroupAddition")
public class UserToGroupAddition extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.ram.IUserToGroupAddition {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.ram.UserToGroupAdditionProps getProps() {
        return software.amazon.jsii.Kernel.get(this, "props", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.ram.UserToGroupAdditionProps.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ram.UserToGroupAddition> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ram.UserToGroupAddition}.
         */
        @Override
