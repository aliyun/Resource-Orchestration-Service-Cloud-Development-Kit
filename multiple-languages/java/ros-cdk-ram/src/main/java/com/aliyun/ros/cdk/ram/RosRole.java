 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:29.010Z")
...
public class RosRole extends com.aliyun.ros.cdk.core.RosResource {
        ...
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                    ...
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.ram.RosRole.PoliciesProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.ram.RosRole.PoliciesProperty; received ")
    ...
    /**
     */
    public @org.jetbrains.annotations.Nullable java.util.List<com.aliyun.ros.cdk.ram.RosRole.TagsProperty> getTags() {
        return java.util.Optional.ofNullable((java.util.List<com.aliyun.ros.cdk.ram.RosRole.TagsProperty>)(software.amazon.jsii.Kernel.get(this, "tags", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.ram.RosRole.TagsProperty.class))))).map(java.util.Collections::unmodifiableList).orElse(null);
    }

    /**
     */
    public void setTags(final @org.jetbrains.annotations.Nullable java.util.List<com.aliyun.ros.cdk.ram.RosRole.TagsProperty> value) {
    ...
    /**
     */
    @software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.ram.$Module.class, fqn = "@alicloud/ros-cdk-ram.RosRole.TagsProperty")
    ...
    public static interface TagsProperty extends software.amazon.jsii.JsiiSerializable {
        ...
        final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TagsProperty {
            ...
            public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
                ...
                final com.fasterxml.jackson.databind.node.ObjectNode struct = com.fasterxml.jackson.databind.node.JsonNodeFactory.instance.objectNode();
                struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-ram.RosRole.TagsProperty"));
                struct.set("data", data);
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.ram.RosRole> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.ram.RosRole}.
         */
        @Override
