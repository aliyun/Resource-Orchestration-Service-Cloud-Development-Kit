...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/ram/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-ram", "1.0.17", $Module.class, "ros-cdk-ram@1.0.17.jsii.tgz");
    }
