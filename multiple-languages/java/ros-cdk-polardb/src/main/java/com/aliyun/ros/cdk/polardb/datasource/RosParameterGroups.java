...
/**
 * A ROS template type:  <code>DATASOURCE::POLARDB::ParameterGroups</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.88.0 (build eaabd08)", date = "2023-09-01T09:26:38.840Z")
...
public class RosParameterGroups extends com.aliyun.ros.cdk.core.RosResource {
    ...
    /**
     * Create a new <code>DATASOURCE::POLARDB::ParameterGroups</code>.
     * <p>
