...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::POLARDB::AccountPrivilege</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:27.914Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.polardb.$Module.class, fqn = "@alicloud/ros-cdk-polardb.AccountPrivilege")
public class AccountPrivilege extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.polardb.IAccountPrivilege {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.polardb.AccountPrivilegeProps getProps() {
