...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::POLARDB::DBClusterAccessWhiteList</code>, which is used to modify the IP address whitelist that allows access to a PolarDB cluster.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:52.772Z")
