...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::POLARDB::DBClusterAccessWhiteList</code>, which is used to modify the IP address whitelist that allows access to a PolarDB cluster.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:28.669Z")
...
public class DBClusterAccessWhiteList extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.polardb.IDBClusterAccessWhiteList {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.polardb.DBClusterAccessWhiteListProps getProps() {
