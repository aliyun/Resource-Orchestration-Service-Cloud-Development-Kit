...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::POLARDB::AITask</code>DATASOURCE::POLARDB::DBNodeClasses is used to query the available resources of a PolarDB cluster.
 */
