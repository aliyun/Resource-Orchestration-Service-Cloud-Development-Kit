...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::POLARDB::DBNodeClasses</code>DATASOURCE::POLARDB::GlobalDatabaseNetworks is used to query all global database networks (GDNs) within the current Alibaba Cloud account.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2023-12-26T06:30:17.295Z")
