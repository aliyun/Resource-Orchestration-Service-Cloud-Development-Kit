...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ESA::CustomScenePolicy</code>The , which resource type is used to create scenario-specific policies.
 */
