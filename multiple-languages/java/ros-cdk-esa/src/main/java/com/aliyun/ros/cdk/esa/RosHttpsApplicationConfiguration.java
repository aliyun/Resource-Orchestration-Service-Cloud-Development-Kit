...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ESA::HttpsApplicationConfiguration</code>The , which resource is used to add an HTTPS application configuration for a website.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T11:49:07.793Z")
