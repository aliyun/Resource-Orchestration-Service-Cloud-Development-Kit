...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::ESA::CustomResponseCodeRule</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:26.172Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.esa.$Module.class, fqn = "@alicloud/ros-cdk-esa.RosCustomResponseCodeRule")
public class RosCustomResponseCodeRule extends com.aliyun.ros.cdk.core.RosResource {

    protected RosCustomResponseCodeRule(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosCustomResponseCodeRule(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosCustomResponseCodeRule(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.esa.RosCustomResponseCodeRuleProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrReturnCode() {
        return software.amazon.jsii.Kernel.get(this, "attrReturnCode", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getPageId() {
        return software.amazon.jsii.Kernel.get(this, "pageId", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setPageId(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "pageId", java.util.Objects.requireNonNull(value, "pageId is required"));
    }

    /**
     */
    public void setPageId(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "pageId", java.util.Objects.requireNonNull(value, "pageId is required"));
    }

    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getReturnCode() {
        return software.amazon.jsii.Kernel.get(this, "returnCode", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setReturnCode(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "returnCode", java.util.Objects.requireNonNull(value, "returnCode is required"));
    }

    /**
     */
    public void setReturnCode(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "returnCode", java.util.Objects.requireNonNull(value, "returnCode is required"));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule> {
        /**
        ...
        private final com.aliyun.ros.cdk.esa.RosCustomResponseCodeRuleProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.esa.RosCustomResponseCodeRuleProps.Builder();
        }

        /**
         * @return {@code this}
         * @param pageId This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param returnCode This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule}.
         */
        @Override
        public com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule build() {
            return new com.aliyun.ros.cdk.esa.RosCustomResponseCodeRule(
                this.scope,
                this.id,
                this.props.build(),
