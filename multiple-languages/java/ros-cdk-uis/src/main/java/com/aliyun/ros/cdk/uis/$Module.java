...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/uis/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-uis", "1.0.2", $Module.class, "ros-cdk-uis@1.0.2.jsii.tgz");
    }
