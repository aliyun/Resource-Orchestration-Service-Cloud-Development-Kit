 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-08-22T08:56:18.084Z")
...
public interface RosDomainProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RosDomainProps> {
        ...
        /**
         * Sets the value of {@link RosDomainProps#getOriginServers}
         * @param originServers the value to be set.
         * @return {@code this}
         */
