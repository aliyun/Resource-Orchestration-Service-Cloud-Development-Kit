...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::WAF::WafSwitch</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-02-21T03:23:22.555Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.waf.$Module.class, fqn = "@alicloud/ros-cdk-waf.WafSwitch")
public class WafSwitch extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.waf.IWafSwitch {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.waf.WafSwitchProps getProps() {
