...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/swas/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-swas", "1.0.19", $Module.class, "ros-cdk-swas@1.0.19.jsii.tgz");
    }
