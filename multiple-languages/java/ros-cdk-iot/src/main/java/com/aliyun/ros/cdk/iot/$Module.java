...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/iot/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-iot", "1.0.20", $Module.class, "ros-cdk-iot@1.0.20.jsii.tgz");
    }
