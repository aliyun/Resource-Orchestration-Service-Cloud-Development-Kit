...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/gws/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-gws", "1.0.11", $Module.class, "ros-cdk-gws@1.0.11.jsii.tgz");
    }
