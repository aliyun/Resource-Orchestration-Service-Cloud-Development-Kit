...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::NLB::LoadBalancer</code>The , which type is used to query the basic information of single Network Load Balancer (NLB) instance.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:28.109Z")
