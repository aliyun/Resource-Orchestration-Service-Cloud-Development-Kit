...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::NLB::SecurityGroupAttachment</code>DATASOURCE::NLB::LoadBalancers is used to query the basic information about created Network Load Balancer (NLB) instances.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2023-12-26T06:30:17.017Z")
