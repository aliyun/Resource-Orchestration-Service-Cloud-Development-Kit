...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::VPC::Ipv4Gateway</code>, which is used to create an IPv4 gateway.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:43.079Z")
...
public class RosIpv4Gateway extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.RosIpv4Gateway> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.vpc.RosIpv4Gateway}.
         */
        @Override
