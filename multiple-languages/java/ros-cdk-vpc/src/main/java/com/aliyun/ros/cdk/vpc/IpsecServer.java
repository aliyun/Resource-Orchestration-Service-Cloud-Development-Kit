...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::IpsecServer</code>, which is used to create an IPsec-VPN server.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-04-07T05:57:30.918Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.IpsecServer")
public class IpsecServer extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.IIpsecServer {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrIpsecServerId() {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrIpsecServerName() {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.IpsecServerProps getProps() {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.IpsecServer> {
         ...
         * <p>
         * @return {@code this}
         * @param ipsecServerName Property ipsecServerName: The value must be 1 to 100 characters in length and start with a letter or Chinese character. This parameter is required.
         */
