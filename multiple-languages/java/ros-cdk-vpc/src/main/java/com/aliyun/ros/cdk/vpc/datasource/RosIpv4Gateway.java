...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::VPC::Ipv4Gateway</code>, which is used to query the information about an IPv4 gateway.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-06T03:35:18.111Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.datasource.RosIpv4Gateway")
public class RosIpv4Gateway extends com.aliyun.ros.cdk.core.RosResource {
    ...
    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getIpv4GatewayId() {
    ...
    /**
     */
    public void setIpv4GatewayId(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "ipv4GatewayId", java.util.Objects.requireNonNull(value, "ipv4GatewayId is required"));
    }

    /**
     */
    public void setIpv4GatewayId(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "ipv4GatewayId", java.util.Objects.requireNonNull(value, "ipv4GatewayId is required"));
    }

    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway> {
        /**
        ...
        private final com.aliyun.ros.cdk.vpc.datasource.RosIpv4GatewayProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.vpc.datasource.RosIpv4GatewayProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway}.
         */
        @Override
        public com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway build() {
            return new com.aliyun.ros.cdk.vpc.datasource.RosIpv4Gateway(
                this.scope,
                this.id,
                this.props.build(),
