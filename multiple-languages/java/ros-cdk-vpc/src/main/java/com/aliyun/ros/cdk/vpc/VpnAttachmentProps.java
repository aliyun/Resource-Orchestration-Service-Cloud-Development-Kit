 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T14:04:31.741Z")
...
public interface VpnAttachmentProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<VpnAttachmentProps> {
        ...
        /**
         * Sets the value of {@link VpnAttachmentProps#getEnableTunnelsBgp}
         * @param enableTunnelsBgp Property enableTunnelsBgp: Support configuring this parameter when creating dual-tunnel mode IPsec-VPN connections.
         *                         Whether to enable BGP function for the tunnel. Values: <strong>true</strong> or <strong>false</strong> (default value).
         *                         <p>
         *                         <blockquote>
         *                         <p>
        ...
        /**
         * Sets the value of {@link VpnAttachmentProps#getResourceGroupId}
         * @param resourceGroupId Property resourceGroupId: The resource group ID to which the IPsec connection belongs.
         *                        <ul>
         *                        <li>You can call the ListResourceGroups interface to query the resource group ID.</li>
         *                        <li>If you do not specify a resource group ID, the IPsec connection will belong to the default resource group after creation.</li>
         *                        </ul>
        ...
        /**
         * Sets the value of {@link VpnAttachmentProps#getTunnelBandwidth}
         * @param tunnelBandwidth Property tunnelBandwidth: Used to indicate the bandwidth specification of a single VPN tunnel, values: Standard (default value): Standard type, default bandwidth 1Gbps Large: Large type, default bandwidth 3Gbps.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link VpnAttachmentProps#getTunnelOptionsSpecification}
         * @param tunnelOptionsSpecification Property tunnelOptionsSpecification: Configuration of tunnels.
         *                                   <ul>
         *                                   <li>When creating dual-tunnel mode IPsec-VPN connections, you can configure parameters under <strong>TunnelOptionsSpecification</strong> array.</li>
         *                                   <li>When creating dual-tunnel mode IPsec-VPN connections, you must add two tunnels for the IPsec-VPN connection simultaneously to ensure the IPsec-VPN connection has link redundancy capability. Only two tunnels are supported under an IPsec-VPN connection.</li>
         *                                   </ul>
