...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::Eipanycast::AnycastEipAddress</code>, which is used to query the information about an Anycast elastic IP address (Anycast EIP).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:45.482Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.datasource.RosAnycastEipAddress")
public class RosAnycastEipAddress extends com.aliyun.ros.cdk.core.RosResource {

    protected RosAnycastEipAddress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosAnycastEipAddress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosAnycastEipAddress(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddressProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress> {
        /**
        ...
        private final com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddressProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddressProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress}.
         */
        @Override
        public com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress build() {
            return new com.aliyun.ros.cdk.vpc.datasource.RosAnycastEipAddress(
                this.scope,
                this.id,
                this.props.build(),
