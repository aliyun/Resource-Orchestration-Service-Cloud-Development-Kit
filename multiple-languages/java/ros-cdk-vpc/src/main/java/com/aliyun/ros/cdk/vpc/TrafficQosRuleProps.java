...
/**
 * Properties for defining a <code>TrafficQosRule</code>.
 * <p>
 * See https://www.alibabacloud.com/help/ros/developer-reference/aliyun-vpc-trafficqosrule
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:55.316Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.TrafficQosRuleProps")
@software.amazon.jsii.Jsii.Proxy(TrafficQosRuleProps.Jsii$Proxy.class)
public interface TrafficQosRuleProps extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link TrafficQosRuleProps}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link TrafficQosRuleProps}
     */
    public static final class Builder implements software.amazon.jsii.Builder<TrafficQosRuleProps> {
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getPriority}
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getProtocol}
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getQosId}
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getQueueId}
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getDstCidr}
         * @param dstCidr Property dstCidr: The destination IPv4 CIDR block that matches the QoS rule traffic.
         *                <blockquote>
         *                <p>
         *                If this parameter is not supported, enter <strong>SrcIPv6Cidr</strong> or **DstIPv6Cidr * *.
         *                <p>
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getDstIpv6Cidr}
         * @param dstIpv6Cidr Property dstIpv6Cidr: The QoS rule traffic matches the Destination IPv6 network segment.
         *                    <blockquote>
         *                    <p>
         *                    If this parameter is not supported, enter <strong>SrcCidr</strong> or **DstCidr * *.
         *                    <p>
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getDstPortRange}
         * @param dstPortRange Property dstPortRange: QoS rule traffic matches the destination port number range.
         *                     Value range: <strong>0</strong> to <strong>65535</strong>. If not, the value is -1. Currently, only a single port number is supported, and the start and end of the port number must be the same. The corresponding destination port number range is fixed for different protocol types. The values are as follows:
         *                     <p>
         *                     <ul>
         *                     <li><strong>ALL</strong>:-1/-1, not editable.</li>
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getMatchDscp}
         * @param matchDscp Property matchDscp: The DSCP value that matches the QoS rule traffic.
         *                  Valid values: 0 to 63. If no value is matched, the value is -1.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getRemarkingDscp}
         * @param remarkingDscp Property remarkingDscp: The new DSCP value.
         *                      Valid values: 0 to 63. If you do not change the value, set the value to -1.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getRuleDescription}
         * @param ruleDescription Property ruleDescription: The description of the QoS rule.
         *                        The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getRuleName}
         * @param ruleName Property ruleName: The name of the QoS rule.
         *                 The length is 0 to 128 characters and cannot start with 'http:// 'or 'https.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getSrcCidr}
         * @param srcCidr Property srcCidr: The source IPv4 CIDR block that matches the QoS rule traffic.
         *                <blockquote>
         *                <p>
         *                If this parameter is not supported, enter <strong>SrcIPv6Cidr</strong> or **DstIPv6Cidr * *.
         *                <p>
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getSrcIpv6Cidr}
         * @param srcIpv6Cidr Property srcIpv6Cidr: The QoS rule traffic matches the source IPv6 network segment.
         *                    <blockquote>
         *                    <p>
         *                    If this parameter is not supported, enter <strong>SrcCidr</strong> or **DstCidr * *.
         *                    <p>
        ...
        /**
         * Sets the value of {@link TrafficQosRuleProps#getSrcPortRange}
         * @param srcPortRange Property srcPortRange: The source port number of the QoS rule traffic matching.
         *                     The value range is <strong>0</strong> to <strong>65535</strong>. If the traffic does not match, the value is -1. Currently, only a single port number is supported, and the start and end of the port number must be the same.
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link TrafficQosRuleProps}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public TrafficQosRuleProps build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link TrafficQosRuleProps}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TrafficQosRuleProps {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-vpc.TrafficQosRuleProps"));
        ...
        public final boolean equals(final Object o) {
            ...
            TrafficQosRuleProps.Jsii$Proxy that = (TrafficQosRuleProps.Jsii$Proxy) o;
