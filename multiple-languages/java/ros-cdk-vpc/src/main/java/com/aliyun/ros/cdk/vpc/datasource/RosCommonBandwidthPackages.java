...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::VPC::CommonBandwidthPackages</code>, which is used to query the Internet Shared Bandwidth instances in a region.
 */
