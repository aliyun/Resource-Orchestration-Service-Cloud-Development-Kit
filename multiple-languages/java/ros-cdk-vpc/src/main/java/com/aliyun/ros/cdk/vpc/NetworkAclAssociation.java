...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::NetworkAclAssociation</code>, which is used to associate a network access control list (ACL) with a vSwitch.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-10-18T08:56:33.997Z")
...
public class NetworkAclAssociation extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.NetworkAclAssociationProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.NetworkAclAssociationProps value) {
