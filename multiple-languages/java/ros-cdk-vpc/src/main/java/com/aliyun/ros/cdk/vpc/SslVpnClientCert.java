...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::SslVpnClientCert</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:30.667Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.SslVpnClientCert")
public class SslVpnClientCert extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.ISslVpnClientCert {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.SslVpnClientCertProps getProps() {
