...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::Ipv4Gateway</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-12-10T08:25:00.990Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.Ipv4Gateway")
public class Ipv4Gateway extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.IIpv4Gateway {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.Ipv4GatewayProps getProps() {
