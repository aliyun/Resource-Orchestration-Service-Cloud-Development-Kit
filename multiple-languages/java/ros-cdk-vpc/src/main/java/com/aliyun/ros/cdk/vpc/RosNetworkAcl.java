...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::VPC::NetworkAcl</code>, which is used to create a network access control list (ACL).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-04-09T06:05:35.683Z")
...
public class RosNetworkAcl extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.RosNetworkAcl> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.vpc.RosNetworkAcl}.
         */
        @Override
