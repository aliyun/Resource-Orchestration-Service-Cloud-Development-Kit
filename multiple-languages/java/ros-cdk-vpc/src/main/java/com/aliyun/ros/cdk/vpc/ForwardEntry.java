...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::ForwardEntry</code>, which is used to add a DNAT entry to a DNAT table.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:44.918Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.ForwardEntry")
public class ForwardEntry extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.IForwardEntry {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.ForwardEntryProps getProps() {
