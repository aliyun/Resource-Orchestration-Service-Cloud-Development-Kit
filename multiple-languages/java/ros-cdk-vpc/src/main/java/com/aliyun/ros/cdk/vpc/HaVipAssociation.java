...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::HaVipAssociation</code>, which is used to associate high-availability virtual IP addresses (HAVIPs) with an Elastic Compute Service (ECS) instance or an elastic network interface (ENI).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:44.928Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.HaVipAssociation")
public class HaVipAssociation extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.IHaVipAssociation {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.HaVipAssociationProps getProps() {
