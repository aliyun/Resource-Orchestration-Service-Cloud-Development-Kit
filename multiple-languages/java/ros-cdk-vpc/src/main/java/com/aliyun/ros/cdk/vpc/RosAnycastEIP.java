...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::VPC::AnycastEIP</code>, which is used to create an Anycast elastic IP address (Anycast EIP).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:43.021Z")
