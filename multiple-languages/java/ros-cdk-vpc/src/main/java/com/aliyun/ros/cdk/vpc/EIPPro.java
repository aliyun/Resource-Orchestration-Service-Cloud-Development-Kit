...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::EIPPro</code>.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:11.198Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.EIPPro")
public class EIPPro extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vpc.IEIPPro {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.EIPProProps getProps() {
