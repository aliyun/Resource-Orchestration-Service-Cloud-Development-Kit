...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::VPC::IpamScope</code>, which is used to create an IP Address Manager (IPAM) scope.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-06-09T14:04:31.566Z")
