...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VPC::SnatEntry</code>, which is used to add SNAT entries to an SNAT table.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:58.043Z")
...
public class SnatEntry extends com.aliyun.ros.cdk.core.Resource {
    ...
    protected @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.SnatEntryProps getProps() {
    ...
    protected void setProps(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.SnatEntryProps value) {
