...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::VPC::RouteTableWithGatewayAssociation</code>, which is used to associate a gateway route table with an IPv4 or IPv6 gateway in the same virtual private cloud (VPC).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:55.160Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vpc.$Module.class, fqn = "@alicloud/ros-cdk-vpc.RosRouteTableWithGatewayAssociation")
public class RosRouteTableWithGatewayAssociation extends com.aliyun.ros.cdk.core.RosResource {

    protected RosRouteTableWithGatewayAssociation(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosRouteTableWithGatewayAssociation(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosRouteTableWithGatewayAssociation(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociationProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getGatewayType() {
    ...
    /**
     */
    public void setGatewayType(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "gatewayType", java.util.Objects.requireNonNull(value, "gatewayType is required"));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation> {
        /**
        ...
        private final com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociationProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociationProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation}.
         */
        @Override
        public com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation build() {
            return new com.aliyun.ros.cdk.vpc.RosRouteTableWithGatewayAssociation(
                this.scope,
                this.id,
                this.props.build(),
