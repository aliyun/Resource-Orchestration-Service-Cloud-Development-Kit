...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::FOAS::Cluster</code>, which is used to create a cluster for an order in exclusive mode.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:10.153Z")
...
public class RosCluster extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.foas.RosCluster> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.foas.RosCluster}.
         */
        @Override
