...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/appflow/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-appflow", "1.11.0", $Module.class, "ros-cdk-appflow@1.11.0.jsii.tgz");
    }
