...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::PolarDBX::Database</code>, which is used to query the information about a PolarDB for Xscale (PolarDB-X) database.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:52.867Z")
