...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/polardbx/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-polardbx", "1.0.20", $Module.class, "ros-cdk-polardbx@1.0.20.jsii.tgz");
    }
