...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/cxapi/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-cxapi", "1.0.21", $Module.class, "ros-cdk-cxapi@1.0.21.jsii.tgz");
    }

    @Override
    public List<Class<? extends JsiiModule>> getDependencies() {
        return asList(com.aliyun.ros.cdk.assembly.schema.$Module.class);
    }
