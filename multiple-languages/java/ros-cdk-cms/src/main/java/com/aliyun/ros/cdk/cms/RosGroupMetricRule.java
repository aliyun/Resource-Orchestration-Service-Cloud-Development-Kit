...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CMS::GroupMetricRule</code>, which is used to create an alert rule for an application group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:53.281Z")
...
public class RosGroupMetricRule extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cms.RosGroupMetricRule> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cms.RosGroupMetricRule}.
         */
        @Override
