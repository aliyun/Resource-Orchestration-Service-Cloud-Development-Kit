...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::CMS::SiteMonitor</code>, which is used to create a site monitoring task.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-12-13T06:45:05.744Z")
...
public class RosSiteMonitor extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public void setIspCities(final @org.jetbrains.annotations.Nullable java.util.List<java.lang.Object> value) {
        if (software.amazon.jsii.Configuration.getRuntimeTypeChecking()) {
            for (int __idx_ac66f0 = 0; __idx_ac66f0 < value.size(); __idx_ac66f0++) {
                ...
                if (
                     !(__val_ac66f0 instanceof com.aliyun.ros.cdk.core.IResolvable)
                    && !(__val_ac66f0 instanceof com.aliyun.ros.cdk.cms.RosSiteMonitor.IspCitiesProperty)
                    && !(__val_ac66f0.getClass().equals(software.amazon.jsii.JsiiObject.class))
                ) {
                    throw new IllegalArgumentException(
                        new java.lang.StringBuilder("Expected ")
                            .append("value").append(".get(").append(__idx_ac66f0).append(")")
                            .append(" to be one of: com.aliyun.ros.cdk.core.IResolvable, com.aliyun.ros.cdk.cms.RosSiteMonitor.IspCitiesProperty; received ")
                            .append(__val_ac66f0.getClass()).toString());
                }
            }
        }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.cms.RosSiteMonitor> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.cms.RosSiteMonitor}.
         */
        @Override
