...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/cms/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-cms", "1.0.27", $Module.class, "ros-cdk-cms@1.0.27.jsii.tgz");
    }
