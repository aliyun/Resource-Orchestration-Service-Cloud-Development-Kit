...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::SAE::SlbBinding</code>, which is used to bind an SLB instance to an application.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-29T07:52:42.426Z")
...
public class RosSlbBinding extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.sae.RosSlbBinding> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.sae.RosSlbBinding}.
         */
        @Override
