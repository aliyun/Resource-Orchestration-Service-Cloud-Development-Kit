...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VS::Group</code>, which is used to create a group.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:45.573Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.vs.$Module.class, fqn = "@alicloud/ros-cdk-vs.Group")
public class Group extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.vs.IGroup {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.vs.GroupProps getProps() {
