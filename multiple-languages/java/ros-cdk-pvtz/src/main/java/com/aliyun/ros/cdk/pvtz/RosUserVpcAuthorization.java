...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::PVTZ::UserVpcAuthorization</code>, which is used to associate virtual private clouds (VPCs) across accounts.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-09-12T02:20:29.525Z")
...
public class RosUserVpcAuthorization extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.pvtz.RosUserVpcAuthorization> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.pvtz.RosUserVpcAuthorization}.
         */
        @Override
