...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::PVTZ::Rule</code>, which is used to query the information about a forwarding rule.
 */
