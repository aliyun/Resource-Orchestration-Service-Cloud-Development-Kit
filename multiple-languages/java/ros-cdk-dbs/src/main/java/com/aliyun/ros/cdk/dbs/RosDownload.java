...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::DBS::Download</code>DATASOURCE::DBS::BackupPlans is used to query the information about backup schedules.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-02-28T02:53:27.786Z")
