...
/**
 * This class encapsulates and extends the ROS resource type <code>DATASOURCE::MNS::Queues</code>, which is used to query all queues within an Alibaba Cloud account.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:41.300Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.mns.$Module.class, fqn = "@alicloud/ros-cdk-mns.datasource.Queues")
public class Queues extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.mns.datasource.IQueues {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrQueueNames() {
     ...
     */
    @Override
    public @org.jetbrains.annotations.NotNull java.lang.Object getAttrQueues() {
        return software.amazon.jsii.Kernel.get(this, "attrQueues", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.mns.datasource.QueuesProps getProps() {
