...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::MNS::Subscription</code>, which is used to describe a subscription relationship, including the subscribed topic and the endpoint that the subscriber uses to receive messages.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:26.927Z")
...
public class Subscription extends com.aliyun.ros.cdk.core.Resource implements com.aliyun.ros.cdk.mns.ISubscription {
    ...
    @Override
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.mns.SubscriptionProps getProps() {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.mns.Subscription> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.mns.Subscription}.
         */
        @Override
