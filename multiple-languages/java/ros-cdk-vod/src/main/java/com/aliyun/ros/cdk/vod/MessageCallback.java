...
/**
 * This class encapsulates and extends the ROS resource type <code>ALIYUN::VOD::MessageCallback</code>, which is used to configure the callback method, callback URL, and event types for event notifications.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:54.802Z")
