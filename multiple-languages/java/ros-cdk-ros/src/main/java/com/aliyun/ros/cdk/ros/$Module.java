...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/ros/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-ros", "1.10.0", $Module.class, "ros-cdk-ros@1.10.0.jsii.tgz");
    }
