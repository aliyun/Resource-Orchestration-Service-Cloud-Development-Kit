...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::PAI::WorkspaceResourceFlinks</code>, which is used to query the Realtime Compute for Apache Flink resources that are associated with a workspace.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-01-23T09:30:42.107Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.pai.$Module.class, fqn = "@alicloud/ros-cdk-pai.datasource.RosWorkspaceResourceFlinks")
public class RosWorkspaceResourceFlinks extends com.aliyun.ros.cdk.core.RosResource {

    protected RosWorkspaceResourceFlinks(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosWorkspaceResourceFlinks(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosWorkspaceResourceFlinks(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinksProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks> {
        /**
        ...
        private final com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinksProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinksProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks}.
         */
        @Override
        public com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks build() {
            return new com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceFlinks(
                this.scope,
                this.id,
                this.props.build(),
