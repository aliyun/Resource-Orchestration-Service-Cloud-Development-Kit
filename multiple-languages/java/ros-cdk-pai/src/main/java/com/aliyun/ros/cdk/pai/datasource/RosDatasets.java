...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::PAI::Datasets</code>, which is used to query the basic information about datasets.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-04T02:47:56.547Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.pai.$Module.class, fqn = "@alicloud/ros-cdk-pai.datasource.RosDatasets")
public class RosDatasets extends com.aliyun.ros.cdk.core.RosResource {

    protected RosDatasets(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosDatasets(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.pai.datasource.RosDatasets.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosDatasets(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.pai.datasource.RosDatasetsProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.pai.datasource.RosDatasets}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.pai.datasource.RosDatasets> {
        /**
        ...
        private final com.aliyun.ros.cdk.pai.datasource.RosDatasetsProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.pai.datasource.RosDatasetsProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.pai.datasource.RosDatasets}.
         */
        @Override
        public com.aliyun.ros.cdk.pai.datasource.RosDatasets build() {
            return new com.aliyun.ros.cdk.pai.datasource.RosDatasets(
                this.scope,
                this.id,
                this.props.build(),
