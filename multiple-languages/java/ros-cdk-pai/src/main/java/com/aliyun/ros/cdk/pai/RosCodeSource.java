...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::PAI::CodeSource</code>, which is used to create a code build in Platform for AI (PAI).
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:52.413Z")
