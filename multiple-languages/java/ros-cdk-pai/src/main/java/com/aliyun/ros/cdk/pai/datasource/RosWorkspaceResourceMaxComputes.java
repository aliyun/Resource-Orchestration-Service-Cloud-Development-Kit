...
/**
 * This class is a base encapsulation around the ROS resource type <code>DATASOURCE::PAI::WorkspaceResourceMaxComputes</code>, which is used to query the MaxCompute resources that are associated with a workspace.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-03-06T05:59:08.746Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.pai.$Module.class, fqn = "@alicloud/ros-cdk-pai.datasource.RosWorkspaceResourceMaxComputes")
public class RosWorkspaceResourceMaxComputes extends com.aliyun.ros.cdk.core.RosResource {

    protected RosWorkspaceResourceMaxComputes(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosWorkspaceResourceMaxComputes(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosWorkspaceResourceMaxComputes(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputesProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrWorkspaceResourceMaxComputes() {
        return software.amazon.jsii.Kernel.get(this, "attrWorkspaceResourceMaxComputes", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes> {
        /**
        ...
        private final com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputesProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputesProps.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes}.
         */
        @Override
        public com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes build() {
            return new com.aliyun.ros.cdk.pai.datasource.RosWorkspaceResourceMaxComputes(
                this.scope,
                this.id,
                this.props.build(),
