...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::PAI::Run</code>, which is used to create a run.
 * <p>
 * A run belongs to an experiment and can be associated with a workload. A run can also represent a single code execution.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2026-05-07T04:16:52.432Z")
@software.amazon.jsii.Jsii(module = com.aliyun.ros.cdk.pai.$Module.class, fqn = "@alicloud/ros-cdk-pai.RosRun")
public class RosRun extends com.aliyun.ros.cdk.core.RosResource {

    protected RosRun(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RosRun(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        ROS_RESOURCE_TYPE_NAME = software.amazon.jsii.JsiiObject.jsiiStaticGet(com.aliyun.ros.cdk.pai.RosRun.class, "ROS_RESOURCE_TYPE_NAME", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public RosRun(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.pai.RosRunProps props, final @org.jetbrains.annotations.NotNull java.lang.Boolean enableResourcePropertyConstraint) {
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrParams() {
        return software.amazon.jsii.Kernel.get(this, "attrParams", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }

    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrRunId() {
        return software.amazon.jsii.Kernel.get(this, "attrRunId", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }

    /**
     */
    public @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable getAttrRunName() {
        return software.amazon.jsii.Kernel.get(this, "attrRunName", software.amazon.jsii.NativeType.forClass(com.aliyun.ros.cdk.core.IResolvable.class));
    }
    ...
    /**
     */
    public @org.jetbrains.annotations.NotNull java.lang.Object getExperimentId() {
        return software.amazon.jsii.Kernel.get(this, "experimentId", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setExperimentId(final @org.jetbrains.annotations.NotNull java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "experimentId", java.util.Objects.requireNonNull(value, "experimentId is required"));
    }

    /**
     */
    public void setExperimentId(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "experimentId", java.util.Objects.requireNonNull(value, "experimentId is required"));
    }

    /**
     */
    public @org.jetbrains.annotations.Nullable java.lang.Object getRunName() {
        return software.amazon.jsii.Kernel.get(this, "runName", software.amazon.jsii.NativeType.forClass(java.lang.Object.class));
    }

    /**
     */
    public void setRunName(final @org.jetbrains.annotations.Nullable java.lang.String value) {
        software.amazon.jsii.Kernel.set(this, "runName", value);
    }

    /**
     */
    public void setRunName(final @org.jetbrains.annotations.Nullable com.aliyun.ros.cdk.core.IResolvable value) {
        software.amazon.jsii.Kernel.set(this, "runName", value);
    }
    ...
    /**
     * A fluent builder for {@link com.aliyun.ros.cdk.pai.RosRun}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.pai.RosRun> {
        /**
        ...
        private final com.aliyun.ros.cdk.pai.RosRunProps.Builder props;

        private Builder(final com.aliyun.ros.cdk.core.Construct scope, final java.lang.String id, final java.lang.Boolean enableResourcePropertyConstraint) {
            this.scope = scope;
            this.id = id;
            this.enableResourcePropertyConstraint = enableResourcePropertyConstraint;
            this.props = new com.aliyun.ros.cdk.pai.RosRunProps.Builder();
        }

        /**
         * @return {@code this}
         * @param experimentId This parameter is required.
         */
        ...
        /**
         * @return {@code this}
         * @param runName This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.pai.RosRun}.
         */
        @Override
        public com.aliyun.ros.cdk.pai.RosRun build() {
            return new com.aliyun.ros.cdk.pai.RosRun(
                this.scope,
                this.id,
                this.props.build(),
