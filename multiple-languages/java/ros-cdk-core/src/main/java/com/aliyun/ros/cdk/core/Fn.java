 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.17.1 (build 2bac5fd)", date = "2021-01-26T09:47:32.104Z")
...
public class Fn extends software.amazon.jsii.JsiiObject {
    ...
    public static @org.jetbrains.annotations.NotNull java.lang.String add(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Object> values) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "add", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(values, "values is required") });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String avg(final @org.jetbrains.annotations.NotNull java.lang.Number ndigits, final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Object> values) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "avg", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(ndigits, "ndigits is required"), java.util.Objects.requireNonNull(values, "values is required") });
    }
    ...
    public static @org.jetbrains.annotations.NotNull java.lang.String calculate(final @org.jetbrains.annotations.NotNull java.lang.String values, final @org.jetbrains.annotations.NotNull java.lang.Number ndigits, final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Number> para) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "calculate", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(values, "values is required"), java.util.Objects.requireNonNull(ndigits, "ndigits is required"), java.util.Objects.requireNonNull(para, "para is required") });
    }
     ...
     */
    public static @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IRosConditionExpression conditionAnd(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IRosConditionExpression... conditions) {
     ...
     */
    public static @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IRosConditionExpression conditionOr(final @org.jetbrains.annotations.NotNull com.aliyun.ros.cdk.core.IRosConditionExpression... conditions) {
    ...
    public static @org.jetbrains.annotations.NotNull java.util.List<java.lang.String> getAzs() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "getAzs", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(java.lang.String.class))));
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String getJsonValue(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Object> value) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "getJsonValue", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(value, "value is required") });
    }
     ...
     * @param stackRegion
     */
    public static @org.jetbrains.annotations.NotNull java.lang.String getStackOutput(final @org.jetbrains.annotations.NotNull java.lang.String stackID, final @org.jetbrains.annotations.NotNull java.lang.String outputKey, final @org.jetbrains.annotations.Nullable java.lang.String stackRegion) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "getStackOutput", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(stackID, "stackID is required"), java.util.Objects.requireNonNull(outputKey, "outputKey is required"), stackRegion });
    }
     ...
     * @param outputKey This parameter is required.
     */
    public static @org.jetbrains.annotations.NotNull java.lang.String getStackOutput(final @org.jetbrains.annotations.NotNull java.lang.String stackID, final @org.jetbrains.annotations.NotNull java.lang.String outputKey) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "getStackOutput", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(stackID, "stackID is required"), java.util.Objects.requireNonNull(outputKey, "outputKey is required") });
    }
    ...
    public static @org.jetbrains.annotations.NotNull java.lang.String jq(final @org.jetbrains.annotations.NotNull java.lang.String method, final @org.jetbrains.annotations.NotNull java.lang.String script, final @org.jetbrains.annotations.NotNull java.lang.Object inputString) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "jq", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(method, "method is required"), java.util.Objects.requireNonNull(script, "script is required"), inputString });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String listMerge(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.util.List<java.lang.String>> valueList) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "listMerge", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(valueList, "valueList is required") });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String max(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Number> values) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "max", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(values, "values is required") });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String mergeMapToList(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Object> mapList) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "mergeMapToList", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(mapList, "mapList is required") });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String min(final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Number> values) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "min", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(values, "values is required") });
    }
     ...
     */
    public static @org.jetbrains.annotations.NotNull java.lang.String select(final @org.jetbrains.annotations.NotNull java.lang.Object index, final @org.jetbrains.annotations.NotNull java.lang.Object array) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "select", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required"), array });
    }

    public static @org.jetbrains.annotations.NotNull java.lang.String selectMapList(final @org.jetbrains.annotations.NotNull java.lang.String key, final @org.jetbrains.annotations.NotNull java.util.List<? extends java.lang.Object> mapList) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(com.aliyun.ros.cdk.core.Fn.class, "selectMapList", software.amazon.jsii.NativeType.forClass(java.lang.String.class), new Object[] { java.util.Objects.requireNonNull(key, "key is required"), java.util.Objects.requireNonNull(mapList, "mapList is required") });
    }
