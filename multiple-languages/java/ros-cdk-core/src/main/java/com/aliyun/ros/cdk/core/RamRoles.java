...
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2024-06-21T05:59:07.085Z")
...
public interface RamRoles extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<RamRoles> {
         ...
         * @return {@code this}
         */
        public Builder fcRole(com.aliyun.ros.cdk.core.IResolvable fcRole) {
            this.fcRole = fcRole;
            return this;
        }
         ...
         * @return a new instance of {@link RamRoles}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RamRoles build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RamRoles}
     */
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RamRoles {
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.fcRole = java.util.Objects.requireNonNull(builder.fcRole, "fcRole is required");
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            data.set("fcRole", om.valueToTree(this.getFcRole()));

            final com.fasterxml.jackson.databind.node.ObjectNode struct = com.fasterxml.jackson.databind.node.JsonNodeFactory.instance.objectNode();
            struct.set("fqn", om.valueToTree("@alicloud/ros-cdk-core.RamRoles"));
        ...
        public final boolean equals(final Object o) {
            ...
            RamRoles.Jsii$Proxy that = (RamRoles.Jsii$Proxy) o;

            return this.fcRole.equals(that.fcRole);
        }

        @Override
        public final int hashCode() {
            int result = this.fcRole.hashCode();
            return result;
        }
    }
}
