...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/aliyun/ros/cdk/core/$Module.txt");
    ...
    public $Module() {
        super("@alicloud/ros-cdk-core", "1.11.0", $Module.class, "ros-cdk-core@1.11.0.jsii.tgz");
    }

    @Override
    public List<Class<? extends JsiiModule>> getDependencies() {
        return asList(com.aliyun.ros.cdk.assembly.schema.$Module.class, com.aliyun.ros.cdk.cxapi.$Module.class, software.constructs.$Module.class);
    }
