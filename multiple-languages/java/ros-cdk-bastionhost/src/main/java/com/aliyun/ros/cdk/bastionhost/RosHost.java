...
/**
 * This class is a base encapsulation around the ROS resource type <code>ALIYUN::BastionHost::Host</code>, which is used to create a host for O&amp;M in a bastion host.
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.85.0 (build 08ee592)", date = "2025-09-28T10:11:21.615Z")
...
public class RosHost extends com.aliyun.ros.cdk.core.RosResource {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<com.aliyun.ros.cdk.bastionhost.RosHost> {
        ...
        /**
         * @return a newly built instance of {@link com.aliyun.ros.cdk.bastionhost.RosHost}.
         */
        @Override
