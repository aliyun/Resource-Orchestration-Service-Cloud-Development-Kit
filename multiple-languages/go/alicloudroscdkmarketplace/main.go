...
func init() {
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-marketplace.IOrder",
	...
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-marketplace.Order",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-marketplace.OrderProps",
		reflect.TypeOf((*OrderProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-marketplace.RosOrder",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "skuCode", GoGetter: "SkuCode"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberMethod{JsiiMethod: "synthesize", GoMethod: "Synthesize"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-marketplace.RosOrderProps",
