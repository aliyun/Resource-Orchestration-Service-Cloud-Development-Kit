...
type RosAntiBruteForceRule interface {
	...
	SetAntiBruteForceRuleId(val interface{})
...
func (j *jsiiProxy_RosAntiBruteForceRule) AntiBruteForceRuleId() interface{} {
...
func (j *jsiiProxy_RosAntiBruteForceRule) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func (j *jsiiProxy_RosAntiBruteForceRule)SetAntiBruteForceRuleId(val interface{}) {
	if err := j.validateSetAntiBruteForceRuleIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosAntiBruteForceRule)SetRefreshOptions(val interface{}) {
...
func (r *jsiiProxy_RosAntiBruteForceRule) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosAntiBruteForceRule) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosAntiBruteForceRule) FetchRosDependency() *[]*string {
	var returns *[]*string
