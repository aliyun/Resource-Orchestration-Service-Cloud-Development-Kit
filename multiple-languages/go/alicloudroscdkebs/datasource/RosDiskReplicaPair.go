...
func (j *jsiiProxy_RosDiskReplicaPair) RefreshOptions() interface{} {
...
func (j *jsiiProxy_RosDiskReplicaPair) ReplicaPairId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"replicaPairId",
...
func (j *jsiiProxy_RosDiskReplicaPair)SetRefreshOptions(val interface{}) {
...
func (j *jsiiProxy_RosDiskReplicaPair)SetReplicaPairId(val interface{}) {
...
func (r *jsiiProxy_RosDiskReplicaPair) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDiskReplicaPair) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDiskReplicaPair) FetchRosDependency() *[]*string {
	var returns *[]*string
