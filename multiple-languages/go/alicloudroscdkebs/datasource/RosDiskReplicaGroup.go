...
func (j *jsiiProxy_RosDiskReplicaGroup) RefreshOptions() interface{} {
...
func (j *jsiiProxy_RosDiskReplicaGroup) ReplicaGroupId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"replicaGroupId",
...
func (j *jsiiProxy_RosDiskReplicaGroup)SetRefreshOptions(val interface{}) {
...
func (j *jsiiProxy_RosDiskReplicaGroup)SetReplicaGroupId(val interface{}) {
...
func (r *jsiiProxy_RosDiskReplicaGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDiskReplicaGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDiskReplicaGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
