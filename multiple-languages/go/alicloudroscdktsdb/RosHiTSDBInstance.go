...
func (r *jsiiProxy_RosHiTSDBInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosHiTSDBInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosHiTSDBInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
