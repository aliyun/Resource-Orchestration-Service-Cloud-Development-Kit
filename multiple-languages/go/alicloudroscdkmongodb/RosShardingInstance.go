...
func (r *jsiiProxy_RosShardingInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosShardingInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosShardingInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
