...
func (r *jsiiProxy_RosMyBase) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosMyBase) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosMyBase) FetchRosDependency() *[]*string {
	var returns *[]*string
