...
func (r *jsiiProxy_RosDBClusterEndpoint) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDBClusterEndpoint) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDBClusterEndpoint) FetchRosDependency() *[]*string {
	var returns *[]*string
