...
type RosApplication interface {
	...
	SetApplicationType(val interface{})
	Architecture() interface{}
	SetArchitecture(val interface{})
	AttrApplicationId() alicloudroscdkcore.IResolvable
	AutoCreatePolarFs() interface{}
	SetAutoCreatePolarFs(val interface{})
	...
	PolarFsInstanceId() interface{}
	SetPolarFsInstanceId(val interface{})
...
func (j *jsiiProxy_RosApplication) ApplicationType() interface{} {
...
func (j *jsiiProxy_RosApplication) Architecture() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"architecture",
...
func (j *jsiiProxy_RosApplication) AttrApplicationId() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosApplication) AutoCreatePolarFs() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoCreatePolarFs",
...
func (j *jsiiProxy_RosApplication) Components() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"components",
...
func (j *jsiiProxy_RosApplication) DbClusterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dbClusterId",
...
func (j *jsiiProxy_RosApplication) Description() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RosApplication) PayType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"payType",
...
func (j *jsiiProxy_RosApplication) Period() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"period",
...
func (j *jsiiProxy_RosApplication) PolarFsInstanceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"polarFsInstanceId",
...
func (j *jsiiProxy_RosApplication) SecurityIpList() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"securityIpList",
...
func (j *jsiiProxy_RosApplication) ZoneId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"zoneId",
...
func NewRosApplication(scope alicloudroscdkcore.Construct, id *string, props *RosApplicationProps, enableResourcePropertyConstraint *bool) RosApplication {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-polardb.RosApplication",
...
func (j *jsiiProxy_RosApplication)SetApplicationType(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetArchitecture(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetAutoCreatePolarFs(val interface{}) {
	if err := j.validateSetAutoCreatePolarFsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosApplication)SetComponents(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetDbClusterId(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetDescription(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetPayType(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetPeriod(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetPolarFsInstanceId(val interface{}) {
	if err := j.validateSetPolarFsInstanceIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosApplication)SetSecurityIpList(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetZoneId(val interface{}) {
...
func (r *jsiiProxy_RosApplication) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosApplication) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosApplication) FetchRosDependency() *[]*string {
	var returns *[]*string
