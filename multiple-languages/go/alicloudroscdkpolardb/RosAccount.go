...
func (j *jsiiProxy_RosAccount) AccountPrivilege() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"accountPrivilege",
...
func (j *jsiiProxy_RosAccount) DbName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dbName",
...
func (j *jsiiProxy_RosAccount)SetAccountPrivilege(val interface{}) {
...
func (j *jsiiProxy_RosAccount)SetDbName(val interface{}) {
