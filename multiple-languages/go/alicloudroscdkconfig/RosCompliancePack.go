...
func (r *jsiiProxy_RosCompliancePack) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosCompliancePack) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosCompliancePack) FetchRosDependency() *[]*string {
	var returns *[]*string
