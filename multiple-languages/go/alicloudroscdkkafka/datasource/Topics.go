...
func (j *jsiiProxy_Topics) AttrTopics() interface{} {
...
func (j *jsiiProxy_Topics) Env() alicloudroscdkcore.IResourceEnvironment {
...
func NewTopics(scope alicloudroscdkcore.Construct, id *string, props *TopicsProps, enableResourcePropertyConstraint *bool) Topics {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-kafka.datasource.Topics",
...
func (t *jsiiProxy_Topics) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (t *jsiiProxy_Topics) FetchDependency() *[]*string {
	var returns *[]*string
...
func (t *jsiiProxy_Topics) FetchResourceDesc() *string {
	var returns *string
