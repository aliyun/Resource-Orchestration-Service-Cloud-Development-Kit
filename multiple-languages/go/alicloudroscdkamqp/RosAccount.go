...
type RosAccount interface {
	...
	AccountAccessKey() interface{}
	SetAccountAccessKey(val interface{})
	AccountAccessKeySecret() interface{}
	SetAccountAccessKeySecret(val interface{})
	AttrAccountAccessKey() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosAccount) AccountAccessKey() interface{} {
...
func (j *jsiiProxy_RosAccount) AccountAccessKeySecret() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosAccount) AttrAccountAccessKey() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosAccount) AttrCreateTimestamp() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrCreateTimestamp",
...
func (j *jsiiProxy_RosAccount) AttrPassword() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrPassword",
...
func (j *jsiiProxy_RosAccount) AttrUserName() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrUserName",
...
func (j *jsiiProxy_RosAccount)SetAccountAccessKey(val interface{}) {
	if err := j.validateSetAccountAccessKeyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosAccount)SetAccountAccessKeySecret(val interface{}) {
	if err := j.validateSetAccountAccessKeySecretParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
