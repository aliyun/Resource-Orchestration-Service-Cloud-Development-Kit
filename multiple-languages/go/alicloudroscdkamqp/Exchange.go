...
func (j *jsiiProxy_Exchange) AttrExchangeName() interface{} {
...
func (j *jsiiProxy_Exchange) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (e *jsiiProxy_Exchange) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (e *jsiiProxy_Exchange) FetchDependency() *[]*string {
	var returns *[]*string
...
func (e *jsiiProxy_Exchange) FetchResourceDesc() *string {
	var returns *string
