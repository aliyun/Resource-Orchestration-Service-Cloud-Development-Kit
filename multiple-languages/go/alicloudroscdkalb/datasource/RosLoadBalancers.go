...
func (j *jsiiProxy_RosLoadBalancers) PayType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"payType",
...
func NewRosLoadBalancers(scope alicloudroscdkcore.Construct, id *string, props *RosLoadBalancersProps, enableResourcePropertyConstraint *bool) RosLoadBalancers {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-alb.datasource.RosLoadBalancers",
...
func (j *jsiiProxy_RosLoadBalancers)SetPayType(val interface{}) {
...
func (r *jsiiProxy_RosLoadBalancers) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosLoadBalancers) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosLoadBalancers) FetchRosDependency() *[]*string {
	var returns *[]*string
