...
func (j *jsiiProxy_RosServerGroup) ServiceName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceName",
...
func (j *jsiiProxy_RosServerGroup) StickySessionConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"stickySessionConfig",
...
func (j *jsiiProxy_RosServerGroup)SetServiceName(val interface{}) {
