...
func (j *jsiiProxy_Topic) AttrMessageType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrMessageType",
...
func (j *jsiiProxy_Topic) AttrStatus() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_Topic) AttrUpdateTime() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrUpdateTime",
...
func (j *jsiiProxy_Topic) Env() alicloudroscdkcore.IResourceEnvironment {
