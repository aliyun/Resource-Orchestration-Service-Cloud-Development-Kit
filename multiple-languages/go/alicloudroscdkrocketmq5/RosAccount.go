...
type RosAccount interface {
	...
	SetAccountStatus(val interface{})
	AttrAccountStatus() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosAccount) AccountStatus() interface{} {
...
func (j *jsiiProxy_RosAccount) AttrAccountStatus() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosAccount) Username() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"username",
...
func (j *jsiiProxy_RosAccount)SetAccountStatus(val interface{}) {
	if err := j.validateSetAccountStatusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosAccount)SetUsername(val interface{}) {
