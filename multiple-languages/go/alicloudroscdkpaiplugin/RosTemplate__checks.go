...
func (j *jsiiProxy_RosTemplate) validateSetContentParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosTemplate) validateSetNameParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosTemplate) validateSetSignatureParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosTemplate) validateSetSignatureIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosTemplate) validateSetTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
