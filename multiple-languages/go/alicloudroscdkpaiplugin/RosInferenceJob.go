...
func (r *jsiiProxy_RosInferenceJob) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosInferenceJob) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosInferenceJob) FetchRosDependency() *[]*string {
	var returns *[]*string
