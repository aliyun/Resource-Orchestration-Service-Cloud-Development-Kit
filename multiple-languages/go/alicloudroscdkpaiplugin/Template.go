...
func (j *jsiiProxy_Template) AttrCreatedTime() interface{} {
...
func (j *jsiiProxy_Template) AttrId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_Template) AttrName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrName",
...
func (j *jsiiProxy_Template) AttrReason() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrReason",
