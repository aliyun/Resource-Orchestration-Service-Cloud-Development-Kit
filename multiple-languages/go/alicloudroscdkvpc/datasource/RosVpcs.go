...
func (r *jsiiProxy_RosVpcs) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosVpcs) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosVpcs) FetchRosDependency() *[]*string {
	var returns *[]*string
