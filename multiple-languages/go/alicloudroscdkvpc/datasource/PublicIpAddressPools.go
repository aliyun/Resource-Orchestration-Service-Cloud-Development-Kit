...
func (j *jsiiProxy_PublicIpAddressPools) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PublicIpAddressPools) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_PublicIpAddressPools) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PublicIpAddressPools) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_PublicIpAddressPools) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_PublicIpAddressPools) Props() *PublicIpAddressPoolsProps {
...
func (j *jsiiProxy_PublicIpAddressPools) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_PublicIpAddressPools) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_PublicIpAddressPools) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_PublicIpAddressPools) Stack() alicloudroscdkcore.Stack {
...
func NewPublicIpAddressPools(scope alicloudroscdkcore.Construct, id *string, props *PublicIpAddressPoolsProps, enableResourcePropertyConstraint *bool) PublicIpAddressPools {
	...
	if err := validateNewPublicIpAddressPoolsParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PublicIpAddressPools)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_PublicIpAddressPools)SetId(val *string) {
...
func (j *jsiiProxy_PublicIpAddressPools)SetScope(val alicloudroscdkcore.Construct) {
...
func PublicIpAddressPools_IsConstruct(x interface{}) *bool {
	...
	if err := validatePublicIpAddressPools_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PublicIpAddressPools) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (p *jsiiProxy_PublicIpAddressPools) AddCount(count interface{}) {
...
func (p *jsiiProxy_PublicIpAddressPools) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (p *jsiiProxy_PublicIpAddressPools) AddResourceDesc(desc *string) {
...
func (p *jsiiProxy_PublicIpAddressPools) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (p *jsiiProxy_PublicIpAddressPools) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (p *jsiiProxy_PublicIpAddressPools) OnPrepare() {
	_jsii_.InvokeVoid(
		p,
		"onPrepare",
		nil, // no parameters
...
func (p *jsiiProxy_PublicIpAddressPools) OnSynthesize(session constructs.ISynthesisSession) {
...
func (p *jsiiProxy_PublicIpAddressPools) OnValidate() *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_PublicIpAddressPools) Prepare() {
	_jsii_.InvokeVoid(
		p,
		"prepare",
		nil, // no parameters
...
func (p *jsiiProxy_PublicIpAddressPools) SetMetadata(key *string, value interface{}) {
...
func (p *jsiiProxy_PublicIpAddressPools) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (p *jsiiProxy_PublicIpAddressPools) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_PublicIpAddressPools) Validate() *[]*string {
	var returns *[]*string
