...
func (j *jsiiProxy_RosPrefixList) PrefixListId() interface{} {
...
func (j *jsiiProxy_RosPrefixList) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func (j *jsiiProxy_RosPrefixList)SetPrefixListId(val interface{}) {
...
func (j *jsiiProxy_RosPrefixList)SetRefreshOptions(val interface{}) {
...
func (r *jsiiProxy_RosPrefixList) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosPrefixList) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosPrefixList) FetchRosDependency() *[]*string {
	var returns *[]*string
