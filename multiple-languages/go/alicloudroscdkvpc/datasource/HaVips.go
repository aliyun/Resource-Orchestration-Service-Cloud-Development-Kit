...
func (j *jsiiProxy_HaVips) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HaVips) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_HaVips) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_HaVips) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_HaVips) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_HaVips) Props() *HaVipsProps {
...
func (j *jsiiProxy_HaVips) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_HaVips) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_HaVips) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_HaVips) Stack() alicloudroscdkcore.Stack {
...
func NewHaVips(scope alicloudroscdkcore.Construct, id *string, props *HaVipsProps, enableResourcePropertyConstraint *bool) HaVips {
	...
	if err := validateNewHaVipsParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_HaVips{}
...
func (j *jsiiProxy_HaVips)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_HaVips)SetId(val *string) {
...
func (j *jsiiProxy_HaVips)SetScope(val alicloudroscdkcore.Construct) {
...
func HaVips_IsConstruct(x interface{}) *bool {
	...
	if err := validateHaVips_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (h *jsiiProxy_HaVips) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (h *jsiiProxy_HaVips) AddCount(count interface{}) {
...
func (h *jsiiProxy_HaVips) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (h *jsiiProxy_HaVips) AddResourceDesc(desc *string) {
...
func (h *jsiiProxy_HaVips) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (h *jsiiProxy_HaVips) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (h *jsiiProxy_HaVips) OnPrepare() {
	_jsii_.InvokeVoid(
		h,
		"onPrepare",
		nil, // no parameters
...
func (h *jsiiProxy_HaVips) OnSynthesize(session constructs.ISynthesisSession) {
...
func (h *jsiiProxy_HaVips) OnValidate() *[]*string {
	var returns *[]*string
...
func (h *jsiiProxy_HaVips) Prepare() {
	_jsii_.InvokeVoid(
		h,
		"prepare",
		nil, // no parameters
...
func (h *jsiiProxy_HaVips) SetMetadata(key *string, value interface{}) {
...
func (h *jsiiProxy_HaVips) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (h *jsiiProxy_HaVips) ToString() *string {
	var returns *string
...
func (h *jsiiProxy_HaVips) Validate() *[]*string {
	var returns *[]*string
