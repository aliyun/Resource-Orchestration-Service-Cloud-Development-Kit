...
func (r *jsiiProxy_RosEIP) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosEIP) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosEIP) FetchRosDependency() *[]*string {
	var returns *[]*string
