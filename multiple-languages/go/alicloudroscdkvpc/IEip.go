...
// The jsii proxy for IEip
type jsiiProxy_IEip struct {
	internal.Type__alicloudroscdkcoreIResource
}

func (j *jsiiProxy_IEip) AttrAllocationId() interface{} {
...
func (j *jsiiProxy_IEip) AttrEipAddress() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrEipAddress",
...
func (j *jsiiProxy_IEip) AttrIsp() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrIsp",
...
func (j *jsiiProxy_IEip) AttrOrderId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrOrderId",
...
func (j *jsiiProxy_IEip) Props() *EIPProps {
