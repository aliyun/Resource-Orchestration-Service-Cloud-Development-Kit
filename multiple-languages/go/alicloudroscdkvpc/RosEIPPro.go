...
func (r *jsiiProxy_RosEIPPro) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosEIPPro) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosEIPPro) FetchRosDependency() *[]*string {
	var returns *[]*string
