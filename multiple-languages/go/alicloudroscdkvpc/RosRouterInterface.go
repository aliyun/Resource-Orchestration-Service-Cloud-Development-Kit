...
func (r *jsiiProxy_RosRouterInterface) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosRouterInterface) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosRouterInterface) FetchRosDependency() *[]*string {
	var returns *[]*string
