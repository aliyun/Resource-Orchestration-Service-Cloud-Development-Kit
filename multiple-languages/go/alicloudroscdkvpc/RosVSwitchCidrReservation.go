...
func (r *jsiiProxy_RosVSwitchCidrReservation) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosVSwitchCidrReservation) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosVSwitchCidrReservation) FetchRosDependency() *[]*string {
	var returns *[]*string
