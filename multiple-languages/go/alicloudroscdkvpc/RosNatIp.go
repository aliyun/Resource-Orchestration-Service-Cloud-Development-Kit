...
func (r *jsiiProxy_RosNatIp) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosNatIp) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosNatIp) FetchRosDependency() *[]*string {
	var returns *[]*string
