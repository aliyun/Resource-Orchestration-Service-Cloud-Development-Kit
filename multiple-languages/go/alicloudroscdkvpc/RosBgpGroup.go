...
func (r *jsiiProxy_RosBgpGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosBgpGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosBgpGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
