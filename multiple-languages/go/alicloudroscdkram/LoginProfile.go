...
func (j *jsiiProxy_LoginProfile) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoginProfile) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_LoginProfile) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoginProfile) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_LoginProfile) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_LoginProfile) Props() *LoginProfileProps {
...
func (j *jsiiProxy_LoginProfile) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_LoginProfile) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_LoginProfile) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_LoginProfile) Stack() alicloudroscdkcore.Stack {
...
func NewLoginProfile(scope alicloudroscdkcore.Construct, id *string, props *LoginProfileProps, enableResourcePropertyConstraint *bool) LoginProfile {
	...
	if err := validateNewLoginProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LoginProfile)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_LoginProfile)SetId(val *string) {
...
func (j *jsiiProxy_LoginProfile)SetScope(val alicloudroscdkcore.Construct) {
...
func LoginProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateLoginProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LoginProfile) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (l *jsiiProxy_LoginProfile) AddCount(count interface{}) {
...
func (l *jsiiProxy_LoginProfile) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (l *jsiiProxy_LoginProfile) AddResourceDesc(desc *string) {
...
func (l *jsiiProxy_LoginProfile) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (l *jsiiProxy_LoginProfile) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (l *jsiiProxy_LoginProfile) OnPrepare() {
	_jsii_.InvokeVoid(
		l,
		"onPrepare",
		nil, // no parameters
...
func (l *jsiiProxy_LoginProfile) OnSynthesize(session constructs.ISynthesisSession) {
...
func (l *jsiiProxy_LoginProfile) OnValidate() *[]*string {
	var returns *[]*string
...
func (l *jsiiProxy_LoginProfile) Prepare() {
	_jsii_.InvokeVoid(
		l,
		"prepare",
		nil, // no parameters
...
func (l *jsiiProxy_LoginProfile) SetMetadata(key *string, value interface{}) {
...
func (l *jsiiProxy_LoginProfile) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (l *jsiiProxy_LoginProfile) ToString() *string {
	var returns *string
...
func (l *jsiiProxy_LoginProfile) Validate() *[]*string {
	var returns *[]*string
