...
func (j *jsiiProxy_AttachPolicyToRole) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (a *jsiiProxy_AttachPolicyToRole) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (a *jsiiProxy_AttachPolicyToRole) FetchDependency() *[]*string {
	var returns *[]*string
...
func (a *jsiiProxy_AttachPolicyToRole) FetchResourceDesc() *string {
	var returns *string
