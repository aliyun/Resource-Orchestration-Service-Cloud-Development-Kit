...
func (j *jsiiProxy_ManagedPolicy) AttrPolicyName() interface{} {
...
func (j *jsiiProxy_ManagedPolicy) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (m *jsiiProxy_ManagedPolicy) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (m *jsiiProxy_ManagedPolicy) FetchDependency() *[]*string {
	var returns *[]*string
...
func (m *jsiiProxy_ManagedPolicy) FetchResourceDesc() *string {
	var returns *string
