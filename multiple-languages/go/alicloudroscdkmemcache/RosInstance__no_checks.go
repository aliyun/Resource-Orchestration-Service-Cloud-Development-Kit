...
func (j *jsiiProxy_RosInstance) validateSetAutoUseCouponParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetCapacityParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetConfigParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetPrivateIpAddressParameters(val interface{}) error {
	return nil
}
