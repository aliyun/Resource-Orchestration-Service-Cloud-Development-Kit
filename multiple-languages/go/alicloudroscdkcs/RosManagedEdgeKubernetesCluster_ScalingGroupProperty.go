...
type RosManagedEdgeKubernetesCluster_ScalingGroupProperty struct {
	...
	Tags *[]*RosManagedEdgeKubernetesCluster_ScalingGroupTagsProperty `field:"optional" json:"tags" yaml:"tags"`
