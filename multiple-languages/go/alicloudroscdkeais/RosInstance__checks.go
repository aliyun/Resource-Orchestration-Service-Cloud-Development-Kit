...
func (j *jsiiProxy_RosInstance) validateSetCreateWithNotebookParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosInstance) validateSetEnvironmentVarParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosInstance_EnvironmentVarProperty:
				v := v.(*RosInstance_EnvironmentVarProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosInstance_EnvironmentVarProperty:
				v_ := v.(RosInstance_EnvironmentVarProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_EnvironmentVarProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
