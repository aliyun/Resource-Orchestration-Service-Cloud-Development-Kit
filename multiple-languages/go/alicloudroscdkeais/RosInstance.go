...
type RosInstance interface {
	...
	SetCreateWithNotebook(val interface{})
	...
	SetEnvironmentVar(val interface{})
...
func (j *jsiiProxy_RosInstance) AttrClientInstanceId() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosInstance) AttrClientInstanceName() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) AttrClientInstanceType() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) AttrJupyterUrl() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrJupyterUrl",
...
func (j *jsiiProxy_RosInstance) CreateWithNotebook() interface{} {
...
func (j *jsiiProxy_RosInstance) EnvironmentVar() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"environmentVar",
...
func (j *jsiiProxy_RosInstance)SetCreateWithNotebook(val interface{}) {
	if err := j.validateSetCreateWithNotebookParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetEnvironmentVar(val interface{}) {
	if err := j.validateSetEnvironmentVarParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
