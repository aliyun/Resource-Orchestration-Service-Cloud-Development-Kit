...
func (j *jsiiProxy_Instance) AttrClientInstanceId() interface{} {
...
func (j *jsiiProxy_Instance) AttrClientInstanceName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Instance) AttrClientInstanceType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Instance) AttrJupyterUrl() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrJupyterUrl",
