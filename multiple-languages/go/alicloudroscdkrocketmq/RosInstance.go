...
type RosInstance interface {
	...
	AttrTcpEndpoint() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosInstance) AttrHttpInternetEndpoint() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) AttrHttpInternetSecureEndpoint() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) AttrTcpEndpoint() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrTcpEndpoint",
