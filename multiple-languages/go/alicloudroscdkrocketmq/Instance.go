...
func (j *jsiiProxy_Instance) AttrHttpInternetEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Instance) AttrHttpInternetSecureEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Instance) AttrTcpEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrTcpEndpoint",
