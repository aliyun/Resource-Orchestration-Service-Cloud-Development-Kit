...
func init() {
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-searchengine.datasource.IInstances",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-searchengine.datasource.InstancesProps",
		reflect.TypeOf((*InstancesProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-searchengine.datasource.RosInstances",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-searchengine.datasource.RosInstancesProps",
