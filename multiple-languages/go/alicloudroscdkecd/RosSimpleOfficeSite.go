...
func (r *jsiiProxy_RosSimpleOfficeSite) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSimpleOfficeSite) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSimpleOfficeSite) FetchRosDependency() *[]*string {
	var returns *[]*string
