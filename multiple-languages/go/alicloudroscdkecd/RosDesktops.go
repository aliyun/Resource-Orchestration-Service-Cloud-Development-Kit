...
func (r *jsiiProxy_RosDesktops) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDesktops) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDesktops) FetchRosDependency() *[]*string {
	var returns *[]*string
