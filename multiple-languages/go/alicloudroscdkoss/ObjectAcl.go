...
func (j *jsiiProxy_ObjectAcl) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_ObjectAcl) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ObjectAcl) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_ObjectAcl) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_ObjectAcl) Props() *ObjectAclProps {
...
func (j *jsiiProxy_ObjectAcl) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_ObjectAcl) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_ObjectAcl) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_ObjectAcl) Stack() alicloudroscdkcore.Stack {
...
func NewObjectAcl(scope alicloudroscdkcore.Construct, id *string, props *ObjectAclProps, enableResourcePropertyConstraint *bool) ObjectAcl {
	...
	if err := validateNewObjectAclParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ObjectAcl)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_ObjectAcl)SetId(val *string) {
...
func (j *jsiiProxy_ObjectAcl)SetScope(val alicloudroscdkcore.Construct) {
...
func ObjectAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateObjectAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (o *jsiiProxy_ObjectAcl) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (o *jsiiProxy_ObjectAcl) AddCount(count interface{}) {
...
func (o *jsiiProxy_ObjectAcl) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (o *jsiiProxy_ObjectAcl) AddResourceDesc(desc *string) {
...
func (o *jsiiProxy_ObjectAcl) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (o *jsiiProxy_ObjectAcl) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (o *jsiiProxy_ObjectAcl) OnPrepare() {
	_jsii_.InvokeVoid(
		o,
		"onPrepare",
		nil, // no parameters
...
func (o *jsiiProxy_ObjectAcl) OnSynthesize(session constructs.ISynthesisSession) {
...
func (o *jsiiProxy_ObjectAcl) OnValidate() *[]*string {
	var returns *[]*string
...
func (o *jsiiProxy_ObjectAcl) Prepare() {
	_jsii_.InvokeVoid(
		o,
		"prepare",
		nil, // no parameters
...
func (o *jsiiProxy_ObjectAcl) SetMetadata(key *string, value interface{}) {
...
func (o *jsiiProxy_ObjectAcl) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (o *jsiiProxy_ObjectAcl) ToString() *string {
	var returns *string
...
func (o *jsiiProxy_ObjectAcl) Validate() *[]*string {
	var returns *[]*string
