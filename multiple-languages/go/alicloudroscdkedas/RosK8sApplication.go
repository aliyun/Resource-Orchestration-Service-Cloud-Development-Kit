...
func (r *jsiiProxy_RosK8sApplication) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosK8sApplication) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosK8sApplication) FetchRosDependency() *[]*string {
	var returns *[]*string
