...
func (r *jsiiProxy_RosK8sSlbBinding) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosK8sSlbBinding) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosK8sSlbBinding) FetchRosDependency() *[]*string {
	var returns *[]*string
