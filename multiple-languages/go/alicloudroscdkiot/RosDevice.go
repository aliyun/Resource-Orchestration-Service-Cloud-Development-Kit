...
func (r *jsiiProxy_RosDevice) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDevice) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDevice) FetchRosDependency() *[]*string {
	var returns *[]*string
