...
func (j *jsiiProxy_RosService) validateSetDeletionForceParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosService) validateSetDescriptionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosService) validateSetInternetAccessParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosService) validateSetLogConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosService_LogConfigProperty:
		val := val.(*RosService_LogConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosService_LogConfigProperty:
		val_ := val.(RosService_LogConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosService_LogConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosService) validateSetNasConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosService_NasConfigProperty:
		val := val.(*RosService_NasConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosService_NasConfigProperty:
		val_ := val.(RosService_NasConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosService_NasConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosService) validateSetOssMountConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosService_OssMountConfigProperty:
		val := val.(*RosService_OssMountConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosService_OssMountConfigProperty:
		val_ := val.(RosService_OssMountConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosService_OssMountConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosService) validateSetRoleParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosService) validateSetTagsParameters(val *[]*RosService_TagsProperty) error {
...
func (j *jsiiProxy_RosService) validateSetTracingConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosService_TracingConfigProperty:
		val := val.(*RosService_TracingConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosService_TracingConfigProperty:
		val_ := val.(RosService_TracingConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosService_TracingConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosService) validateSetVpcBindingsParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *[]interface{}:
...
func (j *jsiiProxy_RosService) validateSetVpcConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosService_VpcConfigProperty:
		val := val.(*RosService_VpcConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosService_VpcConfigProperty:
		val_ := val.(RosService_VpcConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosService_VpcConfigProperty; received %#v (a %T)", val, val)
		}
	}
