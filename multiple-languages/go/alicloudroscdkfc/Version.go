...
func (j *jsiiProxy_Version) AttrServiceName() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_Version) AttrVersionId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrVersionId",
...
func (j *jsiiProxy_Version)SetProps(val *VersionProps) {
