...
func (j *jsiiProxy_RosTrigger) AttrServiceName() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrServiceName",
...
func (j *jsiiProxy_RosTrigger) ServiceName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceName",
...
func (j *jsiiProxy_RosTrigger)SetServiceName(val interface{}) {
