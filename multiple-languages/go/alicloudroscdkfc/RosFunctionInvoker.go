...
func (r *jsiiProxy_RosFunctionInvoker) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosFunctionInvoker) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosFunctionInvoker) FetchRosDependency() *[]*string {
	var returns *[]*string
