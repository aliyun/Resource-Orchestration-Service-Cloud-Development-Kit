...
func (j *jsiiProxy_RosService) AttrInternetAccess() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosService) AttrLogProject() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrLogProject",
...
func (j *jsiiProxy_RosService) AttrLogstore() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrLogstore",
...
func (j *jsiiProxy_RosService) AttrTags() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrTags",
...
func (j *jsiiProxy_RosService) AttrVpcId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrVpcId",
...
func (j *jsiiProxy_RosService) DeletionForce() interface{} {
...
func (j *jsiiProxy_RosService) Description() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RosService) InternetAccess() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internetAccess",
...
func (j *jsiiProxy_RosService) LogConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"logConfig",
...
func (j *jsiiProxy_RosService) NasConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nasConfig",
...
func (j *jsiiProxy_RosService) OssMountConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ossMountConfig",
...
func (j *jsiiProxy_RosService) Role() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_RosService) ServiceName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceName",
...
func (j *jsiiProxy_RosService) Tags() *[]*RosService_TagsProperty {
	var returns *[]*RosService_TagsProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_RosService) TracingConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tracingConfig",
...
func (j *jsiiProxy_RosService) VpcBindings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcBindings",
...
func (j *jsiiProxy_RosService) VpcConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcConfig",
...
func (j *jsiiProxy_RosService)SetDeletionForce(val interface{}) {
...
func (j *jsiiProxy_RosService)SetDescription(val interface{}) {
...
func (j *jsiiProxy_RosService)SetInternetAccess(val interface{}) {
...
func (j *jsiiProxy_RosService)SetLogConfig(val interface{}) {
...
func (j *jsiiProxy_RosService)SetNasConfig(val interface{}) {
...
func (j *jsiiProxy_RosService)SetOssMountConfig(val interface{}) {
...
func (j *jsiiProxy_RosService)SetRole(val interface{}) {
...
func (j *jsiiProxy_RosService)SetServiceName(val interface{}) {
...
func (j *jsiiProxy_RosService)SetTags(val *[]*RosService_TagsProperty) {
...
func (j *jsiiProxy_RosService)SetTracingConfig(val interface{}) {
...
func (j *jsiiProxy_RosService)SetVpcBindings(val interface{}) {
	if err := j.validateSetVpcBindingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosService)SetVpcConfig(val interface{}) {
