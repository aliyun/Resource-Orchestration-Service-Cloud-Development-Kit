...
func (r *jsiiProxy_RosInstance2) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosInstance2) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosInstance2) FetchRosDependency() *[]*string {
	var returns *[]*string
