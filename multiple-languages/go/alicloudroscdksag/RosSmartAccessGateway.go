...
func (r *jsiiProxy_RosSmartAccessGateway) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSmartAccessGateway) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSmartAccessGateway) FetchRosDependency() *[]*string {
	var returns *[]*string
