...
func (j *jsiiProxy_AppUser) AttrSmartAgId() interface{} {
...
func (j *jsiiProxy_AppUser) AttrUserName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrUserName",
...
func (a *jsiiProxy_AppUser) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (a *jsiiProxy_AppUser) FetchDependency() *[]*string {
	var returns *[]*string
...
func (a *jsiiProxy_AppUser) FetchResourceDesc() *string {
	var returns *string
