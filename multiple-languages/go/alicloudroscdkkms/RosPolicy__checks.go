...
func (j *jsiiProxy_RosPolicy) validateSetAccessControlRulesParameters(val interface{}) error {
	if val == nil {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosPolicy_AccessControlRulesProperty:
		val := val.(*RosPolicy_AccessControlRulesProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosPolicy_AccessControlRulesProperty:
		val_ := val.(RosPolicy_AccessControlRulesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosPolicy_AccessControlRulesProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosPolicy) validateSetDescriptionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosPolicy) validateSetKmsInstanceIdParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosPolicy) validateSetPermissionsParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosPolicy) validateSetResourcesParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
