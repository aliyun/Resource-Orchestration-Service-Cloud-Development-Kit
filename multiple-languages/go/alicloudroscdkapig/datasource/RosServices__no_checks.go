...
func (j *jsiiProxy_RosServices) validateSetGatewayIdParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosServices) validateSetResourceGroupIdParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosServices) validateSetSourceTypeParameters(val interface{}) error {
	return nil
}
