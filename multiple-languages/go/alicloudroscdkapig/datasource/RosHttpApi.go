...
func (j *jsiiProxy_RosHttpApi) AttrResourceGroupId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrResourceGroupId",
...
func (j *jsiiProxy_RosHttpApi) HttpApiId() interface{} {
...
func (j *jsiiProxy_RosHttpApi) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func NewRosHttpApi(scope alicloudroscdkcore.Construct, id *string, props *RosHttpApiProps, enableResourcePropertyConstraint *bool) RosHttpApi {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-apig.datasource.RosHttpApi",
...
func (j *jsiiProxy_RosHttpApi)SetHttpApiId(val interface{}) {
...
func (j *jsiiProxy_RosHttpApi)SetRefreshOptions(val interface{}) {
