...
func (j *jsiiProxy_Plugin) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Plugin) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_Plugin) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Plugin) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_Plugin) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_Plugin) Props() *PluginProps {
...
func (j *jsiiProxy_Plugin) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_Plugin) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_Plugin) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_Plugin) Stack() alicloudroscdkcore.Stack {
...
func NewPlugin(scope alicloudroscdkcore.Construct, id *string, props *PluginProps, enableResourcePropertyConstraint *bool) Plugin {
	...
	if err := validateNewPluginParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_Plugin{}

	_jsii_.Create(
		"@alicloud/ros-cdk-apig.datasource.Plugin",
...
func (j *jsiiProxy_Plugin)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_Plugin)SetId(val *string) {
...
func (j *jsiiProxy_Plugin)SetScope(val alicloudroscdkcore.Construct) {
...
func Plugin_IsConstruct(x interface{}) *bool {
	...
	if err := validatePlugin_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_Plugin) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (p *jsiiProxy_Plugin) AddCount(count interface{}) {
...
func (p *jsiiProxy_Plugin) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (p *jsiiProxy_Plugin) AddResourceDesc(desc *string) {
...
func (p *jsiiProxy_Plugin) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (p *jsiiProxy_Plugin) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (p *jsiiProxy_Plugin) OnPrepare() {
	_jsii_.InvokeVoid(
		p,
		"onPrepare",
		nil, // no parameters
...
func (p *jsiiProxy_Plugin) OnSynthesize(session constructs.ISynthesisSession) {
...
func (p *jsiiProxy_Plugin) OnValidate() *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_Plugin) Prepare() {
	_jsii_.InvokeVoid(
		p,
		"prepare",
		nil, // no parameters
...
func (p *jsiiProxy_Plugin) SetMetadata(key *string, value interface{}) {
...
func (p *jsiiProxy_Plugin) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (p *jsiiProxy_Plugin) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_Plugin) Validate() *[]*string {
	var returns *[]*string
