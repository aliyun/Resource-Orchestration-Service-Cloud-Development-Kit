...
func (j *jsiiProxy_RosEnvironment) AttrResourceGroupId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrResourceGroupId",
...
func (j *jsiiProxy_RosEnvironment) EnvironmentId() interface{} {
...
func (j *jsiiProxy_RosEnvironment) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func NewRosEnvironment(scope alicloudroscdkcore.Construct, id *string, props *RosEnvironmentProps, enableResourcePropertyConstraint *bool) RosEnvironment {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-apig.datasource.RosEnvironment",
...
func (j *jsiiProxy_RosEnvironment)SetEnvironmentId(val interface{}) {
...
func (j *jsiiProxy_RosEnvironment)SetRefreshOptions(val interface{}) {
