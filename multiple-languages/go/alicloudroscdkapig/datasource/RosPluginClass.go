...
func (j *jsiiProxy_RosPluginClass) PluginClassId() interface{} {
...
func (j *jsiiProxy_RosPluginClass) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func NewRosPluginClass(scope alicloudroscdkcore.Construct, id *string, props *RosPluginClassProps, enableResourcePropertyConstraint *bool) RosPluginClass {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-apig.datasource.RosPluginClass",
...
func (j *jsiiProxy_RosPluginClass)SetPluginClassId(val interface{}) {
...
func (j *jsiiProxy_RosPluginClass)SetRefreshOptions(val interface{}) {
...
func (r *jsiiProxy_RosPluginClass) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosPluginClass) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosPluginClass) FetchRosDependency() *[]*string {
	var returns *[]*string
