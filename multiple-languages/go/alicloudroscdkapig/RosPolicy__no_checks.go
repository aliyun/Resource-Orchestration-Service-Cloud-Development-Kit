...
func (j *jsiiProxy_RosPolicy) validateSetAttachResourceIdsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosPolicy) validateSetAttachResourceTypeParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosPolicy) validateSetEnvironmentIdParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosPolicy) validateSetGatewayIdParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosPolicy) validateSetPolicyClassNameParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosPolicy) validateSetPolicyConfigParameters(val interface{}) error {
	return nil
}
