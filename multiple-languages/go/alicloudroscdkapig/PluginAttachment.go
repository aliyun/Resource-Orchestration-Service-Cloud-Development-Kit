...
func (j *jsiiProxy_PluginAttachment) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PluginAttachment) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_PluginAttachment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PluginAttachment) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_PluginAttachment) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_PluginAttachment) Props() *PluginAttachmentProps {
...
func (j *jsiiProxy_PluginAttachment) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_PluginAttachment) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_PluginAttachment) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_PluginAttachment) Stack() alicloudroscdkcore.Stack {
...
func NewPluginAttachment(scope alicloudroscdkcore.Construct, id *string, props *PluginAttachmentProps, enableResourcePropertyConstraint *bool) PluginAttachment {
	...
	if err := validateNewPluginAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PluginAttachment)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_PluginAttachment)SetId(val *string) {
...
func (j *jsiiProxy_PluginAttachment)SetScope(val alicloudroscdkcore.Construct) {
...
func PluginAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validatePluginAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PluginAttachment) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (p *jsiiProxy_PluginAttachment) AddCount(count interface{}) {
...
func (p *jsiiProxy_PluginAttachment) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (p *jsiiProxy_PluginAttachment) AddResourceDesc(desc *string) {
...
func (p *jsiiProxy_PluginAttachment) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (p *jsiiProxy_PluginAttachment) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (p *jsiiProxy_PluginAttachment) OnPrepare() {
	_jsii_.InvokeVoid(
		p,
		"onPrepare",
		nil, // no parameters
...
func (p *jsiiProxy_PluginAttachment) OnSynthesize(session constructs.ISynthesisSession) {
...
func (p *jsiiProxy_PluginAttachment) OnValidate() *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_PluginAttachment) Prepare() {
	_jsii_.InvokeVoid(
		p,
		"prepare",
		nil, // no parameters
...
func (p *jsiiProxy_PluginAttachment) SetMetadata(key *string, value interface{}) {
...
func (p *jsiiProxy_PluginAttachment) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (p *jsiiProxy_PluginAttachment) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_PluginAttachment) Validate() *[]*string {
	var returns *[]*string
