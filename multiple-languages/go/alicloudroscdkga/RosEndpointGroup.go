...
func (r *jsiiProxy_RosEndpointGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosEndpointGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosEndpointGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
