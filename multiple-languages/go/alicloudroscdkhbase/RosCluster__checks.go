...
func (j *jsiiProxy_RosCluster) validateSetClusterNameParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetColdStorageSizeParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosCluster) validateSetCoreInstanceTypeParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosCluster) validateSetEncryptionKeyParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetEngineParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetEngineVersionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetMasterInstanceTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetNodeCountParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetPayTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetSecurityIpListParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
