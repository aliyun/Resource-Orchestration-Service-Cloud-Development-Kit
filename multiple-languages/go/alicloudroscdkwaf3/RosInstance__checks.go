...
func (j *jsiiProxy_RosInstance) validateSetAdditionalProtectionNodesParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetApiSecurityParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetBotAppProtectionParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetBotWebProtectionParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetDomainsExtensionParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetElasticQpsParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetExclusiveIpAddressParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetFraudDetectionParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetIntelligentLoadBalancingParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetLogServiceParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetQpsExtensionParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetRegionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetTrafficBillingProtectionThresholdParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetWafVersionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
