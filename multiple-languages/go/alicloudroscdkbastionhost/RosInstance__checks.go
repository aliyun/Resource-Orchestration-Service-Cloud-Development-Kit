...
func (j *jsiiProxy_RosInstance) validateSetExtendedStoragePlansParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetExtraBandwidthParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetPlanParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetStartInstanceParamParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_StartInstanceParamProperty:
		val := val.(*RosInstance_StartInstanceParamProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_StartInstanceParamProperty:
		val_ := val.(RosInstance_StartInstanceParamProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_StartInstanceParamProperty; received %#v (a %T)", val, val)
		}
	}
