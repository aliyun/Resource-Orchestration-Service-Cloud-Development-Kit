...
func init() {
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-bastionhost.Host",
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IHost)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-bastionhost.HostProps",
		reflect.TypeOf((*HostProps)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-bastionhost.IHost",
		reflect.TypeOf((*IHost)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attrHostId", GoGetter: "AttrHostId"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-bastionhost.IInstance",
	...
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-bastionhost.Instance",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-bastionhost.InstanceProps",
		reflect.TypeOf((*InstanceProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-bastionhost.RosHost",
		reflect.TypeOf((*RosHost)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "activeAddressType", GoGetter: "ActiveAddressType"},
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hostPrivateAddress", GoGetter: "HostPrivateAddress"},
			_jsii_.MemberProperty{JsiiProperty: "hostPublicAddress", GoGetter: "HostPublicAddress"},
			_jsii_.MemberProperty{JsiiProperty: "instanceId", GoGetter: "InstanceId"},
			_jsii_.MemberProperty{JsiiProperty: "instanceRegionId", GoGetter: "InstanceRegionId"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-bastionhost.RosHostProps",
		reflect.TypeOf((*RosHostProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-bastionhost.RosInstance",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enableResourcePropertyConstraint", GoGetter: "EnableResourcePropertyConstraint"},
			_jsii_.MemberProperty{JsiiProperty: "extendedStoragePlans", GoGetter: "ExtendedStoragePlans"},
			_jsii_.MemberProperty{JsiiProperty: "extraBandwidth", GoGetter: "ExtraBandwidth"},
			_jsii_.MemberMethod{JsiiMethod: "fetchCondition", GoMethod: "FetchCondition"},
			_jsii_.MemberMethod{JsiiMethod: "fetchDesc", GoMethod: "FetchDesc"},
			_jsii_.MemberMethod{JsiiMethod: "fetchRosDependency", GoMethod: "FetchRosDependency"},
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rosResourceType", GoGetter: "RosResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "startInstanceParam", GoGetter: "StartInstanceParam"},
			_jsii_.MemberMethod{JsiiMethod: "synthesize", GoMethod: "Synthesize"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "updatedProperites", GoGetter: "UpdatedProperites"},
			_jsii_.MemberMethod{JsiiMethod: "validate", GoMethod: "Validate"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-bastionhost.RosInstance.StartInstanceParamProperty",
		reflect.TypeOf((*RosInstance_StartInstanceParamProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-bastionhost.RosInstanceProps",
