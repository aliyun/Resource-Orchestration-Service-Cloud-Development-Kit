...
func (j *jsiiProxy_WafSwitch) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (w *jsiiProxy_WafSwitch) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (w *jsiiProxy_WafSwitch) FetchDependency() *[]*string {
	var returns *[]*string
...
func (w *jsiiProxy_WafSwitch) FetchResourceDesc() *string {
	var returns *string
