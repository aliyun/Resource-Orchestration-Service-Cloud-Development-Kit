...
func (j *jsiiProxy_RosInstance) validateSetBigScreenParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetExclusiveIpPackageParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetExtBandwidthParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetExtDomainPackageParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetLogTimeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetPackageCodeParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetPrefessionalServiceParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetSubscriptionTypeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetWafLogParameters(val interface{}) error {
	return nil
}
