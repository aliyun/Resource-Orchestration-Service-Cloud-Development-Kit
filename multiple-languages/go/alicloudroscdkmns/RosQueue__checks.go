...
func (j *jsiiProxy_RosQueue) validateSetDelaySecondsParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosQueue) validateSetLoggingEnabledParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosQueue) validateSetMaximumMessageSizeParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosQueue) validateSetMessageRetentionPeriodParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosQueue) validateSetPollingWaitSecondsParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosQueue) validateSetVisibilityTimeoutParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
