...
func (j *jsiiProxy_RosSubscription) validateSetEndpointParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosSubscription) validateSetFilterTagParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosSubscription) validateSetNotifyContentFormatParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
