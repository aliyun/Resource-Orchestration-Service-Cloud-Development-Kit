...
func (r *jsiiProxy_RosExecution) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosExecution) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosExecution) FetchRosDependency() *[]*string {
	var returns *[]*string
