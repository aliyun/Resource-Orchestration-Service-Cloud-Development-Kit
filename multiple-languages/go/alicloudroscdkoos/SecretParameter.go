...
func (j *jsiiProxy_SecretParameter) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecretParameter) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_SecretParameter) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SecretParameter) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_SecretParameter) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_SecretParameter) Props() *SecretParameterProps {
...
func (j *jsiiProxy_SecretParameter) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_SecretParameter) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_SecretParameter) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_SecretParameter) Stack() alicloudroscdkcore.Stack {
...
func NewSecretParameter(scope alicloudroscdkcore.Construct, id *string, props *SecretParameterProps, enableResourcePropertyConstraint *bool) SecretParameter {
	...
	if err := validateNewSecretParameterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecretParameter)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_SecretParameter)SetId(val *string) {
...
func (j *jsiiProxy_SecretParameter)SetScope(val alicloudroscdkcore.Construct) {
...
func SecretParameter_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecretParameter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SecretParameter) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (s *jsiiProxy_SecretParameter) AddCount(count interface{}) {
...
func (s *jsiiProxy_SecretParameter) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (s *jsiiProxy_SecretParameter) AddResourceDesc(desc *string) {
...
func (s *jsiiProxy_SecretParameter) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (s *jsiiProxy_SecretParameter) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (s *jsiiProxy_SecretParameter) OnPrepare() {
	_jsii_.InvokeVoid(
		s,
		"onPrepare",
		nil, // no parameters
...
func (s *jsiiProxy_SecretParameter) OnSynthesize(session constructs.ISynthesisSession) {
...
func (s *jsiiProxy_SecretParameter) OnValidate() *[]*string {
	var returns *[]*string
...
func (s *jsiiProxy_SecretParameter) Prepare() {
	_jsii_.InvokeVoid(
		s,
		"prepare",
		nil, // no parameters
...
func (s *jsiiProxy_SecretParameter) SetMetadata(key *string, value interface{}) {
...
func (s *jsiiProxy_SecretParameter) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (s *jsiiProxy_SecretParameter) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SecretParameter) Validate() *[]*string {
	var returns *[]*string
