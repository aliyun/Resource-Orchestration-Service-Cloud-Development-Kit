...
func (j *jsiiProxy_RosTemplate) validateSetRefreshOptionsParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosTemplate) validateSetTemplateVersionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
