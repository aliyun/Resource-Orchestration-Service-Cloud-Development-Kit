...
func (j *jsiiProxy_PatchBaselines) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PatchBaselines) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_PatchBaselines) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PatchBaselines) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_PatchBaselines) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_PatchBaselines) Props() *PatchBaselinesProps {
...
func (j *jsiiProxy_PatchBaselines) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_PatchBaselines) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_PatchBaselines) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_PatchBaselines) Stack() alicloudroscdkcore.Stack {
...
func NewPatchBaselines(scope alicloudroscdkcore.Construct, id *string, props *PatchBaselinesProps, enableResourcePropertyConstraint *bool) PatchBaselines {
	...
	if err := validateNewPatchBaselinesParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PatchBaselines)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_PatchBaselines)SetId(val *string) {
...
func (j *jsiiProxy_PatchBaselines)SetScope(val alicloudroscdkcore.Construct) {
...
func PatchBaselines_IsConstruct(x interface{}) *bool {
	...
	if err := validatePatchBaselines_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PatchBaselines) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (p *jsiiProxy_PatchBaselines) AddCount(count interface{}) {
...
func (p *jsiiProxy_PatchBaselines) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (p *jsiiProxy_PatchBaselines) AddResourceDesc(desc *string) {
...
func (p *jsiiProxy_PatchBaselines) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (p *jsiiProxy_PatchBaselines) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (p *jsiiProxy_PatchBaselines) OnPrepare() {
	_jsii_.InvokeVoid(
		p,
		"onPrepare",
		nil, // no parameters
...
func (p *jsiiProxy_PatchBaselines) OnSynthesize(session constructs.ISynthesisSession) {
...
func (p *jsiiProxy_PatchBaselines) OnValidate() *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_PatchBaselines) Prepare() {
	_jsii_.InvokeVoid(
		p,
		"prepare",
		nil, // no parameters
...
func (p *jsiiProxy_PatchBaselines) SetMetadata(key *string, value interface{}) {
...
func (p *jsiiProxy_PatchBaselines) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (p *jsiiProxy_PatchBaselines) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_PatchBaselines) Validate() *[]*string {
	var returns *[]*string
