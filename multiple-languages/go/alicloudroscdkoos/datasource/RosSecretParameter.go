...
func (j *jsiiProxy_RosSecretParameter) AttrValue() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrValue",
...
func (j *jsiiProxy_RosSecretParameter) RefreshOptions() interface{} {
...
func (j *jsiiProxy_RosSecretParameter)SetRefreshOptions(val interface{}) {
...
func (r *jsiiProxy_RosSecretParameter) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSecretParameter) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSecretParameter) FetchRosDependency() *[]*string {
	var returns *[]*string
