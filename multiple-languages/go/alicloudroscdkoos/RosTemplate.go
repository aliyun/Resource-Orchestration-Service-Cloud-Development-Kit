...
func (j *jsiiProxy_RosTemplate) AttrExecutionPolicy() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosTemplate) ResourceGroupId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceGroupId",
...
func (j *jsiiProxy_RosTemplate) Tags() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_RosTemplate)SetResourceGroupId(val interface{}) {
...
func (j *jsiiProxy_RosTemplate)SetTags(val *map[string]interface{}) {
	_jsii_.Set(
		j,
		"tags",
		val,
