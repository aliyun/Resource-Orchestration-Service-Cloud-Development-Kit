...
func (j *jsiiProxy_Execution) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Execution) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_Execution) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Execution) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_Execution) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_Execution) Props() *ExecutionProps {
...
func (j *jsiiProxy_Execution) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_Execution) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_Execution) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_Execution) Stack() alicloudroscdkcore.Stack {
...
func NewExecution(scope alicloudroscdkcore.Construct, id *string, props *ExecutionProps, enableResourcePropertyConstraint *bool) Execution {
	...
	if err := validateNewExecutionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_Execution)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_Execution)SetId(val *string) {
...
func (j *jsiiProxy_Execution)SetScope(val alicloudroscdkcore.Construct) {
...
func Execution_IsConstruct(x interface{}) *bool {
	...
	if err := validateExecution_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_Execution) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (e *jsiiProxy_Execution) AddCount(count interface{}) {
...
func (e *jsiiProxy_Execution) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (e *jsiiProxy_Execution) AddResourceDesc(desc *string) {
...
func (e *jsiiProxy_Execution) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (e *jsiiProxy_Execution) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (e *jsiiProxy_Execution) OnPrepare() {
	_jsii_.InvokeVoid(
		e,
		"onPrepare",
		nil, // no parameters
...
func (e *jsiiProxy_Execution) OnSynthesize(session constructs.ISynthesisSession) {
...
func (e *jsiiProxy_Execution) OnValidate() *[]*string {
	var returns *[]*string
...
func (e *jsiiProxy_Execution) Prepare() {
	_jsii_.InvokeVoid(
		e,
		"prepare",
		nil, // no parameters
...
func (e *jsiiProxy_Execution) SetMetadata(key *string, value interface{}) {
...
func (e *jsiiProxy_Execution) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (e *jsiiProxy_Execution) ToString() *string {
	var returns *string
...
func (e *jsiiProxy_Execution) Validate() *[]*string {
	var returns *[]*string
