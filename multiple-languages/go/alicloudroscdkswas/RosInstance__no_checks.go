...
func (j *jsiiProxy_RosInstance) validateSetDataDiskSizeParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetImageIdParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetPlanIdParameters(val interface{}) error {
	return nil
}
