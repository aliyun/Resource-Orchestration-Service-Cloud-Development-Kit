...
type RosRunCommand interface {
	...
	AttrInvokeResult() alicloudroscdkcore.IResolvable
	...
	WorkingUser() interface{}
	SetWorkingUser(val interface{})
...
func (j *jsiiProxy_RosRunCommand) AttrInvokeResult() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrInvokeResult",
...
func (j *jsiiProxy_RosRunCommand) InstanceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_RosRunCommand) WorkingUser() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workingUser",
...
func NewRosRunCommand(scope alicloudroscdkcore.Construct, id *string, props *RosRunCommandProps, enableResourcePropertyConstraint *bool) RosRunCommand {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-swas.RosRunCommand",
...
func (j *jsiiProxy_RosRunCommand)SetInstanceId(val interface{}) {
...
func (j *jsiiProxy_RosRunCommand)SetWorkingUser(val interface{}) {
	if err := j.validateSetWorkingUserParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (r *jsiiProxy_RosRunCommand) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosRunCommand) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosRunCommand) FetchRosDependency() *[]*string {
	var returns *[]*string
