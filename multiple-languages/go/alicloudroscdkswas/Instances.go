...
func (j *jsiiProxy_Instances) AttrInnerIpAddresses() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_Instances) AttrPublicIpAddresses() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
