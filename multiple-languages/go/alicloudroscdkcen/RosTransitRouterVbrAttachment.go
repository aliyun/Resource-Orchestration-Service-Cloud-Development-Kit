...
func (r *jsiiProxy_RosTransitRouterVbrAttachment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosTransitRouterVbrAttachment) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosTransitRouterVbrAttachment) FetchRosDependency() *[]*string {
	var returns *[]*string
