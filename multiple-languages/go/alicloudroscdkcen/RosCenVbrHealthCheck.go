...
func (r *jsiiProxy_RosCenVbrHealthCheck) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosCenVbrHealthCheck) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosCenVbrHealthCheck) FetchRosDependency() *[]*string {
	var returns *[]*string
