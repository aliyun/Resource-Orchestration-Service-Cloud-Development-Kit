...
func (j *jsiiProxy_CenBandwidthPackage) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (c *jsiiProxy_CenBandwidthPackage) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (c *jsiiProxy_CenBandwidthPackage) FetchDependency() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CenBandwidthPackage) FetchResourceDesc() *string {
	var returns *string
