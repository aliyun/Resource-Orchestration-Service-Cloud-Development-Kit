...
func (r *jsiiProxy_RosCenRouteMap) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosCenRouteMap) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosCenRouteMap) FetchRosDependency() *[]*string {
	var returns *[]*string
