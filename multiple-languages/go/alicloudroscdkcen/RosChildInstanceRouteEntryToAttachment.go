...
func (r *jsiiProxy_RosChildInstanceRouteEntryToAttachment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosChildInstanceRouteEntryToAttachment) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosChildInstanceRouteEntryToAttachment) FetchRosDependency() *[]*string {
	var returns *[]*string
