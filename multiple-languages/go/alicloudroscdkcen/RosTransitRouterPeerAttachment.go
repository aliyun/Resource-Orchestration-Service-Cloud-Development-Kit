...
// The jsii proxy struct for RosTransitRouterPeerAttachment
type jsiiProxy_RosTransitRouterPeerAttachment struct {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) AutoPublishRouteEnabled() interface{} {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) Bandwidth() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"bandwidth",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) CenBandwidthPackageId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) CenId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"cenId",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) PeerTransitRouterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"peerTransitRouterId",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) PeerTransitRouterRegionId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) RosOptions() alicloudroscdkcore.IRosResourceOptions {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) RosProperties() *map[string]interface{} {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) RosResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rosResourceType",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) Stack() alicloudroscdkcore.Stack {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) TransitRouterAttachmentName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) TransitRouterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"transitRouterId",
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func NewRosTransitRouterPeerAttachment(scope alicloudroscdkcore.Construct, id *string, props *RosTransitRouterPeerAttachmentProps, enableResourcePropertyConstraint *bool) RosTransitRouterPeerAttachment {
	...
	if err := validateNewRosTransitRouterPeerAttachmentParameters(scope, id, props, enableResourcePropertyConstraint); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetAutoPublishRouteEnabled(val interface{}) {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetBandwidth(val interface{}) {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetCenId(val interface{}) {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetPeerTransitRouterId(val interface{}) {
	if err := j.validateSetPeerTransitRouterIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetPeerTransitRouterRegionId(val interface{}) {
	if err := j.validateSetPeerTransitRouterRegionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetTransitRouterAttachmentDescription(val interface{}) {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetTransitRouterAttachmentName(val interface{}) {
...
func (j *jsiiProxy_RosTransitRouterPeerAttachment)SetTransitRouterId(val interface{}) {
...
func RosTransitRouterPeerAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateRosTransitRouterPeerAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RosTransitRouterPeerAttachment_IsRosElement(x interface{}) *bool {
	...
	if err := validateRosTransitRouterPeerAttachment_IsRosElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RosTransitRouterPeerAttachment_IsRosResource(construct alicloudroscdkcore.IConstruct) *bool {
	...
	if err := validateRosTransitRouterPeerAttachment_IsRosResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddCondition(con alicloudroscdkcore.RosCondition) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddCount(count interface{}) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddDeletionOverride(path *string) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddDependsOn(target alicloudroscdkcore.RosResource) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddDesc(desc *string) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddMetaData(key *string, value interface{}) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddOverride(path *string, value interface{}) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddPropertyDeletionOverride(propertyPath *string) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) AddRosDependency(target *string) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy, options *alicloudroscdkcore.RemovalPolicyOptions) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) FetchRosDependency() *[]*string {
	var returns *[]*string
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) GetAtt(attributeName *string) alicloudroscdkcore.Reference {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) OnPrepare() {
	_jsii_.InvokeVoid(
		r,
		"onPrepare",
		nil, // no parameters
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) OnSynthesize(session constructs.ISynthesisSession) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) OnValidate() *[]*string {
	var returns *[]*string
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) Prepare() {
	_jsii_.InvokeVoid(
		r,
		"prepare",
		nil, // no parameters
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) ToString() *string {
	var returns *string
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) Validate() *[]*string {
	var returns *[]*string
...
func (r *jsiiProxy_RosTransitRouterPeerAttachment) ValidateProperties(_properties interface{}) {
