...
func (r *jsiiProxy_RosTransitRouterVpnAttachment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosTransitRouterVpnAttachment) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosTransitRouterVpnAttachment) FetchRosDependency() *[]*string {
	var returns *[]*string
