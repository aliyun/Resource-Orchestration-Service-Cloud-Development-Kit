...
func (r *jsiiProxy_RosHostGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosHostGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosHostGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
