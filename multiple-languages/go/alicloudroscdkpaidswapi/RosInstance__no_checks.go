...
func (j *jsiiProxy_RosInstance) validateSetAccessibilityParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetDatasetsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetEcsSpecParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetEnvironmentVariablesParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetImageUrlParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetLabelsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetSaveImageParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetUserVpcParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetWorkspaceIdParameters(val interface{}) error {
	return nil
}
