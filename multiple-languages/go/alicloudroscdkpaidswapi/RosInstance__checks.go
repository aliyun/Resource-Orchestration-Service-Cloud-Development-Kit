...
func (j *jsiiProxy_RosInstance) validateSetDatasetsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosInstance_DatasetsProperty:
				v := v.(*RosInstance_DatasetsProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosInstance_DatasetsProperty:
				v_ := v.(RosInstance_DatasetsProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_DatasetsProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_RosInstance) validateSetLabelsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosInstance_LabelsProperty:
				v := v.(*RosInstance_LabelsProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosInstance_LabelsProperty:
				v_ := v.(RosInstance_LabelsProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_LabelsProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_RosInstance) validateSetUserVpcParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_UserVpcProperty:
		val := val.(*RosInstance_UserVpcProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_UserVpcProperty:
		val_ := val.(RosInstance_UserVpcProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_UserVpcProperty; received %#v (a %T)", val, val)
		}
	}
