...
func (j *jsiiProxy_RosInstances) validateSetAccessibilityParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstances) validateSetWorkspaceIdParameters(val interface{}) error {
	return nil
}
