...
import (
	_init_ "github.com/alibabacloud-go/ros-cdk/alicloudroscdkpaidswapi/jsii"
...
func (j *jsiiProxy_RosInstances) Accessibility() interface{} {
...
func (j *jsiiProxy_RosInstances) WorkspaceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workspaceId",
...
func NewRosInstances(scope alicloudroscdkcore.Construct, id *string, props *RosInstancesProps, enableResourcePropertyConstraint *bool) RosInstances {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-paidswapi.datasource.RosInstances",
...
func (j *jsiiProxy_RosInstances)SetAccessibility(val interface{}) {
...
func (j *jsiiProxy_RosInstances)SetWorkspaceId(val interface{}) {
