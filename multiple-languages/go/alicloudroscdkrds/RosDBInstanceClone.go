...
func (r *jsiiProxy_RosDBInstanceClone) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDBInstanceClone) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDBInstanceClone) FetchRosDependency() *[]*string {
	var returns *[]*string
