...
func (j *jsiiProxy_DBInstanceClone) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DBInstanceClone) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_DBInstanceClone) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DBInstanceClone) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_DBInstanceClone) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_DBInstanceClone) Props() *DBInstanceCloneProps {
...
func (j *jsiiProxy_DBInstanceClone) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_DBInstanceClone) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_DBInstanceClone) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_DBInstanceClone) Stack() alicloudroscdkcore.Stack {
...
func NewDBInstanceClone(scope alicloudroscdkcore.Construct, id *string, props *DBInstanceCloneProps, enableResourcePropertyConstraint *bool) DBInstanceClone {
	_init_.Initialize()

	if err := validateNewDBInstanceCloneParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
func NewDBInstanceClone_Override(d DBInstanceClone, scope alicloudroscdkcore.Construct, id *string, props *DBInstanceCloneProps, enableResourcePropertyConstraint *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DBInstanceClone)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_DBInstanceClone)SetId(val *string) {
...
func (j *jsiiProxy_DBInstanceClone)SetScope(val alicloudroscdkcore.Construct) {
...
func DBInstanceClone_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDBInstanceClone_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DBInstanceClone) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (d *jsiiProxy_DBInstanceClone) AddCount(count interface{}) {
...
func (d *jsiiProxy_DBInstanceClone) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (d *jsiiProxy_DBInstanceClone) AddResourceDesc(desc *string) {
...
func (d *jsiiProxy_DBInstanceClone) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (d *jsiiProxy_DBInstanceClone) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (d *jsiiProxy_DBInstanceClone) OnPrepare() {
	_jsii_.InvokeVoid(
		d,
		"onPrepare",
		nil, // no parameters
...
func (d *jsiiProxy_DBInstanceClone) OnSynthesize(session constructs.ISynthesisSession) {
...
func (d *jsiiProxy_DBInstanceClone) OnValidate() *[]*string {
	var returns *[]*string
...
func (d *jsiiProxy_DBInstanceClone) Prepare() {
	_jsii_.InvokeVoid(
		d,
		"prepare",
		nil, // no parameters
...
func (d *jsiiProxy_DBInstanceClone) SetMetadata(key *string, value interface{}) {
...
func (d *jsiiProxy_DBInstanceClone) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (d *jsiiProxy_DBInstanceClone) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DBInstanceClone) Validate() *[]*string {
	var returns *[]*string
