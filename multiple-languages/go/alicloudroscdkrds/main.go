...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DBProxy{}
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IDBProxy)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-rds.DBProxyProps",
		reflect.TypeOf((*DBProxyProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-rds.IDBProxy",
		reflect.TypeOf((*IDBProxy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RosDBProxy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dbInstanceId", GoGetter: "DbInstanceId"},
			_jsii_.MemberProperty{JsiiProperty: "dbProxyInstanceNum", GoGetter: "DbProxyInstanceNum"},
			_jsii_.MemberProperty{JsiiProperty: "dbProxyInstanceType", GoGetter: "DbProxyInstanceType"},
			_jsii_.MemberProperty{JsiiProperty: "dbProxyNodes", GoGetter: "DbProxyNodes"},
			_jsii_.MemberProperty{JsiiProperty: "enableResourcePropertyConstraint", GoGetter: "EnableResourcePropertyConstraint"},
			_jsii_.MemberMethod{JsiiMethod: "fetchCondition", GoMethod: "FetchCondition"},
			_jsii_.MemberMethod{JsiiMethod: "fetchDesc", GoMethod: "FetchDesc"},
			_jsii_.MemberMethod{JsiiMethod: "fetchRosDependency", GoMethod: "FetchRosDependency"},
			...
			_jsii_.MemberMethod{JsiiMethod: "onValidate", GoMethod: "OnValidate"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "persistentConnectionStatus", GoGetter: "PersistentConnectionStatus"},
			_jsii_.MemberMethod{JsiiMethod: "prepare", GoMethod: "Prepare"},
			_jsii_.MemberProperty{JsiiProperty: "ref", GoGetter: "Ref"},
			_jsii_.MemberMethod{JsiiMethod: "renderProperties", GoMethod: "RenderProperties"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupId", GoGetter: "ResourceGroupId"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-rds.RosDBProxy.DBProxyNodesProperty",
		reflect.TypeOf((*RosDBProxy_DBProxyNodesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-rds.RosDBProxyProps",
		reflect.TypeOf((*RosDBProxyProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
