...
func (j *jsiiProxy_RosPrepayDBInstance) DeletionProtection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deletionProtection",
...
func (j *jsiiProxy_RosPrepayDBInstance)SetDeletionProtection(val interface{}) {
...
func (r *jsiiProxy_RosPrepayDBInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosPrepayDBInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosPrepayDBInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
