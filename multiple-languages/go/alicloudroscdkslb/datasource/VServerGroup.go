...
func (j *jsiiProxy_VServerGroup) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VServerGroup) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_VServerGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VServerGroup) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_VServerGroup) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_VServerGroup) Props() *VServerGroupProps {
...
func (j *jsiiProxy_VServerGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_VServerGroup) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_VServerGroup) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_VServerGroup) Stack() alicloudroscdkcore.Stack {
...
func NewVServerGroup(scope alicloudroscdkcore.Construct, id *string, props *VServerGroupProps, enableResourcePropertyConstraint *bool) VServerGroup {
	...
	if err := validateNewVServerGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VServerGroup)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_VServerGroup)SetId(val *string) {
...
func (j *jsiiProxy_VServerGroup)SetScope(val alicloudroscdkcore.Construct) {
...
func VServerGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateVServerGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VServerGroup) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (v *jsiiProxy_VServerGroup) AddCount(count interface{}) {
...
func (v *jsiiProxy_VServerGroup) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (v *jsiiProxy_VServerGroup) AddResourceDesc(desc *string) {
...
func (v *jsiiProxy_VServerGroup) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (v *jsiiProxy_VServerGroup) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (v *jsiiProxy_VServerGroup) OnPrepare() {
	_jsii_.InvokeVoid(
		v,
		"onPrepare",
		nil, // no parameters
...
func (v *jsiiProxy_VServerGroup) OnSynthesize(session constructs.ISynthesisSession) {
...
func (v *jsiiProxy_VServerGroup) OnValidate() *[]*string {
	var returns *[]*string
...
func (v *jsiiProxy_VServerGroup) Prepare() {
	_jsii_.InvokeVoid(
		v,
		"prepare",
		nil, // no parameters
...
func (v *jsiiProxy_VServerGroup) SetMetadata(key *string, value interface{}) {
...
func (v *jsiiProxy_VServerGroup) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (v *jsiiProxy_VServerGroup) ToString() *string {
	var returns *string
...
func (v *jsiiProxy_VServerGroup) Validate() *[]*string {
	var returns *[]*string
