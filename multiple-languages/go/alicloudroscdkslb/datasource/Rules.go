...
func (j *jsiiProxy_Rules) AttrRuleIds() interface{} {
...
func (j *jsiiProxy_Rules) AttrRules() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrRules",
...
func (j *jsiiProxy_Rules) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (r *jsiiProxy_Rules) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_Rules) FetchDependency() *[]*string {
	var returns *[]*string
...
func (r *jsiiProxy_Rules) FetchResourceDesc() *string {
	var returns *string
