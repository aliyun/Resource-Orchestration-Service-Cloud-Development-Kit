...
func (j *jsiiProxy_RosRule) validateSetRefreshOptionsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosRule) validateSetRuleIdParameters(val interface{}) error {
	return nil
}
