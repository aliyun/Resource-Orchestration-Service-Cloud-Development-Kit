...
func (r *jsiiProxy_RosLoadBalancerClone) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosLoadBalancerClone) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosLoadBalancerClone) FetchRosDependency() *[]*string {
	var returns *[]*string
