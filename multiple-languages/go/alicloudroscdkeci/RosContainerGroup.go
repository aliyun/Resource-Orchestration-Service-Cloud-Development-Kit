...
func (r *jsiiProxy_RosContainerGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosContainerGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosContainerGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
