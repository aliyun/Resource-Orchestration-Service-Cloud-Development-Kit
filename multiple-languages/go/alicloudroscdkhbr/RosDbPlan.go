...
func (r *jsiiProxy_RosDbPlan) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDbPlan) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDbPlan) FetchRosDependency() *[]*string {
	var returns *[]*string
