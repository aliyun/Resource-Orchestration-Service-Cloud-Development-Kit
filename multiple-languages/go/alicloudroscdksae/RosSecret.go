...
type RosSecret interface {
	...
	AttrSecretId() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosSecret) AttrNamespaceId() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosSecret) AttrSecretId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrSecretId",
...
func (j *jsiiProxy_RosSecret) NamespaceId() interface{} {
...
func NewRosSecret(scope alicloudroscdkcore.Construct, id *string, props *RosSecretProps, enableResourcePropertyConstraint *bool) RosSecret {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-sae.RosSecret",
...
func (j *jsiiProxy_RosSecret)SetNamespaceId(val interface{}) {
...
func (r *jsiiProxy_RosSecret) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSecret) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSecret) FetchRosDependency() *[]*string {
	var returns *[]*string
