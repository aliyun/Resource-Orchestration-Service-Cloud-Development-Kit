...
func (r *jsiiProxy_RosIngress) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosIngress) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosIngress) FetchRosDependency() *[]*string {
	var returns *[]*string
