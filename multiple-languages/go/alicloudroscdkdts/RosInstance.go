...
type RosInstance interface {
	...
	SetComputeUnit(val interface{})
	// Returns: the stack trace of the point where this Resource was created from, sourced
	// from the +metadata+ entry typed +aliyun:ros:logicalId+, and with the bottom-most
	// node +internal+ entries filtered.
	CreationStack() *[]*string
	DatabaseCount() interface{}
	SetDatabaseCount(val interface{})
	DestinationEndpointEngineName() interface{}
	SetDestinationEndpointEngineName(val interface{})
	DestinationRegion() interface{}
	SetDestinationRegion(val interface{})
	Du() interface{}
	SetDu(val interface{})
	...
	SetSourceEndpointEngineName(val interface{})
	SourceRegion() interface{}
	SetSourceRegion(val interface{})
	// The stack in which this element is defined.
	//
	// RosElements must be defined within a stack scope (directly or indirectly).
	Stack() alicloudroscdkcore.Stack
	SyncArchitecture() interface{}
	SetSyncArchitecture(val interface{})
	Type() interface{}
...
func (j *jsiiProxy_RosInstance) AttrJobId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrJobId",
...
func (j *jsiiProxy_RosInstance) AutoStart() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoStart",
...
func (j *jsiiProxy_RosInstance) ComputeUnit() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"computeUnit",
...
func (j *jsiiProxy_RosInstance) DatabaseCount() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"databaseCount",
...
func (j *jsiiProxy_RosInstance) DestinationEndpointEngineName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) DestinationRegion() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"destinationRegion",
...
func (j *jsiiProxy_RosInstance) Du() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"du",
...
func (j *jsiiProxy_RosInstance) FeeType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"feeType",
...
func (j *jsiiProxy_RosInstance) JobId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"jobId",
...
func (j *jsiiProxy_RosInstance) SourceEndpointEngineName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) SourceRegion() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceRegion",
...
func (j *jsiiProxy_RosInstance) SyncArchitecture() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"syncArchitecture",
...
func (j *jsiiProxy_RosInstance) Type() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_RosInstance) UsedTime() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"usedTime",
...
func (j *jsiiProxy_RosInstance)SetAutoStart(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetComputeUnit(val interface{}) {
	if err := j.validateSetComputeUnitParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetDatabaseCount(val interface{}) {
	if err := j.validateSetDatabaseCountParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetDestinationEndpointEngineName(val interface{}) {
	if err := j.validateSetDestinationEndpointEngineNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetDestinationRegion(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetDu(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetFeeType(val interface{}) {
	if err := j.validateSetFeeTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetJobId(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetSourceEndpointEngineName(val interface{}) {
	if err := j.validateSetSourceEndpointEngineNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetSourceRegion(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetSyncArchitecture(val interface{}) {
	if err := j.validateSetSyncArchitectureParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetType(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetUsedTime(val interface{}) {
