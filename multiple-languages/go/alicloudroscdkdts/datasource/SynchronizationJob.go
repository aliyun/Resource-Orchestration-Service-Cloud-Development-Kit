...
func (j *jsiiProxy_SynchronizationJob) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SynchronizationJob) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_SynchronizationJob) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SynchronizationJob) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_SynchronizationJob) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_SynchronizationJob) Props() *SynchronizationJobProps {
...
func (j *jsiiProxy_SynchronizationJob) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_SynchronizationJob) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_SynchronizationJob) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_SynchronizationJob) Stack() alicloudroscdkcore.Stack {
...
func NewSynchronizationJob(scope alicloudroscdkcore.Construct, id *string, props *SynchronizationJobProps, enableResourcePropertyConstraint *bool) SynchronizationJob {
	...
	if err := validateNewSynchronizationJobParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SynchronizationJob)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_SynchronizationJob)SetId(val *string) {
...
func (j *jsiiProxy_SynchronizationJob)SetScope(val alicloudroscdkcore.Construct) {
...
func SynchronizationJob_IsConstruct(x interface{}) *bool {
	...
	if err := validateSynchronizationJob_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SynchronizationJob) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (s *jsiiProxy_SynchronizationJob) AddCount(count interface{}) {
...
func (s *jsiiProxy_SynchronizationJob) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (s *jsiiProxy_SynchronizationJob) AddResourceDesc(desc *string) {
...
func (s *jsiiProxy_SynchronizationJob) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (s *jsiiProxy_SynchronizationJob) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (s *jsiiProxy_SynchronizationJob) OnPrepare() {
	_jsii_.InvokeVoid(
		s,
		"onPrepare",
		nil, // no parameters
...
func (s *jsiiProxy_SynchronizationJob) OnSynthesize(session constructs.ISynthesisSession) {
...
func (s *jsiiProxy_SynchronizationJob) OnValidate() *[]*string {
	var returns *[]*string
...
func (s *jsiiProxy_SynchronizationJob) Prepare() {
	_jsii_.InvokeVoid(
		s,
		"prepare",
		nil, // no parameters
...
func (s *jsiiProxy_SynchronizationJob) SetMetadata(key *string, value interface{}) {
...
func (s *jsiiProxy_SynchronizationJob) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (s *jsiiProxy_SynchronizationJob) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SynchronizationJob) Validate() *[]*string {
	var returns *[]*string
