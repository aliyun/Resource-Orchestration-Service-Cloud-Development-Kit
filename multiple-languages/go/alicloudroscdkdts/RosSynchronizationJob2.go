...
func (r *jsiiProxy_RosSynchronizationJob2) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSynchronizationJob2) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSynchronizationJob2) FetchRosDependency() *[]*string {
	var returns *[]*string
