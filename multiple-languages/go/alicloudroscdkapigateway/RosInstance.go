...
func (j *jsiiProxy_RosInstance) HttpsPolicy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"httpsPolicy",
...
func (j *jsiiProxy_RosInstance) InstanceSpec() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"instanceSpec",
...
func (j *jsiiProxy_RosInstance)SetHttpsPolicy(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetInstanceSpec(val interface{}) {
