...
type jsiiProxy_Deployment struct {
	...
	jsiiProxy_IDeployment
}

func (j *jsiiProxy_Deployment) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Deployment) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_Deployment) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_Deployment) Props() *DeploymentProps {
...
func (j *jsiiProxy_Deployment) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_Deployment) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_Deployment) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_Deployment) Stack() alicloudroscdkcore.Stack {
...
func (j *jsiiProxy_Deployment)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_Deployment)SetResource(val alicloudroscdkcore.RosResource) {
	_jsii_.Set(
		j,
		"resource",
		val,
...
func (j *jsiiProxy_Deployment)SetScope(val alicloudroscdkcore.Construct) {
...
func (d *jsiiProxy_Deployment) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (d *jsiiProxy_Deployment) AddCount(count interface{}) {
...
func (d *jsiiProxy_Deployment) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (d *jsiiProxy_Deployment) AddResourceDesc(desc *string) {
...
func (d *jsiiProxy_Deployment) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (d *jsiiProxy_Deployment) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (d *jsiiProxy_Deployment) FetchDependency() *[]*string {
	var returns *[]*string
...
func (d *jsiiProxy_Deployment) FetchResourceDesc() *string {
	var returns *string
...
func (d *jsiiProxy_Deployment) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (d *jsiiProxy_Deployment) SetMetadata(key *string, value interface{}) {
...
func (d *jsiiProxy_Deployment) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
