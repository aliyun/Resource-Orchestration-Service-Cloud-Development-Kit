...
func (j *jsiiProxy_RosInstances) AttrApiGatewayInstanceIds() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosInstances) AttrApiGatewayInstances() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstances) Language() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"language",
...
func (j *jsiiProxy_RosInstances)SetLanguage(val interface{}) {
