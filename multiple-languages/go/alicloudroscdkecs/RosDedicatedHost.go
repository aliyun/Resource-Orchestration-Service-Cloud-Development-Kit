...
type RosDedicatedHost interface {
	...
	SetAutoPlacement(val interface{})
	...
	SetNetworkAttributesUdpTimeout(val interface{})
...
func (j *jsiiProxy_RosDedicatedHost) ActionOnMaintenance() interface{} {
...
func (j *jsiiProxy_RosDedicatedHost) AttrDedicatedHostIds() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosDedicatedHost) AttrOrderId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrOrderId",
...
func (j *jsiiProxy_RosDedicatedHost) AutoPlacement() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoPlacement",
...
func (j *jsiiProxy_RosDedicatedHost) AutoReleaseTime() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoReleaseTime",
...
func (j *jsiiProxy_RosDedicatedHost) AutoRenewPeriod() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoRenewPeriod",
...
func (j *jsiiProxy_RosDedicatedHost) ChargeType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"chargeType",
...
func (j *jsiiProxy_RosDedicatedHost) DedicatedHostName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dedicatedHostName",
...
func (j *jsiiProxy_RosDedicatedHost) DedicatedHostType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dedicatedHostType",
...
func (j *jsiiProxy_RosDedicatedHost) Description() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RosDedicatedHost) NetworkAttributesSlbUdpTimeout() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosDedicatedHost) NetworkAttributesUdpTimeout() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosDedicatedHost) PeriodUnit() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"periodUnit",
...
func (j *jsiiProxy_RosDedicatedHost) Quantity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"quantity",
...
func (j *jsiiProxy_RosDedicatedHost) ResourceGroupId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceGroupId",
...
func (j *jsiiProxy_RosDedicatedHost)SetActionOnMaintenance(val interface{}) {
	if err := j.validateSetActionOnMaintenanceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDedicatedHost)SetAutoPlacement(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetAutoReleaseTime(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetAutoRenewPeriod(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetChargeType(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetDedicatedHostType(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetDescription(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetNetworkAttributesSlbUdpTimeout(val interface{}) {
	if err := j.validateSetNetworkAttributesSlbUdpTimeoutParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDedicatedHost)SetNetworkAttributesUdpTimeout(val interface{}) {
	if err := j.validateSetNetworkAttributesUdpTimeoutParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDedicatedHost)SetPeriodUnit(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetQuantity(val interface{}) {
...
func (j *jsiiProxy_RosDedicatedHost)SetResourceGroupId(val interface{}) {
