...
type RosPrefixList interface {
	...
	SetAddressFamily(val interface{})
...
func (j *jsiiProxy_RosPrefixList) AddressFamily() interface{} {
...
func (j *jsiiProxy_RosPrefixList) Description() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RosPrefixList)SetAddressFamily(val interface{}) {
...
func (j *jsiiProxy_RosPrefixList)SetDescription(val interface{}) {
