...
func (j *jsiiProxy_Instance) AttrInnerIp() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrInnerIp",
...
func (j *jsiiProxy_Instance) AttrPrimaryNetworkInterfaceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Instance) AttrPublicIp() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrPublicIp",
