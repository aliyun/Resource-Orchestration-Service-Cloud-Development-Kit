...
func (r *jsiiProxy_RosNetworkInterface) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosNetworkInterface) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosNetworkInterface) FetchRosDependency() *[]*string {
	var returns *[]*string
