...
func (j *jsiiProxy_RosCommand) validateSetCommandContentParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCommand) validateSetContentEncodingParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCommand) validateSetDescriptionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCommand) validateSetEnableParameterParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosCommand) validateSetResourceGroupIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCommand) validateSetTagsParameters(val *[]*RosCommand_TagsProperty) error {
...
func (j *jsiiProxy_RosCommand) validateSetTimeoutParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosCommand) validateSetTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCommand) validateSetWorkingDirParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
