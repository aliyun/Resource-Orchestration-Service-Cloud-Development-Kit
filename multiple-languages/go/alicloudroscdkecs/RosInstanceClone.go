...
func (r *jsiiProxy_RosInstanceClone) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosInstanceClone) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosInstanceClone) FetchRosDependency() *[]*string {
	var returns *[]*string
