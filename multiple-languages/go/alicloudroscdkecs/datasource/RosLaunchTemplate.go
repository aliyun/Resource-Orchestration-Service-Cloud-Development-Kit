...
func (r *jsiiProxy_RosLaunchTemplate) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosLaunchTemplate) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosLaunchTemplate) FetchRosDependency() *[]*string {
	var returns *[]*string
