...
func (r *jsiiProxy_RosDedicatedHosts) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDedicatedHosts) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDedicatedHosts) FetchRosDependency() *[]*string {
	var returns *[]*string
