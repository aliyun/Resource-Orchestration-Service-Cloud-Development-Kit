...
func (r *jsiiProxy_RosDisks) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDisks) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDisks) FetchRosDependency() *[]*string {
	var returns *[]*string
