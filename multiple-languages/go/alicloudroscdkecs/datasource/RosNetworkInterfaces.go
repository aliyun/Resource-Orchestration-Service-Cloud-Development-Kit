...
func (r *jsiiProxy_RosNetworkInterfaces) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosNetworkInterfaces) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosNetworkInterfaces) FetchRosDependency() *[]*string {
	var returns *[]*string
