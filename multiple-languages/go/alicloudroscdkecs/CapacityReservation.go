...
type jsiiProxy_CapacityReservation struct {
	...
	jsiiProxy_ICapacityReservation
}

func (j *jsiiProxy_CapacityReservation) AttrPrivatePoolOptionsId() interface{} {
...
func (j *jsiiProxy_CapacityReservation) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (c *jsiiProxy_CapacityReservation) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (c *jsiiProxy_CapacityReservation) FetchDependency() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CapacityReservation) FetchResourceDesc() *string {
	var returns *string
