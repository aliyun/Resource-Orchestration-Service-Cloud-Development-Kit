...
func (j *jsiiProxy_InstanceGroupClone) AttrRelatedOrderIds() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrRelatedOrderIds",
...
func (j *jsiiProxy_InstanceGroupClone) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_InstanceGroupClone) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_InstanceGroupClone) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_InstanceGroupClone) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_InstanceGroupClone) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_InstanceGroupClone) Props() *InstanceGroupCloneProps {
...
func (j *jsiiProxy_InstanceGroupClone) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_InstanceGroupClone) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_InstanceGroupClone) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_InstanceGroupClone) Stack() alicloudroscdkcore.Stack {
...
func NewInstanceGroupClone(scope alicloudroscdkcore.Construct, id *string, props *InstanceGroupCloneProps, enableResourcePropertyConstraint *bool) InstanceGroupClone {
	_init_.Initialize()

	if err := validateNewInstanceGroupCloneParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
func NewInstanceGroupClone_Override(i InstanceGroupClone, scope alicloudroscdkcore.Construct, id *string, props *InstanceGroupCloneProps, enableResourcePropertyConstraint *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_InstanceGroupClone)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_InstanceGroupClone)SetId(val *string) {
...
func (j *jsiiProxy_InstanceGroupClone)SetScope(val alicloudroscdkcore.Construct) {
...
func InstanceGroupClone_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateInstanceGroupClone_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_InstanceGroupClone) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (i *jsiiProxy_InstanceGroupClone) AddCount(count interface{}) {
...
func (i *jsiiProxy_InstanceGroupClone) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (i *jsiiProxy_InstanceGroupClone) AddResourceDesc(desc *string) {
...
func (i *jsiiProxy_InstanceGroupClone) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (i *jsiiProxy_InstanceGroupClone) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (i *jsiiProxy_InstanceGroupClone) OnPrepare() {
	_jsii_.InvokeVoid(
		i,
		"onPrepare",
		nil, // no parameters
...
func (i *jsiiProxy_InstanceGroupClone) OnSynthesize(session constructs.ISynthesisSession) {
...
func (i *jsiiProxy_InstanceGroupClone) OnValidate() *[]*string {
	var returns *[]*string
...
func (i *jsiiProxy_InstanceGroupClone) Prepare() {
	_jsii_.InvokeVoid(
		i,
		"prepare",
		nil, // no parameters
...
func (i *jsiiProxy_InstanceGroupClone) SetMetadata(key *string, value interface{}) {
...
func (i *jsiiProxy_InstanceGroupClone) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (i *jsiiProxy_InstanceGroupClone) ToString() *string {
	var returns *string
...
func (i *jsiiProxy_InstanceGroupClone) Validate() *[]*string {
	var returns *[]*string
