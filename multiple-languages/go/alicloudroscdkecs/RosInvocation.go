...
func (r *jsiiProxy_RosInvocation) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosInvocation) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosInvocation) FetchRosDependency() *[]*string {
	var returns *[]*string
