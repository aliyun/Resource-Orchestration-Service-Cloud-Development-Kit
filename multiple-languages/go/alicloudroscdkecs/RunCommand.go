...
func (j *jsiiProxy_RunCommand) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RunCommand) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_RunCommand) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RunCommand) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_RunCommand) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_RunCommand) Props() *RunCommandProps {
...
func (j *jsiiProxy_RunCommand) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_RunCommand) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_RunCommand) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_RunCommand) Stack() alicloudroscdkcore.Stack {
...
func NewRunCommand(scope alicloudroscdkcore.Construct, id *string, props *RunCommandProps, enableResourcePropertyConstraint *bool) RunCommand {
	...
	if err := validateNewRunCommandParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RunCommand)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_RunCommand)SetId(val *string) {
...
func (j *jsiiProxy_RunCommand)SetScope(val alicloudroscdkcore.Construct) {
...
func RunCommand_IsConstruct(x interface{}) *bool {
	...
	if err := validateRunCommand_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RunCommand) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (r *jsiiProxy_RunCommand) AddCount(count interface{}) {
...
func (r *jsiiProxy_RunCommand) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (r *jsiiProxy_RunCommand) AddResourceDesc(desc *string) {
...
func (r *jsiiProxy_RunCommand) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (r *jsiiProxy_RunCommand) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (r *jsiiProxy_RunCommand) OnPrepare() {
	_jsii_.InvokeVoid(
		r,
		"onPrepare",
		nil, // no parameters
...
func (r *jsiiProxy_RunCommand) OnSynthesize(session constructs.ISynthesisSession) {
...
func (r *jsiiProxy_RunCommand) OnValidate() *[]*string {
	var returns *[]*string
...
func (r *jsiiProxy_RunCommand) Prepare() {
	_jsii_.InvokeVoid(
		r,
		"prepare",
		nil, // no parameters
...
func (r *jsiiProxy_RunCommand) SetMetadata(key *string, value interface{}) {
...
func (r *jsiiProxy_RunCommand) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (r *jsiiProxy_RunCommand) ToString() *string {
	var returns *string
...
func (r *jsiiProxy_RunCommand) Validate() *[]*string {
	var returns *[]*string
