...
func (r *jsiiProxy_RosImagePipeline) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosImagePipeline) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosImagePipeline) FetchRosDependency() *[]*string {
	var returns *[]*string
