...
func (j *jsiiProxy_SecurityGroup) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityGroup) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_SecurityGroup) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_SecurityGroup) Props() *SecurityGroupProps {
...
func (j *jsiiProxy_SecurityGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_SecurityGroup) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_SecurityGroup) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_SecurityGroup) Stack() alicloudroscdkcore.Stack {
...
func NewSecurityGroup(scope alicloudroscdkcore.Construct, id *string, props *SecurityGroupProps, enableResourcePropertyConstraint *bool) SecurityGroup {
	_init_.Initialize()
...
// Param scope - scope in which this resource is defined Param id    - scoped id of the resource Param props - resource properties.
func NewSecurityGroup_Override(s SecurityGroup, scope alicloudroscdkcore.Construct, id *string, props *SecurityGroupProps, enableResourcePropertyConstraint *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityGroup)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_SecurityGroup)SetScope(val alicloudroscdkcore.Construct) {
...
func (s *jsiiProxy_SecurityGroup) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (s *jsiiProxy_SecurityGroup) AddCount(count interface{}) {
...
func (s *jsiiProxy_SecurityGroup) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (s *jsiiProxy_SecurityGroup) AddResourceDesc(desc *string) {
...
func (s *jsiiProxy_SecurityGroup) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (s *jsiiProxy_SecurityGroup) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (s *jsiiProxy_SecurityGroup) SetMetadata(key *string, value interface{}) {
...
func (s *jsiiProxy_SecurityGroup) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
