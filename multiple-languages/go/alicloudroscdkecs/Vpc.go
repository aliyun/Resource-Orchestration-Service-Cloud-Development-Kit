...
func (j *jsiiProxy_Vpc) AttrRouteTableId() interface{} {
...
func (j *jsiiProxy_Vpc) AttrVRouterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrVRouterId",
...
func (j *jsiiProxy_Vpc) Env() alicloudroscdkcore.IResourceEnvironment {
