...
func (r *jsiiProxy_RosMultiZoneInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosMultiZoneInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosMultiZoneInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
