...
func (j *jsiiProxy_RosInstances) validateSetQueryStrParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstances) validateSetServiceTypeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstances) validateSetSupportEngineParameters(val interface{}) error {
	return nil
}
