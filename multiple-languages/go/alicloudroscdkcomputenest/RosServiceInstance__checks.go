...
func (j *jsiiProxy_RosServiceInstance) validateSetCommodityParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosServiceInstance_CommodityProperty:
		val := val.(*RosServiceInstance_CommodityProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosServiceInstance_CommodityProperty:
		val_ := val.(RosServiceInstance_CommodityProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosServiceInstance_CommodityProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosServiceInstance) validateSetServiceParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosServiceInstance_ServiceProperty:
		val := val.(*RosServiceInstance_ServiceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosServiceInstance_ServiceProperty:
		val_ := val.(RosServiceInstance_ServiceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosServiceInstance_ServiceProperty; received %#v (a %T)", val, val)
		}
	}
