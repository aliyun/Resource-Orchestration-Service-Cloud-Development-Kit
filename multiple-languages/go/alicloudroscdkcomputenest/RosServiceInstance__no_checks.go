...
func (j *jsiiProxy_RosServiceInstance) validateSetCommodityParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosServiceInstance) validateSetContactGroupParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosServiceInstance) validateSetOperationNameParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosServiceInstance) validateSetPredefinedParameterNameParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosServiceInstance) validateSetSpecificationCodeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosServiceInstance) validateSetTagsParameters(val *[]*RosServiceInstance_TagsProperty) error {
	return nil
}

func (j *jsiiProxy_RosServiceInstance) validateSetTemplateNameParameters(val interface{}) error {
	return nil
}
