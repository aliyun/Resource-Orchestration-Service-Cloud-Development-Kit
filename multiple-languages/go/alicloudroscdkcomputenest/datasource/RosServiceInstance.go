...
func (j *jsiiProxy_RosServiceInstance) RefreshOptions() interface{} {
...
func (j *jsiiProxy_RosServiceInstance) ServiceInstanceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceInstanceId",
...
func (j *jsiiProxy_RosServiceInstance)SetRefreshOptions(val interface{}) {
...
func (j *jsiiProxy_RosServiceInstance)SetServiceInstanceId(val interface{}) {
...
func (r *jsiiProxy_RosServiceInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosServiceInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosServiceInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
