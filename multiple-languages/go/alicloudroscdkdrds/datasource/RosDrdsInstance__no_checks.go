...
func (j *jsiiProxy_RosDrdsInstance) validateSetDrdsInstanceIdParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosDrdsInstance) validateSetRefreshOptionsParameters(val interface{}) error {
	return nil
}
