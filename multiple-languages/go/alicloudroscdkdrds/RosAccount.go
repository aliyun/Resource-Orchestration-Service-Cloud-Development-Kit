...
type RosAccount interface {
	...
	AttrDbPrivileges() alicloudroscdkcore.IResolvable
	AttrDescription() alicloudroscdkcore.IResolvable
	AttrDrdsAccountName() alicloudroscdkcore.IResolvable
	...
	SetDbPrivileges(val interface{})
	Description() interface{}
	SetDescription(val interface{})
	DrdsAccountName() interface{}
	SetDrdsAccountName(val interface{})
...
func (j *jsiiProxy_RosAccount) AttrDbPrivileges() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrDbPrivileges",
...
func (j *jsiiProxy_RosAccount) AttrDescription() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrDescription",
...
func (j *jsiiProxy_RosAccount) AttrDrdsAccountName() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrDrdsAccountName",
...
func (j *jsiiProxy_RosAccount) AttrHost() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrHost",
...
func (j *jsiiProxy_RosAccount) DbPrivileges() interface{} {
...
func (j *jsiiProxy_RosAccount) Description() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_RosAccount) DrdsAccountName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"drdsAccountName",
...
func (j *jsiiProxy_RosAccount) InstanceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_RosAccount) Password() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"password",
...
func NewRosAccount(scope alicloudroscdkcore.Construct, id *string, props *RosAccountProps, enableResourcePropertyConstraint *bool) RosAccount {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-drds.RosAccount",
...
func (j *jsiiProxy_RosAccount)SetDbPrivileges(val interface{}) {
	if err := j.validateSetDbPrivilegesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosAccount)SetDescription(val interface{}) {
...
func (j *jsiiProxy_RosAccount)SetDrdsAccountName(val interface{}) {
	if err := j.validateSetDrdsAccountNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosAccount)SetInstanceId(val interface{}) {
...
func (j *jsiiProxy_RosAccount)SetPassword(val interface{}) {
...
func (r *jsiiProxy_RosAccount) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosAccount) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosAccount) FetchRosDependency() *[]*string {
	var returns *[]*string
