...
func (j *jsiiProxy_Cluster) AttrHostGroups() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrHostGroups",
...
func (j *jsiiProxy_Cluster) AttrMasterNodeInnerIps() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Cluster) AttrMasterNodePubIps() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
