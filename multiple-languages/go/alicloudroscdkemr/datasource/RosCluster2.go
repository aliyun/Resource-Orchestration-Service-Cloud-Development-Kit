...
type RosCluster2 interface {
	...
	SetClusterIds(val interface{})
	ClusterName() interface{}
	SetClusterName(val interface{})
	ClusterStates() interface{}
	SetClusterStates(val interface{})
...
func (j *jsiiProxy_RosCluster2) AttrClusterIds() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosCluster2) AttrClusters() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrClusters",
...
func (j *jsiiProxy_RosCluster2) ClusterIds() interface{} {
...
func (j *jsiiProxy_RosCluster2) ClusterStates() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"clusterStates",
...
func (j *jsiiProxy_RosCluster2) PaymentTypes() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"paymentTypes",
...
func (j *jsiiProxy_RosCluster2) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func (j *jsiiProxy_RosCluster2)SetClusterIds(val interface{}) {
...
func (j *jsiiProxy_RosCluster2)SetClusterStates(val interface{}) {
...
func (j *jsiiProxy_RosCluster2)SetPaymentTypes(val interface{}) {
	if err := j.validateSetPaymentTypesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosCluster2)SetRefreshOptions(val interface{}) {
...
func (r *jsiiProxy_RosCluster2) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosCluster2) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosCluster2) FetchRosDependency() *[]*string {
	var returns *[]*string
