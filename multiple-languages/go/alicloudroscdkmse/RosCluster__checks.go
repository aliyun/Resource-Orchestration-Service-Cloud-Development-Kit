...
func (j *jsiiProxy_RosCluster) validateSetClusterAliasNameParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetClusterSpecificationParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosCluster) validateSetClusterVersionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetConnectionTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetInstanceCountParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosCluster) validateSetMseVersionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetRequestParsParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
