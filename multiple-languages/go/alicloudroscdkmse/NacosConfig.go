...
func (j *jsiiProxy_NacosConfig) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (n *jsiiProxy_NacosConfig) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (n *jsiiProxy_NacosConfig) FetchDependency() *[]*string {
	var returns *[]*string
...
func (n *jsiiProxy_NacosConfig) FetchResourceDesc() *string {
	var returns *string
