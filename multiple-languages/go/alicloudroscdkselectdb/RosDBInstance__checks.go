...
func (j *jsiiProxy_RosDBInstance) validateSetAccountPasswordParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetCacheSizeParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosDBInstance) validateSetChargeTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDBInstance) validateSetConnectionStringParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetUsedTimeParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
