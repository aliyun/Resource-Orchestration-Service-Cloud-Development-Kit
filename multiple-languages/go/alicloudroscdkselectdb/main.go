...
func init() {
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-selectdb.DBInstance",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrVpcConnectionString", GoGetter: "AttrVpcConnectionString"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-selectdb.DBInstanceProps",
		reflect.TypeOf((*DBInstanceProps)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-selectdb.IDBInstance",
	...
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-selectdb.RosDBInstance",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-selectdb.RosDBInstance.TagsProperty",
		reflect.TypeOf((*RosDBInstance_TagsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-selectdb.RosDBInstanceProps",
