...
type jsiiProxy_Dashboard struct {
	...
	jsiiProxy_IDashboard
}

func (j *jsiiProxy_Dashboard) AttrDashboardName() interface{} {
...
func (j *jsiiProxy_Dashboard) AttrDisplayName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrDisplayName",
...
func (j *jsiiProxy_Dashboard) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (d *jsiiProxy_Dashboard) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (d *jsiiProxy_Dashboard) FetchDependency() *[]*string {
	var returns *[]*string
...
func (d *jsiiProxy_Dashboard) FetchResourceDesc() *string {
	var returns *string
