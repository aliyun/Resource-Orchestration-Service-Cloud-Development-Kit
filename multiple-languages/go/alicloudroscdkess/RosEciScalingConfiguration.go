...
func (r *jsiiProxy_RosEciScalingConfiguration) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosEciScalingConfiguration) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosEciScalingConfiguration) FetchRosDependency() *[]*string {
	var returns *[]*string
