...
func (r *jsiiProxy_RosRun) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosRun) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosRun) FetchRosDependency() *[]*string {
	var returns *[]*string
