...
func (j *jsiiProxy_Image) AttrAccessibility() interface{} {
...
func (j *jsiiProxy_Image) AttrImageUri() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrImageUri",
...
func (j *jsiiProxy_Image) AttrLabels() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrLabels",
...
func (j *jsiiProxy_Image) AttrWorkspaceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrWorkspaceId",
