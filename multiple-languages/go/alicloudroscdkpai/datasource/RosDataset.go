...
func (j *jsiiProxy_RosDataset) DatasetId() interface{} {
...
func (j *jsiiProxy_RosDataset) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func (j *jsiiProxy_RosDataset)SetDatasetId(val interface{}) {
...
func (j *jsiiProxy_RosDataset)SetRefreshOptions(val interface{}) {
