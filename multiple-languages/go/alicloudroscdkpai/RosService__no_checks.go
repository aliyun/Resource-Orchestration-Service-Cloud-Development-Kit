...
func (j *jsiiProxy_RosService) validateSetDevelopParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosService) validateSetLabelsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosService) validateSetServiceConfigParameters(val interface{}) error {
	return nil
}
