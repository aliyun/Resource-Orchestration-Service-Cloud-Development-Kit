...
import (
	_init_ "alicloudroscdkeventbridge/jsii"

	"alicloudroscdkcore"
	"alicloudroscdkeventbridge/internal"
...
type RosRule interface {
	...
	SetEventBusName(val interface{})
	FilterPattern() interface{}
	SetFilterPattern(val interface{})
...
func (j *jsiiProxy_RosRule) AttrEventBusName() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosRule) AttrRuleArn() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrRuleArn",
...
func (j *jsiiProxy_RosRule) EventBusName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"eventBusName",
...
func (j *jsiiProxy_RosRule) FilterPattern() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterPattern",
...
func (j *jsiiProxy_RosRule) Status() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_RosRule) Targets() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targets",
...
func (j *jsiiProxy_RosRule)SetEventBusName(val interface{}) {
...
func (j *jsiiProxy_RosRule)SetFilterPattern(val interface{}) {
...
func (j *jsiiProxy_RosRule)SetStatus(val interface{}) {
...
func (j *jsiiProxy_RosRule)SetTargets(val interface{}) {
