...
type RosInstance interface {
	...
	SetDnsSecurity(val interface{})
	Domain() interface{}
	SetDomain(val interface{})
	DomainNumbers() interface{}
	SetDomainNumbers(val interface{})
...
func (j *jsiiProxy_RosInstance) DnsSecurity() interface{} {
...
func (j *jsiiProxy_RosInstance) Domain() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_RosInstance) DomainNumbers() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"domainNumbers",
...
func (j *jsiiProxy_RosInstance)SetDnsSecurity(val interface{}) {
	if err := j.validateSetDnsSecurityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetDomain(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetDomainNumbers(val interface{}) {
	if err := j.validateSetDomainNumbersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
