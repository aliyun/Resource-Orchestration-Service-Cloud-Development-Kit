...
func (j *jsiiProxy_RosInstance) validateSetDnsSecurityParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetDomainParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosInstance) validateSetDomainNumbersParameters(val interface{}) error {
	return nil
}
