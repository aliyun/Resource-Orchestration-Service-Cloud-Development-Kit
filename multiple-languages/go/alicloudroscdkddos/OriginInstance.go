...
type jsiiProxy_OriginInstance struct {
	...
	jsiiProxy_IOriginInstance
}

func (j *jsiiProxy_OriginInstance) AttrArn() interface{} {
...
func (j *jsiiProxy_OriginInstance) AttrInstanceId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrInstanceId",
...
func (j *jsiiProxy_OriginInstance) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (o *jsiiProxy_OriginInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (o *jsiiProxy_OriginInstance) FetchDependency() *[]*string {
	var returns *[]*string
...
func (o *jsiiProxy_OriginInstance) FetchResourceDesc() *string {
	var returns *string
