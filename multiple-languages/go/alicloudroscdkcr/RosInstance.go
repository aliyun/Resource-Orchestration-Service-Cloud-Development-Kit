...
type RosInstance interface {
	...
	SetImageScanner(val interface{})
	InstanceName() interface{}
	SetInstanceName(val interface{})
	InstanceStorageName() interface{}
	SetInstanceStorageName(val interface{})
...
func (j *jsiiProxy_RosInstance) AttrInstanceSpecification() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosInstance) AttrModifiedTime() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrModifiedTime",
...
func (j *jsiiProxy_RosInstance) ImageScanner() interface{} {
...
func (j *jsiiProxy_RosInstance) InstanceStorageName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"instanceStorageName",
...
func (j *jsiiProxy_RosInstance)SetImageScanner(val interface{}) {
	if err := j.validateSetImageScannerParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosInstance)SetInstanceStorageName(val interface{}) {
	if err := j.validateSetInstanceStorageNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
