...
func init() {
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-cr.datasource.IInstance",
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-cr.datasource.IInstances",
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-cr.datasource.INamespaces",
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-cr.datasource.IRepositories",
		reflect.TypeOf((*IRepositories)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IRepositories)
			return &j
		},
	)
	_jsii_.RegisterStruct(
