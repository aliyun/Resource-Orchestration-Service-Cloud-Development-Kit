...
func (r *jsiiProxy_RosResourceCleaner) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosResourceCleaner) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosResourceCleaner) FetchRosDependency() *[]*string {
	var returns *[]*string
