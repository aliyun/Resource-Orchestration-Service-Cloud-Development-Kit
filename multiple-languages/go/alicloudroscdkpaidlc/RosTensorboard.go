...
func (r *jsiiProxy_RosTensorboard) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosTensorboard) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosTensorboard) FetchRosDependency() *[]*string {
	var returns *[]*string
