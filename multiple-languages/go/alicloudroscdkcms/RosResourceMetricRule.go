...
func (r *jsiiProxy_RosResourceMetricRule) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosResourceMetricRule) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosResourceMetricRule) FetchRosDependency() *[]*string {
	var returns *[]*string
