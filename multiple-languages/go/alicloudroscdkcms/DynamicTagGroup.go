...
type jsiiProxy_DynamicTagGroup struct {
	...
	jsiiProxy_IDynamicTagGroup
}

func (j *jsiiProxy_DynamicTagGroup) AttrDynamicTagRuleId() interface{} {
...
func (j *jsiiProxy_DynamicTagGroup) AttrTagKey() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrTagKey",
...
func (j *jsiiProxy_DynamicTagGroup) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (d *jsiiProxy_DynamicTagGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (d *jsiiProxy_DynamicTagGroup) FetchDependency() *[]*string {
	var returns *[]*string
...
func (d *jsiiProxy_DynamicTagGroup) FetchResourceDesc() *string {
	var returns *string
