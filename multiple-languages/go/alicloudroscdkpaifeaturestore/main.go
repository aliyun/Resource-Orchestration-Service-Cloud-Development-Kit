...
func init() {
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-paifeaturestore.Datasource",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-paifeaturestore.DatasourceProps",
		reflect.TypeOf((*DatasourceProps)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-paifeaturestore.IDatasource",
	...
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-paifeaturestore.RosDatasource",
		reflect.TypeOf((*RosDatasource)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
		...
		func() interface{} {
			j := jsiiProxy_RosDatasource{}
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreRosResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-paifeaturestore.RosDatasourceProps",
		reflect.TypeOf((*RosDatasourceProps)(nil)).Elem(),
	)
}
