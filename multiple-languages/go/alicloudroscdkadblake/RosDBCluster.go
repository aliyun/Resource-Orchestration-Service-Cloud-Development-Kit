...
import (
	_init_ "alicloudroscdkadblake/jsii"

	"alicloudroscdkadblake/internal"
	"alicloudroscdkcore"
...
type RosDBCluster interface {
	...
	SetRestoreToTime(val interface{})
	...
	SetStorageResource(val interface{})
...
func (j *jsiiProxy_RosDBCluster) BackupSetId() interface{} {
...
func (j *jsiiProxy_RosDBCluster) EnableDefaultResourcePool() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosDBCluster) RestoreToTime() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"restoreToTime",
...
func (j *jsiiProxy_RosDBCluster) RestoreType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"restoreType",
...
func (j *jsiiProxy_RosDBCluster) SourceDbClusterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceDbClusterId",
...
func (j *jsiiProxy_RosDBCluster) StorageResource() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"storageResource",
...
func (j *jsiiProxy_RosDBCluster)SetBackupSetId(val interface{}) {
...
func (j *jsiiProxy_RosDBCluster)SetEnableDefaultResourcePool(val interface{}) {
	if err := j.validateSetEnableDefaultResourcePoolParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDBCluster)SetRestoreToTime(val interface{}) {
...
func (j *jsiiProxy_RosDBCluster)SetRestoreType(val interface{}) {
...
func (j *jsiiProxy_RosDBCluster)SetSourceDbClusterId(val interface{}) {
	if err := j.validateSetSourceDbClusterIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDBCluster)SetStorageResource(val interface{}) {
	if err := j.validateSetStorageResourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
