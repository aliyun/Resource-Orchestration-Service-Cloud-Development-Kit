...
func (j *jsiiProxy_RosAccount) DbClusterId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dbClusterId",
...
func (j *jsiiProxy_RosAccount) Engine() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"engine",
...
func (j *jsiiProxy_RosAccount) RamUser() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ramUser",
...
func (j *jsiiProxy_RosAccount)SetDbClusterId(val interface{}) {
...
func (j *jsiiProxy_RosAccount)SetEngine(val interface{}) {
...
func (j *jsiiProxy_RosAccount)SetRamUser(val interface{}) {
	if err := j.validateSetRamUserParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
