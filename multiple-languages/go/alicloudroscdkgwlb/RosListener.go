...
type RosListener interface {
	...
	AttrListenerDescription() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosListener) AttrListenerDescription() alicloudroscdkcore.IResolvable {
...
func (j *jsiiProxy_RosListener) AttrServerGroupId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrServerGroupId",
...
func (j *jsiiProxy_RosListener) AttrTags() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrTags",
...
func NewRosListener(scope alicloudroscdkcore.Construct, id *string, props *RosListenerProps, enableResourcePropertyConstraint *bool) RosListener {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-gwlb.RosListener",
