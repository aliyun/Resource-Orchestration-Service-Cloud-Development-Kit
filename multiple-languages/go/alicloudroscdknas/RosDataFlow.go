...
func (r *jsiiProxy_RosDataFlow) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDataFlow) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDataFlow) FetchRosDependency() *[]*string {
	var returns *[]*string
