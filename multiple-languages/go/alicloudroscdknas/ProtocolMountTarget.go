...
func (j *jsiiProxy_ProtocolMountTarget) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ProtocolMountTarget) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ProtocolMountTarget) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_ProtocolMountTarget) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_ProtocolMountTarget) Props() *ProtocolMountTargetProps {
...
func (j *jsiiProxy_ProtocolMountTarget) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_ProtocolMountTarget) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_ProtocolMountTarget) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_ProtocolMountTarget) Stack() alicloudroscdkcore.Stack {
...
func NewProtocolMountTarget(scope alicloudroscdkcore.Construct, id *string, props *ProtocolMountTargetProps, enableResourcePropertyConstraint *bool) ProtocolMountTarget {
	...
	if err := validateNewProtocolMountTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ProtocolMountTarget)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_ProtocolMountTarget)SetId(val *string) {
...
func (j *jsiiProxy_ProtocolMountTarget)SetScope(val alicloudroscdkcore.Construct) {
...
func ProtocolMountTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateProtocolMountTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProtocolMountTarget) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (p *jsiiProxy_ProtocolMountTarget) AddCount(count interface{}) {
...
func (p *jsiiProxy_ProtocolMountTarget) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (p *jsiiProxy_ProtocolMountTarget) AddResourceDesc(desc *string) {
...
func (p *jsiiProxy_ProtocolMountTarget) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (p *jsiiProxy_ProtocolMountTarget) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (p *jsiiProxy_ProtocolMountTarget) OnPrepare() {
	_jsii_.InvokeVoid(
		p,
		"onPrepare",
		nil, // no parameters
...
func (p *jsiiProxy_ProtocolMountTarget) OnSynthesize(session constructs.ISynthesisSession) {
...
func (p *jsiiProxy_ProtocolMountTarget) OnValidate() *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_ProtocolMountTarget) Prepare() {
	_jsii_.InvokeVoid(
		p,
		"prepare",
		nil, // no parameters
...
func (p *jsiiProxy_ProtocolMountTarget) SetMetadata(key *string, value interface{}) {
...
func (p *jsiiProxy_ProtocolMountTarget) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
...
func (p *jsiiProxy_ProtocolMountTarget) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_ProtocolMountTarget) Validate() *[]*string {
	var returns *[]*string
