...
func (j *jsiiProxy_RosCluster) validateSetOrderParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosCluster_OrderProperty:
		val := val.(*RosCluster_OrderProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosCluster_OrderProperty:
		val_ := val.(RosCluster_OrderProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosCluster_OrderProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosCluster) validateSetOrderIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosCluster) validateSetOssBucketParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
