...
func (j *jsiiProxy_RosDBInstance) validateSetDbNodeCountParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDBInstance) validateSetPrimaryZoneParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDBInstance) validateSetSecondaryZoneParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetSecurityIpConfigParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosDBInstance_SecurityIpConfigProperty:
		val := val.(*RosDBInstance_SecurityIpConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosDBInstance_SecurityIpConfigProperty:
		val_ := val.(RosDBInstance_SecurityIpConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosDBInstance_SecurityIpConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosDBInstance) validateSetTertiaryZoneParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetTopologyTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
