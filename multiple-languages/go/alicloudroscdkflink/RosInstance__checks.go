...
func (j *jsiiProxy_RosInstance) validateSetBucketParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosInstance) validateSetPromotionCodeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetResourceSpecParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_ResourceSpecProperty:
		val := val.(*RosInstance_ResourceSpecProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_ResourceSpecProperty:
		val_ := val.(RosInstance_ResourceSpecProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_ResourceSpecProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetUsePromotionCodeParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetVSwitchIdsParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
