...
type RosUser interface {
	...
	FirstName() interface{}
	SetFirstName(val interface{})
	LastName() interface{}
	SetLastName(val interface{})
...
func (j *jsiiProxy_RosUser) Description() interface{} {
...
func (j *jsiiProxy_RosUser) DirectoryId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"directoryId",
...
func (j *jsiiProxy_RosUser) FirstName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"firstName",
...
func (j *jsiiProxy_RosUser) LastName() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"lastName",
...
func (j *jsiiProxy_RosUser)SetDescription(val interface{}) {
...
func (j *jsiiProxy_RosUser)SetDirectoryId(val interface{}) {
...
func (j *jsiiProxy_RosUser)SetFirstName(val interface{}) {
...
func (j *jsiiProxy_RosUser)SetLastName(val interface{}) {
