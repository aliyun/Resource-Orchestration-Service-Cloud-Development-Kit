...
func (r *jsiiProxy_RosInstanceGroup) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosInstanceGroup) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosInstanceGroup) FetchRosDependency() *[]*string {
	var returns *[]*string
