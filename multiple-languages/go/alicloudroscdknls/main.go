...
func init() {
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-nls.ProjectProps",
		reflect.TypeOf((*ProjectProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-nls.RosProject",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-nls.RosProjectProps",
