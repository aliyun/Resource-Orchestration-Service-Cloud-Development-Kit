...
type RosDataset interface {
	...
	SetDatasetRecord(val interface{})
...
func (j *jsiiProxy_RosDataset) DatasetRecord() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"datasetRecord",
...
func (j *jsiiProxy_RosDataset) ProjectId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"projectId",
...
func NewRosDataset(scope alicloudroscdkcore.Construct, id *string, props *RosDatasetProps, enableResourcePropertyConstraint *bool) RosDataset {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-nlpautoml.RosDataset",
...
func (j *jsiiProxy_RosDataset)SetDatasetRecord(val interface{}) {
	if err := j.validateSetDatasetRecordParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosDataset)SetProjectId(val interface{}) {
