...
import (
	_init_ "github.com/alibabacloud-go/ros-cdk/alicloudroscdkdashvector/jsii"
...
func (j *jsiiProxy_RosCluster) AttrEndpoint() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrEndpoint",
...
func (j *jsiiProxy_RosCluster) IgnoreExisting() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ignoreExisting",
...
func (j *jsiiProxy_RosCluster) ReplicaCount() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"replicaCount",
...
func NewRosCluster(scope alicloudroscdkcore.Construct, id *string, props *RosClusterProps, enableResourcePropertyConstraint *bool) RosCluster {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-dashvector.RosCluster",
...
func (j *jsiiProxy_RosCluster)SetIgnoreExisting(val interface{}) {
...
func (j *jsiiProxy_RosCluster)SetReplicaCount(val interface{}) {
