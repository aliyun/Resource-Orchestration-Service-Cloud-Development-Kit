...
func init() {
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-imm.IProject2",
		reflect.TypeOf((*IProject2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Project2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IProject2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-imm.Project2Props",
		reflect.TypeOf((*Project2Props)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RosProject2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrProjectName", GoGetter: "AttrProjectName"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "datasetMaxBindCount", GoGetter: "DatasetMaxBindCount"},
			_jsii_.MemberProperty{JsiiProperty: "datasetMaxEntityCount", GoGetter: "DatasetMaxEntityCount"},
			_jsii_.MemberProperty{JsiiProperty: "datasetMaxFileCount", GoGetter: "DatasetMaxFileCount"},
			_jsii_.MemberProperty{JsiiProperty: "datasetMaxRelationCount", GoGetter: "DatasetMaxRelationCount"},
			_jsii_.MemberProperty{JsiiProperty: "datasetMaxTotalFileSize", GoGetter: "DatasetMaxTotalFileSize"},
			...
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "prepare", GoMethod: "Prepare"},
			_jsii_.MemberProperty{JsiiProperty: "projectMaxDatasetCount", GoGetter: "ProjectMaxDatasetCount"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-imm.RosProject2Props",
		reflect.TypeOf((*RosProject2Props)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
