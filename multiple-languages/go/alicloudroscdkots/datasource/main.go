...
func init() {
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-ots.datasource.IInstances",
		reflect.TypeOf((*IInstances)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attrInstanceNames", GoGetter: "AttrInstanceNames"},
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-ots.datasource.ITables",
		reflect.TypeOf((*ITables)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attrTableNames", GoGetter: "AttrTableNames"},
			_jsii_.MemberProperty{JsiiProperty: "attrTables", GoGetter: "AttrTables"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ots.datasource.InstancesProps",
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ots.datasource.RosInstancesProps",
		reflect.TypeOf((*RosInstancesProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-ots.datasource.RosTables",
		reflect.TypeOf((*RosTables)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ots.datasource.RosTablesProps",
		reflect.TypeOf((*RosTablesProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-ots.datasource.Tables",
		reflect.TypeOf((*Tables)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
		...
		func() interface{} {
			j := jsiiProxy_Tables{}
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_ITables)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ots.datasource.TablesProps",
		reflect.TypeOf((*TablesProps)(nil)).Elem(),
	)
}
