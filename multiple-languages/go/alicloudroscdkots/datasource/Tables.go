...
func (j *jsiiProxy_Tables) AttrTableNames() interface{} {
...
func (j *jsiiProxy_Tables) AttrTables() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrTables",
...
func (j *jsiiProxy_Tables) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (t *jsiiProxy_Tables) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (t *jsiiProxy_Tables) FetchDependency() *[]*string {
	var returns *[]*string
...
func (t *jsiiProxy_Tables) FetchResourceDesc() *string {
	var returns *string
