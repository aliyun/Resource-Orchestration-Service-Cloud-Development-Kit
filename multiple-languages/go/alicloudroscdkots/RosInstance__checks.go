...
func (j *jsiiProxy_RosInstance) validateSetClusterTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetNetworkParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
