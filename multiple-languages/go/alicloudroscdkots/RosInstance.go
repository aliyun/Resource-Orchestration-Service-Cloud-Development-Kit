...
type RosInstance interface {
	...
	AttrVpcEndpoint() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosInstance) AttrVpcEndpoint() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrVpcEndpoint",
...
func (j *jsiiProxy_RosInstance) ClusterType() interface{} {
...
func (j *jsiiProxy_RosInstance) Network() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_RosInstance)SetClusterType(val interface{}) {
...
func (j *jsiiProxy_RosInstance)SetNetwork(val interface{}) {
