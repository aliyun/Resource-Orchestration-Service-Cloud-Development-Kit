...
func (j *jsiiProxy_Instance) AttrPrivateEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrPrivateEndpoint",
...
func (j *jsiiProxy_Instance) AttrPublicEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrPublicEndpoint",
...
func (j *jsiiProxy_Instance) AttrVpcEndpoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrVpcEndpoint",
