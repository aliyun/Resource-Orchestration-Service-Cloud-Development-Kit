...
func (r *jsiiProxy_RosDownload) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDownload) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDownload) FetchRosDependency() *[]*string {
	var returns *[]*string
