...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BackupPlans)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RosBackupPlans)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-dbs.datasource.RosBackupPlansProps",
		reflect.TypeOf((*RosBackupPlansProps)(nil)).Elem(),
	)
}
