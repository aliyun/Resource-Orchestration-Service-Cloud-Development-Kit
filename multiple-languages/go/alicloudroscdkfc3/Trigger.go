...
func (j *jsiiProxy_Trigger) EnableResourcePropertyConstraint() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Trigger) Env() alicloudroscdkcore.IResourceEnvironment {
...
func (j *jsiiProxy_Trigger) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Trigger) Node() alicloudroscdkcore.ConstructNode {
...
func (j *jsiiProxy_Trigger) Props() *TriggerProps {
...
func (j *jsiiProxy_Trigger) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_Trigger) Resource() alicloudroscdkcore.RosResource {
...
func (j *jsiiProxy_Trigger) Scope() alicloudroscdkcore.Construct {
...
func (j *jsiiProxy_Trigger) Stack() alicloudroscdkcore.Stack {
...
func (j *jsiiProxy_Trigger)SetEnableResourcePropertyConstraint(val *bool) {
...
func (j *jsiiProxy_Trigger)SetId(val *string) {
...
func (j *jsiiProxy_Trigger)SetScope(val alicloudroscdkcore.Construct) {
...
func (t *jsiiProxy_Trigger) AddCondition(condition alicloudroscdkcore.RosCondition) {
...
func (t *jsiiProxy_Trigger) AddCount(count interface{}) {
...
func (t *jsiiProxy_Trigger) AddDependency(resource alicloudroscdkcore.Resource) {
...
func (t *jsiiProxy_Trigger) AddResourceDesc(desc *string) {
...
func (t *jsiiProxy_Trigger) ApplyRemovalPolicy(policy alicloudroscdkcore.RemovalPolicy) {
...
func (t *jsiiProxy_Trigger) GetAtt(name *string) alicloudroscdkcore.IResolvable {
...
func (t *jsiiProxy_Trigger) SetMetadata(key *string, value interface{}) {
...
func (t *jsiiProxy_Trigger) Synthesize(session alicloudroscdkcore.ISynthesisSession) {
