...
func (r *jsiiProxy_RosFunction) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosFunction) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosFunction) FetchRosDependency() *[]*string {
	var returns *[]*string
