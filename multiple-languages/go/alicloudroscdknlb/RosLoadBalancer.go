...
type RosLoadBalancer interface {
	...
	SetDeletionProtectionConfig(val interface{})
	...
	SetLoadBalancerType(val interface{})
	...
	SetTrafficAffinityEnabled(val interface{})
...
func (j *jsiiProxy_RosLoadBalancer) AttrLoadBalancerType() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosLoadBalancer) CrossZoneEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"crossZoneEnabled",
...
func (j *jsiiProxy_RosLoadBalancer) DeletionProtectionConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosLoadBalancer) LoadBalancerType() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"loadBalancerType",
...
func (j *jsiiProxy_RosLoadBalancer) TrafficAffinityEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RosLoadBalancer)SetCrossZoneEnabled(val interface{}) {
...
func (j *jsiiProxy_RosLoadBalancer)SetDeletionProtectionConfig(val interface{}) {
	if err := j.validateSetDeletionProtectionConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RosLoadBalancer)SetLoadBalancerType(val interface{}) {
...
func (j *jsiiProxy_RosLoadBalancer)SetTrafficAffinityEnabled(val interface{}) {
	if err := j.validateSetTrafficAffinityEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
