...
func (j *jsiiProxy_RosRule) Node() ConstructNode {
...
func (j *jsiiProxy_RosRule) Stack() Stack {
	var returns Stack
	_jsii_.Get(
		j,
		"stack",
...
func NewRosRule(scope Construct, id *string, props *RosRuleProps) RosRule {
	_init_.Initialize()

	if err := validateNewRosRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_RosRule{}
...
func NewRosRule_Override(r RosRule, scope Construct, id *string, props *RosRuleProps) {
	_init_.Initialize()
...
func (r *jsiiProxy_RosRule) Synthesize(session ISynthesisSession) {
