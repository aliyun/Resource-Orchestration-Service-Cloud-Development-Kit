...
func (j *jsiiProxy_RosDomainConfig) DomainNames() interface{} {
...
func (j *jsiiProxy_RosDomainConfig) FunctionList() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"functionList",
...
func (j *jsiiProxy_RosDomainConfig)SetDomainNames(val interface{}) {
...
func (j *jsiiProxy_RosDomainConfig)SetFunctionList(val interface{}) {
	if err := j.validateSetFunctionListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (r *jsiiProxy_RosDomainConfig) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDomainConfig) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDomainConfig) FetchRosDependency() *[]*string {
	var returns *[]*string
