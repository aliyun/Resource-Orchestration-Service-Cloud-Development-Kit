...
func (r *jsiiProxy_RosProInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosProInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosProInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
