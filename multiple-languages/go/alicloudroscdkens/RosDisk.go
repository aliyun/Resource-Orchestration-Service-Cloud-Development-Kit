...
func (j *jsiiProxy_RosDisk) Category() interface{} {
...
func (j *jsiiProxy_RosDisk) EnsRegionId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ensRegionId",
...
func (j *jsiiProxy_RosDisk)SetCategory(val interface{}) {
...
func (j *jsiiProxy_RosDisk)SetEnsRegionId(val interface{}) {
...
func (j *jsiiProxy_RosDisk)SetInstanceChargeType(val interface{}) {
