...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableResourcePropertyConstraint", GoGetter: "EnableResourcePropertyConstraint"},
			_jsii_.MemberProperty{JsiiProperty: "ensRegionIds", GoGetter: "EnsRegionIds"},
			_jsii_.MemberProperty{JsiiProperty: "ensServiceId", GoGetter: "EnsServiceId"},
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			...
			_jsii_.MemberProperty{JsiiProperty: "instanceResourceType", GoGetter: "InstanceResourceType"},
