...
func (j *jsiiProxy_KeyPair) AttrKeyPairFingerPrint() interface{} {
...
func (j *jsiiProxy_KeyPair) AttrPrivateKeyBody() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrPrivateKeyBody",
...
func (j *jsiiProxy_KeyPair) Env() alicloudroscdkcore.IResourceEnvironment {
