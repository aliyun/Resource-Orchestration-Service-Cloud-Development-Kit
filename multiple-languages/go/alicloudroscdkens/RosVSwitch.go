...
func (j *jsiiProxy_RosVSwitch) EnsRegionId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ensRegionId",
...
func (j *jsiiProxy_RosVSwitch) NetworkId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"networkId",
...
func (j *jsiiProxy_RosVSwitch)SetEnsRegionId(val interface{}) {
...
func (j *jsiiProxy_RosVSwitch)SetNetworkId(val interface{}) {
