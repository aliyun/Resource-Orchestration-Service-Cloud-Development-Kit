...
func (j *jsiiProxy_RosDisk) validateSetCategoryParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosDisk) validateSetEnsRegionIdParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosDisk) validateSetInstanceBillingCycleParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_RosDisk) validateSetInstanceChargeTypeParameters(val interface{}) error {
	return nil
}
