...
func (j *jsiiProxy_RosInstance) validateSetEnsRegionIdParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetIpTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetQuantityParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosInstance) validateSetUniqueSuffixParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
