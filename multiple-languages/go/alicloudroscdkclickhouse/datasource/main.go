...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrComputingGroupIds", GoGetter: "AttrComputingGroupIds"},
			_jsii_.MemberProperty{JsiiProperty: "attrCreateTime", GoGetter: "AttrCreateTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrDisabledPorts", GoGetter: "AttrDisabledPorts"},
			_jsii_.MemberProperty{JsiiProperty: "attrEndpoints", GoGetter: "AttrEndpoints"},
			_jsii_.MemberProperty{JsiiProperty: "attrEngine", GoGetter: "AttrEngine"},
			_jsii_.MemberProperty{JsiiProperty: "attrEngineMinorVersion", GoGetter: "AttrEngineMinorVersion"},
			_jsii_.MemberProperty{JsiiProperty: "attrEngineVersion", GoGetter: "AttrEngineVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrMultiZones", GoGetter: "AttrMultiZones"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrNodeScaleMax", GoGetter: "AttrNodeScaleMax"},
			_jsii_.MemberProperty{JsiiProperty: "attrNodeScaleMin", GoGetter: "AttrNodeScaleMin"},
			_jsii_.MemberProperty{JsiiProperty: "attrObjectStoreSize", GoGetter: "AttrObjectStoreSize"},
			_jsii_.MemberProperty{JsiiProperty: "attrResourceGroupId", GoGetter: "AttrResourceGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "attrScaleMax", GoGetter: "AttrScaleMax"},
			_jsii_.MemberProperty{JsiiProperty: "attrScaleMin", GoGetter: "AttrScaleMin"},
			_jsii_.MemberProperty{JsiiProperty: "attrStorageQuota", GoGetter: "AttrStorageQuota"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-clickhouse.datasource.EnterpriseDBClusterProps",
		reflect.TypeOf((*EnterpriseDBClusterProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-clickhouse.datasource.EnterpriseDBClusters",
		reflect.TypeOf((*EnterpriseDBClusters)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrEnterpriseDbClusters", GoGetter: "AttrEnterpriseDbClusters"},
			_jsii_.MemberProperty{JsiiProperty: "enableResourcePropertyConstraint", GoGetter: "EnableResourcePropertyConstraint"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberMethod{JsiiMethod: "fetchCondition", GoMethod: "FetchCondition"},
			_jsii_.MemberMethod{JsiiMethod: "fetchDependency", GoMethod: "FetchDependency"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IEnterpriseDBClusters)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-clickhouse.datasource.EnterpriseDBClustersProps",
		reflect.TypeOf((*EnterpriseDBClustersProps)(nil)).Elem(),
	)
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-clickhouse.datasource.IEnterpriseDBCluster",
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-clickhouse.datasource.IEnterpriseDBClusters",
		reflect.TypeOf((*IEnterpriseDBClusters)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attrDbInstanceIds", GoGetter: "AttrDbInstanceIds"},
			_jsii_.MemberProperty{JsiiProperty: "attrEnterpriseDbClusters", GoGetter: "AttrEnterpriseDbClusters"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
		...
		func() interface{} {
			j := jsiiProxy_IEnterpriseDBClusters{}
			_jsii_.InitJsiiProxy(&j.Type__alicloudroscdkcoreIResource)
			return &j
		},
	)
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-clickhouse.datasource.RosEnterpriseDBClusterProps",
		reflect.TypeOf((*RosEnterpriseDBClusterProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-clickhouse.datasource.RosEnterpriseDBClusters",
		reflect.TypeOf((*RosEnterpriseDBClusters)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addCondition", GoMethod: "AddCondition"},
			_jsii_.MemberMethod{JsiiMethod: "addCount", GoMethod: "AddCount"},
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-clickhouse.datasource.RosEnterpriseDBClustersProps",
		reflect.TypeOf((*RosEnterpriseDBClustersProps)(nil)).Elem(),
	)
}
