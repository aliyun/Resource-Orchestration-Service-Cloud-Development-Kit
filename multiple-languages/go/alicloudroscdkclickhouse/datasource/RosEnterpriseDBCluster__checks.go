...
func (j *jsiiProxy_RosEnterpriseDBCluster) validateSetDbInstanceIdParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_RosEnterpriseDBCluster) validateSetRefreshOptionsParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
