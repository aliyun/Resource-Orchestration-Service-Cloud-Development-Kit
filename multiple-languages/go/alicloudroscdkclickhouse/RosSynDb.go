...
func (r *jsiiProxy_RosSynDb) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosSynDb) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosSynDb) FetchRosDependency() *[]*string {
	var returns *[]*string
