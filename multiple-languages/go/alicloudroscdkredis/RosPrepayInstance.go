...
func (j *jsiiProxy_RosPrepayInstance) DeletionProtection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deletionProtection",
...
func (j *jsiiProxy_RosPrepayInstance)SetDeletionProtection(val interface{}) {
...
func (r *jsiiProxy_RosPrepayInstance) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosPrepayInstance) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosPrepayInstance) FetchRosDependency() *[]*string {
	var returns *[]*string
