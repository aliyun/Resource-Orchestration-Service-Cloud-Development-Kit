...
func (j *jsiiProxy_RosInstance) validateSetDbInstanceIdParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_RosInstance) validateSetRefreshOptionsParameters(val interface{}) error {
	return nil
}
