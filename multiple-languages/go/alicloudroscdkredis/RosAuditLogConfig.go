...
func (r *jsiiProxy_RosAuditLogConfig) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosAuditLogConfig) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosAuditLogConfig) FetchRosDependency() *[]*string {
	var returns *[]*string
