...
func (j *jsiiProxy_RosInstance) validateSetAutoRenewDurationParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetBackupPolicyParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_BackupPolicyProperty:
		val := val.(*RosInstance_BackupPolicyProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_BackupPolicyProperty:
		val_ := val.(RosInstance_BackupPolicyProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_BackupPolicyProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetConnectionsParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_ConnectionsProperty:
		val := val.(*RosInstance_ConnectionsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_ConnectionsProperty:
		val_ := val.(RosInstance_ConnectionsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_ConnectionsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetDeletionForceParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetEngineVersionParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetEvictionPolicyParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetInstanceMaintainTimeParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_InstanceMaintainTimeProperty:
		val := val.(*RosInstance_InstanceMaintainTimeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_InstanceMaintainTimeProperty:
		val_ := val.(RosInstance_InstanceMaintainTimeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_InstanceMaintainTimeProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetNodeTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetPasswordParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetProductTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetSecurityGroupIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetShardCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosInstance) validateSetSslEnabledParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetTairConfigParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_TairConfigProperty:
		val := val.(*RosInstance_TairConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_TairConfigProperty:
		val_ := val.(RosInstance_TairConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_TairConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetVpcIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetVpcPasswordFreeParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_RosInstance) validateSetVSwitchIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosInstance) validateSetZoneIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
