...
func (r *jsiiProxy_RosZone) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosZone) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosZone) FetchRosDependency() *[]*string {
	var returns *[]*string
