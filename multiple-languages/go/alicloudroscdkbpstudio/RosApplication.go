...
import (
	_init_ "github.com/alibabacloud-go/ros-cdk/alicloudroscdkbpstudio/jsii"
...
type RosApplication interface {
	...
	AttrImageUrl() alicloudroscdkcore.IResolvable
...
func (j *jsiiProxy_RosApplication) ApplicationName() interface{} {
...
func (j *jsiiProxy_RosApplication) AttrApplicationName() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrApplicationName",
...
func (j *jsiiProxy_RosApplication) AttrImageUrl() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrImageUrl",
...
func (j *jsiiProxy_RosApplication) AttrResourceGroupId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrResourceGroupId",
...
func (j *jsiiProxy_RosApplication) AttrTemplateId() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrTemplateId",
...
func (j *jsiiProxy_RosApplication) ResourceGroupId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceGroupId",
...
func (j *jsiiProxy_RosApplication) TemplateId() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"templateId",
...
func (j *jsiiProxy_RosApplication) TopoUrl() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"topoUrl",
...
func NewRosApplication(scope alicloudroscdkcore.Construct, id *string, props *RosApplicationProps, enableResourcePropertyConstraint *bool) RosApplication {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-bpstudio.RosApplication",
...
func (j *jsiiProxy_RosApplication)SetApplicationName(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetResourceGroupId(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetTemplateId(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetTopoUrl(val interface{}) {
	if err := j.validateSetTopoUrlParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
