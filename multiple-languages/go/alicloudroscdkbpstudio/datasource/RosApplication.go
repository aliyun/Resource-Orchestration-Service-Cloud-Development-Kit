...
type RosApplication interface {
	...
	SetApplicationId(val interface{})
...
func (j *jsiiProxy_RosApplication) ApplicationId() interface{} {
...
func (j *jsiiProxy_RosApplication) AttrStatus() alicloudroscdkcore.IResolvable {
	var returns alicloudroscdkcore.IResolvable
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_RosApplication) RefreshOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"refreshOptions",
...
func NewRosApplication(scope alicloudroscdkcore.Construct, id *string, props *RosApplicationProps, enableResourcePropertyConstraint *bool) RosApplication {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-bpstudio.datasource.RosApplication",
...
func (j *jsiiProxy_RosApplication)SetApplicationId(val interface{}) {
...
func (j *jsiiProxy_RosApplication)SetRefreshOptions(val interface{}) {
