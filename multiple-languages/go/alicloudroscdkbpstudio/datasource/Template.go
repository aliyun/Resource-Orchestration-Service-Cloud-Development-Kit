...
func (j *jsiiProxy_Template) AttrCreateTime() interface{} {
...
func (j *jsiiProxy_Template) AttrImageUrl() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrImageUrl",
...
func (j *jsiiProxy_Template) AttrTopoUrl() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"attrTopoUrl",
...
func NewTemplate(scope alicloudroscdkcore.Construct, id *string, props *TemplateProps, enableResourcePropertyConstraint *bool) Template {
	...
	_jsii_.Create(
		"@alicloud/ros-cdk-bpstudio.datasource.Template",
