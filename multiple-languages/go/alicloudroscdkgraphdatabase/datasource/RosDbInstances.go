...
func (j *jsiiProxy_RosDbInstances) DbInstanceDescription() interface{} {
...
func (j *jsiiProxy_RosDbInstances)SetDbInstanceDescription(val interface{}) {
...
func (r *jsiiProxy_RosDbInstances) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosDbInstances) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosDbInstances) FetchRosDependency() *[]*string {
	var returns *[]*string
