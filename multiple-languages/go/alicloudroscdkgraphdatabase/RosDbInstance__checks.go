...
func (j *jsiiProxy_RosDbInstance) validateSetBackupSetIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDbInstance) validateSetCreateTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDbInstance) validateSetDbInstanceIpArrayParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosDbInstance_DBInstanceIPArrayProperty:
				v := v.(*RosDbInstance_DBInstanceIPArrayProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosDbInstance_DBInstanceIPArrayProperty:
				v_ := v.(RosDbInstance_DBInstanceIPArrayProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosDbInstance_DBInstanceIPArrayProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_RosDbInstance) validateSetDbInstanceNetworkTypeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDbInstance) validateSetDbNodeClassParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDbInstance) validateSetDbNodeStorageParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDbInstance) validateSetDbVersionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_RosDbInstance) validateSetEcsSecurityGroupRelationsParameters(val interface{}) error {
	switch val.(type) {
	case alicloudroscdkcore.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosDbInstance_EcsSecurityGroupRelationsProperty:
				v := v.(*RosDbInstance_EcsSecurityGroupRelationsProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosDbInstance_EcsSecurityGroupRelationsProperty:
				v_ := v.(RosDbInstance_EcsSecurityGroupRelationsProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosDbInstance_EcsSecurityGroupRelationsProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_RosDbInstance) validateSetPaymentTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDbInstance) validateSetRestoreTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDbInstance) validateSetSourceDbInstanceIdParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
