...
func (j *jsiiProxy_RosInstance) validateSetDataNodeParameters(val interface{}) error {
	...
	switch val.(type) {
	case *RosInstance_DataNodeProperty:
		val := val.(*RosInstance_DataNodeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_DataNodeProperty:
		val_ := val.(RosInstance_DataNodeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *RosInstance_DataNodeProperty, alicloudroscdkcore.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetKibanaNodeParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_KibanaNodeProperty:
		val := val.(*RosInstance_KibanaNodeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_KibanaNodeProperty:
		val_ := val.(RosInstance_KibanaNodeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_KibanaNodeProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetMasterNodeParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_MasterNodeProperty:
		val := val.(*RosInstance_MasterNodeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_MasterNodeProperty:
		val_ := val.(RosInstance_MasterNodeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_MasterNodeProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_RosInstance) validateSetYmlConfigParameters(val interface{}) error {
	...
	case alicloudroscdkcore.IResolvable:
		// ok
	case *RosInstance_YMLConfigProperty:
		val := val.(*RosInstance_YMLConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case RosInstance_YMLConfigProperty:
		val_ := val.(RosInstance_YMLConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosInstance_YMLConfigProperty; received %#v (a %T)", val, val)
		}
	}
