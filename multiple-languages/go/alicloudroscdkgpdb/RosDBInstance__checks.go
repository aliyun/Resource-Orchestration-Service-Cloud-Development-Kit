...
func (j *jsiiProxy_RosDBInstance) validateSetAiNodeSpecInfosParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case alicloudroscdkcore.IResolvable:
				// ok
			case *RosDBInstance_AINodeSpecInfosProperty:
				v := v.(*RosDBInstance_AINodeSpecInfosProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case RosDBInstance_AINodeSpecInfosProperty:
				v_ := v.(RosDBInstance_AINodeSpecInfosProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: alicloudroscdkcore.IResolvable, *RosDBInstance_AINodeSpecInfosProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_RosDBInstance) validateSetDbInstanceCategoryParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetDbInstanceGroupCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosDBInstance) validateSetDbInstanceModeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetEncryptionTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetIdleTimeParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosDBInstance) validateSetMasterNodeNumParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosDBInstance) validateSetPeriodUnitParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetProdTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetSegDiskPerformanceLevelParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetSegNodeNumParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosDBInstance) validateSetSegStorageTypeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetServerlessModeParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
...
func (j *jsiiProxy_RosDBInstance) validateSetStorageSizeParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_RosDBInstance) validateSetTagsParameters(val *[]*RosDBInstance_TagsProperty) error {
	for idx_97dfc6, v := range *val {
		if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
			return err
		}
...
func (j *jsiiProxy_RosDBInstance) validateSetVectorConfigurationStatusParameters(val interface{}) error {
	switch val.(type) {
	case *string:
		// ok
	case string:
