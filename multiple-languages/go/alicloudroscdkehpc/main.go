...
func init() {
	...
	_jsii_.RegisterInterface(
		"@alicloud/ros-cdk-ehpc.IQueue",
		reflect.TypeOf((*IQueue)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attrComputeNodes", GoGetter: "AttrComputeNodes"},
			_jsii_.MemberProperty{JsiiProperty: "attrCreateTime", GoGetter: "AttrCreateTime"},
			_jsii_.MemberProperty{JsiiProperty: "attrEnableScaleIn", GoGetter: "AttrEnableScaleIn"},
			_jsii_.MemberProperty{JsiiProperty: "attrEnableScaleOut", GoGetter: "AttrEnableScaleOut"},
			_jsii_.MemberProperty{JsiiProperty: "attrHostnamePrefix", GoGetter: "AttrHostnamePrefix"},
			_jsii_.MemberProperty{JsiiProperty: "attrHostnameSuffix", GoGetter: "AttrHostnameSuffix"},
			_jsii_.MemberProperty{JsiiProperty: "attrInitialCount", GoGetter: "AttrInitialCount"},
			_jsii_.MemberProperty{JsiiProperty: "attrInterConnect", GoGetter: "AttrInterConnect"},
			_jsii_.MemberProperty{JsiiProperty: "attrMaxCount", GoGetter: "AttrMaxCount"},
			_jsii_.MemberProperty{JsiiProperty: "attrMinCount", GoGetter: "AttrMinCount"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ehpc.QueueProps",
	...
	_jsii_.RegisterClass(
		"@alicloud/ros-cdk-ehpc.RosQueue",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enableResourcePropertyConstraint", GoGetter: "EnableResourcePropertyConstraint"},
			_jsii_.MemberProperty{JsiiProperty: "enableScaleIn", GoGetter: "EnableScaleIn"},
			_jsii_.MemberProperty{JsiiProperty: "enableScaleOut", GoGetter: "EnableScaleOut"},
			_jsii_.MemberMethod{JsiiMethod: "fetchCondition", GoMethod: "FetchCondition"},
			_jsii_.MemberMethod{JsiiMethod: "fetchDesc", GoMethod: "FetchDesc"},
			_jsii_.MemberMethod{JsiiMethod: "fetchRosDependency", GoMethod: "FetchRosDependency"},
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			_jsii_.MemberProperty{JsiiProperty: "hostnamePrefix", GoGetter: "HostnamePrefix"},
			_jsii_.MemberProperty{JsiiProperty: "hostnameSuffix", GoGetter: "HostnameSuffix"},
			_jsii_.MemberProperty{JsiiProperty: "initialCount", GoGetter: "InitialCount"},
	...
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ehpc.RosQueue.ComputeNodesProperty",
		reflect.TypeOf((*RosQueue_ComputeNodesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ehpc.RosQueue.SystemDiskProperty",
		reflect.TypeOf((*RosQueue_SystemDiskProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@alicloud/ros-cdk-ehpc.RosQueueProps",
