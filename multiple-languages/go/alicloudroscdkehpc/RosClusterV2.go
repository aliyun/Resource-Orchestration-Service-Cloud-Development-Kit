...
func (r *jsiiProxy_RosClusterV2) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosClusterV2) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosClusterV2) FetchRosDependency() *[]*string {
	var returns *[]*string
