...
func (r *jsiiProxy_RosAutoScaleConfig) FetchCondition() alicloudroscdkcore.RosCondition {
...
func (r *jsiiProxy_RosAutoScaleConfig) FetchDesc() *string {
	var returns *string
...
func (r *jsiiProxy_RosAutoScaleConfig) FetchRosDependency() *[]*string {
	var returns *[]*string
