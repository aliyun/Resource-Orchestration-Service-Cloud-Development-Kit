...
class CountResourcesAssertion extends Assertion<StackInspector> {
  ...
  constructor(private readonly resourceType: string, private readonly count: number, props: any = null) {
    super();
    this.props = props;
  }
  ...
  public get description(): string {
    return `stack only has ${this.inspected} resource of type ${this.resourceType}${
      this.props ? ' with specified properties' : ''
    } but we expected to find ${this.count}`;
  }
}
